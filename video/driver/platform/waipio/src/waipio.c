...
static struct msm_platform_inst_capability instance_cap_data_waipio[] = {
	...
	{ PIX_FMTS, ENC | DEC, HEVC | VP9, MSM_VIDC_FMT_NV12,
	  MSM_VIDC_FMT_TP10C,
	  MSM_VIDC_FMT_NV12 | MSM_VIDC_FMT_NV21 | MSM_VIDC_FMT_NV12C |
		  MSM_VIDC_FMT_TP10C,
	  MSM_VIDC_FMT_NV12C },
	...
	{ FRAME_RATE, ENC | DEC, CODECS_ALL, (MINIMUM_FPS << 16),
	  (MAXIMUM_FPS << 16), 1, (DEFAULT_FPS << 16), 0, HFI_PROP_FRAME_RATE,
	  CAP_FLAG_OUTPUT_PORT },

	{ OPERATING_RATE, ENC | DEC, CODECS_ALL, (MINIMUM_FPS << 16),
	...
	{ SUPER_FRAME, ENC, H264 | HEVC, 0, 32, 1, 0, 0, 0, CAP_FLAG_NONE },
	...
	{ FRAME_RC_ENABLE, ENC, H264 | HEVC, 0, 1, 1, 1,
	...
	{ BLUR_TYPES, ENC, H264 | HEVC, MSM_VIDC_BLUR_NONE,
	  ...
	  MSM_VIDC_BLUR_NONE, 0, HFI_PROP_BLUR_TYPES,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ CSC, ENC, CODECS_ALL, 0, 1, 1, 0, 0, HFI_PROP_CSC },

	{ LOWLATENCY_MODE, ENC, H264 | HEVC, 0, 1, 1, 0, 0, 0, CAP_FLAG_NONE },

	{ LOWLATENCY_MODE, DEC, H264 | HEVC | VP9, 0, 1, 1, 0, 0,
	...
	{ USE_LTR, ENC, H264 | HEVC, 0, ((1 << MAX_LTR_FRAME_COUNT) - 1), 0, 0,
	  V4L2_CID_MPEG_VIDEO_USE_LTR_FRAMES, HFI_PROP_LTR_USE,
	  CAP_FLAG_INPUT_PORT | CAP_FLAG_DYNAMIC_ALLOWED },
	...
	{ CONTENT_ADAPTIVE_CODING, ENC, H264 | HEVC, 0, 1, 1, 1, 0,
	...
	{ MIN_FRAME_QP, ENC, HEVC, MIN_QP_10BIT, MAX_QP, 1, MIN_QP_10BIT,
	...
	{ I_FRAME_MIN_QP, ENC, HEVC, MIN_QP_10BIT, MAX_QP, 1, MIN_QP_10BIT,
	  V4L2_CID_MPEG_VIDEO_HEVC_I_FRAME_MIN_QP },

	{ P_FRAME_MIN_QP, ENC, H264, MIN_QP_8BIT, MAX_QP, 1, MIN_QP_8BIT,
	  V4L2_CID_MPEG_VIDEO_H264_P_FRAME_MIN_QP },

	{ P_FRAME_MIN_QP, ENC, HEVC, MIN_QP_10BIT, MAX_QP, 1, MIN_QP_10BIT,
	...
	{ B_FRAME_MIN_QP, ENC, HEVC, MIN_QP_10BIT, MAX_QP, 1, MIN_QP_10BIT,
	...
	{ MAX_FRAME_QP, ENC, HEVC, MIN_QP_10BIT, MAX_QP, 1, MAX_QP,
	...
	{ I_FRAME_MAX_QP, ENC, HEVC, MIN_QP_10BIT, MAX_QP, 1, MAX_QP,
	  V4L2_CID_MPEG_VIDEO_HEVC_I_FRAME_MAX_QP },

	{ P_FRAME_MAX_QP, ENC, H264, MIN_QP_8BIT, MAX_QP, 1, MAX_QP,
	  V4L2_CID_MPEG_VIDEO_H264_P_FRAME_MAX_QP },

	{ P_FRAME_MAX_QP, ENC, HEVC, MIN_QP_10BIT, MAX_QP, 1, MAX_QP,
	...
	{ B_FRAME_MAX_QP, ENC, HEVC, MIN_QP_10BIT, MAX_QP, 1, MAX_QP,
	...
	{ PROFILE, ENC | DEC, HEVC, V4L2_MPEG_VIDEO_HEVC_PROFILE_MAIN,
	...
	{ LEVEL, ENC, HEVC, V4L2_MPEG_VIDEO_HEVC_LEVEL_1,
	...
	{ LEVEL, DEC, HEVC, V4L2_MPEG_VIDEO_HEVC_LEVEL_1,
	  V4L2_MPEG_VIDEO_HEVC_LEVEL_6_2,
	  BIT(V4L2_MPEG_VIDEO_HEVC_LEVEL_1) |
		  BIT(V4L2_MPEG_VIDEO_HEVC_LEVEL_2) |
		  BIT(V4L2_MPEG_VIDEO_HEVC_LEVEL_2_1) |
	...
	{ LF_ALPHA, ENC, HEVC, -6, 6, 1, 0,
	  V4L2_CID_MPEG_VIDEO_HEVC_LF_TC_OFFSET_DIV2 },

	{ LF_BETA, ENC, H264, -6, 6, 1, 0,
	  V4L2_CID_MPEG_VIDEO_H264_LOOP_FILTER_BETA },

	{ LF_BETA, ENC, HEVC, -6, 6, 1, 0,
	...
	{ DISPLAY_DELAY_ENABLE, DEC, H264 | HEVC | VP9, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDEO_DEC_DISPLAY_DELAY_ENABLE,
	  HFI_PROP_DECODE_ORDER_OUTPUT, CAP_FLAG_INPUT_PORT },

	{ DISPLAY_DELAY, DEC, H264 | HEVC | VP9, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDEO_DEC_DISPLAY_DELAY, HFI_PROP_DECODE_ORDER_OUTPUT,
	  CAP_FLAG_INPUT_PORT },

	{ OUTPUT_ORDER, DEC, H264 | HEVC | VP9, 0, 1, 1, 0, 0,
	  HFI_PROP_DECODE_ORDER_OUTPUT, CAP_FLAG_INPUT_PORT },
	...
	{ CODED_FRAMES, DEC, H264 | HEVC, CODED_FRAMES_PROGRESSIVE,
	  CODED_FRAMES_INTERLACE, 1, CODED_FRAMES_PROGRESSIVE, 0,
	  HFI_PROP_CODED_FRAMES },

	{ BIT_DEPTH, DEC, CODECS_ALL, BIT_DEPTH_8, BIT_DEPTH_10, 1, BIT_DEPTH_8,
	  0, HFI_PROP_LUMA_CHROMA_BIT_DEPTH },

	{ CODEC_CONFIG, DEC, H264 | HEVC, 0, 1, 1, 0, 0, 0,
	  CAP_FLAG_DYNAMIC_ALLOWED },

	{ BITSTREAM_SIZE_OVERWRITE, DEC, CODECS_ALL, 0, INT_MAX, 1, 0, 0 },

	{ THUMBNAIL_MODE, DEC, CODECS_ALL, 0, 1, 1, 0, 0,
	  HFI_PROP_THUMBNAIL_MODE, CAP_FLAG_INPUT_PORT },
	...
	{ PRIORITY, DEC | ENC, CODECS_ALL, 0, 4, 1, 4, 0,
	  HFI_PROP_SESSION_PRIORITY, CAP_FLAG_DYNAMIC_ALLOWED },

	{ FIRMWARE_PRIORITY_OFFSET, DEC | ENC, CODECS_ALL, 1, 1, 1, 1 },

	{ ALL_INTRA, ENC, H264 | HEVC, 0, 1, 1, 0, 0, 0, CAP_FLAG_OUTPUT_PORT },

	{ COMPLEXITY, ENC, H264 | HEVC, 0, 100, 1, DEFAULT_COMPLEXITY, 0 },
};
...
static struct msm_platform_inst_cap_dependency instance_cap_dependency_data_waipio[] = {
	...
	{ BITRATE_MODE,
	  ENC,
	  H264,
	  { LTR_COUNT, I_FRAME_QP, P_FRAME_QP, B_FRAME_QP, ENH_LAYER_COUNT,
	    BIT_RATE, MIN_QUALITY, VBV_DELAY, PEAK_BITRATE, SLICE_MODE,
	...
	{ BITRATE_MODE,
	  ENC,
	  HEVC,
	  { LTR_COUNT, I_FRAME_QP, P_FRAME_QP, B_FRAME_QP, CONSTANT_QUALITY,
	    ENH_LAYER_COUNT, BIT_RATE, MIN_QUALITY, VBV_DELAY, PEAK_BITRATE,
	...
	{ LAYER_TYPE, ENC, H264, { CONTENT_ADAPTIVE_CODING } },
	...
	{ PROFILE, DEC, VP9, { 0 }, NULL, msm_vidc_set_u32_enum },

	{ LEVEL, DEC, CODECS_ALL, { 0 }, NULL, msm_vidc_set_u32_enum },

	{ LEVEL, ENC, CODECS_ALL, { 0 }, NULL, msm_vidc_set_level },

	{ HEVC_TIER, ENC | DEC, HEVC, { 0 }, NULL, msm_vidc_set_u32_enum },
	...
	{ DISPLAY_DELAY, DEC, H264 | HEVC | VP9, { OUTPUT_ORDER }, NULL, NULL },
	...
	{ STAGE, DEC, H264 | HEVC | VP9, { 0 }, NULL, msm_vidc_set_stage },
...
/* freq */
static struct freq_table waipio_freq_table[] = { { 444000000 },
						 { 366000000 },
						 { 338000000 },
						 { 240000000 } };
...
static const struct msm_vidc_platform_data waipio_data = {
	...
	.inst_cap_dependency_data_size =
		ARRAY_SIZE(instance_cap_dependency_data_waipio),
	...
	.dec_input_prop_size_hevc =
		ARRAY_SIZE(waipio_vdec_input_properties_hevc),
	...
	.dec_output_prop_size_avc =
		ARRAY_SIZE(waipio_vdec_output_properties_avc),
	.dec_output_prop_size_hevc =
		ARRAY_SIZE(waipio_vdec_output_properties_hevc),
	.dec_output_prop_size_vp9 =
		ARRAY_SIZE(waipio_vdec_output_properties_vp9),
};
