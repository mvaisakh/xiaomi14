...
#define DEFAULT_COMP_RATIO_RT "NV12/5/1/1.23 AB24/5/1/1.23 XB24/5/1/1.23"
#define DEFAULT_COMP_RATIO_NRT "NV12/5/1/1.25 AB24/5/1/1.25 XB24/5/1/1.25"
...
#define SSPP_GET_REGDMA_BASE(blk_base, top_off) \
	((blk_base) >= (top_off) ? (blk_base) - (top_off) : (blk_base))
...
enum { NOISE_LAYER_OFF, NOISE_LAYER_VERSION, NOISEL_LAYER_PROP_MAX };
...
static struct sde_prop_type sde_hw_prop[] = {
	...
	{ SDE_HW_FENCE_VERSION, "qcom,hw-fence-sw-version", false,
	  PROP_TYPE_U32 },
};
...
static struct sde_prop_type sde_prop[] = {
	...
	{ VIG_SSPP_LINEWIDTH, "qcom,sde-vig-sspp-linewidth", false,
	  PROP_TYPE_U32 },
	{ SCALING_LINEWIDTH, "qcom,sde-scaling-linewidth", false,
	  PROP_TYPE_U32 },
	...
	{ WB_LINEWIDTH_LINEAR, "qcom,sde-wb-linewidth-linear", false,
	  PROP_TYPE_U32 },
	...
	{ SMART_PANEL_ALIGN_MODE, "qcom,sde-smart-panel-align-mode", false,
	  PROP_TYPE_U32 },
	...
	{ PIPE_ORDER_VERSION, "qcom,sde-pipe-order-version", false,
	  PROP_TYPE_U32 },
	{ SEC_SID_MASK, "qcom,sde-secure-sid-mask", false,
	  PROP_TYPE_U32_ARRAY },
	{ BASE_LAYER, "qcom,sde-mixer-stage-base-layer", false,
	  PROP_TYPE_BOOL },
	...
	{ IPCC_CLIENT_DPU_PHYS_ID, "qcom,sde-ipcc-client-dpu-phys-id", false,
	  PROP_TYPE_U32 }
};
...
static struct sde_prop_type sde_perf_prop[] = {
	...
	{ PERF_XTRA_PREFILL_LINES, "qcom,sde-xtra-prefill-lines", false,
	  PROP_TYPE_U32 },
	{ PERF_NUM_DDR_CHANNELS, "qcom,sde-num-ddr-channels", false,
	  PROP_TYPE_U32 },
	{ PERF_DRAM_EFFICIENCY, "qcom,sde-dram-efficiency", false,
	  PROP_TYPE_U32 },
...
static struct sde_prop_type vig_prop[] = {
	...
	[VIG_IGC_PROP] = { VIG_IGC_PROP, "qcom,sde-vig-igc", false,
			   PROP_TYPE_U32_ARRAY },
	[VIG_INVERSE_PMA] = { VIG_INVERSE_PMA, "qcom,sde-vig-inverse-pma",
			      false, PROP_TYPE_BOOL },
	...
	[VIG_UCSC_UNMULT_PROP] = { VIG_UCSC_UNMULT_PROP, "qcom,sde-ucsc-unmult",
				   false, PROP_TYPE_U32_ARRAY },
	[VIG_UCSC_ALPHA_DITHER_PROP] = { VIG_UCSC_ALPHA_DITHER_PROP,
					 "qcom,sde-ucsc-alpha-dither", false,
					 PROP_TYPE_U32_ARRAY },
};
...
static struct sde_prop_type dma_prop[] = {
	...
	[DMA_DGM_INVERSE_PMA] = { DMA_DGM_INVERSE_PMA,
				  "qcom,sde-dma-inverse-pma", false,
				  PROP_TYPE_BOOL },
	...
	[DMA_UCSC_UNMULT_PROP] = { DMA_UCSC_UNMULT_PROP, "qcom,sde-ucsc-unmult",
				   false, PROP_TYPE_U32_ARRAY },
	[DMA_UCSC_ALPHA_DITHER_PROP] = { DMA_UCSC_ALPHA_DITHER_PROP,
					 "qcom,sde-ucsc-alpha-dither", false,
					 PROP_TYPE_U32_ARRAY },
};
...
static struct sde_prop_type mixer_prop[] = {
	...
	{ MIXER_DISP, "qcom,sde-mixer-display-pref", false,
	  PROP_TYPE_STRING_ARRAY },
	{ MIXER_CWB, "qcom,sde-mixer-cwb-pref", false, PROP_TYPE_STRING_ARRAY },
...
static struct sde_prop_type dspp_blocks_prop[] = {
	...
	{ DSPP_DITHER_PROP, "qcom,sde-dspp-dither", false,
	  PROP_TYPE_U32_ARRAY },
...
static struct sde_prop_type rc_prop[] = {
	...
	{ RC_MEM_TOTAL_SIZE, "qcom,sde-dspp-rc-mem-size", false,
	  PROP_TYPE_U32 },
	{ RC_MIN_REGION_WIDTH, "qcom,sde-dspp-rc-min-region-width", false,
	  PROP_TYPE_U32 },
};
...
static struct sde_prop_type pp_prop[] = {
	...
	{ PP_MERGE_3D_ID, "qcom,sde-pp-merge-3d-id", false,
	  PROP_TYPE_U32_ARRAY },
};
...
static struct sde_prop_type intf_prop[] = {
	...
	{ INTF_TE_IRQ, "qcom,sde-intf-tear-irq-off", false,
	  PROP_TYPE_U32_ARRAY },
};
...
static struct sde_prop_type dnsc_blur_prop[] = {
	...
	{ DNSC_BLUR_VERSION, "qcom,sde-dnsc-blur-version", false,
	  PROP_TYPE_U32 },
	{ DNSC_BLUR_GAUS_LUT_OFF, "qcom,sde-dnsc-blur-gaus-lut-off", false,
	  PROP_TYPE_U32_ARRAY },
	{ DNSC_BLUR_GAUS_LUT_LEN, "qcom,sde-dnsc-blur-gaus-lut-size", false,
	  PROP_TYPE_U32 },
	{ DNSC_BLUR_DITHER_OFF, "qcom,sde-dnsc-blur-dither-off", false,
	  PROP_TYPE_U32_ARRAY },
	{ DNSC_BLUR_DITHER_LEN, "qcom,sde-dnsc-blur-dither-size", false,
	  PROP_TYPE_U32 },
};
...
static struct sde_prop_type vbif_prop[] = {
	...
	{ VBIF_DYNAMIC_OT_WR_LIMIT, "qcom,sde-vbif-dynamic-ot-wr-limit", false,
	  PROP_TYPE_U32_ARRAY },
	{ VBIF_MEMTYPE_0, "qcom,sde-vbif-memtype-0", false,
	  PROP_TYPE_U32_ARRAY },
	{ VBIF_MEMTYPE_1, "qcom,sde-vbif-memtype-1", false,
	  PROP_TYPE_U32_ARRAY },
	...
	{ VBIF_QOS_LUTDMA_REMAP, "qcom,sde-vbif-qos-lutdma-remap", false,
	  PROP_TYPE_U32_ARRAY },
	{ VBIF_QOS_CNOC_REMAP, "qcom,sde-vbif-qos-cnoc-remap", false,
	  PROP_TYPE_U32_ARRAY },
	{ VBIF_QOS_OFFLINE_WB_REMAP, "qcom,sde-vbif-qos-offline-wb-remap",
	  false, PROP_TYPE_U32_ARRAY },
	{ VBIF_QOS_WB_ROT_REMAP, "qcom,sde-vbif-qos-wb-rot-remap", false,
	  PROP_TYPE_U32_ARRAY },
};
...
static struct sde_prop_type reg_dma_prop[REG_DMA_PROP_MAX] = {
	...
	[REG_DMA_BROADCAST_DISABLED] = { REG_DMA_BROADCAST_DISABLED,
					 ...
					 false, PROP_TYPE_BOOL },
	[REG_DMA_XIN_ID] = { REG_DMA_XIN_ID, "qcom,sde-reg-dma-xin-id", false,
			     PROP_TYPE_U32 },
	[REG_DMA_CLK_CTRL] = { REG_DMA_CLK_CTRL, "qcom,sde-reg-dma-clk-ctrl",
...
static struct sde_prop_type noise_layer_prop[] = {
	[NOISE_LAYER_OFF] = { NOISE_LAYER_OFF, "qcom,sde-lm-noise-off", false,
			      PROP_TYPE_U32 },
	[NOISE_LAYER_VERSION] = { NOISE_LAYER_VERSION,
				  "qcom,sde-lm-noise-version", false,
				  PROP_TYPE_U32 },
};
...
static int _parse_dt_u32_handler(struct device_node *np, char *prop_name,
				 u32 *offsets, int len, bool mandatory)
{
	int rc = -EINVAL;
...
static int _parse_dt_bit_offset(struct device_node *np, char *prop_name,
				struct sde_prop_value *prop_value,
				u32 prop_index, u32 count, bool mandatory)
{
	int rc = 0, len, i, j;
	const u32 *arr;
...
static int _validate_dt_entry(struct device_node *np,
			      struct sde_prop_type *sde_prop, u32 prop_size,
			      int *prop_count, int *off_count)
{
	int rc = 0, i, val;
	...
	if (off_count) {
		*off_count =
			of_property_count_u32_elems(np, sde_prop[0].prop_name);
	...
	for (i = 0; i < prop_size; i++) {
		...
		case PROP_TYPE_U32_ARRAY:
			prop_count[i] = of_property_count_u32_elems(
				np, sde_prop[i].prop_name);
			if (prop_count[i] < 0)
				rc = prop_count[i];
			break;
		case PROP_TYPE_STRING_ARRAY:
			prop_count[i] = of_property_count_strings(
				np, sde_prop[i].prop_name);
			if (prop_count[i] < 0)
				rc = prop_count[i];
			break;
		case PROP_TYPE_BIT_OFFSET_ARRAY:
			...
			break;
		case PROP_TYPE_NODE:
			snp = of_get_child_by_name(np, sde_prop[i].prop_name);
			if (!snp)
				rc = -EINVAL;
			break;
		case PROP_TYPE_BOOL:
       ...
       */
		...
		SDE_DEBUG(
			...
			i, sde_prop[i].prop_name, sde_prop[i].type,
			prop_count[i]);
...
static int _read_dt_entry(struct device_node *np,
			  struct sde_prop_type *sde_prop, u32 prop_size,
			  int *prop_count, bool *prop_exists,
			  struct sde_prop_value *prop_value)
{
	int rc = 0, i, j;
					     ...
					     u32 prop_size, u32 *off_count)
{
	...
	props->values = kcalloc(prop_max, sizeof(*props->values), GFP_KERNEL);
	if (!props->values)
		goto free_props;
...
static int _add_to_irq_offset_list(struct sde_mdss_cfg *sde_cfg,
				   enum sde_intr_hwblk_type blk_type,
				   u32 instance, u32 offset)
{
	...
	if (err) {
		SDE_ERROR("unable to map instance %d for blk type %d", instance,
			  blk_type);
		return -EINVAL;
	}
...
static bool _sde_sspp_setup_vcm(struct sde_sspp_cfg *sspp,
				...
				const char *name, struct sde_pp_blk *blk,
				u32 type, u32 prop, bool versioned)
{
	...
	if (exists) {
		...
		blk->regdma_base =
			SSPP_GET_REGDMA_BASE(blk->base, sspp->sblk->top_off);
		snprintf(blk->name, SDE_HW_BLK_NAME_LEN, "%s%u", name,
			 sspp->id - SSPP_VIG0);
		if (versioned)
			blk->version =
				PROP_VALUE_ACCESS(props->values, prop, 1);
	} else {
		blk->id = 0;
	}
				...
				struct sde_mdss_cfg *sde_cfg)
{
	...
	if (vcm_count > 0) {
		...
		for_each_child_of_node(snp, vcm_snp) {
			props_tmp = sde_get_dt_props(vcm_snp, VIG_PROP_MAX,
						     vig_prop,
						     ARRAY_SIZE(vig_prop),
						     NULL);
			if (IS_ERR(props_tmp)) {
			...
			i = PROP_VALUE_ACCESS(props_tmp->values,
					      VIG_SUBBLOCK_INDEX, 0);
			if (i >= SSPP_SUBBLK_COUNT_MAX) {
				SDE_ERROR("invalid vcm rect index: %d", i);
				goto end;
			} else if (props[i] != NULL) {
				SDE_ERROR(
					"vcm rect index must be unique! repeat: %d",
					i);
				goto end;
			}
	...
	for (i = 0; i < sde_cfg->sspp_count; ++i) {
		...
		of_property_read_string_index(
			np, sspp_prop[SSPP_TYPE].prop_name, i, &type);
		if (strcmp(type, "vig"))
			continue;
		...
		if (props[0] && props[0]->exists[VIG_TOP_OFF])
			sblk->top_off = PROP_VALUE_ACCESS(props[0]->values,
							  VIG_TOP_OFF, 0);
		else
			sblk->top_off = 0x200;
		...
		for (j = 0; j < SSPP_SUBBLK_COUNT_MAX; j++) {
			...
			if (_sde_sspp_setup_vcm(
				    sspp, props[j], "sspp_vig_fp16_igc",
				    &sblk->fp16_igc_blk[j], SDE_SSPP_FP16_IGC,
				    VIG_FP16_IGC_PROP, true))
				sblk->num_fp16_igc_blk += 1;

			if (_sde_sspp_setup_vcm(
				    sspp, props[j], "sspp_vig_fp16_gc",
				    &sblk->fp16_gc_blk[j], SDE_SSPP_FP16_GC,
				    VIG_FP16_GC_PROP, true))
				sblk->num_fp16_gc_blk += 1;

			if (_sde_sspp_setup_vcm(
				    sspp, props[j], "sspp_vig_fp16_csc",
				    &sblk->fp16_csc_blk[j], SDE_SSPP_FP16_CSC,
				    VIG_FP16_CSC_PROP, true))
			...
			if (_sde_sspp_setup_vcm(
				    sspp, props[j], "sspp_vig_ucsc_igc",
				    &sblk->ucsc_igc_blk[j], SDE_SSPP_UCSC_IGC,
				    VIG_UCSC_IGC_PROP, true))
				sblk->num_ucsc_igc_blk += 1;

			if (_sde_sspp_setup_vcm(
				    sspp, props[j], "sspp_vig_ucsc_gc",
				    &sblk->ucsc_gc_blk[j], SDE_SSPP_UCSC_GC,
				    VIG_UCSC_GC_PROP, true))
				sblk->num_ucsc_gc_blk += 1;

			if (_sde_sspp_setup_vcm(
				    sspp, props[j], "sspp_vig_ucsc_csc",
				    &sblk->ucsc_csc_blk[j], SDE_SSPP_UCSC_CSC,
				    VIG_UCSC_CSC_PROP, true))
		...
		if (props[0] &&
		    ((sde_cfg->qseed_sw_lib_rev == SDE_SSPP_SCALER_QSEED2) ||
		     (sde_cfg->qseed_sw_lib_rev == SDE_SSPP_SCALER_QSEED3) ||
		     (sde_cfg->qseed_sw_lib_rev ==
			...
			sblk->scaler_blk.regdma_base = SSPP_GET_REGDMA_BASE(
				sblk->scaler_blk.base, sblk->top_off);
		...
		if (test_bit(SDE_FEATURE_INLINE_DISABLE_CONST_CLR,
			     sde_cfg->features))
	...
	if (snp) {
		...
		if (dgm_count > 0) {
			...
			for_each_child_of_node(snp, dgm_snp) {
				props_tmp = sde_get_dt_props(
					dgm_snp, DMA_PROP_MAX, dma_prop,
					ARRAY_SIZE(dma_prop), NULL);
				if (IS_ERR(props_tmp)) {
					rc = PTR_ERR(props_tmp);
					props_tmp = NULL;
					goto end;
				} else if (!props_tmp->exists
						    [DMA_SUBBLOCK_INDEX]) {
					SDE_ERROR(
						"dgm sub-block index must be defined");
					goto end;
				}

				i = PROP_VALUE_ACCESS(props_tmp->values,
						      DMA_SUBBLOCK_INDEX, 0);
				if (i >= SSPP_SUBBLK_COUNT_MAX) {
					SDE_ERROR(
						"dgm sub-block index greater than max: %d",
						i);
					goto end;
				} else if (props[i] != NULL) {
					SDE_ERROR(
						"dgm sub-block index already defined: %d",
						i);
					goto end;
				}
		...
		for (j = 0; j < SSPP_SUBBLK_COUNT_MAX; j++) {
			...
			if (PROP_VALUE_ACCESS(props[j]->values,
				...
				if (sde_cfg->hw_rev >= SDE_HW_VER_810)
					sblk->unmult_offset[j] =
						SDE_DGM_UNMULT_2 + j * 0x1000;
				else
					sblk->unmult_offset[j] =
						SDE_DGM_UNMULT + j * 0x1000;
			}
				  ...
				  const struct sde_dt_props *props)
{
	...
	for (i = 0; i < sde_cfg->sspp_count; ++i) {
		...
		if (sde_cfg->uidle_cfg.uidle_rev) {
			...
			if (sde_cfg->uidle_cfg.uidle_rev >=
			    SDE_UIDLE_VERSION_1_0_3)
				set_bit(SDE_PERF_SSPP_UIDLE_FILL_LVL_SCALE,
					&sspp->perf_features);
		}

		if (test_bit(SDE_SYS_CACHE_DISP,
			     sde_cfg->sde_sys_cache_type_map))
		...
		if (props->exists[SSPP_MAX_PER_PIPE_BW])
			sblk->max_per_pipe_bw = PROP_VALUE_ACCESS(
				props->values, SSPP_MAX_PER_PIPE_BW, i);
		else
			sblk->max_per_pipe_bw = DEFAULT_MAX_PER_PIPE_BW;

		if (props->exists[SSPP_MAX_PER_PIPE_BW_HIGH])
			sblk->max_per_pipe_bw_high = PROP_VALUE_ACCESS(
				props->values, SSPP_MAX_PER_PIPE_BW_HIGH, i);
		else
		...
		if (SDE_HW_MAJOR(sde_cfg->hw_rev) >=
		    SDE_HW_MAJOR(SDE_HW_VER_900))
			       ...
			       struct sde_mdss_cfg *sde_cfg)
{
	...
	for (i = 0; i < off_count; i++) {
		...
		sblk->src_blk.len =
			PROP_VALUE_ACCESS(props->values, SSPP_SIZE, 0);

		if (!test_bit(SDE_FEATURE_VBIF_CLK_SPLIT, sde_cfg->features)) {
			for (j = 0; j < sde_cfg->mdp_count; j++) {
				sde_cfg->mdp[j]
					.clk_ctrls[sspp->clk_ctrl]
					.reg_off = PROP_BITVALUE_ACCESS(
					props->values, SSPP_CLK_CTRL, i, 0);
				sde_cfg->mdp[j]
					.clk_ctrls[sspp->clk_ctrl]
					.bit_off = PROP_BITVALUE_ACCESS(
					props->values, SSPP_CLK_CTRL, i, 1);
				sde_cfg->mdp[j]
					.clk_status[sspp->clk_ctrl]
					.reg_off = PROP_BITVALUE_ACCESS(
					props->values, SSPP_CLK_STATUS, i, 0);
				sde_cfg->mdp[j]
					.clk_status[sspp->clk_ctrl]
					.bit_off = PROP_BITVALUE_ACCESS(
					props->values, SSPP_CLK_STATUS, i, 1);
			}

			SDE_DEBUG("xin:%d ram:%d clk%d:%x/%d\n", sspp->xin_id,
				  sblk->pixel_ram_size, sspp->clk_ctrl,
				  sde_cfg->mdp[0]
					  .clk_ctrls[sspp->clk_ctrl]
					  .reg_off,
				  sde_cfg->mdp[0]
			    ...
			    struct sde_mdss_cfg *sde_cfg)
{
	...
	for (i = 0; i < off_count; i++) {
		...
		of_property_read_string_index(np, ctl_prop[HW_DISP].prop_name,
					      i, &disp_pref);
			      ...
			      struct sde_mdss_cfg *sde_cfg)
{
	...
	if (snp) {
		blocks_props =
			sde_get_dt_props(snp, MIXER_PROP_MAX, mixer_blocks_prop,
	...
	for (i = 0, mixer_count = 0, pp_idx = 0, dspp_idx = 0, ds_idx = 0,
		...
		lm_pair_mask =
			PROP_VALUE_ACCESS(props->values, MIXER_PAIR_MASK, i);
		if (lm_pair_mask)
		...
		for (j = 0; j < blend_off_count; j++)
			sblk->blendstage_base[j] = PROP_VALUE_ACCESS(
				blend_props->values, MIXER_BLEND_OP_OFF, j);
		...
		of_property_read_string_index(
			np, mixer_prop[MIXER_DISP].prop_name, i, &disp_pref);
		if (disp_pref && !strcmp(disp_pref, "primary"))
			set_bit(SDE_DISP_PRIMARY_PREF, &mixer->features);

		of_property_read_string_index(
			np, mixer_prop[MIXER_CWB].prop_name, i, &cwb_pref);
		if (cwb_pref && !strcmp(cwb_pref, "cwb"))
			set_bit(SDE_DISP_CWB_PREF, &mixer->features);

		of_property_read_string_index(
			np, mixer_prop[MIXER_DCWB].prop_name, i, &dcwb_pref);
		...
		mixer->pingpong = pp_count > 0 ? pp_idx + PINGPONG_0 :
						 PINGPONG_MAX;
		mixer->dspp = dspp_count > 0 ? dspp_idx + DSPP_0 : DSPP_MAX;
			     ...
			     struct sde_mdss_cfg *sde_cfg)
{
	...
	prop_value = kzalloc(INTF_PROP_MAX * sizeof(struct sde_prop_value),
			     GFP_KERNEL);
	if (!prop_value) {
		rc = -ENOMEM;
		goto end;
	...
	for (i = 0; i < off_count; i++) {
		...
		of_property_read_string_index(
			np, intf_prop[INTF_TYPE].prop_name, i, &type);
		if (!strcmp(type, "dsi")) {
			intf->type = INTF_DSI;
		...
		if (prop_exists[INTF_TE_IRQ])
			intf->te_irq_offset =
				PROP_VALUE_ACCESS(prop_value, INTF_TE_IRQ, i);
...
static int sde_wb_parse_dt(struct device_node *np, struct sde_mdss_cfg *sde_cfg)
{
	...
	prop_value = kzalloc(WB_PROP_MAX * sizeof(struct sde_prop_value),
			     GFP_KERNEL);
	if (!prop_value) {
		rc = -ENOMEM;
		goto end;
	...
	for (i = 0; i < off_count; i++) {
		...
		snprintf(wb->name, SDE_HW_BLK_NAME_LEN, "wb_%u", wb->id - WB_0);
		...
		rc = _add_to_irq_offset_list(sde_cfg, SDE_INTR_HWBLK_WB, wb->id,
					     wb->base);

		if (test_bit(SDE_FEATURE_DEDICATED_CWB, sde_cfg->features)) {
			set_bit(SDE_WB_HAS_DCWB, &wb->features);
			if (test_bit(SDE_FEATURE_DUAL_DEDICATED_CWB,
				     sde_cfg->features))
			...
			for (j = 0; j < sde_cfg->mdp_count; j++) {
				...
				sde_cfg->mdp[j].clk_ctrls[wb->clk_ctrl].bit_off =
					PROP_BITVALUE_ACCESS(prop_value,
							     WB_CLK_CTRL, i, 1);
				sde_cfg->mdp[j]
					.clk_status[wb->clk_ctrl]
					.reg_off = PROP_BITVALUE_ACCESS(
					prop_value, WB_CLK_STATUS, i, 0);
				sde_cfg->mdp[j]
					.clk_status[wb->clk_ctrl]
					.bit_off = PROP_BITVALUE_ACCESS(
					prop_value, WB_CLK_STATUS, i, 1);
			}

			SDE_DEBUG(
				"wb:%d xin:%d vbif:%d clk%d:%x/%d\n",
				wb->id - WB_0, wb->xin_id, wb->vbif_idx,
				wb->clk_ctrl,
				 ...
				 struct sde_mdss_cfg *sde_cfg)
{
	...
	prop_value = kzalloc(DSPP_TOP_PROP_MAX * sizeof(struct sde_prop_value),
			     GFP_KERNEL);
	if (!prop_value) {
		rc = -ENOMEM;
		goto end;
	...
	sde_cfg->dspp_top.base = PROP_VALUE_ACCESS(prop_value, DSPP_TOP_OFF, 0);
	sde_cfg->dspp_top.len = PROP_VALUE_ACCESS(prop_value, DSPP_TOP_SIZE, 0);
			    ...
			    struct sde_mdss_cfg *sde_cfg)
{
	...
	props = sde_get_dt_props(np, AD_PROP_MAX, ad_prop, ARRAY_SIZE(ad_prop),
				 &off_count);
	if (IS_ERR(props))
		return PTR_ERR(props);
	...
	for (i = 0; i < sde_cfg->dspp_count; i++) {
		...
		if (i < off_count) {
			sblk->ad.base =
				PROP_VALUE_ACCESS(props->values, AD_OFF, i);
			sblk->ad.version =
				PROP_VALUE_ACCESS(props->values, AD_VERSION, 0);
			set_bit(SDE_DSPP_AD, &dspp->features);
			rc = _add_to_irq_offset_list(
				sde_cfg, SDE_INTR_HWBLK_AD4, dspp->id,
				     ...
				     struct sde_mdss_cfg *sde_cfg)
{
	...
	for (i = 0; i < sde_cfg->dspp_count; i++) {
		...
		if (props->exists[DEMURA_OFF] && i < off_count) {
			sblk->demura.base =
				PROP_VALUE_ACCESS(props->values, DEMURA_OFF, i);
			sblk->demura.len =
				PROP_VALUE_ACCESS(props->values, DEMURA_LEN, 0);
			sblk->demura.version = PROP_VALUE_ACCESS(
				props->values, DEMURA_VERSION, 0);
				  ...
				  struct sde_mdss_cfg *sde_cfg)
{
	...
	for (i = 0; i < sde_cfg->dspp_count; i++) {
		...
		if (props->exists[SPR_OFF] && i < off_count) {
			sblk->spr.base =
				PROP_VALUE_ACCESS(props->values, SPR_OFF, i);
			sblk->spr.len =
				PROP_VALUE_ACCESS(props->values, SPR_LEN, 0);
			    ...
			    struct sde_mdss_cfg *sde_cfg)
{
	...
	props = sde_get_dt_props(np, RC_PROP_MAX, rc_prop, ARRAY_SIZE(rc_prop),
				 &off_count);
	if (IS_ERR(props))
		return PTR_ERR(props);
	...
	for (i = 0; i < sde_cfg->dspp_count; i++) {
		...
		if (i < off_count) {
			sblk->rc.base =
				PROP_VALUE_ACCESS(props->values, RC_OFF, i);
			sblk->rc.len =
				PROP_VALUE_ACCESS(props->values, RC_LEN, 0);
			sblk->rc.version =
				PROP_VALUE_ACCESS(props->values, RC_VERSION, 0);
				  ...
				  struct sde_mdss_cfg *sde_cfg)
{
	...
	for (i = 0; i < sde_cfg->mixer_count; i++) {
		...
		sblk->nlayer.base =
			PROP_VALUE_ACCESS(props->values, NOISE_LAYER_OFF, 0);
		sblk->nlayer.version = PROP_VALUE_ACCESS(
			props->values, NOISE_LAYER_VERSION, 0);
...
static void _sde_init_dspp_sblk(struct sde_dspp_cfg *dspp,
				struct sde_pp_blk *pp_blk, int prop_id,
				int blk_id, struct sde_dt_props *props)
{
	pp_blk->id = prop_id;
	if (props->exists[blk_id]) {
		pp_blk->base = PROP_VALUE_ACCESS(props->values, blk_id, 0);
		pp_blk->version = PROP_VALUE_ACCESS(props->values, blk_id, 1);
		pp_blk->len = 0;
				    ...
				    struct sde_mdss_cfg *sde_cfg)
{
	...
	props = sde_get_dt_props(snp, DSPP_BLOCKS_PROP_MAX, dspp_blocks_prop,
				 ARRAY_SIZE(dspp_blocks_prop), NULL);
	if (IS_ERR(props))
		return PTR_ERR(props);
	...
	for (i = 0; i < sde_cfg->dspp_count; i++) {
		...
		_sde_init_dspp_sblk(dspp, &sblk->gc, SDE_DSPP_GC, DSPP_GC_PROP,
				    props);
				  ...
				  struct sde_mdss_cfg *sde_cfg)
{
	...
	for (i = 0; i < sde_cfg->dspp_count; i++) {
		sde_cfg->dspp[i].base =
			PROP_VALUE_ACCESS(props->values, DSPP_OFF, i);
		sde_cfg->dspp[i].len =
			PROP_VALUE_ACCESS(props->values, DSPP_SIZE, 0);
...
static int sde_ds_parse_dt(struct device_node *np, struct sde_mdss_cfg *sde_cfg)
{
	...
	top_prop_value = kzalloc(
		DS_TOP_PROP_MAX * sizeof(struct sde_prop_value), GFP_KERNEL);
	if (!top_prop_value) {
		rc = -ENOMEM;
		goto end;
	}

	rc = _validate_dt_entry(np, ds_top_prop, ARRAY_SIZE(ds_top_prop),
				top_prop_count, &top_off_count);
	if (rc)
		goto end;

	rc = _read_dt_entry(np, ds_top_prop, ARRAY_SIZE(ds_top_prop),
			    top_prop_count, top_prop_exists, top_prop_value);
	if (rc)
		goto end;

	/* Parse the offset of each dest scaler block */
	prop_value =
		kcalloc(DS_PROP_MAX, sizeof(struct sde_prop_value), GFP_KERNEL);
	if (!prop_value) {
		rc = -ENOMEM;
		goto end;
	}
	...
	ds_top->maxinputwidth =
		PROP_VALUE_ACCESS(top_prop_value, DS_TOP_INPUT_LINEWIDTH, 0);
	if (!top_prop_exists[DS_TOP_INPUT_LINEWIDTH])
		ds_top->maxinputwidth = DEFAULT_SDE_LINE_WIDTH;

	ds_top->maxoutputwidth =
		PROP_VALUE_ACCESS(top_prop_value, DS_TOP_OUTPUT_LINEWIDTH, 0);
	...
	for (i = 0; i < off_count; i++) {
		...
		snprintf(ds->name, SDE_HW_BLK_NAME_LEN, "ds_%u", ds->id - DS_0);
			    ...
			    struct sde_mdss_cfg *sde_cfg)
{
	...
	prop_value = kzalloc(DSC_PROP_MAX * sizeof(struct sde_prop_value),
			     GFP_KERNEL);
	if (!prop_value)
		return -ENOMEM;
	...
	sde_cfg->max_dsc_width =
		prop_exists[DSC_LINEWIDTH] ?
	...
	for (i = 0; i < off_count; i++) {
		...
		dsc_pair_mask = PROP_VALUE_ACCESS(prop_value, DSC_PAIR_MASK, i);
		if (dsc_pair_mask)
			set_bit(dsc_pair_mask, dsc->dsc_pair_mask);

		if (dsc_rev == SDE_DSC_HW_REV_1_2) {
			sblk->enc.base =
				PROP_VALUE_ACCESS(prop_value, DSC_ENC, i);
			sblk->enc.len =
				PROP_VALUE_ACCESS(prop_value, DSC_ENC_LEN, 0);
			sblk->ctl.base =
				PROP_VALUE_ACCESS(prop_value, DSC_CTL, i);
			sblk->ctl.len =
				PROP_VALUE_ACCESS(prop_value, DSC_CTL_LEN, 0);
			set_bit(SDE_DSC_HW_REV_1_2, &dsc->features);
			if (PROP_VALUE_ACCESS(prop_value, DSC_422, i))
				set_bit(SDE_DSC_NATIVE_422_EN, &dsc->features);
			if (SDE_HW_MAJOR(sde_cfg->hw_rev) >=
			    SDE_HW_MAJOR(SDE_HW_VER_900))
			    ...
			    struct sde_mdss_cfg *sde_cfg)
{
	...
	prop_value = kzalloc(VDC_PROP_MAX * sizeof(struct sde_prop_value),
			     GFP_KERNEL);
	if (!prop_value) {
		rc = -ENOMEM;
		goto end;
	...
	for (i = 0; i < off_count; i++) {
		...
		sblk->enc.base = PROP_VALUE_ACCESS(prop_value, VDC_ENC, i);
		sblk->enc.len = PROP_VALUE_ACCESS(prop_value, VDC_ENC_LEN, 0);
		sblk->ctl.base = PROP_VALUE_ACCESS(prop_value, VDC_CTL, i);
		sblk->ctl.len = PROP_VALUE_ACCESS(prop_value, VDC_CTL_LEN, 0);
			    ...
			    struct sde_mdss_cfg *sde_cfg)
{
	...
	prop_value = kzalloc(HW_PROP_MAX * sizeof(struct sde_prop_value),
			     GFP_KERNEL);
	if (!prop_value) {
		rc = -ENOMEM;
		goto end;
...
static int sde_dnsc_blur_parse_dt(struct device_node *np,
				  struct sde_mdss_cfg *sde_cfg)
{
	...
	prop_value = kzalloc(DNSC_BLUR_PROP_MAX * sizeof(struct sde_prop_value),
			     GFP_KERNEL);
	if (!prop_value) {
		rc = -ENOMEM;
		goto end;
	...
	rc = _read_dt_entry(np, dnsc_blur_prop, ARRAY_SIZE(dnsc_blur_prop),
			    prop_count, prop_exists, prop_value);
	if (rc)
		goto end;
	...
	for (i = 0; i < sde_cfg->dnsc_blur_count; i++) {
		...
		dnsc_blur->base =
			PROP_VALUE_ACCESS(prop_value, DNSC_BLUR_OFF, i);
		dnsc_blur->id = DNSC_BLUR_0 + i;
		dnsc_blur->len =
			PROP_VALUE_ACCESS(prop_value, DNSC_BLUR_LEN, 0);
		snprintf(dnsc_blur->name, SDE_HW_BLK_NAME_LEN, "dnsc_blur_%u",
			 dnsc_blur->id - DNSC_BLUR_0);
		sde_cfg->dnsc_blur_rev =
			PROP_VALUE_ACCESS(prop_value, DNSC_BLUR_VERSION, 0);

		sblk->gaus_lut.base = PROP_VALUE_ACCESS(
			prop_value, DNSC_BLUR_GAUS_LUT_OFF, i);
		sblk->gaus_lut.len = PROP_VALUE_ACCESS(
			prop_value, DNSC_BLUR_GAUS_LUT_LEN, 0);
		snprintf(sblk->gaus_lut.name, SDE_HW_BLK_NAME_LEN,
			 "dnsc_blur_lut_%u", dnsc_blur->id - DNSC_BLUR_0);

		sblk->dither.base =
			PROP_VALUE_ACCESS(prop_value, DNSC_BLUR_DITHER_OFF, i);
		sblk->dither.len =
			PROP_VALUE_ACCESS(prop_value, DNSC_BLUR_DITHER_LEN, 0);
		snprintf(sblk->dither.name, SDE_HW_BLK_NAME_LEN,
			 "dnsc_blur_dit_%u", dnsc_blur->id - DNSC_BLUR_0);
			      ...
			      struct sde_mdss_cfg *sde_cfg)
{
	...
	prop_value = kcalloc(UIDLE_PROP_MAX, sizeof(struct sde_prop_value),
			     GFP_KERNEL);
	if (!prop_value)
		return -ENOMEM;
	...
	sde_cfg->uidle_cfg.base = PROP_VALUE_ACCESS(prop_value, UIDLE_OFF, 0);
	sde_cfg->uidle_cfg.len = PROP_VALUE_ACCESS(prop_value, UIDLE_LEN, 0);
			      ...
			      struct sde_mdss_cfg *sde_cfg)
{
	...
	for (i = 0; i < SDE_SYS_CACHE_MAX; i++) {
		...
		SDE_DEBUG(
			...
			i, usecase_id, sc_cfg->llcc_scid,
			sc_cfg->llcc_slice_size);
	}
					 ...
					 int *prop_count)
{
	...
	vbif->default_ot_rd_limit =
		PROP_VALUE_ACCESS(prop_value, VBIF_DEFAULT_OT_RD_LIMIT, 0);
	SDE_DEBUG("default_ot_rd_limit=%u\n", vbif->default_ot_rd_limit);

	vbif->default_ot_wr_limit =
		PROP_VALUE_ACCESS(prop_value, VBIF_DEFAULT_OT_WR_LIMIT, 0);
	...
	if (vbif->dynamic_ot_rd_tbl.count) {
		vbif->dynamic_ot_rd_tbl.cfg = kcalloc(
			vbif->dynamic_ot_rd_tbl.count,
			sizeof(struct sde_vbif_dynamic_ot_cfg), GFP_KERNEL);
		if (!vbif->dynamic_ot_rd_tbl.cfg)
			return -ENOMEM;
	}

	for (j = 0, k = 0; j < vbif->dynamic_ot_rd_tbl.count; j++) {
		vbif->dynamic_ot_rd_tbl.cfg[j].pps = (u64)PROP_VALUE_ACCESS(
			prop_value, VBIF_DYNAMIC_OT_RD_LIMIT, k++);
		vbif->dynamic_ot_rd_tbl.cfg[j].ot_limit = PROP_VALUE_ACCESS(
			prop_value, VBIF_DYNAMIC_OT_RD_LIMIT, k++);
	...
	for (j = 0, k = 0; j < vbif->dynamic_ot_wr_tbl.count; j++) {
		vbif->dynamic_ot_wr_tbl.cfg[j].pps = (u64)PROP_VALUE_ACCESS(
			prop_value, VBIF_DYNAMIC_OT_WR_LIMIT, k++);
		vbif->dynamic_ot_wr_tbl.cfg[j].ot_limit = PROP_VALUE_ACCESS(
			prop_value, VBIF_DYNAMIC_OT_WR_LIMIT, k++);
	...
	if (vbif->default_ot_rd_limit || vbif->default_ot_wr_limit ||
	    vbif->dynamic_ot_rd_tbl.count || vbif->dynamic_ot_wr_tbl.count)
					  ...
					  int *prop_count)
{
	...
	for (i = VBIF_RT_CLIENT;
		...
		if (vbif->qos_tbl[i].count == entries) {
			vbif->qos_tbl[i].priority_lvl =
				kcalloc(entries, sizeof(u32), GFP_KERNEL);
			      ...
			      int *prop_count, u32 vbif_len, int i)
{
	...
	snprintf(vbif->name, SDE_HW_BLK_NAME_LEN, "vbif_%u", vbif->id - VBIF_0);
	...
	vbif->memtype_count =
		prop_count[VBIF_MEMTYPE_0] + prop_count[VBIF_MEMTYPE_1];
	...
	for (j = 0, k = 0; j < prop_count[VBIF_MEMTYPE_0]; j++)
		vbif->memtype[k++] =
			PROP_VALUE_ACCESS(prop_value, VBIF_MEMTYPE_0, j);
	for (j = 0; j < prop_count[VBIF_MEMTYPE_1]; j++)
		vbif->memtype[k++] =
			PROP_VALUE_ACCESS(prop_value, VBIF_MEMTYPE_1, j);
			     ...
			     struct sde_mdss_cfg *sde_cfg)
{
	...
	prop_value = kzalloc(VBIF_PROP_MAX * sizeof(struct sde_prop_value),
			     GFP_KERNEL);
	if (!prop_value) {
		rc = -ENOMEM;
		goto end;
	...
	for (i = 0; i < off_count; i++) {
		rc = _sde_vbif_populate(sde_cfg, vbif, prop_value, prop_count,
					vbif_len, i);
		if (rc)
			goto end;
	}
...
static int sde_pp_parse_dt(struct device_node *np, struct sde_mdss_cfg *sde_cfg)
{
	...
	prop_value = kzalloc(PP_PROP_MAX * sizeof(struct sde_prop_value),
			     GFP_KERNEL);
	if (!prop_value) {
		rc = -ENOMEM;
		goto end;
	...
	for (i = 0; i < off_count; i++) {
		...
		if (PROP_VALUE_ACCESS(prop_value, PP_CWB, i)) {
			...
			if (test_bit(SDE_FEATURE_DEDICATED_CWB,
				     sde_cfg->features))
				sde_cfg->dcwb_count++;
		}
		pp->dcwb_id = (sde_cfg->dcwb_count > 0) ? sde_cfg->dcwb_count :
							  DCWB_MAX;

		if (major_version < SDE_HW_MAJOR(SDE_HW_VER_700)) {
			sblk->dsc.base =
				PROP_VALUE_ACCESS(prop_value, DSC_OFF, i);
			if (sblk->dsc.base) {
				sblk->dsc.id = SDE_PINGPONG_DSC;
				snprintf(sblk->dsc.name, SDE_HW_BLK_NAME_LEN,
					 "dsc_%u", pp->id - PINGPONG_0);
		...
		sblk->dither.base =
			PROP_VALUE_ACCESS(prop_value, DITHER_OFF, i);
		if (sblk->dither.base) {
		...
		sblk->dither.version =
			PROP_VALUE_ACCESS(prop_value, DITHER_VER, 0);
				     ...
				     struct sde_dt_props *props)
{
	...
	cfg->max_sspp_linewidth =
		props->exists[SSPP_LINEWIDTH] ?
	...
	cfg->scaling_linewidth =
		props->exists[SCALING_LINEWIDTH] ?
			PROP_VALUE_ACCESS(props->values, SCALING_LINEWIDTH, 0) :
			cfg->vig_sspp_linewidth;

	cfg->max_wb_linewidth =
		props->exists[WB_LINEWIDTH] ?
			PROP_VALUE_ACCESS(props->values, WB_LINEWIDTH, 0) :
			DEFAULT_SDE_LINE_WIDTH;

	/* if wb linear width is not defined use the line width as default */
	cfg->max_wb_linewidth_linear =
		props->exists[WB_LINEWIDTH_LINEAR] ?
			PROP_VALUE_ACCESS(props->values, WB_LINEWIDTH_LINEAR,
					  0) :
			cfg->max_wb_linewidth;

	cfg->max_mixer_width =
		props->exists[MIXER_LINEWIDTH] ?
			PROP_VALUE_ACCESS(props->values, MIXER_LINEWIDTH, 0) :
			DEFAULT_SDE_LINE_WIDTH;

	cfg->max_mixer_blendstages =
		props->exists[MIXER_BLEND] ?
			PROP_VALUE_ACCESS(props->values, MIXER_BLEND, 0) :
			DEFAULT_SDE_MIXER_BLENDSTAGES;

	cfg->ubwc_rev =
		props->exists[UBWC_VERSION] ?
			PROP_VALUE_ACCESS(props->values, UBWC_VERSION, 0) :
			DEFAULT_SDE_UBWC_NONE;

	cfg->mdp[0].highest_bank_bit = DEFAULT_SDE_HIGHEST_BANK_BIT;

	if (props->exists[BANK_BIT]) {
		for (i = 0; i < props->counts[BANK_BIT]; i++) {
			ddr_type = PROP_BITVALUE_ACCESS(props->values, BANK_BIT,
							i, 0);
	...
	cfg->ipcc_protocol_id =
		PROP_VALUE_ACCESS(props->values, IPCC_PROTOCOL_ID, 0);
	cfg->ipcc_client_phys_id =
		PROP_VALUE_ACCESS(props->values, IPCC_CLIENT_DPU_PHYS_ID, 0);
	...
	if (props->exists[SEC_SID_MASK]) {
		...
		for (i = 0; i < cfg->sec_sid_mask_count; i++)
			cfg->sec_sid_mask[i] = PROP_VALUE_ACCESS(
				props->values, SEC_SID_MASK, i);
	}
	...
	cfg->pipe_order_type =
		PROP_VALUE_ACCESS(props->values, PIPE_ORDER_VERSION, 0);
	if (PROP_VALUE_ACCESS(props->values, BASE_LAYER, 0))
		set_bit(SDE_FEATURE_BASE_LAYER, cfg->features);
	cfg->qseed_hw_rev =
		PROP_VALUE_ACCESS(props->values, QSEED_HW_VERSION, 0);
	cfg->trusted_vm_env =
		PROP_VALUE_ACCESS(props->values, TRUSTED_VM_ENV, 0);
	cfg->max_trusted_vm_displays =
		PROP_VALUE_ACCESS(props->values, MAX_TRUSTED_VM_DISPLAYS, 0);
	if (props->exists[TVM_INCLUDE_REG]) {
		cfg->tvm_reg_count = props->counts[TVM_INCLUDE_REG] / 2;
		for (i = 0; i < cfg->tvm_reg_count; i++) {
			cfg->tvm_reg[i].start = PROP_VALUE_ACCESS(
				props->values, TVM_INCLUDE_REG, i * 2);
...
static int sde_top_parse_dt(struct device_node *np, struct sde_mdss_cfg *cfg)
{
	...
	cfg->mdp[0].len = props->exists[SDE_LEN] ?
				  PROP_VALUE_ACCESS(props->values, SDE_LEN, 0) :
				  DEFAULT_SDE_HW_BLOCK_LEN;
	...
	rc = _add_to_irq_offset_list(cfg, SDE_INTR_HWBLK_TOP, SDE_INTR_TOP_INTR,
				     cfg->mdp[0].base);
	if (rc)
		goto end;
				...
				struct sde_mdss_cfg *sde_cfg)
{
	...
	prop_value = kcalloc(REG_DMA_PROP_MAX, sizeof(struct sde_prop_value),
			     GFP_KERNEL);
	if (!prop_value) {
		rc = -ENOMEM;
		goto end;
	...
	sde_cfg->dma_cfg.version =
		PROP_VALUE_ACCESS(prop_value, REG_DMA_VERSION, 0);
	sde_cfg->dma_cfg.trigger_sel_off =
		PROP_VALUE_ACCESS(prop_value, REG_DMA_TRIGGER_OFF, 0);
	sde_cfg->dma_cfg.broadcast_disabled =
		PROP_VALUE_ACCESS(prop_value, REG_DMA_BROADCAST_DISABLED, 0);
	sde_cfg->dma_cfg.xin_id =
		PROP_VALUE_ACCESS(prop_value, REG_DMA_XIN_ID, 0);
	...
	if (test_bit(SDE_FEATURE_VBIF_CLK_SPLIT, sde_cfg->features)) {
		...
		for (i = 0; i < sde_cfg->mdp_count; i++) {
			sde_cfg->mdp[i]
				.clk_ctrls[sde_cfg->dma_cfg.clk_ctrl]
				.reg_off = PROP_BITVALUE_ACCESS(
				prop_value, REG_DMA_CLK_CTRL, 0, 0);
			sde_cfg->mdp[i]
				.clk_ctrls[sde_cfg->dma_cfg.clk_ctrl]
				.bit_off = PROP_BITVALUE_ACCESS(
				prop_value, REG_DMA_CLK_CTRL, 0, 1);
		}
	}
end:
	kfree(prop_value);
				 ...
				 bool *prop_exists)
{
	...
	if (prop_exists[QOS_REFRESH_RATES]) {
		...
		cfg->perf.qos_refresh_rate =
			kcalloc(qos_count, sizeof(u32), GFP_KERNEL);
		if (!cfg->perf.qos_refresh_rate)
			goto end;

		for (j = 0; j < qos_count; j++) {
			cfg->perf.qos_refresh_rate[j] = PROP_VALUE_ACCESS(
				prop_value, QOS_REFRESH_RATES, j);
	...
	cfg->perf.danger_lut = kcalloc(qos_count,
				       sizeof(u64) * SDE_QOS_LUT_USAGE_MAX *
	...
	if (prop_exists[QOS_DANGER_LUT] &&
		...
		for (i = 0; i < prop_count[QOS_DANGER_LUT]; i++) {
			cfg->perf.danger_lut[i] = PROP_VALUE_ACCESS(
				prop_value, QOS_DANGER_LUT, i);
	...
	if (prop_exists[QOS_SAFE_LUT] &&
		...
		for (i = 0; i < prop_count[QOS_SAFE_LUT]; i++) {
			cfg->perf.safe_lut[i] =
				PROP_VALUE_ACCESS(prop_value, QOS_SAFE_LUT, i);
	...
	if (prop_exists[QOS_CREQ_LUT] &&
		...
		for (j = 0; j < (qos_count * SDE_QOS_LUT_USAGE_MAX *
				 SDE_CREQ_LUT_TYPE_MAX);
		     j++) {
			lut_hi = PROP_VALUE_ACCESS(prop_value, QOS_CREQ_LUT,
						   (j * 2) + 0);
			lut_lo = PROP_VALUE_ACCESS(prop_value, QOS_CREQ_LUT,
						   (j * 2) + 1);
					    ...
					    bool *prop_exists)
{
	...
	cfg->perf.xtra_prefill_lines =
		prop_exists[PERF_XTRA_PREFILL_LINES] ?
			PROP_VALUE_ACCESS(prop_value, PERF_XTRA_PREFILL_LINES,
					  0) :
	...
	cfg->perf.linear_prefill_lines =
		prop_exists[PERF_LINEAR_PREFILL_LINES] ?
			PROP_VALUE_ACCESS(prop_value, PERF_LINEAR_PREFILL_LINES,
					  0) :
	...
	cfg->perf.num_ddr_channels =
		prop_exists[PERF_NUM_DDR_CHANNELS] ?
			PROP_VALUE_ACCESS(prop_value, PERF_NUM_DDR_CHANNELS,
					  0) :
			DEFAULT_NUM_DDR_CHANNELS;
	cfg->perf.dram_efficiency =
		prop_exists[PERF_DRAM_EFFICIENCY] ?
	...
	cfg->perf.num_mnoc_ports =
		prop_exists[PERF_NUM_MNOC_PORTS] ?
			PROP_VALUE_ACCESS(prop_value, PERF_NUM_MNOC_PORTS, 0) :
			DEFAULT_MNOC_PORTS;
	cfg->perf.axi_bus_width =
		prop_exists[PERF_AXI_BUS_WIDTH] ?
			PROP_VALUE_ACCESS(prop_value, PERF_AXI_BUS_WIDTH, 0) :
			DEFAULT_AXI_BUS_WIDTH;
}

/**
 * _sde_set_possible_cpu_mask - checks defective cores in qos mask and update
 * the mask to avoid defective cores and add next possible cores for pm qos
 * vote.
...
static int _sde_set_possible_cpu_mask(unsigned long qos_mask)
{
	...
	for_each_cpu(cpu, cpu_all_mask) {
		...
		} else if (cpumask_test_cpu(cpu, cpu_qos_mask) &&
			   !cpu_possible(cpu)) {
				  ...
				  bool *prop_exists)
{
   ...
   */
	rc = of_property_read_string(
		np, sde_perf_prop[PERF_CORE_IB_FF].prop_name, &str);
	cfg->perf.core_ib_ff = rc ? DEFAULT_CORE_IB_FF : str;
	rc = of_property_read_string(
		np, sde_perf_prop[PERF_CORE_CLK_FF].prop_name, &str);
	cfg->perf.core_clk_ff = rc ? DEFAULT_CORE_CLK_FF : str;
	rc = of_property_read_string(
		np, sde_perf_prop[PERF_COMP_RATIO_RT].prop_name, &str);
	cfg->perf.comp_ratio_rt = rc ? DEFAULT_COMP_RATIO_RT : str;
	rc = of_property_read_string(
		np, sde_perf_prop[PERF_COMP_RATIO_NRT].prop_name, &str);
	...
	if (prop_exists[PERF_CDP_SETTING]) {
		...
		for (j = 0; j < count; j++) {
			cfg->perf.cdp_cfg[j].rd_enable = PROP_VALUE_ACCESS(
				prop_value, PERF_CDP_SETTING, j * prop_size);
			cfg->perf.cdp_cfg[j].wr_enable =
				PROP_VALUE_ACCESS(prop_value, PERF_CDP_SETTING,
						  j * prop_size + 1);
...
static int sde_perf_parse_dt(struct device_node *np, struct sde_mdss_cfg *cfg)
{
	...
	prop_value = kzalloc(PERF_PROP_MAX * sizeof(struct sde_prop_value),
			     GFP_KERNEL);
	if (!prop_value) {
		rc = -ENOMEM;
		goto end;
...
static int sde_qos_parse_dt(struct device_node *np, struct sde_mdss_cfg *cfg)
{
	...
	prop_value = kzalloc(QOS_PROP_MAX * sizeof(struct sde_prop_value),
			     GFP_KERNEL);
	if (!prop_value) {
		rc = -ENOMEM;
		goto end;
				 ...
				 struct sde_mdss_cfg *sde_cfg)
{
	...
	prop_value =
		kcalloc(HW_PROP_MAX, sizeof(struct sde_prop_value), GFP_KERNEL);
	if (!prop_value)
		return -ENOMEM;
				    ...
				    uint32_t hw_rev)
{
	...
	sde_cfg->dma_formats = kcalloc(
		dma_list_size, sizeof(struct sde_format_extended), GFP_KERNEL);
	if (!sde_cfg->dma_formats) {
		rc = -ENOMEM;
		goto out;
	}

	index = sde_copy_formats(sde_cfg->dma_formats, dma_list_size, 0,
	...
	sde_cfg->vig_formats = kcalloc(
		vig_list_size, sizeof(struct sde_format_extended), GFP_KERNEL);
	if (!sde_cfg->vig_formats) {
		rc = -ENOMEM;
		goto free_dma;
	}

	index = sde_copy_formats(sde_cfg->vig_formats, vig_list_size, 0,
				 plane_formats_vig,
				 ARRAY_SIZE(plane_formats_vig));
	if (test_bit(SDE_FEATURE_VIG_P010, sde_cfg->features))
		index += sde_copy_formats(sde_cfg->vig_formats, vig_list_size,
					  index, p010_ubwc_formats,
	...
	if (test_bit(SDE_FEATURE_FP16, sde_cfg->features))
		index += sde_copy_formats(sde_cfg->virt_vig_formats,
					  virt_vig_list_size, index,
					  fp16_formats,
					  ARRAY_SIZE(fp16_formats));

	/* WB output formats */
	wb2_list_size = ARRAY_SIZE(wb2_formats);
	sde_cfg->wb_formats = kcalloc(
		wb2_list_size, sizeof(struct sde_format_extended), GFP_KERNEL);
	...
	index = sde_copy_formats(sde_cfg->wb_formats, wb2_list_size, 0,
				 wb2_formats, ARRAY_SIZE(wb2_formats));
	...
	if (IS_SDE_INLINE_ROT_REV_100(sde_cfg->true_inline_rot_rev)) {
		...
		inline_restricted_fmt_tbl =
			true_inline_rot_v201_restricted_fmts;
		in_rot_restricted_list_size =
			ARRAY_SIZE(true_inline_rot_v201_fmts);
	}

	if (in_rot_list_size) {
		sde_cfg->inline_rot_formats =
		...
		index = sde_copy_formats(sde_cfg->inline_rot_formats,
					 in_rot_list_size, 0, inline_fmt_tbl,
					 in_rot_list_size);
	}

	if (in_rot_restricted_list_size) {
		sde_cfg->inline_rot_restricted_formats =
			kcalloc(in_rot_restricted_list_size,
				sizeof(struct sde_format_extended), GFP_KERNEL);
		if (!sde_cfg->inline_rot_restricted_formats) {
			SDE_ERROR(
				"failed to alloc inline rot restricted format list\n");
			rc = -ENOMEM;
			goto free_in_rot;
		}

		index = sde_copy_formats(sde_cfg->inline_rot_restricted_formats,
					 in_rot_restricted_list_size, 0,
					 inline_restricted_fmt_tbl,
					 in_rot_restricted_list_size);
	}
...
static void _sde_hw_setup_uidle(struct sde_uidle_cfg *uidle_cfg)
{
	...
	if (IS_SDE_UIDLE_REV_100(uidle_cfg->uidle_rev)) {
		...
		uidle_cfg->fal10_threshold = SDE_UIDLE_FAL10_THRESHOLD_90;
		...
		uidle_cfg->max_fal1_fps = SDE_UIDLE_MAX_FPS_240;
		uidle_cfg->fal1_max_threshold =
			SDE_UIDLE_FAL1_MAX_THRESHOLD_EXT_REV_103;
		uidle_cfg->fal10_threshold = SDE_UIDLE_FAL10_THRESHOLD_60;
		...
		uidle_cfg->max_fal1_fps = SDE_UIDLE_MAX_FPS_240;
		uidle_cfg->fal1_max_threshold =
			SDE_UIDLE_FAL1_MAX_THRESHOLD_EXT_REV_104;
		uidle_cfg->fal10_threshold = SDE_UIDLE_FAL10_THRESHOLD_60;
...
static int _sde_hardware_pre_caps(struct sde_mdss_cfg *sde_cfg, uint32_t hw_rev)
{
	...
	/* Set target specific value based on sytems recommendation if not same as
   * default value */
	...
	if (IS_MSM8996_TARGET(hw_rev)) {
		...
		set_bit(SDE_FEATURE_INLINE_DISABLE_CONST_CLR,
			sde_cfg->features);
		...
		set_bit(SDE_MDP_PERIPH_TOP_0_REMOVED,
...
static int _sde_hw_dnsc_blur_filter_caps(struct sde_mdss_cfg *sde_cfg)
{
	...
	if (filters) {
		sde_cfg->dnsc_blur_filters =
			kcalloc(size, sizeof(struct sde_dnsc_blur_filter_info),
				GFP_KERNEL);
				   ...
				   uint32_t hw_rev)
{
	...
	if (max_horz_deci)
		sde_cfg->max_display_width =
			sde_cfg->max_sspp_linewidth * max_horz_deci;
	else
		sde_cfg->max_display_width =
			sde_cfg->max_sspp_linewidth * MAX_DOWNSCALE_RATIO;
	...
	if (max_vert_deci)
		...
		sde_cfg->max_display_height =
			MAX_DISPLAY_HEIGHT_WITH_DECIMATION *
			MAX_DOWNSCALE_RATIO;
			       ...
			       struct sde_mdss_cfg *cfg)
{
	...
	prop_value = kzalloc(SDE_HW_PROP_MAX * sizeof(struct sde_prop_value),
			     GFP_KERNEL);
	if (!prop_value)
		return -ENOMEM;
	...
	if (prop_exists[SDE_HW_FENCE_VERSION])
		cfg->hw_fence_rev =
			PROP_VALUE_ACCESS(prop_value, SDE_HW_FENCE_VERSION, 0);
	else
		cfg->hw_fence_rev = 0; /* disable hw-fences */
