...
int32_t dsi_phy_hw_v4_0_calc_clk_trail_rec_min(s64 temp_mul, s64 frac, s64 mult)
{
				   ...
				   struct phy_timing_desc *desc)
{
	...
	t->rec_max = (div_s64(rec_temp1, (8 * clk_params->tlpx_numer_ns))) - 1;
}
					  ...
					  u32 phy_type)
{
	...
	DSI_DEBUG("[%d %d %d %d]\n", timing->lane_v4[0], timing->lane_v4[1],
		  timing->lane_v4[2], timing->lane_v4[3]);
	DSI_DEBUG("[%d %d %d %d]\n", timing->lane_v4[4], timing->lane_v4[5],
		  timing->lane_v4[6], timing->lane_v4[7]);
	DSI_DEBUG("[%d %d %d %d]\n", timing->lane_v4[8], timing->lane_v4[9],
		  timing->lane_v4[10], timing->lane_v4[11]);
