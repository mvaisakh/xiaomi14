...
static struct wcd_mbhc_register wcd_mbhc_registers[WCD_MBHC_REG_FUNC_MAX] = {
	WCD_MBHC_REGISTER("WCD_MBHC_L_DET_EN", AQT1000_ANA_MBHC_MECH, 0x80, 7,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_GND_DET_EN", AQT1000_ANA_MBHC_MECH, 0x40, 6,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_MECH_DETECTION_TYPE", AQT1000_ANA_MBHC_MECH,
			  0x20, 5, 0),
	...
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_PLUG_TYPE", AQT1000_ANA_MBHC_MECH,
			  0x10, 4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_GND_PLUG_TYPE", AQT1000_ANA_MBHC_MECH, 0x08,
			  3, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_SW_HPH_LP_100K_TO_GND",
			  AQT1000_ANA_MBHC_MECH, 0x01, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ELECT_SCHMT_ISRC", AQT1000_ANA_MBHC_ELECT,
			  0x06, 1, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_FSM_EN", AQT1000_ANA_MBHC_ELECT, 0x80, 7,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_INSREM_DBNC",
			  AQT1000_MBHC_NEW_PLUG_DETECT_CTL, 0x0F, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_BTN_DBNC", AQT1000_MBHC_NEW_CTL_1, 0x03, 0,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_HS_VREF", AQT1000_MBHC_NEW_CTL_2, 0x03, 0,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_HS_COMP_RESULT", AQT1000_ANA_MBHC_RESULT_3,
			  0x08, 3, 0),
	...
	WCD_MBHC_REGISTER("WCD_MBHC_OCP_FSM_EN", AQT1000_HPH_OCP_CTL, 0x10, 4,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_BTN_RESULT", AQT1000_ANA_MBHC_RESULT_3,
			  0x07, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_BTN_ISRC_CTL", AQT1000_ANA_MBHC_ELECT, 0x70,
			  4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ELECT_RESULT", AQT1000_ANA_MBHC_RESULT_3,
			  0xFF, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_MICB_CTRL", AQT1000_ANA_MICB1, 0xC0, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPH_CNP_WG_TIME", AQT1000_HPH_CNP_WG_TIME,
			  0xFF, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHR_PA_EN", AQT1000_ANA_HPH, 0x40, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_PA_EN", AQT1000_ANA_HPH, 0x80, 7, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPH_PA_EN", AQT1000_ANA_HPH, 0xC0, 6, 0),
	...
	WCD_MBHC_REGISTER("WCD_MBHC_ANC_DET_EN", AQT1000_MBHC_CTL_BCS, 0x02, 1,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_FSM_STATUS", AQT1000_MBHC_NEW_FSM_STATUS,
			  0x01, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_MUX_CTL", AQT1000_MBHC_NEW_CTL_2, 0x70, 4,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_OCP_DET_EN", AQT1000_HPH_L_TEST, 0x01,
			  0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHR_OCP_DET_EN", AQT1000_HPH_R_TEST, 0x01,
			  0, 0),
	...
	WCD_MBHC_REGISTER("WCD_MBHC_ADC_EN", AQT1000_MBHC_NEW_CTL_1, 0x08, 3,
			  0),
	...
	WCD_MBHC_REGISTER("WCD_MBHC_ADC_MODE", AQT1000_MBHC_NEW_CTL_1, 0x10, 4,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_DETECTION_DONE", AQT1000_MBHC_NEW_CTL_1,
			  0x04, 2, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ELECT_ISRC_EN", AQT1000_ANA_MBHC_ZDET, 0x02,
			  1, 0),
};
...
static int aqt_mbhc_request_irq(struct snd_soc_component *component, int irq,
...
static void aqt_mbhc_irq_control(struct snd_soc_component *component, int irq,
				 bool enable)
{
	struct aqt1000 *aqt = dev_get_drvdata(component->dev);
...
static int aqt_mbhc_free_irq(struct snd_soc_component *component, int irq,
			     void *data)
{
	struct aqt1000 *aqt = dev_get_drvdata(component->dev);
...
static void aqt_mbhc_clk_setup(struct snd_soc_component *component, bool enable)
{
	if (enable)
		snd_soc_component_update_bits(component, AQT1000_MBHC_NEW_CTL_1,
					      0x80, 0x80);
	else
		snd_soc_component_update_bits(component, AQT1000_MBHC_NEW_CTL_1,
					      0x80, 0x00);
...
{
	return snd_soc_component_read32(component, AQT1000_ANA_MBHC_RESULT_3) &
	       0x7;
}
...
{
	if (enable)
		snd_soc_component_update_bits(component, AQT1000_ANA_MBHC_ELECT,
					      0x01, 0x01);
	else
		snd_soc_component_update_bits(component, AQT1000_ANA_MBHC_ELECT,
					      0x01, 0x00);
				     ...
				     bool is_micbias)
{
	...
	for (i = 0; i < num_btn; i++) {
		...
		snd_soc_component_update_bits(
			component, AQT1000_ANA_MBHC_BTN0 + i, 0xFC, vth << 2);
				      ...
				      bool enable)
{
	...
	if (enable)
		...
		return blocking_notifier_chain_unregister(&aqt_mbhc->notifier,
							  nblock);
}
...
{
	if (enable) {
		snd_soc_component_update_bits(component, AQT1000_ANA_MICB1_RAMP,
					      0x1C, 0x0C);
		snd_soc_component_update_bits(component, AQT1000_ANA_MICB1_RAMP,
					      0x80, 0x80);
	} else {
...
static int aqt_mbhc_micb_ctrl_threshold_mic(struct snd_soc_component *component,
...
static inline void aqt_mbhc_get_result_params(struct aqt1000 *aqt, s16 *d1_a,
					      u16 noff, int32_t *zdet)
{
	int i;
	int val, val1;
	s16 c1;
...
ramp_down:
	i = 0;
	while (x1) {
		regmap_bulk_read(aqt->regmap, AQT1000_ANA_MBHC_RESULT_1,
				 (u8 *)&val, 2);
		x1 = AQT_MBHC_GET_X1(val);
		i++;
			       ...
			       int32_t *zl, int32_t *zr, s16 *d1_a)
{
	...
	snd_soc_component_update_bits(component, AQT1000_ANA_MBHC_BTN5, 0xFC,
				      zdet_param->btn5);
	snd_soc_component_update_bits(component, AQT1000_ANA_MBHC_BTN6, 0xFC,
				      zdet_param->btn6);
	snd_soc_component_update_bits(component, AQT1000_ANA_MBHC_BTN7, 0xFC,
				      zdet_param->btn7);
	snd_soc_component_update_bits(component, AQT1000_MBHC_NEW_ZDET_ANA_CTL,
	...
	regmap_update_bits(aqt->regmap, AQT1000_ANA_MBHC_ZDET, 0x80, 0x80);
	dev_dbg(aqt->dev, "%s: ramp for HPH_L, noff = %d\n", __func__,
		zdet_param->noff);
	aqt_mbhc_get_result_params(aqt, d1_a, zdet_param->noff, &zdet);
	regmap_update_bits(aqt->regmap, AQT1000_ANA_MBHC_ZDET, 0x80, 0x00);
...
z_right:
	...
	regmap_update_bits(aqt->regmap, AQT1000_ANA_MBHC_ZDET, 0x40, 0x40);
	dev_dbg(aqt->dev, "%s: ramp for HPH_R, noff = %d\n", __func__,
		zdet_param->noff);
	aqt_mbhc_get_result_params(aqt, d1_a, zdet_param->noff, &zdet);
	regmap_update_bits(aqt->regmap, AQT1000_ANA_MBHC_ZDET, 0x40, 0x00);
					  ...
					  int32_t *z_val, int flag_l_r)
{
	...
	if (*z_val < (AQT_ZDET_VAL_400 / 1000))
		q1 = snd_soc_component_read32(component,
					      AQT1000_CHIP_CFG0_EFUSE_VAL_OUT1 +
						      (2 * flag_l_r));
	else
		q1 = snd_soc_component_read32(component,
					...
					uint32_t *zr)
{
	...
	if (snd_soc_component_read32(component, AQT1000_ANA_MBHC_ELECT) &
	    0x80) {
		is_fsm_disable = true;
		regmap_update_bits(aqt->regmap, AQT1000_ANA_MBHC_ELECT, 0x80,
				   0x00);
	}

	/* For NO-jack, disable L_DET_EN before Z-det measurements */
	if (mbhc->hphl_swh)
		regmap_update_bits(aqt->regmap, AQT1000_ANA_MBHC_MECH, 0x80,
				   0x00);

	/* Turn off 100k pull down on HPHL */
	regmap_update_bits(aqt->regmap, AQT1000_ANA_MBHC_MECH, 0x01, 0x00);
...
left_ch_impedance:
	if ((z1L == AQT_ZDET_FLOATING_IMPEDANCE) || (z1L > AQT_ZDET_VAL_100K)) {
...
right_ch_impedance:
	...
	snd_soc_component_update_bits(component, AQT1000_HPH_R_ATEST, 0x02,
				      0x02);
	snd_soc_component_update_bits(component, AQT1000_HPH_PA_CTL2, 0x40,
				      0x01);
...
zdet_complete:
	...
	regmap_update_bits(aqt->regmap, AQT1000_ANA_MBHC_MECH, 0x01, 0x01);
	...
	snd_soc_component_write(component, AQT1000_MBHC_NEW_ZDET_ANA_CTL, reg4);
...
static void aqt_mbhc_moisture_config(struct wcd_mbhc *mbhc)
{
	...
	snd_soc_component_update_bits(component, AQT1000_MBHC_NEW_CTL_2, 0x0C,
				      mbhc->moist_rref << 2);
}
...
static const struct snd_kcontrol_new hph_type_detect_controls[] = {
	SOC_SINGLE_EXT("HPH Type", 0, 0, UINT_MAX, 0, aqt_get_hph_type, NULL),
};
 ...
 */
int aqt_mbhc_get_impedance(struct aqt1000_mbhc *aqt_mbhc, uint32_t *zl,
			   uint32_t *zr)
{
	if (!aqt_mbhc) {
...
int aqt_mbhc_init(struct aqt1000_mbhc **mbhc,
		  struct snd_soc_component *component, struct fw_info *fw_data)
{
	struct aqt1000_mbhc *aqt_mbhc;
	struct wcd_mbhc *wcd_mbhc;
	int ret;
