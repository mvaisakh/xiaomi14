...
static const struct spi_device_id cs35l43_id_spi[] = { { "cs35l43", 0 }, {} };
...
static int cs35l43_spi_probe(struct spi_device *spi)
{
	...
	struct cs35l43_platform_data *pdata = dev_get_platdata(&spi->dev);
	struct cs35l43_private *cs35l43;
	int ret;

	cs35l43 = devm_kzalloc(&spi->dev, sizeof(struct cs35l43_private),
			       GFP_KERNEL);
	if (cs35l43 == NULL)
		return -ENOMEM;
