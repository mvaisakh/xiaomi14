...
{
	pmo_tx_ops->send_set_pkt_filter = target_if_pmo_send_pkt_filter_req;
...
static void update_pmo_igmp_tx_ops(struct wlan_pmo_tx_ops *pmo_tx_ops)
{
	pmo_tx_ops->send_igmp_offload_req = target_if_pmo_send_igmp_offload_req;
}
#else
static inline void update_pmo_igmp_tx_ops(struct wlan_pmo_tx_ops *pmo_tx_ops)
{
}
#endif
...
{
	pmo_tx_ops->send_icmp_offload_req = target_if_pmo_send_icmp_offload_req;
}
#else
static inline void tgt_if_pmo_icmp_tx_ops(struct wlan_pmo_tx_ops *pmo_tx_ops)
{
}
#endif
void target_if_pmo_register_tx_ops(struct wlan_pmo_tx_ops *pmo_tx_ops)
{
	...
	pmo_tx_ops->send_arp_offload_req = target_if_pmo_send_arp_offload_req;
	pmo_tx_ops->send_conf_hw_filter_req = target_if_pmo_conf_hw_filter;
	pmo_tx_ops->send_ns_offload_req = target_if_pmo_send_ns_offload_req;
	...
	pmo_tx_ops->del_wow_pattern = target_if_pmo_del_wow_patterns_to_fw;
	pmo_tx_ops->send_enhance_mc_offload_req =
		target_if_pmo_send_enhance_mc_offload_req;
	pmo_tx_ops->send_set_mc_filter_req = target_if_pmo_set_mc_filter_req;
	...
	pmo_tx_ops->send_ra_filter_req = target_if_pmo_send_ra_filter_req;
	pmo_tx_ops->send_gtk_offload_req = target_if_pmo_send_gtk_offload_req;
	pmo_tx_ops->send_get_gtk_rsp_cmd = target_if_pmo_send_gtk_response_req;
	pmo_tx_ops->send_action_frame_pattern_req =
		target_if_pmo_send_action_frame_patterns;
	pmo_tx_ops->send_lphb_enable = target_if_pmo_send_lphb_enable;
	pmo_tx_ops->send_lphb_tcp_params = target_if_pmo_send_lphb_tcp_params;
	pmo_tx_ops->send_lphb_tcp_filter_req =
		target_if_pmo_send_lphb_tcp_pkt_filter;
	pmo_tx_ops->send_lphb_upd_params = target_if_pmo_send_lphb_udp_params;
	...
	pmo_tx_ops->psoc_get_host_credits = target_if_pmo_psoc_get_host_credits;
	...
	pmo_tx_ops->is_target_suspended = target_if_pmo_is_target_suspended;
	pmo_tx_ops->psoc_send_wow_enable_req =
		target_if_pmo_psoc_send_wow_enable_req;
	pmo_tx_ops->psoc_send_supend_req = target_if_pmo_psoc_send_suspend_req;
