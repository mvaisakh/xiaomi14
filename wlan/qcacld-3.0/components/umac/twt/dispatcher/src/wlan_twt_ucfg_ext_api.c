...
ucfg_twt_setup_req(struct wlan_objmgr_psoc *psoc,
		   struct twt_add_dialog_param *params, void *context)
{
...
ucfg_twt_pause_req(struct wlan_objmgr_psoc *psoc,
		   struct twt_pause_dialog_cmd_param *params, void *context)
{
...
ucfg_twt_resume_req(struct wlan_objmgr_psoc *psoc,
		    struct twt_resume_dialog_cmd_param *params, void *context)
{
...
ucfg_twt_nudge_req(struct wlan_objmgr_psoc *psoc,
		   struct twt_nudge_dialog_cmd_param *params, void *context)
{
...
{
	return wlan_twt_set_command_in_progress(psoc, peer_mac, dialog_id, cmd);
}
...
bool ucfg_twt_is_setup_done(struct wlan_objmgr_psoc *psoc,
			    struct qdf_mac_addr *peer_mac, uint8_t dialog_id)
{
...
void ucfg_twt_set_work_params(struct wlan_objmgr_vdev *vdev,
			      struct qdf_mac_addr *peer_mac, uint8_t dialog_id,
