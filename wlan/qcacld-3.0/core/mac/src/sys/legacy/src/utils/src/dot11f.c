...
#if !defined ANI_OS_TYPE_OSX && !defined ANI_OS_TYPE_LINUX && \
...
static void framesntohs(tpAniSirGlobal pCtx, uint16_t *pOut, uint8_t *pIn,
			tFRAMES_BOOL fMsb)
{
	(void)pCtx;
...
static void framesntohl(tpAniSirGlobal pCtx, uint32_t *pOut, uint8_t *pIn,
			tFRAMES_BOOL fMsb)
{
	(void)pCtx;
#if defined(DOT11F_LITTLE_ENDIAN_HOST)
	if (!fMsb)
		...
		*pOut = (uint32_t)(*pIn << 24) | (*(pIn + 1) << 16) |
			(*(pIn + 2) << 8) | (*(pIn + 3));
#else
	if (!fMsb)
		*pOut = (uint32_t)(*(pIn + 3) << 24) | (*(pIn + 2) << 16) |
			(*(pIn + 1) << 8) | (*(pIn));
	else
		*pOut = *(uint32_t *)pIn;
#endif
...
static void framesntohq(tpAniSirGlobal pCtx, tDOT11F_U64 *pOut, uint8_t *pIn,
			tFRAMES_BOOL fMsb)
{
#if defined(DOT11F_LITTLE_ENDIAN_HOST)
...
static void frameshtons(tpAniSirGlobal pCtx, uint8_t *pOut, uint16_t pIn,
			tFRAMES_BOOL fMsb)
{
	(void)pCtx;
#if defined(DOT11F_LITTLE_ENDIAN_HOST)
...
static void frameshtonl(tpAniSirGlobal pCtx, uint8_t *pOut, uint32_t pIn,
			tFRAMES_BOOL fMsb)
{
	(void)pCtx;
#if defined(DOT11F_LITTLE_ENDIAN_HOST)
...
static void frameshtonq(tpAniSirGlobal pCtx, uint8_t *pOut, tDOT11F_U64 pIn,
			tFRAMES_BOOL fMsb)
{
#if defined(DOT11F_LITTLE_ENDIAN_HOST)
...
static const tIEDefn *find_ie_defn(tpAniSirGlobal pCtx, uint8_t *pBuf,
				   uint32_t nBuf, const tIEDefn IEs[])
{
	const tIEDefn *pIe;
	(void)pCtx;
...
static uint32_t get_container_ies_len(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint32_t nBuf, uint8_t *pnConsumed,
				      const tIEDefn IEs[])
{
...
static uint32_t unpack_core(tpAniSirGlobal pCtx, uint8_t *pBuf, uint32_t nBuf,
			    const tFFDefn FFs[], const tIEDefn IEs[],
			    uint8_t *pFrm, size_t nFrm, bool append_ie);
static uint32_t pack_core(tpAniSirGlobal pCtx, uint8_t *pSrc, uint8_t *pBuf,
			  uint32_t nBuf, uint32_t *pnConsumed,
			  const tFFDefn FFs[], const tIEDefn IEs[]);
static uint32_t get_packed_size_core(tpAniSirGlobal pCtx, uint8_t *pFrm,
				     uint32_t *pnNeeded, const tIEDefn IEs[]);
...
static void dot11f_unpack_ff_common_func(tpAniSirGlobal pCtx, uint8_t *pBuf,
					 uint16_t *pDstField)
{
...
static const tTLVDefn *find_tlv_defn(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint32_t nBuf, const tTLVDefn TLVs[])
{
	const tTLVDefn *pTlv;
	uint32_t pec;
	uint16_t id;
...
static uint32_t unpack_tlv_core(tpAniSirGlobal pCtx, uint8_t *pBuf,
				uint32_t nBuf, const tTLVDefn TLVs[],
				uint8_t *pFrm, size_t nFrm);
static uint32_t pack_tlv_core(tpAniSirGlobal pCtx, uint8_t *pSrc, uint8_t *pBuf,
			      uint32_t nBuf, uint32_t *pnConsumed,
			      const tTLVDefn TLVs[], uint32_t *pidx);
static uint32_t get_packed_size_tlv_core(tpAniSirGlobal pCtx, uint8_t *pFrm,
					 uint32_t *pnNeeded,
					 const tTLVDefn TLVs[]);

#define SigFfAID (0x0001)

void dot11f_unpack_ff_action(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_capabilities(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_category(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_current_ap_address(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_dialog_token(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_link_margin(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_max_tx_power(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_num_of_repetitions(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_operating_mode(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_rcpi(tpAniSirGlobal pCtx, uint8_t *pBuf,
			   tDot11fFfRCPI *pDst)
{
	pDst->rcpi = *pBuf;
	(void)pCtx;
...
void dot11f_unpack_ff_rsni(tpAniSirGlobal pCtx, uint8_t *pBuf,
			   tDot11fFfRSNI *pDst)
{
	pDst->rsni = *pBuf;
	(void)pCtx;
...
void dot11f_unpack_ff_rx_antenna_id(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_sm_power_mode_set(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_status_code(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_tpc_ele_id(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_tpc_ele_len(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_ts_info(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_time_stamp(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_transaction_id(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_tx_antenna_id(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_tx_power(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_vht_membership_status_array(
	tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_vht_user_position_array(
	tpAniSirGlobal pCtx, uint8_t *pBuf, tDot11fFfVhtUserPositionArray *pDst)
{
...
void dot11f_unpack_ff_addba_param_set(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_ba_start_seq_ctrl(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_ba_timeout(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_delba_param_set(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_p2p_action_oui(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_p2p_action_subtype(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_vendor_action_subtype(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
void dot11f_unpack_ff_vendor_oui(tpAniSirGlobal pCtx, uint8_t *pBuf,
...
uint32_t dot11f_unpack_tlv_authorized_ma_cs(tpAniSirGlobal pCtx, uint8_t *pBuf,
					    uint16_t tlvlen,
...
uint32_t dot11f_unpack_tlv_version2(tpAniSirGlobal pCtx, uint8_t *pBuf,
				    uint16_t tlvlen, tDot11fTLVVersion2 *pDst)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint8_t tmp8__;
	pDst->present = 1;
...
uint32_t dot11f_unpack_tlv_device_name(tpAniSirGlobal pCtx, uint8_t *pBuf,
				       uint16_t tlvlen,
...
uint32_t
dot11f_unpack_tlv_extended_listen_timing(tpAniSirGlobal pCtx, uint8_t *pBuf,
					 uint16_t tlvlen,
...
uint32_t dot11f_unpack_tlv_listen_channel(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint16_t tlvlen,
...
uint32_t dot11f_unpack_tlv_manufacturer(tpAniSirGlobal pCtx, uint8_t *pBuf,
					uint16_t tlvlen,
...
uint32_t dot11f_unpack_tlv_model_name(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint16_t tlvlen,
...
uint32_t dot11f_unpack_tlv_model_number(tpAniSirGlobal pCtx, uint8_t *pBuf,
					uint16_t tlvlen,
...
uint32_t dot11f_unpack_tlv_notice_of_absence(tpAniSirGlobal pCtx, uint8_t *pBuf,
					     uint16_t tlvlen,
...
uint32_t dot11f_unpack_tlv_operating_channel(tpAniSirGlobal pCtx, uint8_t *pBuf,
					     uint16_t tlvlen,
...
uint32_t dot11f_unpack_tlv_p2_p_capability(tpAniSirGlobal pCtx, uint8_t *pBuf,
					   uint16_t tlvlen,
...
uint32_t dot11f_unpack_tlv_p2_p_device_id(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint16_t tlvlen,
...
static const tTLVDefn TLVS_P2PDeviceInfo[] = {
	{
		...
		offsetof(tDot11fTLVDeviceName, present),
		"DeviceName",
		SigTlvDeviceName,
		DOT11F_TLV_DEVICENAME,
		0,
		4,
		36,
		1,
...
uint32_t dot11f_unpack_tlv_p2_p_device_info(tpAniSirGlobal pCtx, uint8_t *pBuf,
					    uint16_t tlvlen,
					    tDot11fTLVP2PDeviceInfo *pDst)
{
	...
	tlvlen -= (uint8_t)8;
	(void)pCtx;
	status |= unpack_tlv_core(pCtx, pBuf, tlvlen, TLVS_P2PDeviceInfo,
...
uint32_t dot11f_unpack_tlv_p2_p_group_info(tpAniSirGlobal pCtx, uint8_t *pBuf,
					   uint16_t tlvlen,
...
uint32_t
dot11f_unpack_tlv_primary_device_type(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint16_t tlvlen,
...
uint32_t
dot11f_unpack_tlv_request_device_type(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint16_t tlvlen,
...
uint32_t dot11f_unpack_tlv_serial_number(tpAniSirGlobal pCtx, uint8_t *pBuf,
					 uint16_t tlvlen,
...
uint32_t dot11f_unpack_tlv_uuid_e(tpAniSirGlobal pCtx, uint8_t *pBuf,
				  uint16_t tlvlen, tDot11fTLVUUID_E *pDst)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	pDst->present = 1;
...
uint32_t dot11f_unpack_tlv_uuid_r(tpAniSirGlobal pCtx, uint8_t *pBuf,
				  uint16_t tlvlen, tDot11fTLVUUID_R *pDst)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	pDst->present = 1;
	if (unlikely(tlvlen < 16)) {
...
static const tTLVDefn TLVS_VendorExtension[] = {
	{
		...
		offsetof(tDot11fTLVVersion2, present),
		"Version2",
		SigTlvVersion2,
		DOT11F_TLV_VERSION2,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVAuthorizedMACs, present),
		"AuthorizedMACs",
		SigTlvAuthorizedMACs,
		DOT11F_TLV_AUTHORIZEDMACS,
		0,
		8,
		8,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVRequestToEnroll, present),
		"RequestToEnroll",
		SigTlvRequestToEnroll,
		DOT11F_TLV_REQUESTTOENROLL,
		0,
		3,
		3,
		0,
...
uint32_t dot11f_unpack_tlv_vendor_extension(tpAniSirGlobal pCtx, uint8_t *pBuf,
					    uint16_t tlvlen,
					    tDot11fTLVVendorExtension *pDst)
{
	...
	tlvlen -= (uint8_t)3;
	(void)pCtx;
	status |= unpack_tlv_core(pCtx, pBuf, tlvlen, TLVS_VendorExtension,
				  (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
uint32_t dot11f_unpack_tlv_version(tpAniSirGlobal pCtx, uint8_t *pBuf,
				   uint16_t tlvlen, tDot11fTLVVersion *pDst)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint8_t tmp9__;
	pDst->present = 1;
...
uint32_t dot11f_unpack_tlv_ecsa_target_tsf_info_attr(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint16_t tlvlen,
...
uint32_t
dot11f_unpack_tlv_edca_pifs_param_attr(tpAniSirGlobal pCtx, uint8_t *pBuf,
				       uint16_t tlvlen,
...
uint32_t dot11f_unpack_tlv_he_400ns_sgi_attr(tpAniSirGlobal pCtx, uint8_t *pBuf,
					     uint16_t tlvlen,
...
uint32_t dot11f_unpack_tlv_he_mcs13_attr(tpAniSirGlobal pCtx, uint8_t *pBuf,
					 uint16_t tlvlen,
...
uint32_t
dot11f_unpack_tlv_non_prefferd_chan_rep(tpAniSirGlobal pCtx, uint8_t *pBuf,
					uint16_t tlvlen,
...
uint32_t dot11f_unpack_tlv_oce_cap(tpAniSirGlobal pCtx, uint8_t *pBuf,
				   uint16_t tlvlen, tDot11fTLVoce_cap *pDst)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint8_t tmp10__;
	pDst->present = 1;
...
uint32_t dot11f_unpack_tlv_qcn_version(tpAniSirGlobal pCtx, uint8_t *pBuf,
				       uint16_t tlvlen,
...
uint32_t
dot11f_unpack_tlv_reduced_wan_metrics(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint16_t tlvlen,
...
uint32_t dot11f_unpack_tlv_rssi_assoc_rej(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint16_t tlvlen,
...
uint32_t dot11f_unpack_tlv_p2_p_interface(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint16_t tlvlen,
...
uint32_t dot11f_unpack_ie_gtk(tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
			      tDot11fIEGTK *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint16_t tmp12__;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
	if (pDst->present)
...
uint32_t dot11f_unpack_ie_igtk(tpAniSirGlobal pCtx, uint8_t *pBuf,
			       uint8_t ielen, tDot11fIEIGTK *pDst,
			       bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_r0_kh_id(tpAniSirGlobal pCtx, uint8_t *pBuf,
				   uint8_t ielen, tDot11fIER0KH_ID *pDst,
				   bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_r1_kh_id(tpAniSirGlobal pCtx, uint8_t *pBuf,
				   uint8_t ielen, tDot11fIER1KH_ID *pDst,
				   bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_ap_channel_report(tpAniSirGlobal pCtx, uint8_t *pBuf,
					    uint8_t ielen,
...
uint32_t dot11f_unpack_ie_bcn_reporting_detail(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEBcnReportingDetail *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_beacon_report_frm_body(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEBeaconReportFrmBody *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_beacon_reporting(tpAniSirGlobal pCtx, uint8_t *pBuf,
					   uint8_t ielen,
...
uint32_t dot11f_unpack_ie_condensed_country_str(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIECondensedCountryStr *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_measurement_pilot(tpAniSirGlobal pCtx, uint8_t *pBuf,
					    uint8_t ielen,
...
uint32_t dot11f_unpack_ie_multi_bssid(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint8_t ielen, tDot11fIEMultiBssid *pDst,
				      bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_ric_data(tpAniSirGlobal pCtx, uint8_t *pBuf,
				   uint8_t ielen, tDot11fIERICData *pDst,
				   bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_ric_descriptor(tpAniSirGlobal pCtx, uint8_t *pBuf,
					 uint8_t ielen,
...
uint32_t dot11f_unpack_ie_rrm_enabled_cap(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint8_t ielen,
...
uint32_t dot11f_unpack_ie_requested_info(tpAniSirGlobal pCtx, uint8_t *pBuf,
					 uint8_t ielen,
...
uint32_t dot11f_unpack_ie_ssid(tpAniSirGlobal pCtx, uint8_t *pBuf,
			       uint8_t ielen, tDot11fIESSID *pDst,
			       bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_schedule(tpAniSirGlobal pCtx, uint8_t *pBuf,
				   uint8_t ielen, tDot11fIESchedule *pDst,
				   bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint16_t tmp18__;
...
uint32_t dot11f_unpack_ie_tclas(tpAniSirGlobal pCtx, uint8_t *pBuf,
				uint8_t ielen, tDot11fIETCLAS *pDst,
				bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	...
	case 1:
		...
		case 4:
			...
			DOT11F_MEMCPY(
				pCtx,
				pDst->info.IpParams.params.IpV4Params.source,
				pBuf, 4);
			pBuf += 4;
			ielen -= (uint8_t)4;
			if (unlikely(ielen < 4)) {
			...
			DOT11F_MEMCPY(
				pCtx,
				pDst->info.IpParams.params.IpV4Params.dest,
				pBuf, 4);
			pBuf += 4;
			ielen -= (uint8_t)4;
			if (unlikely(ielen < 2)) {
			...
			framesntohs(
				pCtx,
				&pDst->info.IpParams.params.IpV4Params.src_port,
				pBuf, 0);
			pBuf += 2;
			ielen -= (uint8_t)2;
			if (unlikely(ielen < 2)) {
			...
			framesntohs(
				pCtx,
				&pDst->info.IpParams.params.IpV4Params.dest_port,
				pBuf, 0);
			pBuf += 2;
			ielen -= (uint8_t)2;
			if (unlikely(ielen < 1)) {
		...
		case 6:
			...
			DOT11F_MEMCPY(
				pCtx,
				pDst->info.IpParams.params.IpV6Params.source,
				pBuf, 16);
			pBuf += 16;
			ielen -= (uint8_t)16;
			if (unlikely(ielen < 16)) {
			...
			DOT11F_MEMCPY(
				pCtx,
				pDst->info.IpParams.params.IpV6Params.dest,
				pBuf, 16);
			pBuf += 16;
			ielen -= (uint8_t)16;
			if (unlikely(ielen < 2)) {
			...
			framesntohs(
				pCtx,
				&pDst->info.IpParams.params.IpV6Params.src_port,
				pBuf, 0);
			pBuf += 2;
			ielen -= (uint8_t)2;
			if (unlikely(ielen < 2)) {
			...
			framesntohs(
				pCtx,
				&pDst->info.IpParams.params.IpV6Params.dest_port,
				pBuf, 0);
			pBuf += 2;
			ielen -= (uint8_t)2;
			if (unlikely(ielen < 3)) {
			...
			DOT11F_MEMCPY(
				pCtx,
				pDst->info.IpParams.params.IpV6Params.flow_label,
				pBuf, 3);
			pBuf += 3;
			ielen -= (uint8_t)3;
			break;
...
uint32_t dot11f_unpack_ie_ts_delay(tpAniSirGlobal pCtx, uint8_t *pBuf,
				   uint8_t ielen, tDot11fIETSDelay *pDst,
				   bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_tsf_info(tpAniSirGlobal pCtx, uint8_t *pBuf,
				   uint8_t ielen, tDot11fIETSFInfo *pDst,
				   bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_tspec(tpAniSirGlobal pCtx, uint8_t *pBuf,
				uint8_t ielen, tDot11fIETSPEC *pDst,
				bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint16_t tmp19__;
...
uint32_t dot11f_unpack_ie_vht_caps(tpAniSirGlobal pCtx, uint8_t *pBuf,
				   uint8_t ielen, tDot11fIEVHTCaps *pDst,
				   bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint32_t tmp22__;
...
uint32_t dot11f_unpack_ie_vht_operation(tpAniSirGlobal pCtx, uint8_t *pBuf,
					uint8_t ielen,
...
uint32_t dot11f_unpack_ie_wmm_schedule(tpAniSirGlobal pCtx, uint8_t *pBuf,
				       uint8_t ielen,
...
uint32_t dot11f_unpack_ie_wmmtclas(tpAniSirGlobal pCtx, uint8_t *pBuf,
				   uint8_t ielen, tDot11fIEWMMTCLAS *pDst,
				   bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_wmmtclasproc(tpAniSirGlobal pCtx, uint8_t *pBuf,
				       uint8_t ielen,
...
uint32_t dot11f_unpack_ie_wmmts_delay(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint8_t ielen, tDot11fIEWMMTSDelay *pDst,
				      bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_wmmtspec(tpAniSirGlobal pCtx, uint8_t *pBuf,
				   uint8_t ielen, tDot11fIEWMMTSPEC *pDst,
				   bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint16_t tmp26__;
...
uint32_t dot11f_unpack_ie_wider_bw_chan_switch_ann(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEWiderBWChanSwitchAnn *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_azimuth_req(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint8_t ielen, tDot11fIEazimuth_req *pDst,
				      bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_beacon_report_frm_body_fragment_id(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEbeacon_report_frm_body_fragment_id *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint16_t tmp29__;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_last_beacon_report_indication(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIElast_beacon_report_indication *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_max_age(tpAniSirGlobal pCtx, uint8_t *pBuf,
				  uint8_t ielen, tDot11fIEmax_age *pDst,
				  bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_mscs_status(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint8_t ielen, tDot11fIEmscs_status *pDst,
				      bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
static const tIEDefn IES_neighbor_rpt[] = {
	{
		offsetof(tDot11fIEneighbor_rpt, TSFInfo),
		offsetof(tDot11fIETSFInfo, present),
		0,
		"TSFInfo",
		0,
		6,
	...
	},
	{
		...
		offsetof(tDot11fIECondensedCountryStr, present),
		0,
		"CondensedCountryStr",
		0,
		4,
		4,
		SigIeCondensedCountryStr,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_CONDENSEDCOUNTRYSTR,
		0,
		0,
	},
	{
		offsetof(tDot11fIEneighbor_rpt, MeasurementPilot),
		offsetof(tDot11fIEMeasurementPilot, present),
		0,
		"MeasurementPilot",
		0,
		3,
		258,
		SigIeMeasurementPilot,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_MEASUREMENTPILOT,
		0,
		0,
	},
	{
		offsetof(tDot11fIEneighbor_rpt, RRMEnabledCap),
		offsetof(tDot11fIERRMEnabledCap, present),
		0,
		"RRMEnabledCap",
		0,
		7,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_RRMENABLEDCAP,
		0,
		0,
	},
	{
		offsetof(tDot11fIEneighbor_rpt, MultiBssid),
		offsetof(tDot11fIEMultiBssid, present),
		0,
		"MultiBssid",
		0,
		3,
...
uint32_t dot11f_unpack_ie_neighbor_rpt(tpAniSirGlobal pCtx, uint8_t *pBuf,
				       uint8_t ielen,
				       ...
				       bool append_ie)
{
	...
	ielen -= (uint8_t)1;
	(void)pCtx;
	status |= unpack_core(pCtx, pBuf, ielen, FFS_neighbor_rpt,
			      IES_neighbor_rpt, (uint8_t *)pDst, sizeof(*pDst),
			      append_ie);
	return status;
...
uint32_t dot11f_unpack_ie_req_mac_addr(tpAniSirGlobal pCtx, uint8_t *pBuf,
				       uint8_t ielen,
...
uint32_t dot11f_unpack_ie_tclas_mask(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint8_t ielen, tDot11fIEtclas_mask *pDst,
				     bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_tgt_mac_addr(tpAniSirGlobal pCtx, uint8_t *pBuf,
				       uint8_t ielen,
...
uint32_t dot11f_unpack_ie_transmit_power_env(tpAniSirGlobal pCtx, uint8_t *pBuf,
					     uint8_t ielen,
...
uint32_t dot11f_unpack_ie_aid(tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
			      tDot11fIEAID *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_cf_params(tpAniSirGlobal pCtx, uint8_t *pBuf,
				    uint8_t ielen, tDot11fIECFParams *pDst,
				    bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_challenge_text(tpAniSirGlobal pCtx, uint8_t *pBuf,
					 uint8_t ielen,
...
uint32_t dot11f_unpack_ie_chan_switch_ann(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint8_t ielen,
...
static const tIEDefn IES_ChannelSwitchWrapper[] = {
	{
		...
		offsetof(tDot11fIEWiderBWChanSwitchAnn, present),
		0,
		"WiderBWChanSwitchAnn",
		0,
		5,
		5,
		SigIeWiderBWChanSwitchAnn,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_WIDERBWCHANSWITCHANN,
		0,
		0,
	},
	{
		...
		4,
		11,
		SigIetransmit_power_env,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_TRANSMIT_POWER_ENV,
		0,
		0,
	},
	{
...
uint32_t dot11f_unpack_ie_channel_switch_wrapper(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEChannelSwitchWrapper *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
	...
	pDst->present = 1;
	(void)pCtx;
	status |= unpack_core(pCtx, pBuf, ielen, FFS_ChannelSwitchWrapper,
			      IES_ChannelSwitchWrapper, (uint8_t *)pDst,
...
uint32_t dot11f_unpack_ie_country(tpAniSirGlobal pCtx, uint8_t *pBuf,
				  uint8_t ielen, tDot11fIECountry *pDst,
				  bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_edca_param_set(tpAniSirGlobal pCtx, uint8_t *pBuf,
					 uint8_t ielen,
...
uint32_t dot11f_unpack_ie_erp_info(tpAniSirGlobal pCtx, uint8_t *pBuf,
				   uint8_t ielen, tDot11fIEERPInfo *pDst,
				   bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint8_t tmp41__;
...
uint32_t dot11f_unpack_ie_ese_cckm_opaque(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint8_t ielen,
...
uint32_t dot11f_unpack_ie_ese_rad_mgmt_cap(tpAniSirGlobal pCtx, uint8_t *pBuf,
					   uint8_t ielen,
...
uint32_t dot11f_unpack_ie_ese_traf_strm_met(tpAniSirGlobal pCtx, uint8_t *pBuf,
					    uint8_t ielen,
...
uint32_t dot11f_unpack_ie_ese_traf_strm_rate_set(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEESETrafStrmRateSet *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_ese_txmit_power(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint8_t ielen,
...
uint32_t dot11f_unpack_ie_ese_version(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint8_t ielen, tDot11fIEESEVersion *pDst,
				      bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_ext_cap(tpAniSirGlobal pCtx, uint8_t *pBuf,
				  uint8_t ielen, tDot11fIEExtCap *pDst,
				  bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_ext_supp_rates(tpAniSirGlobal pCtx, uint8_t *pBuf,
					 uint8_t ielen,
					 ...
					 bool append_ie)
{
	...
	pDst->present = 1;
	for (i = 0; i < ielen; i++) {
		if ((DOT11F_IS_BG_RATE(pBuf[i] & 0x7F)) && (rate_indx < 12)) {
...
uint32_t dot11f_unpack_ie_fh_param_set(tpAniSirGlobal pCtx, uint8_t *pBuf,
				       uint8_t ielen, tDot11fIEFHParamSet *pDst,
				       bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_fh_params(tpAniSirGlobal pCtx, uint8_t *pBuf,
				    uint8_t ielen, tDot11fIEFHParams *pDst,
				    bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_fh_patt_table(tpAniSirGlobal pCtx, uint8_t *pBuf,
					uint8_t ielen,
...
static const tIEDefn IES_FTInfo[] = {
	{
		offsetof(tDot11fIEFTInfo, R1KH_ID),
		offsetof(tDot11fIER1KH_ID, present),
		0,
		"R1KH_ID",
		0,
		8,
	...
	{
		offsetof(tDot11fIEFTInfo, GTK),
		offsetof(tDot11fIEGTK, present),
		0,
		"GTK",
		0,
		18,
	...
	{
		offsetof(tDot11fIEFTInfo, R0KH_ID),
		offsetof(tDot11fIER0KH_ID, present),
		0,
		"R0KH_ID",
		0,
		3,
	...
	{
		offsetof(tDot11fIEFTInfo, IGTK),
		offsetof(tDot11fIEIGTK, present),
		0,
		"IGTK",
		0,
		35,
...
uint32_t dot11f_unpack_ie_ft_info(tpAniSirGlobal pCtx, uint8_t *pBuf,
				  uint8_t ielen, tDot11fIEFTInfo *pDst,
				  bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint16_t tmp43__;
	...
	ielen -= (uint8_t)32;
	(void)pCtx;
	status |= unpack_core(pCtx, pBuf, ielen, FFS_FTInfo, IES_FTInfo,
			      (uint8_t *)pDst, sizeof(*pDst), append_ie);
	return status;
} /* End dot11f_unpack_ie_ft_info. */

#define SigIeFTInfo (0x003d)

uint32_t dot11f_unpack_ie_ht_caps(tpAniSirGlobal pCtx, uint8_t *pBuf,
				  uint8_t ielen, tDot11fIEHTCaps *pDst,
				  bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint16_t tmp44__;
...
uint32_t dot11f_unpack_ie_ht_info(tpAniSirGlobal pCtx, uint8_t *pBuf,
				  uint8_t ielen, tDot11fIEHTInfo *pDst,
				  bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint8_t tmp49__;
...
uint32_t dot11f_unpack_ie_link_identifier(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint8_t ielen,
...
static const tTLVDefn TLVS_MBO_IE[] = {
	{
		offsetof(tDot11fIEMBO_IE, mbo_ap_cap),
		offsetof(tDot11fTLVmbo_ap_cap, present),
		"mbo_ap_cap",
		SigTlvmbo_ap_cap,
		DOT11F_TLV_MBO_AP_CAP,
		0,
		3,
		3,
		0,
	...
	},
	{
		...
		"non_prefferd_chan_rep",
		SigTlvnon_prefferd_chan_rep,
		DOT11F_TLV_NON_PREFFERD_CHAN_REP,
		0,
		6,
		257,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVcellular_data_cap, present),
		"cellular_data_cap",
		SigTlvcellular_data_cap,
		DOT11F_TLV_CELLULAR_DATA_CAP,
		0,
		3,
		3,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVassoc_disallowed, present),
		"assoc_disallowed",
		SigTlvassoc_disallowed,
		DOT11F_TLV_ASSOC_DISALLOWED,
		0,
		3,
		3,
		0,
	...
	},
	{
		...
		"cellular_data_con_pref",
		SigTlvcellular_data_con_pref,
		DOT11F_TLV_CELLULAR_DATA_CON_PREF,
		0,
		3,
		3,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVtransition_reason, present),
		"transition_reason",
		SigTlvtransition_reason,
		DOT11F_TLV_TRANSITION_REASON,
		0,
		3,
		3,
		0,
	...
	},
	{
		...
		SigTlvtransition_reject_reason,
		DOT11F_TLV_TRANSITION_REJECT_REASON,
		0,
		3,
		3,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVassoc_retry_delay, present),
		"assoc_retry_delay",
		SigTlvassoc_retry_delay,
		DOT11F_TLV_ASSOC_RETRY_DELAY,
		0,
		4,
		4,
		0,
	...
	{
		offsetof(tDot11fIEMBO_IE, oce_cap),
		offsetof(tDot11fTLVoce_cap, present),
		"oce_cap",
		SigTlvoce_cap,
		DOT11F_TLV_OCE_CAP,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVrssi_assoc_rej, present),
		"rssi_assoc_rej",
		SigTlvrssi_assoc_rej,
		DOT11F_TLV_RSSI_ASSOC_REJ,
		0,
		4,
		4,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVreduced_wan_metrics, present),
		"reduced_wan_metrics",
		SigTlvreduced_wan_metrics,
		DOT11F_TLV_REDUCED_WAN_METRICS,
		0,
		3,
		3,
		0,
...
uint32_t dot11f_unpack_ie_MBO_IE(tpAniSirGlobal pCtx, uint8_t *pBuf,
				 uint8_t ielen, tDot11fIEMBO_IE *pDst,
				 bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_MBO_IE,
				 (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
static const tIEDefn IES_reportBeacon[] = {
	{
		...
		offsetof(tDot11fIEBeaconReportFrmBody, present),
		0,
		"BeaconReportFrmBody",
		0,
		2,
		226,
		SigIeBeaconReportFrmBody,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_BEACONREPORTFRMBODY,
		0,
		0,
	},
	{
		...
		offsetof(tDot11fIEbeacon_report_frm_body_fragment_id, present),
		0,
		"beacon_report_frm_body_fragment_id",
		0,
		4,
		4,
		SigIebeacon_report_frm_body_fragment_id,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_BEACON_REPORT_FRM_BODY_FRAGMENT_ID,
		0,
		0,
	},
	{
		...
		3,
		3,
		SigIelast_beacon_report_indication,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_LAST_BEACON_REPORT_INDICATION,
		0,
		0,
	},
	{
...
uint32_t dot11f_unpack_ie_measurement_report(tpAniSirGlobal pCtx, uint8_t *pBuf,
					     uint8_t ielen,
					     ...
					     bool append_ie)
{
	...
	if (!ielen) {
		...
		case 0:
			...
			framesntohq(pCtx, &pDst->report.Basic.meas_start_time,
				    pBuf, 0);
			pBuf += 8;
			ielen -= (uint8_t)8;
			if (unlikely(ielen < 2)) {
			...
			framesntohs(pCtx, &pDst->report.Basic.meas_duration,
				    pBuf, 0);
			pBuf += 2;
			ielen -= (uint8_t)2;
			if (unlikely(ielen < 1)) {
		...
		case 1:
			...
			framesntohq(pCtx, &pDst->report.CCA.meas_start_time,
				    pBuf, 0);
			pBuf += 8;
			ielen -= (uint8_t)8;
			if (unlikely(ielen < 2)) {
			...
			framesntohs(pCtx, &pDst->report.CCA.meas_duration, pBuf,
				    0);
			pBuf += 2;
			ielen -= (uint8_t)2;
			if (unlikely(ielen < 1)) {
		...
		case 2:
			...
			framesntohq(pCtx,
				    &pDst->report.RPIHistogram.meas_start_time,
				    pBuf, 0);
			pBuf += 8;
			ielen -= (uint8_t)8;
			if (unlikely(ielen < 2)) {
			...
			framesntohs(pCtx,
				    &pDst->report.RPIHistogram.meas_duration,
				    pBuf, 0);
			pBuf += 2;
			ielen -= (uint8_t)2;
			if (unlikely(ielen < 1)) {
		...
		case 5:
			...
			framesntohq(pCtx, &pDst->report.Beacon.meas_start_time,
				    pBuf, 0);
			pBuf += 8;
			ielen -= (uint8_t)8;
			if (unlikely(ielen < 2)) {
			...
			framesntohs(pCtx, &pDst->report.Beacon.meas_duration,
				    pBuf, 0);
			pBuf += 2;
			ielen -= (uint8_t)2;
			if (unlikely(ielen < 1)) {
			...
			pDst->report.Beacon.reported_frame_type = tmp54__ >> 7 &
								  0x1;
			if (unlikely(ielen < 1)) {
				pDst->present = 0;
				return DOT11F_INCOMPLETE_IE;
			...
			framesntohl(pCtx, &pDst->report.Beacon.parent_TSF, pBuf,
				    0);
			pBuf += 4;
			ielen -= (uint8_t)4;
			status |= unpack_core(pCtx, pBuf, ielen,
					      FFS_reportBeacon,
					      IES_reportBeacon, (uint8_t *)pDst,
					      sizeof(*pDst), append_ie);
			break;
		}
	}
...
static const tIEDefn IES_measurement_requestBeacon[] = {
	{
		offsetof(tDot11fIEMeasurementRequest,
			 measurement_request.Beacon.SSID),
		offsetof(tDot11fIESSID, present),
		0,
		"SSID",
		0,
		2,
	...
	},
	{
		...
		offsetof(tDot11fIEBeaconReporting, present),
		0,
		"BeaconReporting",
		0,
		4,
		4,
		SigIeBeaconReporting,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_BEACONREPORTING,
		0,
		0,
	},
	{
		...
		offsetof(tDot11fIEBcnReportingDetail, present),
		0,
		"BcnReportingDetail",
		0,
		3,
		3,
		SigIeBcnReportingDetail,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_BCNREPORTINGDETAIL,
		0,
		0,
	},
	{
		...
		offsetof(tDot11fIERequestedInfo, present),
		0,
		"RequestedInfo",
		0,
		2,
	...
	},
	{
		...
		offsetof(tDot11fIEMeasurementRequest,
			 measurement_request.Beacon.num_APChannelReport),
		"APChannelReport",
		2,
		3,
		53,
		SigIeAPChannelReport,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_APCHANNELREPORT,
		0,
		0,
	},
	{
		offsetof(tDot11fIEMeasurementRequest,
			 measurement_request.Beacon
				 .last_beacon_report_indication),
		offsetof(tDot11fIElast_beacon_report_indication, present),
		0,
		"last_beacon_report_indication",
...
static const tIEDefn IES_measurement_requestlci[] = {
	{
		offsetof(tDot11fIEMeasurementRequest,
			 measurement_request.lci.azimuth_req),
		offsetof(tDot11fIEazimuth_req, present),
		0,
		"azimuth_req",
		0,
		3,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_AZIMUTH_REQ,
		0,
		0,
	},
	{
		offsetof(tDot11fIEMeasurementRequest,
			 measurement_request.lci.req_mac_addr),
		offsetof(tDot11fIEreq_mac_addr, present),
		0,
		"req_mac_addr",
		0,
		8,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_REQ_MAC_ADDR,
		0,
		0,
	},
	{
		offsetof(tDot11fIEMeasurementRequest,
			 measurement_request.lci.tgt_mac_addr),
		offsetof(tDot11fIEtgt_mac_addr, present),
		0,
		"tgt_mac_addr",
		0,
		8,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_TGT_MAC_ADDR,
		0,
		0,
	},
	{
		offsetof(tDot11fIEMeasurementRequest,
			 measurement_request.lci.max_age),
...
static const tIEDefn IES_measurement_requestftmrr[] = {
	{
		offsetof(tDot11fIEMeasurementRequest,
			 measurement_request.ftmrr.neighbor_rpt),
		offsetof(tDot11fIEneighbor_rpt, present),
		0,
		"neighbor_rpt",
		0,
		15,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_NEIGHBOR_RPT,
		0,
		0,
	},
	{
		offsetof(tDot11fIEMeasurementRequest,
			 measurement_request.ftmrr.max_age),
		offsetof(tDot11fIEmax_age, present),
		0,
		"max_age",
		0,
					      ...
					      bool append_ie)
{
	...
	case 0:
		...
		DOT11F_MEMCPY(pCtx,
			      pDst->measurement_request.Basic.meas_start_time,
			      pBuf, 8);
		pBuf += 8;
		ielen -= (uint8_t)8;
		if (unlikely(ielen < 2)) {
		...
		framesntohs(pCtx,
			    &pDst->measurement_request.Basic.meas_duration,
			    pBuf, 0);
		pBuf += 2;
		ielen -= (uint8_t)2;
		break;
	case 1:
		...
		DOT11F_MEMCPY(pCtx,
			      pDst->measurement_request.CCA.meas_start_time,
			      pBuf, 8);
		pBuf += 8;
		ielen -= (uint8_t)8;
		if (unlikely(ielen < 2)) {
		...
		framesntohs(pCtx, &pDst->measurement_request.CCA.meas_duration,
			    pBuf, 0);
		pBuf += 2;
		ielen -= (uint8_t)2;
		break;
	case 2:
		...
		DOT11F_MEMCPY(
			pCtx,
			pDst->measurement_request.RPIHistogram.meas_start_time,
			pBuf, 8);
		pBuf += 8;
		ielen -= (uint8_t)8;
		if (unlikely(ielen < 2)) {
		...
		framesntohs(
			pCtx,
			&pDst->measurement_request.RPIHistogram.meas_duration,
			pBuf, 0);
		pBuf += 2;
		ielen -= (uint8_t)2;
		break;
	case 5:
		...
		framesntohs(pCtx,
			    &pDst->measurement_request.Beacon.randomization,
			    pBuf, 0);
		pBuf += 2;
		ielen -= (uint8_t)2;
		if (unlikely(ielen < 2)) {
		...
		framesntohs(pCtx,
			    &pDst->measurement_request.Beacon.meas_duration,
			    pBuf, 0);
		pBuf += 2;
		ielen -= (uint8_t)2;
		if (unlikely(ielen < 1)) {
		...
		DOT11F_MEMCPY(pCtx, pDst->measurement_request.Beacon.BSSID,
			      pBuf, 6);
		pBuf += 6;
		ielen -= (uint8_t)6;
		status |= unpack_core(pCtx, pBuf, ielen,
	...
	case 16:
		...
		framesntohs(pCtx,
			    &pDst->measurement_request.ftmrr.random_interval,
			    pBuf, 0);
		pBuf += 2;
		ielen -= (uint8_t)2;
		if (unlikely(ielen < 1)) {
...
uint32_t dot11f_unpack_ie_mobility_domain(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint8_t ielen,
...
static const tIEDefn IES_NeighborReport[] = {
	{
		offsetof(tDot11fIENeighborReport, TSFInfo),
		offsetof(tDot11fIETSFInfo, present),
		0,
		"TSFInfo",
		0,
...
uint32_t dot11f_unpack_ie_neighbor_report(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint8_t ielen,
					  ...
					  bool append_ie)
{
	...
	ielen -= (uint8_t)1;
	(void)pCtx;
	status |= unpack_core(pCtx, pBuf, ielen, FFS_NeighborReport,
			      IES_NeighborReport, (uint8_t *)pDst,
			      sizeof(*pDst), append_ie);
	return status;
...
uint32_t dot11f_unpack_ie_obss_scan_parameters(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEOBSSScanParameters *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_operating_mode(tpAniSirGlobal pCtx, uint8_t *pBuf,
					 uint8_t ielen,
...
static const tTLVDefn TLVS_P2PAssocReq[] = {
	{
		...
		offsetof(tDot11fTLVP2PCapability, present),
		"P2PCapability",
		SigTlvP2PCapability,
		DOT11F_TLV_P2PCAPABILITY,
		0,
		5,
		5,
		1,
	...
	},
	{
		...
		SigTlvExtendedListenTiming,
		DOT11F_TLV_EXTENDEDLISTENTIMING,
		0,
		7,
		7,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVP2PDeviceInfo, present),
		"P2PDeviceInfo",
		SigTlvP2PDeviceInfo,
		DOT11F_TLV_P2PDEVICEINFO,
		0,
		19,
		55,
		1,
...
uint32_t dot11f_unpack_ie_p2_p_assoc_req(tpAniSirGlobal pCtx, uint8_t *pBuf,
					 uint8_t ielen,
					 ...
					 bool append_ie)
{
	...
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_P2PAssocReq,
				 (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
static const tTLVDefn TLVS_P2PAssocRes[] = {
	{
		...
		offsetof(tDot11fTLVP2PStatus, present),
		"P2PStatus",
		SigTlvP2PStatus,
		DOT11F_TLV_P2PSTATUS,
		0,
		4,
		4,
		1,
...
uint32_t dot11f_unpack_ie_p2_p_assoc_res(tpAniSirGlobal pCtx, uint8_t *pBuf,
					 uint8_t ielen,
					 ...
					 bool append_ie)
{
	...
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_P2PAssocRes,
				 (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
static const tTLVDefn TLVS_P2PBeacon[] = {
	...
	},
	{
		...
		offsetof(tDot11fTLVP2PDeviceId, present),
		"P2PDeviceId",
		SigTlvP2PDeviceId,
		DOT11F_TLV_P2PDEVICEID,
		0,
		9,
		9,
		1,
	...
	},
	{
		...
		offsetof(tDot11fTLVNoticeOfAbsence, present),
		"NoticeOfAbsence",
		SigTlvNoticeOfAbsence,
		DOT11F_TLV_NOTICEOFABSENCE,
		0,
		5,
		41,
		0,
...
uint32_t dot11f_unpack_ie_p2_p_beacon(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint8_t ielen, tDot11fIEP2PBeacon *pDst,
				      bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_P2PBeacon,
				 (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
static const tTLVDefn TLVS_P2PBeaconProbeRes[] = {
	...
	},
	{
		...
		offsetof(tDot11fTLVP2PGroupInfo, present),
		"P2PGroupInfo",
		SigTlvP2PGroupInfo,
		DOT11F_TLV_P2PGROUPINFO,
		0,
		3,
		1027,
		0,
...
uint32_t dot11f_unpack_ie_p2_p_beacon_probe_res(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEP2PBeaconProbeRes *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_P2PBeaconProbeRes,
				 (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
static const tTLVDefn TLVS_P2PDeAuth[] = {
	{
		...
		offsetof(tDot11fTLVMinorReasonCode, present),
		"MinorReasonCode",
		SigTlvMinorReasonCode,
		DOT11F_TLV_MINORREASONCODE,
		0,
		4,
		4,
		1,
...
uint32_t dot11f_unpack_ie_p2_p_de_auth(tpAniSirGlobal pCtx, uint8_t *pBuf,
				       uint8_t ielen, tDot11fIEP2PDeAuth *pDst,
				       bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_P2PDeAuth,
				 (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
uint32_t dot11f_unpack_ie_p2_p_dis_assoc(tpAniSirGlobal pCtx, uint8_t *pBuf,
					 uint8_t ielen,
					 ...
					 bool append_ie)
{
	...
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_P2PDisAssoc,
				 (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
uint32_t dot11f_unpack_ie_p2_pie_opaque(tpAniSirGlobal pCtx, uint8_t *pBuf,
					uint8_t ielen,
...
static const tTLVDefn TLVS_P2PProbeReq[] = {
	...
	},
	{
		...
		offsetof(tDot11fTLVListenChannel, present),
		"ListenChannel",
		SigTlvListenChannel,
		DOT11F_TLV_LISTENCHANNEL,
		0,
		8,
		8,
		1,
	...
	},
	{
		...
		offsetof(tDot11fTLVOperatingChannel, present),
		"OperatingChannel",
		SigTlvOperatingChannel,
		DOT11F_TLV_OPERATINGCHANNEL,
		0,
		8,
		8,
		0,
...
uint32_t dot11f_unpack_ie_p2_p_probe_req(tpAniSirGlobal pCtx, uint8_t *pBuf,
					 uint8_t ielen,
					 ...
					 bool append_ie)
{
	...
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_P2PProbeReq,
				 (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
uint32_t dot11f_unpack_ie_p2_p_probe_res(tpAniSirGlobal pCtx, uint8_t *pBuf,
					 uint8_t ielen,
					 ...
					 bool append_ie)
{
	...
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_P2PProbeRes,
				 (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
uint32_t dot11f_unpack_ie_pti_control(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint8_t ielen, tDot11fIEPTIControl *pDst,
				      bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_pu_buffer_status(tpAniSirGlobal pCtx, uint8_t *pBuf,
					   uint8_t ielen,
...
uint32_t dot11f_unpack_ie_power_caps(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint8_t ielen, tDot11fIEPowerCaps *pDst,
				     bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_power_constraints(tpAniSirGlobal pCtx, uint8_t *pBuf,
					    uint8_t ielen,
...
uint32_t dot11f_unpack_ie_qbss_load(tpAniSirGlobal pCtx, uint8_t *pBuf,
				    uint8_t ielen, tDot11fIEQBSSLoad *pDst,
				    bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_QComVendorIE(tpAniSirGlobal pCtx, uint8_t *pBuf,
				       uint8_t ielen,
...
uint32_t dot11f_unpack_ie_qos_caps_ap(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint8_t ielen, tDot11fIEQOSCapsAp *pDst,
				      bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint8_t tmp61__;
...
uint32_t dot11f_unpack_ie_qos_caps_station(tpAniSirGlobal pCtx, uint8_t *pBuf,
					   uint8_t ielen,
...
uint32_t dot11f_unpack_ie_qos_map_set(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint8_t ielen, tDot11fIEQosMapSet *pDst,
				      bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_quiet(tpAniSirGlobal pCtx, uint8_t *pBuf,
				uint8_t ielen, tDot11fIEQuiet *pDst,
				bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_rcpiie(tpAniSirGlobal pCtx, uint8_t *pBuf,
				 uint8_t ielen, tDot11fIERCPIIE *pDst,
				 bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
static const tIEDefn IES_RICDataDesc[] = {
	{
		offsetof(tDot11fIERICDataDesc, RICData),
		offsetof(tDot11fIERICData, present),
		0,
		"RICData",
		0,
		6,
	...
	},
	{
		...
		offsetof(tDot11fIERICDescriptor, present),
		0,
		"RICDescriptor",
		0,
		3,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_RICDESCRIPTOR,
		0,
		0,
	},
	{
		offsetof(tDot11fIERICDataDesc, TSPEC),
		offsetof(tDot11fIETSPEC, present),
		0,
		"TSPEC",
		0,
		57,
	...
	{
		offsetof(tDot11fIERICDataDesc, TCLAS),
		offsetof(tDot11fIETCLAS, present),
		offsetof(tDot11fIERICDataDesc, num_TCLAS),
		"TCLAS",
		2,
		7,
		45,
	...
	},
	{
		...
		offsetof(tDot11fIETCLASSPROC, present),
		0,
		"TCLASSPROC",
		0,
		3,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_TCLASSPROC,
		0,
		0,
	},
	{
		offsetof(tDot11fIERICDataDesc, TSDelay),
		offsetof(tDot11fIETSDelay, present),
		0,
		"TSDelay",
		0,
		6,
	...
	{
		offsetof(tDot11fIERICDataDesc, Schedule),
		offsetof(tDot11fIESchedule, present),
		0,
		"Schedule",
		0,
		16,
	...
	{
		offsetof(tDot11fIERICDataDesc, WMMTSPEC),
	...
	{
		offsetof(tDot11fIERICDataDesc, WMMTCLAS),
		offsetof(tDot11fIEWMMTCLAS, present),
		offsetof(tDot11fIERICDataDesc, num_WMMTCLAS),
		"WMMTCLAS",
		2,
		13,
		51,
	...
	},
	{
		...
		offsetof(tDot11fIEWMMTCLASPROC, present),
		0,
		"WMMTCLASPROC",
		0,
		9,
		...
		{ 0, 80, 242, 2, 7 },
		5,
		DOT11F_EID_WMMTCLASPROC,
		0,
		0,
	},
	{
		offsetof(tDot11fIERICDataDesc, WMMTSDelay),
		offsetof(tDot11fIEWMMTSDelay, present),
		0,
		"WMMTSDelay",
		0,
		12,
		...
		{ 0, 80, 242, 2, 8 },
		5,
		DOT11F_EID_WMMTSDELAY,
		0,
		0,
	},
	{
		offsetof(tDot11fIERICDataDesc, WMMSchedule),
		offsetof(tDot11fIEWMMSchedule, present),
		0,
		"WMMSchedule",
		0,
		22,
...
uint32_t dot11f_unpack_ie_ric_data_desc(tpAniSirGlobal pCtx, uint8_t *pBuf,
					uint8_t ielen,
					...
					bool append_ie)
{
	...
	pDst->present = 1;
	(void)pCtx;
	status |= unpack_core(pCtx, pBuf, ielen, FFS_RICDataDesc,
			      IES_RICDataDesc, (uint8_t *)pDst, sizeof(*pDst),
			      append_ie);
	return status;
...
uint32_t dot11f_unpack_ie_rsn(tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
			      tDot11fIERSN *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	...
	if (!ielen) {
		...
		DOT11F_MEMCPY(pCtx, pDst->pwise_cipher_suites, def_cipher_suite,
			      4);
	...
	DOT11F_MEMCPY(pCtx, pDst->pwise_cipher_suites, pBuf,
	...
	if (!pDst->akm_suite_cnt || pDst->akm_suite_cnt > 6) {
		pDst->present = 0;
		return DOT11F_SKIPPED_BAD_IE;
	}
...
uint32_t dot11f_unpack_ie_rsniie(tpAniSirGlobal pCtx, uint8_t *pBuf,
				 uint8_t ielen, tDot11fIERSNIIE *pDst,
				 bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_rsn_opaque(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint8_t ielen, tDot11fIERSNOpaque *pDst,
				     bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_supp_channels(tpAniSirGlobal pCtx, uint8_t *pBuf,
					uint8_t ielen,
...
uint32_t dot11f_unpack_ie_supp_operating_classes(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIESuppOperatingClasses *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_supp_rates(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint8_t ielen, tDot11fIESuppRates *pDst,
				     bool append_ie)
{
	uint8_t i;
	uint8_t rate_indx = 0;
...
uint32_t dot11f_unpack_ie_tim(tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
			      tDot11fIETIM *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_tpc_report(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint8_t ielen, tDot11fIETPCReport *pDst,
				     bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_tpc_request(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint8_t ielen, tDot11fIETPCRequest *pDst,
				      bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_time_advertisement(tpAniSirGlobal pCtx, uint8_t *pBuf,
					     uint8_t ielen,
...
uint32_t dot11f_unpack_ie_timeout_interval(tpAniSirGlobal pCtx, uint8_t *pBuf,
					   uint8_t ielen,
...
uint32_t dot11f_unpack_ie_vht_ext_bss_load(tpAniSirGlobal pCtx, uint8_t *pBuf,
					   uint8_t ielen,
...
uint32_t dot11f_unpack_ie_vendor1_ie(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint8_t ielen, tDot11fIEVendor1IE *pDst,
				     bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_vendor3_ie(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint8_t ielen, tDot11fIEVendor3IE *pDst,
				     bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_wapi(tpAniSirGlobal pCtx, uint8_t *pBuf,
			       uint8_t ielen, tDot11fIEWAPI *pDst,
			       bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint16_t tmp63__;
	...
	DOT11F_MEMCPY(pCtx, pDst->akm_suites, pBuf,
		      (pDst->akm_suite_count * 4));
	...
	DOT11F_MEMCPY(pCtx, pDst->unicast_cipher_suites, pBuf,
		      (pDst->unicast_cipher_suite_count * 4));
...
uint32_t dot11f_unpack_ie_wapi_opaque(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint8_t ielen, tDot11fIEWAPIOpaque *pDst,
				      bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_wfatpc(tpAniSirGlobal pCtx, uint8_t *pBuf,
				 uint8_t ielen, tDot11fIEWFATPC *pDst,
				 bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_wfdie_opaque(tpAniSirGlobal pCtx, uint8_t *pBuf,
				       uint8_t ielen,
...
uint32_t dot11f_unpack_ie_wmm_caps(tpAniSirGlobal pCtx, uint8_t *pBuf,
				   uint8_t ielen, tDot11fIEWMMCaps *pDst,
				   bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint8_t tmp64__;
...
uint32_t dot11f_unpack_ie_wmm_info_ap(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint8_t ielen, tDot11fIEWMMInfoAp *pDst,
				      bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint8_t tmp65__;
...
uint32_t dot11f_unpack_ie_wmm_info_station(tpAniSirGlobal pCtx, uint8_t *pBuf,
					   uint8_t ielen,
...
uint32_t dot11f_unpack_ie_wmm_params(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint8_t ielen, tDot11fIEWMMParams *pDst,
				     bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint8_t tmp67__;
...
uint32_t dot11f_unpack_ie_wpa(tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
			      tDot11fIEWPA *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
	...
	DOT11F_MEMCPY(pCtx, pDst->unicast_ciphers, pBuf,
		      (pDst->unicast_cipher_count * 4));
	...
	DOT11F_MEMCPY(pCtx, pDst->auth_suites, pBuf,
		      (pDst->auth_suite_count * 4));
...
uint32_t dot11f_unpack_ie_wpa_opaque(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint8_t ielen, tDot11fIEWPAOpaque *pDst,
				     bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
static const tTLVDefn TLVS_WSC[] = {
	{
		offsetof(tDot11fIEWSC, Version),
		offsetof(tDot11fTLVVersion, present),
		"Version",
		SigTlvVersion,
		DOT11F_TLV_VERSION,
		0,
	...
	{
		offsetof(tDot11fIEWSC, WPSState),
		offsetof(tDot11fTLVWPSState, present),
		"WPSState",
		SigTlvWPSState,
		DOT11F_TLV_WPSSTATE,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVAPSetupLocked, present),
		"APSetupLocked",
		SigTlvAPSetupLocked,
		DOT11F_TLV_APSETUPLOCKED,
		0,
		5,
		5,
		0,
	...
	},
	{
		...
		SigTlvSelectedRegistrarConfigMethods,
		DOT11F_TLV_SELECTEDREGISTRARCONFIGMETHODS,
		0,
		6,
		6,
		0,
	...
	{
		offsetof(tDot11fIEWSC, UUID_E),
		offsetof(tDot11fTLVUUID_E, present),
		"UUID_E",
		SigTlvUUID_E,
		DOT11F_TLV_UUID_E,
		0,
	...
	{
		offsetof(tDot11fIEWSC, UUID_R),
		offsetof(tDot11fTLVUUID_R, present),
		"UUID_R",
		SigTlvUUID_R,
		DOT11F_TLV_UUID_R,
		0,
	...
	{
		offsetof(tDot11fIEWSC, RFBands),
		offsetof(tDot11fTLVRFBands, present),
		"RFBands",
		SigTlvRFBands,
		DOT11F_TLV_RFBANDS,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVSelectedRegistrar, present),
		"SelectedRegistrar",
		SigTlvSelectedRegistrar,
		DOT11F_TLV_SELECTEDREGISTRAR,
		0,
		5,
		5,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVConfigMethods, present),
		"ConfigMethods",
		SigTlvConfigMethods,
		DOT11F_TLV_CONFIGMETHODS,
		0,
		6,
		6,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVAssociationState, present),
		"AssociationState",
		SigTlvAssociationState,
		DOT11F_TLV_ASSOCIATIONSTATE,
		0,
		6,
		6,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVConfigurationError, present),
		"ConfigurationError",
		SigTlvConfigurationError,
		DOT11F_TLV_CONFIGURATIONERROR,
		0,
		6,
		6,
		0,
	...
	{
		offsetof(tDot11fIEWSC, Manufacturer),
		offsetof(tDot11fTLVManufacturer, present),
		"Manufacturer",
		SigTlvManufacturer,
		DOT11F_TLV_MANUFACTURER,
		0,
		4,
		68,
		0,
	...
	{
		offsetof(tDot11fIEWSC, ModelName),
		offsetof(tDot11fTLVModelName, present),
		"ModelName",
		SigTlvModelName,
		DOT11F_TLV_MODELNAME,
		0,
		4,
		36,
		0,
	...
	{
		offsetof(tDot11fIEWSC, ModelNumber),
		offsetof(tDot11fTLVModelNumber, present),
		"ModelNumber",
		SigTlvModelNumber,
		DOT11F_TLV_MODELNUMBER,
		0,
		4,
		36,
		0,
	...
	{
		offsetof(tDot11fIEWSC, SerialNumber),
		offsetof(tDot11fTLVSerialNumber, present),
		"SerialNumber",
		SigTlvSerialNumber,
		DOT11F_TLV_SERIALNUMBER,
		0,
		4,
		36,
		0,
	...
	{
		offsetof(tDot11fIEWSC, DeviceName),
		offsetof(tDot11fTLVDeviceName, present),
		"DeviceName",
		SigTlvDeviceName,
		DOT11F_TLV_DEVICENAME,
	...
	},
	{
		...
		offsetof(tDot11fTLVDevicePasswordID, present),
		"DevicePasswordID",
		SigTlvDevicePasswordID,
		DOT11F_TLV_DEVICEPASSWORDID,
		0,
		6,
		6,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVPrimaryDeviceType, present),
		"PrimaryDeviceType",
		SigTlvPrimaryDeviceType,
		DOT11F_TLV_PRIMARYDEVICETYPE,
		0,
		12,
		12,
		0,
	...
	{
		offsetof(tDot11fIEWSC, RequestType),
		offsetof(tDot11fTLVRequestType, present),
		"RequestType",
		SigTlvRequestType,
		DOT11F_TLV_REQUESTTYPE,
		0,
		5,
		5,
		0,
	...
	{
		offsetof(tDot11fIEWSC, ResponseType),
		offsetof(tDot11fTLVResponseType, present),
		"ResponseType",
		SigTlvResponseType,
		DOT11F_TLV_RESPONSETYPE,
		0,
		5,
		5,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVVendorExtension, present),
		"VendorExtension",
		SigTlvVendorExtension,
		DOT11F_TLV_VENDOREXTENSION,
		0,
		7,
		21,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVRequestDeviceType, present),
		"RequestDeviceType",
		SigTlvRequestDeviceType,
		DOT11F_TLV_REQUESTDEVICETYPE,
		0,
		12,
		12,
		0,
...
uint32_t dot11f_unpack_ie_wsc(tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
			      tDot11fIEWSC *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_WSC, (uint8_t *)pDst,
				 sizeof(*pDst));
	return status;
...
static const tTLVDefn TLVS_WscAssocReq[] = {
	{
		offsetof(tDot11fIEWscAssocReq, Version),
		offsetof(tDot11fTLVVersion, present),
		"Version",
		SigTlvVersion,
		DOT11F_TLV_VERSION,
...
uint32_t dot11f_unpack_ie_wsc_assoc_req(tpAniSirGlobal pCtx, uint8_t *pBuf,
					uint8_t ielen,
					...
					bool append_ie)
{
	...
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_WscAssocReq,
				 (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
static const tTLVDefn TLVS_WscAssocRes[] = {
	{
		offsetof(tDot11fIEWscAssocRes, Version),
		offsetof(tDot11fTLVVersion, present),
		"Version",
		SigTlvVersion,
		DOT11F_TLV_VERSION,
...
uint32_t dot11f_unpack_ie_wsc_assoc_res(tpAniSirGlobal pCtx, uint8_t *pBuf,
					uint8_t ielen,
					...
					bool append_ie)
{
	...
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_WscAssocRes,
				 (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
static const tTLVDefn TLVS_WscBeacon[] = {
	{
		offsetof(tDot11fIEWscBeacon, Version),
		offsetof(tDot11fTLVVersion, present),
		"Version",
		SigTlvVersion,
		DOT11F_TLV_VERSION,
	...
	{
		offsetof(tDot11fIEWscBeacon, WPSState),
		offsetof(tDot11fTLVWPSState, present),
		"WPSState",
		SigTlvWPSState,
		DOT11F_TLV_WPSSTATE,
	...
	{
		offsetof(tDot11fIEWscBeacon, UUID_E),
		offsetof(tDot11fTLVUUID_E, present),
		"UUID_E",
		SigTlvUUID_E,
		DOT11F_TLV_UUID_E,
	...
	{
		offsetof(tDot11fIEWscBeacon, RFBands),
		offsetof(tDot11fTLVRFBands, present),
		"RFBands",
		SigTlvRFBands,
		DOT11F_TLV_RFBANDS,
...
uint32_t dot11f_unpack_ie_wsc_beacon(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint8_t ielen, tDot11fIEWscBeacon *pDst,
				     bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_WscBeacon,
				 (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
static const tTLVDefn TLVS_WscBeaconProbeRes[] = {
	...
	{
		offsetof(tDot11fIEWscBeaconProbeRes,
			 SelectedRegistrarConfigMethods),
		offsetof(tDot11fTLVSelectedRegistrarConfigMethods, present),
		"SelectedRegistrarConfigMethods",
		SigTlvSelectedRegistrarConfigMethods,
					       ...
					       bool append_ie)
{
	...
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_WscBeaconProbeRes,
				 (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
uint32_t dot11f_unpack_ie_wsc_ie_opaque(tpAniSirGlobal pCtx, uint8_t *pBuf,
					uint8_t ielen,
...
static const tTLVDefn TLVS_WscProbeReq[] = {
	{
		offsetof(tDot11fIEWscProbeReq, Version),
		offsetof(tDot11fTLVVersion, present),
		"Version",
		SigTlvVersion,
		DOT11F_TLV_VERSION,
	...
	{
		offsetof(tDot11fIEWscProbeReq, UUID_E),
		offsetof(tDot11fTLVUUID_E, present),
		"UUID_E",
		SigTlvUUID_E,
		DOT11F_TLV_UUID_E,
	...
	{
		offsetof(tDot11fIEWscProbeReq, RFBands),
		offsetof(tDot11fTLVRFBands, present),
		"RFBands",
		SigTlvRFBands,
		DOT11F_TLV_RFBANDS,
...
uint32_t dot11f_unpack_ie_wsc_probe_req(tpAniSirGlobal pCtx, uint8_t *pBuf,
					uint8_t ielen,
					...
					bool append_ie)
{
	...
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_WscProbeReq,
				 (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
static const tTLVDefn TLVS_WscProbeRes[] = {
	{
		offsetof(tDot11fIEWscProbeRes, Version),
		offsetof(tDot11fTLVVersion, present),
		"Version",
		SigTlvVersion,
		DOT11F_TLV_VERSION,
	...
	{
		offsetof(tDot11fIEWscProbeRes, WPSState),
		offsetof(tDot11fTLVWPSState, present),
		"WPSState",
		SigTlvWPSState,
		DOT11F_TLV_WPSSTATE,
	...
	{
		offsetof(tDot11fIEWscProbeRes, UUID_E),
		offsetof(tDot11fTLVUUID_E, present),
		"UUID_E",
		SigTlvUUID_E,
		DOT11F_TLV_UUID_E,
	...
	{
		offsetof(tDot11fIEWscProbeRes, RFBands),
		offsetof(tDot11fTLVRFBands, present),
		"RFBands",
		SigTlvRFBands,
		DOT11F_TLV_RFBANDS,
...
uint32_t dot11f_unpack_ie_wsc_probe_res(tpAniSirGlobal pCtx, uint8_t *pBuf,
					uint8_t ielen,
					...
					bool append_ie)
{
	...
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_WscProbeRes,
				 (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
static const tTLVDefn TLVS_WscReassocRes[] = {
	{
		offsetof(tDot11fIEWscReassocRes, Version),
		offsetof(tDot11fTLVVersion, present),
		"Version",
		SigTlvVersion,
		DOT11F_TLV_VERSION,
...
uint32_t dot11f_unpack_ie_wsc_reassoc_res(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint8_t ielen,
					  ...
					  bool append_ie)
{
	...
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_WscReassocRes,
				 (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
uint32_t dot11f_unpack_ie_addba_extn_element(tpAniSirGlobal pCtx, uint8_t *pBuf,
					     uint8_t ielen,
...
uint32_t dot11f_unpack_ie_bss_color_change(tpAniSirGlobal pCtx, uint8_t *pBuf,
					   uint8_t ielen,
...
uint32_t dot11f_unpack_ie_bss_max_idle_period(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEbss_max_idle_period *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint8_t tmp77__;
	(void)pBuf;
...
static const tIEDefn IES_descriptor_element[] = {
	{
		...
		offsetof(tDot11fIEtclas_mask, present),
		0,
		"tclas_mask",
		0,
		20,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_TCLAS_MASK,
		89,
		0,
	},
	{
		offsetof(tDot11fIEdescriptor_element, mscs_status),
		offsetof(tDot11fIEmscs_status, present),
		0,
		"mscs_status",
		0,
		3,
...
uint32_t dot11f_unpack_ie_descriptor_element(tpAniSirGlobal pCtx, uint8_t *pBuf,
					     uint8_t ielen,
					     ...
					     bool append_ie)
{
	...
	ielen -= (uint8_t)4;
	(void)pCtx;
	status |= unpack_core(pCtx, pBuf, ielen, FFS_descriptor_element,
			      IES_descriptor_element, (uint8_t *)pDst,
			      sizeof(*pDst), append_ie);
	return status;
...
uint32_t dot11f_unpack_ie_dh_parameter_element(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEdh_parameter_element *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_eht_cap(tpAniSirGlobal pCtx, uint8_t *pBuf,
				  uint8_t ielen, tDot11fIEeht_cap *pDst,
				  bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint16_t tmp78__;
	...
	case 1:
		...
		DOT11F_MEMCPY(pCtx, pDst->ppet.ppe_threshold.ppe_th, pBuf,
			      (ielen));
		pBuf += (ielen);
		ielen -= (ielen);
		break;
...
uint32_t dot11f_unpack_ie_eht_op(tpAniSirGlobal pCtx, uint8_t *pBuf,
				 uint8_t ielen, tDot11fIEeht_op *pDst,
				 bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint8_t tmp86__;
	...
	DOT11F_MEMCPY(pCtx, pDst->disabled_sub_chan_bitmap, pBuf,
		      (pDst->disabled_sub_chan_bitmap_present * 2));
	(void)pCtx;
	return status;
...
uint32_t dot11f_unpack_ie_esp_information(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint8_t ielen,
...
uint32_t dot11f_unpack_ie_ext_chan_switch_ann(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEext_chan_switch_ann *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_fils_assoc_delay_info(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEfils_assoc_delay_info *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_fils_hlp_container(tpAniSirGlobal pCtx, uint8_t *pBuf,
					     uint8_t ielen,
...
uint32_t dot11f_unpack_ie_fils_indication(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint8_t ielen,
...
uint32_t dot11f_unpack_ie_fils_kde(tpAniSirGlobal pCtx, uint8_t *pBuf,
				   uint8_t ielen, tDot11fIEfils_kde *pDst,
				   bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_fils_key_confirmation(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEfils_key_confirmation *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_fils_nonce(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint8_t ielen, tDot11fIEfils_nonce *pDst,
				     bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_fils_public_key(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint8_t ielen,
...
uint32_t dot11f_unpack_ie_fils_session(tpAniSirGlobal pCtx, uint8_t *pBuf,
				       uint8_t ielen,
...
uint32_t dot11f_unpack_ie_fils_wrapped_data(tpAniSirGlobal pCtx, uint8_t *pBuf,
					    uint8_t ielen,
...
uint32_t dot11f_unpack_ie_fragment_ie(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint8_t ielen, tDot11fIEfragment_ie *pDst,
				      bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_he_6ghz_band_cap(tpAniSirGlobal pCtx, uint8_t *pBuf,
					   uint8_t ielen,
...
uint32_t dot11f_unpack_ie_he_cap(tpAniSirGlobal pCtx, uint8_t *pBuf,
				 uint8_t ielen, tDot11fIEhe_cap *pDst,
				 bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint32_t tmp91__;
	...
	DOT11F_MEMCPY(pCtx, pDst->rx_he_mcs_map_160, pBuf,
		      (pDst->chan_width_2 * 2));
	...
	DOT11F_MEMCPY(pCtx, pDst->tx_he_mcs_map_160, pBuf,
		      (pDst->chan_width_2 * 2));
	pBuf += (pDst->chan_width_2 * 2);
	ielen -= (pDst->chan_width_2 * 2);
	...
	DOT11F_MEMCPY(pCtx, pDst->rx_he_mcs_map_80_80, pBuf,
		      (pDst->chan_width_3 * 2));
	...
	DOT11F_MEMCPY(pCtx, pDst->tx_he_mcs_map_80_80, pBuf,
		      (pDst->chan_width_3 * 2));
	pBuf += (pDst->chan_width_3 * 2);
	ielen -= (pDst->chan_width_3 * 2);
	switch (pDst->ppet_present) {
...
uint32_t dot11f_unpack_ie_he_op(tpAniSirGlobal pCtx, uint8_t *pBuf,
				uint8_t ielen, tDot11fIEhe_op *pDst,
				bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint16_t tmp96__;
...
uint32_t dot11f_unpack_ie_hs20vendor_ie(tpAniSirGlobal pCtx, uint8_t *pBuf,
					uint8_t ielen,
					...
					bool append_ie)
{
	...
	if (!ielen) {
		...
		case 1:
			...
			framesntohs(pCtx, &pDst->hs_id.pps_mo.pps_mo_id, pBuf,
				    0);
			pBuf += 2;
			ielen -= (uint8_t)2;
			break;
		case 2:
			...
			framesntohs(pCtx,
				    &pDst->hs_id.anqp_domain.anqp_domain_id,
				    pBuf, 0);
			pBuf += 2;
			ielen -= (uint8_t)2;
			break;
...
uint32_t dot11f_unpack_ie_ht2040_bss_coexistence(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEht2040_bss_coexistence *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint8_t tmp101__;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_ht2040_bss_intolerant_report(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEht2040_bss_intolerant_report *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_max_chan_switch_time(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEmax_chan_switch_time *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_mlo_ie(tpAniSirGlobal pCtx, uint8_t *pBuf,
				 uint8_t ielen, tDot11fIEmlo_ie *pDst,
				 bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
uint32_t dot11f_unpack_ie_mu_edca_param_set(tpAniSirGlobal pCtx, uint8_t *pBuf,
					    uint8_t ielen,
...
uint32_t dot11f_unpack_ie_non_inheritance(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint8_t ielen,
...
uint32_t dot11f_unpack_ie_oci(tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
			      tDot11fIEoci *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_osen_ie(tpAniSirGlobal pCtx, uint8_t *pBuf,
				  uint8_t ielen, tDot11fIEosen_ie *pDst,
				  bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
static const tTLVDefn TLVS_qcn_ie[] = {
	{
		offsetof(tDot11fIEqcn_ie, qcn_version),
		offsetof(tDot11fTLVqcn_version, present),
		"qcn_version",
		SigTlvqcn_version,
		DOT11F_TLV_QCN_VERSION,
		0,
		4,
		4,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVvht_mcs11_attr, present),
		"vht_mcs11_attr",
		SigTlvvht_mcs11_attr,
		DOT11F_TLV_VHT_MCS11_ATTR,
		0,
		3,
		3,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVhe_400ns_sgi_attr, present),
		"he_400ns_sgi_attr",
		SigTlvhe_400ns_sgi_attr,
		DOT11F_TLV_HE_400NS_SGI_ATTR,
		0,
		5,
		5,
		0,
	...
	},
	{
		...
		"he_2xltf_160mhz_supp",
		SigTlvhe_2xltf_160mhz_supp,
		DOT11F_TLV_HE_2XLTF_160MHZ_SUPP,
		0,
		3,
		3,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVhe_dl_ofdma_attr, present),
		"he_dl_ofdma_attr",
		SigTlvhe_dl_ofdma_attr,
		DOT11F_TLV_HE_DL_OFDMA_ATTR,
		0,
		3,
		3,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVtrans_reasonp_attr, present),
		"trans_reasonp_attr",
		SigTlvtrans_reasonp_attr,
	...
	},
	{
		...
		offsetof(tDot11fTLVtrans_rejectp_attr, present),
		"trans_rejectp_attr",
		SigTlvtrans_rejectp_attr,
		DOT11F_TLV_TRANS_REJECTP_ATTR,
		0,
		3,
		3,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVhe_dl_mumimo_attr, present),
		"he_dl_mumimo_attr",
		SigTlvhe_dl_mumimo_attr,
		DOT11F_TLV_HE_DL_MUMIMO_ATTR,
		0,
		3,
		3,
		0,
	...
	},
	{
		...
		offsetof(tDot11fTLVhe_mcs13_attr, present),
		"he_mcs13_attr",
		SigTlvhe_mcs13_attr,
	...
	},
	{
		...
		"edca_pifs_param_attr",
		SigTlvedca_pifs_param_attr,
		DOT11F_TLV_EDCA_PIFS_PARAM_ATTR,
		0,
		6,
		7,
		0,
	...
	},
	{
		...
		SigTlvecsa_target_tsf_info_attr,
		DOT11F_TLV_ECSA_TARGET_TSF_INFO_ATTR,
		0,
		11,
		11,
		0,
...
uint32_t dot11f_unpack_ie_qcn_ie(tpAniSirGlobal pCtx, uint8_t *pBuf,
				 uint8_t ielen, tDot11fIEqcn_ie *pDst,
				 bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
	pDst->present = 1;
	status = unpack_tlv_core(pCtx, pBuf, ielen, TLVS_qcn_ie,
				 (uint8_t *)pDst, sizeof(*pDst));
	return status;
...
uint32_t dot11f_unpack_ie_reduced_neighbor_report(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEreduced_neighbor_report *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	uint16_t tmp110__;
	uint16_t tmp111__;
	...
	case 5:
		...
		framesntohl(pCtx, &pDst->tbtt_info.tbtt_info_5.short_ssid, pBuf,
			    0);
		pBuf += 4;
		ielen -= (uint8_t)4;
		break;
	case 6:
		...
		framesntohl(pCtx, &pDst->tbtt_info.tbtt_info_6.short_ssid, pBuf,
			    0);
		pBuf += 4;
		ielen -= (uint8_t)4;
		if (unlikely(ielen < 1)) {
	...
	case 11:
		...
		DOT11F_MEMCPY(pCtx, pDst->tbtt_info.tbtt_info_11.bssid, pBuf,
			      6);
		pBuf += 6;
		ielen -= (uint8_t)6;
		if (unlikely(ielen < 4)) {
		...
		framesntohl(pCtx, &pDst->tbtt_info.tbtt_info_11.short_ssid,
			    pBuf, 0);
		pBuf += 4;
		ielen -= (uint8_t)4;
		break;
	case 12:
		...
		DOT11F_MEMCPY(pCtx, pDst->tbtt_info.tbtt_info_12.bssid, pBuf,
			      6);
		pBuf += 6;
		ielen -= (uint8_t)6;
		if (unlikely(ielen < 4)) {
		...
		framesntohl(pCtx, &pDst->tbtt_info.tbtt_info_12.short_ssid,
			    pBuf, 0);
		pBuf += 4;
		ielen -= (uint8_t)4;
		if (unlikely(ielen < 1)) {
	...
	case 13:
		...
		DOT11F_MEMCPY(pCtx, pDst->tbtt_info.tbtt_info_13.bssid, pBuf,
			      6);
		pBuf += 6;
		ielen -= (uint8_t)6;
		if (unlikely(ielen < 4)) {
		...
		framesntohl(pCtx, &pDst->tbtt_info.tbtt_info_13.short_ssid,
			    pBuf, 0);
		pBuf += 4;
		ielen -= (uint8_t)4;
		if (unlikely(ielen < 1)) {
	...
	case 16:
		...
		DOT11F_MEMCPY(pCtx, pDst->tbtt_info.tbtt_info_16.bssid, pBuf,
			      6);
		pBuf += 6;
		ielen -= (uint8_t)6;
		if (unlikely(ielen < 4)) {
		...
		framesntohl(pCtx, &pDst->tbtt_info.tbtt_info_16.short_ssid,
			    pBuf, 0);
		pBuf += 4;
		ielen -= (uint8_t)4;
		if (unlikely(ielen < 1)) {
		...
		pDst->tbtt_info.tbtt_info_16.bss_param_change_cnt =
			tmp111__ >> 4 & 0xff;
		pDst->tbtt_info.tbtt_info_16.all_updates_included =
			tmp111__ >> 12 & 0x1;
...
uint32_t dot11f_unpack_ie_roaming_consortium_sel(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEroaming_consortium_sel *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_sec_chan_offset_ele(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint8_t ielen,
	tDot11fIEsec_chan_offset_ele *pDst, bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
	(void)ielen; /* Shutup the compiler */
...
uint32_t dot11f_unpack_ie_spatial_reuse(tpAniSirGlobal pCtx, uint8_t *pBuf,
					uint8_t ielen,
					...
					bool append_ie)
{
	...
	case 1:
		...
		DOT11F_MEMCPY(pCtx, pDst->srg_info.info.srg_partial_bssid, pBuf,
			      8);
		pBuf += 8;
		ielen -= (uint8_t)8;
		break;
...
uint32_t dot11f_unpack_ie_t2lm_ie(tpAniSirGlobal pCtx, uint8_t *pBuf,
				  uint8_t ielen, tDot11fIEt2lm_ie *pDst,
				  bool append_ie)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pBuf;
...
static const tIEDefn IES_vendor_vht_ie[] = {
	{
		offsetof(tDot11fIEvendor_vht_ie, VHTCaps),
		offsetof(tDot11fIEVHTCaps, present),
		0,
		"VHTCaps",
		0,
		14,
	...
	},
	{
		...
		offsetof(tDot11fIEVHTOperation, present),
		0,
		"VHTOperation",
		0,
		7,
...
uint32_t dot11f_unpack_ie_vendor_vht_ie(tpAniSirGlobal pCtx, uint8_t *pBuf,
					uint8_t ielen,
					...
					bool append_ie)
{
	...
	ielen -= (uint8_t)1;
	(void)pCtx;
	status |= unpack_core(pCtx, pBuf, ielen, FFS_vendor_vht_ie,
			      IES_vendor_vht_ie, (uint8_t *)pDst, sizeof(*pDst),
			      append_ie);
	return status;
...
static const tFFDefn FFS_AddTSRequest[] = {
	{
		"Category",
		offsetof(tDot11fAddTSRequest, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fAddTSRequest, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fAddTSRequest, DialogToken),
		SigFfDialogToken,
...
static const tIEDefn IES_AddTSRequest[] = {
	{
		offsetof(tDot11fAddTSRequest, TSPEC),
		offsetof(tDot11fIETSPEC, present),
		0,
		"TSPEC",
		0,
	...
	{
		offsetof(tDot11fAddTSRequest, TCLAS),
		offsetof(tDot11fIETCLAS, present),
		offsetof(tDot11fAddTSRequest, num_TCLAS),
		"TCLAS",
		2,
		7,
		45,
	...
	{
		offsetof(tDot11fAddTSRequest, WMMTSPEC),
		offsetof(tDot11fIEWMMTSPEC, present),
		0,
		"WMMTSPEC",
		0,
	...
	{
		offsetof(tDot11fAddTSRequest, WMMTCLAS),
		offsetof(tDot11fIEWMMTCLAS, present),
		offsetof(tDot11fAddTSRequest, num_WMMTCLAS),
		"WMMTCLAS",
		2,
		13,
		51,
	...
	},
	{
		...
		offsetof(tDot11fIEESETrafStrmRateSet, present),
		0,
		"ESETrafStrmRateSet",
		0,
		7,
		15,
		SigIeESETrafStrmRateSet,
		{ 0, 64, 150, 8, 0 },
		4,
		DOT11F_EID_ESETRAFSTRMRATESET,
		0,
		0,
	},
	{
...
uint32_t dot11f_unpack_add_ts_request(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint32_t nBuf, tDot11fAddTSRequest *pFrm,
				      bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_AddTSRequest,
			     IES_AddTSRequest, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_AddTSResponse[] = {
	{
		"Category",
		offsetof(tDot11fAddTSResponse, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fAddTSResponse, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fAddTSResponse, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
		"Status",
		offsetof(tDot11fAddTSResponse, Status),
		SigFfStatus,
...
static const tIEDefn IES_AddTSResponse[] = {
	{
		offsetof(tDot11fAddTSResponse, TSDelay),
		offsetof(tDot11fIETSDelay, present),
		0,
		"TSDelay",
		0,
	...
	{
		offsetof(tDot11fAddTSResponse, TSPEC),
		offsetof(tDot11fIETSPEC, present),
		0,
		"TSPEC",
		0,
	...
	{
		offsetof(tDot11fAddTSResponse, TCLAS),
		offsetof(tDot11fIETCLAS, present),
		offsetof(tDot11fAddTSResponse, num_TCLAS),
		"TCLAS",
		2,
		7,
		45,
	...
	{
		offsetof(tDot11fAddTSResponse, Schedule),
		offsetof(tDot11fIESchedule, present),
		0,
		"Schedule",
		0,
	...
	{
		offsetof(tDot11fAddTSResponse, WMMTSPEC),
		offsetof(tDot11fIEWMMTSPEC, present),
		0,
		"WMMTSPEC",
		0,
	...
	{
		offsetof(tDot11fAddTSResponse, WMMTCLAS),
		offsetof(tDot11fIEWMMTCLAS, present),
		offsetof(tDot11fAddTSResponse, num_WMMTCLAS),
		"WMMTCLAS",
		2,
		13,
		51,
	...
	},
	{
		...
		offsetof(tDot11fIEESETrafStrmMet, present),
		0,
		"ESETrafStrmMet",
		0,
		10,
...
uint32_t dot11f_unpack_add_ts_response(tpAniSirGlobal pCtx, uint8_t *pBuf,
				       uint32_t nBuf,
				       ...
				       bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_AddTSResponse,
			     IES_AddTSResponse, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_AssocRequest[] = {
	{
		"Capabilities",
		offsetof(tDot11fAssocRequest, Capabilities),
		SigFfCapabilities,
		DOT11F_FF_CAPABILITIES_LEN,
	},
	{
		"ListenInterval",
		offsetof(tDot11fAssocRequest, ListenInterval),
		SigFfListenInterval,
		DOT11F_FF_LISTENINTERVAL_LEN,
	},
	{
		NULL,
		0,
...
static const tIEDefn IES_AssocRequest[] = {
	{
		offsetof(tDot11fAssocRequest, SSID),
		offsetof(tDot11fIESSID, present),
		0,
		"SSID",
		0,
	...
	{
		offsetof(tDot11fAssocRequest, SuppRates),
	...
	{
		offsetof(tDot11fAssocRequest, PowerCaps),
		offsetof(tDot11fIEPowerCaps, present),
		0,
		"PowerCaps",
		0,
		4,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_POWERCAPS,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, SuppChannels),
		offsetof(tDot11fIESuppChannels, present),
		0,
		"SuppChannels",
		0,
		2,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_SUPPCHANNELS,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, RSNOpaque),
		offsetof(tDot11fIERSNOpaque, present),
		0,
		"RSNOpaque",
		0,
		2,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_RSNOPAQUE,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, QOSCapsStation),
		offsetof(tDot11fIEQOSCapsStation, present),
		0,
		"QOSCapsStation",
		0,
		3,
	...
	},
	{
		...
		offsetof(tDot11fIEMobilityDomain, present),
		0,
		"MobilityDomain",
		0,
		5,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_MOBILITYDOMAIN,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, SuppOperatingClasses),
		offsetof(tDot11fIESuppOperatingClasses, present),
		0,
		"SuppOperatingClasses",
		0,
		3,
		34,
		SigIeSuppOperatingClasses,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_SUPPOPERATINGCLASSES,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, HTCaps),
		offsetof(tDot11fIEHTCaps, present),
		0,
		"HTCaps",
		0,
		28,
	...
	{
		offsetof(tDot11fAssocRequest, ExtCap),
		offsetof(tDot11fIEExtCap, present),
		0,
		"ExtCap",
		0,
		3,
	...
	{
		offsetof(tDot11fAssocRequest, VHTCaps),
		offsetof(tDot11fIEVHTCaps, present),
		0,
		"VHTCaps",
		0,
	...
	},
	{
		...
		offsetof(tDot11fIEOperatingMode, present),
		0,
		"OperatingMode",
		0,
		3,
	...
	},
	{
		...
		offsetof(tDot11fIEfils_session, present),
		0,
		"fils_session",
		0,
		10,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_FILS_SESSION,
		4,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, fils_public_key),
		offsetof(tDot11fIEfils_public_key, present),
		0,
		"fils_public_key",
		0,
		3,
		258,
		SigIefils_public_key,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_FILS_PUBLIC_KEY,
		12,
		0,
	},
	{
		...
		2,
		257,
		SigIefils_key_confirmation,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_FILS_KEY_CONFIRMATION,
		3,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, fils_hlp_container),
		offsetof(tDot11fIEfils_hlp_container, present),
		0,
		"fils_hlp_container",
		0,
		14,
		269,
		SigIefils_hlp_container,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_FILS_HLP_CONTAINER,
		5,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, bss_max_idle_period),
		offsetof(tDot11fIEbss_max_idle_period, present),
		0,
		"bss_max_idle_period",
		0,
		5,
		5,
		SigIebss_max_idle_period,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_BSS_MAX_IDLE_PERIOD,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, FTInfo),
		offsetof(tDot11fIEFTInfo, present),
		0,
		"FTInfo",
		0,
		84,
	...
	{
		offsetof(tDot11fAssocRequest, he_cap),
		offsetof(tDot11fIEhe_cap, present),
		0,
		"he_cap",
		0,
		23,
	...
	},
	{
		...
		offsetof(tDot11fIEhe_6ghz_band_cap, present),
		0,
		"he_6ghz_band_cap",
		0,
		4,
		4,
		SigIehe_6ghz_band_cap,
		{ 0, 0, 0, 0, 0 },
		0,
	...
	},
	{
		...
		offsetof(tDot11fIEWAPIOpaque, present),
		0,
		"WAPIOpaque",
		0,
		8,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_WAPIOPAQUE,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, WAPI),
		offsetof(tDot11fIEWAPI, present),
		0,
		"WAPI",
		0,
		14,
	...
	{
		offsetof(tDot11fAssocRequest, QosMapSet),
		offsetof(tDot11fIEQosMapSet, present),
		0,
		"QosMapSet",
		0,
		18,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_QOSMAPSET,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, fragment_ie),
		offsetof(tDot11fIEfragment_ie, present),
		0,
		"fragment_ie",
		0,
		2,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_FRAGMENT_IE,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, dh_parameter_element),
		offsetof(tDot11fIEdh_parameter_element, present),
		0,
		"dh_parameter_element",
		0,
		4,
		259,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_DH_PARAMETER_ELEMENT,
		32,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, eht_cap),
		offsetof(tDot11fIEeht_cap, present),
		0,
		"eht_cap",
		0,
		26,
	...
	{
		offsetof(tDot11fAssocRequest, mlo_ie),
		offsetof(tDot11fIEmlo_ie, present),
		0,
		"mlo_ie",
		0,
		11,
	...
	{
		offsetof(tDot11fAssocRequest, t2lm_ie),
		offsetof(tDot11fIEt2lm_ie, present),
		offsetof(tDot11fAssocRequest, num_t2lm_ie),
		"t2lm_ie",
		2,
		5,
		257,
	...
	{
		offsetof(tDot11fAssocRequest, WPAOpaque),
		offsetof(tDot11fIEWPAOpaque, present),
		0,
		"WPAOpaque",
		0,
		8,
		...
		{ 0, 80, 242, 1, 0 },
		4,
		DOT11F_EID_WPAOPAQUE,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, WMMCaps),
		offsetof(tDot11fIEWMMCaps, present),
		0,
		"WMMCaps",
		0,
		9,
	...
	},
	{
		...
		offsetof(tDot11fIEWMMInfoStation, present),
		0,
		"WMMInfoStation",
		0,
		9,
		...
		{ 0, 80, 242, 2, 0 },
		5,
		DOT11F_EID_WMMINFOSTATION,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, WscIEOpaque),
		offsetof(tDot11fIEWscIEOpaque, present),
		0,
		"WscIEOpaque",
		0,
		8,
		...
		{ 0, 80, 242, 4, 0 },
		4,
		DOT11F_EID_WSCIEOPAQUE,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, ESERadMgmtCap),
		offsetof(tDot11fIEESERadMgmtCap, present),
		0,
		"ESERadMgmtCap",
		0,
		8,
		...
		{ 0, 64, 150, 1, 0 },
		4,
		DOT11F_EID_ESERADMGMTCAP,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, ESEVersion),
		offsetof(tDot11fIEESEVersion, present),
		0,
		"ESEVersion",
		0,
		7,
		...
		{ 0, 64, 150, 3, 0 },
		4,
		DOT11F_EID_ESEVERSION,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, P2PIEOpaque),
		offsetof(tDot11fIEP2PIEOpaque, present),
		0,
		"P2PIEOpaque",
		0,
		8,
		...
		{ 80, 111, 154, 9, 0 },
		4,
		DOT11F_EID_P2PIEOPAQUE,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, WFDIEOpaque),
		offsetof(tDot11fIEWFDIEOpaque, present),
		0,
		"WFDIEOpaque",
		0,
		8,
		...
		{ 80, 111, 154, 10, 0 },
		4,
		DOT11F_EID_WFDIEOPAQUE,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, vendor_vht_ie),
		offsetof(tDot11fIEvendor_vht_ie, present),
		0,
		"vendor_vht_ie",
		0,
		7,
		...
		{ 0, 144, 76, 4, 0 },
		4,
		DOT11F_EID_VENDOR_VHT_IE,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, hs20vendor_ie),
		offsetof(tDot11fIEhs20vendor_ie, present),
		0,
		"hs20vendor_ie",
		0,
		7,
		...
		{ 80, 111, 154, 16, 0 },
		4,
		DOT11F_EID_HS20VENDOR_IE,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocRequest, qcn_ie),
		offsetof(tDot11fIEqcn_ie, present),
		0,
		"qcn_ie",
		0,
		6,
	...
	{
		offsetof(tDot11fAssocRequest, osen_ie),
		offsetof(tDot11fIEosen_ie, present),
		0,
		"osen_ie",
		0,
		6,
	...
	},
	{
		...
		offsetof(tDot11fIEroaming_consortium_sel, present),
		0,
		"roaming_consortium_sel",
		0,
		6,
		261,
		SigIeroaming_consortium_sel,
		{ 80, 111, 154, 29, 0 },
		4,
		DOT11F_EID_ROAMING_CONSORTIUM_SEL,
		0,
		0,
	},
	{
...
uint32_t dot11f_unpack_assoc_request(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint32_t nBuf, tDot11fAssocRequest *pFrm,
				     bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_AssocRequest,
			     IES_AssocRequest, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_AssocResponse[] = {
	{
		"Capabilities",
		offsetof(tDot11fAssocResponse, Capabilities),
		SigFfCapabilities,
		DOT11F_FF_CAPABILITIES_LEN,
	},
	{
		"Status",
		offsetof(tDot11fAssocResponse, Status),
		SigFfStatus,
		DOT11F_FF_STATUS_LEN,
	},
	{
		"AID",
		offsetof(tDot11fAssocResponse, AID),
		SigFfAID,
		DOT11F_FF_AID_LEN,
	},
	{
...
static const tIEDefn IES_AssocResponse[] = {
	...
	},
	{
		...
		offsetof(tDot11fIEEDCAParamSet, present),
		0,
		"EDCAParamSet",
		0,
		20,
	...
	{
		offsetof(tDot11fAssocResponse, RCPIIE),
		offsetof(tDot11fIERCPIIE, present),
		0,
		"RCPIIE",
		0,
		3,
	...
	{
		offsetof(tDot11fAssocResponse, RSNIIE),
		offsetof(tDot11fIERSNIIE, present),
		0,
		"RSNIIE",
		0,
		3,
	...
	{
		offsetof(tDot11fAssocResponse, FTInfo),
		offsetof(tDot11fIEFTInfo, present),
		0,
		"FTInfo",
		0,
	...
	},
	{
		...
		offsetof(tDot11fIETimeoutInterval, present),
		0,
		"TimeoutInterval",
		0,
		7,
		7,
		SigIeTimeoutInterval,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_TIMEOUTINTERVAL,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocResponse, HTCaps),
		offsetof(tDot11fIEHTCaps, present),
		0,
		"HTCaps",
		0,
	...
	{
		offsetof(tDot11fAssocResponse, HTInfo),
		offsetof(tDot11fIEHTInfo, present),
		0,
		"HTInfo",
		0,
		24,
	...
	},
	{
		...
		offsetof(tDot11fIEOBSSScanParameters, present),
		0,
		"OBSSScanParameters",
		0,
		16,
		16,
		SigIeOBSSScanParameters,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_OBSSSCANPARAMETERS,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocResponse, ExtCap),
		offsetof(tDot11fIEExtCap, present),
		0,
		"ExtCap",
		0,
	...
	{
		offsetof(tDot11fAssocResponse, QosMapSet),
		offsetof(tDot11fIEQosMapSet, present),
		0,
		"QosMapSet",
		0,
	...
	{
		offsetof(tDot11fAssocResponse, VHTCaps),
		offsetof(tDot11fIEVHTCaps, present),
		0,
		"VHTCaps",
		0,
	...
	{
		offsetof(tDot11fAssocResponse, he_cap),
		offsetof(tDot11fIEhe_cap, present),
		0,
		"he_cap",
		0,
	...
	{
		offsetof(tDot11fAssocResponse, he_op),
		offsetof(tDot11fIEhe_op, present),
		0,
		"he_op",
		0,
		8,
	...
	},
	{
		...
		offsetof(tDot11fIEspatial_reuse, present),
		0,
		"spatial_reuse",
		0,
		3,
	...
	},
	{
		...
		offsetof(tDot11fIEbss_color_change, present),
		0,
		"bss_color_change",
		0,
		4,
		4,
		SigIebss_color_change,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_BSS_COLOR_CHANGE,
		42,
		0,
	},
	{
		offsetof(tDot11fAssocResponse, mu_edca_param_set),
		offsetof(tDot11fIEmu_edca_param_set, present),
		0,
		"mu_edca_param_set",
		0,
		15,
		15,
		SigIemu_edca_param_set,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_MU_EDCA_PARAM_SET,
		38,
		0,
	},
	{
	...
	},
	{
		...
		offsetof(tDot11fIEESETxmitPower, present),
		0,
		"ESETxmitPower",
		0,
		8,
	...
	{
		offsetof(tDot11fAssocResponse, fils_kde),
		offsetof(tDot11fIEfils_kde, present),
		0,
		"fils_kde",
		0,
		10,
	...
	{
		offsetof(tDot11fAssocResponse, eht_cap),
		offsetof(tDot11fIEeht_cap, present),
		0,
		"eht_cap",
		0,
	...
	{
		offsetof(tDot11fAssocResponse, eht_op),
		offsetof(tDot11fIEeht_op, present),
		0,
		"eht_op",
		0,
		10,
	...
	{
		offsetof(tDot11fAssocResponse, mlo_ie),
		offsetof(tDot11fIEmlo_ie, present),
		0,
		"mlo_ie",
		0,
	...
	{
		offsetof(tDot11fAssocResponse, t2lm_ie),
		offsetof(tDot11fIEt2lm_ie, present),
		offsetof(tDot11fAssocResponse, num_t2lm_ie),
		"t2lm_ie",
		2,
		5,
		257,
	...
	{
		offsetof(tDot11fAssocResponse, WPA),
		offsetof(tDot11fIEWPA, present),
		0,
		"WPA",
		0,
		8,
	...
	{
		offsetof(tDot11fAssocResponse, WMMParams),
		offsetof(tDot11fIEWMMParams, present),
		0,
		"WMMParams",
		0,
		26,
	...
	{
		offsetof(tDot11fAssocResponse, WMMCaps),
		offsetof(tDot11fIEWMMCaps, present),
		0,
		"WMMCaps",
		0,
	...
	},
	{
		...
		{ 0, 80, 242, 4, 0 },
		4,
		DOT11F_EID_WSCASSOCRES,
		0,
		0,
	},
	{
		offsetof(tDot11fAssocResponse, P2PAssocRes),
		offsetof(tDot11fIEP2PAssocRes, present),
		0,
		"P2PAssocRes",
		0,
		6,
	...
	{
		offsetof(tDot11fAssocResponse, qcn_ie),
		offsetof(tDot11fIEqcn_ie, present),
		0,
		"qcn_ie",
		0,
	...
	{
		offsetof(tDot11fAssocResponse, MBO_IE),
		offsetof(tDot11fIEMBO_IE, present),
		0,
		"MBO_IE",
		0,
		6,
	...
	},
	{
		...
		offsetof(tDot11fIEreduced_neighbor_report, present),
		0,
		"reduced_neighbor_report",
		0,
		7,
		22,
		SigIereduced_neighbor_report,
		{ 0, 0, 0, 0, 0 },
		0,
...
uint32_t dot11f_unpack_assoc_response(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint32_t nBuf, tDot11fAssocResponse *pFrm,
				      bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_AssocResponse,
			     IES_AssocResponse, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_Authentication[] = {
	{
		"AuthAlgo",
		offsetof(tDot11fAuthentication, AuthAlgo),
		SigFfAuthAlgo,
		DOT11F_FF_AUTHALGO_LEN,
	},
	{
		"AuthSeqNo",
		offsetof(tDot11fAuthentication, AuthSeqNo),
		SigFfAuthSeqNo,
		DOT11F_FF_AUTHSEQNO_LEN,
	},
	{
		"Status",
		offsetof(tDot11fAuthentication, Status),
		SigFfStatus,
		DOT11F_FF_STATUS_LEN,
	},
	{
...
static const tIEDefn IES_Authentication[] = {
	{
		...
		offsetof(tDot11fIEChallengeText, present),
		0,
		"ChallengeText",
		0,
		3,
	...
	{
		offsetof(tDot11fAuthentication, FTInfo),
		offsetof(tDot11fIEFTInfo, present),
		0,
		"FTInfo",
		0,
	...
	},
	{
		...
		offsetof(tDot11fIERICDataDesc, present),
		offsetof(tDot11fAuthentication, num_RICDataDesc),
		"RICDataDesc",
		2,
		2,
		550,
	...
	},
	{
		...
		offsetof(tDot11fIEfils_nonce, present),
		0,
		"fils_nonce",
		0,
		18,
	...
	},
	{
		...
		offsetof(tDot11fIEfils_wrapped_data, present),
		0,
		"fils_wrapped_data",
		0,
		2,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_FILS_WRAPPED_DATA,
		8,
		0,
	},
	{
		offsetof(tDot11fAuthentication, fils_assoc_delay_info),
		offsetof(tDot11fIEfils_assoc_delay_info, present),
		0,
		"fils_assoc_delay_info",
		0,
		3,
		3,
		SigIefils_assoc_delay_info,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_FILS_ASSOC_DELAY_INFO,
		1,
		0,
	},
	{
		offsetof(tDot11fAuthentication, mlo_ie),
		offsetof(tDot11fIEmlo_ie, present),
		0,
		"mlo_ie",
		0,
...
uint32_t dot11f_unpack_authentication(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint32_t nBuf,
				      ...
				      bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_Authentication,
			     IES_Authentication, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_Beacon[] = {
	{
		"TimeStamp",
		offsetof(tDot11fBeacon, TimeStamp),
		SigFfTimeStamp,
		DOT11F_FF_TIMESTAMP_LEN,
	},
	{
		"BeaconInterval",
		offsetof(tDot11fBeacon, BeaconInterval),
		SigFfBeaconInterval,
		DOT11F_FF_BEACONINTERVAL_LEN,
	},
	{
		"Capabilities",
		offsetof(tDot11fBeacon, Capabilities),
		SigFfCapabilities,
		DOT11F_FF_CAPABILITIES_LEN,
	},
	{
...
static const tIEDefn IES_Beacon[] = {
	...
	{
		offsetof(tDot11fBeacon, SuppRates),
		offsetof(tDot11fIESuppRates, present),
		0,
		"SuppRates",
		0,
	...
	{
		offsetof(tDot11fBeacon, FHParamSet),
		offsetof(tDot11fIEFHParamSet, present),
		0,
		"FHParamSet",
		0,
		7,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_FHPARAMSET,
		0,
		0,
	},
	{
		offsetof(tDot11fBeacon, DSParams),
		offsetof(tDot11fIEDSParams, present),
		0,
		"DSParams",
		0,
		3,
	...
	{
		offsetof(tDot11fBeacon, CFParams),
		offsetof(tDot11fIECFParams, present),
		0,
		"CFParams",
		0,
		8,
	...
	{
		offsetof(tDot11fBeacon, TIM),
		offsetof(tDot11fIETIM, present),
		0,
		"TIM",
		0,
		6,
	...
	{
		offsetof(tDot11fBeacon, Country),
		offsetof(tDot11fIECountry, present),
		0,
		"Country",
		0,
		8,
	...
	{
		offsetof(tDot11fBeacon, FHParams),
		offsetof(tDot11fIEFHParams, present),
		0,
		"FHParams",
		0,
		4,
	...
	{
		offsetof(tDot11fBeacon, FHPattTable),
		offsetof(tDot11fIEFHPattTable, present),
		0,
		"FHPattTable",
		0,
		6,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_FHPATTTABLE,
		0,
		0,
	},
	{
		offsetof(tDot11fBeacon, PowerConstraints),
		offsetof(tDot11fIEPowerConstraints, present),
		0,
		"PowerConstraints",
		0,
		3,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_POWERCONSTRAINTS,
		0,
		0,
	},
	{
		offsetof(tDot11fBeacon, ChanSwitchAnn),
		offsetof(tDot11fIEChanSwitchAnn, present),
		0,
		"ChanSwitchAnn",
		0,
		5,
	...
	{
		offsetof(tDot11fBeacon, Quiet),
		offsetof(tDot11fIEQuiet, present),
		0,
		"Quiet",
		0,
		8,
	...
	{
		offsetof(tDot11fBeacon, TPCReport),
		offsetof(tDot11fIETPCReport, present),
		0,
		"TPCReport",
		0,
		4,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_TPCREPORT,
		0,
		0,
	},
	{
		offsetof(tDot11fBeacon, ERPInfo),
		offsetof(tDot11fIEERPInfo, present),
		0,
		"ERPInfo",
		0,
		3,
	...
	{
		offsetof(tDot11fBeacon, ExtSuppRates),
		offsetof(tDot11fIEExtSuppRates, present),
		0,
		"ExtSuppRates",
		0,
	...
	{
		offsetof(tDot11fBeacon, RSN),
		offsetof(tDot11fIERSN, present),
		0,
		"RSN",
		0,
		4,
	...
	{
		offsetof(tDot11fBeacon, QBSSLoad),
		offsetof(tDot11fIEQBSSLoad, present),
		0,
		"QBSSLoad",
		0,
		7,
	...
	{
		offsetof(tDot11fBeacon, EDCAParamSet),
		offsetof(tDot11fIEEDCAParamSet, present),
		0,
		"EDCAParamSet",
		0,
	...
	{
		offsetof(tDot11fBeacon, QOSCapsAp),
		offsetof(tDot11fIEQOSCapsAp, present),
		0,
		"QOSCapsAp",
		0,
		3,
	...
	},
	{
		...
		offsetof(tDot11fIEext_chan_switch_ann, present),
		0,
		"ext_chan_switch_ann",
		0,
		6,
		6,
		SigIeext_chan_switch_ann,
		{ 0, 0, 0, 0, 0 },
		0,
	...
	{
		offsetof(tDot11fBeacon, VHTCaps),
		offsetof(tDot11fIEVHTCaps, present),
		0,
		"VHTCaps",
		0,
	...
	{
		offsetof(tDot11fBeacon, VHTOperation),
		offsetof(tDot11fIEVHTOperation, present),
		0,
		"VHTOperation",
		0,
	...
	},
	{
		...
		offsetof(tDot11fIEtransmit_power_env, present),
		offsetof(tDot11fBeacon, num_transmit_power_env),
		"transmit_power_env",
		8,
		4,
		11,
	...
	},
	{
		...
		offsetof(tDot11fIEChannelSwitchWrapper, present),
		0,
		"ChannelSwitchWrapper",
		0,
		2,
		18,
		SigIeChannelSwitchWrapper,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_CHANNELSWITCHWRAPPER,
		0,
		0,
	},
	{
		offsetof(tDot11fBeacon, VHTExtBssLoad),
		offsetof(tDot11fIEVHTExtBssLoad, present),
		0,
		"VHTExtBssLoad",
		0,
		7,
	...
	},
	{
		...
		offsetof(tDot11fIEfils_indication, present),
		0,
		"fils_indication",
		0,
		6,
		259,
		SigIefils_indication,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_FILS_INDICATION,
		0,
		0,
	},
	{
		offsetof(tDot11fBeacon, max_chan_switch_time),
		offsetof(tDot11fIEmax_chan_switch_time, present),
		0,
		"max_chan_switch_time",
		0,
		5,
		5,
		SigIemax_chan_switch_time,
		{ 0, 0, 0, 0, 0 },
		0,
	...
	},
	{
		...
		offsetof(tDot11fIEesp_information, present),
		0,
		"esp_information",
		0,
		2,
		98,
		SigIeesp_information,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_ESP_INFORMATION,
		11,
		0,
	},
	{
		offsetof(tDot11fBeacon, he_cap),
		offsetof(tDot11fIEhe_cap, present),
		0,
		"he_cap",
		0,
	...
	},
	{
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_SEC_CHAN_OFFSET_ELE,
		0,
		0,
	},
	{
		offsetof(tDot11fBeacon, WAPI),
		offsetof(tDot11fIEWAPI, present),
		0,
		"WAPI",
		0,
	...
	{
		offsetof(tDot11fBeacon, eht_cap),
		offsetof(tDot11fIEeht_cap, present),
		0,
		"eht_cap",
		0,
	...
	{
		offsetof(tDot11fBeacon, t2lm_ie),
		offsetof(tDot11fIEt2lm_ie, present),
		offsetof(tDot11fBeacon, num_t2lm_ie),
		"t2lm_ie",
		2,
		5,
		257,
	...
	{
		offsetof(tDot11fBeacon, WMMInfoAp),
		offsetof(tDot11fIEWMMInfoAp, present),
		0,
		"WMMInfoAp",
		0,
		9,
		...
		{ 0, 80, 242, 2, 0 },
		5,
		DOT11F_EID_WMMINFOAP,
		0,
		0,
	},
	{
		offsetof(tDot11fBeacon, WMMParams),
		offsetof(tDot11fIEWMMParams, present),
		0,
		"WMMParams",
		0,
	...
	{
		offsetof(tDot11fBeacon, WMMCaps),
		offsetof(tDot11fIEWMMCaps, present),
		0,
		"WMMCaps",
		0,
	...
	{
		offsetof(tDot11fBeacon, ESEVersion),
		offsetof(tDot11fIEESEVersion, present),
		0,
		"ESEVersion",
		0,
	...
	{
		offsetof(tDot11fBeacon, WscBeacon),
		offsetof(tDot11fIEWscBeacon, present),
		0,
		"WscBeacon",
		0,
		6,
		...
		{ 0, 80, 242, 4, 0 },
		4,
		DOT11F_EID_WSCBEACON,
		0,
		0,
	},
	{
		offsetof(tDot11fBeacon, P2PBeacon),
		...
		{ 80, 111, 154, 9, 0 },
		4,
		DOT11F_EID_P2PBEACON,
		0,
		0,
	},
	{
		offsetof(tDot11fBeacon, Vendor1IE),
		offsetof(tDot11fIEVendor1IE, present),
		0,
		"Vendor1IE",
		0,
		5,
	...
	{
		offsetof(tDot11fBeacon, Vendor3IE),
		offsetof(tDot11fIEVendor3IE, present),
		0,
		"Vendor3IE",
		0,
		5,
	...
	{
		offsetof(tDot11fBeacon, QComVendorIE),
		offsetof(tDot11fIEQComVendorIE, present),
		0,
		"QComVendorIE",
		0,
		7,
		...
		{ 0, 160, 198, 0, 0 },
		3,
		DOT11F_EID_QCOMVENDORIE,
		0,
		0,
	},
	{
		offsetof(tDot11fBeacon, MBO_IE),
		offsetof(tDot11fIEMBO_IE, present),
		0,
		"MBO_IE",
		0,
...
uint32_t dot11f_unpack_beacon(tpAniSirGlobal pCtx, uint8_t *pBuf, uint32_t nBuf,
			      tDot11fBeacon *pFrm, bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_Beacon, IES_Beacon,
...
static const tFFDefn FFS_Beacon1[] = {
	{
		"TimeStamp",
		offsetof(tDot11fBeacon1, TimeStamp),
		SigFfTimeStamp,
		DOT11F_FF_TIMESTAMP_LEN,
	},
	{
		"BeaconInterval",
		offsetof(tDot11fBeacon1, BeaconInterval),
		SigFfBeaconInterval,
		DOT11F_FF_BEACONINTERVAL_LEN,
	},
	{
		"Capabilities",
		offsetof(tDot11fBeacon1, Capabilities),
		SigFfCapabilities,
		DOT11F_FF_CAPABILITIES_LEN,
	},
	{
...
static const tIEDefn IES_Beacon1[] = {
	...
	{
		offsetof(tDot11fBeacon1, SuppRates),
		offsetof(tDot11fIESuppRates, present),
		0,
		"SuppRates",
		0,
	...
	{
		offsetof(tDot11fBeacon1, DSParams),
		offsetof(tDot11fIEDSParams, present),
		0,
		"DSParams",
		0,
...
uint32_t dot11f_unpack_beacon1(tpAniSirGlobal pCtx, uint8_t *pBuf,
			       uint32_t nBuf, tDot11fBeacon1 *pFrm,
			       bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_Beacon1, IES_Beacon1,
			     (uint8_t *)pFrm, sizeof(*pFrm), append_ie);
...
static const tIEDefn IES_Beacon2[] = {
	{
		offsetof(tDot11fBeacon2, Country),
		offsetof(tDot11fIECountry, present),
		0,
		"Country",
		0,
	...
	{
		offsetof(tDot11fBeacon2, TPCReport),
		offsetof(tDot11fIETPCReport, present),
		0,
		"TPCReport",
		0,
	...
	{
		offsetof(tDot11fBeacon2, ERPInfo),
		offsetof(tDot11fIEERPInfo, present),
		0,
		"ERPInfo",
		0,
	...
	{
		offsetof(tDot11fBeacon2, ExtSuppRates),
		offsetof(tDot11fIEExtSuppRates, present),
		0,
		"ExtSuppRates",
		0,
	...
	{
		offsetof(tDot11fBeacon2, RSNOpaque),
		offsetof(tDot11fIERSNOpaque, present),
		0,
		"RSNOpaque",
		0,
	...
	{
		offsetof(tDot11fBeacon2, EDCAParamSet),
		offsetof(tDot11fIEEDCAParamSet, present),
		0,
		"EDCAParamSet",
		0,
	...
	{
		offsetof(tDot11fBeacon2, HTCaps),
		offsetof(tDot11fIEHTCaps, present),
		0,
		"HTCaps",
		0,
	...
	{
		offsetof(tDot11fBeacon2, HTInfo),
		offsetof(tDot11fIEHTInfo, present),
		0,
		"HTInfo",
		0,
	...
	{
		offsetof(tDot11fBeacon2, ExtCap),
		offsetof(tDot11fIEExtCap, present),
		0,
		"ExtCap",
		0,
	...
	{
		offsetof(tDot11fBeacon2, VHTCaps),
		offsetof(tDot11fIEVHTCaps, present),
		0,
		"VHTCaps",
		0,
	...
	{
		offsetof(tDot11fBeacon2, VHTOperation),
		offsetof(tDot11fIEVHTOperation, present),
		0,
		"VHTOperation",
		0,
	...
	},
	{
		...
		offsetof(tDot11fIEtransmit_power_env, present),
		offsetof(tDot11fBeacon2, num_transmit_power_env),
		"transmit_power_env",
		8,
		4,
		11,
	...
	{
		offsetof(tDot11fBeacon2, he_cap),
		offsetof(tDot11fIEhe_cap, present),
		0,
		"he_cap",
		0,
	...
	{
		offsetof(tDot11fBeacon2, eht_cap),
		offsetof(tDot11fIEeht_cap, present),
		0,
		"eht_cap",
		0,
	...
	{
		offsetof(tDot11fBeacon2, eht_op),
		offsetof(tDot11fIEeht_op, present),
		0,
		"eht_op",
		0,
	...
	{
		offsetof(tDot11fBeacon2, mlo_ie),
		offsetof(tDot11fIEmlo_ie, present),
		0,
		"mlo_ie",
		0,
	...
	{
		offsetof(tDot11fBeacon2, t2lm_ie),
		offsetof(tDot11fIEt2lm_ie, present),
		offsetof(tDot11fBeacon2, num_t2lm_ie),
		"t2lm_ie",
		2,
		5,
		257,
	...
	{
		offsetof(tDot11fBeacon2, WMMInfoAp),
		offsetof(tDot11fIEWMMInfoAp, present),
		0,
		"WMMInfoAp",
		0,
	...
	{
		offsetof(tDot11fBeacon2, WMMParams),
		offsetof(tDot11fIEWMMParams, present),
		0,
		"WMMParams",
		0,
	...
	{
		offsetof(tDot11fBeacon2, WMMCaps),
		offsetof(tDot11fIEWMMCaps, present),
		0,
		"WMMCaps",
		0,
	...
	{
		offsetof(tDot11fBeacon2, WscBeacon),
		offsetof(tDot11fIEWscBeacon, present),
		0,
		"WscBeacon",
		0,
	...
	{
		offsetof(tDot11fBeacon2, P2PBeacon),
		offsetof(tDot11fIEP2PBeacon, present),
		0,
		"P2PBeacon",
		0,
	...
	{
		offsetof(tDot11fBeacon2, Vendor1IE),
		offsetof(tDot11fIEVendor1IE, present),
		0,
		"Vendor1IE",
		0,
	...
	{
		offsetof(tDot11fBeacon2, Vendor3IE),
		offsetof(tDot11fIEVendor3IE, present),
		0,
		"Vendor3IE",
		0,
	...
	{
		offsetof(tDot11fBeacon2, QComVendorIE),
		offsetof(tDot11fIEQComVendorIE, present),
		0,
		"QComVendorIE",
		0,
	...
	{
		offsetof(tDot11fBeacon2, ESEVersion),
		offsetof(tDot11fIEESEVersion, present),
		0,
		"ESEVersion",
		0,
	...
	{
		offsetof(tDot11fBeacon2, qcn_ie),
		offsetof(tDot11fIEqcn_ie, present),
		0,
		"qcn_ie",
		0,
...
uint32_t dot11f_unpack_beacon2(tpAniSirGlobal pCtx, uint8_t *pBuf,
			       uint32_t nBuf, tDot11fBeacon2 *pFrm,
			       bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_Beacon2, IES_Beacon2,
			     (uint8_t *)pFrm, sizeof(*pFrm), append_ie);
...
static const tIEDefn IES_BeaconIEs[] = {
	{
		offsetof(tDot11fBeaconIEs, SSID),
		offsetof(tDot11fIESSID, present),
		0,
		"SSID",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, SuppRates),
		offsetof(tDot11fIESuppRates, present),
		0,
		"SuppRates",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, FHParamSet),
		offsetof(tDot11fIEFHParamSet, present),
		0,
		"FHParamSet",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, DSParams),
		offsetof(tDot11fIEDSParams, present),
		0,
		"DSParams",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, CFParams),
		offsetof(tDot11fIECFParams, present),
		0,
		"CFParams",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, Country),
		offsetof(tDot11fIECountry, present),
		0,
		"Country",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, FHParams),
		offsetof(tDot11fIEFHParams, present),
		0,
		"FHParams",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, FHPattTable),
		offsetof(tDot11fIEFHPattTable, present),
		0,
		"FHPattTable",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, Quiet),
		offsetof(tDot11fIEQuiet, present),
		0,
		"Quiet",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, TPCReport),
		offsetof(tDot11fIETPCReport, present),
		0,
		"TPCReport",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, ERPInfo),
		offsetof(tDot11fIEERPInfo, present),
		0,
		"ERPInfo",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, QBSSLoad),
		offsetof(tDot11fIEQBSSLoad, present),
		0,
		"QBSSLoad",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, QOSCapsAp),
		offsetof(tDot11fIEQOSCapsAp, present),
		0,
		"QOSCapsAp",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, HTCaps),
		offsetof(tDot11fIEHTCaps, present),
		0,
		"HTCaps",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, HTInfo),
		offsetof(tDot11fIEHTInfo, present),
		0,
		"HTInfo",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, ExtCap),
		offsetof(tDot11fIEExtCap, present),
		0,
		"ExtCap",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, VHTCaps),
		offsetof(tDot11fIEVHTCaps, present),
		0,
		"VHTCaps",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, he_cap),
		offsetof(tDot11fIEhe_cap, present),
		0,
		"he_cap",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, he_op),
		offsetof(tDot11fIEhe_op, present),
		0,
		"he_op",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, WAPI),
		offsetof(tDot11fIEWAPI, present),
		0,
		"WAPI",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, eht_cap),
		offsetof(tDot11fIEeht_cap, present),
		0,
		"eht_cap",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, eht_op),
		offsetof(tDot11fIEeht_op, present),
		0,
		"eht_op",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, mlo_ie),
		offsetof(tDot11fIEmlo_ie, present),
		0,
		"mlo_ie",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, t2lm_ie),
		offsetof(tDot11fIEt2lm_ie, present),
		offsetof(tDot11fBeaconIEs, num_t2lm_ie),
		"t2lm_ie",
		2,
		5,
		257,
	...
	{
		offsetof(tDot11fBeaconIEs, WMMInfoAp),
		offsetof(tDot11fIEWMMInfoAp, present),
		0,
		"WMMInfoAp",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, WMMParams),
		offsetof(tDot11fIEWMMParams, present),
		0,
		"WMMParams",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, WMMCaps),
		offsetof(tDot11fIEWMMCaps, present),
		0,
		"WMMCaps",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, ESEVersion),
		offsetof(tDot11fIEESEVersion, present),
		0,
		"ESEVersion",
		0,
	...
	},
	{
		...
		offsetof(tDot11fIEWscBeaconProbeRes, present),
		0,
		"WscBeaconProbeRes",
		0,
		6,
		319,
		SigIeWscBeaconProbeRes,
		{ 0, 80, 242, 4, 0 },
		4,
		DOT11F_EID_WSCBEACONPROBERES,
		0,
		0,
	},
	{
		offsetof(tDot11fBeaconIEs, P2PBeaconProbeRes),
		offsetof(tDot11fIEP2PBeaconProbeRes, present),
		0,
		"P2PBeaconProbeRes",
		0,
		6,
		1150,
		SigIeP2PBeaconProbeRes,
		{ 80, 111, 154, 9, 0 },
		4,
		DOT11F_EID_P2PBEACONPROBERES,
		0,
		0,
	},
	{
		offsetof(tDot11fBeaconIEs, Vendor1IE),
		offsetof(tDot11fIEVendor1IE, present),
		0,
		"Vendor1IE",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, Vendor3IE),
		offsetof(tDot11fIEVendor3IE, present),
		0,
		"Vendor3IE",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, MBO_IE),
		offsetof(tDot11fIEMBO_IE, present),
		0,
		"MBO_IE",
		0,
	...
	{
		offsetof(tDot11fBeaconIEs, qcn_ie),
		offsetof(tDot11fIEqcn_ie, present),
		0,
		"qcn_ie",
		0,
...
uint32_t dot11f_unpack_beacon_i_es(tpAniSirGlobal pCtx, uint8_t *pBuf,
				   uint32_t nBuf, tDot11fBeaconIEs *pFrm,
				   bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_BeaconIEs, IES_BeaconIEs,
			     (uint8_t *)pFrm, sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_ChannelSwitch[] = {
	{
		"Category",
		offsetof(tDot11fChannelSwitch, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fChannelSwitch, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
...
uint32_t dot11f_unpack_channel_switch(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint32_t nBuf, tDot11fChannelSwitch *pFrm,
				      bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_ChannelSwitch,
			     IES_ChannelSwitch, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tIEDefn IES_DeAuth[] = {
	{
		offsetof(tDot11fDeAuth, P2PDeAuth),
		offsetof(tDot11fIEP2PDeAuth, present),
		0,
		"P2PDeAuth",
		0,
		6,
...
uint32_t dot11f_unpack_de_auth(tpAniSirGlobal pCtx, uint8_t *pBuf,
			       uint32_t nBuf, tDot11fDeAuth *pFrm,
			       bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_DeAuth, IES_DeAuth,
			     (uint8_t *)pFrm, sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_DelTS[] = {
	{
		"Category",
		offsetof(tDot11fDelTS, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fDelTS, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"TSInfo",
		offsetof(tDot11fDelTS, TSInfo),
		SigFfTSInfo,
		DOT11F_FF_TSINFO_LEN,
	},
	{
		"Reason",
		offsetof(tDot11fDelTS, Reason),
		SigFfReason,
		DOT11F_FF_REASON_LEN,
	},
	{
...
uint32_t dot11f_unpack_del_ts(tpAniSirGlobal pCtx, uint8_t *pBuf, uint32_t nBuf,
			      tDot11fDelTS *pFrm, bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_DelTS, IES_DelTS,
			     (uint8_t *)pFrm, sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_Disassociation[] = {
	{
		"Reason",
		offsetof(tDot11fDisassociation, Reason),
		SigFfReason,
		DOT11F_FF_REASON_LEN,
	},
	{
...
static const tIEDefn IES_Disassociation[] = {
	{
		...
		offsetof(tDot11fIEP2PDisAssoc, present),
		0,
		"P2PDisAssoc",
		0,
		6,
...
uint32_t dot11f_unpack_disassociation(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint32_t nBuf,
				      ...
				      bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_Disassociation,
			     IES_Disassociation, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_LinkMeasurementReport[] = {
	{
		"Category",
		offsetof(tDot11fLinkMeasurementReport, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fLinkMeasurementReport, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fLinkMeasurementReport, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
		"TPCEleID",
		offsetof(tDot11fLinkMeasurementReport, TPCEleID),
		SigFfTPCEleID,
		DOT11F_FF_TPCELEID_LEN,
	},
	{
		"TPCEleLen",
		offsetof(tDot11fLinkMeasurementReport, TPCEleLen),
		SigFfTPCEleLen,
		DOT11F_FF_TPCELELEN_LEN,
	},
	{
		"TxPower",
		offsetof(tDot11fLinkMeasurementReport, TxPower),
		SigFfTxPower,
		DOT11F_FF_TXPOWER_LEN,
	},
	{
		"LinkMargin",
		offsetof(tDot11fLinkMeasurementReport, LinkMargin),
		SigFfLinkMargin,
		DOT11F_FF_LINKMARGIN_LEN,
	},
	{
		"RxAntennaId",
		offsetof(tDot11fLinkMeasurementReport, RxAntennaId),
		SigFfRxAntennaId,
		DOT11F_FF_RXANTENNAID_LEN,
	},
	{
		"TxAntennaId",
		offsetof(tDot11fLinkMeasurementReport, TxAntennaId),
		SigFfTxAntennaId,
		DOT11F_FF_TXANTENNAID_LEN,
	},
	{
		"RCPI",
		offsetof(tDot11fLinkMeasurementReport, RCPI),
		SigFfRCPI,
		DOT11F_FF_RCPI_LEN,
	},
	{
		"RSNI",
		offsetof(tDot11fLinkMeasurementReport, RSNI),
		SigFfRSNI,
		DOT11F_FF_RSNI_LEN,
	},
	{
...
uint32_t dot11f_unpack_link_measurement_report(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint32_t nBuf,
	tDot11fLinkMeasurementReport *pFrm, bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_LinkMeasurementReport,
			     IES_LinkMeasurementReport, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_LinkMeasurementRequest[] = {
	{
		"Category",
		offsetof(tDot11fLinkMeasurementRequest, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fLinkMeasurementRequest, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fLinkMeasurementRequest, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
		"TxPower",
		offsetof(tDot11fLinkMeasurementRequest, TxPower),
		SigFfTxPower,
		DOT11F_FF_TXPOWER_LEN,
	},
	{
		"MaxTxPower",
		offsetof(tDot11fLinkMeasurementRequest, MaxTxPower),
		SigFfMaxTxPower,
		DOT11F_FF_MAXTXPOWER_LEN,
	},
	{
		NULL,
		0,
...
uint32_t dot11f_unpack_link_measurement_request(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint32_t nBuf,
	tDot11fLinkMeasurementRequest *pFrm, bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_LinkMeasurementRequest,
			     IES_LinkMeasurementRequest, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_MeasurementReport[] = {
	{
		"Category",
		offsetof(tDot11fMeasurementReport, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fMeasurementReport, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fMeasurementReport, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
...
static const tIEDefn IES_MeasurementReport[] = {
	{
		...
		5,
		31,
		SigIeMeasurementReport,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_MEASUREMENTREPORT,
		0,
		1,
	},
	{
...
uint32_t dot11f_unpack_measurement_report(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint32_t nBuf,
					  ...
					  bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_MeasurementReport,
			     IES_MeasurementReport, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_MeasurementRequest[] = {
	{
		"Category",
		offsetof(tDot11fMeasurementRequest, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fMeasurementRequest, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fMeasurementRequest, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
...
static const tIEDefn IES_MeasurementRequest[] = {
	{
		...
		6,
		18,
		SigIeMeasurementRequest,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_MEASUREMENTREQUEST,
		0,
		1,
	},
	{
...
uint32_t dot11f_unpack_measurement_request(tpAniSirGlobal pCtx, uint8_t *pBuf,
					   uint32_t nBuf,
					   ...
					   bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_MeasurementRequest,
			     IES_MeasurementRequest, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_NeighborReportRequest[] = {
	{
		"Category",
		offsetof(tDot11fNeighborReportRequest, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fNeighborReportRequest, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fNeighborReportRequest, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
...
static const tIEDefn IES_NeighborReportRequest[] = {
	{
		offsetof(tDot11fNeighborReportRequest, SSID),
		offsetof(tDot11fIESSID, present),
		0,
		"SSID",
		0,
...
uint32_t dot11f_unpack_neighbor_report_request(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint32_t nBuf,
	tDot11fNeighborReportRequest *pFrm, bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_NeighborReportRequest,
			     IES_NeighborReportRequest, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_NeighborReportResponse[] = {
	{
		"Category",
		offsetof(tDot11fNeighborReportResponse, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fNeighborReportResponse, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fNeighborReportResponse, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
...
uint32_t dot11f_unpack_neighbor_report_response(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint32_t nBuf,
	tDot11fNeighborReportResponse *pFrm, bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_NeighborReportResponse,
			     IES_NeighborReportResponse, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_OperatingMode[] = {
	{
		"Category",
		offsetof(tDot11fOperatingMode, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fOperatingMode, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"OperatingMode",
		offsetof(tDot11fOperatingMode, OperatingMode),
		SigFfOperatingMode,
...
uint32_t dot11f_unpack_operating_mode(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint32_t nBuf, tDot11fOperatingMode *pFrm,
				      bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_OperatingMode,
			     IES_OperatingMode, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tIEDefn IES_ProbeRequest[] = {
	{
		offsetof(tDot11fProbeRequest, SSID),
		offsetof(tDot11fIESSID, present),
		0,
		"SSID",
		0,
	...
	{
		offsetof(tDot11fProbeRequest, SuppRates),
		offsetof(tDot11fIESuppRates, present),
		0,
		"SuppRates",
		0,
	...
	{
		offsetof(tDot11fProbeRequest, DSParams),
		offsetof(tDot11fIEDSParams, present),
		0,
		"DSParams",
		0,
	...
	{
		offsetof(tDot11fProbeRequest, HTCaps),
		offsetof(tDot11fIEHTCaps, present),
		0,
		"HTCaps",
		0,
	...
	{
		offsetof(tDot11fProbeRequest, ExtCap),
		offsetof(tDot11fIEExtCap, present),
		0,
		"ExtCap",
		0,
	...
	{
		offsetof(tDot11fProbeRequest, VHTCaps),
		offsetof(tDot11fIEVHTCaps, present),
		0,
		"VHTCaps",
		0,
	...
	{
		offsetof(tDot11fProbeRequest, he_cap),
		offsetof(tDot11fIEhe_cap, present),
		0,
		"he_cap",
		0,
	...
	{
		offsetof(tDot11fProbeRequest, eht_cap),
		offsetof(tDot11fIEeht_cap, present),
		0,
		"eht_cap",
		0,
	...
	{
		offsetof(tDot11fProbeRequest, mlo_ie),
		offsetof(tDot11fIEmlo_ie, present),
		0,
		"mlo_ie",
		0,
	...
	},
	{
		...
		offsetof(tDot11fIEWscProbeReq, present),
		0,
		"WscProbeReq",
		0,
		6,
		...
		{ 0, 80, 242, 4, 0 },
		4,
		DOT11F_EID_WSCPROBEREQ,
		0,
		0,
	},
	{
		offsetof(tDot11fProbeRequest, WFATPC),
		offsetof(tDot11fIEWFATPC, present),
		0,
		"WFATPC",
		0,
		9,
	...
	},
	{
		...
		offsetof(tDot11fIEP2PProbeReq, present),
		0,
		"P2PProbeReq",
		0,
		6,
		...
		{ 80, 111, 154, 9, 0 },
		4,
		DOT11F_EID_P2PPROBEREQ,
		0,
		0,
	},
	{
		offsetof(tDot11fProbeRequest, qcn_ie),
		offsetof(tDot11fIEqcn_ie, present),
		0,
		"qcn_ie",
		0,
...
uint32_t dot11f_unpack_probe_request(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint32_t nBuf, tDot11fProbeRequest *pFrm,
				     bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_ProbeRequest,
			     IES_ProbeRequest, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_ProbeResponse[] = {
	{
		"TimeStamp",
		offsetof(tDot11fProbeResponse, TimeStamp),
		SigFfTimeStamp,
		DOT11F_FF_TIMESTAMP_LEN,
	},
	{
		"BeaconInterval",
		offsetof(tDot11fProbeResponse, BeaconInterval),
		SigFfBeaconInterval,
		DOT11F_FF_BEACONINTERVAL_LEN,
	},
	{
		"Capabilities",
		offsetof(tDot11fProbeResponse, Capabilities),
		SigFfCapabilities,
		DOT11F_FF_CAPABILITIES_LEN,
	},
	{
...
static const tIEDefn IES_ProbeResponse[] = {
	{
		offsetof(tDot11fProbeResponse, SSID),
		offsetof(tDot11fIESSID, present),
		0,
		"SSID",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, SuppRates),
		offsetof(tDot11fIESuppRates, present),
		0,
		"SuppRates",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, DSParams),
		offsetof(tDot11fIEDSParams, present),
		0,
		"DSParams",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, CFParams),
		offsetof(tDot11fIECFParams, present),
		0,
		"CFParams",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, Country),
		offsetof(tDot11fIECountry, present),
		0,
		"Country",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, FHParams),
		offsetof(tDot11fIEFHParams, present),
		0,
		"FHParams",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, Quiet),
		offsetof(tDot11fIEQuiet, present),
		0,
		"Quiet",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, TPCReport),
		offsetof(tDot11fIETPCReport, present),
		0,
		"TPCReport",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, ERPInfo),
		offsetof(tDot11fIEERPInfo, present),
		0,
		"ERPInfo",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, RSNOpaque),
		offsetof(tDot11fIERSNOpaque, present),
		0,
		"RSNOpaque",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, QBSSLoad),
		offsetof(tDot11fIEQBSSLoad, present),
		0,
		"QBSSLoad",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, HTCaps),
		offsetof(tDot11fIEHTCaps, present),
		0,
		"HTCaps",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, HTInfo),
		offsetof(tDot11fIEHTInfo, present),
		0,
		"HTInfo",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, ExtCap),
		offsetof(tDot11fIEExtCap, present),
		0,
		"ExtCap",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, VHTCaps),
		offsetof(tDot11fIEVHTCaps, present),
		0,
		"VHTCaps",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, he_cap),
		offsetof(tDot11fIEhe_cap, present),
		0,
		"he_cap",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, he_op),
		offsetof(tDot11fIEhe_op, present),
		0,
		"he_op",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, WAPI),
		offsetof(tDot11fIEWAPI, present),
		0,
		"WAPI",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, eht_cap),
		offsetof(tDot11fIEeht_cap, present),
		0,
		"eht_cap",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, eht_op),
		offsetof(tDot11fIEeht_op, present),
		0,
		"eht_op",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, mlo_ie),
		offsetof(tDot11fIEmlo_ie, present),
		0,
		"mlo_ie",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, t2lm_ie),
		offsetof(tDot11fIEt2lm_ie, present),
		offsetof(tDot11fProbeResponse, num_t2lm_ie),
		"t2lm_ie",
		2,
		5,
		257,
	...
	{
		offsetof(tDot11fProbeResponse, WPA),
		offsetof(tDot11fIEWPA, present),
		0,
		"WPA",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, WMMInfoAp),
		offsetof(tDot11fIEWMMInfoAp, present),
		0,
		"WMMInfoAp",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, WMMParams),
		offsetof(tDot11fIEWMMParams, present),
		0,
		"WMMParams",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, WMMCaps),
		offsetof(tDot11fIEWMMCaps, present),
		0,
		"WMMCaps",
		0,
	...
	},
	{
		...
		offsetof(tDot11fIEWscProbeRes, present),
		0,
		"WscProbeRes",
		0,
		6,
	...
	},
	{
		...
		offsetof(tDot11fIEP2PProbeRes, present),
		0,
		"P2PProbeRes",
		0,
		6,
		...
		{ 80, 111, 154, 9, 0 },
		4,
		DOT11F_EID_P2PPROBERES,
		0,
		0,
	},
	{
		offsetof(tDot11fProbeResponse, Vendor1IE),
		offsetof(tDot11fIEVendor1IE, present),
		0,
		"Vendor1IE",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, Vendor3IE),
		offsetof(tDot11fIEVendor3IE, present),
		0,
		"Vendor3IE",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, MBO_IE),
		offsetof(tDot11fIEMBO_IE, present),
		0,
		"MBO_IE",
		0,
	...
	{
		offsetof(tDot11fProbeResponse, qcn_ie),
		offsetof(tDot11fIEqcn_ie, present),
		0,
		"qcn_ie",
		0,
...
uint32_t dot11f_unpack_probe_response(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint32_t nBuf, tDot11fProbeResponse *pFrm,
				      bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_ProbeResponse,
			     IES_ProbeResponse, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_QosMapConfigure[] = {
	{
		"Category",
		offsetof(tDot11fQosMapConfigure, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fQosMapConfigure, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
...
uint32_t dot11f_unpack_qos_map_configure(tpAniSirGlobal pCtx, uint8_t *pBuf,
					 uint32_t nBuf,
					 ...
					 bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_QosMapConfigure,
			     IES_QosMapConfigure, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_RadioMeasurementReport[] = {
	{
		"Category",
		offsetof(tDot11fRadioMeasurementReport, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fRadioMeasurementReport, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fRadioMeasurementReport, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
...
uint32_t dot11f_unpack_radio_measurement_report(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint32_t nBuf,
	tDot11fRadioMeasurementReport *pFrm, bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_RadioMeasurementReport,
			     IES_RadioMeasurementReport, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_RadioMeasurementRequest[] = {
	{
		"Category",
		offsetof(tDot11fRadioMeasurementRequest, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fRadioMeasurementRequest, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fRadioMeasurementRequest, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
		"NumOfRepetitions",
		offsetof(tDot11fRadioMeasurementRequest, NumOfRepetitions),
		SigFfNumOfRepetitions,
...
static const tIEDefn IES_RadioMeasurementRequest[] = {
	{
		...
		offsetof(tDot11fIEMeasurementRequest, present),
		offsetof(tDot11fRadioMeasurementRequest,
...
uint32_t dot11f_unpack_radio_measurement_request(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint32_t nBuf,
	tDot11fRadioMeasurementRequest *pFrm, bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_RadioMeasurementRequest,
			     IES_RadioMeasurementRequest, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_ReAssocRequest[] = {
	{
		"Capabilities",
		offsetof(tDot11fReAssocRequest, Capabilities),
		SigFfCapabilities,
		DOT11F_FF_CAPABILITIES_LEN,
	},
	{
		"ListenInterval",
		offsetof(tDot11fReAssocRequest, ListenInterval),
		SigFfListenInterval,
		DOT11F_FF_LISTENINTERVAL_LEN,
	},
	{
		"CurrentAPAddress",
		offsetof(tDot11fReAssocRequest, CurrentAPAddress),
		SigFfCurrentAPAddress,
		DOT11F_FF_CURRENTAPADDRESS_LEN,
	},
	{
		NULL,
		0,
...
static const tIEDefn IES_ReAssocRequest[] = {
	{
		offsetof(tDot11fReAssocRequest, SSID),
		offsetof(tDot11fIESSID, present),
		0,
		"SSID",
		0,
	...
	{
		offsetof(tDot11fReAssocRequest, FTInfo),
		offsetof(tDot11fIEFTInfo, present),
		0,
		"FTInfo",
		0,
	...
	},
	{
		...
		offsetof(tDot11fIERICDataDesc, present),
		offsetof(tDot11fReAssocRequest, num_RICDataDesc),
		"RICDataDesc",
		2,
		2,
		550,
	...
	{
		offsetof(tDot11fReAssocRequest, HTCaps),
		offsetof(tDot11fIEHTCaps, present),
		0,
		"HTCaps",
		0,
	...
	{
		offsetof(tDot11fReAssocRequest, ExtCap),
		offsetof(tDot11fIEExtCap, present),
		0,
		"ExtCap",
		0,
	...
	{
		offsetof(tDot11fReAssocRequest, VHTCaps),
		offsetof(tDot11fIEVHTCaps, present),
		0,
		"VHTCaps",
		0,
	...
	{
		offsetof(tDot11fReAssocRequest, he_cap),
		offsetof(tDot11fIEhe_cap, present),
		0,
		"he_cap",
		0,
	...
	{
		offsetof(tDot11fReAssocRequest, WAPI),
		offsetof(tDot11fIEWAPI, present),
		0,
		"WAPI",
		0,
	...
	},
	{
		...
		offsetof(tDot11fIEESECckmOpaque, present),
		0,
		"ESECckmOpaque",
		0,
		12,
	...
	{
		offsetof(tDot11fReAssocRequest, eht_cap),
		offsetof(tDot11fIEeht_cap, present),
		0,
		"eht_cap",
		0,
	...
	{
		offsetof(tDot11fReAssocRequest, mlo_ie),
		offsetof(tDot11fIEmlo_ie, present),
		0,
		"mlo_ie",
		0,
	...
	{
		offsetof(tDot11fReAssocRequest, t2lm_ie),
		offsetof(tDot11fIEt2lm_ie, present),
		offsetof(tDot11fReAssocRequest, num_t2lm_ie),
		"t2lm_ie",
		2,
		5,
		257,
	...
	{
		offsetof(tDot11fReAssocRequest, WMMCaps),
		offsetof(tDot11fIEWMMCaps, present),
		0,
		"WMMCaps",
		0,
	...
	{
		offsetof(tDot11fReAssocRequest, WMMTSPEC),
		offsetof(tDot11fIEWMMTSPEC, present),
		offsetof(tDot11fReAssocRequest, num_WMMTSPEC),
		"WMMTSPEC",
		4,
		63,
		63,
...
uint32_t dot11f_unpack_re_assoc_request(tpAniSirGlobal pCtx, uint8_t *pBuf,
					uint32_t nBuf,
					...
					bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_ReAssocRequest,
			     IES_ReAssocRequest, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_ReAssocResponse[] = {
	{
		"Capabilities",
		offsetof(tDot11fReAssocResponse, Capabilities),
		SigFfCapabilities,
		DOT11F_FF_CAPABILITIES_LEN,
	},
	{
		"Status",
		offsetof(tDot11fReAssocResponse, Status),
		SigFfStatus,
		DOT11F_FF_STATUS_LEN,
	},
	{
		"AID",
		offsetof(tDot11fReAssocResponse, AID),
		SigFfAID,
		DOT11F_FF_AID_LEN,
	},
	{
...
static const tIEDefn IES_ReAssocResponse[] = {
	...
	{
		offsetof(tDot11fReAssocResponse, RCPIIE),
		offsetof(tDot11fIERCPIIE, present),
		0,
		"RCPIIE",
		0,
	...
	{
		offsetof(tDot11fReAssocResponse, RSNIIE),
		offsetof(tDot11fIERSNIIE, present),
		0,
		"RSNIIE",
		0,
	...
	{
		offsetof(tDot11fReAssocResponse, FTInfo),
		offsetof(tDot11fIEFTInfo, present),
		0,
		"FTInfo",
		0,
	...
	},
	{
		...
		offsetof(tDot11fIERICDataDesc, present),
		offsetof(tDot11fReAssocResponse, num_RICDataDesc),
		"RICDataDesc",
		2,
		2,
		550,
	...
	{
		offsetof(tDot11fReAssocResponse, HTCaps),
		offsetof(tDot11fIEHTCaps, present),
		0,
		"HTCaps",
		0,
	...
	{
		offsetof(tDot11fReAssocResponse, HTInfo),
		offsetof(tDot11fIEHTInfo, present),
		0,
		"HTInfo",
		0,
	...
	{
		offsetof(tDot11fReAssocResponse, ExtCap),
		offsetof(tDot11fIEExtCap, present),
		0,
		"ExtCap",
		0,
	...
	{
		offsetof(tDot11fReAssocResponse, VHTCaps),
		offsetof(tDot11fIEVHTCaps, present),
		0,
		"VHTCaps",
		0,
	...
	{
		offsetof(tDot11fReAssocResponse, he_cap),
		offsetof(tDot11fIEhe_cap, present),
		0,
		"he_cap",
		0,
	...
	{
		offsetof(tDot11fReAssocResponse, he_op),
		offsetof(tDot11fIEhe_op, present),
		0,
		"he_op",
		0,
	...
	{
		offsetof(tDot11fReAssocResponse, eht_cap),
		offsetof(tDot11fIEeht_cap, present),
		0,
		"eht_cap",
		0,
	...
	{
		offsetof(tDot11fReAssocResponse, eht_op),
		offsetof(tDot11fIEeht_op, present),
		0,
		"eht_op",
		0,
	...
	{
		offsetof(tDot11fReAssocResponse, mlo_ie),
		offsetof(tDot11fIEmlo_ie, present),
		0,
		"mlo_ie",
		0,
	...
	{
		offsetof(tDot11fReAssocResponse, t2lm_ie),
		offsetof(tDot11fIEt2lm_ie, present),
		offsetof(tDot11fReAssocResponse, num_t2lm_ie),
		"t2lm_ie",
		2,
		5,
		257,
	...
	{
		offsetof(tDot11fReAssocResponse, WPA),
		offsetof(tDot11fIEWPA, present),
		0,
		"WPA",
		0,
	...
	{
		offsetof(tDot11fReAssocResponse, WMMTSPEC),
		offsetof(tDot11fIEWMMTSPEC, present),
		offsetof(tDot11fReAssocResponse, num_WMMTSPEC),
		"WMMTSPEC",
		4,
		63,
		63,
	...
	},
	{
		...
		offsetof(tDot11fIEWscReassocRes, present),
		0,
		"WscReassocRes",
		0,
		6,
	...
	{
		offsetof(tDot11fReAssocResponse, MBO_IE),
		offsetof(tDot11fIEMBO_IE, present),
		0,
		"MBO_IE",
		0,
...
uint32_t dot11f_unpack_re_assoc_response(tpAniSirGlobal pCtx, uint8_t *pBuf,
					 uint32_t nBuf,
					 ...
					 bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_ReAssocResponse,
			     IES_ReAssocResponse, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_SMPowerSave[] = {
	{
		"Category",
		offsetof(tDot11fSMPowerSave, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fSMPowerSave, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"SMPowerModeSet",
		offsetof(tDot11fSMPowerSave, SMPowerModeSet),
		SigFfSMPowerModeSet,
...
uint32_t dot11f_unpack_sm_power_save(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint32_t nBuf, tDot11fSMPowerSave *pFrm,
				     bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_SMPowerSave, IES_SMPowerSave,
			     (uint8_t *)pFrm, sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_SaQueryReq[] = {
	{
		"Category",
		offsetof(tDot11fSaQueryReq, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fSaQueryReq, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"TransactionId",
		offsetof(tDot11fSaQueryReq, TransactionId),
		SigFfTransactionId,
...
static const tIEDefn IES_SaQueryReq[] = {
	{
		offsetof(tDot11fSaQueryReq, oci),
		offsetof(tDot11fIEoci, present),
		0,
		"oci",
		0,
		5,
...
uint32_t dot11f_unpack_sa_query_req(tpAniSirGlobal pCtx, uint8_t *pBuf,
				    uint32_t nBuf, tDot11fSaQueryReq *pFrm,
				    bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_SaQueryReq, IES_SaQueryReq,
			     (uint8_t *)pFrm, sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_SaQueryRsp[] = {
	{
		"Category",
		offsetof(tDot11fSaQueryRsp, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fSaQueryRsp, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"TransactionId",
		offsetof(tDot11fSaQueryRsp, TransactionId),
		SigFfTransactionId,
		DOT11F_FF_TRANSACTIONID_LEN,
	},
	{
...
static const tIEDefn IES_SaQueryRsp[] = {
	{
		offsetof(tDot11fSaQueryRsp, oci),
		offsetof(tDot11fIEoci, present),
		0,
		"oci",
		0,
...
uint32_t dot11f_unpack_sa_query_rsp(tpAniSirGlobal pCtx, uint8_t *pBuf,
				    uint32_t nBuf, tDot11fSaQueryRsp *pFrm,
				    bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_SaQueryRsp, IES_SaQueryRsp,
			     (uint8_t *)pFrm, sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_TDLSDisReq[] = {
	{
		"Category",
		offsetof(tDot11fTDLSDisReq, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fTDLSDisReq, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fTDLSDisReq, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
...
static const tIEDefn IES_TDLSDisReq[] = {
	{
		...
		offsetof(tDot11fIELinkIdentifier, present),
		0,
		"LinkIdentifier",
		0,
		20,
...
uint32_t dot11f_unpack_tdls_dis_req(tpAniSirGlobal pCtx, uint8_t *pBuf,
				    uint32_t nBuf, tDot11fTDLSDisReq *pFrm,
				    bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_TDLSDisReq, IES_TDLSDisReq,
			     (uint8_t *)pFrm, sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_TDLSDisRsp[] = {
	{
		"Category",
		offsetof(tDot11fTDLSDisRsp, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fTDLSDisRsp, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fTDLSDisRsp, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
		"Capabilities",
		offsetof(tDot11fTDLSDisRsp, Capabilities),
		SigFfCapabilities,
		DOT11F_FF_CAPABILITIES_LEN,
	},
	{
...
static const tIEDefn IES_TDLSDisRsp[] = {
	{
		offsetof(tDot11fTDLSDisRsp, SuppRates),
		offsetof(tDot11fIESuppRates, present),
		0,
		"SuppRates",
		0,
	...
	{
		offsetof(tDot11fTDLSDisRsp, RSN),
		offsetof(tDot11fIERSN, present),
		0,
		"RSN",
		0,
	...
	{
		offsetof(tDot11fTDLSDisRsp, ExtCap),
		offsetof(tDot11fIEExtCap, present),
		0,
		"ExtCap",
		0,
	...
	{
		offsetof(tDot11fTDLSDisRsp, FTInfo),
		offsetof(tDot11fIEFTInfo, present),
		0,
		"FTInfo",
		0,
	...
	{
		offsetof(tDot11fTDLSDisRsp, RICData),
		offsetof(tDot11fIERICData, present),
		0,
		"RICData",
		0,
	...
	{
		offsetof(tDot11fTDLSDisRsp, HTCaps),
		offsetof(tDot11fIEHTCaps, present),
		0,
		"HTCaps",
		0,
	...
	},
	{
		...
		0,
		"ht2040_bss_coexistence",
		0,
		3,
		3,
		SigIeht2040_bss_coexistence,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_HT2040_BSS_COEXISTENCE,
		0,
		0,
	},
	{
	...
	{
		offsetof(tDot11fTDLSDisRsp, VHTCaps),
		offsetof(tDot11fIEVHTCaps, present),
		0,
		"VHTCaps",
		0,
	...
	{
		offsetof(tDot11fTDLSDisRsp, he_cap),
		offsetof(tDot11fIEhe_cap, present),
		0,
		"he_cap",
		0,
...
uint32_t dot11f_unpack_tdls_dis_rsp(tpAniSirGlobal pCtx, uint8_t *pBuf,
				    uint32_t nBuf, tDot11fTDLSDisRsp *pFrm,
				    bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_TDLSDisRsp, IES_TDLSDisRsp,
			     (uint8_t *)pFrm, sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_TDLSPeerTrafficInd[] = {
	{
		"Category",
		offsetof(tDot11fTDLSPeerTrafficInd, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fTDLSPeerTrafficInd, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fTDLSPeerTrafficInd, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
...
static const tIEDefn IES_TDLSPeerTrafficInd[] = {
	...
	},
	{
		...
		offsetof(tDot11fIEPTIControl, present),
		0,
		"PTIControl",
		0,
		5,
		...
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_PTICONTROL,
		0,
		0,
	},
	{
		offsetof(tDot11fTDLSPeerTrafficInd, PUBufferStatus),
		offsetof(tDot11fIEPUBufferStatus, present),
		0,
		"PUBufferStatus",
		0,
		3,
...
uint32_t dot11f_unpack_tdls_peer_traffic_ind(tpAniSirGlobal pCtx, uint8_t *pBuf,
					     uint32_t nBuf,
					     ...
					     bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_TDLSPeerTrafficInd,
			     IES_TDLSPeerTrafficInd, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_TDLSPeerTrafficRsp[] = {
	{
		"Category",
		offsetof(tDot11fTDLSPeerTrafficRsp, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fTDLSPeerTrafficRsp, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fTDLSPeerTrafficRsp, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
...
uint32_t dot11f_unpack_tdls_peer_traffic_rsp(tpAniSirGlobal pCtx, uint8_t *pBuf,
					     uint32_t nBuf,
					     ...
					     bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_TDLSPeerTrafficRsp,
			     IES_TDLSPeerTrafficRsp, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_TDLSSetupCnf[] = {
	{
		"Category",
		offsetof(tDot11fTDLSSetupCnf, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fTDLSSetupCnf, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"Status",
		offsetof(tDot11fTDLSSetupCnf, Status),
		SigFfStatus,
		DOT11F_FF_STATUS_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fTDLSSetupCnf, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
...
static const tIEDefn IES_TDLSSetupCnf[] = {
	{
		offsetof(tDot11fTDLSSetupCnf, RSN),
		offsetof(tDot11fIERSN, present),
		0,
		"RSN",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupCnf, FTInfo),
		offsetof(tDot11fIEFTInfo, present),
		0,
		"FTInfo",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupCnf, HTInfo),
		offsetof(tDot11fIEHTInfo, present),
		0,
		"HTInfo",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupCnf, WMMParams),
		offsetof(tDot11fIEWMMParams, present),
		0,
		"WMMParams",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupCnf, he_op),
		offsetof(tDot11fIEhe_op, present),
		0,
		"he_op",
		0,
...
uint32_t dot11f_unpack_tdls_setup_cnf(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint32_t nBuf, tDot11fTDLSSetupCnf *pFrm,
				      bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_TDLSSetupCnf,
			     IES_TDLSSetupCnf, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_TDLSSetupReq[] = {
	{
		"Category",
		offsetof(tDot11fTDLSSetupReq, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fTDLSSetupReq, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fTDLSSetupReq, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
		"Capabilities",
		offsetof(tDot11fTDLSSetupReq, Capabilities),
		SigFfCapabilities,
		DOT11F_FF_CAPABILITIES_LEN,
	},
	{
...
static const tIEDefn IES_TDLSSetupReq[] = {
	{
		offsetof(tDot11fTDLSSetupReq, SuppRates),
		offsetof(tDot11fIESuppRates, present),
		0,
		"SuppRates",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupReq, Country),
		offsetof(tDot11fIECountry, present),
		0,
		"Country",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupReq, RSN),
		offsetof(tDot11fIERSN, present),
		0,
		"RSN",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupReq, ExtCap),
		offsetof(tDot11fIEExtCap, present),
		0,
		"ExtCap",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupReq, FTInfo),
		offsetof(tDot11fIEFTInfo, present),
		0,
		"FTInfo",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupReq, RICData),
		offsetof(tDot11fIERICData, present),
		0,
		"RICData",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupReq, HTCaps),
		offsetof(tDot11fIEHTCaps, present),
		0,
		"HTCaps",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupReq, AID),
		offsetof(tDot11fIEAID, present),
		0,
		"AID",
		0,
		4,
	...
	{
		offsetof(tDot11fTDLSSetupReq, VHTCaps),
		offsetof(tDot11fIEVHTCaps, present),
		0,
		"VHTCaps",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupReq, he_cap),
		offsetof(tDot11fIEhe_cap, present),
		0,
		"he_cap",
		0,
...
uint32_t dot11f_unpack_tdls_setup_req(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint32_t nBuf, tDot11fTDLSSetupReq *pFrm,
				      bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_TDLSSetupReq,
			     IES_TDLSSetupReq, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_TDLSSetupRsp[] = {
	{
		"Category",
		offsetof(tDot11fTDLSSetupRsp, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fTDLSSetupRsp, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"Status",
		offsetof(tDot11fTDLSSetupRsp, Status),
		SigFfStatus,
		DOT11F_FF_STATUS_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fTDLSSetupRsp, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
		"Capabilities",
		offsetof(tDot11fTDLSSetupRsp, Capabilities),
		SigFfCapabilities,
		DOT11F_FF_CAPABILITIES_LEN,
	},
	{
...
static const tIEDefn IES_TDLSSetupRsp[] = {
	{
		offsetof(tDot11fTDLSSetupRsp, SuppRates),
		offsetof(tDot11fIESuppRates, present),
		0,
		"SuppRates",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupRsp, Country),
		offsetof(tDot11fIECountry, present),
		0,
		"Country",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupRsp, RSN),
		offsetof(tDot11fIERSN, present),
		0,
		"RSN",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupRsp, ExtCap),
		offsetof(tDot11fIEExtCap, present),
		0,
		"ExtCap",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupRsp, FTInfo),
		offsetof(tDot11fIEFTInfo, present),
		0,
		"FTInfo",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupRsp, RICData),
		offsetof(tDot11fIERICData, present),
		0,
		"RICData",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupRsp, HTCaps),
		offsetof(tDot11fIEHTCaps, present),
		0,
		"HTCaps",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupRsp, AID),
		offsetof(tDot11fIEAID, present),
		0,
		"AID",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupRsp, VHTCaps),
		offsetof(tDot11fIEVHTCaps, present),
		0,
		"VHTCaps",
		0,
	...
	{
		offsetof(tDot11fTDLSSetupRsp, he_cap),
		offsetof(tDot11fIEhe_cap, present),
		0,
		"he_cap",
		0,
...
uint32_t dot11f_unpack_tdls_setup_rsp(tpAniSirGlobal pCtx, uint8_t *pBuf,
				      uint32_t nBuf, tDot11fTDLSSetupRsp *pFrm,
				      bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_TDLSSetupRsp,
			     IES_TDLSSetupRsp, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_TDLSTeardown[] = {
	{
		"Category",
		offsetof(tDot11fTDLSTeardown, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fTDLSTeardown, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"Reason",
		offsetof(tDot11fTDLSTeardown, Reason),
		SigFfReason,
		DOT11F_FF_REASON_LEN,
	},
	{
...
static const tIEDefn IES_TDLSTeardown[] = {
	{
		offsetof(tDot11fTDLSTeardown, FTInfo),
		offsetof(tDot11fIEFTInfo, present),
		0,
		"FTInfo",
		0,
...
uint32_t dot11f_unpack_tdls_teardown(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint32_t nBuf, tDot11fTDLSTeardown *pFrm,
				     bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_TDLSTeardown,
			     IES_TDLSTeardown, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_TPCReport[] = {
	{
		"Category",
		offsetof(tDot11fTPCReport, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fTPCReport, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fTPCReport, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
...
static const tIEDefn IES_TPCReport[] = {
	{
		offsetof(tDot11fTPCReport, TPCReport),
		offsetof(tDot11fIETPCReport, present),
		0,
		"TPCReport",
		0,
...
uint32_t dot11f_unpack_tpc_report(tpAniSirGlobal pCtx, uint8_t *pBuf,
				  uint32_t nBuf, tDot11fTPCReport *pFrm,
				  bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_TPCReport, IES_TPCReport,
			     (uint8_t *)pFrm, sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_TPCRequest[] = {
	{
		"Category",
		offsetof(tDot11fTPCRequest, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fTPCRequest, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fTPCRequest, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
...
static const tIEDefn IES_TPCRequest[] = {
	{
		offsetof(tDot11fTPCRequest, TPCRequest),
		offsetof(tDot11fIETPCRequest, present),
		0,
		"TPCRequest",
		0,
		2,
...
uint32_t dot11f_unpack_tpc_request(tpAniSirGlobal pCtx, uint8_t *pBuf,
				   uint32_t nBuf, tDot11fTPCRequest *pFrm,
				   bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_TPCRequest, IES_TPCRequest,
			     (uint8_t *)pFrm, sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_TimingAdvertisementFrame[] = {
	{
		"TimeStamp",
		offsetof(tDot11fTimingAdvertisementFrame, TimeStamp),
		SigFfTimeStamp,
		DOT11F_FF_TIMESTAMP_LEN,
	},
	{
		"Capabilities",
		offsetof(tDot11fTimingAdvertisementFrame, Capabilities),
		SigFfCapabilities,
		DOT11F_FF_CAPABILITIES_LEN,
	},
	{
...
static const tIEDefn IES_TimingAdvertisementFrame[] = {
	...
	},
	{
		...
		offsetof(tDot11fIETimeAdvertisement, present),
		0,
		"TimeAdvertisement",
		0,
		18,
		18,
		SigIeTimeAdvertisement,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_TIMEADVERTISEMENT,
		0,
		0,
	},
	{
...
uint32_t dot11f_unpack_timing_advertisement_frame(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint32_t nBuf,
	tDot11fTimingAdvertisementFrame *pFrm, bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_TimingAdvertisementFrame,
			     IES_TimingAdvertisementFrame, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_VHTGidManagementActionFrame[] = {
	{
		"Category",
		offsetof(tDot11fVHTGidManagementActionFrame, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fVHTGidManagementActionFrame, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"VhtMembershipStatusArray",
		offsetof(tDot11fVHTGidManagementActionFrame,
			 VhtMembershipStatusArray),
		SigFfVhtMembershipStatusArray,
		DOT11F_FF_VHTMEMBERSHIPSTATUSARRAY_LEN,
	},
	{
		"VhtUserPositionArray",
		offsetof(tDot11fVHTGidManagementActionFrame,
			 VhtUserPositionArray),
		SigFfVhtUserPositionArray,
...
uint32_t dot11f_unpack_vht_gid_management_action_frame(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint32_t nBuf,
	tDot11fVHTGidManagementActionFrame *pFrm, bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_VHTGidManagementActionFrame,
			     IES_VHTGidManagementActionFrame, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_WMMAddTSRequest[] = {
	{
		"Category",
		offsetof(tDot11fWMMAddTSRequest, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fWMMAddTSRequest, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fWMMAddTSRequest, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
		"StatusCode",
		offsetof(tDot11fWMMAddTSRequest, StatusCode),
		SigFfStatusCode,
...
static const tIEDefn IES_WMMAddTSRequest[] = {
	{
		offsetof(tDot11fWMMAddTSRequest, WMMTSPEC),
		offsetof(tDot11fIEWMMTSPEC, present),
		0,
		"WMMTSPEC",
		0,
...
uint32_t dot11f_unpack_wmm_add_ts_request(tpAniSirGlobal pCtx, uint8_t *pBuf,
					  uint32_t nBuf,
					  ...
					  bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_WMMAddTSRequest,
			     IES_WMMAddTSRequest, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_WMMAddTSResponse[] = {
	{
		"Category",
		offsetof(tDot11fWMMAddTSResponse, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fWMMAddTSResponse, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fWMMAddTSResponse, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
		"StatusCode",
		offsetof(tDot11fWMMAddTSResponse, StatusCode),
		SigFfStatusCode,
		DOT11F_FF_STATUSCODE_LEN,
	},
	{
...
uint32_t dot11f_unpack_wmm_add_ts_response(tpAniSirGlobal pCtx, uint8_t *pBuf,
					   uint32_t nBuf,
					   ...
					   bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_WMMAddTSResponse,
			     IES_WMMAddTSResponse, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_WMMDelTS[] = {
	{
		"Category",
		offsetof(tDot11fWMMDelTS, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fWMMDelTS, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fWMMDelTS, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
		"StatusCode",
		offsetof(tDot11fWMMDelTS, StatusCode),
		SigFfStatusCode,
		DOT11F_FF_STATUSCODE_LEN,
	},
	{
...
static const tIEDefn IES_WMMDelTS[] = {
	{
		offsetof(tDot11fWMMDelTS, WMMTSPEC),
		offsetof(tDot11fIEWMMTSPEC, present),
		0,
		"WMMTSPEC",
		0,
...
uint32_t dot11f_unpack_wmm_del_ts(tpAniSirGlobal pCtx, uint8_t *pBuf,
				  uint32_t nBuf, tDot11fWMMDelTS *pFrm,
				  bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_WMMDelTS, IES_WMMDelTS,
			     (uint8_t *)pFrm, sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_addba_req[] = {
	{
		"Category",
		offsetof(tDot11faddba_req, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11faddba_req, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11faddba_req, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
		"addba_param_set",
		offsetof(tDot11faddba_req, addba_param_set),
		SigFfaddba_param_set,
		DOT11F_FF_ADDBA_PARAM_SET_LEN,
	},
	{
		"ba_timeout",
		offsetof(tDot11faddba_req, ba_timeout),
		SigFfba_timeout,
		DOT11F_FF_BA_TIMEOUT_LEN,
	},
	{
		"ba_start_seq_ctrl",
		offsetof(tDot11faddba_req, ba_start_seq_ctrl),
		SigFfba_start_seq_ctrl,
...
static const tIEDefn IES_addba_req[] = {
	{
		...
		offsetof(tDot11fIEaddba_extn_element, present),
		0,
		"addba_extn_element",
		0,
		3,
		3,
		SigIeaddba_extn_element,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_ADDBA_EXTN_ELEMENT,
		0,
		0,
	},
	{
...
uint32_t dot11f_unpack_addba_req(tpAniSirGlobal pCtx, uint8_t *pBuf,
				 uint32_t nBuf, tDot11faddba_req *pFrm,
				 bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_addba_req, IES_addba_req,
			     (uint8_t *)pFrm, sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_addba_rsp[] = {
	{
		"Category",
		offsetof(tDot11faddba_rsp, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11faddba_rsp, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11faddba_rsp, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
		"Status",
		offsetof(tDot11faddba_rsp, Status),
		SigFfStatus,
		DOT11F_FF_STATUS_LEN,
	},
	{
		"addba_param_set",
		offsetof(tDot11faddba_rsp, addba_param_set),
		SigFfaddba_param_set,
		DOT11F_FF_ADDBA_PARAM_SET_LEN,
	},
	{
		"ba_timeout",
		offsetof(tDot11faddba_rsp, ba_timeout),
		SigFfba_timeout,
		DOT11F_FF_BA_TIMEOUT_LEN,
	},
	{
...
uint32_t dot11f_unpack_addba_rsp(tpAniSirGlobal pCtx, uint8_t *pBuf,
				 uint32_t nBuf, tDot11faddba_rsp *pFrm,
				 bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_addba_rsp, IES_addba_rsp,
			     (uint8_t *)pFrm, sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_delba_req[] = {
	{
		"Category",
		offsetof(tDot11fdelba_req, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fdelba_req, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"delba_param_set",
		offsetof(tDot11fdelba_req, delba_param_set),
		SigFfdelba_param_set,
		DOT11F_FF_DELBA_PARAM_SET_LEN,
	},
	{
		"Reason",
		offsetof(tDot11fdelba_req, Reason),
		SigFfReason,
		DOT11F_FF_REASON_LEN,
	},
	{
...
uint32_t dot11f_unpack_delba_req(tpAniSirGlobal pCtx, uint8_t *pBuf,
				 uint32_t nBuf, tDot11fdelba_req *pFrm,
				 bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_delba_req, IES_delba_req,
			     (uint8_t *)pFrm, sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_epcs_neg_req[] = {
	{
		"Category",
		offsetof(tDot11fepcs_neg_req, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fepcs_neg_req, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fepcs_neg_req, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
...
uint32_t dot11f_unpack_epcs_neg_req(tpAniSirGlobal pCtx, uint8_t *pBuf,
				    uint32_t nBuf, tDot11fepcs_neg_req *pFrm,
				    bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_epcs_neg_req,
			     IES_epcs_neg_req, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_epcs_neg_rsp[] = {
	{
		"Category",
		offsetof(tDot11fepcs_neg_rsp, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fepcs_neg_rsp, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fepcs_neg_rsp, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
		"Status",
		offsetof(tDot11fepcs_neg_rsp, Status),
		SigFfStatus,
		DOT11F_FF_STATUS_LEN,
	},
	{
...
uint32_t dot11f_unpack_epcs_neg_rsp(tpAniSirGlobal pCtx, uint8_t *pBuf,
				    uint32_t nBuf, tDot11fepcs_neg_rsp *pFrm,
				    bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_epcs_neg_rsp,
			     IES_epcs_neg_rsp, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_epcs_teardown[] = {
	{
		"Category",
		offsetof(tDot11fepcs_teardown, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fepcs_teardown, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
...
uint32_t dot11f_unpack_epcs_teardown(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint32_t nBuf, tDot11fepcs_teardown *pFrm,
				     bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_epcs_teardown,
			     IES_epcs_teardown, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_ext_channel_switch_action_frame[] = {
	{
		"Category",
		offsetof(tDot11fext_channel_switch_action_frame, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fext_channel_switch_action_frame, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		...
		offsetof(tDot11fext_channel_switch_action_frame,
			 ext_chan_switch_ann_action),
		SigFfext_chan_switch_ann_action,
...
uint32_t dot11f_unpack_ext_channel_switch_action_frame(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint32_t nBuf,
	tDot11fext_channel_switch_action_frame *pFrm, bool append_ie)
{
	...
	status = unpack_core(pCtx, pBuf, nBuf,
			     FFS_ext_channel_switch_action_frame,
...
static const tIEDefn IES_ht2040_bss_coexistence_mgmt_action_frame[] = {
	...
	},
	{
		...
		offsetof(tDot11fIEht2040_bss_intolerant_report, present),
		0,
		"ht2040_bss_intolerant_report",
		0,
		3,
		53,
		SigIeht2040_bss_intolerant_report,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_HT2040_BSS_INTOLERANT_REPORT,
		0,
		1,
	},
	{
...
uint32_t dot11f_unpack_ht2040_bss_coexistence_mgmt_action_frame(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint32_t nBuf,
...
static const tFFDefn FFS_mscs_request_action_frame[] = {
	{
		"Category",
		offsetof(tDot11fmscs_request_action_frame, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11fmscs_request_action_frame, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fmscs_request_action_frame, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
...
static const tIEDefn IES_mscs_request_action_frame[] = {
	{
		...
		offsetof(tDot11fIEdescriptor_element, present),
		0,
		"descriptor_element",
		0,
		9,
		32,
		SigIedescriptor_element,
		{ 0, 0, 0, 0, 0 },
		0,
		DOT11F_EID_DESCRIPTOR_ELEMENT,
		88,
		1,
	},
	{
...
uint32_t dot11f_unpack_mscs_request_action_frame(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint32_t nBuf,
	tDot11fmscs_request_action_frame *pFrm, bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_mscs_request_action_frame,
			     IES_mscs_request_action_frame, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_p2p_oper_chan_change_confirm[] = {
	{
		"Category",
		offsetof(tDot11fp2p_oper_chan_change_confirm, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"p2p_action_oui",
		offsetof(tDot11fp2p_oper_chan_change_confirm, p2p_action_oui),
		SigFfp2p_action_oui,
		DOT11F_FF_P2P_ACTION_OUI_LEN,
	},
	{
		"p2p_action_subtype",
		offsetof(tDot11fp2p_oper_chan_change_confirm,
			 p2p_action_subtype),
		SigFfp2p_action_subtype,
		DOT11F_FF_P2P_ACTION_SUBTYPE_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11fp2p_oper_chan_change_confirm, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
...
uint32_t dot11f_unpack_p2p_oper_chan_change_confirm(
	tpAniSirGlobal pCtx, uint8_t *pBuf, uint32_t nBuf,
	tDot11fp2p_oper_chan_change_confirm *pFrm, bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_p2p_oper_chan_change_confirm,
			     IES_p2p_oper_chan_change_confirm, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
...
static const tFFDefn FFS_t2lm_neg_req[] = {
	{
		"Category",
		offsetof(tDot11ft2lm_neg_req, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11ft2lm_neg_req, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11ft2lm_neg_req, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
...
static const tIEDefn IES_t2lm_neg_req[] = {
	{
		offsetof(tDot11ft2lm_neg_req, t2lm_ie),
		offsetof(tDot11fIEt2lm_ie, present),
		offsetof(tDot11ft2lm_neg_req, num_t2lm_ie),
		"t2lm_ie",
		2,
		5,
		257,
...
uint32_t dot11f_unpack_t2lm_neg_req(tpAniSirGlobal pCtx, uint8_t *pBuf,
				    uint32_t nBuf, tDot11ft2lm_neg_req *pFrm,
				    bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_t2lm_neg_req,
			     IES_t2lm_neg_req, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_t2lm_neg_rsp[] = {
	{
		"Category",
		offsetof(tDot11ft2lm_neg_rsp, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11ft2lm_neg_rsp, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
		"DialogToken",
		offsetof(tDot11ft2lm_neg_rsp, DialogToken),
		SigFfDialogToken,
		DOT11F_FF_DIALOGTOKEN_LEN,
	},
	{
		"Status",
		offsetof(tDot11ft2lm_neg_rsp, Status),
		SigFfStatus,
		DOT11F_FF_STATUS_LEN,
	},
	{
...
uint32_t dot11f_unpack_t2lm_neg_rsp(tpAniSirGlobal pCtx, uint8_t *pBuf,
				    uint32_t nBuf, tDot11ft2lm_neg_rsp *pFrm,
				    bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_t2lm_neg_rsp,
			     IES_t2lm_neg_rsp, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_t2lm_teardown[] = {
	{
		"Category",
		offsetof(tDot11ft2lm_teardown, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"Action",
		offsetof(tDot11ft2lm_teardown, Action),
		SigFfAction,
		DOT11F_FF_ACTION_LEN,
	},
	{
...
uint32_t dot11f_unpack_t2lm_teardown(tpAniSirGlobal pCtx, uint8_t *pBuf,
				     uint32_t nBuf, tDot11ft2lm_teardown *pFrm,
				     bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_t2lm_teardown,
			     IES_t2lm_teardown, (uint8_t *)pFrm, sizeof(*pFrm),
			     append_ie);
...
static const tFFDefn FFS_vendor_action_frame[] = {
	{
		"Category",
		offsetof(tDot11fvendor_action_frame, Category),
		SigFfCategory,
		DOT11F_FF_CATEGORY_LEN,
	},
	{
		"vendor_oui",
		offsetof(tDot11fvendor_action_frame, vendor_oui),
		SigFfvendor_oui,
		DOT11F_FF_VENDOR_OUI_LEN,
	},
	{
		"vendor_action_subtype",
		offsetof(tDot11fvendor_action_frame, vendor_action_subtype),
		SigFfvendor_action_subtype,
...
uint32_t dot11f_unpack_vendor_action_frame(tpAniSirGlobal pCtx, uint8_t *pBuf,
					   uint32_t nBuf,
					   ...
					   bool append_ie)
{
	uint32_t i = 0;
	uint32_t status = 0;
	status = unpack_core(pCtx, pBuf, nBuf, FFS_vendor_action_frame,
			     IES_vendor_action_frame, (uint8_t *)pFrm,
			     sizeof(*pFrm), append_ie);
			    ...
			    uint8_t *pFrm, size_t nFrm, bool append_ie)
{
	...
	while (!append_ie && pFf->size) {
		...
		case SigFfAID:
			dot11f_unpack_ff_common_func(
				pCtx, pBufRemaining,
				(uint16_t *)&(
					((tDot11fFfAID *)(pFrm + pFf->offset))
						->associd));
			break;
		case SigFfAction:
			dot11f_unpack_ff_action(
				pCtx, pBufRemaining,
				(tDot11fFfAction *)(pFrm + pFf->offset));
			break;
		case SigFfAuthAlgo:
			dot11f_unpack_ff_common_func(
				pCtx, pBufRemaining,
				(uint16_t *)&(
					((tDot11fFfAuthAlgo *)(pFrm +
							       pFf->offset))
						->algo));
			break;
		case SigFfAuthSeqNo:
		...
		case SigFfBeaconInterval:
			dot11f_unpack_ff_common_func(
				pCtx, pBufRemaining,
				(uint16_t *)&(((tDot11fFfBeaconInterval
							*)(pFrm + pFf->offset))
						      ->interval));
			break;
		case SigFfCapabilities:
			dot11f_unpack_ff_capabilities(
				pCtx, pBufRemaining,
				(tDot11fFfCapabilities *)(pFrm + pFf->offset));
			break;
		case SigFfCategory:
			dot11f_unpack_ff_category(
				pCtx, pBufRemaining,
				(tDot11fFfCategory *)(pFrm + pFf->offset));
			break;
		case SigFfCurrentAPAddress:
			dot11f_unpack_ff_current_ap_address(
				pCtx, pBufRemaining,
				(tDot11fFfCurrentAPAddress *)(pFrm +
							      pFf->offset));
			break;
		case SigFfDialogToken:
			dot11f_unpack_ff_dialog_token(
				pCtx, pBufRemaining,
				(tDot11fFfDialogToken *)(pFrm + pFf->offset));
			break;
		case SigFfLinkMargin:
			dot11f_unpack_ff_link_margin(
				pCtx, pBufRemaining,
				(tDot11fFfLinkMargin *)(pFrm + pFf->offset));
			break;
		case SigFfListenInterval:
			dot11f_unpack_ff_common_func(
				pCtx, pBufRemaining,
				(uint16_t *)&(((tDot11fFfListenInterval
							*)(pFrm + pFf->offset))
						      ->interval));
			break;
		case SigFfMaxTxPower:
			dot11f_unpack_ff_max_tx_power(
				pCtx, pBufRemaining,
				(tDot11fFfMaxTxPower *)(pFrm + pFf->offset));
			break;
		case SigFfNumOfRepetitions:
			dot11f_unpack_ff_num_of_repetitions(
				pCtx, pBufRemaining,
				(tDot11fFfNumOfRepetitions *)(pFrm +
							      pFf->offset));
			break;
		case SigFfOperatingMode:
			dot11f_unpack_ff_operating_mode(
				pCtx, pBufRemaining,
				(tDot11fFfOperatingMode *)(pFrm + pFf->offset));
			break;
		case SigFfRCPI:
			dot11f_unpack_ff_rcpi(
				pCtx, pBufRemaining,
				(tDot11fFfRCPI *)(pFrm + pFf->offset));
			break;
		case SigFfRSNI:
			dot11f_unpack_ff_rsni(
				pCtx, pBufRemaining,
				(tDot11fFfRSNI *)(pFrm + pFf->offset));
			break;
		case SigFfReason:
			dot11f_unpack_ff_common_func(
				pCtx, pBufRemaining,
				(uint16_t *)&(((tDot11fFfReason *)(pFrm +
								   pFf->offset))
						      ->code));
			break;
		case SigFfRxAntennaId:
			dot11f_unpack_ff_rx_antenna_id(
				pCtx, pBufRemaining,
				(tDot11fFfRxAntennaId *)(pFrm + pFf->offset));
			break;
		case SigFfSMPowerModeSet:
			dot11f_unpack_ff_sm_power_mode_set(
				pCtx, pBufRemaining,
				(tDot11fFfSMPowerModeSet *)(pFrm +
							    pFf->offset));
			break;
		case SigFfStatus:
			dot11f_unpack_ff_common_func(
				pCtx, pBufRemaining,
				(uint16_t *)&(((tDot11fFfStatus *)(pFrm +
								   pFf->offset))
						      ->status));
			break;
		case SigFfStatusCode:
			dot11f_unpack_ff_status_code(
				pCtx, pBufRemaining,
				(tDot11fFfStatusCode *)(pFrm + pFf->offset));
			break;
		case SigFfTPCEleID:
			dot11f_unpack_ff_tpc_ele_id(
				pCtx, pBufRemaining,
				(tDot11fFfTPCEleID *)(pFrm + pFf->offset));
			break;
		case SigFfTPCEleLen:
			dot11f_unpack_ff_tpc_ele_len(
				pCtx, pBufRemaining,
				(tDot11fFfTPCEleLen *)(pFrm + pFf->offset));
			break;
		case SigFfTSInfo:
			dot11f_unpack_ff_ts_info(
				pCtx, pBufRemaining,
				(tDot11fFfTSInfo *)(pFrm + pFf->offset));
			break;
		case SigFfTimeStamp:
			dot11f_unpack_ff_time_stamp(
				pCtx, pBufRemaining,
				(tDot11fFfTimeStamp *)(pFrm + pFf->offset));
			break;
		case SigFfTransactionId:
			dot11f_unpack_ff_transaction_id(
				pCtx, pBufRemaining,
				(tDot11fFfTransactionId *)(pFrm + pFf->offset));
			break;
		case SigFfTxAntennaId:
			dot11f_unpack_ff_tx_antenna_id(
				pCtx, pBufRemaining,
				(tDot11fFfTxAntennaId *)(pFrm + pFf->offset));
			break;
		case SigFfTxPower:
			dot11f_unpack_ff_tx_power(
				pCtx, pBufRemaining,
				(tDot11fFfTxPower *)(pFrm + pFf->offset));
			break;
		case SigFfVhtMembershipStatusArray:
			dot11f_unpack_ff_vht_membership_status_array(
				pCtx, pBufRemaining,
		...
		case SigFfVhtUserPositionArray:
			dot11f_unpack_ff_vht_user_position_array(
				pCtx, pBufRemaining,
				(tDot11fFfVhtUserPositionArray *)(pFrm +
								  pFf->offset));
			break;
		case SigFfaddba_param_set:
			dot11f_unpack_ff_addba_param_set(
				pCtx, pBufRemaining,
				(tDot11fFfaddba_param_set *)(pFrm +
							     pFf->offset));
			break;
		case SigFfba_start_seq_ctrl:
			dot11f_unpack_ff_ba_start_seq_ctrl(
				pCtx, pBufRemaining,
				(tDot11fFfba_start_seq_ctrl *)(pFrm +
							       pFf->offset));
			break;
		case SigFfba_timeout:
			dot11f_unpack_ff_ba_timeout(
				pCtx, pBufRemaining,
				(tDot11fFfba_timeout *)(pFrm + pFf->offset));
			break;
		case SigFfdelba_param_set:
			dot11f_unpack_ff_delba_param_set(
				pCtx, pBufRemaining,
				(tDot11fFfdelba_param_set *)(pFrm +
							     pFf->offset));
			break;
		case SigFfext_chan_switch_ann_action:
			dot11f_unpack_ff_ext_chan_switch_ann_action(
				pCtx, pBufRemaining,
				(tDot11fFfext_chan_switch_ann_action
					 *)(pFrm + pFf->offset));
			break;
		case SigFfp2p_action_oui:
			dot11f_unpack_ff_p2p_action_oui(
				pCtx, pBufRemaining,
				(tDot11fFfp2p_action_oui *)(pFrm +
							    pFf->offset));
			break;
		case SigFfp2p_action_subtype:
			dot11f_unpack_ff_p2p_action_subtype(
				pCtx, pBufRemaining,
				(tDot11fFfp2p_action_subtype *)(pFrm +
								pFf->offset));
			break;
		case SigFfvendor_action_subtype:
			dot11f_unpack_ff_vendor_action_subtype(
				pCtx, pBufRemaining,
				(tDot11fFfvendor_action_subtype *)(pFrm +
								   pFf->offset));
			break;
		case SigFfvendor_oui:
			dot11f_unpack_ff_vendor_oui(
				pCtx, pBufRemaining,
				(tDot11fFfvendor_oui *)(pFrm + pFf->offset));
			break;
		default:
			FRAMES_LOG1(
				pCtx, FRLOGE,
				FRFL("INTERNAL ERROR: I don'"
	...
	while (nBufRemaining) {
		...
		if (len > nBufRemaining) {
			FRAMES_LOG4(
				pCtx, FRLOGW,
				FRFL("IE %d extn id %d reports length %"
		...
		if (pIe) {
			if ((nBufRemaining < pIe->minSize - pIe->noui - 2U)) {
				...
				countOffset =
					((0 != pIe->arraybound) *
					 (*(uint16_t *)(pFrm +
							pIe->countOffset)));
				if (0 != pIe->arraybound &&
				    countOffset >= pIe->arraybound) {
					status |= DOT11F_DUPLICATE_IE;
					goto skip_ie;
				}
				switch (pIe->sig) {
				case SigIeGTK:
					status |= dot11f_unpack_ie_gtk(
				...
				case SigIeIGTK:
					...
					break;
				case SigIeR0KH_ID:
					status |= dot11f_unpack_ie_r0_kh_id(
						pCtx, pBufRemaining, len,
						(tDot11fIER0KH_ID
							 *)(pFrm + pIe->offset +
					...
					break;
				case SigIeR1KH_ID:
					status |= dot11f_unpack_ie_r1_kh_id(
						pCtx, pBufRemaining, len,
						(tDot11fIER1KH_ID
							 *)(pFrm + pIe->offset +
				...
				case SigIeAPChannelReport:
					status |= dot11f_unpack_ie_ap_channel_report(
						pCtx, pBufRemaining, len,
				...
				case SigIeBcnReportingDetail:
					status |= dot11f_unpack_ie_bcn_reporting_detail(
						pCtx, pBufRemaining, len,
				...
				case SigIeBeaconReportFrmBody:
					status |= dot11f_unpack_ie_beacon_report_frm_body(
						pCtx, pBufRemaining, len,
				...
				case SigIeBeaconReporting:
					status |= dot11f_unpack_ie_beacon_reporting(
						pCtx, pBufRemaining, len,
				...
				case SigIeCondensedCountryStr:
					status |= dot11f_unpack_ie_condensed_country_str(
						pCtx, pBufRemaining, len,
				...
				case SigIeMeasurementPilot:
					status |= dot11f_unpack_ie_measurement_pilot(
						pCtx, pBufRemaining, len,
				...
				case SigIeMultiBssid:
					status |= dot11f_unpack_ie_multi_bssid(
						pCtx, pBufRemaining, len,
						(tDot11fIEMultiBssid
							 *)(pFrm + pIe->offset +
					...
					break;
				case SigIeRICData:
					status |= dot11f_unpack_ie_ric_data(
						pCtx, pBufRemaining, len,
						(tDot11fIERICData
							 *)(pFrm + pIe->offset +
				...
				case SigIeRICDescriptor:
					status |= dot11f_unpack_ie_ric_descriptor(
						pCtx, pBufRemaining, len,
				...
				case SigIeRRMEnabledCap:
					status |= dot11f_unpack_ie_rrm_enabled_cap(
						pCtx, pBufRemaining, len,
				...
				case SigIeRequestedInfo:
					status |= dot11f_unpack_ie_requested_info(
						pCtx, pBufRemaining, len,
				...
				case SigIeSSID:
					...
					break;
				case SigIeSchedule:
					status |= dot11f_unpack_ie_schedule(
						pCtx, pBufRemaining, len,
						(tDot11fIESchedule
							 *)(pFrm + pIe->offset +
				...
				case SigIeTCLASSPROC:
					status |= dot11f_unpack_ie_common_func(
						pCtx, pBufRemaining, len,
						(uint8_t *)&(
							((tDot11fIETCLASSPROC
								  *)(pFrm +
								     pIe->offset +
								     sizeof(tDot11fIETCLASSPROC) *
									     countOffset))
								->present),
						(uint8_t *)&(
							((tDot11fIETCLASSPROC
					...
					break;
				case SigIeTSDelay:
					status |= dot11f_unpack_ie_ts_delay(
						pCtx, pBufRemaining, len,
						(tDot11fIETSDelay
							 *)(pFrm + pIe->offset +
					...
					break;
				case SigIeTSFInfo:
					status |= dot11f_unpack_ie_tsf_info(
						pCtx, pBufRemaining, len,
						(tDot11fIETSFInfo
							 *)(pFrm + pIe->offset +
				...
				case SigIeTSPEC:
					...
					break;
				case SigIeVHTCaps:
					status |= dot11f_unpack_ie_vht_caps(
						pCtx, pBufRemaining, len,
						(tDot11fIEVHTCaps
							 *)(pFrm + pIe->offset +
				...
				case SigIeVHTOperation:
					status |= dot11f_unpack_ie_vht_operation(
						pCtx, pBufRemaining, len,
				...
				case SigIeWMMSchedule:
					status |= dot11f_unpack_ie_wmm_schedule(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIeWMMTCLAS:
					status |= dot11f_unpack_ie_wmmtclas(
						pCtx, pBufRemaining, len,
						(tDot11fIEWMMTCLAS
							 *)(pFrm + pIe->offset +
				...
				case SigIeWMMTCLASPROC:
					status |= dot11f_unpack_ie_wmmtclasproc(
						pCtx, pBufRemaining, len,
				...
				case SigIeWMMTSDelay:
					status |= dot11f_unpack_ie_wmmts_delay(
						pCtx, pBufRemaining, len,
						(tDot11fIEWMMTSDelay
							 *)(pFrm + pIe->offset +
					...
					break;
				case SigIeWMMTSPEC:
					status |= dot11f_unpack_ie_wmmtspec(
						pCtx, pBufRemaining, len,
						(tDot11fIEWMMTSPEC
							 *)(pFrm + pIe->offset +
				...
				case SigIeWiderBWChanSwitchAnn:
					status |= dot11f_unpack_ie_wider_bw_chan_switch_ann(
						pCtx, pBufRemaining, len,
				...
				case SigIeazimuth_req:
					status |= dot11f_unpack_ie_azimuth_req(
						pCtx, pBufRemaining, len,
				...
				case SigIebeacon_report_frm_body_fragment_id:
					status |= dot11f_unpack_ie_beacon_report_frm_body_fragment_id(
						pCtx, pBufRemaining, len,
				...
				case SigIelast_beacon_report_indication:
					status |= dot11f_unpack_ie_last_beacon_report_indication(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIemax_age:
					status |= dot11f_unpack_ie_max_age(
						pCtx, pBufRemaining, len,
						(tDot11fIEmax_age
							 *)(pFrm + pIe->offset +
				...
				case SigIemscs_status:
					status |= dot11f_unpack_ie_mscs_status(
						pCtx, pBufRemaining, len,
				...
				case SigIeneighbor_rpt:
					status |= dot11f_unpack_ie_neighbor_rpt(
						pCtx, pBufRemaining, len,
				...
				case SigIereq_mac_addr:
					status |= dot11f_unpack_ie_req_mac_addr(
						pCtx, pBufRemaining, len,
				...
				case SigIetclas_mask:
					status |= dot11f_unpack_ie_tclas_mask(
						pCtx, pBufRemaining, len,
						(tDot11fIEtclas_mask
							 *)(pFrm + pIe->offset +
				...
				case SigIetgt_mac_addr:
					status |= dot11f_unpack_ie_tgt_mac_addr(
						pCtx, pBufRemaining, len,
				...
				case SigIetransmit_power_env:
					status |= dot11f_unpack_ie_transmit_power_env(
						pCtx, pBufRemaining, len,
				...
				case SigIeAID:
					...
					break;
				case SigIeCFParams:
					status |= dot11f_unpack_ie_cf_params(
						pCtx, pBufRemaining, len,
						(tDot11fIECFParams
							 *)(pFrm + pIe->offset +
				...
				case SigIeChallengeText:
					status |= dot11f_unpack_ie_challenge_text(
						pCtx, pBufRemaining, len,
				...
				case SigIeChanSwitchAnn:
					status |= dot11f_unpack_ie_chan_switch_ann(
						pCtx, pBufRemaining, len,
				...
				case SigIeChannelSwitchWrapper:
					status |= dot11f_unpack_ie_channel_switch_wrapper(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIeCountry:
					status |= dot11f_unpack_ie_country(
						pCtx, pBufRemaining, len,
						(tDot11fIECountry
							 *)(pFrm + pIe->offset +
				...
				case SigIeEDCAParamSet:
					status |= dot11f_unpack_ie_edca_param_set(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIeERPInfo:
					status |= dot11f_unpack_ie_erp_info(
						pCtx, pBufRemaining, len,
						(tDot11fIEERPInfo
							 *)(pFrm + pIe->offset +
				...
				case SigIeESECckmOpaque:
					status |= dot11f_unpack_ie_ese_cckm_opaque(
						pCtx, pBufRemaining, len,
				...
				case SigIeESERadMgmtCap:
					status |= dot11f_unpack_ie_ese_rad_mgmt_cap(
						pCtx, pBufRemaining, len,
				...
				case SigIeESETrafStrmMet:
					status |= dot11f_unpack_ie_ese_traf_strm_met(
						pCtx, pBufRemaining, len,
				...
				case SigIeESETrafStrmRateSet:
					status |= dot11f_unpack_ie_ese_traf_strm_rate_set(
						pCtx, pBufRemaining, len,
				...
				case SigIeESETxmitPower:
					status |= dot11f_unpack_ie_ese_txmit_power(
						pCtx, pBufRemaining, len,
				...
				case SigIeESEVersion:
					status |= dot11f_unpack_ie_ese_version(
						pCtx, pBufRemaining, len,
						(tDot11fIEESEVersion
							 *)(pFrm + pIe->offset +
					...
					break;
				case SigIeExtCap:
					status |= dot11f_unpack_ie_ext_cap(
						pCtx, pBufRemaining, len,
						(tDot11fIEExtCap
							 *)(pFrm + pIe->offset +
				...
				case SigIeExtSuppRates:
					status |= dot11f_unpack_ie_ext_supp_rates(
						pCtx, pBufRemaining, len,
				...
				case SigIeFHParamSet:
					status |= dot11f_unpack_ie_fh_param_set(
						pCtx, pBufRemaining, len,
						(tDot11fIEFHParamSet
							 *)(pFrm + pIe->offset +
					...
					break;
				case SigIeFHParams:
					status |= dot11f_unpack_ie_fh_params(
						pCtx, pBufRemaining, len,
						(tDot11fIEFHParams
							 *)(pFrm + pIe->offset +
				...
				case SigIeFHPattTable:
					...
					break;
				case SigIeFTInfo:
					status |= dot11f_unpack_ie_ft_info(
						pCtx, pBufRemaining, len,
						(tDot11fIEFTInfo
							 *)(pFrm + pIe->offset +
					...
					break;
				case SigIeHTCaps:
					status |= dot11f_unpack_ie_ht_caps(
						pCtx, pBufRemaining, len,
						(tDot11fIEHTCaps
							 *)(pFrm + pIe->offset +
					...
					break;
				case SigIeHTInfo:
					status |= dot11f_unpack_ie_ht_info(
						pCtx, pBufRemaining, len,
						(tDot11fIEHTInfo
							 *)(pFrm + pIe->offset +
				...
				case SigIeLinkIdentifier:
					status |= dot11f_unpack_ie_link_identifier(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIeMBO_IE:
					status |= dot11f_unpack_ie_MBO_IE(
						pCtx, pBufRemaining, len,
						(tDot11fIEMBO_IE
							 *)(pFrm + pIe->offset +
				...
				case SigIeMeasurementReport:
					status |= dot11f_unpack_ie_measurement_report(
						pCtx, pBufRemaining, len,
				...
				case SigIeMeasurementRequest:
					status |= dot11f_unpack_ie_measurement_request(
						pCtx, pBufRemaining, len,
				...
				case SigIeMobilityDomain:
					status |= dot11f_unpack_ie_mobility_domain(
						pCtx, pBufRemaining, len,
				...
				case SigIeNeighborReport:
					status |= dot11f_unpack_ie_neighbor_report(
						pCtx, pBufRemaining, len,
				...
				case SigIeOBSSScanParameters:
					status |= dot11f_unpack_ie_obss_scan_parameters(
						pCtx, pBufRemaining, len,
				...
				case SigIeOperatingMode:
					status |= dot11f_unpack_ie_operating_mode(
						pCtx, pBufRemaining, len,
				...
				case SigIeP2PAssocReq:
					status |= dot11f_unpack_ie_p2_p_assoc_req(
						pCtx, pBufRemaining, len,
				...
				case SigIeP2PAssocRes:
					status |= dot11f_unpack_ie_p2_p_assoc_res(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIeP2PBeacon:
					status |= dot11f_unpack_ie_p2_p_beacon(
						pCtx, pBufRemaining, len,
						(tDot11fIEP2PBeacon
							 *)(pFrm + pIe->offset +
				...
				case SigIeP2PBeaconProbeRes:
					status |= dot11f_unpack_ie_p2_p_beacon_probe_res(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIeP2PDeAuth:
					status |= dot11f_unpack_ie_p2_p_de_auth(
						pCtx, pBufRemaining, len,
						(tDot11fIEP2PDeAuth
							 *)(pFrm + pIe->offset +
				...
				case SigIeP2PDisAssoc:
					status |= dot11f_unpack_ie_p2_p_dis_assoc(
						pCtx, pBufRemaining, len,
				...
				case SigIeP2PIEOpaque:
					status |= dot11f_unpack_ie_p2_pie_opaque(
						pCtx, pBufRemaining, len,
				...
				case SigIeP2PProbeReq:
					status |= dot11f_unpack_ie_p2_p_probe_req(
						pCtx, pBufRemaining, len,
				...
				case SigIeP2PProbeRes:
					status |= dot11f_unpack_ie_p2_p_probe_res(
						pCtx, pBufRemaining, len,
				...
				case SigIePTIControl:
					status |= dot11f_unpack_ie_pti_control(
						pCtx, pBufRemaining, len,
						(tDot11fIEPTIControl
							 *)(pFrm + pIe->offset +
				...
				case SigIePUBufferStatus:
					status |= dot11f_unpack_ie_pu_buffer_status(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIePowerCaps:
					status |= dot11f_unpack_ie_power_caps(
						pCtx, pBufRemaining, len,
						(tDot11fIEPowerCaps
							 *)(pFrm + pIe->offset +
				...
				case SigIePowerConstraints:
					status |= dot11f_unpack_ie_power_constraints(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIeQBSSLoad:
					status |= dot11f_unpack_ie_qbss_load(
						pCtx, pBufRemaining, len,
						(tDot11fIEQBSSLoad
							 *)(pFrm + pIe->offset +
				...
				case SigIeQComVendorIE:
					status |= dot11f_unpack_ie_QComVendorIE(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIeQOSCapsAp:
					status |= dot11f_unpack_ie_qos_caps_ap(
						pCtx, pBufRemaining, len,
						(tDot11fIEQOSCapsAp
							 *)(pFrm + pIe->offset +
				...
				case SigIeQOSCapsStation:
					status |= dot11f_unpack_ie_qos_caps_station(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIeQosMapSet:
					status |= dot11f_unpack_ie_qos_map_set(
						pCtx, pBufRemaining, len,
						(tDot11fIEQosMapSet
							 *)(pFrm + pIe->offset +
				...
				case SigIeQuiet:
					...
					break;
				case SigIeRCPIIE:
					status |= dot11f_unpack_ie_rcpiie(
						pCtx, pBufRemaining, len,
						(tDot11fIERCPIIE
							 *)(pFrm + pIe->offset +
				...
				case SigIeRICDataDesc:
					/* reset the pointers back since this is a container IE and it doesn't
           * have its own EID and Len. */
					pBufRemaining -= 2;
					nBufRemaining += 2;
					if (pIe && pIe->noui) {
						pBufRemaining -= pIe->noui;
					...
					if (status != DOT11F_PARSE_SUCCESS &&
						...
						break;
					status |= dot11f_unpack_ie_ric_data_desc(
						pCtx, pBufRemaining, len,
				...
				case SigIeRSN:
					...
					break;
				case SigIeRSNIIE:
					status |= dot11f_unpack_ie_rsniie(
						pCtx, pBufRemaining, len,
						(tDot11fIERSNIIE
							 *)(pFrm + pIe->offset +
					...
					break;
				case SigIeRSNOpaque:
					status |= dot11f_unpack_ie_rsn_opaque(
						pCtx, pBufRemaining, len,
						(tDot11fIERSNOpaque
							 *)(pFrm + pIe->offset +
				...
				case SigIeSuppChannels:
					status |= dot11f_unpack_ie_supp_channels(
						pCtx, pBufRemaining, len,
				...
				case SigIeSuppOperatingClasses:
					status |= dot11f_unpack_ie_supp_operating_classes(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIeSuppRates:
					status |= dot11f_unpack_ie_supp_rates(
						pCtx, pBufRemaining, len,
						(tDot11fIESuppRates
							 *)(pFrm + pIe->offset +
				...
				case SigIeTIM:
					...
					break;
				case SigIeTPCReport:
					status |= dot11f_unpack_ie_tpc_report(
						pCtx, pBufRemaining, len,
						(tDot11fIETPCReport
							 *)(pFrm + pIe->offset +
				...
				case SigIeTPCRequest:
					status |= dot11f_unpack_ie_tpc_request(
						pCtx, pBufRemaining, len,
						(tDot11fIETPCRequest
							 *)(pFrm + pIe->offset +
				...
				case SigIeTimeAdvertisement:
					status |= dot11f_unpack_ie_time_advertisement(
						pCtx, pBufRemaining, len,
				...
				case SigIeTimeoutInterval:
					status |= dot11f_unpack_ie_timeout_interval(
						pCtx, pBufRemaining, len,
				...
				case SigIeVHTExtBssLoad:
					status |= dot11f_unpack_ie_vht_ext_bss_load(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIeVendor1IE:
					status |= dot11f_unpack_ie_vendor1_ie(
						pCtx, pBufRemaining, len,
						(tDot11fIEVendor1IE
							 *)(pFrm + pIe->offset +
					...
					break;
				case SigIeVendor3IE:
					status |= dot11f_unpack_ie_vendor3_ie(
						pCtx, pBufRemaining, len,
						(tDot11fIEVendor3IE
							 *)(pFrm + pIe->offset +
				...
				case SigIeWAPIOpaque:
					status |= dot11f_unpack_ie_wapi_opaque(
						pCtx, pBufRemaining, len,
						(tDot11fIEWAPIOpaque
							 *)(pFrm + pIe->offset +
					...
					break;
				case SigIeWFATPC:
					status |= dot11f_unpack_ie_wfatpc(
						pCtx, pBufRemaining, len,
						(tDot11fIEWFATPC
							 *)(pFrm + pIe->offset +
				...
				case SigIeWFDIEOpaque:
					status |= dot11f_unpack_ie_wfdie_opaque(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIeWMMCaps:
					status |= dot11f_unpack_ie_wmm_caps(
						pCtx, pBufRemaining, len,
						(tDot11fIEWMMCaps
							 *)(pFrm + pIe->offset +
					...
					break;
				case SigIeWMMInfoAp:
					status |= dot11f_unpack_ie_wmm_info_ap(
						pCtx, pBufRemaining, len,
						(tDot11fIEWMMInfoAp
							 *)(pFrm + pIe->offset +
				...
				case SigIeWMMInfoStation:
					status |= dot11f_unpack_ie_wmm_info_station(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIeWMMParams:
					status |= dot11f_unpack_ie_wmm_params(
						pCtx, pBufRemaining, len,
						(tDot11fIEWMMParams
							 *)(pFrm + pIe->offset +
				...
				case SigIeWPA:
					...
					break;
				case SigIeWPAOpaque:
					status |= dot11f_unpack_ie_wpa_opaque(
						pCtx, pBufRemaining, len,
						(tDot11fIEWPAOpaque
							 *)(pFrm + pIe->offset +
				...
				case SigIeWscAssocReq:
					status |= dot11f_unpack_ie_wsc_assoc_req(
						pCtx, pBufRemaining, len,
				...
				case SigIeWscAssocRes:
					status |= dot11f_unpack_ie_wsc_assoc_res(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIeWscBeacon:
					status |= dot11f_unpack_ie_wsc_beacon(
						pCtx, pBufRemaining, len,
						(tDot11fIEWscBeacon
							 *)(pFrm + pIe->offset +
				...
				case SigIeWscBeaconProbeRes:
					status |= dot11f_unpack_ie_wsc_beacon_probe_res(
						pCtx, pBufRemaining, len,
				...
				case SigIeWscIEOpaque:
					status |= dot11f_unpack_ie_wsc_ie_opaque(
						pCtx, pBufRemaining, len,
				...
				case SigIeWscProbeReq:
					status |= dot11f_unpack_ie_wsc_probe_req(
						pCtx, pBufRemaining, len,
				...
				case SigIeWscProbeRes:
					status |= dot11f_unpack_ie_wsc_probe_res(
						pCtx, pBufRemaining, len,
				...
				case SigIeWscReassocRes:
					status |= dot11f_unpack_ie_wsc_reassoc_res(
						pCtx, pBufRemaining, len,
				...
				case SigIeaddba_extn_element:
					status |= dot11f_unpack_ie_addba_extn_element(
						pCtx, pBufRemaining, len,
				...
				case SigIebss_color_change:
					status |= dot11f_unpack_ie_bss_color_change(
						pCtx, pBufRemaining, len,
				...
				case SigIebss_max_idle_period:
					status |= dot11f_unpack_ie_bss_max_idle_period(
						pCtx, pBufRemaining, len,
				...
				case SigIedh_parameter_element:
					...
					break;
				case SigIeeht_cap:
					status |= dot11f_unpack_ie_eht_cap(
						pCtx, pBufRemaining, len,
						(tDot11fIEeht_cap
							 *)(pFrm + pIe->offset +
					...
					break;
				case SigIeeht_op:
					status |= dot11f_unpack_ie_eht_op(
						pCtx, pBufRemaining, len,
						(tDot11fIEeht_op
							 *)(pFrm + pIe->offset +
				...
				case SigIeesp_information:
					status |= dot11f_unpack_ie_esp_information(
						pCtx, pBufRemaining, len,
				...
				case SigIeext_chan_switch_ann:
					status |= dot11f_unpack_ie_ext_chan_switch_ann(
						pCtx, pBufRemaining, len,
				...
				case SigIefils_hlp_container:
					status |= dot11f_unpack_ie_fils_hlp_container(
						pCtx, pBufRemaining, len,
				...
				case SigIefils_indication:
					status |= dot11f_unpack_ie_fils_indication(
						pCtx, pBufRemaining, len,
				...
				case SigIefils_nonce:
					status |= dot11f_unpack_ie_fils_nonce(
						pCtx, pBufRemaining, len,
						(tDot11fIEfils_nonce
							 *)(pFrm + pIe->offset +
				...
				case SigIefils_public_key:
					status |= dot11f_unpack_ie_fils_public_key(
						pCtx, pBufRemaining, len,
				...
				case SigIefils_session:
					status |= dot11f_unpack_ie_fils_session(
						pCtx, pBufRemaining, len,
				...
				case SigIefils_wrapped_data:
					status |= dot11f_unpack_ie_fils_wrapped_data(
						pCtx, pBufRemaining, len,
				...
				case SigIefragment_ie:
					status |= dot11f_unpack_ie_fragment_ie(
						pCtx, pBufRemaining, len,
				...
				case SigIehe_6ghz_band_cap:
					status |= dot11f_unpack_ie_he_6ghz_band_cap(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIehe_cap:
					status |= dot11f_unpack_ie_he_cap(
						pCtx, pBufRemaining, len,
						(tDot11fIEhe_cap
							 *)(pFrm + pIe->offset +
				...
				case SigIehs20vendor_ie:
					status |= dot11f_unpack_ie_hs20vendor_ie(
						pCtx, pBufRemaining, len,
				...
				case SigIeht2040_bss_coexistence:
					status |= dot11f_unpack_ie_ht2040_bss_coexistence(
						pCtx, pBufRemaining, len,
				...
				case SigIeht2040_bss_intolerant_report:
					status |= dot11f_unpack_ie_ht2040_bss_intolerant_report(
						pCtx, pBufRemaining, len,
				...
				case SigIemax_chan_switch_time:
					status |= dot11f_unpack_ie_max_chan_switch_time(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIemlo_ie:
					status |= dot11f_unpack_ie_mlo_ie(
						pCtx, pBufRemaining, len,
						(tDot11fIEmlo_ie
							 *)(pFrm + pIe->offset +
				...
				case SigIemu_edca_param_set:
					status |= dot11f_unpack_ie_mu_edca_param_set(
						pCtx, pBufRemaining, len,
				...
				case SigIenon_inheritance:
					status |= dot11f_unpack_ie_non_inheritance(
						pCtx, pBufRemaining, len,
				...
				case SigIeoci:
					...
					break;
				case SigIeosen_ie:
					status |= dot11f_unpack_ie_osen_ie(
						pCtx, pBufRemaining, len,
						(tDot11fIEosen_ie
							 *)(pFrm + pIe->offset +
					...
					break;
				case SigIeqcn_ie:
					status |= dot11f_unpack_ie_qcn_ie(
						pCtx, pBufRemaining, len,
						(tDot11fIEqcn_ie
							 *)(pFrm + pIe->offset +
				...
				case SigIereduced_neighbor_report:
					status |= dot11f_unpack_ie_reduced_neighbor_report(
						pCtx, pBufRemaining, len,
				...
				case SigIeroaming_consortium_sel:
					status |= dot11f_unpack_ie_roaming_consortium_sel(
						pCtx, pBufRemaining, len,
				...
				case SigIespatial_reuse:
					status |= dot11f_unpack_ie_spatial_reuse(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigIet2lm_ie:
					status |= dot11f_unpack_ie_t2lm_ie(
						pCtx, pBufRemaining, len,
						(tDot11fIEt2lm_ie
							 *)(pFrm + pIe->offset +
				...
				case SigIevendor_vht_ie:
					status |= dot11f_unpack_ie_vendor_vht_ie(
						pCtx, pBufRemaining, len,
			...
			FRAMES_LOG3(pCtx, FRLOG3,
				    FRFL("Skipping unknown IE %d extn ID %d"
					 " (length %d)\n"),
				    eid, extn_eid, len);
	...
	while (0xff != pIe->eid || pIe->extn_eid) {
		if (pIe->fMandatory) {
			pfFound = (tFRAMES_BOOL *)(pFrm + pIe->offset +
						   pIe->presenceOffset);
			if (!*pfFound) {
				FRAMES_LOG1(pCtx, FRLOGW,
					    FRFL("ERROR: The mandato"
						 "ry IE %s wasn't seen.\n"),
					    pIe->name);
				FRAMES_DBG_BREAK();
				...
				uint8_t *pFrm, size_t nFrm)
{
	...
	while (nBufRemaining) {
		...
		if (pTlv) {
			if (pTlv->sType == 2) {
				framesntohs(pCtx, &id, pBufRemaining,
					    pTlv->fMsb);
				pBufRemaining += 2;
				nBufRemaining -= 2;
			} else {
			...
			if (pTlv->sLen == 2) {
				...
				framesntohs(pCtx, &len, pBufRemaining,
					    pTlv->fMsb);
				pBufRemaining += 2;
				nBufRemaining -= 2;
			} else {
		...
		if (pTlv) {
			if (len + (pTlv->sType + pTlv->sLen) <
			    pTlv->minSize - npec) {
				FRAMES_LOG3(
					pCtx, FRLOGW,
					FRFL("The IE %s must be "
			...
			if (nBufRemaining <
			    pTlv->minSize - npec - (pTlv->sType + pTlv->sLen)) {
				FRAMES_LOG3(
					pCtx, FRLOGW,
					FRFL("The IE %s must be "
					     "at least %d bytes in size, but there are only "
					     "%d bytes remaining in this frame.\n"),
					pTlv->name, pTlv->minSize,
					nBufRemaining);
				FRAMES_DUMP(pCtx, FRLOG1, pBuf, nBuf);
				status |= DOT11F_INCOMPLETE_TLV;
				FRAMES_DBG_BREAK();
				goto MandatoryCheck;
			} else if (len > pTlv->maxSize - npec -
						 (pTlv->sType + pTlv->sLen)) {
				FRAMES_LOG1(
					pCtx, FRLOGW,
					FRFL("The TLV %s reports "
				...
				case SigTlvAuthorizedMACs:
					status |= dot11f_unpack_tlv_authorized_ma_cs(
						pCtx, pBufRemaining, len,
				...
				case SigTlvRequestToEnroll:
					status |= dot11f_unpack_tlv_common_func(
						pCtx, pBufRemaining, len,
						(uint8_t *)&(
					...
					break;
				case SigTlvVersion2:
					status |= dot11f_unpack_tlv_version2(
						pCtx, pBufRemaining, len,
						(tDot11fTLVVersion2
							 *)(pFrm +
							    pTlv->offset));
				...
				case SigTlvAssociationState:
					status |= dot11f_unpack_tlv_common_func2(
						pCtx, pBufRemaining, len,
						(uint8_t *)&(
				...
				case SigTlvDeviceName:
					status |= dot11f_unpack_tlv_device_name(
						pCtx, pBufRemaining, len,
				...
				case SigTlvExtendedListenTiming:
					status |= dot11f_unpack_tlv_extended_listen_timing(
						pCtx, pBufRemaining, len,
				...
				case SigTlvListenChannel:
					status |= dot11f_unpack_tlv_listen_channel(
						pCtx, pBufRemaining, len,
				...
				case SigTlvManufacturer:
					status |= dot11f_unpack_tlv_manufacturer(
						pCtx, pBufRemaining, len,
				...
				case SigTlvModelName:
					status |= dot11f_unpack_tlv_model_name(
						pCtx, pBufRemaining, len,
						(tDot11fTLVModelName
							 *)(pFrm +
							    pTlv->offset));
				...
				case SigTlvModelNumber:
					status |= dot11f_unpack_tlv_model_number(
						pCtx, pBufRemaining, len,
				...
				case SigTlvNoticeOfAbsence:
					status |= dot11f_unpack_tlv_notice_of_absence(
						pCtx, pBufRemaining, len,
				...
				case SigTlvOperatingChannel:
					status |= dot11f_unpack_tlv_operating_channel(
						pCtx, pBufRemaining, len,
				...
				case SigTlvP2PCapability:
					status |= dot11f_unpack_tlv_p2_p_capability(
						pCtx, pBufRemaining, len,
				...
				case SigTlvP2PDeviceId:
					status |= dot11f_unpack_tlv_p2_p_device_id(
						pCtx, pBufRemaining, len,
				...
				case SigTlvP2PDeviceInfo:
					status |= dot11f_unpack_tlv_p2_p_device_info(
						pCtx, pBufRemaining, len,
				...
				case SigTlvP2PGroupInfo:
					status |= dot11f_unpack_tlv_p2_p_group_info(
						pCtx, pBufRemaining, len,
				...
				case SigTlvPrimaryDeviceType:
					status |= dot11f_unpack_tlv_primary_device_type(
						pCtx, pBufRemaining, len,
				...
				case SigTlvRequestDeviceType:
					status |= dot11f_unpack_tlv_request_device_type(
						pCtx, pBufRemaining, len,
				...
				case SigTlvSerialNumber:
					status |= dot11f_unpack_tlv_serial_number(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigTlvUUID_E:
					status |= dot11f_unpack_tlv_uuid_e(
						pCtx, pBufRemaining, len,
						(tDot11fTLVUUID_E
							 *)(pFrm +
							    pTlv->offset));
					break;
				case SigTlvUUID_R:
					status |= dot11f_unpack_tlv_uuid_r(
						pCtx, pBufRemaining, len,
						(tDot11fTLVUUID_R
							 *)(pFrm +
							    pTlv->offset));
				...
				case SigTlvVendorExtension:
					status |= dot11f_unpack_tlv_vendor_extension(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigTlvVersion:
					status |= dot11f_unpack_tlv_version(
						pCtx, pBufRemaining, len,
						(tDot11fTLVVersion
							 *)(pFrm +
							    pTlv->offset));
				...
				case SigTlvecsa_target_tsf_info_attr:
					status |= dot11f_unpack_tlv_ecsa_target_tsf_info_attr(
						pCtx, pBufRemaining, len,
				...
				case SigTlvedca_pifs_param_attr:
					status |= dot11f_unpack_tlv_edca_pifs_param_attr(
						pCtx, pBufRemaining, len,
				...
				case SigTlvhe_400ns_sgi_attr:
					status |= dot11f_unpack_tlv_he_400ns_sgi_attr(
						pCtx, pBufRemaining, len,
				...
				case SigTlvhe_mcs13_attr:
					status |= dot11f_unpack_tlv_he_mcs13_attr(
						pCtx, pBufRemaining, len,
				...
				case SigTlvnon_prefferd_chan_rep:
					status |= dot11f_unpack_tlv_non_prefferd_chan_rep(
						pCtx, pBufRemaining, len,
					...
					break;
				case SigTlvoce_cap:
					status |= dot11f_unpack_tlv_oce_cap(
						pCtx, pBufRemaining, len,
						(tDot11fTLVoce_cap
							 *)(pFrm +
							    pTlv->offset));
				...
				case SigTlvqcn_version:
					status |= dot11f_unpack_tlv_qcn_version(
						pCtx, pBufRemaining, len,
				...
				case SigTlvrssi_assoc_rej:
					status |= dot11f_unpack_tlv_rssi_assoc_rej(
						pCtx, pBufRemaining, len,
				...
				case SigTlvP2PInterface:
					status |= dot11f_unpack_tlv_p2_p_interface(
						pCtx, pBufRemaining, len,
			...
			FRAMES_LOG2(pCtx, FRLOG3,
				    FRFL("Skipping unknown TLV %d ("
					 "length %d)\n"),
				    id, len);
			FRAMES_DUMP(pCtx, FRLOG3,
				    pBufRemaining - (pTlv->sType + pTlv->sLen),
				    len);
...
uint32_t dot11f_get_packed_ietclas(tpAniSirGlobal pCtx, tDot11fIETCLAS *pIe,
				   uint32_t *pnNeeded)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pCtx;
...
uint32_t
dot11f_get_packed_ie_channel_switch_wrapper(tpAniSirGlobal pCtx,
					    tDot11fIEChannelSwitchWrapper *pIe,
					    uint32_t *pnNeeded)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pCtx;
...
uint32_t dot11f_get_packed_ieft_info(tpAniSirGlobal pCtx, tDot11fIEFTInfo *pIe,
				     uint32_t *pnNeeded)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pCtx;
...
uint32_t dot11f_get_packed_ie_MBO_IE(tpAniSirGlobal pCtx, tDot11fIEMBO_IE *pIe,
				     uint32_t *pnNeeded)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pCtx;
	while (pIe->present) {
		status = get_packed_size_tlv_core(pCtx, (uint8_t *)pIe,
						  pnNeeded, TLVS_MBO_IE);
		break;
	}
	return status;
...
uint32_t
dot11f_get_packed_ie_measurement_report(tpAniSirGlobal pCtx,
					tDot11fIEMeasurementReport *pIe,
					uint32_t *pnNeeded)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pCtx;
		...
		*pnNeeded += 1;
		if (pIe->type) {
			...
			case 5:
				...
				*pnNeeded += 1;
				*pnNeeded += 4;
				status = get_packed_size_core(pCtx,
							      (uint8_t *)pIe,
							      pnNeeded,
							      IES_reportBeacon);
				break;
...
uint32_t
dot11f_get_packed_ie_measurement_request(tpAniSirGlobal pCtx,
					 tDot11fIEMeasurementRequest *pIe,
					 uint32_t *pnNeeded)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pCtx;
	while (pIe->present) {
		...
		*pnNeeded += 1;
		...
		case 5:
			...
			*pnNeeded += 1;
			*pnNeeded += 6;
			status = get_packed_size_core(
				pCtx, (uint8_t *)pIe, pnNeeded,
				IES_measurement_requestBeacon);
			break;
		case 8:
			*pnNeeded += 1;
...
uint32_t
dot11f_get_packed_iep2_p_beacon_probe_res(tpAniSirGlobal pCtx,
					  tDot11fIEP2PBeaconProbeRes *pIe,
					  uint32_t *pnNeeded)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pCtx;
	while (pIe->present) {
		status = get_packed_size_tlv_core(
			pCtx, (uint8_t *)pIe, pnNeeded, TLVS_P2PBeaconProbeRes);
		break;
	}
	return status;
...
uint32_t dot11f_get_packed_iersn(tpAniSirGlobal pCtx, tDot11fIERSN *pIe,
				 uint32_t *pnNeeded)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pCtx;
...
uint32_t dot11f_get_packed_iewapi(tpAniSirGlobal pCtx, tDot11fIEWAPI *pIe,
				  uint32_t *pnNeeded)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pCtx;
...
uint32_t dot11f_get_packed_iewpa(tpAniSirGlobal pCtx, tDot11fIEWPA *pIe,
				 uint32_t *pnNeeded)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pCtx;
...
uint32_t dot11f_get_packed_iewsc(tpAniSirGlobal pCtx, tDot11fIEWSC *pIe,
				 uint32_t *pnNeeded)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pCtx;
...
uint32_t
dot11f_get_packed_ie_wsc_beacon_probe_res(tpAniSirGlobal pCtx,
					  tDot11fIEWscBeaconProbeRes *pIe,
					  uint32_t *pnNeeded)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pCtx;
	while (pIe->present) {
		status = get_packed_size_tlv_core(
			pCtx, (uint8_t *)pIe, pnNeeded, TLVS_WscBeaconProbeRes);
		break;
	}
	return status;
...
uint32_t
dot11f_get_packed_ie_descriptor_element(tpAniSirGlobal pCtx,
					tDot11fIEdescriptor_element *pIe,
					uint32_t *pnNeeded)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pCtx;
...
uint32_t dot11f_get_packed_ie_he_cap(tpAniSirGlobal pCtx, tDot11fIEhe_cap *pIe,
				     uint32_t *pnNeeded)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pCtx;
...
uint32_t dot11f_get_packed_ie_he_op(tpAniSirGlobal pCtx, tDot11fIEhe_op *pIe,
				    uint32_t *pnNeeded)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pCtx;
...
uint32_t dot11f_get_packed_ie_qcn_ie(tpAniSirGlobal pCtx, tDot11fIEqcn_ie *pIe,
				     uint32_t *pnNeeded)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pCtx;
...
uint32_t dot11f_get_packed_ie_reduced_neighbor_report(
	tpAniSirGlobal pCtx, tDot11fIEreduced_neighbor_report *pIe,
	uint32_t *pnNeeded)
{
	uint32_t status = DOT11F_PARSE_SUCCESS;
	(void)pCtx;
...
uint32_t dot11f_get_packed_beacon_size(tpAniSirGlobal pCtx, tDot11fBeacon *pFrm,
				       uint32_t *pnNeeded)
{
	uint32_t status = 0;
	*pnNeeded = 12;
...
uint32_t dot11f_get_packed_del_ts_size(tpAniSirGlobal pCtx, tDot11fDelTS *pFrm,
				       uint32_t *pnNeeded)
{
	uint32_t status = 0;
	*pnNeeded = 7;
...
uint32_t dot11f_get_packed_link_measurement_report_size(
	tpAniSirGlobal pCtx, tDot11fLinkMeasurementReport *pFrm,
	uint32_t *pnNeeded)
{
	uint32_t status = 0;
	*pnNeeded = 11;
...
uint32_t dot11f_get_packed_link_measurement_request_size(
	tpAniSirGlobal pCtx, tDot11fLinkMeasurementRequest *pFrm,
	uint32_t *pnNeeded)
{
	uint32_t status = 0;
	*pnNeeded = 5;
...
uint32_t dot11f_get_packed_measurement_report_size(
	tpAniSirGlobal pCtx, tDot11fMeasurementReport *pFrm, uint32_t *pnNeeded)
{
	uint32_t status = 0;
	*pnNeeded = 3;
	status = get_packed_size_core(pCtx, (uint8_t *)pFrm, pnNeeded,
...
uint32_t
dot11f_get_packed_measurement_request_size(tpAniSirGlobal pCtx,
					   tDot11fMeasurementRequest *pFrm,
					   uint32_t *pnNeeded)
{
	uint32_t status = 0;
...
uint32_t dot11f_get_packed_neighbor_report_request_size(
	tpAniSirGlobal pCtx, tDot11fNeighborReportRequest *pFrm,
	uint32_t *pnNeeded)
{
	uint32_t status = 0;
	*pnNeeded = 3;
...
uint32_t dot11f_get_packed_neighbor_report_response_size(
	tpAniSirGlobal pCtx, tDot11fNeighborReportResponse *pFrm,
	uint32_t *pnNeeded)
{
	uint32_t status = 0;
	*pnNeeded = 3;
...
uint32_t dot11f_get_packed_radio_measurement_report_size(
	tpAniSirGlobal pCtx, tDot11fRadioMeasurementReport *pFrm,
	uint32_t *pnNeeded)
{
	uint32_t status = 0;
	*pnNeeded = 3;
...
uint32_t dot11f_get_packed_radio_measurement_request_size(
	tpAniSirGlobal pCtx, tDot11fRadioMeasurementRequest *pFrm,
	uint32_t *pnNeeded)
{
	uint32_t status = 0;
	*pnNeeded = 5;
...
uint32_t
dot11f_get_packed_tdls_peer_traffic_ind_size(tpAniSirGlobal pCtx,
					     tDot11fTDLSPeerTrafficInd *pFrm,
					     uint32_t *pnNeeded)
{
	uint32_t status = 0;
...
uint32_t
dot11f_get_packed_tdls_peer_traffic_rsp_size(tpAniSirGlobal pCtx,
					     tDot11fTDLSPeerTrafficRsp *pFrm,
					     uint32_t *pnNeeded)
{
	uint32_t status = 0;
...
uint32_t dot11f_get_packed_timing_advertisement_frame_size(
	tpAniSirGlobal pCtx, tDot11fTimingAdvertisementFrame *pFrm,
	uint32_t *pnNeeded)
{
	uint32_t status = 0;
	*pnNeeded = 10;
...
uint32_t dot11f_get_packed_vht_gid_management_action_frame_size(
	tpAniSirGlobal pCtx, tDot11fVHTGidManagementActionFrame *pFrm,
	uint32_t *pnNeeded)
{
	uint32_t status = 0;
	*pnNeeded = 26;
...
uint32_t dot11f_get_packed_wmm_add_ts_response_size(
	tpAniSirGlobal pCtx, tDot11fWMMAddTSResponse *pFrm, uint32_t *pnNeeded)
{
	uint32_t status = 0;
	*pnNeeded = 4;
	status = get_packed_size_core(pCtx, (uint8_t *)pFrm, pnNeeded,
...
uint32_t dot11f_get_packed_ext_channel_switch_action_frame_size(
	tpAniSirGlobal pCtx, tDot11fext_channel_switch_action_frame *pFrm,
	uint32_t *pnNeeded)
{
	uint32_t status = 0;
	*pnNeeded = 6;
...
uint32_t dot11f_get_packed_ht2040_bss_coexistence_mgmt_action_frameSize(
	tpAniSirGlobal pCtx,
	...
	uint32_t *pnNeeded)
{
	...
	*pnNeeded = 2;
	status = get_packed_size_core(
		pCtx, (uint8_t *)pFrm, pnNeeded,
		IES_ht2040_bss_coexistence_mgmt_action_frame);
	return status;
} /* End dot11f_get_packed_ht2040_bss_coexistence_mgmt_action_frameSize. */

uint32_t dot11f_get_packed_mscs_request_action_frameSize(
	tpAniSirGlobal pCtx, tDot11fmscs_request_action_frame *pFrm,
	uint32_t *pnNeeded)
{
	uint32_t status = 0;
	*pnNeeded = 3;
...
uint32_t dot11f_get_packed_p2p_oper_chan_change_confirmSize(
	tpAniSirGlobal pCtx, tDot11fp2p_oper_chan_change_confirm *pFrm,
	uint32_t *pnNeeded)
{
	uint32_t status = 0;
	*pnNeeded = 7;
...
uint32_t
dot11f_get_packed_vendor_action_frameSize(tpAniSirGlobal pCtx,
					  tDot11fvendor_action_frame *pFrm,
					  uint32_t *pnNeeded)
{
	uint32_t status = 0;
			...
			for (i = 0U; i < countOffset; ++i) {
				*pnNeeded += 2U + pIe->noui;
				...
				case SigIeTCLAS:
					...
					status |= dot11f_get_packed_ietclas(
						pCtx,
						(tDot11fIETCLAS *)(pFrm +
								   pIe->offset +
								   offset * i),
				...
				case SigIeWMMTCLAS:
					...
					status |= dot11f_get_packed_iewmmtclas(
						pCtx,
						(tDot11fIEWMMTCLAS
							 *)(pFrm + pIe->offset +
							    offset * i),
				...
				case SigIeChannelSwitchWrapper:
					offset = sizeof(
						tDot11fIEChannelSwitchWrapper);
					status |= dot11f_get_packed_ie_channel_switch_wrapper(
						pCtx,
						(tDot11fIEChannelSwitchWrapper
							 *)(pFrm + pIe->offset +
							    offset * i),
				...
				case SigIeCountry:
					...
					status |= dot11f_get_packed_ie_country(
						pCtx,
						(tDot11fIECountry
							 *)(pFrm + pIe->offset +
							    offset * i),
				...
				case SigIeFTInfo:
					...
					status |= dot11f_get_packed_ieft_info(
						pCtx,
						(tDot11fIEFTInfo *)(pFrm +
								    pIe->offset +
								    offset * i),
						pnNeeded);
					break;
				...
				case SigIeMBO_IE:
					...
					status |= dot11f_get_packed_ie_MBO_IE(
						pCtx,
						(tDot11fIEMBO_IE *)(pFrm +
								    pIe->offset +
								    offset * i),
						pnNeeded);
					break;
				case SigIeMeasurementReport:
					offset = sizeof(
						tDot11fIEMeasurementReport);
					status |= dot11f_get_packed_ie_measurement_report(
						pCtx,
						(tDot11fIEMeasurementReport
							 *)(pFrm + pIe->offset +
							    offset * i),
				...
				case SigIeMeasurementRequest:
					offset = sizeof(
						tDot11fIEMeasurementRequest);
					status |= dot11f_get_packed_ie_measurement_request(
						pCtx,
						(tDot11fIEMeasurementRequest
							 *)(pFrm + pIe->offset +
							    offset * i),
				...
				case SigIeP2PBeaconProbeRes:
					offset = sizeof(
						tDot11fIEP2PBeaconProbeRes);
					status |= dot11f_get_packed_iep2_p_beacon_probe_res(
						pCtx,
						(tDot11fIEP2PBeaconProbeRes
							 *)(pFrm + pIe->offset +
							    offset * i),
				...
				case SigIeRICDataDesc:
					...
					pnNeeded -=
						2; /* Subtract the length and Oui as this is our container IE to
                    group Ies and it doesn't have its own length and OUI. */
					status |=
				...
				case SigIeRSN:
					...
					status |= dot11f_get_packed_iersn(
						pCtx,
						(tDot11fIERSN *)(pFrm +
								 pIe->offset +
								 offset * i),
				...
				case SigIeWAPI:
					...
					status |= dot11f_get_packed_iewapi(
						pCtx,
						(tDot11fIEWAPI *)(pFrm +
								  pIe->offset +
								  offset * i),
				...
				case SigIeWPA:
					...
					status |= dot11f_get_packed_iewpa(
						pCtx,
						(tDot11fIEWPA *)(pFrm +
								 pIe->offset +
								 offset * i),
				...
				case SigIeWSC:
					...
					status |= dot11f_get_packed_iewsc(
						pCtx,
						(tDot11fIEWSC *)(pFrm +
								 pIe->offset +
								 offset * i),
				...
				case SigIeWscBeaconProbeRes:
					offset = sizeof(
						tDot11fIEWscBeaconProbeRes);
					status |= dot11f_get_packed_ie_wsc_beacon_probe_res(
						pCtx,
						(tDot11fIEWscBeaconProbeRes
							 *)(pFrm + pIe->offset +
							    offset * i),
				...
				case SigIedescriptor_element:
					offset = sizeof(
						tDot11fIEdescriptor_element);
					status |= dot11f_get_packed_ie_descriptor_element(
						pCtx,
						(tDot11fIEdescriptor_element
							 *)(pFrm + pIe->offset +
							    offset * i),
				...
				case SigIeeht_cap:
					...
					status |= dot11f_get_packed_ie_eht_cap(
						pCtx,
						(tDot11fIEeht_cap
							 *)(pFrm + pIe->offset +
							    offset * i),
				...
				case SigIehe_cap:
					...
					status |= dot11f_get_packed_ie_he_cap(
						pCtx,
						(tDot11fIEhe_cap *)(pFrm +
								    pIe->offset +
								    offset * i),
						pnNeeded);
					break;
				case SigIehe_op:
					...
					status |= dot11f_get_packed_ie_he_op(
						pCtx,
						(tDot11fIEhe_op *)(pFrm +
								   pIe->offset +
								   offset * i),
				...
				case SigIeqcn_ie:
					...
					status |= dot11f_get_packed_ie_qcn_ie(
						pCtx,
						(tDot11fIEqcn_ie *)(pFrm +
								    pIe->offset +
								    offset * i),
						pnNeeded);
					break;
				case SigIereduced_neighbor_report:
					offset = sizeof(
						tDot11fIEreduced_neighbor_report);
					status |= dot11f_get_packed_ie_reduced_neighbor_report(
						pCtx,
						(tDot11fIEreduced_neighbor_report
							 *)(pFrm + pIe->offset +
							    offset * i),
		...
		if (*pfFound) {
			*pnNeeded += (pTlv->sType + pTlv->sLen);
			...
			case SigTlvListenChannel:
				...
				break;
			case SigTlvManufacturer:
				byteCount = ((tDot11fTLVManufacturer
						      *)(pFrm + pTlv->offset))
						    ->num_name;
			...
			case SigTlvModelNumber:
				...
				break;
			case SigTlvNoticeOfAbsence:
				byteCount = ((tDot11fTLVNoticeOfAbsence
						      *)(pFrm + pTlv->offset))
						    ->num_NoADesc +
					    2;
			...
			case SigTlvP2PDeviceId:
				byteCount = 6;
				pTlvPresent =
					((tDot11fTLVP2PDeviceId *)(pFrm +
								   pTlv->offset))
						->present;
				break;
			case SigTlvP2PDeviceInfo:
				status = get_packed_size_tlv_core(
					pCtx, (uint8_t *)pFrm + pTlv->offset,
					pnNeeded, TLVS_P2PDeviceInfo);
				byteCount = 16;
				...
				break;
			case SigTlvP2PGroupInfo:
				byteCount = ((tDot11fTLVP2PGroupInfo
						      *)(pFrm + pTlv->offset))
			...
			case SigTlvSelectedRegistrarConfigMethods:
				...
				break;
			case SigTlvSerialNumber:
				byteCount = ((tDot11fTLVSerialNumber
						      *)(pFrm + pTlv->offset))
						    ->num_text;
			...
			case SigTlvecsa_target_tsf_info_attr:
				...
				break;
			case SigTlvedca_pifs_param_attr:
				byteCount = ((tDot11fTLVedca_pifs_param_attr
						      *)(pFrm + pTlv->offset))
						    ->num_data +
					    1;
			...
			case SigTlvmbo_ap_cap:
				byteCount = 1;
				pTlvPresent =
					((tDot11fTLVmbo_ap_cap *)(pFrm +
								  pTlv->offset))
						->present;
				break;
			case SigTlvnon_prefferd_chan_rep:
				byteCount = ((tDot11fTLVnon_prefferd_chan_rep
						      *)(pFrm + pTlv->offset))
						    ->num_channel_report +
					    1;
...
void dot11f_pack_ff_aid(tpAniSirGlobal pCtx, tDot11fFfAID *pSrc, uint8_t *pBuf)
{
	frameshtons(pCtx, pBuf, pSrc->associd, 0);
	(void)pCtx;
} /* End dot11f_pack_ff_aid. */

void dot11f_pack_ff_action(tpAniSirGlobal pCtx, tDot11fFfAction *pSrc,
			   uint8_t *pBuf)
{
	*pBuf = pSrc->action;
	(void)pCtx;
...
void dot11f_pack_ff_auth_algo(tpAniSirGlobal pCtx, tDot11fFfAuthAlgo *pSrc,
			      uint8_t *pBuf)
{
...
void dot11f_pack_ff_auth_seq_no(tpAniSirGlobal pCtx, tDot11fFfAuthSeqNo *pSrc,
				uint8_t *pBuf)
{
...
void dot11f_pack_ff_capabilities(tpAniSirGlobal pCtx,
				 tDot11fFfCapabilities *pSrc, uint8_t *pBuf)
{
	uint16_t tmp113__;
	tmp113__ = 0U;
	tmp113__ |= (pSrc->ess << 0);
...
void dot11f_pack_ff_category(tpAniSirGlobal pCtx, tDot11fFfCategory *pSrc,
			     uint8_t *pBuf)
{
	*pBuf = pSrc->category;
	(void)pCtx;
...
void dot11f_pack_ff_dialog_token(tpAniSirGlobal pCtx,
				 tDot11fFfDialogToken *pSrc, uint8_t *pBuf)
{
	*pBuf = pSrc->token;
	(void)pCtx;
} /* End dot11f_pack_ff_dialog_token. */

void dot11f_pack_ff_link_margin(tpAniSirGlobal pCtx, tDot11fFfLinkMargin *pSrc,
				uint8_t *pBuf)
{
...
void dot11f_pack_ff_max_tx_power(tpAniSirGlobal pCtx, tDot11fFfMaxTxPower *pSrc,
				 uint8_t *pBuf)
{
...
void dot11f_pack_ff_operating_mode(tpAniSirGlobal pCtx,
				   tDot11fFfOperatingMode *pSrc, uint8_t *pBuf)
{
	uint8_t tmp114__;
	tmp114__ = 0U;
...
void dot11f_pack_ff_rcpi(tpAniSirGlobal pCtx, tDot11fFfRCPI *pSrc,
			 uint8_t *pBuf)
{
	*pBuf = pSrc->rcpi;
	(void)pCtx;
...
void dot11f_pack_ff_rsni(tpAniSirGlobal pCtx, tDot11fFfRSNI *pSrc,
			 uint8_t *pBuf)
{
	*pBuf = pSrc->rsni;
	(void)pCtx;
...
void dot11f_pack_ff_reason(tpAniSirGlobal pCtx, tDot11fFfReason *pSrc,
			   uint8_t *pBuf)
{
...
void dot11f_pack_ff_rx_antenna_id(tpAniSirGlobal pCtx,
				  tDot11fFfRxAntennaId *pSrc, uint8_t *pBuf)
{
	*pBuf = pSrc->antennaId;
	(void)pCtx;
...
void dot11f_pack_ff_status(tpAniSirGlobal pCtx, tDot11fFfStatus *pSrc,
			   uint8_t *pBuf)
{
...
void dot11f_pack_ff_status_code(tpAniSirGlobal pCtx, tDot11fFfStatusCode *pSrc,
				uint8_t *pBuf)
{
...
void dot11f_pack_ff_tpc_ele_id(tpAniSirGlobal pCtx, tDot11fFfTPCEleID *pSrc,
			       uint8_t *pBuf)
{
	*pBuf = pSrc->TPCId;
	(void)pCtx;
...
void dot11f_pack_ff_tpc_ele_len(tpAniSirGlobal pCtx, tDot11fFfTPCEleLen *pSrc,
				uint8_t *pBuf)
{
	*pBuf = pSrc->TPCLen;
	(void)pCtx;
...
void dot11f_pack_ff_ts_info(tpAniSirGlobal pCtx, tDot11fFfTSInfo *pSrc,
			    uint8_t *pBuf)
{
	uint32_t tmp116__;
	tmp116__ = 0U;
...
void dot11f_pack_ff_time_stamp(tpAniSirGlobal pCtx, tDot11fFfTimeStamp *pSrc,
			       uint8_t *pBuf)
{
...
void dot11f_pack_ff_transaction_id(tpAniSirGlobal pCtx,
				   tDot11fFfTransactionId *pSrc, uint8_t *pBuf)
{
...
void dot11f_pack_ff_tx_antenna_id(tpAniSirGlobal pCtx,
				  tDot11fFfTxAntennaId *pSrc, uint8_t *pBuf)
{
	*pBuf = pSrc->antennaId;
	(void)pCtx;
} /* End dot11f_pack_ff_tx_antenna_id. */

void dot11f_pack_ff_tx_power(tpAniSirGlobal pCtx, tDot11fFfTxPower *pSrc,
			     uint8_t *pBuf)
{
	*pBuf = pSrc->txPower;
	(void)pCtx;
...
void dot11f_pack_ff_vht_membership_status_array(
	tpAniSirGlobal pCtx, tDot11fFfVhtMembershipStatusArray *pSrc,
	uint8_t *pBuf)
{
...
void dot11f_pack_ff_ba_timeout(tpAniSirGlobal pCtx, tDot11fFfba_timeout *pSrc,
			       uint8_t *pBuf)
{
...
void dot11f_pack_ff_ext_chan_switch_ann_action(
	tpAniSirGlobal pCtx, tDot11fFfext_chan_switch_ann_action *pSrc,
	uint8_t *pBuf)
{
	uint32_t tmp120__;
	tmp120__ = 0U;
...
void dot11f_pack_ff_p2p_action_oui(tpAniSirGlobal pCtx,
				   tDot11fFfp2p_action_oui *pSrc, uint8_t *pBuf)
{
...
void dot11f_pack_ff_vendor_oui(tpAniSirGlobal pCtx, tDot11fFfvendor_oui *pSrc,
			       uint8_t *pBuf)
{
...
uint32_t dot11f_pack_tlv_version2(tpAniSirGlobal pCtx, tDot11fTLVVersion2 *pSrc,
				  uint8_t *pBuf, uint32_t nBuf,
				  uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
					 ...
					 uint32_t *pnConsumed)
{
	...
	(void)pCtx;
	if (pTlvLen) {
		frameshtons(pCtx, pTlvLen, *pnConsumed - nConsumedOnEntry - 4,
			    1);
	}
	return DOT11F_PARSE_SUCCESS;
...
uint32_t dot11f_pack_tlv_device_name(tpAniSirGlobal pCtx,
				     tDot11fTLVDeviceName *pSrc, uint8_t *pBuf,
				     uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_tlv_extended_listen_timing(
	tpAniSirGlobal pCtx, tDot11fTLVExtendedListenTiming *pSrc,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	...
	(void)pCtx;
	if (pTlvLen) {
		frameshtons(pCtx, pTlvLen, *pnConsumed - nConsumedOnEntry - 3,
			    0);
	}
	return DOT11F_PARSE_SUCCESS;
...
uint32_t dot11f_pack_tlv_model_name(tpAniSirGlobal pCtx,
				    tDot11fTLVModelName *pSrc, uint8_t *pBuf,
				    uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
					  ...
					  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 8;
		pBuf += 8;
		status |= pack_tlv_core(pCtx, (uint8_t *)pSrc, pBuf, nBuf,
					pnConsumed, TLVS_P2PDeviceInfo, &idx);
		break;
	}
	(void)pCtx;
	if (pTlvLen) {
					 ...
					 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		...
		pBuf += 2;
		*pnConsumed += 2;
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->P2PClientInfoDesc),
			      pSrc->num_P2PClientInfoDesc);
...
uint32_t dot11f_pack_tlv_p2_p_status(tpAniSirGlobal pCtx,
				     tDot11fTLVP2PStatus *pSrc, uint8_t *pBuf,
				     uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_tlv_rf_bands(tpAniSirGlobal pCtx, tDot11fTLVRFBands *pSrc,
				  uint8_t *pBuf, uint32_t nBuf,
				  uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
...
uint32_t dot11f_pack_tlv_selected_registrar_config_methods(
	tpAniSirGlobal pCtx, tDot11fTLVSelectedRegistrarConfigMethods *pSrc,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_tlv_uuid_e(tpAniSirGlobal pCtx, tDot11fTLVUUID_E *pSrc,
				uint8_t *pBuf, uint32_t nBuf,
				uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
...
uint32_t dot11f_pack_tlv_uuid_r(tpAniSirGlobal pCtx, tDot11fTLVUUID_R *pSrc,
				uint8_t *pBuf, uint32_t nBuf,
				uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
					  ...
					  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 3;
		pBuf += 3;
		status |= pack_tlv_core(pCtx, (uint8_t *)pSrc, pBuf, nBuf,
					pnConsumed, TLVS_VendorExtension, &idx);
		break;
	}
	(void)pCtx;
	if (pTlvLen) {
...
uint32_t dot11f_pack_tlv_version(tpAniSirGlobal pCtx, tDot11fTLVVersion *pSrc,
				 uint8_t *pBuf, uint32_t nBuf,
				 uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
...
uint32_t dot11f_pack_tlv_wps_state(tpAniSirGlobal pCtx,
				   tDot11fTLVWPSState *pSrc, uint8_t *pBuf,
				   uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_tlv_cellular_data_con_pref(
	tpAniSirGlobal pCtx, tDot11fTLVcellular_data_con_pref *pSrc,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_tlv_ecsa_target_tsf_info_attr(
	tpAniSirGlobal pCtx, tDot11fTLVecsa_target_tsf_info_attr *pSrc,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_tlv_edca_pifs_param_attr(
	tpAniSirGlobal pCtx, tDot11fTLVedca_pifs_param_attr *pSrc,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_tlv_he_2xltf_160mhz_supp(
	tpAniSirGlobal pCtx, tDot11fTLVhe_2xltf_160mhz_supp *pSrc,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_tlv_mbo_ap_cap(tpAniSirGlobal pCtx,
				    tDot11fTLVmbo_ap_cap *pSrc, uint8_t *pBuf,
				    uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_tlv_non_prefferd_chan_rep(
	tpAniSirGlobal pCtx, tDot11fTLVnon_prefferd_chan_rep *pSrc,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->channel_report),
			      pSrc->num_channel_report);
...
uint32_t dot11f_pack_tlv_oce_cap(tpAniSirGlobal pCtx, tDot11fTLVoce_cap *pSrc,
				 uint8_t *pBuf, uint32_t nBuf,
				 uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
...
uint32_t dot11f_pack_tlv_qcn_version(tpAniSirGlobal pCtx,
				     tDot11fTLVqcn_version *pSrc, uint8_t *pBuf,
				     uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_tlv_reduced_wan_metrics(
	tpAniSirGlobal pCtx, tDot11fTLVreduced_wan_metrics *pSrc, uint8_t *pBuf,
	uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_tlv_transition_reject_reason(
	tpAniSirGlobal pCtx, tDot11fTLVtransition_reject_reason *pSrc,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pTlvLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_gtk(tpAniSirGlobal pCtx, tDot11fIEGTK *pSrc,
			    uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_igtk(tpAniSirGlobal pCtx, tDot11fIEIGTK *pSrc,
			     uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_r0_kh_id(tpAniSirGlobal pCtx, tDot11fIER0KH_ID *pSrc,
				 uint8_t *pBuf, uint32_t nBuf,
				 uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	...
	while (pSrc->present) {
		...
		*pBuf = 3;
		...
		++pBuf;
		++(*pnConsumed);
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->PMK_R0_ID),
			      pSrc->num_PMK_R0_ID);
...
uint32_t dot11f_pack_ie_r1_kh_id(tpAniSirGlobal pCtx, tDot11fIER1KH_ID *pSrc,
				 uint8_t *pBuf, uint32_t nBuf,
				 uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
					  ...
					  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->channelList),
			      pSrc->num_channelList);
...
uint32_t dot11f_pack_ie_beacon_report_frm_body(
	tpAniSirGlobal pCtx, tDot11fIEBeaconReportFrmBody *pSrc, uint8_t *pBuf,
	uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_condensed_country_str(
	tpAniSirGlobal pCtx, tDot11fIECondensedCountryStr *pSrc, uint8_t *pBuf,
	uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
					  ...
					  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->vendorSpecific),
			      pSrc->num_vendorSpecific);
...
uint32_t dot11f_pack_ie_multi_bssid(tpAniSirGlobal pCtx,
				    tDot11fIEMultiBssid *pSrc, uint8_t *pBuf,
				    uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_ric_data(tpAniSirGlobal pCtx, tDot11fIERICData *pSrc,
				 uint8_t *pBuf, uint32_t nBuf,
				 uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->variableData),
			      pSrc->num_variableData);
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 10;
		...
		++pBuf;
		++(*pnConsumed);
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->requested_eids),
			      pSrc->num_requested_eids);
...
uint32_t dot11f_pack_ie_ssid(tpAniSirGlobal pCtx, tDot11fIESSID *pSrc,
			     uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_schedule(tpAniSirGlobal pCtx, tDot11fIESchedule *pSrc,
				 uint8_t *pBuf, uint32_t nBuf,
				 uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_tclas(tpAniSirGlobal pCtx, tDot11fIETCLAS *pSrc,
			      uint8_t *pBuf, uint32_t nBuf,
			      uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		...
		case 0:
			DOT11F_MEMCPY(pCtx, pBuf, pSrc->info.EthParams.source,
				      6);
			*pnConsumed += 6;
			pBuf += 6;
			...
			*pnConsumed += 1;
			...
			case 4:
				...
				*pnConsumed += 2;
				...
				frameshtons(pCtx, pBuf,
					    pSrc->info.IpParams.params
						    .IpV4Params.dest_port,
					    0);
				*pnConsumed += 2;
				pBuf += 2;
				*pBuf = pSrc->info.IpParams.params.IpV4Params
						.DSCP;
				*pnConsumed += 1;
				pBuf += 1;
				*pBuf = pSrc->info.IpParams.params.IpV4Params
		...
		case 2:
			frameshtons(pCtx, pBuf,
				    pSrc->info.Params8021dq.tag_type, 0);
			*pnConsumed += 2;
			/* fieldsEndFlag = 1 */
			break;
		}
...
uint32_t dot11f_pack_ie_tclassproc(tpAniSirGlobal pCtx,
				   tDot11fIETCLASSPROC *pSrc, uint8_t *pBuf,
				   uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_ts_delay(tpAniSirGlobal pCtx, tDot11fIETSDelay *pSrc,
				 uint8_t *pBuf, uint32_t nBuf,
				 uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_tsf_info(tpAniSirGlobal pCtx, tDot11fIETSFInfo *pSrc,
				 uint8_t *pBuf, uint32_t nBuf,
				 uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_tspec(tpAniSirGlobal pCtx, tDot11fIETSPEC *pSrc,
			      uint8_t *pBuf, uint32_t nBuf,
			      uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_vht_caps(tpAniSirGlobal pCtx, tDot11fIEVHTCaps *pSrc,
				 uint8_t *pBuf, uint32_t nBuf,
				 uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_wmm_schedule(tpAniSirGlobal pCtx,
				     tDot11fIEWMMSchedule *pSrc, uint8_t *pBuf,
				     uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_wmmtclas(tpAniSirGlobal pCtx, tDot11fIEWMMTCLAS *pSrc,
				 uint8_t *pBuf, uint32_t nBuf,
				 uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_wmmtclasproc(tpAniSirGlobal pCtx,
				     tDot11fIEWMMTCLASPROC *pSrc, uint8_t *pBuf,
				     uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_wmmts_delay(tpAniSirGlobal pCtx,
				    tDot11fIEWMMTSDelay *pSrc, uint8_t *pBuf,
				    uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_wmmtspec(tpAniSirGlobal pCtx, tDot11fIEWMMTSPEC *pSrc,
				 uint8_t *pBuf, uint32_t nBuf,
				 uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_wider_bw_chan_switch_ann(
	tpAniSirGlobal pCtx, tDot11fIEWiderBWChanSwitchAnn *pSrc, uint8_t *pBuf,
	uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_azimuth_req(tpAniSirGlobal pCtx,
				    tDot11fIEazimuth_req *pSrc, uint8_t *pBuf,
				    uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_beacon_report_frm_body_fragment_id(
	tpAniSirGlobal pCtx, tDot11fIEbeacon_report_frm_body_fragment_id *pSrc,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_last_beacon_report_indication(
	tpAniSirGlobal pCtx, tDot11fIElast_beacon_report_indication *pSrc,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_mscs_status(tpAniSirGlobal pCtx,
				    tDot11fIEmscs_status *pSrc, uint8_t *pBuf,
				    uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_neighbor_rpt(tpAniSirGlobal pCtx,
				     tDot11fIEneighbor_rpt *pSrc, uint8_t *pBuf,
				     uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_req_mac_addr(tpAniSirGlobal pCtx,
				     tDot11fIEreq_mac_addr *pSrc, uint8_t *pBuf,
				     uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_tclas_mask(tpAniSirGlobal pCtx,
				   tDot11fIEtclas_mask *pSrc, uint8_t *pBuf,
				   uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		...
		switch (pSrc->classifier_type) {
		case 4:
			DOT11F_MEMCPY(pCtx, pBuf, pSrc->info.ip_param.reserved,
				      16);
			*pnConsumed += 16;
			/* fieldsEndFlag = 1 */
			break;
...
uint32_t dot11f_pack_ie_tgt_mac_addr(tpAniSirGlobal pCtx,
				     tDot11fIEtgt_mac_addr *pSrc, uint8_t *pBuf,
				     uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
					   ...
					   uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		nBuf -= 1;
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->tx_power),
			      pSrc->num_tx_power);
...
uint32_t dot11f_pack_ie_aid(tpAniSirGlobal pCtx, tDot11fIEAID *pSrc,
			    uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_cf_params(tpAniSirGlobal pCtx, tDot11fIECFParams *pSrc,
				  uint8_t *pBuf, uint32_t nBuf,
				  uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_channel_switch_wrapper(
	tpAniSirGlobal pCtx, tDot11fIEChannelSwitchWrapper *pSrc, uint8_t *pBuf,
	uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
	uint32_t nNeeded = 0U;
	uint32_t status = DOT11F_PARSE_SUCCESS;
	status = dot11f_get_packed_ie_channel_switch_wrapper(pCtx, pSrc,
							     &nNeeded);
	if (!DOT11F_SUCCEEDED(status))
		return status;
	while (pSrc->present) {
		...
		*pBuf = 196;
		...
		++(*pnConsumed);
		status = pack_core(pCtx, (uint8_t *)pSrc, pBuf, nBuf,
				   pnConsumed, FFS_ChannelSwitchWrapper,
				   IES_ChannelSwitchWrapper);
		break;
	}
	(void)pCtx;
...
uint32_t dot11f_pack_ie_country(tpAniSirGlobal pCtx, tDot11fIECountry *pSrc,
				uint8_t *pBuf, uint32_t nBuf,
				uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	...
	while (pSrc->present) {
		...
		*pnConsumed += 3;
		...
		if (pSrc->num_more_triplets) {
			DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->more_triplets),
				      (pSrc->num_more_triplets * 3));
...
uint32_t dot11f_pack_ie_ds_params(tpAniSirGlobal pCtx, tDot11fIEDSParams *pSrc,
				  uint8_t *pBuf, uint32_t nBuf,
				  uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_erp_info(tpAniSirGlobal pCtx, tDot11fIEERPInfo *pSrc,
				 uint8_t *pBuf, uint32_t nBuf,
				 uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_ese_traf_strm_rate_set(
	tpAniSirGlobal pCtx, tDot11fIEESETrafStrmRateSet *pSrc, uint8_t *pBuf,
	uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_ese_version(tpAniSirGlobal pCtx,
				    tDot11fIEESEVersion *pSrc, uint8_t *pBuf,
				    uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_ext_cap(tpAniSirGlobal pCtx, tDot11fIEExtCap *pSrc,
				uint8_t *pBuf, uint32_t nBuf,
				uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_fh_param_set(tpAniSirGlobal pCtx,
				     tDot11fIEFHParamSet *pSrc, uint8_t *pBuf,
				     uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_fh_params(tpAniSirGlobal pCtx, tDot11fIEFHParams *pSrc,
				  uint8_t *pBuf, uint32_t nBuf,
				  uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_fh_patt_table(tpAniSirGlobal pCtx,
				      tDot11fIEFHPattTable *pSrc, uint8_t *pBuf,
				      uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->randtable),
			      pSrc->num_randtable);
...
uint32_t dot11f_pack_ie_ft_info(tpAniSirGlobal pCtx, tDot11fIEFTInfo *pSrc,
				uint8_t *pBuf, uint32_t nBuf,
				uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	...
	while (pSrc->present) {
		...
		*pnConsumed += 32;
		pBuf += 32;
		status = pack_core(pCtx, (uint8_t *)pSrc, pBuf, nBuf,
				   pnConsumed, FFS_FTInfo, IES_FTInfo);
		break;
	}
	(void)pCtx;
	if (pIeLen) {
...
uint32_t dot11f_pack_ie_ht_caps(tpAniSirGlobal pCtx, tDot11fIEHTCaps *pSrc,
				uint8_t *pBuf, uint32_t nBuf,
				uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	...
	while (pSrc->present) {
		...
		*pnConsumed += 2;
		...
		tmp160__ |= (pSrc->explicitUncompressedSteeringMatrixFeedback
			     << 13);
		tmp160__ |=
			(pSrc->explicitCompressedSteeringMatrixFeedback << 16);
...
uint32_t dot11f_pack_ie_ht_info(tpAniSirGlobal pCtx, tDot11fIEHTInfo *pSrc,
				uint8_t *pBuf, uint32_t nBuf,
				uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_MBO_IE(tpAniSirGlobal pCtx, tDot11fIEMBO_IE *pSrc,
			       uint8_t *pBuf, uint32_t nBuf,
			       uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
		...
		*pnConsumed += 1;
		...
		if (pSrc->type) {
			...
			case 0:
				...
				*pnConsumed += 1;
				pBuf += 1;
				frameshtonq(pCtx, pBuf,
					    pSrc->report.Basic.meas_start_time,
					    0);
				*pnConsumed += 8;
				pBuf += 8;
				frameshtons(pCtx, pBuf,
					    pSrc->report.Basic.meas_duration,
					    0);
				*pnConsumed += 2;
				pBuf += 2;
				tmp166__ = 0U;
				...
				tmp166__ |=
					(pSrc->report.Basic.ofdm_preamble << 1);
				tmp166__ |=
					(pSrc->report.Basic.unid_signal << 2);
				tmp166__ |= (pSrc->report.Basic.rader << 3);
				tmp166__ |=
					(pSrc->report.Basic.unmeasured << 4);
			...
			case 1:
				...
				*pnConsumed += 1;
				pBuf += 1;
				frameshtonq(pCtx, pBuf,
					    pSrc->report.CCA.meas_start_time,
					    0);
				*pnConsumed += 8;
				pBuf += 8;
				frameshtons(pCtx, pBuf,
					    pSrc->report.CCA.meas_duration, 0);
				*pnConsumed += 2;
				pBuf += 2;
			...
			case 2:
				...
				*pnConsumed += 8;
				...
				frameshtons(
					pCtx, pBuf,
					pSrc->report.RPIHistogram.meas_duration,
					0);
				*pnConsumed += 2;
				pBuf += 2;
			...
			case 5:
				...
				*pnConsumed += 1;
				pBuf += 1;
				frameshtonq(pCtx, pBuf,
					    pSrc->report.Beacon.meas_start_time,
					    0);
				*pnConsumed += 8;
				pBuf += 8;
				frameshtons(pCtx, pBuf,
					    pSrc->report.Beacon.meas_duration,
					    0);
				*pnConsumed += 2;
				pBuf += 2;
				tmp167__ = 0U;
				tmp167__ |= (pSrc->report.Beacon.condensed_PHY
					     << 0);
				tmp167__ |=
					(pSrc->report.Beacon.reported_frame_type
					 << 7);
				if (unlikely(nBuf < 1))
					return DOT11F_INCOMPLETE_IE;
				...
				*pnConsumed += 1;
				pBuf += 1;
				DOT11F_MEMCPY(pCtx, pBuf,
					      pSrc->report.Beacon.BSSID, 6);
				*pnConsumed += 6;
				pBuf += 6;
				*pBuf = pSrc->report.Beacon.antenna_id;
				*pnConsumed += 1;
				pBuf += 1;
				frameshtonl(pCtx, pBuf,
					    pSrc->report.Beacon.parent_TSF, 0);
				*pnConsumed += 4;
				pBuf += 4;
				status = pack_core(pCtx, (uint8_t *)pSrc, pBuf,
						   nBuf, pnConsumed,
						   FFS_reportBeacon,
						   IES_reportBeacon);
				break;
		...
		*pnConsumed += 1;
		...
		case 0:
			...
			*pnConsumed += 1;
			...
			DOT11F_MEMCPY(
				pCtx, pBuf,
				pSrc->measurement_request.Basic.meas_start_time,
				8);
			*pnConsumed += 8;
			pBuf += 8;
			frameshtons(
				pCtx, pBuf,
				pSrc->measurement_request.Basic.meas_duration,
				0);
			*pnConsumed += 2;
			/* fieldsEndFlag = 1 */
			break;
		case 1:
			...
			*pnConsumed += 1;
			...
			DOT11F_MEMCPY(
				pCtx, pBuf,
				pSrc->measurement_request.CCA.meas_start_time,
				8);
			*pnConsumed += 8;
			pBuf += 8;
			frameshtons(pCtx, pBuf,
				    pSrc->measurement_request.CCA.meas_duration,
				    0);
			*pnConsumed += 2;
			/* fieldsEndFlag = 1 */
			break;
		case 2:
			*pBuf = pSrc->measurement_request.RPIHistogram
					.channel_no;
			*pnConsumed += 1;
			pBuf += 1;
			DOT11F_MEMCPY(pCtx, pBuf,
				      pSrc->measurement_request.RPIHistogram
					      .meas_start_time,
				      8);
			*pnConsumed += 8;
			pBuf += 8;
		...
		case 5:
			...
			*pnConsumed += 1;
			...
			frameshtons(
				pCtx, pBuf,
				pSrc->measurement_request.Beacon.randomization,
				0);
			*pnConsumed += 2;
			pBuf += 2;
			frameshtons(
				pCtx, pBuf,
				pSrc->measurement_request.Beacon.meas_duration,
				0);
			*pnConsumed += 2;
			pBuf += 2;
			...
			*pnConsumed += 1;
			pBuf += 1;
			DOT11F_MEMCPY(pCtx, pBuf,
				      pSrc->measurement_request.Beacon.BSSID,
				      6);
			*pnConsumed += 6;
			pBuf += 6;
			status = pack_core(pCtx, (uint8_t *)pSrc, pBuf, nBuf,
		...
		case 16:
			frameshtons(
				pCtx, pBuf,
				pSrc->measurement_request.ftmrr.random_interval,
				0);
			*pnConsumed += 2;
			pBuf += 2;
					     ...
					     uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 2;
		pBuf += 2;
		frameshtons(pCtx, pBuf,
			    pSrc->bssChannelWidthTriggerScanInterval, 0);
		*pnConsumed += 2;
		pBuf += 2;
		frameshtons(pCtx, pBuf, pSrc->obssScanPassiveTotalPerChannel,
			    0);
		*pnConsumed += 2;
		pBuf += 2;
		...
		*pnConsumed += 2;
		pBuf += 2;
		frameshtons(pCtx, pBuf,
			    pSrc->bssWidthChannelTransitionDelayFactor, 0);
		*pnConsumed += 2;
		pBuf += 2;
...
uint32_t dot11f_pack_ie_p2_p_beacon(tpAniSirGlobal pCtx,
				    tDot11fIEP2PBeacon *pSrc, uint8_t *pBuf,
				    uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t n, idx = 0, idxlast;
					      ...
					      uint32_t *pnConsumed)
{
	...
	uint32_t nNeeded = 0U;
	status =
		dot11f_get_packed_iep2_p_beacon_probe_res(pCtx, pSrc, &nNeeded);
	if (!DOT11F_SUCCEEDED(status))
		return status;
	if (nNeeded > nBuf)
		return DOT11F_BUFFER_OVERFLOW;
...
uint32_t dot11f_pack_ie_p2_p_de_auth(tpAniSirGlobal pCtx,
				     tDot11fIEP2PDeAuth *pSrc, uint8_t *pBuf,
				     uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t n, idx = 0, idxlast;
...
uint32_t dot11f_pack_ie_p2_pie_opaque(tpAniSirGlobal pCtx,
				      tDot11fIEP2PIEOpaque *pSrc, uint8_t *pBuf,
				      uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_pti_control(tpAniSirGlobal pCtx,
				    tDot11fIEPTIControl *pSrc, uint8_t *pBuf,
				    uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_power_caps(tpAniSirGlobal pCtx,
				   tDot11fIEPowerCaps *pSrc, uint8_t *pBuf,
				   uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_qbss_load(tpAniSirGlobal pCtx, tDot11fIEQBSSLoad *pSrc,
				  uint8_t *pBuf, uint32_t nBuf,
				  uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_QComVendorIE(tpAniSirGlobal pCtx,
				     tDot11fIEQComVendorIE *pSrc, uint8_t *pBuf,
				     uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_qos_caps_ap(tpAniSirGlobal pCtx,
				    tDot11fIEQOSCapsAp *pSrc, uint8_t *pBuf,
				    uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_qos_map_set(tpAniSirGlobal pCtx,
				    tDot11fIEQosMapSet *pSrc, uint8_t *pBuf,
				    uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
	...
	while (pSrc->present) {
		...
		*pBuf = 110;
		...
		++pBuf;
		++(*pnConsumed);
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->dscp_exceptions),
			      pSrc->num_dscp_exceptions);
...
uint32_t dot11f_pack_ie_quiet(tpAniSirGlobal pCtx, tDot11fIEQuiet *pSrc,
			      uint8_t *pBuf, uint32_t nBuf,
			      uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_rcpiie(tpAniSirGlobal pCtx, tDot11fIERCPIIE *pSrc,
			       uint8_t *pBuf, uint32_t nBuf,
			       uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_ric_data_desc(tpAniSirGlobal pCtx,
				      tDot11fIERICDataDesc *pSrc, uint8_t *pBuf,
				      uint32_t nBuf, uint32_t *pnConsumed)
{
	uint32_t nNeeded = 0U;
	uint32_t status = DOT11F_PARSE_SUCCESS;
...
uint32_t dot11f_pack_ie_rsn(tpAniSirGlobal pCtx, tDot11fIERSN *pSrc,
			    uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
	...
	while (pSrc->present) {
		...
		*pnConsumed += 2;
		...
		if (pSrc->pwise_cipher_suite_count) {
			frameshtons(pCtx, pBuf, pSrc->pwise_cipher_suite_count,
				    0);
			*pnConsumed += 2;
			pBuf += 2;
		} else {
		...
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->pwise_cipher_suites),
			      (pSrc->pwise_cipher_suite_count * 4));
		*pnConsumed += (pSrc->pwise_cipher_suite_count * 4);
		...
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->akm_suite),
			      (pSrc->akm_suite_cnt * 4));
		*pnConsumed += (pSrc->akm_suite_cnt * 4);
		...
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->pmkid),
			      (pSrc->pmkid_count * 16));
...
uint32_t dot11f_pack_ie_rsniie(tpAniSirGlobal pCtx, tDot11fIERSNIIE *pSrc,
			       uint8_t *pBuf, uint32_t nBuf,
			       uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_rsn_opaque(tpAniSirGlobal pCtx,
				   tDot11fIERSNOpaque *pSrc, uint8_t *pBuf,
				   uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
				      ...
				      uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 36;
		...
		++pBuf;
		++(*pnConsumed);
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->bands),
			      (pSrc->num_bands * 2));
...
uint32_t dot11f_pack_ie_supp_operating_classes(
	tpAniSirGlobal pCtx, tDot11fIESuppOperatingClasses *pSrc, uint8_t *pBuf,
	uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_supp_rates(tpAniSirGlobal pCtx,
				   tDot11fIESuppRates *pSrc, uint8_t *pBuf,
				   uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_tim(tpAniSirGlobal pCtx, tDot11fIETIM *pSrc,
			    uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_tpc_report(tpAniSirGlobal pCtx,
				   tDot11fIETPCReport *pSrc, uint8_t *pBuf,
				   uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_tpc_request(tpAniSirGlobal pCtx,
				    tDot11fIETPCRequest *pSrc, uint8_t *pBuf,
				    uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_vendor1_ie(tpAniSirGlobal pCtx,
				   tDot11fIEVendor1IE *pSrc, uint8_t *pBuf,
				   uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_vendor3_ie(tpAniSirGlobal pCtx,
				   tDot11fIEVendor3IE *pSrc, uint8_t *pBuf,
				   uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_wapi(tpAniSirGlobal pCtx, tDot11fIEWAPI *pSrc,
			     uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
	...
	while (pSrc->present) {
		...
		*pnConsumed += 2;
		pBuf += 2;
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->akm_suites),
			      (pSrc->akm_suite_count * 4));
		*pnConsumed += (pSrc->akm_suite_count * 4);
		pBuf += (pSrc->akm_suite_count * 4);
		frameshtons(pCtx, pBuf, pSrc->unicast_cipher_suite_count, 0);
		*pnConsumed += 2;
		pBuf += 2;
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->unicast_cipher_suites),
			      (pSrc->unicast_cipher_suite_count * 4));
		...
		*pnConsumed += 2;
		...
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->bkid),
			      (pSrc->bkid_count * 16));
...
uint32_t dot11f_pack_ie_wapi_opaque(tpAniSirGlobal pCtx,
				    tDot11fIEWAPIOpaque *pSrc, uint8_t *pBuf,
				    uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_wfatpc(tpAniSirGlobal pCtx, tDot11fIEWFATPC *pSrc,
			       uint8_t *pBuf, uint32_t nBuf,
			       uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_wfdie_opaque(tpAniSirGlobal pCtx,
				     tDot11fIEWFDIEOpaque *pSrc, uint8_t *pBuf,
				     uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_wmm_caps(tpAniSirGlobal pCtx, tDot11fIEWMMCaps *pSrc,
				 uint8_t *pBuf, uint32_t nBuf,
				 uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_wmm_info_ap(tpAniSirGlobal pCtx,
				    tDot11fIEWMMInfoAp *pSrc, uint8_t *pBuf,
				    uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_wmm_params(tpAniSirGlobal pCtx,
				   tDot11fIEWMMParams *pSrc, uint8_t *pBuf,
				   uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_wpa(tpAniSirGlobal pCtx, tDot11fIEWPA *pSrc,
			    uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
	...
	while (pSrc->present) {
		...
		*pnConsumed += 2;
		...
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->unicast_ciphers),
			      (pSrc->unicast_cipher_count * 4));
		*pnConsumed += (pSrc->unicast_cipher_count * 4);
		...
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->auth_suites),
			      (pSrc->auth_suite_count * 4));
...
uint32_t dot11f_pack_ie_wpa_opaque(tpAniSirGlobal pCtx,
				   tDot11fIEWPAOpaque *pSrc, uint8_t *pBuf,
				   uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_wsc(tpAniSirGlobal pCtx, tDot11fIEWSC *pSrc,
			    uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t n, idx = 0, idxlast;
...
uint32_t dot11f_pack_ie_wsc_assoc_req(tpAniSirGlobal pCtx,
				      tDot11fIEWscAssocReq *pSrc, uint8_t *pBuf,
				      uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t n, idx = 0, idxlast;
...
uint32_t dot11f_pack_ie_wsc_assoc_res(tpAniSirGlobal pCtx,
				      tDot11fIEWscAssocRes *pSrc, uint8_t *pBuf,
				      uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t n, idx = 0, idxlast;
...
uint32_t dot11f_pack_ie_wsc_beacon(tpAniSirGlobal pCtx,
				   tDot11fIEWscBeacon *pSrc, uint8_t *pBuf,
				   uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t n, idx = 0, idxlast;
					     ...
					     uint32_t *pnConsumed)
{
	...
	uint32_t nNeeded = 0U;
	status =
		dot11f_get_packed_ie_wsc_beacon_probe_res(pCtx, pSrc, &nNeeded);
	if (!DOT11F_SUCCEEDED(status))
		return status;
	if (nNeeded > nBuf)
		return DOT11F_BUFFER_OVERFLOW;
...
uint32_t dot11f_pack_ie_wsc_ie_opaque(tpAniSirGlobal pCtx,
				      tDot11fIEWscIEOpaque *pSrc, uint8_t *pBuf,
				      uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_wsc_probe_req(tpAniSirGlobal pCtx,
				      tDot11fIEWscProbeReq *pSrc, uint8_t *pBuf,
				      uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t n, idx = 0, idxlast;
...
uint32_t dot11f_pack_ie_wsc_probe_res(tpAniSirGlobal pCtx,
				      tDot11fIEWscProbeRes *pSrc, uint8_t *pBuf,
				      uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t n, idx = 0, idxlast;
					   ...
					   uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 4;
		pBuf += 4;
		status = pack_core(pCtx, (uint8_t *)pSrc, pBuf, nBuf,
				   pnConsumed, FFS_descriptor_element,
				   IES_descriptor_element);
		break;
	}
	(void)pCtx;
...
uint32_t dot11f_pack_ie_dh_parameter_element(
	tpAniSirGlobal pCtx, tDot11fIEdh_parameter_element *pSrc, uint8_t *pBuf,
	uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
	...
	while (pSrc->present) {
		...
		*pnConsumed += 2;
		pBuf += 2;
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->public_key),
			      pSrc->num_public_key);
...
uint32_t dot11f_pack_ie_eht_cap(tpAniSirGlobal pCtx, tDot11fIEeht_cap *pSrc,
				uint8_t *pBuf, uint32_t nBuf,
				uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	...
	while (pSrc->present) {
		...
		*pnConsumed += 4;
		...
		tmp194__ |=
			(pSrc->triggered_mu_bf_full_bw_fb_and_dl_mumimo << 3);
		...
		*pnConsumed += 1;
		...
		if (pSrc->ppet_present) {
			...
			case 1:
				DOT11F_MEMCPY(
					pCtx, pBuf,
					&(pSrc->ppet.ppe_threshold.ppe_th),
					pSrc->ppet.ppe_threshold.num_ppe_th);
				*pnConsumed +=
					pSrc->ppet.ppe_threshold.num_ppe_th;
				/* fieldsEndFlag = 1 */
				break;
...
uint32_t dot11f_pack_ie_eht_op(tpAniSirGlobal pCtx, tDot11fIEeht_op *pSrc,
			       uint8_t *pBuf, uint32_t nBuf,
			       uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->disabled_sub_chan_bitmap),
			      (pSrc->disabled_sub_chan_bitmap_present * 2));
...
uint32_t dot11f_pack_ie_fils_assoc_delay_info(
	tpAniSirGlobal pCtx, tDot11fIEfils_assoc_delay_info *pSrc,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
					   ...
					   uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 6;
		pBuf += 6;
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->hlp_packet),
			      pSrc->num_hlp_packet);
					...
					uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 2;
		pBuf += 2;
		nBuf -= 2;
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->variable_data),
			      pSrc->num_variable_data);
...
uint32_t dot11f_pack_ie_fils_kde(tpAniSirGlobal pCtx, tDot11fIEfils_kde *pSrc,
				 uint8_t *pBuf, uint32_t nBuf,
				 uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	...
	while (pSrc->present) {
		...
		*pnConsumed += 8;
		pBuf += 8;
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->kde_list),
			      pSrc->num_kde_list);
...
uint32_t dot11f_pack_ie_fils_key_confirmation(
	tpAniSirGlobal pCtx, tDot11fIEfils_key_confirmation *pSrc,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
	...
	while (pSrc->present) {
		...
		*pBuf = 3;
		++pBuf;
		++(*pnConsumed);
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->key_auth),
			      pSrc->num_key_auth);
...
uint32_t dot11f_pack_ie_fils_nonce(tpAniSirGlobal pCtx,
				   tDot11fIEfils_nonce *pSrc, uint8_t *pBuf,
				   uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_fils_session(tpAniSirGlobal pCtx,
				     tDot11fIEfils_session *pSrc, uint8_t *pBuf,
				     uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
					  ...
					  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 8;
		++pBuf;
		++(*pnConsumed);
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->wrapped_data),
			      pSrc->num_wrapped_data);
...
uint32_t dot11f_pack_ie_fragment_ie(tpAniSirGlobal pCtx,
				    tDot11fIEfragment_ie *pSrc, uint8_t *pBuf,
				    uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_he_cap(tpAniSirGlobal pCtx, tDot11fIEhe_cap *pSrc,
			       uint8_t *pBuf, uint32_t nBuf,
			       uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	...
	while (pSrc->present) {
		...
		*pnConsumed += 2;
		pBuf += 2;
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->rx_he_mcs_map_160),
			      (pSrc->chan_width_2 * 2));
		*pnConsumed += (pSrc->chan_width_2 * 2);
		pBuf += (pSrc->chan_width_2 * 2);
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->tx_he_mcs_map_160),
			      (pSrc->chan_width_2 * 2));
		*pnConsumed += (pSrc->chan_width_2 * 2);
		pBuf += (pSrc->chan_width_2 * 2);
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->rx_he_mcs_map_80_80),
			      (pSrc->chan_width_3 * 2));
		*pnConsumed += (pSrc->chan_width_3 * 2);
		pBuf += (pSrc->chan_width_3 * 2);
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->tx_he_mcs_map_80_80),
			      (pSrc->chan_width_3 * 2));
		*pnConsumed += (pSrc->chan_width_3 * 2);
		pBuf += (pSrc->chan_width_3 * 2);
		if (pSrc->ppet_present) {
...
uint32_t dot11f_pack_ie_he_op(tpAniSirGlobal pCtx, tDot11fIEhe_op *pSrc,
			      uint8_t *pBuf, uint32_t nBuf,
			      uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
		...
		if (pSrc->oper_info_6g_present) {
			...
			case 1:
				...
				*pnConsumed += 1;
				...
				tmp212__ = 0U;
				tmp212__ |=
					(pSrc->oper_info_6g.info.ch_width << 0);
				tmp212__ |=
					(pSrc->oper_info_6g.info.dup_bcon << 2);
				tmp212__ |=
					(pSrc->oper_info_6g.info.reg_info << 3);
				tmp212__ |=
					(pSrc->oper_info_6g.info.reserved << 6);
				if (unlikely(nBuf < 1))
					return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		if (pSrc->hs_id_present) {
			...
			case 2:
				frameshtons(
					pCtx, pBuf,
					pSrc->hs_id.anqp_domain.anqp_domain_id,
					0);
				*pnConsumed += 2;
				/* fieldsEndFlag = 1 */
				break;
...
uint32_t dot11f_pack_ie_ht2040_bss_coexistence(
	tpAniSirGlobal pCtx, tDot11fIEht2040_bss_coexistence *pSrc,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_ht2040_bss_intolerant_report(
	tpAniSirGlobal pCtx, tDot11fIEht2040_bss_intolerant_report *pSrc,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		DOT11F_MEMCPY(pCtx, pBuf, &(pSrc->channel_list),
			      pSrc->num_channel_list);
...
uint32_t dot11f_pack_ie_max_chan_switch_time(
	tpAniSirGlobal pCtx, tDot11fIEmax_chan_switch_time *pSrc, uint8_t *pBuf,
	uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_mlo_ie(tpAniSirGlobal pCtx, tDot11fIEmlo_ie *pSrc,
			       uint8_t *pBuf, uint32_t nBuf,
			       uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_oci(tpAniSirGlobal pCtx, tDot11fIEoci *pSrc,
			    uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_osen_ie(tpAniSirGlobal pCtx, tDot11fIEosen_ie *pSrc,
				uint8_t *pBuf, uint32_t nBuf,
				uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_qcn_ie(tpAniSirGlobal pCtx, tDot11fIEqcn_ie *pSrc,
			       uint8_t *pBuf, uint32_t nBuf,
			       uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_ie_reduced_neighbor_report(
	tpAniSirGlobal pCtx, tDot11fIEreduced_neighbor_report *pSrc,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
	...
	uint16_t tmp224__;
	uint32_t status = DOT11F_PARSE_SUCCESS;
	status = dot11f_get_packed_ie_reduced_neighbor_report(pCtx, pSrc,
							      &nNeeded);
	if (!DOT11F_SUCCEEDED(status))
		return status;
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		...
		case 5:
			...
			*pnConsumed += 1;
			pBuf += 1;
			frameshtonl(pCtx, pBuf,
				    pSrc->tbtt_info.tbtt_info_5.short_ssid, 0);
			*pnConsumed += 4;
			/* fieldsEndFlag = 1 */
			break;
		case 6:
			...
			*pnConsumed += 1;
			pBuf += 1;
			frameshtonl(pCtx, pBuf,
				    pSrc->tbtt_info.tbtt_info_6.short_ssid, 0);
			*pnConsumed += 4;
			pBuf += 4;
		...
		case 7:
			...
			*pnConsumed += 1;
			pBuf += 1;
			DOT11F_MEMCPY(pCtx, pBuf,
				      pSrc->tbtt_info.tbtt_info_7.bssid, 6);
			*pnConsumed += 6;
			/* fieldsEndFlag = 1 */
			break;
		case 8:
			...
			*pnConsumed += 1;
			pBuf += 1;
			DOT11F_MEMCPY(pCtx, pBuf,
				      pSrc->tbtt_info.tbtt_info_8.bssid, 6);
			*pnConsumed += 6;
			pBuf += 6;
		...
		case 9:
			...
			*pnConsumed += 1;
			pBuf += 1;
			DOT11F_MEMCPY(pCtx, pBuf,
				      pSrc->tbtt_info.tbtt_info_9.bssid, 6);
			*pnConsumed += 6;
			pBuf += 6;
		...
		case 11:
			...
			*pnConsumed += 1;
			pBuf += 1;
			DOT11F_MEMCPY(pCtx, pBuf,
				      pSrc->tbtt_info.tbtt_info_11.bssid, 6);
			*pnConsumed += 6;
			pBuf += 6;
			frameshtonl(pCtx, pBuf,
				    pSrc->tbtt_info.tbtt_info_11.short_ssid, 0);
			*pnConsumed += 4;
			/* fieldsEndFlag = 1 */
			break;
		case 12:
			...
			*pnConsumed += 1;
			pBuf += 1;
			DOT11F_MEMCPY(pCtx, pBuf,
				      pSrc->tbtt_info.tbtt_info_12.bssid, 6);
			*pnConsumed += 6;
			pBuf += 6;
			frameshtonl(pCtx, pBuf,
				    pSrc->tbtt_info.tbtt_info_12.short_ssid, 0);
			*pnConsumed += 4;
			pBuf += 4;
		...
		case 13:
			...
			*pnConsumed += 1;
			pBuf += 1;
			DOT11F_MEMCPY(pCtx, pBuf,
				      pSrc->tbtt_info.tbtt_info_13.bssid, 6);
			*pnConsumed += 6;
			pBuf += 6;
			frameshtonl(pCtx, pBuf,
				    pSrc->tbtt_info.tbtt_info_13.short_ssid, 0);
			*pnConsumed += 4;
			pBuf += 4;
		...
		case 16:
			...
			*pnConsumed += 1;
			pBuf += 1;
			DOT11F_MEMCPY(pCtx, pBuf,
				      pSrc->tbtt_info.tbtt_info_16.bssid, 6);
			*pnConsumed += 6;
			pBuf += 6;
			frameshtonl(pCtx, pBuf,
				    pSrc->tbtt_info.tbtt_info_16.short_ssid, 0);
			*pnConsumed += 4;
			pBuf += 4;
			...
			*pnConsumed += 1;
			...
			tmp224__ |= (pSrc->tbtt_info.tbtt_info_16
			...
			tmp224__ |= (pSrc->tbtt_info.tbtt_info_16
				     ...
				     << 12);
			tmp224__ |=
				(pSrc->tbtt_info.tbtt_info_16.reserved << 13);
			if (unlikely(nBuf < 2))
				return DOT11F_INCOMPLETE_IE;
...
uint32_t dot11f_pack_ie_roaming_consortium_sel(
	tpAniSirGlobal pCtx, tDot11fIEroaming_consortium_sel *pSrc,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
	uint32_t nConsumedOnEntry = *pnConsumed;
...
uint32_t dot11f_pack_ie_t2lm_ie(tpAniSirGlobal pCtx, tDot11fIEt2lm_ie *pSrc,
				uint8_t *pBuf, uint32_t nBuf,
				uint32_t *pnConsumed)
{
	uint8_t *pIeLen = 0;
...
uint32_t dot11f_pack_beacon(tpAniSirGlobal pCtx, tDot11fBeacon *pFrm,
			    uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint32_t i = 0;
	uint32_t status = 0;
...
uint32_t dot11f_pack_beacon1(tpAniSirGlobal pCtx, tDot11fBeacon1 *pFrm,
			     uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint32_t i = 0;
	uint32_t status = 0;
...
uint32_t dot11f_pack_beacon2(tpAniSirGlobal pCtx, tDot11fBeacon2 *pFrm,
			     uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint32_t i = 0;
	uint32_t status = 0;
...
uint32_t dot11f_pack_beacon_i_es(tpAniSirGlobal pCtx, tDot11fBeaconIEs *pFrm,
				 uint8_t *pBuf, uint32_t nBuf,
				 uint32_t *pnConsumed)
{
	uint32_t i = 0;
...
uint32_t dot11f_pack_de_auth(tpAniSirGlobal pCtx, tDot11fDeAuth *pFrm,
			     uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint32_t i = 0;
	uint32_t status = 0;
...
uint32_t dot11f_pack_del_ts(tpAniSirGlobal pCtx, tDot11fDelTS *pFrm,
			    uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint32_t i = 0;
	uint32_t status = 0;
...
uint32_t dot11f_pack_link_measurement_request(
	tpAniSirGlobal pCtx, tDot11fLinkMeasurementRequest *pFrm, uint8_t *pBuf,
	uint32_t nBuf, uint32_t *pnConsumed)
{
	uint32_t i = 0;
	uint32_t status = 0;
...
uint32_t dot11f_pack_neighbor_report_response(
	tpAniSirGlobal pCtx, tDot11fNeighborReportResponse *pFrm, uint8_t *pBuf,
	uint32_t nBuf, uint32_t *pnConsumed)
{
	uint32_t i = 0;
	uint32_t status = 0;
...
uint32_t dot11f_pack_radio_measurement_report(
	tpAniSirGlobal pCtx, tDot11fRadioMeasurementReport *pFrm, uint8_t *pBuf,
	uint32_t nBuf, uint32_t *pnConsumed)
{
	uint32_t i = 0;
	uint32_t status = 0;
...
uint32_t dot11f_pack_radio_measurement_request(
	tpAniSirGlobal pCtx, tDot11fRadioMeasurementRequest *pFrm,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint32_t i = 0;
...
uint32_t dot11f_pack_sa_query_req(tpAniSirGlobal pCtx, tDot11fSaQueryReq *pFrm,
				  uint8_t *pBuf, uint32_t nBuf,
				  uint32_t *pnConsumed)
{
	uint32_t i = 0;
...
uint32_t dot11f_pack_sa_query_rsp(tpAniSirGlobal pCtx, tDot11fSaQueryRsp *pFrm,
				  uint8_t *pBuf, uint32_t nBuf,
				  uint32_t *pnConsumed)
{
	uint32_t i = 0;
...
uint32_t dot11f_pack_tdls_dis_req(tpAniSirGlobal pCtx, tDot11fTDLSDisReq *pFrm,
				  uint8_t *pBuf, uint32_t nBuf,
				  uint32_t *pnConsumed)
{
	uint32_t i = 0;
...
uint32_t dot11f_pack_tdls_dis_rsp(tpAniSirGlobal pCtx, tDot11fTDLSDisRsp *pFrm,
				  uint8_t *pBuf, uint32_t nBuf,
				  uint32_t *pnConsumed)
{
	uint32_t i = 0;
...
uint32_t dot11f_pack_tpc_report(tpAniSirGlobal pCtx, tDot11fTPCReport *pFrm,
				uint8_t *pBuf, uint32_t nBuf,
				uint32_t *pnConsumed)
{
	uint32_t i = 0;
...
uint32_t dot11f_pack_tpc_request(tpAniSirGlobal pCtx, tDot11fTPCRequest *pFrm,
				 uint8_t *pBuf, uint32_t nBuf,
				 uint32_t *pnConsumed)
{
	uint32_t i = 0;
...
uint32_t dot11f_pack_timing_advertisement_frame(
	tpAniSirGlobal pCtx, tDot11fTimingAdvertisementFrame *pFrm,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint32_t i = 0;
...
uint32_t dot11f_pack_vht_gid_management_action_frame(
	tpAniSirGlobal pCtx, tDot11fVHTGidManagementActionFrame *pFrm,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint32_t i = 0;
...
uint32_t dot11f_pack_wmm_del_ts(tpAniSirGlobal pCtx, tDot11fWMMDelTS *pFrm,
				uint8_t *pBuf, uint32_t nBuf,
				uint32_t *pnConsumed)
{
	uint32_t i = 0;
...
uint32_t dot11f_pack_addba_req(tpAniSirGlobal pCtx, tDot11faddba_req *pFrm,
			       uint8_t *pBuf, uint32_t nBuf,
			       uint32_t *pnConsumed)
{
	uint32_t i = 0;
...
uint32_t dot11f_pack_addba_rsp(tpAniSirGlobal pCtx, tDot11faddba_rsp *pFrm,
			       uint8_t *pBuf, uint32_t nBuf,
			       uint32_t *pnConsumed)
{
	uint32_t i = 0;
...
uint32_t dot11f_pack_delba_req(tpAniSirGlobal pCtx, tDot11fdelba_req *pFrm,
			       uint8_t *pBuf, uint32_t nBuf,
			       uint32_t *pnConsumed)
{
	uint32_t i = 0;
...
uint32_t dot11f_pack_ht2040_bss_coexistence_mgmt_action_frame(
	tpAniSirGlobal pCtx,
...
uint32_t dot11f_pack_mscs_request_action_frame(
	tpAniSirGlobal pCtx, tDot11fmscs_request_action_frame *pFrm,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint32_t i = 0;
...
uint32_t dot11f_pack_p2p_oper_chan_change_confirm(
	tpAniSirGlobal pCtx, tDot11fp2p_oper_chan_change_confirm *pFrm,
	uint8_t *pBuf, uint32_t nBuf, uint32_t *pnConsumed)
{
	uint32_t i = 0;
	...
	*pnConsumed = 0U;
	status = pack_core(pCtx, (uint8_t *)pFrm, pBuf, nBuf, pnConsumed,
			   FFS_p2p_oper_chan_change_confirm,
			   IES_p2p_oper_chan_change_confirm);
			  ...
			  const tFFDefn FFs[], const tIEDefn IEs[])
{
	...
	while (pFf->size) {
		...
		switch (pFf->sig) {
		case SigFfAID:
			dot11f_pack_ff_aid(pCtx,
					   (tDot11fFfAID *)(pSrc + pFf->offset),
					   pBufRemaining);
			break;
		case SigFfAction:
			dot11f_pack_ff_action(
				pCtx, (tDot11fFfAction *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfAuthAlgo:
			dot11f_pack_ff_auth_algo(
				pCtx, (tDot11fFfAuthAlgo *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfAuthSeqNo:
			dot11f_pack_ff_auth_seq_no(
				pCtx,
				(tDot11fFfAuthSeqNo *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfBeaconInterval:
			dot11f_pack_ff_beacon_interval(
				pCtx,
				(tDot11fFfBeaconInterval *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfCapabilities:
			dot11f_pack_ff_capabilities(
				pCtx,
				(tDot11fFfCapabilities *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfCategory:
			dot11f_pack_ff_category(
				pCtx, (tDot11fFfCategory *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfCurrentAPAddress:
		...
		case SigFfDialogToken:
			dot11f_pack_ff_dialog_token(
				pCtx,
				(tDot11fFfDialogToken *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfLinkMargin:
			dot11f_pack_ff_link_margin(
				pCtx,
				(tDot11fFfLinkMargin *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfListenInterval:
			dot11f_pack_ff_listen_interval(
				pCtx,
				(tDot11fFfListenInterval *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfMaxTxPower:
			dot11f_pack_ff_max_tx_power(
				pCtx,
				(tDot11fFfMaxTxPower *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfNumOfRepetitions:
		...
		case SigFfOperatingMode:
			dot11f_pack_ff_operating_mode(
				pCtx,
				(tDot11fFfOperatingMode *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfRCPI:
			dot11f_pack_ff_rcpi(
				pCtx, (tDot11fFfRCPI *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfRSNI:
			dot11f_pack_ff_rsni(
				pCtx, (tDot11fFfRSNI *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfReason:
			dot11f_pack_ff_reason(
				pCtx, (tDot11fFfReason *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfRxAntennaId:
			dot11f_pack_ff_rx_antenna_id(
				pCtx,
				(tDot11fFfRxAntennaId *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfSMPowerModeSet:
			dot11f_pack_ff_sm_power_mode_set(
				pCtx,
				(tDot11fFfSMPowerModeSet *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfStatus:
			dot11f_pack_ff_status(
				pCtx, (tDot11fFfStatus *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfStatusCode:
			dot11f_pack_ff_status_code(
				pCtx,
				(tDot11fFfStatusCode *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfTPCEleID:
			dot11f_pack_ff_tpc_ele_id(
				pCtx, (tDot11fFfTPCEleID *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfTPCEleLen:
			dot11f_pack_ff_tpc_ele_len(
				pCtx,
				(tDot11fFfTPCEleLen *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfTSInfo:
			dot11f_pack_ff_ts_info(
				pCtx, (tDot11fFfTSInfo *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfTimeStamp:
			dot11f_pack_ff_time_stamp(
				pCtx,
				(tDot11fFfTimeStamp *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfTransactionId:
			dot11f_pack_ff_transaction_id(
				pCtx,
				(tDot11fFfTransactionId *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfTxAntennaId:
			dot11f_pack_ff_tx_antenna_id(
				pCtx,
				(tDot11fFfTxAntennaId *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfTxPower:
			dot11f_pack_ff_tx_power(
				pCtx, (tDot11fFfTxPower *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfVhtMembershipStatusArray:
		...
		case SigFfba_timeout:
			dot11f_pack_ff_ba_timeout(
				pCtx,
				(tDot11fFfba_timeout *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfdelba_param_set:
		...
		case SigFfp2p_action_oui:
			dot11f_pack_ff_p2p_action_oui(
				pCtx,
				(tDot11fFfp2p_action_oui *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		case SigFfp2p_action_subtype:
		...
		case SigFfvendor_oui:
			dot11f_pack_ff_vendor_oui(
				pCtx,
				(tDot11fFfvendor_oui *)(pSrc + pFf->offset),
				pBufRemaining);
			break;
		default:
			FRAMES_LOG1(
	...
	while (0xff != pIe->eid || pIe->extn_eid) {
		...
		countOffset = ((0 == pIe->arraybound) ?
				       1 :
				       *(uint16_t *)(pSrc + pIe->countOffset));
		for (i = 0; i < countOffset; ++i) {
			len = 0U;
			switch (pIe->sig) {
			case SigIeGTK:
				status |= dot11f_pack_ie_gtk(
					pCtx,
					(tDot11fIEGTK *)(pSrc + pIe->offset +
							 sizeof(tDot11fIEGTK) *
								 i),
			...
			case SigIeIGTK:
				status |= dot11f_pack_ie_igtk(
					pCtx,
					(tDot11fIEIGTK *)(pSrc + pIe->offset +
							  sizeof(tDot11fIEIGTK) *
								  i),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigIeR0KH_ID:
				status |= dot11f_pack_ie_r0_kh_id(
					pCtx,
					(tDot11fIER0KH_ID
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIER0KH_ID) *
				...
				break;
			case SigIeR1KH_ID:
				status |= dot11f_pack_ie_r1_kh_id(
					pCtx,
					(tDot11fIER1KH_ID
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIER1KH_ID) *
				...
				break;
			case SigIeAPChannelReport:
				status |= dot11f_pack_ie_ap_channel_report(
					pCtx,
					(tDot11fIEAPChannelReport
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEAPChannelReport) *
				...
				break;
			case SigIeBcnReportingDetail:
				status |= dot11f_pack_ie_bcn_reporting_detail(
					pCtx,
					(tDot11fIEBcnReportingDetail
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEBcnReportingDetail) *
				...
				break;
			case SigIeBeaconReportFrmBody:
				status |= dot11f_pack_ie_beacon_report_frm_body(
					pCtx,
					(tDot11fIEBeaconReportFrmBody
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEBeaconReportFrmBody) *
				...
				break;
			case SigIeBeaconReporting:
				status |= dot11f_pack_ie_beacon_reporting(
					pCtx,
					(tDot11fIEBeaconReporting
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEBeaconReporting) *
				...
				break;
			case SigIeCondensedCountryStr:
				status |= dot11f_pack_ie_condensed_country_str(
					pCtx,
					(tDot11fIECondensedCountryStr
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIECondensedCountryStr) *
				...
				break;
			case SigIeMeasurementPilot:
				status |= dot11f_pack_ie_measurement_pilot(
					pCtx,
					(tDot11fIEMeasurementPilot
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEMeasurementPilot) *
				...
				break;
			case SigIeMultiBssid:
				status |= dot11f_pack_ie_multi_bssid(
					pCtx,
					(tDot11fIEMultiBssid
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEMultiBssid) *
				...
				break;
			case SigIeRICData:
				status |= dot11f_pack_ie_ric_data(
					pCtx,
					(tDot11fIERICData
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIERICData) *
				...
				break;
			case SigIeRICDescriptor:
				status |= dot11f_pack_ie_ric_descriptor(
					pCtx,
					(tDot11fIERICDescriptor
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIERICDescriptor) *
			...
			case SigIeRRMEnabledCap:
				...
				break;
			case SigIeRequestedInfo:
				status |= dot11f_pack_ie_requested_info(
					pCtx,
					(tDot11fIERequestedInfo
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIERequestedInfo) *
				...
				break;
			case SigIeSSID:
				status |= dot11f_pack_ie_ssid(
					pCtx,
					(tDot11fIESSID *)(pSrc + pIe->offset +
							  sizeof(tDot11fIESSID) *
								  i),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigIeSchedule:
				status |= dot11f_pack_ie_schedule(
					pCtx,
					(tDot11fIESchedule
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIESchedule) *
			...
			case SigIeTCLAS:
				...
				break;
			case SigIeTCLASSPROC:
				status |= dot11f_pack_ie_tclassproc(
					pCtx,
					(tDot11fIETCLASSPROC
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIETCLASSPROC) *
				...
				break;
			case SigIeTSDelay:
				status |= dot11f_pack_ie_ts_delay(
					pCtx,
					(tDot11fIETSDelay
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIETSDelay) *
				...
				break;
			case SigIeTSFInfo:
				status |= dot11f_pack_ie_tsf_info(
					pCtx,
					(tDot11fIETSFInfo
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIETSFInfo) *
			...
			case SigIeTSPEC:
				...
				break;
			case SigIeVHTCaps:
				status |= dot11f_pack_ie_vht_caps(
					pCtx,
					(tDot11fIEVHTCaps
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEVHTCaps) *
				...
				break;
			case SigIeVHTOperation:
				status |= dot11f_pack_ie_vht_operation(
					pCtx,
					(tDot11fIEVHTOperation
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEVHTOperation) *
				...
				break;
			case SigIeWMMSchedule:
				status |= dot11f_pack_ie_wmm_schedule(
					pCtx,
					(tDot11fIEWMMSchedule
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWMMSchedule) *
				...
				break;
			case SigIeWMMTCLAS:
				status |= dot11f_pack_ie_wmmtclas(
					pCtx,
					(tDot11fIEWMMTCLAS
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWMMTCLAS) *
				...
				break;
			case SigIeWMMTCLASPROC:
				status |= dot11f_pack_ie_wmmtclasproc(
					pCtx,
					(tDot11fIEWMMTCLASPROC
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWMMTCLASPROC) *
				...
				break;
			case SigIeWMMTSDelay:
				status |= dot11f_pack_ie_wmmts_delay(
					pCtx,
					(tDot11fIEWMMTSDelay
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWMMTSDelay) *
				...
				break;
			case SigIeWMMTSPEC:
				status |= dot11f_pack_ie_wmmtspec(
					pCtx,
					(tDot11fIEWMMTSPEC
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWMMTSPEC) *
				...
				break;
			case SigIeWiderBWChanSwitchAnn:
				status |= dot11f_pack_ie_wider_bw_chan_switch_ann(
					pCtx,
					(tDot11fIEWiderBWChanSwitchAnn
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWiderBWChanSwitchAnn) *
				...
				break;
			case SigIeazimuth_req:
				status |= dot11f_pack_ie_azimuth_req(
					pCtx,
					(tDot11fIEazimuth_req
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEazimuth_req) *
				...
				break;
			case SigIebeacon_report_frm_body_fragment_id:
				status |= dot11f_pack_ie_beacon_report_frm_body_fragment_id(
					pCtx,
					(tDot11fIEbeacon_report_frm_body_fragment_id
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEbeacon_report_frm_body_fragment_id) *
				...
				break;
			case SigIelast_beacon_report_indication:
				status |= dot11f_pack_ie_last_beacon_report_indication(
					pCtx,
					(tDot11fIElast_beacon_report_indication
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIElast_beacon_report_indication) *
			...
			case SigIemax_age:
				...
				break;
			case SigIemscs_status:
				status |= dot11f_pack_ie_mscs_status(
					pCtx,
					(tDot11fIEmscs_status
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEmscs_status) *
				...
				break;
			case SigIeneighbor_rpt:
				status |= dot11f_pack_ie_neighbor_rpt(
					pCtx,
					(tDot11fIEneighbor_rpt
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEneighbor_rpt) *
			...
			case SigIereq_mac_addr:
				...
				break;
			case SigIetclas_mask:
				status |= dot11f_pack_ie_tclas_mask(
					pCtx,
					(tDot11fIEtclas_mask
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEtclas_mask) *
				...
				break;
			case SigIetgt_mac_addr:
				status |= dot11f_pack_ie_tgt_mac_addr(
					pCtx,
					(tDot11fIEtgt_mac_addr
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEtgt_mac_addr) *
				...
				break;
			case SigIetransmit_power_env:
				status |= dot11f_pack_ie_transmit_power_env(
					pCtx,
					(tDot11fIEtransmit_power_env
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEtransmit_power_env) *
				...
				break;
			case SigIeAID:
				status |= dot11f_pack_ie_aid(
					pCtx,
					(tDot11fIEAID *)(pSrc + pIe->offset +
							 sizeof(tDot11fIEAID) *
								 i),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigIeCFParams:
				status |= dot11f_pack_ie_cf_params(
					pCtx,
					(tDot11fIECFParams
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIECFParams) *
			...
			case SigIeChallengeText:
				...
				break;
			case SigIeChanSwitchAnn:
				status |= dot11f_pack_ie_chan_switch_ann(
					pCtx,
					(tDot11fIEChanSwitchAnn
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEChanSwitchAnn) *
				...
				break;
			case SigIeChannelSwitchWrapper:
				status |= dot11f_pack_ie_channel_switch_wrapper(
					pCtx,
					(tDot11fIEChannelSwitchWrapper
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEChannelSwitchWrapper) *
			...
			case SigIeCountry:
				...
				break;
			case SigIeDSParams:
				status |= dot11f_pack_ie_ds_params(
					pCtx,
					(tDot11fIEDSParams
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEDSParams) *
				...
				break;
			case SigIeEDCAParamSet:
				status |= dot11f_pack_ie_edca_param_set(
					pCtx,
					(tDot11fIEEDCAParamSet
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEEDCAParamSet) *
				...
				break;
			case SigIeERPInfo:
				status |= dot11f_pack_ie_erp_info(
					pCtx,
					(tDot11fIEERPInfo
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEERPInfo) *
				...
				break;
			case SigIeESECckmOpaque:
				status |= dot11f_pack_ie_ese_cckm_opaque(
					pCtx,
					(tDot11fIEESECckmOpaque
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEESECckmOpaque) *
				...
				break;
			case SigIeESERadMgmtCap:
				status |= dot11f_pack_ie_ese_rad_mgmt_cap(
					pCtx,
					(tDot11fIEESERadMgmtCap
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEESERadMgmtCap) *
				...
				break;
			case SigIeESETrafStrmMet:
				status |= dot11f_pack_ie_ese_traf_strm_met(
					pCtx,
					(tDot11fIEESETrafStrmMet
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEESETrafStrmMet) *
				...
				break;
			case SigIeESETrafStrmRateSet:
				status |= dot11f_pack_ie_ese_traf_strm_rate_set(
					pCtx,
					(tDot11fIEESETrafStrmRateSet
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEESETrafStrmRateSet) *
				...
				break;
			case SigIeESETxmitPower:
				status |= dot11f_pack_ie_ese_txmit_power(
					pCtx,
					(tDot11fIEESETxmitPower
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEESETxmitPower) *
				...
				break;
			case SigIeESEVersion:
				status |= dot11f_pack_ie_ese_version(
					pCtx,
					(tDot11fIEESEVersion
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEESEVersion) *
			...
			case SigIeExtCap:
				...
				break;
			case SigIeExtSuppRates:
				status |= dot11f_pack_ie_ext_supp_rates(
					pCtx,
					(tDot11fIEExtSuppRates
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEExtSuppRates) *
				...
				break;
			case SigIeFHParamSet:
				status |= dot11f_pack_ie_fh_param_set(
					pCtx,
					(tDot11fIEFHParamSet
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEFHParamSet) *
				...
				break;
			case SigIeFHParams:
				status |= dot11f_pack_ie_fh_params(
					pCtx,
					(tDot11fIEFHParams
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEFHParams) *
				...
				break;
			case SigIeFHPattTable:
				status |= dot11f_pack_ie_fh_patt_table(
					pCtx,
					(tDot11fIEFHPattTable
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEFHPattTable) *
			...
			case SigIeHTInfo:
				...
				break;
			case SigIeLinkIdentifier:
				status |= dot11f_pack_ie_link_identifier(
					pCtx,
					(tDot11fIELinkIdentifier
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIELinkIdentifier) *
			...
			case SigIeMBO_IE:
				...
				break;
			case SigIeMeasurementReport:
				status |= dot11f_pack_ie_measurement_report(
					pCtx,
					(tDot11fIEMeasurementReport
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEMeasurementReport) *
				...
				break;
			case SigIeMeasurementRequest:
				status |= dot11f_pack_ie_measurement_request(
					pCtx,
					(tDot11fIEMeasurementRequest
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEMeasurementRequest) *
				...
				break;
			case SigIeMobilityDomain:
				status |= dot11f_pack_ie_mobility_domain(
					pCtx,
					(tDot11fIEMobilityDomain
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEMobilityDomain) *
				...
				break;
			case SigIeNeighborReport:
				status |= dot11f_pack_ie_neighbor_report(
					pCtx,
					(tDot11fIENeighborReport
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIENeighborReport) *
				...
				break;
			case SigIeOBSSScanParameters:
				status |= dot11f_pack_ie_obss_scan_parameters(
					pCtx,
					(tDot11fIEOBSSScanParameters
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEOBSSScanParameters) *
				...
				break;
			case SigIeOperatingMode:
				status |= dot11f_pack_ie_operating_mode(
					pCtx,
					(tDot11fIEOperatingMode
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEOperatingMode) *
				...
				break;
			case SigIeP2PAssocReq:
				status |= dot11f_pack_ie_p2_p_assoc_req(
					pCtx,
					(tDot11fIEP2PAssocReq
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEP2PAssocReq) *
				...
				break;
			case SigIeP2PAssocRes:
				status |= dot11f_pack_ie_p2_p_assoc_res(
					pCtx,
					(tDot11fIEP2PAssocRes
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEP2PAssocRes) *
				...
				break;
			case SigIeP2PBeacon:
				status |= dot11f_pack_ie_p2_p_beacon(
					pCtx,
					(tDot11fIEP2PBeacon
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEP2PBeacon) *
				...
				break;
			case SigIeP2PBeaconProbeRes:
				status |= dot11f_pack_ie_p2_p_beacon_probe_res(
					pCtx,
					(tDot11fIEP2PBeaconProbeRes
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEP2PBeaconProbeRes) *
				...
				break;
			case SigIeP2PDeAuth:
				status |= dot11f_pack_ie_p2_p_de_auth(
					pCtx,
					(tDot11fIEP2PDeAuth
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEP2PDeAuth) *
				...
				break;
			case SigIeP2PDisAssoc:
				status |= dot11f_pack_ie_p2_p_dis_assoc(
					pCtx,
					(tDot11fIEP2PDisAssoc
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEP2PDisAssoc) *
				...
				break;
			case SigIeP2PIEOpaque:
				status |= dot11f_pack_ie_p2_pie_opaque(
					pCtx,
					(tDot11fIEP2PIEOpaque
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEP2PIEOpaque) *
				...
				break;
			case SigIeP2PProbeReq:
				status |= dot11f_pack_ie_p2_p_probe_req(
					pCtx,
					(tDot11fIEP2PProbeReq
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEP2PProbeReq) *
				...
				break;
			case SigIeP2PProbeRes:
				status |= dot11f_pack_ie_p2_p_probe_res(
					pCtx,
					(tDot11fIEP2PProbeRes
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEP2PProbeRes) *
				...
				break;
			case SigIePTIControl:
				status |= dot11f_pack_ie_pti_control(
					pCtx,
					(tDot11fIEPTIControl
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEPTIControl) *
			...
			case SigIePUBufferStatus:
				...
				break;
			case SigIePowerCaps:
				status |= dot11f_pack_ie_power_caps(
					pCtx,
					(tDot11fIEPowerCaps
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEPowerCaps) *
				...
				break;
			case SigIePowerConstraints:
				status |= dot11f_pack_ie_power_constraints(
					pCtx,
					(tDot11fIEPowerConstraints
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEPowerConstraints) *
				...
				break;
			case SigIeQBSSLoad:
				status |= dot11f_pack_ie_qbss_load(
					pCtx,
					(tDot11fIEQBSSLoad
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEQBSSLoad) *
				...
				break;
			case SigIeQComVendorIE:
				status |= dot11f_pack_ie_QComVendorIE(
					pCtx,
					(tDot11fIEQComVendorIE
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEQComVendorIE) *
				...
				break;
			case SigIeQOSCapsAp:
				status |= dot11f_pack_ie_qos_caps_ap(
					pCtx,
					(tDot11fIEQOSCapsAp
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEQOSCapsAp) *
				...
				break;
			case SigIeQOSCapsStation:
				status |= dot11f_pack_ie_qos_caps_station(
					pCtx,
					(tDot11fIEQOSCapsStation
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEQOSCapsStation) *
				...
				break;
			case SigIeQosMapSet:
				status |= dot11f_pack_ie_qos_map_set(
					pCtx,
					(tDot11fIEQosMapSet
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEQosMapSet) *
			...
			case SigIeRCPIIE:
				...
				break;
			case SigIeRICDataDesc:
				status |= dot11f_pack_ie_ric_data_desc(
					pCtx,
					(tDot11fIERICDataDesc
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIERICDataDesc) *
				...
				break;
			case SigIeRSN:
				status |= dot11f_pack_ie_rsn(
					pCtx,
					(tDot11fIERSN *)(pSrc + pIe->offset +
							 sizeof(tDot11fIERSN) *
								 i),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigIeRSNIIE:
				status |= dot11f_pack_ie_rsniie(
					pCtx,
					(tDot11fIERSNIIE
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIERSNIIE) *
				...
				break;
			case SigIeRSNOpaque:
				status |= dot11f_pack_ie_rsn_opaque(
					pCtx,
					(tDot11fIERSNOpaque
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIERSNOpaque) *
				...
				break;
			case SigIeSuppChannels:
				status |= dot11f_pack_ie_supp_channels(
					pCtx,
					(tDot11fIESuppChannels
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIESuppChannels) *
				...
				break;
			case SigIeSuppOperatingClasses:
				status |= dot11f_pack_ie_supp_operating_classes(
					pCtx,
					(tDot11fIESuppOperatingClasses
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIESuppOperatingClasses) *
				...
				break;
			case SigIeSuppRates:
				status |= dot11f_pack_ie_supp_rates(
					pCtx,
					(tDot11fIESuppRates
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIESuppRates) *
				...
				break;
			case SigIeTIM:
				status |= dot11f_pack_ie_tim(
					pCtx,
					(tDot11fIETIM *)(pSrc + pIe->offset +
							 sizeof(tDot11fIETIM) *
								 i),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigIeTPCReport:
				status |= dot11f_pack_ie_tpc_report(
					pCtx,
					(tDot11fIETPCReport
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIETPCReport) *
				...
				break;
			case SigIeTPCRequest:
				status |= dot11f_pack_ie_tpc_request(
					pCtx,
					(tDot11fIETPCRequest
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIETPCRequest) *
				...
				break;
			case SigIeTimeAdvertisement:
				status |= dot11f_pack_ie_time_advertisement(
					pCtx,
					(tDot11fIETimeAdvertisement
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIETimeAdvertisement) *
				...
				break;
			case SigIeTimeoutInterval:
				status |= dot11f_pack_ie_timeout_interval(
					pCtx,
					(tDot11fIETimeoutInterval
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIETimeoutInterval) *
				...
				break;
			case SigIeVHTExtBssLoad:
				status |= dot11f_pack_ie_vht_ext_bss_load(
					pCtx,
					(tDot11fIEVHTExtBssLoad
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEVHTExtBssLoad) *
				...
				break;
			case SigIeVendor1IE:
				status |= dot11f_pack_ie_vendor1_ie(
					pCtx,
					(tDot11fIEVendor1IE
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEVendor1IE) *
				...
				break;
			case SigIeVendor3IE:
				status |= dot11f_pack_ie_vendor3_ie(
					pCtx,
					(tDot11fIEVendor3IE
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEVendor3IE) *
				...
				break;
			case SigIeWAPI:
				status |= dot11f_pack_ie_wapi(
					pCtx,
					(tDot11fIEWAPI *)(pSrc + pIe->offset +
							  sizeof(tDot11fIEWAPI) *
								  i),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigIeWAPIOpaque:
				status |= dot11f_pack_ie_wapi_opaque(
					pCtx,
					(tDot11fIEWAPIOpaque
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWAPIOpaque) *
			...
			case SigIeWFATPC:
				...
				break;
			case SigIeWFDIEOpaque:
				status |= dot11f_pack_ie_wfdie_opaque(
					pCtx,
					(tDot11fIEWFDIEOpaque
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWFDIEOpaque) *
				...
				break;
			case SigIeWMMCaps:
				status |= dot11f_pack_ie_wmm_caps(
					pCtx,
					(tDot11fIEWMMCaps
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWMMCaps) *
				...
				break;
			case SigIeWMMInfoAp:
				status |= dot11f_pack_ie_wmm_info_ap(
					pCtx,
					(tDot11fIEWMMInfoAp
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWMMInfoAp) *
				...
				break;
			case SigIeWMMInfoStation:
				status |= dot11f_pack_ie_wmm_info_station(
					pCtx,
					(tDot11fIEWMMInfoStation
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWMMInfoStation) *
				...
				break;
			case SigIeWMMParams:
				status |= dot11f_pack_ie_wmm_params(
					pCtx,
					(tDot11fIEWMMParams
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWMMParams) *
				...
				break;
			case SigIeWPA:
				status |= dot11f_pack_ie_wpa(
					pCtx,
					(tDot11fIEWPA *)(pSrc + pIe->offset +
							 sizeof(tDot11fIEWPA) *
								 i),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigIeWPAOpaque:
				status |= dot11f_pack_ie_wpa_opaque(
					pCtx,
					(tDot11fIEWPAOpaque
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWPAOpaque) *
				...
				break;
			case SigIeWSC:
				status |= dot11f_pack_ie_wsc(
					pCtx,
					(tDot11fIEWSC *)(pSrc + pIe->offset +
							 sizeof(tDot11fIEWSC) *
								 i),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigIeWscAssocReq:
				status |= dot11f_pack_ie_wsc_assoc_req(
					pCtx,
					(tDot11fIEWscAssocReq
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWscAssocReq) *
				...
				break;
			case SigIeWscAssocRes:
				status |= dot11f_pack_ie_wsc_assoc_res(
					pCtx,
					(tDot11fIEWscAssocRes
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWscAssocRes) *
				...
				break;
			case SigIeWscBeacon:
				status |= dot11f_pack_ie_wsc_beacon(
					pCtx,
					(tDot11fIEWscBeacon
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWscBeacon) *
				...
				break;
			case SigIeWscBeaconProbeRes:
				status |= dot11f_pack_ie_wsc_beacon_probe_res(
					pCtx,
					(tDot11fIEWscBeaconProbeRes
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWscBeaconProbeRes) *
				...
				break;
			case SigIeWscIEOpaque:
				status |= dot11f_pack_ie_wsc_ie_opaque(
					pCtx,
					(tDot11fIEWscIEOpaque
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWscIEOpaque) *
				...
				break;
			case SigIeWscProbeReq:
				status |= dot11f_pack_ie_wsc_probe_req(
					pCtx,
					(tDot11fIEWscProbeReq
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWscProbeReq) *
				...
				break;
			case SigIeWscProbeRes:
				status |= dot11f_pack_ie_wsc_probe_res(
					pCtx,
					(tDot11fIEWscProbeRes
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWscProbeRes) *
				...
				break;
			case SigIeWscReassocRes:
				status |= dot11f_pack_ie_wsc_reassoc_res(
					pCtx,
					(tDot11fIEWscReassocRes
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEWscReassocRes) *
				...
				break;
			case SigIeaddba_extn_element:
				status |= dot11f_pack_ie_addba_extn_element(
					pCtx,
					(tDot11fIEaddba_extn_element
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEaddba_extn_element) *
				...
				break;
			case SigIebss_color_change:
				status |= dot11f_pack_ie_bss_color_change(
					pCtx,
					(tDot11fIEbss_color_change
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEbss_color_change) *
				...
				break;
			case SigIebss_max_idle_period:
				status |= dot11f_pack_ie_bss_max_idle_period(
					pCtx,
					(tDot11fIEbss_max_idle_period
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEbss_max_idle_period) *
				...
				break;
			case SigIedescriptor_element:
				status |= dot11f_pack_ie_descriptor_element(
					pCtx,
					(tDot11fIEdescriptor_element
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEdescriptor_element) *
				...
				break;
			case SigIedh_parameter_element:
				status |= dot11f_pack_ie_dh_parameter_element(
					pCtx,
					(tDot11fIEdh_parameter_element
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEdh_parameter_element) *
			...
			case SigIeeht_op:
				...
				break;
			case SigIeesp_information:
				status |= dot11f_pack_ie_esp_information(
					pCtx,
					(tDot11fIEesp_information
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEesp_information) *
				...
				break;
			case SigIeext_chan_switch_ann:
				status |= dot11f_pack_ie_ext_chan_switch_ann(
					pCtx,
					(tDot11fIEext_chan_switch_ann
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEext_chan_switch_ann) *
			...
			case SigIefils_assoc_delay_info:
				...
				break;
			case SigIefils_hlp_container:
				status |= dot11f_pack_ie_fils_hlp_container(
					pCtx,
					(tDot11fIEfils_hlp_container
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEfils_hlp_container) *
				...
				break;
			case SigIefils_indication:
				status |= dot11f_pack_ie_fils_indication(
					pCtx,
					(tDot11fIEfils_indication
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEfils_indication) *
				...
				break;
			case SigIefils_kde:
				status |= dot11f_pack_ie_fils_kde(
					pCtx,
					(tDot11fIEfils_kde
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEfils_kde) *
				...
				break;
			case SigIefils_key_confirmation:
				status |= dot11f_pack_ie_fils_key_confirmation(
					pCtx,
					(tDot11fIEfils_key_confirmation
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEfils_key_confirmation) *
				...
				break;
			case SigIefils_nonce:
				status |= dot11f_pack_ie_fils_nonce(
					pCtx,
					(tDot11fIEfils_nonce
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEfils_nonce) *
				...
				break;
			case SigIefils_public_key:
				status |= dot11f_pack_ie_fils_public_key(
					pCtx,
					(tDot11fIEfils_public_key
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEfils_public_key) *
				...
				break;
			case SigIefils_session:
				status |= dot11f_pack_ie_fils_session(
					pCtx,
					(tDot11fIEfils_session
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEfils_session) *
				...
				break;
			case SigIefils_wrapped_data:
				status |= dot11f_pack_ie_fils_wrapped_data(
					pCtx,
					(tDot11fIEfils_wrapped_data
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEfils_wrapped_data) *
				...
				break;
			case SigIefragment_ie:
				status |= dot11f_pack_ie_fragment_ie(
					pCtx,
					(tDot11fIEfragment_ie
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEfragment_ie) *
				...
				break;
			case SigIehe_6ghz_band_cap:
				status |= dot11f_pack_ie_he_6ghz_band_cap(
					pCtx,
					(tDot11fIEhe_6ghz_band_cap
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEhe_6ghz_band_cap) *
			...
			case SigIehe_op:
				...
				break;
			case SigIehs20vendor_ie:
				status |= dot11f_pack_ie_hs20vendor_ie(
					pCtx,
					(tDot11fIEhs20vendor_ie
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEhs20vendor_ie) *
				...
				break;
			case SigIeht2040_bss_coexistence:
				status |= dot11f_pack_ie_ht2040_bss_coexistence(
					pCtx,
					(tDot11fIEht2040_bss_coexistence
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEht2040_bss_coexistence) *
				...
				break;
			case SigIeht2040_bss_intolerant_report:
				status |= dot11f_pack_ie_ht2040_bss_intolerant_report(
					pCtx,
					(tDot11fIEht2040_bss_intolerant_report
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEht2040_bss_intolerant_report) *
				...
				break;
			case SigIemax_chan_switch_time:
				status |= dot11f_pack_ie_max_chan_switch_time(
					pCtx,
					(tDot11fIEmax_chan_switch_time
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEmax_chan_switch_time) *
			...
			case SigIemlo_ie:
				...
				break;
			case SigIemu_edca_param_set:
				status |= dot11f_pack_ie_mu_edca_param_set(
					pCtx,
					(tDot11fIEmu_edca_param_set
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEmu_edca_param_set) *
				...
				break;
			case SigIenon_inheritance:
				status |= dot11f_pack_ie_non_inheritance(
					pCtx,
					(tDot11fIEnon_inheritance
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEnon_inheritance) *
				...
				break;
			case SigIeoci:
				status |= dot11f_pack_ie_oci(
					pCtx,
					(tDot11fIEoci *)(pSrc + pIe->offset +
							 sizeof(tDot11fIEoci) *
								 i),
					pBufRemaining, nBufRemaining, &len);
				break;
			...
			case SigIeqcn_ie:
				...
				break;
			case SigIereduced_neighbor_report:
				status |= dot11f_pack_ie_reduced_neighbor_report(
					pCtx,
					(tDot11fIEreduced_neighbor_report
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEreduced_neighbor_report) *
				...
				break;
			case SigIeroaming_consortium_sel:
				status |= dot11f_pack_ie_roaming_consortium_sel(
					pCtx,
					(tDot11fIEroaming_consortium_sel
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEroaming_consortium_sel) *
				...
				break;
			case SigIesec_chan_offset_ele:
				status |= dot11f_pack_ie_sec_chan_offset_ele(
					pCtx,
					(tDot11fIEsec_chan_offset_ele
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEsec_chan_offset_ele) *
				...
				break;
			case SigIespatial_reuse:
				status |= dot11f_pack_ie_spatial_reuse(
					pCtx,
					(tDot11fIEspatial_reuse
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEspatial_reuse) *
			...
			case SigIet2lm_ie:
				...
				break;
			case SigIevendor_vht_ie:
				status |= dot11f_pack_ie_vendor_vht_ie(
					pCtx,
					(tDot11fIEvendor_vht_ie
						 *)(pSrc + pIe->offset +
						    sizeof(tDot11fIEvendor_vht_ie) *
			      ...
			      const tTLVDefn TLVs[], uint32_t *pidx)
{
	...
	while (0xffff != pTlv->id) {
		...
		if (*pfFound) {
			switch (pTlv->sig) {
			case SigTlvAuthorizedMACs:
				status |= dot11f_pack_tlv_authorized_ma_cs(
					pCtx,
					(tDot11fTLVAuthorizedMACs
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvRequestToEnroll:
				status |= dot11f_pack_tlv_request_to_enroll(
					pCtx,
					(tDot11fTLVRequestToEnroll
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvVersion2:
				status |= dot11f_pack_tlv_version2(
					pCtx,
				...
				break;
			case SigTlvAPSetupLocked:
				status |= dot11f_pack_tlv_ap_setup_locked(
					pCtx,
					(tDot11fTLVAPSetupLocked
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
			...
			case SigTlvAssociationState:
				...
				break;
			case SigTlvConfigMethods:
				status |= dot11f_pack_tlv_config_methods(
					pCtx,
					(tDot11fTLVConfigMethods
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
			...
			case SigTlvConfigurationError:
				...
				break;
			case SigTlvDeviceName:
				status |= dot11f_pack_tlv_device_name(
					pCtx,
				...
				break;
			case SigTlvDevicePasswordID:
				status |= dot11f_pack_tlv_device_password_id(
					pCtx,
					(tDot11fTLVDevicePasswordID
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvExtendedListenTiming:
				status |= dot11f_pack_tlv_extended_listen_timing(
					pCtx,
					(tDot11fTLVExtendedListenTiming
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvListenChannel:
				status |= dot11f_pack_tlv_listen_channel(
					pCtx,
					(tDot11fTLVListenChannel
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvManufacturer:
				status |= dot11f_pack_tlv_manufacturer(
					pCtx,
					(tDot11fTLVManufacturer *)(pSrc +
								   pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvMinorReasonCode:
				status |= dot11f_pack_tlv_minor_reason_code(
					pCtx,
					(tDot11fTLVMinorReasonCode
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvModelName:
				status |= dot11f_pack_tlv_model_name(
					pCtx,
				...
				break;
			case SigTlvModelNumber:
				status |= dot11f_pack_tlv_model_number(
					pCtx,
					(tDot11fTLVModelNumber *)(pSrc +
								  pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvNoticeOfAbsence:
				status |= dot11f_pack_tlv_notice_of_absence(
					pCtx,
					(tDot11fTLVNoticeOfAbsence
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvOperatingChannel:
				status |= dot11f_pack_tlv_operating_channel(
					pCtx,
					(tDot11fTLVOperatingChannel
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvP2PCapability:
				status |= dot11f_pack_tlv_p2_p_capability(
					pCtx,
					(tDot11fTLVP2PCapability
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvP2PDeviceId:
				status |= dot11f_pack_tlv_p2_p_device_id(
					pCtx,
					(tDot11fTLVP2PDeviceId *)(pSrc +
								  pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvP2PDeviceInfo:
				status |= dot11f_pack_tlv_p2_p_device_info(
					pCtx,
					(tDot11fTLVP2PDeviceInfo
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvP2PGroupInfo:
				status |= dot11f_pack_tlv_p2_p_group_info(
					pCtx,
					(tDot11fTLVP2PGroupInfo *)(pSrc +
								   pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvP2PStatus:
				status |= dot11f_pack_tlv_p2_p_status(
					pCtx,
				...
				break;
			case SigTlvPrimaryDeviceType:
				status |= dot11f_pack_tlv_primary_device_type(
					pCtx,
					(tDot11fTLVPrimaryDeviceType
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvRFBands:
				status |= dot11f_pack_tlv_rf_bands(
					pCtx,
				...
				break;
			case SigTlvRequestDeviceType:
				status |= dot11f_pack_tlv_request_device_type(
					pCtx,
					(tDot11fTLVRequestDeviceType
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvRequestType:
				status |= dot11f_pack_tlv_request_type(
					pCtx,
					(tDot11fTLVRequestType *)(pSrc +
								  pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvResponseType:
				status |= dot11f_pack_tlv_response_type(
					pCtx,
					(tDot11fTLVResponseType *)(pSrc +
								   pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvSelectedRegistrar:
				status |= dot11f_pack_tlv_selected_registrar(
					pCtx,
					(tDot11fTLVSelectedRegistrar
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvSelectedRegistrarConfigMethods:
				status |= dot11f_pack_tlv_selected_registrar_config_methods(
					pCtx,
					(tDot11fTLVSelectedRegistrarConfigMethods
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvSerialNumber:
				status |= dot11f_pack_tlv_serial_number(
					pCtx,
					(tDot11fTLVSerialNumber *)(pSrc +
								   pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
			...
			case SigTlvUUID_R:
				...
				break;
			case SigTlvVendorExtension:
				status |= dot11f_pack_tlv_vendor_extension(
					pCtx,
					(tDot11fTLVVendorExtension
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvVersion:
				status |= dot11f_pack_tlv_version(
					pCtx,
			...
			case SigTlvWPSState:
				...
				break;
			case SigTlvassoc_disallowed:
				status |= dot11f_pack_tlv_assoc_disallowed(
					pCtx,
					(tDot11fTLVassoc_disallowed
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvassoc_retry_delay:
				status |= dot11f_pack_tlv_assoc_retry_delay(
					pCtx,
					(tDot11fTLVassoc_retry_delay
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvcellular_data_cap:
				status |= dot11f_pack_tlv_cellular_data_cap(
					pCtx,
					(tDot11fTLVcellular_data_cap
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
			...
			case SigTlvcellular_data_con_pref:
				...
				break;
			case SigTlvecsa_target_tsf_info_attr:
				status |= dot11f_pack_tlv_ecsa_target_tsf_info_attr(
					pCtx,
					(tDot11fTLVecsa_target_tsf_info_attr
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvedca_pifs_param_attr:
				status |= dot11f_pack_tlv_edca_pifs_param_attr(
					pCtx,
					(tDot11fTLVedca_pifs_param_attr
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvhe_2xltf_160mhz_supp:
				status |= dot11f_pack_tlv_he_2xltf_160mhz_supp(
					pCtx,
					(tDot11fTLVhe_2xltf_160mhz_supp
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvhe_400ns_sgi_attr:
				status |= dot11f_pack_tlv_he_400ns_sgi_attr(
					pCtx,
					(tDot11fTLVhe_400ns_sgi_attr
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvhe_dl_mumimo_attr:
				status |= dot11f_pack_tlv_he_dl_mumimo_attr(
					pCtx,
					(tDot11fTLVhe_dl_mumimo_attr
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvhe_dl_ofdma_attr:
				status |= dot11f_pack_tlv_he_dl_ofdma_attr(
					pCtx,
					(tDot11fTLVhe_dl_ofdma_attr
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvhe_mcs13_attr:
				status |= dot11f_pack_tlv_he_mcs13_attr(
					pCtx,
					(tDot11fTLVhe_mcs13_attr
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvmbo_ap_cap:
				status |= dot11f_pack_tlv_mbo_ap_cap(
					pCtx,
				...
				break;
			case SigTlvnon_prefferd_chan_rep:
				status |= dot11f_pack_tlv_non_prefferd_chan_rep(
					pCtx,
					(tDot11fTLVnon_prefferd_chan_rep
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvoce_cap:
				status |= dot11f_pack_tlv_oce_cap(
					pCtx,
				...
				break;
			case SigTlvqcn_version:
				status |= dot11f_pack_tlv_qcn_version(
					pCtx,
				...
				break;
			case SigTlvreduced_wan_metrics:
				status |= dot11f_pack_tlv_reduced_wan_metrics(
					pCtx,
					(tDot11fTLVreduced_wan_metrics
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvrssi_assoc_rej:
				status |= dot11f_pack_tlv_rssi_assoc_rej(
					pCtx,
					(tDot11fTLVrssi_assoc_rej
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
			...
			case SigTlvtrans_reasonp_attr:
				...
				break;
			case SigTlvtrans_rejectp_attr:
				status |= dot11f_pack_tlv_trans_rejectp_attr(
					pCtx,
					(tDot11fTLVtrans_rejectp_attr
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvtransition_reason:
				status |= dot11f_pack_tlv_transition_reason(
					pCtx,
					(tDot11fTLVtransition_reason
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvtransition_reject_reason:
				status |= dot11f_pack_tlv_transition_reject_reason(
					pCtx,
					(tDot11fTLVtransition_reject_reason
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvvht_mcs11_attr:
				status |= dot11f_pack_tlv_vht_mcs11_attr(
					pCtx,
					(tDot11fTLVvht_mcs11_attr
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvP2PInterface:
				status |= dot11f_pack_tlv_p2_p_interface(
					pCtx,
					(tDot11fTLVP2PInterface *)(pSrc +
								   pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
				break;
			case SigTlvP2PManageability:
				status |= dot11f_pack_tlv_p2_p_manageability(
					pCtx,
					(tDot11fTLVP2PManageability
						 *)(pSrc + pTlv->offset),
					pBufRemaining, nBufRemaining, &len);
