 ...
 */
static ssize_t __hdd_wlan_txrx_stats_store(struct hdd_context *hdd_ctx,
					   const char *buf, size_t count)
{
	...
	soc->ops->cmn_drv_ops->txrx_sysfs_set_stat_type(
		soc, stat_type_requested, mac_id);
 ...
 */
static ssize_t __hdd_wlan_txrx_stats_show(char *buf)
{
	...
	soc->ops->cmn_drv_ops->txrx_sysfs_fill_stats(soc, buf,
 ...
 */
static ssize_t hdd_sysfs_dp_txrx_stats_show(struct kobject *kobj,
 ...
 */
static ssize_t hdd_sysfs_dp_txrx_stats_store(struct kobject *kobj,
					     struct kobj_attribute *attr,
					     const char *buf, size_t count)
{
	struct hdd_context *hdd_ctx = cds_get_context(QDF_MODULE_ID_HDD);
 ...
 * Return: void
 */
void hdd_sysfs_dp_txrx_stats_sysfs_destroy(struct kobject *driver_kobject)
{
	if (!driver_kobject) {
