...
static ssize_t __hdd_sysfs_txrx_fw_st_rst_store(struct net_device *net_dev,
						char const *buf, size_t count)
{
	...
	ret = hdd_sysfs_set_vdev(adapter, WMA_VDEV_TXRX_FWSTATS_RESET_CMDID,
				 value);
...
static ssize_t hdd_sysfs_txrx_fw_st_rst_store(struct device *dev,
...
static DEVICE_ATTR(txrx_fw_st_rst, 0220, NULL, hdd_sysfs_txrx_fw_st_rst_store);
