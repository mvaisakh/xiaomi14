...
static void hal_rx_dump_msdu_end_tlv_kiwi(void *msduend, uint8_t dbg_level)
{
	...
	__QDF_TRACE_RL(dbg_level, QDF_MODULE_ID_HAL,
		       ...
		       msdu_end->sw_frame_group_id, msdu_end->reserved_0,
		       msdu_end->phy_ppdu_id, msdu_end->ip_hdr_chksum,
		       msdu_end->reported_mpdu_length, msdu_end->reserved_1a,
		       msdu_end->reserved_2a, msdu_end->cce_super_rule,
		       ...
		       msdu_end->ipv6_options_crc, msdu_end->da_offset,
		       msdu_end->sa_offset, msdu_end->da_offset_valid,
		       msdu_end->sa_offset_valid, msdu_end->reserved_5a,
		       msdu_end->l3_type);
	...
	__QDF_TRACE_RL(dbg_level, QDF_MODULE_ID_HAL,
		       ...
		       msdu_end->reserved_9a, msdu_end->window_size,
		       msdu_end->sa_sw_peer_id, msdu_end->sa_idx_timeout,
		       msdu_end->da_idx_timeout, msdu_end->to_ds, msdu_end->tid,
		       msdu_end->sa_is_valid, msdu_end->da_is_valid,
		       msdu_end->da_is_mcbc, msdu_end->l3_header_padding,
		       msdu_end->first_msdu, msdu_end->last_msdu,
		       msdu_end->fr_ds, msdu_end->ip_chksum_fail_copy,
		       msdu_end->sa_idx, msdu_end->da_idx_or_sw_peer_id);
	...
	__QDF_TRACE_RL(dbg_level, QDF_MODULE_ID_HAL,
		       ...
		       msdu_end->use_ppe, msdu_end->vlan_ctag_stripped,
		       msdu_end->vlan_stag_stripped, msdu_end->fragment_flag,
		       msdu_end->fse_metadata, msdu_end->cce_metadata,
		       msdu_end->tcp_udp_chksum, msdu_end->aggregation_count,
		       ...
		       msdu_end->flow_idx_invalid, msdu_end->cce_match,
		       msdu_end->amsdu_parser_error,
		       msdu_end->cumulative_ip_length, msdu_end->key_id_octet,
		       msdu_end->reserved_16a, msdu_end->reserved_17a,
		       msdu_end->service_code, msdu_end->priority_valid,
		       msdu_end->intra_bss, msdu_end->dest_chip_id,
		       msdu_end->multicast_echo, msdu_end->wds_learning_event,
		       msdu_end->wds_roaming_event,
		       msdu_end->wds_keep_alive_event, msdu_end->reserved_17b);

	__QDF_TRACE_RL(
		dbg_level, QDF_MODULE_ID_HAL,
		"rx_msdu_end tlv (4/5)- "
		"msdu_length :%x "
		"stbc :%x "
		"ipsec_esp :%x "
		...
		"msdu_done_copy :%x "
		"flow_id_toeplitz :%x",
		msdu_end->msdu_length, msdu_end->stbc, msdu_end->ipsec_esp,
		msdu_end->l3_offset, msdu_end->ipsec_ah, msdu_end->l4_offset,
		msdu_end->msdu_number, msdu_end->decap_format,
		msdu_end->ipv4_proto, msdu_end->ipv6_proto, msdu_end->tcp_proto,
		msdu_end->udp_proto, msdu_end->ip_frag, msdu_end->tcp_only_ack,
		msdu_end->da_is_bcast_mcast, msdu_end->toeplitz_hash_sel,
		msdu_end->ip_fixed_header_valid, msdu_end->ip_extn_header_valid,
		msdu_end->tcp_udp_header_valid, msdu_end->mesh_control_present,
		msdu_end->ldpc, msdu_end->ip4_protocol_ip6_next_header,
		msdu_end->vlan_ctag_ci, msdu_end->vlan_stag_ci,
		msdu_end->peer_meta_data, msdu_end->user_rssi,
		msdu_end->pkt_type, msdu_end->sgi, msdu_end->rate_mcs,
		msdu_end->receive_bandwidth, msdu_end->reception_type,
		msdu_end->mimo_ss_bitmap, msdu_end->msdu_done_copy,
	...
	__QDF_TRACE_RL(
		...
		msdu_end->sw_phy_meta_data, msdu_end->ppdu_start_timestamp_31_0,
		msdu_end->toeplitz_hash_2_or_4, msdu_end->reserved_28a,
		msdu_end->sa_15_0, msdu_end->sa_47_16, msdu_end->first_mpdu,
		msdu_end->reserved_30a, msdu_end->mcast_bcast,
		msdu_end->ast_index_not_found, msdu_end->ast_index_timeout,
		msdu_end->power_mgmt, msdu_end->non_qos, msdu_end->null_data,
		msdu_end->mgmt_type, msdu_end->ctrl_type, msdu_end->more_data,
		msdu_end->eosp, msdu_end->a_msdu_error, msdu_end->reserved_30b,
		msdu_end->order, msdu_end->wifi_parser_error,
		msdu_end->overflow_err, msdu_end->msdu_length_err,
		msdu_end->tcp_udp_chksum_fail, msdu_end->ip_chksum_fail,
		msdu_end->sa_idx_invalid, msdu_end->da_idx_invalid,
		msdu_end->amsdu_addr_mismatch, msdu_end->rx_in_tx_decrypt_byp,
		msdu_end->encrypt_required, msdu_end->directed,
		msdu_end->buffer_fragment, msdu_end->mpdu_length_err,
		msdu_end->tkip_mic_err, msdu_end->decrypt_err,
		msdu_end->unencrypted_frame_err, msdu_end->fcs_err,
		msdu_end->reserved_31a, msdu_end->decrypt_status_code,
		msdu_end->rx_bitmap_not_updated, msdu_end->reserved_31b,
		msdu_end->msdu_done);
}
#else
static void hal_rx_dump_msdu_end_tlv_kiwi(void *msduend, uint8_t dbg_level)
{
	...
	__QDF_TRACE_RL(dbg_level, QDF_MODULE_ID_HAL,
		       ...
		       msdu_end->lro_eligible, msdu_end->reserved_9a,
	...
	__QDF_TRACE_RL(dbg_level, QDF_MODULE_ID_HAL,
		       ...
		       "priority_valid :%x",
		       msdu_end->tcp_udp_chksum_fail_copy,
		       msdu_end->ip_chksum_fail_copy, msdu_end->sa_idx,
		       msdu_end->da_idx_or_sw_peer_id, msdu_end->msdu_drop,
		       msdu_end->reo_destination_indication, msdu_end->flow_idx,
		       msdu_end->reserved_12a, msdu_end->fse_metadata,
		       msdu_end->cce_metadata, msdu_end->sa_sw_peer_id,
		       msdu_end->aggregation_count,
		       msdu_end->flow_aggregation_continuation,
		       msdu_end->fisa_timeout, msdu_end->reserved_15a,
		       msdu_end->cumulative_l4_checksum,
		       msdu_end->cumulative_ip_length, msdu_end->service_code,
	...
	__QDF_TRACE_RL(dbg_level, QDF_MODULE_ID_HAL,
		       ...
		       "ip_extn_header_valid :%x"
		       "tcp_udp_header_valid :%x",
		       msdu_end->reserved_17a, msdu_end->msdu_length,
		       msdu_end->ipsec_esp, msdu_end->l3_offset,
		       msdu_end->ipsec_ah, msdu_end->l4_offset,
		       msdu_end->msdu_number, msdu_end->decap_format,
		       msdu_end->ipv4_proto, msdu_end->ipv6_proto,
		       msdu_end->tcp_proto, msdu_end->udp_proto,
		       msdu_end->ip_frag, msdu_end->tcp_only_ack,
		       msdu_end->da_is_bcast_mcast, msdu_end->toeplitz_hash_sel,
	...
	__QDF_TRACE_RL(dbg_level, QDF_MODULE_ID_HAL,
		       ...
		       "reserved_30a :%x"
		       "mcast_bcast :%x",
		       msdu_end->mesh_control_present, msdu_end->ldpc,
		       msdu_end->ip4_protocol_ip6_next_header,
		       msdu_end->toeplitz_hash_2_or_4,
		       msdu_end->flow_id_toeplitz, msdu_end->user_rssi,
		       msdu_end->pkt_type, msdu_end->stbc, msdu_end->sgi,
		       msdu_end->rate_mcs, msdu_end->receive_bandwidth,
		       msdu_end->reception_type, msdu_end->mimo_ss_bitmap,
		       msdu_end->ppdu_start_timestamp_31_0,
		       msdu_end->ppdu_start_timestamp_63_32,
		       msdu_end->sw_phy_meta_data, msdu_end->vlan_ctag_ci,
		       msdu_end->vlan_stag_ci, msdu_end->first_mpdu,
		       msdu_end->reserved_30a, msdu_end->mcast_bcast);
	...
	__QDF_TRACE_RL(
		...
		msdu_end->power_mgmt, msdu_end->non_qos, msdu_end->null_data,
		msdu_end->mgmt_type, msdu_end->ctrl_type, msdu_end->more_data,
		msdu_end->eosp, msdu_end->a_msdu_error, msdu_end->fragment_flag,
		msdu_end->order, msdu_end->cce_match, msdu_end->overflow_err,
		msdu_end->msdu_length_err, msdu_end->tcp_udp_chksum_fail,
		msdu_end->ip_chksum_fail, msdu_end->sa_idx_invalid,
		msdu_end->da_idx_invalid, msdu_end->reserved_30b);
...
static inline void hal_register_rx_pkt_hdr_tlv_api_kiwi(struct hal_soc *hal_soc)
{
}
						   ...
						   uint8_t dbg_level)
{
	...
	__QDF_TRACE_RL(
		...
		mpdu_info->pre_delim_err_warning, mpdu_info->first_delim_err,
		mpdu_info->reserved_2a, mpdu_info->pn_31_0, mpdu_info->pn_63_32,
		mpdu_info->pn_95_64, mpdu_info->pn_127_96, mpdu_info->epd_en,
		mpdu_info->all_frames_shall_be_encrypted,
		mpdu_info->encrypt_type,
		mpdu_info->wep_key_width_for_variable_key, mpdu_info->bssid_hit,
		mpdu_info->bssid_number, mpdu_info->tid, mpdu_info->reserved_7a,
	...
	__QDF_TRACE_RL(
		...
		mpdu_info->sw_frame_group_id, mpdu_info->ndp_frame,
		mpdu_info->phy_err, mpdu_info->phy_err_during_mpdu_header,
		mpdu_info->protocol_version_err,
		mpdu_info->ast_based_lookup_valid, mpdu_info->reserved_9a,
		mpdu_info->phy_ppdu_id, mpdu_info->ast_index,
		mpdu_info->sw_peer_id, mpdu_info->mpdu_frame_control_valid,
		mpdu_info->mpdu_duration_valid, mpdu_info->mac_addr_ad1_valid,
		mpdu_info->mac_addr_ad2_valid, mpdu_info->mac_addr_ad3_valid,
	...
	__QDF_TRACE_RL(dbg_level, QDF_MODULE_ID_HAL,
		       ...
		       mpdu_info->more_fragment_flag, mpdu_info->reserved_11a,
		       mpdu_info->fr_ds, mpdu_info->to_ds, mpdu_info->encrypted,
		       mpdu_info->mpdu_retry, mpdu_info->mpdu_sequence_number,
		       mpdu_info->key_id_octet, mpdu_info->new_peer_entry,
		       mpdu_info->decrypt_needed, mpdu_info->decap_type,
		       ...
		       mpdu_info->pre_delim_count, mpdu_info->ampdu_flag,
		       mpdu_info->bar_frame, mpdu_info->raw_mpdu,
		       mpdu_info->reserved_12, mpdu_info->mpdu_length);
	...
	__QDF_TRACE_RL(dbg_level, QDF_MODULE_ID_HAL,
		       ...
		       mpdu_info->mpdu_length, mpdu_info->first_mpdu,
		       mpdu_info->mcast_bcast, mpdu_info->ast_index_not_found,
		       mpdu_info->ast_index_timeout, mpdu_info->power_mgmt,
		       mpdu_info->non_qos, mpdu_info->null_data,
		       mpdu_info->mgmt_type, mpdu_info->ctrl_type,
		       mpdu_info->more_data, mpdu_info->eosp,
		       mpdu_info->fragment_flag, mpdu_info->order,
		       mpdu_info->u_apsd_trigger, mpdu_info->encrypt_required,
		       mpdu_info->directed, mpdu_info->amsdu_present,
	...
	__QDF_TRACE_RL(
		...
		"priority_valid:%x "
		"reserved_23a:%x ",
		mpdu_info->mac_addr_ad1_31_0, mpdu_info->mac_addr_ad1_47_32,
		mpdu_info->mac_addr_ad2_15_0, mpdu_info->mac_addr_ad2_47_16,
		mpdu_info->mac_addr_ad3_31_0, mpdu_info->mac_addr_ad3_47_32,
		mpdu_info->mpdu_sequence_control_field,
		mpdu_info->mac_addr_ad4_31_0, mpdu_info->mac_addr_ad4_47_32,
		mpdu_info->mpdu_qos_control_field,
		mpdu_info->mpdu_ht_control_field, mpdu_info->vdev_id,
		mpdu_info->service_code, mpdu_info->priority_valid,
 ...
 * Return: None
 */
static void hal_rx_tlv_populate_mpdu_desc_info_kiwi(uint8_t *buf,
					   ...
					   void *h1)
{
   ...
   */
	...
	case HAL_REO_DESC_THRES_STATUS_TLV:
		val1 = d[HAL_OFFSET_QW(REO_DESCRIPTOR_THRESHOLD_REACHED_STATUS,
				       STATUS_HEADER_REO_STATUS_NUMBER)];
		break;
	...
	h->cmd_num = HAL_GET_FIELD(UNIFORM_REO_STATUS_HEADER, REO_STATUS_NUMBER,
				   val1);
	h->exec_time = HAL_GET_FIELD(UNIFORM_REO_STATUS_HEADER,
				     CMD_EXECUTION_TIME, val1);
	h->status = HAL_GET_FIELD(UNIFORM_REO_STATUS_HEADER,
	...
	h->tstamp = HAL_GET_FIELD(UNIFORM_REO_STATUS_HEADER, TIMESTAMP, val1);
}

static void *hal_rx_msdu0_buffer_addr_lsb_kiwi(void *link_desc_va)
{
	return (void *)HAL_RX_MSDU0_BUFFER_ADDR_LSB(link_desc_va);
}

static void *hal_rx_msdu_desc_info_ptr_get_kiwi(void *msdu0)
{
	return (void *)HAL_RX_MSDU_DESC_INFO_PTR_GET(msdu0);
}

static void *hal_ent_mpdu_desc_info_kiwi(void *ent_ring_desc)
{
	return (void *)HAL_ENT_MPDU_DESC_INFO(ent_ring_desc);
}

static void *hal_dst_mpdu_desc_info_kiwi(void *dst_ring_desc)
{
 ...
 */
static void
hal_rx_proc_phyrx_other_receive_info_tlv_kiwi(void *rx_tlv_hdr,
					      void *ppdu_info_handle)
{
	...
	default:
		hal_err_rl("unhandled TLV type: %d, TLV len:%d", other_tlv_tag,
			   other_tlv_len);
		break;
	}
}
 ...
 * Return: void
 */
static void hal_reo_config_kiwi(struct hal_soc *soc, uint32_t reg_val,
 ...
 * Return: none.
 */
static void hal_reo_set_err_dst_remap_kiwi(void *hal_soc)
{
	/*
   * Set REO error 2k jump (error code 5) / OOR (error code 7)
   * frame routed to REO2SW0 ring.
   */
	uint32_t dst_remap_ix0 = HAL_REO_ERR_REMAP_IX0(REO_REMAP_TCL, 0) |
	...
	uint32_t dst_remap_ix1 = HAL_REO_ERR_REMAP_IX1(REO_REMAP_TCL, 14) |
 ...
 */
static void *hal_rx_flow_setup_fse_kiwi(uint8_t *rx_fst, uint32_t table_offset,
					uint8_t *rx_flow)
{
	...
	HAL_SET_FLD(fse, RX_FLOW_SEARCH_ENTRY, DEST_PORT) |= HAL_SET_FLD_SM(
		RX_FLOW_SEARCH_ENTRY, DEST_PORT, (flow->tuple_info.dest_port));

	HAL_CLR_FLD(fse, RX_FLOW_SEARCH_ENTRY, SRC_PORT);
	HAL_SET_FLD(fse, RX_FLOW_SEARCH_ENTRY, SRC_PORT) |= HAL_SET_FLD_SM(
		RX_FLOW_SEARCH_ENTRY, SRC_PORT, (flow->tuple_info.src_port));
	...
	HAL_SET_FLD(fse, RX_FLOW_SEARCH_ENTRY, METADATA) = HAL_SET_FLD_SM(
		RX_FLOW_SEARCH_ENTRY, METADATA, (flow->fse_metadata));
	...
	HAL_SET_FLD(fse, RX_FLOW_SEARCH_ENTRY, REO_DESTINATION_INDICATION) |=
		HAL_SET_FLD_SM(RX_FLOW_SEARCH_ENTRY, REO_DESTINATION_INDICATION,
 ...
 * Return: Success/Failure
 */
static uint32_t hal_rx_flow_setup_cmem_fse_kiwi(struct hal_soc *hal_soc,
						uint32_t cmem_ba,
						...
						uint8_t *rx_flow)
{
	...
	HAL_CMEM_WRITE(hal_soc,
		       fse_offset + HAL_OFFSET(RX_FLOW_SEARCH_ENTRY, VALID), 0);

	value = HAL_SET_FLD_SM(RX_FLOW_SEARCH_ENTRY, SRC_IP_127_96,
			       (flow->tuple_info.src_ip_127_96));
	HAL_CMEM_WRITE(hal_soc,
		       fse_offset +
			       HAL_OFFSET(RX_FLOW_SEARCH_ENTRY, SRC_IP_127_96),
		       value);
	...
	HAL_CMEM_WRITE(hal_soc,
		       fse_offset +
			       HAL_OFFSET(RX_FLOW_SEARCH_ENTRY, SRC_IP_95_64),
		       value);
	...
	HAL_CMEM_WRITE(hal_soc,
		       fse_offset +
			       HAL_OFFSET(RX_FLOW_SEARCH_ENTRY, SRC_IP_63_32),
		       value);
	...
	HAL_CMEM_WRITE(hal_soc,
		       fse_offset +
			       HAL_OFFSET(RX_FLOW_SEARCH_ENTRY, SRC_IP_31_0),
		       value);
	...
	HAL_CMEM_WRITE(hal_soc,
		       fse_offset +
			       HAL_OFFSET(RX_FLOW_SEARCH_ENTRY, DEST_IP_127_96),
		       value);
	...
	HAL_CMEM_WRITE(hal_soc,
		       fse_offset +
			       HAL_OFFSET(RX_FLOW_SEARCH_ENTRY, DEST_IP_95_64),
		       value);
	...
	HAL_CMEM_WRITE(hal_soc,
		       fse_offset +
			       HAL_OFFSET(RX_FLOW_SEARCH_ENTRY, DEST_IP_63_32),
		       value);
	...
	HAL_CMEM_WRITE(hal_soc,
		       fse_offset +
			       HAL_OFFSET(RX_FLOW_SEARCH_ENTRY, DEST_IP_31_0),
		       value);
	...
	HAL_CMEM_WRITE(hal_soc,
		       fse_offset + HAL_OFFSET(RX_FLOW_SEARCH_ENTRY, SRC_PORT),
		       value);

	value = HAL_SET_FLD_SM(RX_FLOW_SEARCH_ENTRY, METADATA,
			       (flow->fse_metadata));
	HAL_CMEM_WRITE(hal_soc,
		       fse_offset + HAL_OFFSET(RX_FLOW_SEARCH_ENTRY, METADATA),
		       value);

	/* Reset all the other fields in FSE */
	HAL_CMEM_WRITE(
		hal_soc,
		fse_offset + HAL_OFFSET(RX_FLOW_SEARCH_ENTRY, MSDU_COUNT), 0);
	HAL_CMEM_WRITE(hal_soc,
		       fse_offset + HAL_OFFSET(RX_FLOW_SEARCH_ENTRY,
					       MSDU_BYTE_COUNT),
		       0);
	HAL_CMEM_WRITE(hal_soc,
		       fse_offset + HAL_OFFSET(RX_FLOW_SEARCH_ENTRY, TIMESTAMP),
		       0);
	...
	HAL_CMEM_WRITE(hal_soc,
		       fse_offset +
			       HAL_OFFSET(RX_FLOW_SEARCH_ENTRY, L4_PROTOCOL),
		       value);
 ...
 */
static void hal_rx_flow_get_cmem_fse_kiwi(struct hal_soc *hal_soc,
...
static void hal_compute_reo_remap_ix2_ix3_kiwi(uint32_t *ring_map,
					       uint32_t num_rings,
					       uint32_t *remap1,
					       uint32_t *remap2)
{
 ...
 * Return: None
 */
static void hal_rx_reo_prev_pn_get_kiwi(void *ring_desc, uint64_t *prev_pn)
{
...
static inline uint64_t hal_tsf_get_fw_time(struct hal_soc *soc)
{
...
static inline uint64_t hal_fw_qtime_to_usecs(uint64_t time)
{
	/*
 ...
 * Return: None.
 */
static void hal_get_tsf_time_kiwi(hal_soc_handle_t hal_soc_hdl, uint32_t tsf_id,
				  ...
				  uint64_t *tsf_sync_soc_time)
{
	...
	global_time = fw_time + (global_time_low_offset |
...
#else
static inline void hal_get_tsf_time_kiwi(hal_soc_handle_t hal_soc_hdl,
					 uint32_t tsf_id, uint32_t mac_id,
					 uint64_t *tsf,
					 uint64_t *tsf_sync_soc_time)
{
}
 ...
 */
static inline bool hal_rx_en_mcast_fp_data_filter_kiwi(void)
{
	return false;
}
 ...
 * Return: None
 */
static inline void hal_srng_dst_hw_init_misc_1_kiwi(struct hal_srng *srng)
{
	uint32_t reg_val = 0;
 ...
 */
static inline void
hal_srng_hw_reg_offset_init_misc_1_kiwi(struct hal_soc *hal_soc)
{
 ...
 * Return: None
 */
static inline void hal_srng_dst_hw_init_kiwi(struct hal_soc *hal_soc,
...
static void hal_hw_txrx_ops_attach_kiwi(struct hal_soc *hal_soc)
{
	...
	hal_soc->ops->hal_rx_msdu_cce_match_get = hal_rx_msdu_cce_match_get_be;
...
struct hal_hw_srng_config hw_srng_table_kiwi[] = {
    /* TODO: max_rings can populated by querying HW capabilities */
    {
        ...
        .nf_irq_support = true,
        .reg_start = {HWIO_REO_R0_REO2SW1_RING_BASE_LSB_ADDR(REO_REG_REG_BASE),
                      HWIO_REO_R2_REO2SW1_RING_HP_ADDR(REO_REG_REG_BASE)},
        .reg_size =
            {
    ...
    },
    {
        ...
        .lmac_ring = FALSE,
        .ring_dir = HAL_SRNG_DST_RING,
        .reg_start = {HWIO_REO_R0_REO2SW0_RING_BASE_LSB_ADDR(REO_REG_REG_BASE),
                      HWIO_REO_R2_REO2SW0_RING_HP_ADDR(REO_REG_REG_BASE)},
        /* Single ring - provide ring size if multiple rings of this
         * type are supported
         */
        .reg_size = {},
        .max_size = HWIO_REO_R0_REO2SW0_RING_BASE_MSB_RING_SIZE_BMSK >>
    ...
    },
    {
        ...
        .reg_start = {HWIO_REO_R0_SW2REO_RING_BASE_LSB_ADDR(REO_REG_REG_BASE),
                      HWIO_REO_R2_SW2REO_RING_HP_ADDR(REO_REG_REG_BASE)},
        /* Single ring - provide ring size if multiple rings of this
         * type are supported
         */
        .reg_size = {},
    ...
    },
    {
        ...
        .reg_start =
            {
                HWIO_REO_R0_REO_CMD_RING_BASE_LSB_ADDR(REO_REG_REG_BASE),
                HWIO_REO_R2_REO_CMD_RING_HP_ADDR(REO_REG_REG_BASE),
            },
        /* Single ring - provide ring size if multiple rings of this
         * type are supported
         */
    ...
    },
    {
        ...
        .reg_start =
            {
                HWIO_REO_R0_REO_STATUS_RING_BASE_LSB_ADDR(REO_REG_REG_BASE),
                HWIO_REO_R2_REO_STATUS_RING_HP_ADDR(REO_REG_REG_BASE),
            },
        /* Single ring - provide ring size if multiple rings of this
         * type are supported
         */
    ...
    },
    {
        ...
        .reg_start =
            {
                HWIO_TCL_R0_SW2TCL1_RING_BASE_LSB_ADDR(MAC_TCL_REG_REG_BASE),
                HWIO_TCL_R2_SW2TCL1_RING_HP_ADDR(MAC_TCL_REG_REG_BASE),
            },
        .reg_size =
            {
        ...
        .reg_start =
            {
                ...
                HWIO_TCL_R2_SW2TCL_CREDIT_RING_HP_ADDR(MAC_TCL_REG_REG_BASE),
            },
        /* Single ring - provide ring size if multiple rings of this
         * type are supported
         */
        ...
        .reg_start =
            {
                HWIO_TCL_R0_TCL_STATUS1_RING_BASE_LSB_ADDR(
                    MAC_TCL_REG_REG_BASE),
                HWIO_TCL_R2_TCL_STATUS1_RING_HP_ADDR(MAC_TCL_REG_REG_BASE),
            },
        /* Single ring - provide ring size if multiple rings of this
         * type are supported
         */
