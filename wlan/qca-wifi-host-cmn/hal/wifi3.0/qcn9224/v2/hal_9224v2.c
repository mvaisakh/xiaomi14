...
struct hal_hw_srng_config hw_srng_table_9224v2[] = {
    ...
    },
    {
        ...
        .reg_size = {},
        .max_size = HWIO_WBM_R0_PPE_RELEASE_RING_BASE_MSB_RING_SIZE_BMSK >>
 ...
 */
static inline void
hal_reo_config_reo2ppe_dest_info_9224(hal_soc_handle_t hal_soc_hdl)
{
						...
						uint8_t mac_id, uint64_t *value)
{
	...
	offset_lo =
		hal_read_pmm_scratch_reg(soc, PMM_REG_BASE_QCN9224_V2, enum_lo);

	offset_hi =
		hal_read_pmm_scratch_reg(soc, PMM_REG_BASE_QCN9224_V2, enum_hi);
					       ...
					       uint64_t *value)
{
	...
	offset_lo = hal_read_pmm_scratch_reg(soc, PMM_REG_BASE_QCN9224_V2,
					     PMM_TQM_CLOCK_OFFSET_LO_US);

	offset_hi = hal_read_pmm_scratch_reg(soc, PMM_REG_BASE_QCN9224_V2,
