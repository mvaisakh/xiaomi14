 ...
 * Return: uint32_t(nss)
 */
static uint32_t hal_rx_msdu_start_nss_get_6490(uint8_t *buf)
{
 ...
 */
static void
hal_rx_proc_phyrx_other_receive_info_tlv_6490(void *rx_tlv_hdr,
 ...
 * Return: void
 */
static void hal_rx_dump_msdu_end_tlv_6490(void *pkttlvs, uint8_t dbg_level)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)pkttlvs;
	...
	__QDF_TRACE_RL(dbg_level, QDF_MODULE_ID_DP,
		       ...
		       msdu_end->ext_wapi_pn_63_48, msdu_end->ext_wapi_pn_95_64,
 ...
 */
static uint32_t hal_rx_msdu_start_reception_type_get_6490(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_msdu_start *msdu_start =
		&pkt_tlvs->msdu_start_tlv.rx_msdu_start;
 ...
 */
static uint8_t hal_rx_get_rx_fragment_number_6490(uint8_t *buf)
{
 ...
 * Return: da_is_mcbc
 */
static uint8_t hal_rx_msdu_end_da_is_mcbc_get_6490(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_msdu_end *msdu_end = &pkt_tlvs->msdu_end_tlv.rx_msdu_end;
 ...
 */
static uint8_t hal_rx_msdu_end_sa_is_valid_get_6490(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_msdu_end *msdu_end = &pkt_tlvs->msdu_end_tlv.rx_msdu_end;
	uint8_t sa_is_valid;
 ...
 */
static uint16_t hal_rx_msdu_end_sa_idx_get_6490(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_msdu_end *msdu_end = &pkt_tlvs->msdu_end_tlv.rx_msdu_end;
	uint16_t sa_idx;
 ...
 * Return: success/failure
 */
static QDF_STATUS hal_rx_mpdu_get_addr2_6490(uint8_t *buf, uint8_t *mac_addr)
{
 ...
 * Return: void
 */
static inline void hal_tx_desc_set_mesh_en_6490(void *desc, uint8_t en)
{
	HAL_SET_FLD(desc, TCL_DATA_CMD_5, MESH_ENABLE) |=
		HAL_TX_SM(TCL_DATA_CMD_5, MESH_ENABLE, en);
}

static void *hal_rx_msdu0_buffer_addr_lsb_6490(void *link_desc_va)
{
	return (void *)HAL_RX_MSDU0_BUFFER_ADDR_LSB(link_desc_va);
}

static void *hal_rx_msdu_desc_info_ptr_get_6490(void *msdu0)
{
	return (void *)HAL_RX_MSDU_DESC_INFO_PTR_GET(msdu0);
}

static void *hal_ent_mpdu_desc_info_6490(void *ent_ring_desc)
{
	return (void *)HAL_ENT_MPDU_DESC_INFO(ent_ring_desc);
}

static void *hal_dst_mpdu_desc_info_6490(void *dst_ring_desc)
{
	return (void *)HAL_DST_MPDU_DESC_INFO(dst_ring_desc);
}

static uint8_t hal_rx_get_fc_valid_6490(uint8_t *buf)
{
...
static uint32_t hal_rx_get_ppdu_id_6490(uint8_t *buf)
{
 ...
 * Return: void
 */
static void hal_reo_config_6490(struct hal_soc *soc, uint32_t reg_val,
 ...
 * Return: cce_metadata
 */
static uint16_t hal_rx_msdu_cce_metadata_get_6490(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_msdu_end *msdu_end = &pkt_tlvs->msdu_end_tlv.rx_msdu_end;
 ...
 * Return: none
 */
static inline void hal_rx_msdu_get_flow_params_6490(uint8_t *buf,
						    bool *flow_invalid,
						    bool *flow_timeout,
						    uint32_t *flow_index)
{
 ...
 * Return: tcp checksum
 */
static uint16_t hal_rx_tlv_get_tcp_chksum_6490(uint8_t *buf)
{
 ...
 */
static uint16_t hal_rx_get_rx_sequence_6490(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = hal_rx_get_pkt_tlvs(buf);
	struct rx_mpdu_info *rx_mpdu_info = hal_rx_get_mpdu_info(pkt_tlvs);
 ...
 */
static inline uint16_t hal_rx_get_fisa_cumulative_l4_checksum_6490(uint8_t *buf)
{
 ...
 */
static inline uint16_t hal_rx_get_fisa_cumulative_ip_length_6490(uint8_t *buf)
{
 ...
 */
static inline bool hal_rx_get_udp_proto_6490(uint8_t *buf)
{
 ...
 * Return: flow agg
 */
static inline bool hal_rx_get_flow_agg_continuation_6490(uint8_t *buf)
{
 ...
 */
static inline uint8_t hal_rx_get_flow_agg_count_6490(uint8_t *buf)
{
 ...
 * Return: fisa timeout
 */
static inline bool hal_rx_get_fisa_timeout_6490(uint8_t *buf)
{
 ...
 * Return: none.
 */
static void hal_reo_set_err_dst_remap_6490(void *hal_soc)
{
	/*
 ...
 * Return: Success/Failure
 */
static void *hal_rx_flow_setup_fse_6490(uint8_t *rx_fst, uint32_t table_offset,
					uint8_t *rx_flow)
{
...
static void hal_compute_reo_remap_ix2_ix3_6490(uint32_t *ring,
					       uint32_t num_rings,
					       uint32_t *remap1,
					       uint32_t *remap2)
{
...
static void hal_compute_reo_remap_ix0_6490(uint32_t *remap0)
{
...
static void hal_hw_txrx_ops_attach_qca6490(struct hal_soc *hal_soc)
{
	...
	hal_soc->ops->hal_rx_tlv_l3_type_get = hal_rx_tlv_l3_type_get_6490;
	hal_soc->ops->hal_rx_tlv_msdu_len_get = hal_rx_msdu_start_get_len_6490;
};
