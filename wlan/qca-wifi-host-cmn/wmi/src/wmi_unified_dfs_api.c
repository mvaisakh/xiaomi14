...
QDF_STATUS wmi_extract_dfs_cac_complete_event(wmi_unified_t wmi_handle,
					      uint8_t *evt_buf,
					      uint32_t *vdev_id, uint32_t len)
{
...
QDF_STATUS
wmi_extract_wlan_radar_event_info(wmi_unified_t wmi_handle, uint8_t *evt_buf,
...
QDF_STATUS
wmi_send_subchan_marking_pdev_param(wmi_unified_t wmi_handle, bool subchanmark,
				    struct wlan_objmgr_pdev *pdev)
{
	struct pdev_params pparam;
	int pdev_idx;
