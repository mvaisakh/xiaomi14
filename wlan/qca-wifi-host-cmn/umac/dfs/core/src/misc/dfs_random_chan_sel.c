...
struct dfs_matrix_tx_leak_info ht80_chan[] = {
	{ 52,
	  ...
	  { { 36, 5180, 148 },
	    ...
	    { 124, 5620, 437 },
	    { 128, 5640, 435 },
	    { 132, 5660, DFS_TX_LEAKAGE_MAX },
	    { 136, 5680, DFS_TX_LEAKAGE_MAX },
	...
	{ 56,
	  ...
	  { { 36, 5180, 171 },
	    ...
	    { 48, 5240, 178 },
	    { 52, 5260, DFS_TX_LEAKAGE_MIN },
	    { 56, 5280, DFS_TX_LEAKAGE_MIN },
	    { 60, 5300, DFS_TX_LEAKAGE_MIN },
	    { 64, 5320, 280 },
	    { 100, 5500, 351 },
	    { 104, 5520, 376 },
	    { 108, 5540, 362 },
	...
	{ 60,
	  ...
	  { { 36, 5180, 156 },
	    { 40, 5200, 146 },
	    { 44, 5220, DFS_TX_LEAKAGE_MIN },
	    { 48, 5240, DFS_TX_LEAKAGE_MIN },
	    { 52, 5260, 180 },
	    { 56, 5280, DFS_TX_LEAKAGE_MIN },
	    { 60, 5300, DFS_TX_LEAKAGE_MIN },
	    { 64, 5320, DFS_TX_LEAKAGE_MIN },
	    { 100, 5500, 376 },
	    { 104, 5520, 360 },
	    { 108, 5540, DFS_TX_LEAKAGE_MAX },
	    { 112, 5560, DFS_TX_LEAKAGE_MAX },
	    { 116, 5580, 395 },
	    { 120, 5600, 399 },
	    { 124, 5620, DFS_TX_LEAKAGE_MAX },
	    { 128, 5640, DFS_TX_LEAKAGE_MAX },
	...
	{ 100,
	  ...
	  { { 36, 5180, 357 },
	    ...
	    { 52, 5260, 378 },
	    { 56, 5280, 396 },
	    { 60, 5300, DFS_TX_LEAKAGE_MAX },
	    { 64, 5320, DFS_TX_LEAKAGE_MAX },
	    { 100, 5500, DFS_TX_LEAKAGE_MIN },
	    { 104, 5520, DFS_TX_LEAKAGE_MIN },
	    { 108, 5540, 196 },
	    { 112, 5560, 116 },
	    { 116, 5580, 166 },
	    { 120, 5600, DFS_TX_LEAKAGE_MIN },
	    { 124, 5620, DFS_TX_LEAKAGE_MIN },
	    { 128, 5640, DFS_TX_LEAKAGE_MIN },
	    { 132, 5660, DFS_TX_LEAKAGE_MIN },
	    { 136, 5680, DFS_TX_LEAKAGE_MIN },
	...
	{ 132, 5660, { { 36, 5180, DFS_TX_LEAKAGE_MAX },
		       { 40, 5200, DFS_TX_LEAKAGE_MAX },
		       { 44, 5220, DFS_TX_LEAKAGE_MAX },
		       { 48, 5240, DFS_TX_LEAKAGE_MAX },
		       { 52, 5260, DFS_TX_LEAKAGE_MAX },
		       { 56, 5280, DFS_TX_LEAKAGE_MAX },
		       { 60, 5300, DFS_TX_LEAKAGE_MIN },
		       { 64, 5320, DFS_TX_LEAKAGE_MIN },
		       { 100, 5500, DFS_TX_LEAKAGE_MIN },
		       { 104, 5520, DFS_TX_LEAKAGE_MIN },
	...
	{ 136, 5680, { { 36, 5180, DFS_TX_LEAKAGE_MAX },
		       { 40, 5200, DFS_TX_LEAKAGE_MAX },
		       { 44, 5220, DFS_TX_LEAKAGE_MAX },
		       { 48, 5240, DFS_TX_LEAKAGE_MAX },
		       { 52, 5260, DFS_TX_LEAKAGE_MAX },
...
struct dfs_matrix_tx_leak_info ht40_chan[] = {
	{ 52,
	  5260,
	  { { 36, 5180, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 40, 5200, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 44, 5220, 230 },
	    { 48, 5240, 230 },
	    { 52, 5260, DFS_TX_LEAKAGE_MIN },
	    { 56, 5280, DFS_TX_LEAKAGE_MIN },
	    { 60, 5300, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 64, 5320, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 100, 5500, 625 },
	    { 104, 5520, 323 },
	    { 108, 5540, 646 },
	    { 112, 5560, 646 },
	    { 116, 5580, DFS_TX_LEAKAGE_MAX },
	    { 120, 5600, DFS_TX_LEAKAGE_MAX },
	    { 124, 5620, DFS_TX_LEAKAGE_MAX },
	    { 128, 5640, DFS_TX_LEAKAGE_MAX },
	    { 132, 5660, DFS_TX_LEAKAGE_MAX },
	    { 136, 5680, DFS_TX_LEAKAGE_MAX },
	...
	{ 56,
	  ...
	  { { 36, 5180, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 40, 5200, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 44, 5220, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 48, 5240, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 52, 5260, DFS_TX_LEAKAGE_MIN },
	    { 56, 5280, DFS_TX_LEAKAGE_MIN },
	    { 60, 5300, DFS_TX_LEAKAGE_MIN },
	    { 64, 5320, DFS_TX_LEAKAGE_MIN },
	...
	{ 100,
	  ...
	  { { 36, 5180, 618 },
	    ...
	    { 108, 5540, 299 },
	    { 112, 5560, 299 },
	    { 116, 5580, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 120, 5600, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 124, 5620, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 128, 5640, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 132, 5660, 538 },
	    { 136, 5680, 538 },
	    { 140, 5700, 598 },
	    { 144, 5720, DFS_TX_LEAKAGE_MIN } } },
	...
	{ 108,
	  ...
	  { { 36, 5180, 600 },
	    ...
	    { 124, 5620, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 128, 5640, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 132, 5660, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 136, 5680, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 140, 5700, 534 },
	    { 144, 5720, DFS_TX_LEAKAGE_MIN } } },
	...
	{ 124,
	  ...
	  { { 36, 5180, 676 },
	    ...
	    { 100, 5500, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 104, 5520, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 108, 5540, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 112, 5560, DFS_TX_LEAKAGE_AUTO_MIN },
	    { 116, 5580, 225 },
	    { 120, 5600, 225 },
	    { 124, 5620, DFS_TX_LEAKAGE_MIN },
	    { 128, 5640, DFS_TX_LEAKAGE_MIN },
...
static bool dfs_find_target_channel_in_channel_matrix_for_freq(
	enum phy_ch_width chan_width, uint16_t nol_freq,
...
QDF_STATUS
dfs_mark_leaking_chan_for_freq(struct wlan_dfs *dfs, enum phy_ch_width ch_width,
			       ...
			       uint16_t *temp_freq_lst)
{
	...
	while (nol) {
		if (false ==
		    dfs_find_target_channel_in_channel_matrix_for_freq(
			    ch_width, nol->nol_freq, &target_chan_matrix)) {
			/*
     ...
     */
       ...
       */
         ...
         */
				dfs_debug(
					dfs, WLAN_DEBUG_DFS_RANDOM_CHAN,
...
static uint8_t dfs_populate_80mhz_available_channel_for_freq(
	struct wlan_dfs *dfs, struct chan_bonding_bitmap *bitmap,
	uint16_t *avail_freq_list)
{
	...
	dfs_info(dfs, WLAN_DEBUG_DFS_RANDOM_CHAN, "channel count %d",
		 chnl_count);
					      ...
					      uint16_t *avail_freq_list)
{
	...
	for (i = 0; i < DFS_MAX_80MHZ_BANDS; i++) {
		...
		if ((bmap->chan_bonding_set[i].chan_map & DFS_40MHZ_MASK_L) ==
		    DFS_40MHZ_MASK_L) {
			avail_freq_list[chnl_count++] =
				start_chan_freq +
				(DFS_NEXT_5GHZ_CHANNEL_FREQ_OFFSET * 0);
		...
		if ((bmap->chan_bonding_set[i].chan_map & DFS_40MHZ_MASK_H) ==
		    DFS_40MHZ_MASK_H) {
			avail_freq_list[chnl_count++] =
				start_chan_freq +
				(DFS_NEXT_5GHZ_CHANNEL_FREQ_OFFSET * 2);
 ...
 */
#ifdef CONFIG_CHAN_FREQ_API
static uint8_t dfs_populate_available_channel_for_freq(
	struct wlan_dfs *dfs, struct chan_bonding_bitmap *bitmap,
	uint16_t chan_width, uint16_t *freq_list)
{
	switch (chan_width) {
	...
	case DFS_CH_WIDTH_80MHZ:
		return dfs_populate_80mhz_available_channel_for_freq(
			dfs, bitmap, freq_list);
	case DFS_CH_WIDTH_40MHZ:
		return dfs_populate_40mhz_available_channel_for_freq(
			dfs, bitmap, freq_list);
	default:
		dfs_err(dfs, WLAN_DEBUG_DFS_RANDOM_CHAN,
					       ...
					       uint8_t num_chan)
{
	...
	if (!num_chan || !freq_lst) {
		dfs_err(NULL, WLAN_DEBUG_DFS_ALWAYS,
			"invalid param freq_lst %pK, num_chan = %d", freq_lst,
			num_chan);
		return 0;
	}
	...
	dfs_info(dfs, WLAN_DEBUG_DFS_RANDOM_CHAN, "random chan freq %d",
		 freq_lst[i]);
					   ...
					   uint16_t chan_freq)
{
	...
	for (i = 0; i < DFS_MAX_80MHZ_BANDS; i++) {
		...
		if (chan_freq >= start_chan_freq &&
		    chan_freq <= start_chan_freq + FREQUENCY_BAND_LIMIT) {
...
static qdf_freq_t dfs_find_next_chan_start_freq_for_320_160(uint8_t chan_count,
							    uint16_t *freq_list,
							    uint16_t chan_width,
							    bool *chan_found)
{
						   ...
						   uint32_t num_chan)
{
	...
	final_cnt = dfs_populate_available_channel_for_freq(
		dfs, &ch_map, *chan_wd, final_lst);
     ...
     * frequency spectrum.
     */
		new_start_ch = dfs_find_next_chan_start_freq_for_320_160(
			final_cnt, final_lst, *chan_wd, &flag);
	...
	if (*chan_wd == DFS_CH_WIDTH_320MHZ ||
	    *chan_wd == DFS_CH_WIDTH_160MHZ) {
		get_random_bytes((uint8_t *)&rand_byte, 1);
		rand_byte =
			(rand_byte + qdf_mc_timer_get_system_ticks()) %
			dfs_find_num_sub_channels_for_chwidth_320_160(*chan_wd);
		target_channel = new_start_ch +
		...
		*center_freq_seg1 = sec_seg_ch;
		...
		target_channel = dfs_get_rand_from_lst_for_freq(dfs, final_lst,
								final_cnt);
	}
	dfs_info(dfs, WLAN_DEBUG_DFS_RANDOM_CHAN, "target channel = %d",
		 target_channel);
 ...
 */
#ifdef CONFIG_CHAN_FREQ_API
static void dfs_apply_rules_for_freq(struct wlan_dfs *dfs, uint32_t flags,
				     uint16_t *random_chan_freq_list,
				     uint32_t *random_chan_cnt,
				     struct dfs_channel *chan_list,
				     uint32_t chan_cnt, uint8_t dfs_region,
				     struct dfs_acs_info *acs_info)
{
	...
	flag_no_weather = (dfs_region == DFS_ETSI_REGION) ?
				  flags & DFS_RANDOM_CH_FLAG_NO_WEATHER_CH :
				  0;
 ...
 * return: void.
 */
static void dfs_remove_spruce_spur_channels_for_bw_20_40(uint16_t *freq_list,
							 uint8_t freq_count)
{
	uint8_t i;
...
uint16_t dfs_prepare_random_channel_for_freq(struct wlan_dfs *dfs,
					     struct dfs_channel *chan_list,
					     uint32_t chan_cnt, uint32_t flags,
					     ...
					     struct dfs_acs_info *acs_info)
{
	...
	if (!chan_list || !chan_cnt) {
		dfs_info(dfs, WLAN_DEBUG_DFS_RANDOM_CHAN,
			 "Invalid params %pK, chan_cnt=%d", chan_list,
			 chan_cnt);
		return 0;
	}

	if (*chan_wd < DFS_CH_WIDTH_20MHZ || *chan_wd > DFS_CH_WIDTH_320MHZ) {
		dfs_info(dfs, WLAN_DEBUG_DFS_RANDOM_CHAN, "Invalid chan_wd %d",
			 *chan_wd);
		return 0;
	}
	...
	leakage_adjusted_lst =
		qdf_mem_malloc(random_chan_cnt * sizeof(*leakage_adjusted_lst));
	...
	if (flag_no_spur_leakage_adj_chans &&
	    (*chan_wd == DFS_CH_WIDTH_20MHZ || *chan_wd == DFS_CH_WIDTH_40MHZ))
		dfs_remove_spruce_spur_channels_for_bw_20_40(
			random_chan_freq_list, random_chan_cnt);
	do {
		int ret;

		qdf_mem_copy(leakage_adjusted_lst, random_chan_freq_list,
			     random_chan_cnt * sizeof(*leakage_adjusted_lst));
		ret = dfs_mark_leaking_chan_for_freq(
			dfs, *chan_wd, random_chan_cnt, leakage_adjusted_lst);
       ...
       */
			...
			target_freq = dfs_get_rand_from_lst_for_freq(
     ...
     */
		if ((*chan_wd == DFS_CH_WIDTH_80P80MHZ) &&
			...
			wlan_reg_set_channel_params_for_pwrmode(
				dfs->dfs_pdev_obj, target_freq, 0, chan_params,
     ...
     */
		if (flag_no_weather &&
		    (target_freq == DFS_ADJACENT_WEATHER_RADAR_CHANNEL_FREQ) &&
		    (*chan_wd == DFS_CH_WIDTH_40MHZ)) {
			dfs_debug(dfs, WLAN_DEBUG_DFS_RANDOM_CHAN,
