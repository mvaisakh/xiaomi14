...
static struct qmi_elem_info ims_private_service_header_value_v01_ei[] = {
	{
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0,
		.offset = offsetof(struct ims_private_service_header_value_v01,
				   header),
	},
	{
		.data_type = QMI_STRING,
...
struct qmi_elem_info ims_private_service_subscribe_for_indications_req_msg_v01_ei[] = {
	{
...
struct qmi_elem_info ims_private_service_subscribe_for_indications_rsp_msg_v01_ei[] = {
	{
...
struct qmi_elem_info ims_private_service_wfc_call_twt_config_req_msg_v01_ei[] = {
	{
		.data_type = QMI_OPT_FLAG,
		.elem_len = 1,
		.elem_size = sizeof(u8),
...
struct qmi_elem_info ims_private_service_wfc_call_twt_config_rsp_msg_v01_ei[] = {
	{
		.data_type = QMI_STRUCT,
		.elem_len = 1,
		.elem_size = sizeof(struct qmi_response_type_v01),
