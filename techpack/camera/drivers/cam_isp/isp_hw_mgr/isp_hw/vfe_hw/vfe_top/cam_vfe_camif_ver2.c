...
int cam_vfe_camif_dump_timestamps(struct cam_isp_resource_node *rsrc_node,
				  void *cmd_args)
{
	struct cam_vfe_mux_camif_data *camif_priv =
...
static int
cam_vfe_camif_blanking_update(struct cam_isp_resource_node *rsrc_node,
			      void *cmd_args)
{
	struct cam_vfe_mux_camif_data *camif_priv =
		(struct cam_vfe_mux_camif_data *)rsrc_node->res_priv;
