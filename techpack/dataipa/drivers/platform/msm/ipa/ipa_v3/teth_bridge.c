...
static long ipa3_teth_bridge_ioctl(struct file *filp, unsigned int cmd,
				   unsigned long arg)
{
...
int ipa3_teth_bridge_driver_init(void)
{
	...
	ipa3_teth_ctx->dev = device_create(ipa3_teth_ctx->class, NULL,
					   ipa3_teth_ctx->dev_num,
					   ipa3_teth_ctx, TETH_BRIDGE_DRV_NAME);
