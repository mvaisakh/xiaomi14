...
static const char
	*ipahal_pkt_status_exception_to_str[IPAHAL_PKT_STATUS_EXCEPTION_MAX] = {
...
ipa_imm_cmd_construct_dma_task_32b_addr(enum ipahal_imm_cmd_name cmd,
...
static struct ipahal_imm_cmd_pyld *
ipa_imm_cmd_construct_dma_shared_mem(enum ipahal_imm_cmd_name cmd,
				     const void *params, bool is_atomic_ctx)
{
	struct ipahal_imm_cmd_pyld *pyld;
...
static struct ipahal_imm_cmd_pyld *
ipa_imm_cmd_construct_register_write(enum ipahal_imm_cmd_name cmd,
				     const void *params, bool is_atomic_ctx)
{
	struct ipahal_imm_cmd_pyld *pyld;
...
static struct ipahal_imm_cmd_pyld *
ipa_imm_cmd_construct_register_read(enum ipahal_imm_cmd_name cmd,
				    const void *params, bool is_atomic_ctx)
{
	struct ipahal_imm_cmd_pyld *pyld;
...
static struct ipahal_imm_cmd_pyld *
ipa_imm_cmd_construct_ip_packet_init(enum ipahal_imm_cmd_name cmd,
				     const void *params, bool is_atomic_ctx)
{
	struct ipahal_imm_cmd_pyld *pyld;
...
static struct ipahal_imm_cmd_pyld *
ipa_imm_cmd_construct_ip_packet_init_ex(enum ipahal_imm_cmd_name cmd,
					const void *params, bool is_atomic_ctx)
{
	struct ipahal_imm_cmd_pyld *pyld;
...
int ipa_imm_cmd_modify_ip_packet_init_ex(enum ipahal_imm_cmd_name cmd,
					 const void *cmd_data,
					 const void *params,
...
static int ipa_imm_cmd_modify_ip_packet_init_ex_v5_5(
	enum ipahal_imm_cmd_name cmd, const void *cmd_data, const void *params,
	const void *params_mask)
{
	struct ipa_imm_cmd_hw_ip_packet_init_ex_v5_5 *data =
...
inline void
ipa_imm_cmd_modify_ip_packet_init_ex_dest_pipe_v5_5(const void *cmd_data,
						    u64 pipe_dest_idx)
{
	((struct ipa_imm_cmd_hw_ip_packet_init_ex_v5_5 *)cmd_data)
		->rt_pipe_dest_idx = pipe_dest_idx;
}

inline void ipa_imm_cmd_modify_ip_packet_init_ex_dest_pipe(const void *cmd_data,
							   u64 pipe_dest_idx)
{
	if (ipahal_ctx->hw_type >= IPA_HW_v5_5)
		return ipa_imm_cmd_modify_ip_packet_init_ex_dest_pipe_v5_5(
			cmd_data, pipe_dest_idx);
	else
		((struct ipa_imm_cmd_hw_ip_packet_init_ex *)cmd_data)
			->rt_pipe_dest_idx = pipe_dest_idx;
}
...
static struct ipahal_imm_cmd_pyld *
ipa_imm_cmd_construct_nat_dma(enum ipahal_imm_cmd_name cmd, const void *params,
			      bool is_atomic_ctx)
{
	struct ipahal_imm_cmd_pyld *pyld;
...
static struct ipahal_imm_cmd_pyld *
ipa_imm_cmd_construct_table_dma_ipav4(enum ipahal_imm_cmd_name cmd,
				      const void *params, bool is_atomic_ctx)
{
	struct ipahal_imm_cmd_pyld *pyld;
...
static struct ipahal_imm_cmd_pyld *
ipa_imm_cmd_construct_hdr_init_system(enum ipahal_imm_cmd_name cmd,
				      const void *params, bool is_atomic_ctx)
{
	struct ipahal_imm_cmd_pyld *pyld;
...
static struct ipahal_imm_cmd_pyld *
ipa_imm_cmd_construct_hdr_init_local(enum ipahal_imm_cmd_name cmd,
				     const void *params, bool is_atomic_ctx)
{
	struct ipahal_imm_cmd_pyld *pyld;
...
static struct ipahal_imm_cmd_pyld *
ipa_imm_cmd_construct_ip_v6_routing_init(enum ipahal_imm_cmd_name cmd,
					 const void *params, bool is_atomic_ctx)
{
	struct ipahal_imm_cmd_pyld *pyld;
...
static struct ipahal_imm_cmd_pyld *
ipa_imm_cmd_construct_ip_v4_routing_init(enum ipahal_imm_cmd_name cmd,
					 const void *params, bool is_atomic_ctx)
{
	struct ipahal_imm_cmd_pyld *pyld;
...
static struct ipahal_imm_cmd_pyld *
ipa_imm_cmd_construct_ip_v4_nat_init(enum ipahal_imm_cmd_name cmd,
				     const void *params, bool is_atomic_ctx)
{
	struct ipahal_imm_cmd_pyld *pyld;
	...
	data->index_table_addr_type = nat4_params->index_table_addr_shared ? 1 :
									     0;
...
static struct ipahal_imm_cmd_pyld *
ipa_imm_cmd_construct_ip_v6_ct_init(enum ipahal_imm_cmd_name cmd,
				    const void *params, bool is_atomic_ctx)
{
	struct ipahal_imm_cmd_pyld *pyld;
...
static struct ipahal_imm_cmd_pyld *
ipa_imm_cmd_construct_ip_v6_filter_init(enum ipahal_imm_cmd_name cmd,
					const void *params, bool is_atomic_ctx)
{
	struct ipahal_imm_cmd_pyld *pyld;
...
static struct ipahal_imm_cmd_pyld *
ipa_imm_cmd_construct_ip_v4_filter_init(enum ipahal_imm_cmd_name cmd,
					const void *params, bool is_atomic_ctx)
{
	struct ipahal_imm_cmd_pyld *pyld;
...
static struct ipahal_imm_cmd_pyld *
ipa_imm_cmd_construct_dummy(enum ipahal_imm_cmd_name cmd, const void *params,
			    bool is_atomic_ctx)
{
...
static int ipa_imm_cmd_modify_dummy(enum ipahal_imm_cmd_name cmd,
				    const void *cmd_data, const void *params,
				    const void *params_mask)
{
...
struct ipahal_imm_cmd_obj {
	struct ipahal_imm_cmd_pyld *(*construct)(enum ipahal_imm_cmd_name cmd,
						 const void *params,
						 bool is_atomic_ctx);
	int (*modify)(enum ipahal_imm_cmd_name cmd, const void *cmd_data,
		      const void *params, const void *params_mask);
	u16 opcode;
};
 ...
 *  specific version
 */
static struct ipahal_imm_cmd_obj ipahal_imm_cmd_objs[IPA_HW_MAX][IPA_IMM_CMD_MAX] = {
	/* IPAv3 */
	[IPA_HW_v3_0]
		[IPA_IMM_CMD_IP_V4_FILTER_INIT] = { ipa_imm_cmd_construct_ip_v4_filter_init,
						    ipa_imm_cmd_modify_dummy,
						    3 },
	[IPA_HW_v3_0]
		[IPA_IMM_CMD_IP_V6_FILTER_INIT] = { ipa_imm_cmd_construct_ip_v6_filter_init,
						    ipa_imm_cmd_modify_dummy,
						    4 },
	[IPA_HW_v3_0]
		[IPA_IMM_CMD_IP_V4_NAT_INIT] = { ipa_imm_cmd_construct_ip_v4_nat_init,
						 ipa_imm_cmd_modify_dummy, 5 },
	[IPA_HW_v3_0]
		[IPA_IMM_CMD_IP_V4_ROUTING_INIT] = { ipa_imm_cmd_construct_ip_v4_routing_init,
						     ipa_imm_cmd_modify_dummy,
						     7 },
	[IPA_HW_v3_0]
		[IPA_IMM_CMD_IP_V6_ROUTING_INIT] = { ipa_imm_cmd_construct_ip_v6_routing_init,
						     ipa_imm_cmd_modify_dummy,
						     8 },
	[IPA_HW_v3_0]
		[IPA_IMM_CMD_HDR_INIT_LOCAL] = { ipa_imm_cmd_construct_hdr_init_local,
						 ipa_imm_cmd_modify_dummy, 9 },
	[IPA_HW_v3_0]
		[IPA_IMM_CMD_HDR_INIT_SYSTEM] = { ipa_imm_cmd_construct_hdr_init_system,
						  ipa_imm_cmd_modify_dummy,
						  10 },
	[IPA_HW_v3_0]
		[IPA_IMM_CMD_REGISTER_WRITE] = { ipa_imm_cmd_construct_register_write,
						 ipa_imm_cmd_modify_dummy, 12 },
	[IPA_HW_v3_0][IPA_IMM_CMD_NAT_DMA] = { ipa_imm_cmd_construct_nat_dma,
					       ipa_imm_cmd_modify_dummy, 14 },
	[IPA_HW_v3_0]
		[IPA_IMM_CMD_IP_PACKET_INIT] = { ipa_imm_cmd_construct_ip_packet_init,
						 ipa_imm_cmd_modify_dummy, 16 },
	[IPA_HW_v3_0]
		[IPA_IMM_CMD_DMA_TASK_32B_ADDR] = { ipa_imm_cmd_construct_dma_task_32b_addr,
						    ipa_imm_cmd_modify_dummy,
						    17 },
	[IPA_HW_v3_0]
		[IPA_IMM_CMD_DMA_SHARED_MEM] = { ipa_imm_cmd_construct_dma_shared_mem,
						 ipa_imm_cmd_modify_dummy, 19 },
	[IPA_HW_v3_0]
		[IPA_IMM_CMD_IP_PACKET_TAG_STATUS] = { ipa_imm_cmd_construct_ip_packet_tag_status,
						       ipa_imm_cmd_modify_dummy,
						       20 },

	/* IPAv4 */
	[IPA_HW_v4_0]
		[IPA_IMM_CMD_REGISTER_WRITE] = { ipa_imm_cmd_construct_register_write_v_4_0,
						 ipa_imm_cmd_modify_dummy, 12 },
	/* NAT_DMA was renamed to TABLE_DMA for IPAv4 */
	[IPA_HW_v4_0][IPA_IMM_CMD_NAT_DMA] = { ipa_imm_cmd_construct_dummy,
					       ipa_imm_cmd_modify_dummy, -1 },
	[IPA_HW_v4_0]
		[IPA_IMM_CMD_TABLE_DMA] = { ipa_imm_cmd_construct_table_dma_ipav4,
					    ipa_imm_cmd_modify_dummy, 14 },
	[IPA_HW_v4_0]
		[IPA_IMM_CMD_DMA_SHARED_MEM] = { ipa_imm_cmd_construct_dma_shared_mem_v_4_0,
						 ipa_imm_cmd_modify_dummy, 19 },
	[IPA_HW_v4_0]
		[IPA_IMM_CMD_IP_V6_CT_INIT] = { ipa_imm_cmd_construct_ip_v6_ct_init,
						ipa_imm_cmd_modify_dummy, 23 },

	/* IPAv5 */
	[IPA_HW_v5_0]
		[IPA_IMM_CMD_IP_PACKET_INIT] = { ipa_imm_cmd_construct_ip_packet_init_v_5_0,
						 ipa_imm_cmd_modify_dummy, 16 },
	[IPA_HW_v5_0]
		[IPA_IMM_CMD_IP_PACKET_INIT_EX] = { ipa_imm_cmd_construct_ip_packet_init_ex,
						    ipa_imm_cmd_modify_ip_packet_init_ex,
						    18 },

	[IPA_HW_v5_1]
		[IPA_IMM_CMD_REGISTER_READ] = { ipa_imm_cmd_construct_register_read,
						ipa_imm_cmd_modify_dummy, 13 },
	/* IPAv5_5 */
	[IPA_HW_v5_5]
		[IPA_IMM_CMD_IP_PACKET_INIT_EX] = { ipa_imm_cmd_construct_ip_packet_init_ex_v5_5,
 ...
 */
int ipahal_modify_imm_cmd(enum ipahal_imm_cmd_name cmd, const void *cmd_data,
			  const void *params, const void *params_mask)
{
	...
	return ipahal_imm_cmd_objs[ipahal_ctx->hw_type][cmd].modify(
		cmd, cmd_data, params, params_mask);
}
 ...
 */
struct ipahal_imm_cmd_pyld *
ipahal_construct_nop_imm_cmd(bool skip_pipline_clear,
...
#define IPA_PKT_STATUS_SET_MSK(__hw_bit_msk, __shft)                        \
	(status->status_mask |= ((hw_status_mask) & (__hw_bit_msk) ? 1 : 0) \
				<< (__shft))

static enum ipahal_pkt_status_exception
pkt_status_parse_exception(bool is_ipv6, u64 exception)
{
				...
				const void *unparsed_status)
{
	...
	status->exception = pkt_status_parse_exception(
		is_ipv6, hw_status->ipa_pkt.exception);
}
...
static void ipa_pkt_status_parse(const void *unparsed_status,
				 struct ipahal_pkt_status *status);
static void ipa_pkt_status_parse_thin(const void *unparsed_status,
				      struct ipahal_pkt_status_thin *status);
static void
ipa_pkt_status_parse_thin_v5_0(const void *unparsed_status,
			       struct ipahal_pkt_status_thin *status);
static void
ipa_pkt_status_parse_thin_v5_5(const void *unparsed_status,
			       struct ipahal_pkt_status_thin *status);
static void ipa_pkt_status_parse(const void *unparsed_status,
				 struct ipahal_pkt_status *status);
static void ipa_pkt_status_parse_v5_0(const void *unparsed_status,
				      struct ipahal_pkt_status *status);
static void ipa_pkt_status_parse_v5_5(const void *unparsed_status,
				      struct ipahal_pkt_status *status);
/*
...
static inline enum ipahal_pkt_status_opcode
ipa_hw_opcode_to_opcode(const u8 hw_opcode)
{
...
static inline enum ipahal_pkt_status_nat_type
ipa_hw_nat_type_to_nat_type(const enum ipahal_pkt_status_nat_type hw_nat_type)
{
...
static inline void
ipa_set_pkt_status_mask_v5_5(const u16 hw_status_mask,
			     struct ipahal_pkt_status *status)
{
	IPA_PKT_STATUS_SET_MSK(0x1, IPAHAL_PKT_STATUS_MASK_FRAG_PROCESS_SHFT);
	IPA_PKT_STATUS_SET_MSK(0x2, IPAHAL_PKT_STATUS_MASK_FILT_PROCESS_SHFT);
				 ...
				 struct ipahal_pkt_status *status)
{
	...
	if (status->status_opcode == IPAHAL_PKT_STATUS_OPCODE_NEW_FRAG_RULE)
		ipahal_pkt_status_objs[ipahal_ctx->hw_type].__parse_frag_pkt(
			status, unparsed_status);
	else
		ipahal_pkt_status_objs[ipahal_ctx->hw_type].__parse_gen_pkt(
			status, unparsed_status);
				      ...
				      struct ipahal_pkt_status *status)
{
	...
	ipa_set_pkt_status_mask_v5_5((u16)(hw_status->ipa_pkt.status_mask),
				     status);
}
...
static int ipahal_pkt_status_init(enum ipa_hw_type ipa_hw_type)
{
   ...
   */
	BUILD_BUG_ON(sizeof(union ipa_pkt_status_hw) != IPA3_0_PKT_STATUS_SIZE);
...
static int ipahal_cp_proc_ctx_to_hw_buff_v3(
	...
	struct ipa_eth_II_to_eth_II_ex_procparams *generic_params, bool is_64)
{
	u64 hdr_addr;
	...
	if (type == IPA_HDR_PROC_NONE) {
		...
		ctx = (struct ipa_hw_hdr_proc_ctx_add_hdr_seq *)(base + offset);
		...
		ctx->l2tp_params.tlv.type = IPA_PROC_CTX_TLV_TYPE_PROC_CMD;
		ctx->l2tp_params.tlv.length = 1;
		ctx->l2tp_params.tlv.value = IPA_HDR_UCP_L2TP_HEADER_REMOVE;
		...
		if (l2tp_params->hdr_remove_param.eth_hdr_retained) {
			...
			IPAHAL_CP_PROC_CTX_HEADER_UPDATE(
				ctx->hdr_add.hdr_addr, ctx->hdr_add.hdr_addr_hi,
				hdr_addr);
			if (!is_64)
				ctx->hdr_add.hdr_addr_hi = 0;
		} else {
		...
		ctx->l2tp_params.tlv.type = IPA_PROC_CTX_TLV_TYPE_PROC_CMD;
		ctx->l2tp_params.tlv.length = 1;
		ctx->l2tp_params.tlv.value = IPA_HDR_UCP_L2TP_UDP_HEADER_REMOVE;
		ctx->l2tp_params.l2tp_params.hdr_len_remove =
			l2tp_params->hdr_remove_param.hdr_len_remove;
		ctx->l2tp_params.l2tp_params.eth_hdr_retained =
			l2tp_params->hdr_remove_param.eth_hdr_retained;
		...
		ctx = (struct ipa_hw_hdr_proc_ctx_add_hdr_cmd_seq_ex *)(base +
									offset);
		...
		IPAHAL_DBG(
			"eth_hdr_retained %d input_ip_version %d output_ip_version %d "
			"second_pass %d\n",
			eogre_params->hdr_add_param.eth_hdr_retained,
			eogre_params->hdr_add_param.input_ip_version,
			eogre_params->hdr_add_param.output_ip_version,
		...
		ctx = (struct ipa_hw_hdr_proc_ctx_add_hdr_cmd_seq *)(base +
								     offset);
		ctx->hdr_add.tlv.type = IPA_PROC_CTX_TLV_TYPE_HDR_ADD;
		ctx->hdr_add.tlv.length = 2;
		ctx->hdr_add.tlv.value = hdr_len;
...
struct ipahal_hdr_funcs {
	...
	int (*ipahal_cp_proc_ctx_to_hw_buff)(
		enum ipa_hdr_proc_type type, void *const base, u32 offset,
...
{
	IPAHAL_DBG(
		"type %d, base %pK, offset %d, hdr_len %d, hdr_base_addr %llu, "
		"offset_entry %pK, bool %d\n",
		type, base, offset, hdr_len, hdr_base_addr, offset_entry,
		is_64);
	...
	return hdr_funcs.ipahal_cp_proc_ctx_to_hw_buff(
		type, base, offset, hdr_len, hdr_base_addr, offset_entry,
		l2tp_params, eogre_params, generic_params, is_64);
}
		...
		u32 ipa_cfg_offset, struct device *ipa_pdev)
{
	...
	ipahal_ctx->regdumpbuf = ipc_log_context_create(
		IPAHAL_IPC_LOG_PAGES, "ipa_regs", MINIDUMP_MASK);
 ...
 * ***************************************************************
 */
void ipa_qmap_hdr_parse_v4_5(union qmap_hdr_u *qmap_hdr,
			     struct qmap_hdr_data *qmap_data_rslt)
{
	...
	qmap_data_rslt->packet_len_with_pad =
		qmap_hdr->qmap5_0.packet_len_with_pad;
...
void ipa_qmap_hdr_parse_v5_0(union qmap_hdr_u *qmap_hdr,
			     struct qmap_hdr_data *qmap_data_rslt)
{
	qmap_data_rslt->cd = qmap_hdr->qmap5_0.cd;
	qmap_data_rslt->qmap_next_hdr = qmap_hdr->qmap5_0.qmap_next_hdr;
	...
	qmap_data_rslt->zero_checksum = qmap_hdr->qmap5_0.zero_checksum;
	qmap_data_rslt->additional_hdr_size =
		qmap_hdr->qmap5_0.additional_hdr_size;
	qmap_data_rslt->segment_size = qmap_hdr->qmap5_0.segment_size;
}

void ipa_qmap_hdr_parse_v5_5(union qmap_hdr_u *qmap_hdr,
			     struct qmap_hdr_data *qmap_data_rslt)
{
	...
	qmap_data_rslt->packet_len_with_pad =
		ntohs(qmap_hdr->qmap5_5.packet_len_with_pad);
...
struct ipahal_qmap_parse_s {
   ...
   * function.
   */
	void (*parse)(union qmap_hdr_u *qmap_hdr,
		      struct qmap_hdr_data *qmap_data_rslt);
};
...
static struct ipahal_qmap_parse_s ipahal_qmap_parse_tbl[IPA_HW_MAX] = {
	/* IPAv4.5 */
	[IPA_HW_v4_5] = { ipa_qmap_hdr_parse_v4_5 },
	/* IPAv5.0 */
	[IPA_HW_v5_0] = { ipa_qmap_hdr_parse_v5_0 },
	/* IPAv5.5 */
	[IPA_HW_v5_5] = { ipa_qmap_hdr_parse_v5_5 },
};
...
static int ipahal_qmap_init(enum ipa_hw_type ipa_hw_type)
{
	...
	for (i = IPA_HW_v4_5; i < (IPA_HW_MAX - 1); i++) {
		if (memcmp(&ipahal_qmap_parse_tbl[i + 1], &zero_obj,
			   sizeof(struct ipahal_qmap_parse_s)) == 0) {
			memcpy(&ipahal_qmap_parse_tbl[i + 1],
 ...
 */
int ipahal_qmap_parse(const void *unparsed_qmap,
		      struct qmap_hdr_data *qmap_data_rslt)
{
	...
	if (ipahal_ctx->hw_type < IPA_HW_v4_5) {
		IPAHAL_ERR("Unsupported qmap parse for IPA HW type (%d)\n",
			   ipahal_ctx->hw_type);
		return -EINVAL;
	}
	...
	ipahal_qmap_parse_tbl[ipahal_ctx->hw_type].parse(&qmap_hdr,
							 qmap_data_rslt);
