...
struct elem_info wcd_spi_req_access_msg_v01_ei[] = {
	...
	},
	{
		...
		.is_array = NO_ARRAY,
		.tlv_type = 0x10,
		.offset = offsetof(struct wcd_spi_req_access_msg_v01, reason),
	},
	{
		.data_type = QMI_EOTI,
		.is_array = NO_ARRAY,
...
struct elem_info wcd_spi_req_access_resp_v01_ei[] = {
	{
		...
		.is_array = NO_ARRAY,
		.tlv_type = 0x02,
		.offset = offsetof(struct wcd_spi_req_access_resp_v01, resp),
...
struct elem_info wcd_spi_rel_access_resp_v01_ei[] = {
	{
		...
		.is_array = NO_ARRAY,
		.tlv_type = 0x02,
		.offset = offsetof(struct wcd_spi_rel_access_resp_v01, resp),
		.ei_array = get_qmi_response_type_v01_ei(),
	},
	{
		.data_type = QMI_EOTI,
...
struct elem_info wcd_spi_buff_msg_v01_ei[] = {
	{
		...
		.tlv_type = 0x01,
		.offset = offsetof(struct wcd_spi_buff_msg_v01, buff_addr_1),
	},
	{
		.data_type = QMI_OPT_FLAG,
		.elem_len = 1,
	...
	},
	{
		...
		.is_array = STATIC_ARRAY,
		.tlv_type = 0x10,
		.offset = offsetof(struct wcd_spi_buff_msg_v01, buff_addr_2),
	},
	{
		.data_type = QMI_EOTI,
		.is_array = NO_ARRAY,
...
struct elem_info wcd_spi_buff_resp_v01_ei[] = {
	{
		...
		.is_array = NO_ARRAY,
		.tlv_type = 0x02,
		.offset = offsetof(struct wcd_spi_buff_resp_v01, resp),
		.ei_array = get_qmi_response_type_v01_ei(),
	},
	{
		.data_type = QMI_EOTI,
