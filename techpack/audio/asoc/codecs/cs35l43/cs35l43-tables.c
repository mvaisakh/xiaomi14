...
bool cs35l43_readable_reg(struct device *dev, unsigned int reg)
{
	...
	case CS35L43_DSP1_XMEM_UNPACKED32_0 ... CS35L43_DSP1_XMEM_UNPACKED32_4095:
	case CS35L43_DSP1_XMEM_UNPACKED24_0 ... CS35L43_DSP1_XMEM_UNPACKED24_8191:
	case CS35L43_DSP1_XROM_UNPACKED24_0 ... CS35L43_DSP1_XROM_UNPACKED24_6141:
	case CS35L43_DSP1_YMEM_PACKED_0 ... CS35L43_DSP1_YMEM_PACKED_1532:
	case CS35L43_DSP1_YMEM_UNPACKED32_0 ... CS35L43_DSP1_YMEM_UNPACKED32_1022:
	case CS35L43_DSP1_YMEM_UNPACKED24_0 ... CS35L43_DSP1_YMEM_UNPACKED24_2045:
...
const struct cs35l43_fs_mon_config cs35l43_fs_mon[7] = {
	{ 705600, 154, 244 }, { 768000, 141, 224 }, { 1411200, 77, 125 },
	{ 1536000, 71, 115 }, { 2822400, 39, 65 },  { 3072000, 36, 60 },
	{ 5644800, 20, 35 },
};
...
const u8 cs35l43_write_seq_op_sizes[CS35L43_POWER_SEQ_NUM_OPS][2] = {
	...
	{ CS35L43_POWER_SEQ_OP_DELAY, CS35L43_POWER_SEQ_OP_DELAY_WORDS },
	{ CS35L43_POWER_SEQ_OP_END, CS35L43_POWER_SEQ_OP_END_WORDS },
};

const struct dev_pm_ops cs35l43_pm_ops = { SET_RUNTIME_PM_OPS(
	cs35l43_suspend_runtime, cs35l43_resume_runtime, NULL) };
