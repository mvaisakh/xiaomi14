...
static struct wcd_mbhc_register wcd_mbhc_registers[WCD_MBHC_REG_FUNC_MAX] = {
	WCD_MBHC_REGISTER("WCD_MBHC_L_DET_EN", WCD938X_ANA_MBHC_MECH, 0x80, 7,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_GND_DET_EN", WCD938X_ANA_MBHC_MECH, 0x40, 6,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_MECH_DETECTION_TYPE", WCD938X_ANA_MBHC_MECH,
			  0x20, 5, 0),
	...
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_PLUG_TYPE", WCD938X_ANA_MBHC_MECH,
			  0x10, 4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_GND_PLUG_TYPE", WCD938X_ANA_MBHC_MECH, 0x08,
			  3, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_SW_HPH_LP_100K_TO_GND",
			  WCD938X_ANA_MBHC_MECH, 0x01, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ELECT_SCHMT_ISRC", WCD938X_ANA_MBHC_ELECT,
			  0x06, 1, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_FSM_EN", WCD938X_ANA_MBHC_ELECT, 0x80, 7,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_INSREM_DBNC",
			  WCD938X_MBHC_NEW_PLUG_DETECT_CTL, 0x0F, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_BTN_DBNC", WCD938X_MBHC_NEW_CTL_1, 0x03, 0,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_HS_VREF", WCD938X_MBHC_NEW_CTL_2, 0x03, 0,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_HS_COMP_RESULT", WCD938X_ANA_MBHC_RESULT_3,
			  0x08, 3, 0),
	...
	WCD_MBHC_REGISTER("WCD_MBHC_OCP_FSM_EN", WCD938X_HPH_OCP_CTL, 0x10, 4,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_BTN_RESULT", WCD938X_ANA_MBHC_RESULT_3,
			  0x07, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_BTN_ISRC_CTL", WCD938X_ANA_MBHC_ELECT, 0x70,
			  4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ELECT_RESULT", WCD938X_ANA_MBHC_RESULT_3,
			  0xFF, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_MICB_CTRL", WCD938X_ANA_MICB2, 0xC0, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPH_CNP_WG_TIME", WCD938X_HPH_CNP_WG_TIME,
			  0xFF, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHR_PA_EN", WCD938X_ANA_HPH, 0x40, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_PA_EN", WCD938X_ANA_HPH, 0x80, 7, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPH_PA_EN", WCD938X_ANA_HPH, 0xC0, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_SWCH_LEVEL_REMOVE",
			  WCD938X_ANA_MBHC_RESULT_3, 0x10, 4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_PULLDOWN_CTRL", 0, 0, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ANC_DET_EN", WCD938X_MBHC_CTL_BCS, 0x02, 1,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_FSM_STATUS", WCD938X_MBHC_NEW_FSM_STATUS,
			  0x01, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_MUX_CTL", WCD938X_MBHC_NEW_CTL_2, 0x70, 4,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_MOISTURE_STATUS",
			  WCD938X_MBHC_NEW_FSM_STATUS, 0x20, 5, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHR_GND", WCD938X_HPH_PA_CTL2, 0x40, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_GND", WCD938X_HPH_PA_CTL2, 0x10, 4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_OCP_DET_EN", WCD938X_HPH_L_TEST, 0x01,
			  0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHR_OCP_DET_EN", WCD938X_HPH_R_TEST, 0x01,
			  0, 0),
	...
	WCD_MBHC_REGISTER("WCD_MBHC_ADC_EN", WCD938X_MBHC_NEW_CTL_1, 0x08, 3,
			  0),
	...
	WCD_MBHC_REGISTER("WCD_MBHC_ADC_MODE", WCD938X_MBHC_NEW_CTL_1, 0x10, 4,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_DETECTION_DONE", WCD938X_MBHC_NEW_CTL_1,
			  0x04, 2, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ELECT_ISRC_EN", WCD938X_ANA_MBHC_ZDET, 0x02,
			  1, 0),
};
...
static int wcd938x_mbhc_free_irq(struct snd_soc_component *component, int irq,
				 void *data)
{
	struct wcd938x_priv *wcd938x = dev_get_drvdata(component->dev);
...
{
	return snd_soc_component_read(component, WCD938X_ANA_MBHC_RESULT_3) &
	       0x7;
}
					 ...
					 int num_btn, bool is_micbias)
{
	...
	for (i = 0; i < num_btn; i++) {
		...
		snd_soc_component_update_bits(
			component, WCD938X_ANA_MBHC_BTN0 + i, 0xFC, vth << 2);
...
static void
wcd938x_mbhc_hph_l_pull_up_control(struct snd_soc_component *component,
				   int pull_up_cur)
{
...
static int
wcd938x_mbhc_micb_ctrl_threshold_mic(struct snd_soc_component *component,
...
ramp_down:
	i = 0;
	while (x1) {
		regmap_read(wcd938x->regmap, WCD938X_ANA_MBHC_RESULT_1, &val);
		regmap_read(wcd938x->regmap, WCD938X_ANA_MBHC_RESULT_2, &val1);
		val = val << 0x08;
		val |= val1;
		x1 = WCD938X_MBHC_GET_X1(val);
		i++;
				   ...
				   int32_t *zl, int32_t *zr, s16 *d1_a)
{
	...
	regmap_update_bits(wcd938x->regmap, WCD938X_ANA_MBHC_ZDET, 0x80, 0x80);
	dev_dbg(wcd938x->dev, "%s: ramp for HPH_L, noff = %d\n", __func__,
		zdet_param->noff);
	wcd938x_mbhc_get_result_params(wcd938x, d1_a, zdet_param->noff, &zdet);
	regmap_update_bits(wcd938x->regmap, WCD938X_ANA_MBHC_ZDET, 0x80, 0x00);
...
z_right:
	...
	regmap_update_bits(wcd938x->regmap, WCD938X_ANA_MBHC_ZDET, 0x40, 0x40);
	dev_dbg(wcd938x->dev, "%s: ramp for HPH_R, noff = %d\n", __func__,
		zdet_param->noff);
	wcd938x_mbhc_get_result_params(wcd938x, d1_a, zdet_param->noff, &zdet);
	regmap_update_bits(wcd938x->regmap, WCD938X_ANA_MBHC_ZDET, 0x40, 0x00);

	*zr = zdet;
}

static inline void
wcd938x_wcd_mbhc_qfuse_cal(struct snd_soc_component *component, int32_t *z_val,
			   int flag_l_r)
{
	s16 q1;
	int q1_cal;
					    ...
					    uint32_t *zr)
{
	...
	if (snd_soc_component_read(component, WCD938X_ANA_MBHC_ELECT) & 0x80) {
		is_fsm_disable = true;
		regmap_update_bits(wcd938x->regmap, WCD938X_ANA_MBHC_ELECT,
				   0x80, 0x00);
	}

	/* For NO-jack, disable L_DET_EN before Z-det measurements */
	if (mbhc->hphl_swh)
		regmap_update_bits(wcd938x->regmap, WCD938X_ANA_MBHC_MECH, 0x80,
				   0x00);

	/* Turn off 100k pull down on HPHL */
	regmap_update_bits(wcd938x->regmap, WCD938X_ANA_MBHC_MECH, 0x01, 0x00);

	/* Disable surge protection before impedance detection.
   * This is done to give correct value for high impedance.
   */
	regmap_update_bits(wcd938x->regmap, WCD938X_HPH_SURGE_HPHLR_SURGE_EN,
			   0xC0, 0x00);
...
left_ch_impedance:
	...
	if (WCD938X_MBHC_IS_SECOND_RAMP_REQUIRED(z1R)) {
		...
		wcd938x_mbhc_zdet_ramp(component, zdet_param_ptr, NULL, &z1R,
				       d1);
	}
right_ch_impedance:
	...
	snd_soc_component_update_bits(component, WCD938X_HPH_R_ATEST, 0x02,
				      0x02);
	snd_soc_component_update_bits(component, WCD938X_HPH_PA_CTL2, 0x40,
				      0x01);
	if (*zl < (WCD938X_ZDET_VAL_32 / 1000))
		wcd938x_mbhc_zdet_ramp(component, &zdet_param[0], &z1Ls, NULL,
				       d1);
	else
		wcd938x_mbhc_zdet_ramp(component, &zdet_param[1], &z1Ls, NULL,
				       d1);
	snd_soc_component_update_bits(component, WCD938X_HPH_PA_CTL2, 0x40,
				      0x00);
	snd_soc_component_update_bits(component, WCD938X_HPH_R_ATEST, 0x02,
...
zdet_complete:
	...
	regmap_update_bits(wcd938x->regmap, WCD938X_ANA_MBHC_MECH, 0x01, 0x01);
...
static void wcd938x_mbhc_moisture_config(struct wcd_mbhc *mbhc)
{
	...
	snd_soc_component_update_bits(component, WCD938X_MBHC_NEW_CTL_2, 0x0C,
				      mbhc->moist_rref << 2);
}
					       ...
					       bool enable)
{
	...
	snd_soc_component_update_bits(
		component, WCD938X_MBHC_NEW_INT_MOISTURE_DET_POLLING_CTRL, 0x04,
		(enable << 2));
}

static void wcd938x_mbhc_bcs_enable(struct wcd_mbhc *mbhc, bool bcs_enable)
{
	if (bcs_enable)
...
static const struct snd_kcontrol_new hph_type_detect_controls[] = {
	SOC_SINGLE_EXT("HPH Type", 0, 0, UINT_MAX, 0, wcd938x_get_hph_type,
		       NULL),
};
 ...
 */
int wcd938x_mbhc_get_impedance(struct wcd938x_mbhc *wcd938x_mbhc, uint32_t *zl,
			       uint32_t *zr)
{
	if (!wcd938x_mbhc) {
			       ...
			       struct snd_soc_component *component)
{
	...
	snd_soc_component_update_bits(component, WCD938X_ANA_MBHC_MECH, 0x20,
				      0x20);
