...
static struct wcd_mbhc_register wcd_mbhc_registers[WCD_MBHC_REG_FUNC_MAX] = {
	WCD_MBHC_REGISTER("WCD_MBHC_L_DET_EN", ROULEUR_ANA_MBHC_MECH, 0x80, 7,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_GND_DET_EN", ROULEUR_ANA_MBHC_MECH, 0x40, 6,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_MECH_DETECTION_TYPE", ROULEUR_ANA_MBHC_MECH,
			  0x20, 5, 0),
	...
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_PLUG_TYPE", ROULEUR_ANA_MBHC_MECH,
			  0x10, 4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_GND_PLUG_TYPE", ROULEUR_ANA_MBHC_MECH, 0x08,
			  3, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_SW_HPH_LP_100K_TO_GND",
			  ROULEUR_ANA_MBHC_MECH, 0x01, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ELECT_SCHMT_ISRC", ROULEUR_ANA_MBHC_ELECT,
			  0x06, 1, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_FSM_EN", ROULEUR_ANA_MBHC_ELECT, 0x80, 7,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_INSREM_DBNC",
			  ROULEUR_ANA_MBHC_PLUG_DETECT_CTL, 0x0F, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_BTN_DBNC", ROULEUR_ANA_MBHC_CTL_1, 0x03, 0,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_HS_VREF", ROULEUR_ANA_MBHC_CTL_2, 0x03, 0,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_HS_COMP_RESULT", ROULEUR_ANA_MBHC_RESULT_3,
			  0x08, 3, 0),
	...
	WCD_MBHC_REGISTER("WCD_MBHC_OCP_FSM_EN", SND_SOC_NOPM, 0x00, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_BTN_RESULT", ROULEUR_ANA_MBHC_RESULT_3,
			  0x07, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_BTN_ISRC_CTL", ROULEUR_ANA_MBHC_ELECT, 0x70,
			  4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ELECT_RESULT", ROULEUR_ANA_MBHC_RESULT_3,
			  0xFF, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_MICB_CTRL", ROULEUR_ANA_MICBIAS_MICB_1_2_EN,
			  0x06, 1, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPH_CNP_WG_TIME", SND_SOC_NOPM, 0x00, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHR_PA_EN", ROULEUR_ANA_HPHPA_CNP_CTL_2,
			  0x40, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_PA_EN", ROULEUR_ANA_HPHPA_CNP_CTL_2,
			  0x80, 7, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPH_PA_EN", ROULEUR_ANA_HPHPA_CNP_CTL_2,
			  0xC0, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_SWCH_LEVEL_REMOVE",
			  ROULEUR_ANA_MBHC_RESULT_3, 0x10, 4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_PULLDOWN_CTRL", 0, 0, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ANC_DET_EN", SND_SOC_NOPM, 0x00, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_FSM_STATUS", ROULEUR_ANA_MBHC_FSM_STATUS,
			  0x01, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_MUX_CTL", ROULEUR_ANA_MBHC_CTL_2, 0x70, 4,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_MOISTURE_STATUS",
			  ROULEUR_ANA_MBHC_FSM_STATUS, 0x20, 5, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHR_GND", SND_SOC_NOPM, 0x00, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_GND", SND_SOC_NOPM, 0x00, 0, 0),
	...
	WCD_MBHC_REGISTER("WCD_MBHC_ADC_EN", ROULEUR_ANA_MBHC_CTL_1, 0x08, 3,
			  0),
	...
	WCD_MBHC_REGISTER("WCD_MBHC_ADC_MODE", ROULEUR_ANA_MBHC_CTL_1, 0x10, 4,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_DETECTION_DONE", ROULEUR_ANA_MBHC_CTL_1,
			  0x04, 2, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ELECT_ISRC_EN", ROULEUR_ANA_MBHC_ZDET, 0x02,
			  1, 0),
};
...
static int rouleur_mbhc_free_irq(struct snd_soc_component *component, int irq,
				 void *data)
{
	struct rouleur_priv *rouleur = dev_get_drvdata(component->dev);
					 ...
					 int num_btn, bool is_micbias)
{
	...
	for (i = 0; i < num_btn; i++) {
		...
		snd_soc_component_update_bits(
			component, ROULEUR_ANA_MBHC_BTN0_ZDET_VREF1 + i, 0xFC,
			vth << 2);
...
static bool rouleur_mbhc_micb_en_status(struct wcd_mbhc *mbhc, int micb_num)
{
	...
	if (micb_num == MIC_BIAS_2) {
		val = ((snd_soc_component_read32(
				mbhc->component,
				ROULEUR_ANA_MICBIAS_MICB_1_2_EN) &
			0x04) >>
		       2);
		if (val == 0x01)
			return true;
...
static void
rouleur_mbhc_hph_l_pull_up_control(struct snd_soc_component *component,
				   int pull_up_cur)
{
	...
	snd_soc_component_update_bits(component,
				      ROULEUR_ANA_MBHC_PLUG_DETECT_CTL, 0xC0,
				      pull_up_cur << 6);
}
					   ...
					   bool enable)
{
	if (enable) {
		snd_soc_component_update_bits(
			component, ROULEUR_ANA_MBHC_MICB2_RAMP, 0x1C, 0x0C);
		snd_soc_component_update_bits(
			component, ROULEUR_ANA_MBHC_MICB2_RAMP, 0x80, 0x80);
	} else {
		snd_soc_component_update_bits(
			component, ROULEUR_ANA_MBHC_MICB2_RAMP, 0x80, 0x00);
		snd_soc_component_update_bits(
			component, ROULEUR_ANA_MBHC_MICB2_RAMP, 0x1C, 0x00);
	}
}
...
static int
rouleur_mbhc_micb_ctrl_threshold_mic(struct snd_soc_component *component,
					   ...
					   int32_t *zdet)
{
	...
	if (!(zcode & 0x80)) {
		dev_dbg(rouleur->dev,
			...
			__func__, zcode);
		regmap_update_bits(rouleur->regmap, ROULEUR_ANA_MBHC_ZDET, 0x20,
				   0x00);
		return;
	}
	zcode = zcode << 0x8;
	...
	dev_dbg(rouleur->dev, "%s: zcode: %d, zcode1: %d\n", __func__, zcode,
		zcode1);

	/* Calculate calibration coefficient */
	zdet_cal_result =
		(snd_soc_component_read32(component,
					  ROULEUR_ANA_MBHC_ZDET_CALIB_RESULT)) &
		0x1F;
	zdet_cal_coeff =
		ROULEUR_ZDET_C1 /
	...
	dev_dbg(rouleur->dev, "%s: num: %d, denom: %d\n", __func__, num, denom);
	if (denom > 0)
				    ...
				    int32_t *zl, int32_t *zr)
{
	...
	regmap_update_bits(rouleur->regmap, ROULEUR_ANA_HPHPA_CNP_CTL_2, 0x30,
			   0x00);
	/* Averaging enable for reliable results */
	regmap_update_bits(rouleur->regmap, ROULEUR_ANA_MBHC_ZDET_ANA_CTL, 0x80,
			   0x80);
	/* ZDET left measurement enable */
	regmap_update_bits(rouleur->regmap, ROULEUR_ANA_MBHC_ZDET, 0x80, 0x80);
	/* Calculate the left Rload result */
	rouleur_mbhc_get_result_params(rouleur, component, &zdet);

	regmap_update_bits(rouleur->regmap, ROULEUR_ANA_MBHC_ZDET, 0x80, 0x00);
	regmap_update_bits(rouleur->regmap, ROULEUR_ANA_MBHC_ZDET_ANA_CTL, 0x80,
			   0x00);
	regmap_update_bits(rouleur->regmap, ROULEUR_ANA_HPHPA_CNP_CTL_2, 0x30,
			   0x20);
...
z_right:
	...
	regmap_update_bits(rouleur->regmap, ROULEUR_ANA_HPHPA_CNP_CTL_2, 0x0C,
			   0x00);
	/* Averaging enable for reliable results */
	regmap_update_bits(rouleur->regmap, ROULEUR_ANA_MBHC_ZDET_ANA_CTL, 0x80,
			   0x80);
	/* ZDET right measurement enable */
	regmap_update_bits(rouleur->regmap, ROULEUR_ANA_MBHC_ZDET, 0x40, 0x40);

	/* Calculate the right Rload result */
	rouleur_mbhc_get_result_params(rouleur, component, &zdet);

	regmap_update_bits(rouleur->regmap, ROULEUR_ANA_MBHC_ZDET, 0x40, 0x00);
	regmap_update_bits(rouleur->regmap, ROULEUR_ANA_MBHC_ZDET_ANA_CTL, 0x80,
			   0x00);
	regmap_update_bits(rouleur->regmap, ROULEUR_ANA_HPHPA_CNP_CTL_2, 0x0C,
			   0x08);
...
static void rouleur_mbhc_impedance_fn(struct snd_soc_component *component,
				      int32_t *z1L, int32_t *z1R, int32_t *zl,
				      int32_t *zr)
{
	int i;
					    ...
					    uint32_t *zr)
{
	...
	if (reg0 & 0x80) {
		is_fsm_disable = true;
		regmap_update_bits(rouleur->regmap, ROULEUR_ANA_MBHC_ELECT,
				   0x80, 0x00);
	}
	...
	/* Enable RCO clock */
	snd_soc_component_update_bits(component, ROULEUR_ANA_MBHC_CTL_1, 0x80,
				      0x80);

	/* For NO-jack, disable L_DET_EN before Z-det measurements */
	if (mbhc->hphl_swh)
		regmap_update_bits(rouleur->regmap, ROULEUR_ANA_MBHC_MECH, 0x80,
				   0x00);

	/* Turn off 100k pull down on HPHL */
	regmap_update_bits(rouleur->regmap, ROULEUR_ANA_MBHC_MECH, 0x01, 0x00);
...
zdet_complete:
	...
	regmap_update_bits(rouleur->regmap, ROULEUR_ANA_SURGE_EN, 0xC0, 0xC0);
	/* Turn on 100k pull down on HPHL */
	regmap_update_bits(rouleur->regmap, ROULEUR_ANA_MBHC_MECH, 0x01, 0x01);
					    ...
					    bool enable)
{
	if (enable) {
		snd_soc_component_update_bits(
			component, ROULEUR_ANA_HPHPA_CNP_CTL_2, 0x30, 0x20);
		snd_soc_component_update_bits(
			component, ROULEUR_ANA_HPHPA_CNP_CTL_2, 0x0C, 0x08);
	} else {
		snd_soc_component_update_bits(
			component, ROULEUR_ANA_HPHPA_CNP_CTL_2, 0x30, 0x00);
		snd_soc_component_update_bits(
			component, ROULEUR_ANA_HPHPA_CNP_CTL_2, 0x0C, 0x00);
	}
}
...
static void rouleur_mbhc_moisture_config(struct wcd_mbhc *mbhc)
{
	...
	snd_soc_component_update_bits(component, ROULEUR_ANA_MBHC_CTL_2, 0x0C,
				      mbhc->moist_rref << 2);
}
...
static void rouleur_mbhc_bcs_enable(struct wcd_mbhc *mbhc, bool bcs_enable)
{
	if (bcs_enable)
					       ...
					       bool az_enable)
{
	if (az_enable)
		snd_soc_component_update_bits(
			mbhc->component, ROULEUR_ANA_MBHC_CTL_CLK, 0x08, 0x08);
	else
		snd_soc_component_update_bits(
			mbhc->component, ROULEUR_ANA_MBHC_CTL_CLK, 0x08, 0x00);
}

static void rouleur_mbhc_surge_control(struct wcd_mbhc *mbhc, bool surge_enable)
{
	if (surge_enable)
...
static const struct snd_kcontrol_new hph_type_detect_controls[] = {
	SOC_SINGLE_EXT("HPH Type", 0, 0, UINT_MAX, 0, rouleur_get_hph_type,
		       NULL),
};
 ...
 */
int rouleur_mbhc_get_impedance(struct rouleur_mbhc *rouleur_mbhc, uint32_t *zl,
			       uint32_t *zr)
{
	if (!rouleur_mbhc) {
			       ...
			       struct snd_soc_component *component)
{
	...
	snd_soc_component_update_bits(component, ROULEUR_ANA_MBHC_MECH, 0x20,
				      0x20);
