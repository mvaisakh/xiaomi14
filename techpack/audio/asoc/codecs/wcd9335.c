...
#define WCD9335_MIX_RATES_MASK \
	(SNDRV_PCM_RATE_48000 | SNDRV_PCM_RATE_96000 | SNDRV_PCM_RATE_192000)

#define TASHA_FORMATS_S16_S24_LE                             \
	(SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S24_LE | \
	 SNDRV_PCM_FMTBIT_S24_3LE)

#define TASHA_FORMATS_S16_S24_S32_LE                         \
	(SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S24_LE | \
...
#define TASHA_CPE_FATAL_IRQS \
	(TASHA_CPE_SS_ERR_STATUS_WDOG_BITE | TASHA_CPE_SS_ERR_STATUS_MEM_ACCESS)
...
static char on_demand_supply_name[][MAX_ON_DEMAND_SUPPLY_NAME_LENGTH] = {
	"cdc-vdd-mic-bias", "cdc-vdd-tx-h", "cdc-vdd-rx-h"
};
...
static struct afe_param_cdc_reg_cfg audio_reg_cfg[] = {
	{ 1, (TASHA_REGISTER_START_OFFSET + WCD9335_SOC_MAD_MAIN_CTL_1),
	  HW_MAD_AUDIO_ENABLE, 0x1, WCD9335_REG_BITS, 0 },
	{ 1, (TASHA_REGISTER_START_OFFSET + WCD9335_SOC_MAD_AUDIO_CTL_3),
	  HW_MAD_AUDIO_SLEEP_TIME, 0xF, WCD9335_REG_BITS, 0 },
	{ 1, (TASHA_REGISTER_START_OFFSET + WCD9335_SOC_MAD_AUDIO_CTL_4),
	  HW_MAD_TX_AUDIO_SWITCH_OFF, 0x1, WCD9335_REG_BITS, 0 },
	{ 1, (TASHA_REGISTER_START_OFFSET + WCD9335_INTR_CFG),
	  MAD_AUDIO_INT_DEST_SELECT_REG, 0x2, WCD9335_REG_BITS, 0 },
	{ 1, (TASHA_REGISTER_START_OFFSET + WCD9335_INTR_PIN2_MASK3),
	  MAD_AUDIO_INT_MASK_REG, 0x1, WCD9335_REG_BITS, 0 },
	{ 1, (TASHA_REGISTER_START_OFFSET + WCD9335_INTR_PIN2_STATUS3),
	  MAD_AUDIO_INT_STATUS_REG, 0x1, WCD9335_REG_BITS, 0 },
	{ 1, (TASHA_REGISTER_START_OFFSET + WCD9335_INTR_PIN2_CLEAR3),
...
#define IS_VALID_NATIVE_FIFO_PORT(inp) \
	((inp >= INTn_1_MIX_INP_SEL_RX0) && (inp <= INTn_1_MIX_INP_SEL_RX3))
...
static const struct wcd9xxx_ch tasha_tx_chs[TASHA_TX_MAX] = {
	WCD9XXX_CH(0, 0),   WCD9XXX_CH(1, 1),	WCD9XXX_CH(2, 2),
	WCD9XXX_CH(3, 3),   WCD9XXX_CH(4, 4),	WCD9XXX_CH(5, 5),
	WCD9XXX_CH(6, 6),   WCD9XXX_CH(7, 7),	WCD9XXX_CH(8, 8),
	WCD9XXX_CH(9, 9),   WCD9XXX_CH(10, 10), WCD9XXX_CH(11, 11),
	WCD9XXX_CH(12, 12), WCD9XXX_CH(13, 13), WCD9XXX_CH(14, 14),
	WCD9XXX_CH(15, 15),
};
...
static struct wcd_mbhc_register wcd_mbhc_registers[WCD_MBHC_REG_FUNC_MAX] = {
	WCD_MBHC_REGISTER("WCD_MBHC_L_DET_EN", WCD9335_ANA_MBHC_MECH, 0x80, 7,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_GND_DET_EN", WCD9335_ANA_MBHC_MECH, 0x40, 6,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_MECH_DETECTION_TYPE", WCD9335_ANA_MBHC_MECH,
			  0x20, 5, 0),
	...
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_PLUG_TYPE", WCD9335_ANA_MBHC_MECH,
			  0x10, 4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_GND_PLUG_TYPE", WCD9335_ANA_MBHC_MECH, 0x08,
			  3, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_SW_HPH_LP_100K_TO_GND",
			  WCD9335_ANA_MBHC_MECH, 0x01, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ELECT_SCHMT_ISRC", WCD9335_ANA_MBHC_ELECT,
			  0x06, 1, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_FSM_EN", WCD9335_ANA_MBHC_ELECT, 0x80, 7,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_INSREM_DBNC", WCD9335_MBHC_PLUG_DETECT_CTL,
			  0x0F, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_BTN_DBNC", WCD9335_MBHC_CTL_1, 0x03, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HS_VREF", WCD9335_MBHC_CTL_2, 0x03, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HS_COMP_RESULT", WCD9335_ANA_MBHC_RESULT_3,
			  0x08, 3, 0),
	...
	WCD_MBHC_REGISTER("WCD_MBHC_OCP_FSM_EN", WCD9335_HPH_OCP_CTL, 0x10, 4,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_BTN_RESULT", WCD9335_ANA_MBHC_RESULT_3,
			  0x07, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_BTN_ISRC_CTL", WCD9335_ANA_MBHC_ELECT, 0x70,
			  4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ELECT_RESULT", WCD9335_ANA_MBHC_RESULT_3,
			  0xFF, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_MICB_CTRL", WCD9335_ANA_MICB2, 0xC0, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPH_CNP_WG_TIME", WCD9335_HPH_CNP_WG_TIME,
			  0xFF, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHR_PA_EN", WCD9335_ANA_HPH, 0x40, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_PA_EN", WCD9335_ANA_HPH, 0x80, 7, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPH_PA_EN", WCD9335_ANA_HPH, 0xC0, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_SWCH_LEVEL_REMOVE",
			  WCD9335_ANA_MBHC_RESULT_3, 0x10, 4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_PULLDOWN_CTRL", 0, 0, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ANC_DET_EN", WCD9335_ANA_MBHC_ZDET, 0x01, 0,
			  0),
	/*
	...
	WCD_MBHC_REGISTER("WCD_MBHC_MUX_CTL", WCD9335_MBHC_CTL_2, 0x70, 4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_MOISTURE_STATUS", WCD9335_MBHC_FSM_STATUS,
			  0X20, 5, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHR_GND", WCD9335_HPH_PA_CTL2, 0x40, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_GND", WCD9335_HPH_PA_CTL2, 0x10, 4, 0),
};
...
struct tasha_priv {
   ...
   */
	...
	struct platform_device *pdev_child_devices[WCD9335_CHILD_DEVICES_MAX];
	int child_count;
};
...
static void tasha_enable_sido_buck(struct snd_soc_component *component)
{
	...
	snd_soc_component_update_bits(component, WCD9335_ANA_BUCK_CTL, 0x02,
				      0x02);
	/* 100us sleep needed after IREF settings */
	usleep_range(100, 110);
	snd_soc_component_update_bits(component, WCD9335_ANA_BUCK_CTL, 0x04,
				      0x04);
...
static void tasha_cdc_sido_ccl_enable(struct tasha_priv *tasha, bool ccl_flag)
{
	...
	dev_dbg(component->dev, "%s: sido_ccl_cnt=%d, ccl_flag:%d\n", __func__,
		tasha->sido_ccl_cnt, ccl_flag);
	if (ccl_flag) {
		if (++tasha->sido_ccl_cnt == 1)
			snd_soc_component_update_bits(component,
						      WCD9335_SIDO_SIDO_CCL_10,
						      0xFF, 0x6E);
	} else {
		if (tasha->sido_ccl_cnt == 0) {
			dev_dbg(component->dev,
				"%s: sido_ccl already disabled\n", __func__);
			return;
		}
		if (--tasha->sido_ccl_cnt == 0)
			snd_soc_component_update_bits(component,
...
{
	if (TASHA_IS_2_0(tasha->wcd9xxx) && svs_scaling_enabled)
		return true;

	return false;
}

static int tasha_cdc_req_mclk_enable(struct tasha_priv *tasha, bool enable)
{
	int ret = 0;
...
static void tasha_codec_apply_sido_voltage(struct tasha_priv *tasha,
					   enum tasha_sido_voltage req_mv)
{
	...
	snd_soc_component_write(component, WCD9335_ANA_BUCK_VOUT_D,
				vout_d_val & 0xFF);
	snd_soc_component_update_bits(component, WCD9335_ANA_BUCK_CTL, 0x80,
				      0x80);
...
static int tasha_codec_update_sido_voltage(struct tasha_priv *tasha,
					   enum tasha_sido_voltage req_mv)
{
	int ret = 0;
...
int tasha_enable_efuse_sensing(struct snd_soc_component *component)
{
	...
	snd_soc_component_update_bits(
		component, WCD9335_CHIP_TIER_CTRL_EFUSE_CTL, 0x01, 0x01);
	/*
   ...
   */
	...
	if (TASHA_IS_2_0(priv->wcd9xxx)) {
		if (!(snd_soc_component_read32(
		      ...
		      0x40))
			snd_soc_component_update_bits(
				component, WCD9335_HPH_R_ATEST, 0x04, 0x00);
...
static int tasha_mbhc_request_irq(struct snd_soc_component *component, int irq,
...
static void tasha_mbhc_irq_control(struct snd_soc_component *component, int irq,
				   bool enable)
{
	struct tasha_priv *tasha = snd_soc_component_get_drvdata(component);
	struct wcd9xxx *wcd9xxx = tasha->wcd9xxx;
...
static int tasha_mbhc_free_irq(struct snd_soc_component *component, int irq,
			       void *data)
{
	struct tasha_priv *tasha = snd_soc_component_get_drvdata(component);
	struct wcd9xxx *wcd9xxx = tasha->wcd9xxx;
...
{
	return snd_soc_component_read32(component, WCD9335_ANA_MBHC_RESULT_3) &
	       0x7;
}
...
static void tasha_mbhc_program_btn_thr(struct snd_soc_component *component,
				       s16 *btn_low, s16 *btn_high, int num_btn,
				       bool is_micbias)
{
	int i;
	int vth;
   ...
   */
	for (i = 0; i < num_btn; i++) {
		...
		snd_soc_component_update_bits(
			component, WCD9335_ANA_MBHC_BTN0 + i, 0xFC, vth << 2);
...
static void
tasha_mbhc_hph_l_pull_up_control(struct snd_soc_component *component,
				 enum mbhc_hs_pullup_iref pull_up_cur)
{
	...
	if (TASHA_IS_2_0(tasha->wcd9xxx))
		...
		snd_soc_component_update_bits(
			component, WCD9335_MBHC_PLUG_DETECT_CTL, 0xC0, 0x40);
}

static int tasha_enable_ext_mb_source(struct wcd_mbhc *mbhc, bool turn_on)
{
	struct snd_soc_component *component = mbhc->component;
	struct tasha_priv *tasha = snd_soc_component_get_drvdata(component);
	int ret = 0;
	...
	if (!supply->supply) {
		dev_dbg(component->dev,
			"%s: warning supply not present ond for %s\n", __func__,
			"onDemand Micbias");
		return ret;
	}
	...
	case MICB_ENABLE:
		...
		if (is_dapm && post_dapm_on)
			blocking_notifier_call_chain(
				&tasha->notifier, post_dapm_on, &tasha->mbhc);
		break;
	case MICB_DISABLE:
		...
		if (is_dapm && post_dapm_off)
			blocking_notifier_call_chain(
				&tasha->notifier, post_dapm_off, &tasha->mbhc);
		break;
	};

	dev_dbg(component->dev,
		"%s: micb_num:%d, micb_ref: %d, pullup_ref: %d\n", __func__,
		micb_num, tasha->micb_ref[micb_index],
		tasha->pullup_ref[micb_index]);
...
static int
tasha_mbhc_micb_ctrl_threshold_mic(struct snd_soc_component *component,
						...
						int32_t *zdet)
{
	...
	s32 x1, d1;
	int32_t denom;
	int minCode_param[] = { 3277, 1639, 820, 410, 205, 103, 52, 26 };
...
ramp_down:
	i = 0;
	while (x1) {
		regmap_bulk_read(wcd9xxx->regmap, WCD9335_ANA_MBHC_RESULT_1,
				 (u8 *)&val, 2);
		x1 = TASHA_MBHC_GET_X1(val);
		i++;
				 ...
				 int32_t *zl, int32_t *zr, s16 *d1_a)
{
	...
	regmap_update_bits(wcd9xxx->regmap, WCD9335_ANA_MBHC_ZDET, 0x80, 0x80);
	dev_dbg(wcd9xxx->dev, "%s: ramp for HPH_L, noff = %d\n", __func__,
		zdet_param->noff);
	tasha_mbhc_get_result_params(wcd9xxx, d1_a, zdet_param->noff, &zdet);
	regmap_update_bits(wcd9xxx->regmap, WCD9335_ANA_MBHC_ZDET, 0x80, 0x00);
...
z_right:
	...
	regmap_update_bits(wcd9xxx->regmap, WCD9335_ANA_MBHC_ZDET, 0x40, 0x40);
	dev_dbg(wcd9xxx->dev, "%s: ramp for HPH_R, noff = %d\n", __func__,
		zdet_param->noff);
	tasha_mbhc_get_result_params(wcd9xxx, d1_a, zdet_param->noff, &zdet);
	regmap_update_bits(wcd9xxx->regmap, WCD9335_ANA_MBHC_ZDET, 0x40, 0x00);
					  ...
					  uint32_t *zr)
{
	...
	if (!TASHA_IS_2_0(wcd9xxx)) {
		dev_dbg(component->dev,
			"%s: Z-det is not supported for this codec version\n",
			__func__);
		*zl = 0;
		*zr = 0;
		return;
	...
	if (snd_soc_component_read32(component, WCD9335_ANA_MBHC_ELECT) &
	    0x80) {
		is_fsm_disable = true;
		regmap_update_bits(wcd9xxx->regmap, WCD9335_ANA_MBHC_ELECT,
				   0x80, 0x00);
	}

	/* For NO-jack, disable L_DET_EN before Z-det measurements */
	if (mbhc->hphl_swh)
		regmap_update_bits(wcd9xxx->regmap, WCD9335_ANA_MBHC_MECH, 0x80,
				   0x00);

	/* Enable AZ */
	snd_soc_component_update_bits(component, WCD9335_MBHC_CTL_1, 0x0C,
				      0x04);
	/* Turn off 100k pull down on HPHL */
	regmap_update_bits(wcd9xxx->regmap, WCD9335_ANA_MBHC_MECH, 0x01, 0x00);
...
right_ch_impedance:
	...
	snd_soc_component_update_bits(component, WCD9335_HPH_R_ATEST, 0x02,
				      0x02);
	snd_soc_component_update_bits(component, WCD9335_HPH_PA_CTL2, 0x40,
				      0x01);
	if (*zl < (TASHA_ZDET_VAL_32 / 1000))
		tasha_mbhc_zdet_ramp(component, &zdet_param[0], &z1Ls, NULL,
				     d1);
	else
		tasha_mbhc_zdet_ramp(component, &zdet_param[1], &z1Ls, NULL,
				     d1);
	snd_soc_component_update_bits(component, WCD9335_HPH_PA_CTL2, 0x40,
				      0x00);
	snd_soc_component_update_bits(component, WCD9335_HPH_R_ATEST, 0x02,
...
zdet_complete:
	...
	regmap_update_bits(wcd9xxx->regmap, WCD9335_ANA_MBHC_MECH, 0x01, 0x01);
...
static void tasha_mbhc_gnd_det_ctrl(struct snd_soc_component *component,
				    bool enable)
{
	if (enable) {
					  ...
					  bool enable)
{
	...
	if (enable) {
		...
		if (TASHA_IS_2_0(tasha->wcd9xxx))
			snd_soc_component_update_bits(
				component, WCD9335_HPH_PA_CTL2, 0x10, 0x10);
	} else {
		snd_soc_component_update_bits(component, WCD9335_HPH_PA_CTL2,
					      0x40, 0x00);
		if (TASHA_IS_2_0(tasha->wcd9xxx))
			snd_soc_component_update_bits(
				component, WCD9335_HPH_PA_CTL2, 0x10, 0x00);
	}
}
...
static void tasha_mbhc_moisture_config(struct wcd_mbhc *mbhc)
{
	...
	snd_soc_component_update_bits(component, WCD9335_MBHC_CTL_2, 0x0C,
				      mbhc->moist_vref << 2);
...
static bool tasha_is_anc_on(struct wcd_mbhc *mbhc)
{
	...
	ancl = (snd_soc_component_read32(mbhc->component,
					 WCD9335_CDC_RX1_RX_PATH_CFG0)) &
	       0x10;
	ancr = (snd_soc_component_read32(mbhc->component,
					 WCD9335_CDC_RX2_RX_PATH_CFG0)) &
	       0x10;
...
static int tasha_get_iir_enable_audio_mixer(struct snd_kcontrol *kcontrol,
					    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component =
		snd_soc_kcontrol_component(kcontrol);
	...
	dev_dbg(component->dev, "%s: IIR #%d band #%d enable %d\n", __func__,
		iir_idx, band_idx, (uint32_t)ucontrol->value.integer.value[0]);
	return 0;
}
...
static const struct snd_kcontrol_new hph_type_detect_controls[] = {
	SOC_SINGLE_EXT("HPH Type", 0, 0, UINT_MAX, 0, tasha_get_hph_type, NULL),
};
				   ...
				   struct snd_ctl_elem_value *ucontrol)
{
	...
	if (enable) {
		if (port_id == TASHA_TX14 &&
		    !test_bit(VI_SENSE_1, &tasha_p->status_mask)) {
			list_add_tail(&core->tx_chs[TASHA_TX14].list,
				      &tasha_p->dai[dai_id].wcd9xxx_ch_list);
			set_bit(VI_SENSE_1, &tasha_p->status_mask);
		}
		if (port_id == TASHA_TX15 &&
		    !test_bit(VI_SENSE_2, &tasha_p->status_mask)) {
			     ...
			     struct snd_ctl_elem_value *ucontrol)
{
	...
	dev_dbg(component->dev,
		"%s: wname %s cname %s value %u shift %d item %ld\n", __func__,
	...
	case AIF3_CAP:
		...
		if (enable && !(tasha_p->tx_port_value & 1 << port_id)) {
			if (wcd9xxx_tx_vport_validation(vtable, port_id,
							...
							NUM_CODEC_DAIS)) {
				dev_dbg(component->dev,
					"%s: TX%u is used by other virtual port\n",
					__func__, port_id);
				mutex_unlock(&tasha_p->codec_mutex);
				return 0;
			}
			...
			list_add_tail(&core->tx_chs[port_id].list,
				      &tasha_p->dai[dai_id].wcd9xxx_ch_list);
		} else if (!enable && (tasha_p->tx_port_value & 1 << port_id)) {
			tasha_p->tx_port_value &= ~(1 << port_id);
			list_del_init(&core->tx_chs[port_id].list);
		} else {
			if (enable)
				dev_dbg(component->dev,
					"%s: TX%u port is used by\n"
					"this virtual port\n",
					__func__, port_id);
			else
				dev_dbg(component->dev,
					"%s: TX%u port is not used by\n"
					"this virtual port\n",
					__func__, port_id);
...
static const char *const slim_rx_mux_text[] = { "ZERO",	   "AIF1_PB",
						"AIF2_PB", "AIF3_PB",
						"AIF4_PB", "AIF_MIX1_PB" };
			   ...
			   struct snd_ctl_elem_value *ucontrol)
{
	...
	pr_debug("%s: wname %s cname %s value %u shift %d item %ld\n", __func__,
		 widget->name, ucontrol->id.name, rx_port_value, widget->shift,
		 ucontrol->value.integer.value[0]);
	...
	case 0:
		...
		break;
	case 1:
		if (wcd9xxx_rx_vport_validation(
			    port_id + TASHA_RX_PORT_START_NUMBER,
			    &tasha_p->dai[AIF1_PB].wcd9xxx_ch_list)) {
			dev_dbg(component->dev,
				"%s: RX%u is used by current requesting AIF_PB itself\n",
				__func__, port_id);
			goto rtn;
		}
...
rtn:
	mutex_unlock(&tasha_p->codec_mutex);
	snd_soc_dapm_mux_update_power(widget->dapm, kcontrol, rx_port_value, e,
				      update);
...
static const struct snd_kcontrol_new aif4_mad_mixer[] = {
	...
	SOC_SINGLE_EXT("SLIM TX13", SND_SOC_NOPM, TASHA_TX13, 1, 0,
		       slim_tx_mixer_get, slim_tx_mixer_put),
	SOC_SINGLE_EXT("SLIM TX1", SND_SOC_NOPM, 0, 1, 0, slim_tx_mixer_get,
		       slim_tx_mixer_put),
...
static const struct snd_kcontrol_new cpe_in_mix_switch[] = { SOC_DAPM_SINGLE(
	"MAD_BYPASS", SND_SOC_NOPM, 0, 1, 0) };

static int tasha_put_iir_enable_audio_mixer(struct snd_kcontrol *kcontrol,
					    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component =
		snd_soc_kcontrol_component(kcontrol);
				   ...
				   int iir_idx, int band_idx, int coeff_idx)
{
	...
	snd_soc_component_write(
		...
		((band_idx * BAND_MAX + coeff_idx) * sizeof(uint32_t)) & 0x7F);

	value |= snd_soc_component_read32(
		component,
	...
	snd_soc_component_write(
		component,
		(WCD9335_CDC_SIDETONE_IIR0_IIR_COEF_B1_CTL + 16 * iir_idx),
		((band_idx * BAND_MAX + coeff_idx) * sizeof(uint32_t) + 1) &
			0x7F);

	value |=
		(snd_soc_component_read32(
			 component, (WCD9335_CDC_SIDETONE_IIR0_IIR_COEF_B2_CTL +
				     16 * iir_idx))
		 << 8);
	...
	snd_soc_component_write(
		component,
		(WCD9335_CDC_SIDETONE_IIR0_IIR_COEF_B1_CTL + 16 * iir_idx),
		((band_idx * BAND_MAX + coeff_idx) * sizeof(uint32_t) + 2) &
			0x7F);
	...
	snd_soc_component_write(
		component,
		(WCD9335_CDC_SIDETONE_IIR0_IIR_COEF_B1_CTL + 16 * iir_idx),
		((band_idx * BAND_MAX + coeff_idx) * sizeof(uint32_t) + 3) &
			0x7F);
...
static int tasha_get_iir_band_audio_mixer(struct snd_kcontrol *kcontrol,
					  struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component =
		snd_soc_kcontrol_component(kcontrol);
	...
	pr_debug("%s: IIR #%d band #%d b0 = 0x%x\n"
		 ...
		 (uint32_t)ucontrol->value.integer.value[0], __func__, iir_idx,
		 band_idx, (uint32_t)ucontrol->value.integer.value[1], __func__,
		 iir_idx, band_idx, (uint32_t)ucontrol->value.integer.value[2],
		 __func__, iir_idx, band_idx,
		 (uint32_t)ucontrol->value.integer.value[3], __func__, iir_idx,
		 band_idx, (uint32_t)ucontrol->value.integer.value[4]);
	return 0;
}

static void set_iir_band_coeff(struct snd_soc_component *component, int iir_idx,
					...
					struct snd_soc_component *component)
{
	...
	list_for_each_entry(ch, &dai->wcd9xxx_ch_list, list) {
		if (ch->port >= TASHA_RX_PORT_START_NUMBER) {
			...
			val = wcd9xxx_interface_reg_read(tasha_p->wcd9xxx, reg);
					  ...
					  bool up)
{
	...
	if (up) {
		...
		ret = wait_event_timeout(
			dai->dai_wait, (dai->ch_mask == 0),
			msecs_to_jiffies(TASHA_SLIM_CLOSE_TIMEOUT));
		if (!ret) {
				     ...
				     struct snd_kcontrol *kcontrol, int event)
{
	...
	dev_dbg(component->dev,
		"%s: event called! component name %s num_dai %d\n"
		"stream name %s event %d\n",
		__func__, component->name, component->num_dai, w->sname, event);
					      ...
					      int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		if (test_bit(VI_SENSE_1, &tasha_p->status_mask)) {
			...
			/* Enable V&I sensing */
			snd_soc_component_update_bits(
				component, WCD9335_CDC_TX9_SPKR_PROT_PATH_CTL,
				0x20, 0x20);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_TX10_SPKR_PROT_PATH_CTL,
				0x20, 0x20);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_TX9_SPKR_PROT_PATH_CTL,
				0x0F, 0x00);
		...
		if (test_bit(VI_SENSE_2, &tasha_p->status_mask)) {
			...
			/* Enable V&I sensing */
			snd_soc_component_update_bits(
				component, WCD9335_CDC_TX11_SPKR_PROT_PATH_CTL,
				0x20, 0x20);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_TX12_SPKR_PROT_PATH_CTL,
				0x20, 0x20);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_TX11_SPKR_PROT_PATH_CTL,
				0x0F, 0x00);
	...
	case SND_SOC_DAPM_POST_PMD:
		...
		if (ret)
			dev_err(component->dev,
				"%s error in close_slim_sch_tx %d\n", __func__,
				ret);
		if (!dai->bus_down_in_recovery)
			ret = tasha_codec_enable_slim_chmask(dai, false);
		if (ret < 0) {
			ret = wcd9xxx_disconnect_port(
				core, &dai->wcd9xxx_ch_list, dai->grph);
			dev_dbg(component->dev,
				     ...
				     struct snd_kcontrol *kcontrol, int event)
{
	...
	dev_dbg(component->dev,
		...
		__func__, w->name, w->shift, component->num_dai, w->sname);
				       ...
				       int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		snd_soc_component_update_bits(
			component, WCD9335_CPE_SS_TX_PP_CFG, 0x0F, bit_width);
		...
		snd_soc_component_update_bits(
			component, WCD9335_CPE_SS_TX_PP_CFG, 0x70, rate);

		buf_period = (dai->rate * (dai->bit_width / 8)) / (16 * 1000);
		snd_soc_component_update_bits(
			component, WCD9335_CPE_SS_TX_PP_BUF_INT_PERIOD, 0xFF,
			buf_period);
	...
	case SND_SOC_DAPM_POST_PMD:
		snd_soc_component_write(component, WCD9335_CPE_SS_TX_PP_CFG,
					0x3C);
		snd_soc_component_write(
			component, WCD9335_CPE_SS_TX_PP_BUF_INT_PERIOD, 0x60);
		break;
					 ...
					 u8 event)
{
	...
	if (port == TASHA_TX13) {
		...
		case SND_SOC_DAPM_POST_PMU:
			snd_soc_component_update_bits(
				component,
				WCD9335_CODEC_RPM_PWR_CPE_DRAM1_SHUTDOWN, 0x20,
				0x00);
			snd_soc_component_update_bits(
				component,
				WCD9335_DATA_HUB_DATA_HUB_SB_TX13_INP_CFG, 0x03,
				0x02);
			snd_soc_component_update_bits(
				component, WCD9335_CPE_SS_CFG, 0x80, 0x80);
			break;
		case SND_SOC_DAPM_POST_PMD:
			snd_soc_component_update_bits(
				component,
			...
			snd_soc_component_update_bits(
				...
				0x00);
			snd_soc_component_update_bits(
				component, WCD9335_CPE_SS_CFG, 0x80, 0x00);
			break;
		}
	}
...
static int tasha_put_iir_band_audio_mixer(struct snd_kcontrol *kcontrol,
					  struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component =
		snd_soc_kcontrol_component(kcontrol);
   ...
   */
	...
	pr_debug("%s: IIR #%d band #%d b0 = 0x%x\n"
		 ...
		 "%s: IIR #%d band #%d a2 = 0x%x\n",
		 __func__, iir_idx, band_idx,
		 get_iir_band_coeff(component, iir_idx, band_idx, 0), __func__,
		 iir_idx, band_idx,
		 get_iir_band_coeff(component, iir_idx, band_idx, 1), __func__,
		 iir_idx, band_idx,
		 get_iir_band_coeff(component, iir_idx, band_idx, 2), __func__,
		 iir_idx, band_idx,
		 get_iir_band_coeff(component, iir_idx, band_idx, 3), __func__,
		 iir_idx, band_idx,
		 get_iir_band_coeff(component, iir_idx, band_idx, 4));
	return 0;
}
			       ...
			       struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component =
		snd_soc_kcontrol_component(kcontrol);
	int comp = ((struct soc_multi_mixer_control *)kcontrol->private_value)
			   ->shift;
	struct tasha_priv *tasha = snd_soc_component_get_drvdata(component);
			       ...
			       struct snd_ctl_elem_value *ucontrol)
{
	...
	pr_debug("%s: Compander %d enable current %d, new %d\n", __func__,
		 comp + 1, tasha->comp_enabled[comp], value);
				      ...
				      struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		if (tasha->rx_bias_count == 1) {
			...
			snd_soc_component_update_bits(
				component, WCD9335_ANA_RX_SUPPLIES, 0x01, 0x01);
		}
		break;
	case SND_SOC_DAPM_POST_PMD:
		tasha->rx_bias_count--;
		if (!tasha->rx_bias_count)
			snd_soc_component_update_bits(
				component, WCD9335_ANA_RX_SUPPLIES, 0x01, 0x00);
		break;
	};
				    ...
				    u16 reg1, u16 reg2)
{
	...
	if (val1 == 0x0F && val2 == 0xFF) {
		...
		dev_dbg(component->dev,
			"%s: ANC1 co-eff index already aligned\n", __func__);
		snd_soc_component_write(component, reg1, 0x00);
		snd_soc_component_write(component, reg2, tmpval1);
		snd_soc_component_write(component, reg1, 0x01);
		snd_soc_component_write(component, reg2, tmpval2);
				  ...
				  struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		anc_size_remaining =
			cal_size - sizeof(struct wcd9xxx_anc_header);
		...
		for (i = 0; i < num_anc_slots; i++) {
			...
			anc_size_remaining -=
				(anc_writes_size * TASHA_PACKED_REG_SIZE);
			anc_ptr += anc_writes_size;
		}
		if (i == num_anc_slots) {
			dev_err(component->dev,
				"Selected ANC slot not present\n");
			ret = -EINVAL;
			goto err;
		}
		...
		if (!strcmp(w->name, "RX INT0 DAC") ||
			...
			tasha_realign_anc_coeff(
				component, WCD9335_CDC_ANC0_IIR_COEFF_1_CTL,
		...
		if (!strcmp(w->name, "RX INT1 DAC") ||
			...
			snd_soc_component_update_bits(
				component, WCD9335_CDC_ANC0_CLK_RESET_CTL, 0x39,
				0x39);
		} else if (!strcmp(w->name, "RX INT2 DAC") ||
			   !strcmp(w->name, "RX INT4 DAC")) {
			tasha_realign_anc_coeff(
				component, WCD9335_CDC_ANC1_IIR_COEFF_1_CTL,
				WCD9335_CDC_ANC1_IIR_COEFF_2_CTL);
			i = anc_cal_size / 2;
			snd_soc_component_update_bits(
				component, WCD9335_CDC_ANC1_CLK_RESET_CTL, 0x39,
				0x39);
		}
		...
		if (!strcmp(w->name, "RX INT1 DAC") ||
		    !strcmp(w->name, "RX INT3 DAC")) {
			snd_soc_component_update_bits(
				component, WCD9335_CDC_ANC0_CLK_RESET_CTL, 0x08,
				0x08);
		} else if (!strcmp(w->name, "RX INT2 DAC") ||
			   !strcmp(w->name, "RX INT4 DAC")) {
			snd_soc_component_update_bits(
				component, WCD9335_CDC_ANC1_CLK_RESET_CTL, 0x08,
				0x08);
		}
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		snd_soc_component_update_bits(
			component, WCD9335_CDC_ANC0_CLK_RESET_CTL, 0x08, 0x00);
		snd_soc_component_update_bits(
			component, WCD9335_CDC_ANC1_CLK_RESET_CTL, 0x08, 0x00);
		break;
	case SND_SOC_DAPM_POST_PMD:
		if (!strcmp(w->name, "ANC HPHL PA") ||
			...
			snd_soc_component_update_bits(
				component, WCD9335_CDC_ANC0_MODE_1_CTL, 0x30,
				0x00);
			msleep(50);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_ANC0_MODE_1_CTL, 0x01,
				0x00);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_ANC0_CLK_RESET_CTL, 0x38,
				0x38);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_ANC0_CLK_RESET_CTL, 0x07,
				0x00);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_ANC0_CLK_RESET_CTL, 0x38,
				0x00);
			...
			snd_soc_component_update_bits(
				component, WCD9335_CDC_ANC1_MODE_1_CTL, 0x30,
				0x00);
			msleep(50);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_ANC1_MODE_1_CTL, 0x01,
				0x00);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_ANC1_CLK_RESET_CTL, 0x38,
				0x38);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_ANC1_CLK_RESET_CTL, 0x07,
				0x00);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_ANC1_CLK_RESET_CTL, 0x38,
				0x00);
...
static void tasha_codec_clear_anc_tx_hold(struct tasha_priv *tasha)
{
	if (test_and_clear_bit(ANC_MIC_AMIC1, &tasha->status_mask))
		tasha_codec_set_tx_hold(tasha->component, WCD9335_ANA_AMIC1,
					false);
	if (test_and_clear_bit(ANC_MIC_AMIC2, &tasha->status_mask))
		tasha_codec_set_tx_hold(tasha->component, WCD9335_ANA_AMIC2,
					false);
	if (test_and_clear_bit(ANC_MIC_AMIC3, &tasha->status_mask))
		tasha_codec_set_tx_hold(tasha->component, WCD9335_ANA_AMIC3,
					false);
	if (test_and_clear_bit(ANC_MIC_AMIC4, &tasha->status_mask))
		tasha_codec_set_tx_hold(tasha->component, WCD9335_ANA_AMIC4,
					false);
	if (test_and_clear_bit(ANC_MIC_AMIC5, &tasha->status_mask))
		tasha_codec_set_tx_hold(tasha->component, WCD9335_ANA_AMIC5,
					false);
	if (test_and_clear_bit(ANC_MIC_AMIC6, &tasha->status_mask))
		tasha_codec_set_tx_hold(tasha->component, WCD9335_ANA_AMIC6,
					false);
}

static void tasha_codec_hph_post_pa_config(struct tasha_priv *tasha, int mode,
					   int event)
{
	u8 scale_val = 0;
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		if (tasha->anc_func) {
			...
			if ((snd_soc_component_read32(tasha->component,
						      WCD9335_ANA_HPH) &
			     0xC0) == 0xC0) {
	...
	if (SND_SOC_DAPM_EVENT_ON(event)) {
		if (tasha->comp_enabled[COMPANDER_1] ||
			...
			snd_soc_component_update_bits(
				tasha->component, WCD9335_HPH_L_EN, 0x20, 0x00);
			snd_soc_component_update_bits(
				tasha->component, WCD9335_HPH_R_EN, 0x20, 0x00);
			snd_soc_component_update_bits(tasha->component,
	...
	if (SND_SOC_DAPM_EVENT_OFF(event)) {
		snd_soc_component_update_bits(
			tasha->component, WCD9335_HPH_AUTO_CHOP, 0x20, 0x00);
	}
}

static void tasha_codec_override(struct snd_soc_component *component, int mode,
				 int event)
{
	if (mode == CLS_AB) {
		switch (event) {
		case SND_SOC_DAPM_POST_PMU:
			if (!(snd_soc_component_read32(
				      component, WCD9335_CDC_RX2_RX_PATH_CTL) &
			      0x10) &&
			    (!(snd_soc_component_read32(
				       component, WCD9335_CDC_RX1_RX_PATH_CTL) &
			       0x10)))
				snd_soc_component_update_bits(
					component, WCD9XXX_A_ANA_RX_SUPPLIES,
					0x02, 0x02);
			break;
		case SND_SOC_DAPM_POST_PMD:
			snd_soc_component_update_bits(component,
				      ...
				      struct snd_kcontrol *kcontrol, int event)
{
     ...
     */
		...
		snd_soc_component_update_bits(
			component, WCD9335_CDC_RX2_RX_PATH_CTL, 0x10, 0x00);
		/* Remove mix path mute if it is enabled */
		if ((snd_soc_component_read32(
			    component, WCD9335_CDC_RX2_RX_PATH_MIX_CTL)) &
		    0x10)
			snd_soc_component_update_bits(
				component, WCD9335_CDC_RX2_RX_PATH_MIX_CTL,
				0x10, 0x00);
		...
		if (!(strcmp(w->name, "ANC HPHR PA"))) {
			...
			snd_soc_component_update_bits(
				component, WCD9335_CDC_RX1_RX_PATH_CTL, 0x10,
				0x00);
			/* Remove mix path mute if it is enabled */
			if ((snd_soc_component_read32(
				    component,
				...
				snd_soc_component_update_bits(
					component,
					WCD9335_CDC_RX1_RX_PATH_MIX_CTL, 0x10,
					0x00);
			/* Remove ANC Rx from reset */
	...
	case SND_SOC_DAPM_PRE_PMD:
		...
		if (!(strcmp(w->name, "ANC HPHR PA")) ||
			...
			snd_soc_component_update_bits(
				component, WCD9335_ANA_HPH, 0x40, 0x00);
		break;
	case SND_SOC_DAPM_POST_PMD:
     ...
     */
		...
		if (!(strcmp(w->name, "ANC HPHR PA"))) {
			ret = tasha_codec_enable_anc(w, kcontrol, event);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_RX2_RX_PATH_CFG0, 0x10,
				0x00);
		}
		break;
	};
				      ...
				      struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		if (!(strcmp(w->name, "HPHL PA")))
			snd_soc_component_update_bits(
				component, WCD9335_ANA_HPH, 0x80, 0x80);
		set_bit(HPH_PA_DELAY, &tasha->status_mask);
		break;
	case SND_SOC_DAPM_POST_PMU:
		if (!(strcmp(w->name, "ANC HPHL PA"))) {
     ...
     */
		...
		tasha_codec_hph_post_pa_config(tasha, hph_mode, event);
		snd_soc_component_update_bits(
			component, WCD9335_CDC_RX1_RX_PATH_CTL, 0x10, 0x00);
		/* Remove mix path mute if it is enabled */
		if ((snd_soc_component_read32(
			    component, WCD9335_CDC_RX1_RX_PATH_MIX_CTL)) &
		    0x10)
			snd_soc_component_update_bits(
				component, WCD9335_CDC_RX1_RX_PATH_MIX_CTL,
				0x10, 0x00);
		...
		if (!(strcmp(w->name, "ANC HPHL PA"))) {
			...
			snd_soc_component_update_bits(
				component, WCD9335_CDC_RX2_RX_PATH_CTL, 0x10,
				0x00);
			/* Remove mix path mute if it is enabled */
			if ((snd_soc_component_read32(
				    component,
				...
				snd_soc_component_update_bits(
					component,
					WCD9335_CDC_RX2_RX_PATH_MIX_CTL, 0x10,
					0x00);
	...
	case SND_SOC_DAPM_PRE_PMD:
		...
		if (!(strcmp(w->name, "ANC HPHL PA")) ||
			...
			snd_soc_component_update_bits(
				component, WCD9335_ANA_HPH, 0x80, 0x00);
		break;
	case SND_SOC_DAPM_POST_PMD:
		/* 5ms sleep is required after PA is disabled as per
     * HW requirement
     */
		...
		if (!(strcmp(w->name, "ANC HPHL PA"))) {
			ret = tasha_codec_enable_anc(w, kcontrol, event);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_RX1_RX_PATH_CFG0, 0x10,
				0x00);
		}
		break;
	};
					 ...
					 int event)
{
     ...
     */
		usleep_range(5000, 5500);
		snd_soc_component_update_bits(component, lineout_vol_reg, 0x10,
					      0x00);
		/* Remove mix path mute if it is enabled */
		if ((snd_soc_component_read32(component, lineout_mix_vol_reg)) &
		    0x10)
			snd_soc_component_update_bits(
				component, lineout_mix_vol_reg, 0x10, 0x00);
     ...
     */
		...
		if (!(strcmp(w->name, "ANC LINEOUT1 PA")) ||
			...
			if (!(strcmp(w->name, "ANC LINEOUT1 PA")))
				snd_soc_component_update_bits(
					component, WCD9335_CDC_RX3_RX_PATH_CFG0,
					0x10, 0x10);
			else
				snd_soc_component_update_bits(
					component, WCD9335_CDC_RX4_RX_PATH_CFG0,
					0x10, 0x10);
		}
		break;
	};
				      ...
				      struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMD:
		...
		snd_soc_component_update_bits(
			component, WCD9335_CDC_RX7_RX_PATH_CFG0, 0x10, 0x00);
		ret = tasha_codec_enable_anc(w, kcontrol, event);
		break;
	}
	return ret;
				     ...
				     struct snd_kcontrol *kcontrol, int event)
{
     ...
     */
		usleep_range(5000, 5500);
		snd_soc_component_update_bits(
			component, WCD9335_CDC_RX0_RX_PATH_CTL, 0x10, 0x00);
		/* Remove mix path mute if it is enabled */
		if ((snd_soc_component_read32(
     ...
     */
		...
		if (!(strcmp(w->name, "ANC EAR PA"))) {
			ret = tasha_codec_enable_anc(w, kcontrol, event);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_RX0_RX_PATH_CFG0, 0x10,
				0x00);
		}
		break;
	};
...
{
	if (SND_SOC_DAPM_EVENT_ON(event)) {
		snd_soc_component_update_bits(component, WCD9335_RX_BIAS_HPH_PA,
					      0x0F, 0x06);
		snd_soc_component_update_bits(component,
					      WCD9335_RX_BIAS_HPH_RDACBUFF_CNP2,
					      0xF0, 0x40);
		snd_soc_component_update_bits(component, WCD9335_HPH_CNP_WG_CTL,
					      0x07, 0x03);
		snd_soc_component_update_bits(component, WCD9335_HPH_PA_CTL2,
					      0x08, 0x08);
		snd_soc_component_update_bits(component, WCD9335_HPH_PA_CTL1,
					      0x0E, 0x0C);
	...
	if (SND_SOC_DAPM_EVENT_OFF(event)) {
		...
		snd_soc_component_update_bits(component, WCD9335_HPH_CNP_WG_CTL,
					      0x07, 0x02);
		snd_soc_component_write(
			component, WCD9335_RX_BIAS_HPH_RDACBUFF_CNP2, 0x8A);
		snd_soc_component_update_bits(component, WCD9335_RX_BIAS_HPH_PA,
					      0x0F, 0x0A);
	}
}
				      ...
				      int event)
{
	if (SND_SOC_DAPM_EVENT_ON(event)) {
		...
		snd_soc_component_update_bits(component, WCD9335_HPH_PA_CTL2,
					      0x20, 0x20);
		snd_soc_component_update_bits(
			component, WCD9335_HPH_RDAC_LDO_CTL, 0x07, 0x01);
		snd_soc_component_update_bits(
			component, WCD9335_HPH_RDAC_LDO_CTL, 0x70, 0x10);
		snd_soc_component_update_bits(
			component, WCD9335_RX_BIAS_HPH_RDAC_LDO, 0x0F, 0x01);
		snd_soc_component_update_bits(
			component, WCD9335_RX_BIAS_HPH_RDAC_LDO, 0xF0, 0x10);
	}

	if (SND_SOC_DAPM_EVENT_OFF(event)) {
		snd_soc_component_write(component, WCD9335_RX_BIAS_HPH_RDAC_LDO,
					0x88);
		snd_soc_component_write(component, WCD9335_HPH_RDAC_LDO_CTL,
					0x33);
		snd_soc_component_update_bits(component, WCD9335_HPH_PA_CTL2,
					      0x20, 0x00);
		snd_soc_component_update_bits(component, WCD9335_HPH_PA_CTL2,
		...
		snd_soc_component_update_bits(component, WCD9335_HPH_CNP_WG_CTL,
					      0x07, 0x02);
		snd_soc_component_update_bits(component, WCD9335_HPH_R_EN, 0xC0,
					      0x80);
		snd_soc_component_update_bits(component, WCD9335_HPH_L_EN, 0xC0,
					      0x80);
	}
}
				      ...
				      struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		if (((hph_mode == CLS_H_HIFI) || (hph_mode == CLS_H_LOHIFI) ||
		    ...
		    (dem_inp != 0x01)) {
			dev_err(component->dev,
				"%s: DEM Input not set correctly, hph_mode: %d\n",
				__func__, hph_mode);
			return -EINVAL;
		}
		wcd_clsh_fsm(component, &tasha->clsh_d, WCD_CLSH_EVENT_PRE_DAC,
			     WCD_CLSH_STATE_HPHR,
			     ((hph_mode == CLS_H_LOHIFI) ? CLS_H_HIFI :
							   hph_mode));

		if (!(strcmp(w->name, "RX INT2 DAC")))
			snd_soc_component_update_bits(
				component, WCD9335_ANA_HPH, 0x10, 0x10);
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		usleep_range(1000, 1100);
		if ((hph_mode == CLS_H_LP) && (TASHA_IS_1_1(wcd9xxx))) {
			snd_soc_component_update_bits(
				component, WCD9335_HPH_L_DAC_CTL, 0x03, 0x03);
		}
		break;
	case SND_SOC_DAPM_PRE_PMD:
		if ((hph_mode == CLS_H_LP) && (TASHA_IS_1_1(wcd9xxx))) {
			snd_soc_component_update_bits(
				component, WCD9335_HPH_L_DAC_CTL, 0x03, 0x00);
		}
		if (!(strcmp(w->name, "RX INT2 DAC")))
			snd_soc_component_update_bits(
				component, WCD9335_ANA_HPH, 0x10, 0x00);
		break;
	case SND_SOC_DAPM_POST_PMD:
		/* 1000us required as per HW requirement */
		usleep_range(1000, 1100);
		...
		wcd_clsh_fsm(component, &tasha->clsh_d, WCD_CLSH_EVENT_POST_PA,
			     WCD_CLSH_STATE_HPHR,
			     ((hph_mode == CLS_H_LOHIFI) ? CLS_H_HIFI :
							   hph_mode));
		break;
				      ...
				      struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		if (!(strcmp(w->name, "RX INT1 DAC")))
			snd_soc_component_update_bits(
				component, WCD9335_ANA_HPH, 0x20, 0x20);
		...
		ret = wcd_mbhc_get_impedance(&tasha->mbhc, &impedl, &impedr);
		if (!ret) {
			wcd_clsh_imped_config(component, impedl, false);
			set_bit(CLASSH_CONFIG, &tasha->status_mask);
		} else {
			dev_dbg(component->dev,
				"%s: Failed to get mbhc impedance %d\n",
				__func__, ret);
			ret = 0;
		}
	...
	case SND_SOC_DAPM_PRE_PMD:
		if (!(strcmp(w->name, "RX INT1 DAC")))
			snd_soc_component_update_bits(
				component, WCD9335_ANA_HPH, 0x20, 0x00);
		if ((hph_mode == CLS_H_LP) && (TASHA_IS_1_1(wcd9xxx))) {
			snd_soc_component_update_bits(
				component, WCD9335_HPH_L_DAC_CTL, 0x03, 0x00);
		}
					 ...
					 int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		if (tasha->anc_func && (!strcmp(w->name, "RX INT3 DAC") ||
					!strcmp(w->name, "RX INT4 DAC")))
			ret = tasha_codec_enable_anc(w, kcontrol, event);
				       ...
				       struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		snd_soc_component_update_bits(component, boost_path_ctl, 0x10,
					      0x10);
		snd_soc_component_update_bits(component, boost_path_cfg1, 0x01,
					      0x01);
		snd_soc_component_update_bits(component, reg, 0x10, 0x00);
		if ((snd_soc_component_read32(component, reg_mix)) & 0x10)
			snd_soc_component_update_bits(component, reg_mix, 0x10,
						      0x00);
		break;
	case SND_SOC_DAPM_POST_PMD:
		snd_soc_component_update_bits(component, boost_path_cfg1, 0x01,
				    ...
				    u16 prim_int_reg, int event)
{
	...
	if (hd2_enable_reg && SND_SOC_DAPM_EVENT_ON(event)) {
		snd_soc_component_update_bits(component, hd2_scale_reg, 0x3C,
					      0x10);
		snd_soc_component_update_bits(component, hd2_scale_reg, 0x03,
					      0x01);
		snd_soc_component_update_bits(component, hd2_enable_reg, 0x04,
					      0x04);
	}
...
static int
tasha_codec_enable_prim_interpolator(struct snd_soc_component *component,
				     u16 reg, int event)
{
	struct tasha_priv *tasha = snd_soc_component_get_drvdata(component);
	u16 prim_int_reg;
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		if ((reg != prim_int_reg) &&
		    ((snd_soc_component_read32(component, prim_int_reg)) &
		     0x10))
					 ...
					 int src_num, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		count++;
		if (count == 1) {
			if ((snd_soc_component_read32(component, src_clk_reg) &
			     0x02) ||
			    (snd_soc_component_read32(component,
						      src_paired_reg) &
			     0x02)) {
				snd_soc_component_update_bits(
					component, src_clk_reg, 0x02, 0x00);
				snd_soc_component_update_bits(
					component, src_paired_reg, 0x02, 0x00);
			}
			snd_soc_component_update_bits(component, src_clk_reg,
						      0x01, 0x01);
			snd_soc_component_update_bits(
				component, rx_path_cfg_reg, 0x80, 0x80);
		}
		*src_users = count;
		break;
	case SND_SOC_DAPM_POST_PMD:
		...
		if (count == 0) {
			snd_soc_component_update_bits(
				component, rx_path_cfg_reg, 0x80, 0x00);
			snd_soc_component_update_bits(component, src_clk_reg,
						      0x03, 0x02);
			/* default sample rate */
			snd_soc_component_update_bits(
				component, rx_path_ctl_reg, 0x0f, 0x04);
		}
		*src_users = count;
		break;
	};
				  ...
				  struct snd_kcontrol *kcontrol, int event)
{
	...
	dev_dbg(tasha->dev, "%s: current swr ch cnt: %d\n", __func__,
		tasha->rx_7_count + tasha->rx_8_count);
	...
	case SND_SOC_DAPM_POST_PMU:
		if ((tasha->spkr_gain_offset == RX_GAIN_OFFSET_M1P5_DB) &&
		    ...
		    (gain_reg == WCD9335_CDC_RX7_RX_VOL_MIX_CTL ||
		     gain_reg == WCD9335_CDC_RX8_RX_VOL_MIX_CTL)) {
			snd_soc_component_update_bits(
				component, WCD9335_CDC_RX7_RX_PATH_SEC1, 0x01,
				0x01);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_RX7_RX_PATH_MIX_SEC0,
				0x01, 0x01);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_RX8_RX_PATH_SEC1, 0x01,
				0x01);
			snd_soc_component_update_bits(
				component, WCD9335_CDC_RX8_RX_PATH_MIX_SEC0,
				0x01, 0x01);
			offset_val = -2;
		}
...
static int __tasha_cdc_native_clk_enable(struct tasha_priv *tasha, bool enable)
{
	int ret = 0;
	struct snd_soc_component *component = tasha->component;
	...
	if (enable) {
		...
		if (++tasha->native_clk_users == 1) {
			snd_soc_component_update_bits(
				component, WCD9335_CLOCK_TEST_CTL, 0x10, 0x10);
			snd_soc_component_update_bits(
				component, WCD9335_CLOCK_TEST_CTL, 0x80, 0x80);
			snd_soc_component_update_bits(
				component, WCD9335_CODEC_RPM_CLK_GATE, 0x04,
				0x00);
			snd_soc_component_update_bits(
				component,
				WCD9335_CDC_CLK_RST_CTRL_MCLK_CONTROL, 0x02,
				0x02);
		}
	} else {
		if (tasha->native_clk_users &&
			...
			snd_soc_component_update_bits(
				...
				0x04);
			snd_soc_component_update_bits(
				component, WCD9335_CLOCK_TEST_CTL, 0x80, 0x00);
			snd_soc_component_update_bits(
				component, WCD9335_CLOCK_TEST_CTL, 0x10, 0x00);
		}
...
static int
tasha_codec_get_native_fifo_sync_mask(struct snd_soc_component *component,
				      int interp_n)
{
	int mask = 0;
	u16 reg;
	...
	if (!mask)
		dev_err(component->dev,
			"native fifo err,int:%d,inp0:%d,inp1:%d,inp2:%d\n",
				      ...
				      struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		snd_soc_component_update_bits(component, interp_reg, 0x0F,
					      0x09);
...
static int tasha_codec_enable_on_demand_supply(struct snd_soc_dapm_widget *w,
					       struct snd_kcontrol *kcontrol,
					       int event)
{
	int ret = 0;
	...
	dev_dbg(component->dev, "%s: supply: %s event: %d\n", __func__,
		on_demand_supply_name[w->shift], event);
	...
	case SND_SOC_DAPM_PRE_PMU:
		if (pdata->vote_regulator_on_demand) {
			ret = wcd9xxx_vote_ondemand_regulator(
				wcd9xxx, pdata, supply_name, true);
			if (ret)
				dev_err(component->dev,
					"%s: Failed to vote %s\n", __func__,
					on_demand_supply_name[w->shift]);
	...
	case SND_SOC_DAPM_POST_PMD:
		...
		if (pdata->vote_regulator_on_demand) {
			ret = wcd9xxx_vote_ondemand_regulator(
				wcd9xxx, pdata, supply_name, false);
			if (ret)
				dev_err(component->dev,
					"%s: Failed to unvote %s\n", __func__,
					on_demand_supply_name[w->shift]);
		}
		break;
	default:
				       ...
				       int adc_mux_n)
{
	...
	if (adc_mux_n < 4) {
		adc_mux_in_reg =
			WCD9335_CDC_TX_INP_MUX_ADC_MUX0_CFG1 + 2 * adc_mux_n;
		amic_mux_sel_reg =
			WCD9335_CDC_TX_INP_MUX_ADC_MUX0_CFG0 + 2 * adc_mux_n;
		mask = 0x03;
		shift = 0;
	} else {
		adc_mux_in_reg =
			WCD9335_CDC_TX_INP_MUX_ADC_MUX4_CFG0 + adc_mux_n - 4;
...
static u16 tasha_codec_get_amic_pwlvl_reg(struct snd_soc_component *component,
					  int amic)
{
	u16 pwr_level_reg = 0;
...
static void tasha_tx_mute_update_callback(struct work_struct *work)
{
	...
	tx_vol_ctl_reg =
		WCD9335_CDC_TX0_TX_PATH_CTL + 16 * tx_mute_dwork->decimator;
	hpf_gate_reg =
		WCD9335_CDC_TX0_TX_PATH_SEC2 + 16 * tx_mute_dwork->decimator;
				  ...
				  struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		if (pwr_level_reg) {
			switch ((snd_soc_component_read32(component,
							  pwr_level_reg) &
		...
		if (hpf_cut_off_freq != CF_MIN_3DB_150HZ)
			snd_soc_component_update_bits(component, dec_cfg_reg,
						      ...
						      CF_MIN_3DB_150HZ << 5);
		/* Enable TX PGA Mute */
		snd_soc_component_update_bits(component, tx_vol_ctl_reg, 0x10,
					      0x10);
		break;
	case SND_SOC_DAPM_POST_PMU:
		snd_soc_component_update_bits(component, hpf_gate_reg, 0x01,
					      0x00);

		if (decimator == 0) {
			snd_soc_component_write(
				component, WCD9335_MBHC_ZDET_RAMP_CTL, 0x83);
			snd_soc_component_write(
				component, WCD9335_MBHC_ZDET_RAMP_CTL, 0xA3);
			snd_soc_component_write(
				component, WCD9335_MBHC_ZDET_RAMP_CTL, 0x83);
			snd_soc_component_write(
				component, WCD9335_MBHC_ZDET_RAMP_CTL, 0x03);
		}
				      ...
				      struct wcd9xxx_pdata *pdata)
{
	...
	if (dec_found == true && adc_mux_index <= 8) {
		...
		tx_stream_fs = snd_soc_component_read32(component, tx_fs_reg) &
			       0x0F;
				 ...
				 u32 mclk_rate, u32 dmic_clk_rate)
{
	...
	dev_dbg(component->dev, "%s: mclk_rate = %d, dmic_sample_rate = %d\n",
	...
	if (dmic_clk_rate == 0) {
		dev_err(component->dev, "%s: dmic_sample_rate cannot be 0\n",
			__func__);
		goto done;
	}
				   ...
				   struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		dmic_sample_rate =
			tasha_get_dmic_sample_rate(component, dmic, pdata);
		dmic_rate_val = tasha_get_dmic_clk_val(
			component, pdata->mclk_rate, dmic_sample_rate);

		(*dmic_clk_cnt)++;
		if (*dmic_clk_cnt == 1) {
			snd_soc_component_update_bits(
				component, dmic_clk_reg,
	...
	case SND_SOC_DAPM_POST_PMD:
		dmic_rate_val =
			tasha_get_dmic_clk_val(component, pdata->mclk_rate,
...
static int tasha_codec_ldo_h_control(struct snd_soc_dapm_widget *w, int event)
{
	struct snd_soc_component *component =
		snd_soc_dapm_to_component(w->dapm);
	struct tasha_priv *tasha = snd_soc_component_get_drvdata(component);
	...
	if (SND_SOC_DAPM_EVENT_ON(event)) {
		...
		if (tasha->ldo_h_users == 1)
			snd_soc_component_update_bits(
				component, WCD9335_LDOH_MODE, 0x80, 0x80);
	}
	...
	if (SND_SOC_DAPM_EVENT_OFF(event)) {
		...
		if (tasha->ldo_h_users == 0)
			snd_soc_component_update_bits(
				component, WCD9335_LDOH_MODE, 0x80, 0x00);
	}
...
static int
tasha_codec_enable_standalone_ldo_h(struct snd_soc_component *component,
				    bool enable)
{
	int rc;
...
{
	const char *const micb_names[] = { DAPM_MICBIAS1_STANDALONE,
					   DAPM_MICBIAS2_STANDALONE,
					   DAPM_MICBIAS3_STANDALONE,
					   DAPM_MICBIAS4_STANDALONE };
	int micb_index = micb_num - 1;
	int rc;
				 ...
				 struct snd_ctl_elem_value *ucontrol)
{
	...
	if (mode_val == 0) {
		dev_warn(component->dev,
			 "%s:Invalid HPH Mode, default to Cls-H HiFi\n",
			 __func__);
		mode_val = CLS_H_HIFI;
	}
...
static const char *const tasha_conn_mad_text[] = {
	"NOTUSED1", "ADC1",	"ADC2",	    "ADC3",    "ADC4",	"ADC5",
	"ADC6",	    "NOTUSED2", "DMIC0",    "DMIC1",   "DMIC2", "DMIC3",
	"DMIC4",    "DMIC5",	"NOTUSED3", "NOTUSED4"
};

static const struct soc_enum tasha_conn_mad_enum = SOC_ENUM_SINGLE_EXT(
	ARRAY_SIZE(tasha_conn_mad_text), tasha_conn_mad_text);
			       ...
			       struct snd_ctl_elem_value *ucontrol)
{
	...
	tasha_mad_input =
		snd_soc_component_read32(component, WCD9335_SOC_MAD_INP_SEL) &
		0x0F;
	ucontrol->value.integer.value[0] = tasha_mad_input;

	dev_dbg(component->dev, "%s: tasha_mad_input = %s\n", __func__,
			       ...
			       struct snd_ctl_elem_value *ucontrol)
{
	...
	if (strnstr(tasha_conn_mad_text[tasha_mad_input], "ADC",
		    sizeof("ADC"))) {
		mad_input =
			strpbrk(tasha_conn_mad_text[tasha_mad_input], "123456");
		if (!mad_input) {
	...
	dev_dbg(component->dev, "%s: tasha input widget = %s\n", __func__,
		mad_input_widget);
	...
	for (i = 0; i < card->num_of_dapm_routes; i++) {
		if (!strcmp(card->of_dapm_routes[i].sink, mad_input_widget)) {
			...
			if (strnstr(source_widget, "MIC BIAS1",
				    sizeof("MIC BIAS1"))) {
				mic_bias_found = 1;
				break;
			} else if (strnstr(source_widget, "MIC BIAS2",
					   sizeof("MIC BIAS2"))) {
				mic_bias_found = 2;
				break;
			} else if (strnstr(source_widget, "MIC BIAS3",
					   sizeof("MIC BIAS3"))) {
				mic_bias_found = 3;
				break;
			} else if (strnstr(source_widget, "MIC BIAS4",
					   sizeof("MIC BIAS4"))) {
				mic_bias_found = 4;
				break;
			}
	...
	snd_soc_component_update_bits(component, WCD9335_SOC_MAD_INP_SEL, 0x0F,
				      tasha_mad_input);
	snd_soc_component_update_bits(component, WCD9335_ANA_MAD_SETUP, 0x07,
				      mic_bias_found);
				 ...
				 struct snd_ctl_elem_value *ucontrol)
{
	...
	dev_dbg(component->dev,
		"%s: reg=0x%x mask=0x%x val=%d reg=0x%x val=%d\n", __func__,
		ctl_reg, mask, ctl_val, cfg_reg, cfg_val);
					...
					struct snd_soc_component *component)
{
   ...
   */
	snd_soc_component_update_bits(component, WCD9335_BIAS_CTL, 0x82, 0x82);
	...
	snd_soc_component_update_bits(component, WCD9335_CDC_VBAT_VBAT_DEBUG1,
				      0x01, 0x01);
	snd_soc_component_update_bits(component, WCD9335_ANA_VBADC, 0x80, 0x80);
	snd_soc_component_update_bits(component, WCD9335_VBADC_SUBBLOCK_EN,
				      0x20, 0x00);
	snd_soc_component_update_bits(component, WCD9335_VBADC_FE_CTRL, 0x20,
				      0x20);
	/* Wait 100 usec after calibration select as Vbg */
	usleep_range(100, 110);

	snd_soc_component_update_bits(component, WCD9335_VBADC_ADC_IO, 0x40,
				      0x40);
	...
	snd_soc_component_update_bits(component, WCD9335_VBADC_SUBBLOCK_EN,
				      0x20, 0x20);
	snd_soc_component_update_bits(component, WCD9335_ANA_VBADC, 0x80, 0x00);
...
static int tasha_update_vbat_reg_config(struct snd_soc_component *component)
{
	...
	dev_dbg(component->dev,
		"%s: vbat_writes_sz: %d, vbat_sz_remaining: %zd\n", __func__,
		vbat_writes_size, vbat_size_remaining);

	if ((vbat_writes_size * TASHA_PACKED_REG_SIZE) > vbat_size_remaining) {
	...
	for (i = 0; i < vbat_writes_size; i++) {
		TASHA_CODEC_UNPACK_ENTRY(vbat_reg_ptr->writes[i], reg, mask,
					 val);
...
static const char *const tasha_vbat_gsm_mode_text[] = { "OFF", "ON" };
					...
					struct snd_ctl_elem_value *ucontrol)
{
	...
	if (ucontrol->value.integer.value[0])
		snd_soc_component_update_bits(
			component, WCD9335_CDC_VBAT_VBAT_CFG, 0x04, 0x04);
	else
		snd_soc_component_update_bits(
			component, WCD9335_CDC_VBAT_VBAT_CFG, 0x04, 0x00);
					 ...
					 int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		snd_soc_component_write(component, WCD9335_ANA_VBADC, 0x80);
		snd_soc_component_update_bits(component, vbat_path_cfg, 0x02,
					      0x02);
		snd_soc_component_update_bits(component, vbat_path_ctl, 0x10,
					      0x10);
	...
	case SND_SOC_DAPM_POST_PMD:
		if (tasha->vbat.is_enabled) {
			snd_soc_component_update_bits(component, vbat_cfg, 0x01,
						      0x00);
...
static const char *const rx_hph_mode_mux_text[] = { "CLS_H_INVALID",
						    "CLS_H_HIFI", "CLS_H_LP",
						    "CLS_AB", "CLS_H_LOHIFI" };
...
static const char *const amic_pwr_lvl_text[] = { "LOW_PWR", "DEFAULT",
						 "HIGH_PERF" };

static const struct soc_enum amic_pwr_lvl_enum =
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(amic_pwr_lvl_text), amic_pwr_lvl_text);
...
static const struct snd_kcontrol_new tasha_snd_controls[] = {
	SOC_SINGLE_S8_TLV("RX0 Digital Volume", WCD9335_CDC_RX0_RX_VOL_CTL, -84,
			  40, digital_gain), /* -84dB min - 40dB max */
	...
	SOC_SINGLE_S8_TLV("RX0 Mix Digital Volume",
			  ...
			  digital_gain), /* -84dB min - 40dB max */
	...
	SOC_SINGLE_S8_TLV("DEC0 Volume", WCD9335_CDC_TX0_TX_VOL_CTL, -84, 40,
			  digital_gain),
	SOC_SINGLE_S8_TLV("DEC1 Volume", WCD9335_CDC_TX1_TX_VOL_CTL, -84, 40,
			  digital_gain),
	SOC_SINGLE_S8_TLV("DEC2 Volume", WCD9335_CDC_TX2_TX_VOL_CTL, -84, 40,
			  digital_gain),
	SOC_SINGLE_S8_TLV("DEC3 Volume", WCD9335_CDC_TX3_TX_VOL_CTL, -84, 40,
			  digital_gain),
	SOC_SINGLE_S8_TLV("DEC4 Volume", WCD9335_CDC_TX4_TX_VOL_CTL, -84, 40,
			  digital_gain),
	SOC_SINGLE_S8_TLV("DEC5 Volume", WCD9335_CDC_TX5_TX_VOL_CTL, -84, 40,
			  digital_gain),
	SOC_SINGLE_S8_TLV("DEC6 Volume", WCD9335_CDC_TX6_TX_VOL_CTL, -84, 40,
			  digital_gain),
	SOC_SINGLE_S8_TLV("DEC7 Volume", WCD9335_CDC_TX7_TX_VOL_CTL, -84, 40,
			  digital_gain),
	SOC_SINGLE_S8_TLV("DEC8 Volume", WCD9335_CDC_TX8_TX_VOL_CTL, -84, 40,
			  digital_gain),

	SOC_SINGLE_S8_TLV("IIR0 INP0 Volume",
			  WCD9335_CDC_SIDETONE_IIR0_IIR_GAIN_B1_CTL, -84, 40,
			  digital_gain),
	SOC_SINGLE_S8_TLV("IIR0 INP1 Volume",
			  WCD9335_CDC_SIDETONE_IIR0_IIR_GAIN_B2_CTL, -84, 40,
			  digital_gain),
	SOC_SINGLE_S8_TLV("IIR0 INP2 Volume",
			  WCD9335_CDC_SIDETONE_IIR0_IIR_GAIN_B3_CTL, -84, 40,
			  digital_gain),
	SOC_SINGLE_S8_TLV("IIR0 INP3 Volume",
			  WCD9335_CDC_SIDETONE_IIR0_IIR_GAIN_B4_CTL, -84, 40,
			  digital_gain),
	SOC_SINGLE_S8_TLV("IIR1 INP0 Volume",
			  WCD9335_CDC_SIDETONE_IIR1_IIR_GAIN_B1_CTL, -84, 40,
			  digital_gain),
	SOC_SINGLE_S8_TLV("IIR1 INP1 Volume",
			  WCD9335_CDC_SIDETONE_IIR1_IIR_GAIN_B2_CTL, -84, 40,
			  digital_gain),
	SOC_SINGLE_S8_TLV("IIR1 INP2 Volume",
			  WCD9335_CDC_SIDETONE_IIR1_IIR_GAIN_B3_CTL, -84, 40,
			  digital_gain),
	SOC_SINGLE_S8_TLV("IIR1 INP3 Volume",
			  WCD9335_CDC_SIDETONE_IIR1_IIR_GAIN_B4_CTL, -84, 40,
			  digital_gain),
	...
	SOC_SINGLE_EXT("IIR0 Enable Band1", IIR0, BAND1, 1, 0,
		       tasha_get_iir_enable_audio_mixer,
		       tasha_put_iir_enable_audio_mixer),
	...
	SOC_SINGLE_MULTI_EXT("IIR0 Band1", IIR0, BAND1, 255, 0, 5,
			     tasha_get_iir_band_audio_mixer,
	...
	SOC_ENUM_EXT("RX HPH Mode", rx_hph_mode_mux_enum, tasha_rx_hph_mode_get,
		     tasha_rx_hph_mode_put),

	SOC_ENUM_EXT("MAD Input", tasha_conn_mad_enum, tasha_mad_input_get,
		     tasha_mad_input_put),
				     ...
				     struct snd_ctl_elem_value *ucontrol)
{
	...
	snd_soc_component_update_bits(component, look_ahead_dly_reg, 0x08,
				      (val ? 0x08 : 0x00));
	/* Set DEM INP Select */
	return snd_soc_dapm_put_enum_double(kcontrol, ucontrol);
}
				 ...
				 struct snd_ctl_elem_value *ucontrol)
{
	...
	snd_soc_component_update_bits(component, WCD9335_ANA_EAR, 0x70,
				      ear_pa_gain);
	return 0;
}
				  ...
				  int interp_n, int event)
{
	...
	if (SND_SOC_DAPM_EVENT_ON(event)) {
		...
		snd_soc_component_update_bits(component, comp_ctl0_reg, 0x01,
					      0x01);
		snd_soc_component_update_bits(component, comp_ctl0_reg, 0x02,
					      0x02);
		snd_soc_component_update_bits(component, comp_ctl0_reg, 0x02,
					      0x00);
		snd_soc_component_update_bits(component, rx_path_cfg0_reg, 0x02,
					      0x02);
	}

	if (SND_SOC_DAPM_EVENT_OFF(event)) {
		snd_soc_component_update_bits(component, comp_ctl0_reg, 0x04,
					      0x04);
		snd_soc_component_update_bits(component, rx_path_cfg0_reg, 0x02,
					      0x00);
		snd_soc_component_update_bits(component, comp_ctl0_reg, 0x02,
...
static int tasha_codec_config_mad(struct snd_soc_component *component)
{
	...
	if (!mad_cal) {
		dev_err(component->dev, "%s: Invalid calibration data\n",
			__func__);
		ret = -EINVAL;
		goto done;
	}
	...
	snd_soc_component_update_bits(
		component, WCD9335_SOC_MAD_MAIN_CTL_1, 0xFF << 3,
	...
	snd_soc_component_update_bits(component, WCD9335_SOC_MAD_AUDIO_CTL_1,
				      0x07 << 4,
				      mad_cal->audio_info.rms_comp_time << 4);
	snd_soc_component_update_bits(
		component, WCD9335_SOC_MAD_AUDIO_CTL_2, 0x03 << 2,
	...
	for (idx = 0; idx < ARRAY_SIZE(mad_cal->audio_info.iir_coefficients);
	     idx++) {
		snd_soc_component_update_bits(component,
					      WCD9335_SOC_MAD_AUDIO_IIR_CTL_PTR,
					      0x3F, idx);
		snd_soc_component_write(
			component, WCD9335_SOC_MAD_AUDIO_IIR_CTL_VAL,
	...
	snd_soc_component_update_bits(component, WCD9335_SOC_MAD_BEACON_CTL_1,
				      0x07 << 4,
				      mad_cal->beacon_info.rms_comp_time << 4);
	snd_soc_component_update_bits(
		component, WCD9335_SOC_MAD_BEACON_CTL_2, 0x03 << 2,
	...
	for (idx = 0; idx < ARRAY_SIZE(mad_cal->beacon_info.iir_coefficients);
	     idx++) {
		snd_soc_component_update_bits(
			component, WCD9335_SOC_MAD_BEACON_IIR_CTL_PTR, 0x3F,
			idx);
		snd_soc_component_write(
			component, WCD9335_SOC_MAD_BEACON_IIR_CTL_VAL,
	...
	/* Ultrasound */
	snd_soc_component_update_bits(
		component, WCD9335_SOC_MAD_ULTR_CTL_1, 0x07 << 4,
		mad_cal->ultrasound_info.rms_comp_time << 4);
	snd_soc_component_update_bits(
		component, WCD9335_SOC_MAD_ULTR_CTL_2, 0x03 << 2,
					   ...
					   int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		snd_soc_component_update_bits(
			component, WCD9335_CDC_TX1_TX_PATH_CTL, 0x0F, 0x01);

		break;
	case SND_SOC_DAPM_POST_PMD:
		/* Reset DEC1 Tx out sample rate */
		snd_soc_component_update_bits(
			component, WCD9335_CDC_TX1_TX_PATH_CTL, 0x0F, 0x04);
		snd_soc_component_update_bits(component, WCD9335_CPE_SS_SVA_CFG,
					      0x01, 0x00);
...
static int
tasha_codec_aif4_mixer_switch_get(struct snd_kcontrol *kcontrol,
				  struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_dapm_widget *widget =
		snd_soc_dapm_kcontrol_widget(kcontrol);
...
static int
tasha_codec_aif4_mixer_switch_put(struct snd_kcontrol *kcontrol,
				  struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_dapm_widget *widget =
		snd_soc_dapm_kcontrol_widget(kcontrol);
...
static const char *const tasha_ear_pa_gain_text[] = { "G_6_DB",	   "G_4P5_DB",
						      "G_3_DB",	   "G_1P5_DB",
						      "G_0_DB",	   "G_M2P5_DB",
						      "UNDEFINED", "G_M12_DB" };

static const char *const tasha_ear_spkr_pa_gain_text[] = {
	"G_DEFAULT", "G_0_DB", "G_1_DB", "G_2_DB",
	"G_3_DB",    "G_4_DB", "G_5_DB", "G_6_DB"
};

static const char *const tasha_speaker_boost_stage_text[] = { "NO_MAX_STATE",
							      "MAX_STATE_1",
							      "MAX_STATE_2" };

static const struct soc_enum tasha_ear_pa_gain_enum = SOC_ENUM_SINGLE_EXT(
	ARRAY_SIZE(tasha_ear_pa_gain_text), tasha_ear_pa_gain_text);

static const struct soc_enum tasha_ear_spkr_pa_gain_enum = SOC_ENUM_SINGLE_EXT(
	ARRAY_SIZE(tasha_ear_spkr_pa_gain_text), tasha_ear_spkr_pa_gain_text);
...
static const char *const rx_sidetone_mix_text[] = { "ZERO", "SRC0", "SRC1",
						    "SRC_SUM" };
...
static const char *const sb_tx9_mux_text[] = { "ZERO", "DEC7", "DEC7_192" };

static const char *const sb_tx10_mux_text[] = { "ZERO", "DEC6", "DEC6_192" };

static const char *const sb_tx11_mux_text[] = { "DEC_0_5", "DEC_9_12",
						"MAD_AUDIO", "MAD_BRDCST" };

static const char *const sb_tx11_inp1_mux_text[] = {
	"ZERO", "DEC0", "DEC1",	      "DEC2",	 "DEC3",
	"DEC4", "DEC5", "RX_MIX_TX5", "DEC9_10", "DEC11_12"
};

static const char *const sb_tx13_mux_text[] = { "ZERO", "DEC5", "DEC5_192" };

static const char *const tx13_inp_mux_text[] = { "CDC_DEC_5", "MAD_BRDCST",
						 "CPE_TX_PP" };

static const char *const iir_inp_mux_text[] = {
	"ZERO", "DEC0", "DEC1", "DEC2", "DEC3", "DEC4", "DEC5", "DEC6", "DEC7",
	"DEC8", "RX0",	"RX1",	"RX2",	"RX3",	"RX4",	"RX5",	"RX6",	"RX7"
};
...
static const char *const mad_sel_text[] = { "SPE", "MSM" };
...
static const char *const rx_echo_mux_text[] = {
	...
	"RX_MIX3",	"RX_MIX4",     "RX_MIX5",      "RX_MIX6",
	"RX_MIX7",	"RX_MIX8",     "RX_MIX_VBAT5", "RX_MIX_VBAT6",
	"RX_MIX_VBAT7", "RX_MIX_VBAT8"
};

static const char *const anc0_fb_mux_text[] = { "ZERO", "ANC_IN_HPHL",
						"ANC_IN_EAR", "ANC_IN_EAR_SPKR",
						"ANC_IN_LO1" };

static const char *const anc1_fb_mux_text[] = { "ZERO", "ANC_IN_HPHR",
						"ANC_IN_LO2" };
...
static const struct soc_enum spl_src0_mux_chain_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_SPLINE_SRC_CFG0, 0, 3, spl_src0_mux_text);

static const struct soc_enum spl_src1_mux_chain_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_SPLINE_SRC_CFG0, 2, 3, spl_src1_mux_text);

static const struct soc_enum spl_src2_mux_chain_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_SPLINE_SRC_CFG0, 4, 3, spl_src2_mux_text);

static const struct soc_enum spl_src3_mux_chain_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_SPLINE_SRC_CFG0, 6, 3, spl_src3_mux_text);
...
static const struct soc_enum int1_1_native_enum = SOC_ENUM_SINGLE(
	SND_SOC_NOPM, 0, ARRAY_SIZE(native_mux_text), native_mux_text);

static const struct soc_enum int2_1_native_enum = SOC_ENUM_SINGLE(
	SND_SOC_NOPM, 0, ARRAY_SIZE(native_mux_text), native_mux_text);

static const struct soc_enum int3_1_native_enum = SOC_ENUM_SINGLE(
	SND_SOC_NOPM, 0, ARRAY_SIZE(native_mux_text), native_mux_text);

static const struct soc_enum int4_1_native_enum = SOC_ENUM_SINGLE(
	SND_SOC_NOPM, 0, ARRAY_SIZE(native_mux_text), native_mux_text);
...
static const struct soc_enum rx_int0_sidetone_mix_chain_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_SIDETONE_SRC_CFG0, 0, 4, rx_sidetone_mix_text);

static const struct soc_enum rx_int1_sidetone_mix_chain_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_SIDETONE_SRC_CFG0, 2, 4, rx_sidetone_mix_text);

static const struct soc_enum rx_int2_sidetone_mix_chain_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_SIDETONE_SRC_CFG0, 4, 4, rx_sidetone_mix_text);

static const struct soc_enum rx_int3_sidetone_mix_chain_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_SIDETONE_SRC_CFG0, 6, 4, rx_sidetone_mix_text);

static const struct soc_enum rx_int4_sidetone_mix_chain_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_SIDETONE_SRC_CFG1, 0, 4, rx_sidetone_mix_text);

static const struct soc_enum rx_int7_sidetone_mix_chain_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_SIDETONE_SRC_CFG1, 2, 4, rx_sidetone_mix_text);
...
static const struct soc_enum tx_adc_mux10_chain_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_TX_INP_MUX_ADC_MUX10_CFG0, 6, 4, adc_mux_text);

static const struct soc_enum tx_adc_mux11_chain_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_TX_INP_MUX_ADC_MUX11_CFG0, 6, 4, adc_mux_text);

static const struct soc_enum tx_adc_mux12_chain_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_TX_INP_MUX_ADC_MUX12_CFG0, 6, 4, adc_mux_text);

static const struct soc_enum tx_adc_mux13_chain_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_TX_INP_MUX_ADC_MUX13_CFG0, 6, 4, adc_mux_text);
...
static const struct soc_enum tx_dmic_mux10_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_TX_INP_MUX_ADC_MUX10_CFG0, 3, 7, dmic_mux_alt_text);

static const struct soc_enum tx_dmic_mux11_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_TX_INP_MUX_ADC_MUX11_CFG0, 3, 7, dmic_mux_alt_text);

static const struct soc_enum tx_dmic_mux12_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_TX_INP_MUX_ADC_MUX12_CFG0, 3, 7, dmic_mux_alt_text);

static const struct soc_enum tx_dmic_mux13_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_TX_INP_MUX_ADC_MUX13_CFG0, 3, 7, dmic_mux_alt_text);
...
static const struct soc_enum tx_amic_mux10_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_TX_INP_MUX_ADC_MUX10_CFG0, 0, 7, amic_mux_text);

static const struct soc_enum tx_amic_mux11_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_TX_INP_MUX_ADC_MUX11_CFG0, 0, 7, amic_mux_text);

static const struct soc_enum tx_amic_mux12_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_TX_INP_MUX_ADC_MUX12_CFG0, 0, 7, amic_mux_text);

static const struct soc_enum tx_amic_mux13_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_TX_INP_MUX_ADC_MUX13_CFG0, 0, 7, amic_mux_text);
...
static const struct soc_enum sb_tx9_mux_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_IF_ROUTER_TX_MUX_CFG2, 2, 3, sb_tx9_mux_text);

static const struct soc_enum sb_tx10_mux_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_IF_ROUTER_TX_MUX_CFG2, 4, 3, sb_tx10_mux_text);

static const struct soc_enum sb_tx11_mux_enum = SOC_ENUM_SINGLE(
	WCD9335_DATA_HUB_DATA_HUB_SB_TX11_INP_CFG, 0, 4, sb_tx11_mux_text);

static const struct soc_enum sb_tx11_inp1_mux_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_IF_ROUTER_TX_MUX_CFG3, 0, 10, sb_tx11_inp1_mux_text);

static const struct soc_enum sb_tx13_mux_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_IF_ROUTER_TX_MUX_CFG3, 4, 3, sb_tx13_mux_text);

static const struct soc_enum tx13_inp_mux_enum = SOC_ENUM_SINGLE(
	WCD9335_DATA_HUB_DATA_HUB_SB_TX13_INP_CFG, 0, 3, tx13_inp_mux_text);

static const struct soc_enum rx_mix_tx0_mux_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_RX_MIX_CFG0, 0, 14, rx_echo_mux_text);

static const struct soc_enum rx_mix_tx1_mux_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_RX_MIX_CFG0, 4, 14, rx_echo_mux_text);

static const struct soc_enum rx_mix_tx2_mux_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_RX_MIX_CFG1, 0, 14, rx_echo_mux_text);

static const struct soc_enum rx_mix_tx3_mux_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_RX_MIX_CFG1, 4, 14, rx_echo_mux_text);

static const struct soc_enum rx_mix_tx4_mux_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_RX_MIX_CFG2, 0, 14, rx_echo_mux_text);

static const struct soc_enum rx_mix_tx5_mux_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_RX_MIX_CFG2, 4, 14, rx_echo_mux_text);

static const struct soc_enum rx_mix_tx6_mux_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_RX_MIX_CFG3, 0, 14, rx_echo_mux_text);

static const struct soc_enum rx_mix_tx7_mux_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_RX_MIX_CFG3, 4, 14, rx_echo_mux_text);

static const struct soc_enum rx_mix_tx8_mux_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_RX_MIX_CFG4, 0, 14, rx_echo_mux_text);
...
static const struct soc_enum anc0_fb_mux_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_ANC_CFG0, 0, 5, anc0_fb_mux_text);

static const struct soc_enum anc1_fb_mux_enum = SOC_ENUM_SINGLE(
	WCD9335_CDC_RX_INP_MUX_ANC_CFG0, 3, 3, anc1_fb_mux_text);
...
static const struct snd_kcontrol_new tx_adc_mux0 =
	SOC_DAPM_ENUM_EXT("ADC MUX0 Mux", tx_adc_mux0_chain_enum,
			  snd_soc_dapm_get_enum_double, tasha_put_dec_enum);
...
static const struct snd_kcontrol_new aif4_switch_mixer_controls =
	SOC_SINGLE_EXT("Switch", SND_SOC_NOPM, 0, 1, 0,
		       tasha_codec_aif4_mixer_switch_get,
					 ...
					 int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		snd_soc_component_update_bits(component, WCD9335_CPE_SS_CFG,
					      0x08, 0x08);
		snd_soc_component_update_bits(component,
...
static const char *const ec_buf_mux_text[] = {
	"ZERO",		"RXMIXEC",	"SB_RX0",	"SB_RX1",
	"SB_RX2",	"SB_RX3",	"I2S_RX_SD0_L", "I2S_RX_SD0_R",
	"I2S_RX_SD1_L", "I2S_RX_SD1_R", "DEC1"
};

static SOC_ENUM_SINGLE_DECL(ec_buf_mux_enum, WCD9335_CPE_SS_US_EC_MUX_CFG, 0,
			    ec_buf_mux_text);
...
static const struct snd_soc_dapm_widget tasha_dapm_widgets[] = {
	...
	SND_SOC_DAPM_MIXER_E("RX INT7 CHAIN", SND_SOC_NOPM, 0, 0, NULL, 0,
			     tasha_codec_spk_boost_event,
			     SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_MIXER_E("RX INT8 CHAIN", SND_SOC_NOPM, 0, 0, NULL, 0,
			     tasha_codec_spk_boost_event,
			     SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	...
	SND_SOC_DAPM_MUX("RX INT0 MIX2 INP", WCD9335_CDC_RX0_RX_PATH_CFG1, 4, 0,
			 &rx_int0_mix2_inp_mux),
	SND_SOC_DAPM_MUX("RX INT1 MIX2 INP", WCD9335_CDC_RX1_RX_PATH_CFG1, 4, 0,
			 &rx_int1_mix2_inp_mux),
	SND_SOC_DAPM_MUX("RX INT2 MIX2 INP", WCD9335_CDC_RX2_RX_PATH_CFG1, 4, 0,
			 &rx_int2_mix2_inp_mux),
	SND_SOC_DAPM_MUX("RX INT3 MIX2 INP", WCD9335_CDC_RX3_RX_PATH_CFG1, 4, 0,
			 &rx_int3_mix2_inp_mux),
	SND_SOC_DAPM_MUX("RX INT4 MIX2 INP", WCD9335_CDC_RX4_RX_PATH_CFG1, 4, 0,
			 &rx_int4_mix2_inp_mux),
	SND_SOC_DAPM_MUX("RX INT7 MIX2 INP", WCD9335_CDC_RX7_RX_PATH_CFG1, 4, 0,
	...
	SND_SOC_DAPM_MUX("SLIM TX13 MUX", SND_SOC_NOPM, TASHA_TX13, 0,
			 &sb_tx13_mux),
	SND_SOC_DAPM_MUX("TX13 INP MUX", SND_SOC_NOPM, 0, 0, &tx13_inp_mux),
	...
	SND_SOC_DAPM_MUX_E("ADC MUX10", SND_SOC_NOPM, 10, 0, &tx_adc_mux10,
			   tasha_codec_tx_adc_cfg, SND_SOC_DAPM_POST_PMU),

	SND_SOC_DAPM_MUX_E("ADC MUX11", SND_SOC_NOPM, 11, 0, &tx_adc_mux11,
			   tasha_codec_tx_adc_cfg, SND_SOC_DAPM_POST_PMU),

	SND_SOC_DAPM_MUX_E("ADC MUX12", SND_SOC_NOPM, 12, 0, &tx_adc_mux12,
			   tasha_codec_tx_adc_cfg, SND_SOC_DAPM_POST_PMU),

	SND_SOC_DAPM_MUX_E("ADC MUX13", SND_SOC_NOPM, 13, 0, &tx_adc_mux13,
			   tasha_codec_tx_adc_cfg, SND_SOC_DAPM_POST_PMU),
	...
	SND_SOC_DAPM_MUX("DMIC MUX10", SND_SOC_NOPM, 0, 0, &tx_dmic_mux10),
	SND_SOC_DAPM_MUX("DMIC MUX11", SND_SOC_NOPM, 0, 0, &tx_dmic_mux11),
	SND_SOC_DAPM_MUX("DMIC MUX12", SND_SOC_NOPM, 0, 0, &tx_dmic_mux12),
	SND_SOC_DAPM_MUX("DMIC MUX13", SND_SOC_NOPM, 0, 0, &tx_dmic_mux13),
	...
	SND_SOC_DAPM_MUX("AMIC MUX10", SND_SOC_NOPM, 0, 0, &tx_amic_mux10),
	SND_SOC_DAPM_MUX("AMIC MUX11", SND_SOC_NOPM, 0, 0, &tx_amic_mux11),
	SND_SOC_DAPM_MUX("AMIC MUX12", SND_SOC_NOPM, 0, 0, &tx_amic_mux12),
	SND_SOC_DAPM_MUX("AMIC MUX13", SND_SOC_NOPM, 0, 0, &tx_amic_mux13),
	...
	SND_SOC_DAPM_SUPPLY("RX INT1 NATIVE SUPPLY", SND_SOC_NOPM, INTERP_HPHL,
			    0, tasha_enable_native_supply,
			    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_PRE_PMD),

	SND_SOC_DAPM_SUPPLY("RX INT2 NATIVE SUPPLY", SND_SOC_NOPM, INTERP_HPHR,
			    0, tasha_enable_native_supply,
			    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_PRE_PMD),

	SND_SOC_DAPM_SUPPLY("RX INT3 NATIVE SUPPLY", SND_SOC_NOPM, INTERP_LO1,
			    0, tasha_enable_native_supply,
			    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_PRE_PMD),

	SND_SOC_DAPM_SUPPLY("RX INT4 NATIVE SUPPLY", SND_SOC_NOPM, INTERP_LO2,
			    0, tasha_enable_native_supply,
			    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_PRE_PMD),
	...
	SND_SOC_DAPM_SUPPLY(DAPM_LDO_H_STANDALONE, SND_SOC_NOPM, 0, 0,
			    ...
			    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_SUPPLY("tx regulator", SND_SOC_NOPM, ON_DEMAND_TX_SUPPLY,
			    0, tasha_codec_enable_on_demand_supply,
			    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_SUPPLY("rx regulator", SND_SOC_NOPM, ON_DEMAND_RX_SUPPLY,
			    0, tasha_codec_enable_on_demand_supply,
			    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	...
	SND_SOC_DAPM_AIF_OUT_E("AIF4 VI", "VIfeed", 0, SND_SOC_NOPM,
			       AIF4_VIFEED, 0,
			       tasha_codec_enable_slimvi_feedback,
			       SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_POST_PMD),
	...
	SND_SOC_DAPM_MIXER_E("IIR0", WCD9335_CDC_SIDETONE_IIR0_IIR_PATH_CTL, 4,
			     0, NULL, 0, tasha_codec_set_iir_gain,
			     SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
	SND_SOC_DAPM_MIXER_E("IIR1", WCD9335_CDC_SIDETONE_IIR1_IIR_PATH_CTL, 4,
			     0, NULL, 0, tasha_codec_set_iir_gain,
			     SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
	SND_SOC_DAPM_MIXER("SRC0", WCD9335_CDC_SIDETONE_SRC0_ST_SRC_PATH_CTL, 4,
			   0, NULL, 0),
	SND_SOC_DAPM_MIXER("SRC1", WCD9335_CDC_SIDETONE_SRC1_ST_SRC_PATH_CTL, 4,
			   0, NULL, 0),
	SND_SOC_DAPM_MIXER_E("CPE IN Mixer", SND_SOC_NOPM, 0, 0,
			     cpe_in_mix_switch, ARRAY_SIZE(cpe_in_mix_switch),
	...
	SND_SOC_DAPM_MUX("RX INT4_1 NATIVE MUX", SND_SOC_NOPM, 0, 0,
			 &int4_1_native_mux),
	SND_SOC_DAPM_MUX("RX MIX TX0 MUX", SND_SOC_NOPM, 0, 0, &rx_mix_tx0_mux),
	SND_SOC_DAPM_MUX("RX MIX TX1 MUX", SND_SOC_NOPM, 0, 0, &rx_mix_tx1_mux),
	SND_SOC_DAPM_MUX("RX MIX TX2 MUX", SND_SOC_NOPM, 0, 0, &rx_mix_tx2_mux),
	SND_SOC_DAPM_MUX("RX MIX TX3 MUX", SND_SOC_NOPM, 0, 0, &rx_mix_tx3_mux),
	SND_SOC_DAPM_MUX("RX MIX TX4 MUX", SND_SOC_NOPM, 0, 0, &rx_mix_tx4_mux),
	SND_SOC_DAPM_MUX("RX MIX TX5 MUX", SND_SOC_NOPM, 0, 0, &rx_mix_tx5_mux),
	SND_SOC_DAPM_MUX("RX MIX TX6 MUX", SND_SOC_NOPM, 0, 0, &rx_mix_tx6_mux),
	SND_SOC_DAPM_MUX("RX MIX TX7 MUX", SND_SOC_NOPM, 0, 0, &rx_mix_tx7_mux),
	SND_SOC_DAPM_MUX("RX MIX TX8 MUX", SND_SOC_NOPM, 0, 0, &rx_mix_tx8_mux),
	...
	SND_SOC_DAPM_MUX_E("RX INT0 INTERP", SND_SOC_NOPM, INTERP_EAR, 0,
			   &rx_int0_interp_mux, tasha_codec_enable_interpolator,
			   SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
				   SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_MUX_E("RX INT1 INTERP", SND_SOC_NOPM, INTERP_HPHL, 0,
			   &rx_int1_interp_mux, tasha_codec_enable_interpolator,
			   SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
				   SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_MUX_E("RX INT2 INTERP", SND_SOC_NOPM, INTERP_HPHR, 0,
			   &rx_int2_interp_mux, tasha_codec_enable_interpolator,
			   SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
				   SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_MUX_E("RX INT3 INTERP", SND_SOC_NOPM, INTERP_LO1, 0,
			   &rx_int3_interp_mux, tasha_codec_enable_interpolator,
			   SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
				   SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_MUX_E("RX INT4 INTERP", SND_SOC_NOPM, INTERP_LO2, 0,
			   &rx_int4_interp_mux, tasha_codec_enable_interpolator,
			   SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
				   SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_MUX_E("RX INT5 INTERP", SND_SOC_NOPM, INTERP_LO3, 0,
			   &rx_int5_interp_mux, tasha_codec_enable_interpolator,
			   SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
				   SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_MUX_E("RX INT6 INTERP", SND_SOC_NOPM, INTERP_LO4, 0,
			   &rx_int6_interp_mux, tasha_codec_enable_interpolator,
			   SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
				   SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_MUX_E("RX INT7 INTERP", SND_SOC_NOPM, INTERP_SPKR1, 0,
			   &rx_int7_interp_mux, tasha_codec_enable_interpolator,
			   SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
				   SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_MUX_E("RX INT8 INTERP", SND_SOC_NOPM, INTERP_SPKR2, 0,
			   &rx_int8_interp_mux, tasha_codec_enable_interpolator,
			   SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
				   SND_SOC_DAPM_POST_PMD),

	SND_SOC_DAPM_DAC_E("RX INT0 DAC", NULL, SND_SOC_NOPM, 0, 0,
			   tasha_codec_ear_dac_event,
			   SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
				   SND_SOC_DAPM_PRE_PMD |
				   SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_DAC_E("RX INT1 DAC", NULL, SND_SOC_NOPM, 0, 0,
			   tasha_codec_hphl_dac_event,
			   SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
				   SND_SOC_DAPM_PRE_PMD |
				   SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_DAC_E("RX INT2 DAC", NULL, SND_SOC_NOPM, 0, 0,
			   tasha_codec_hphr_dac_event,
			   SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
				   SND_SOC_DAPM_PRE_PMD |
				   SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_DAC_E("RX INT3 DAC", NULL, SND_SOC_NOPM, 0, 0,
			   tasha_codec_lineout_dac_event,
			   SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	...
	SND_SOC_DAPM_PGA_E("ANC HPHR PA", SND_SOC_NOPM, 0, 0, NULL, 0,
			   ...
			   SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
				   SND_SOC_DAPM_PRE_PMD |
				   SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_PGA_E("ANC LINEOUT1 PA", WCD9335_ANA_LO_1_2, 7, 0, NULL, 0,
			   tasha_codec_enable_lineout_pa,
			   SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD |
				   SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_PGA_E("ANC LINEOUT2 PA", WCD9335_ANA_LO_1_2, 6, 0, NULL, 0,
			   tasha_codec_enable_lineout_pa,
			   SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD |
				   SND_SOC_DAPM_POST_PMD),
	...
	/* MAD related widgets */
	SND_SOC_DAPM_AIF_OUT_E("AIF4 MAD", "AIF4 MAD TX", 0, SND_SOC_NOPM, 0, 0,
			       tasha_codec_enable_mad,
			       SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),

	SND_SOC_DAPM_MUX("MAD_SEL MUX", SND_SOC_NOPM, 0, 0, &mad_sel_mux),
	SND_SOC_DAPM_INPUT("MAD_CPE_INPUT"),
	SND_SOC_DAPM_INPUT("MADINPUT"),
	SND_SOC_DAPM_SWITCH("MADONOFF", SND_SOC_NOPM, 0, 0, &aif4_mad_switch),
...
static int tasha_get_channel_map(struct snd_soc_dai *dai, unsigned int *tx_num,
...
static int tasha_set_channel_map(struct snd_soc_dai *dai, unsigned int tx_num,
				 unsigned int *tx_slot, unsigned int rx_num,
				 unsigned int *rx_slot)
{
	struct tasha_priv *tasha;
	...
	if (tasha->intf_type == WCD9XXX_INTERFACE_TYPE_SLIMBUS) {
		wcd9xxx_init_slimslave(core, core->slim->laddr, tx_num, tx_slot,
				       rx_num, rx_slot);
				    ...
				    u8 tx_fs_rate_reg_val, u32 sample_rate)
{
	...
	list_for_each_entry(ch, &tasha->dai[dai->id].wcd9xxx_ch_list, list) {
		...
		if ((tx_port < 0) || (tx_port == 12) || (tx_port >= 14)) {
			dev_err(component->dev,
				"%s: Invalid SLIM TX%u port. DAI ID: %d\n",
		...
		if (decimator >= 0) {
			tx_fs_reg =
				WCD9335_CDC_TX0_TX_PATH_CTL + 16 * decimator;
			dev_dbg(component->dev,
				"%s: set DEC%u (-> SLIM_TX%u) rate to %u\n",
			...
			dev_dbg(component->dev,
				"%s: RX_MIX_TX%u going to SLIM TX%u\n",
		...
		for (j = 0; j < TASHA_NUM_INTERPOLATORS; j++) {
			...
			if (int_mux_cfg1_val == int_2_inp) {
				int_fs_reg = WCD9335_CDC_RX0_RX_PATH_MIX_CTL +
					     20 * j;
				pr_debug(
					"%s: AIF_MIX_PB DAI(%d) connected to INT%u_2\n",
					__func__, dai->id, j);
				pr_debug("%s: set INT%u_2 sample rate to %u\n",
					 __func__, j, sample_rate);
				snd_soc_component_update_bits(
					component, int_fs_reg, 0x0F,
     ...
     */
		for (j = 0; j < TASHA_NUM_INTERPOLATORS; j++) {
			...
			if ((inp0_sel == int_1_mix1_inp) ||
				...
				int_fs_reg =
					WCD9335_CDC_RX0_RX_PATH_CTL + 20 * j;
				pr_debug(
...
static int tasha_set_interpolator_rate(struct snd_soc_dai *dai, u32 sample_rate)
{
	int rate_val = 0;
	int i, ret;
	...
	if ((i == ARRAY_SIZE(int_mix_sample_rate_val)) || (rate_val < 0))
		goto prim_rate;
	ret = tasha_set_mix_interpolator_rate(dai, (u8)rate_val, sample_rate);
prim_rate:
	...
	if ((i == ARRAY_SIZE(int_prim_sample_rate_val)) || (rate_val < 0))
		return -EINVAL;
	ret = tasha_set_prim_interpolator_rate(dai, (u8)rate_val, sample_rate);
	return ret;
}
			   ...
			   struct snd_soc_dai *dai)
{
	...
	case SNDRV_PCM_STREAM_PLAYBACK:
		...
		if (tasha->intf_type == WCD9XXX_INTERFACE_TYPE_I2C) {
			...
			snd_soc_component_update_bits(
				component, WCD9335_DATA_HUB_DATA_HUB_RX_I2S_CTL,
				0x20, i2s_bit_mode << 5);
			snd_soc_component_update_bits(
				component, WCD9335_DATA_HUB_DATA_HUB_RX_I2S_CTL,
				0x1c, (rx_fs_rate << 2));
	...
	case SNDRV_PCM_STREAM_CAPTURE:
		...
		if (dai->id != AIF4_VIFEED && dai->id != AIF4_MAD_TX) {
		...
		if (tasha->intf_type == WCD9XXX_INTERFACE_TYPE_I2C) {
			snd_soc_component_update_bits(
				component, WCD9335_DATA_HUB_DATA_HUB_TX_I2S_CTL,
				0x20, i2s_bit_mode << 5);
			if (tx_fs_rate > 1)
				tx_fs_rate--;
			snd_soc_component_update_bits(
...
static int tasha_set_dai_sysclk(struct snd_soc_dai *dai, int clk_id,
...
static void tasha_codec_power_gate_digital_core(struct tasha_priv *tasha)
{
	...
	wcd9xxx_set_power_state(tasha->wcd9xxx, WCD_REGION_POWER_COLLAPSE_BEGIN,
				WCD9XXX_DIG_CORE_REGION_1);
	snd_soc_component_update_bits(
		component, WCD9335_CODEC_RPM_PWR_CDC_DIG_HM_CTL, 0x04, 0x04);
	snd_soc_component_update_bits(
		component, WCD9335_CODEC_RPM_PWR_CDC_DIG_HM_CTL, 0x01, 0x00);
	snd_soc_component_update_bits(
		component, WCD9335_CODEC_RPM_PWR_CDC_DIG_HM_CTL, 0x02, 0x00);
...
static int
tasha_dig_core_remove_power_collapse(struct snd_soc_component *component)
{
	struct tasha_priv *tasha = snd_soc_component_get_drvdata(component);

	tasha_codec_vote_max_bw(component, true);
	snd_soc_component_write(component, WCD9335_CODEC_RPM_PWR_CDC_DIG_HM_CTL,
				0x5);
	snd_soc_component_write(component, WCD9335_CODEC_RPM_PWR_CDC_DIG_HM_CTL,
				0x7);
	snd_soc_component_write(component, WCD9335_CODEC_RPM_PWR_CDC_DIG_HM_CTL,
	...
	regcache_sync_region(component->regmap, TASHA_DIG_CORE_REG_MIN,
			     TASHA_DIG_CORE_REG_MAX);
	tasha_codec_vote_max_bw(component, false);
	...
	if (req_state == POWER_COLLAPSE) {
		if (tasha->power_active_ref == 0) {
			schedule_delayed_work(
				...
				msecs_to_jiffies(dig_core_collapse_timer *
						 1000));
		}
	} else if (req_state == POWER_RESUME) {
       ...
       */
			cur_state = wcd9xxx_get_current_power_state(
				tasha->wcd9xxx, WCD9XXX_DIG_CORE_REGION_1);
...
static int __tasha_cdc_mclk_enable_locked(struct tasha_priv *tasha, bool enable)
{
	int ret = 0;
	...
	if (enable) {
		...
		tasha_codec_apply_sido_voltage(tasha, SIDO_VOLTAGE_NOMINAL_MV);
	} else {
		if (!dig_core_collapse_enable) {
			clear_bit(AUDIO_NOMINAL, &tasha->status_mask);
...
int tasha_cdc_mclk_enable(struct snd_soc_component *component, int enable,
			  bool dapm)
{
	struct tasha_priv *tasha = snd_soc_component_get_drvdata(component);
...
int tasha_cdc_mclk_tx_enable(struct snd_soc_component *component, int enable,
			     bool dapm)
{
	struct tasha_priv *tasha = snd_soc_component_get_drvdata(component);
	int ret = 0;
	...
	if (tasha->clk_mode || tasha->clk_internal) {
		if (enable) {
			...
			snd_soc_component_update_bits(
				component,
				WCD9335_CDC_CLK_RST_CTRL_FS_CNT_CONTROL, 0x01,
				0x01);
			snd_soc_component_update_bits(
				component,
				WCD9335_CDC_CLK_RST_CTRL_MCLK_CONTROL, 0x01,
				0x01);
			set_bit(CPE_NOMINAL, &tasha->status_mask);
			tasha_codec_update_sido_voltage(
				tasha, SIDO_VOLTAGE_NOMINAL_MV);
					...
					struct snd_soc_component *component)
{
	...
	card = component->card;
	tasha->entry =
		snd_info_create_subdir(codec_root->module, "tasha", codec_root);
	if (!tasha->entry) {
	...
	if (!version_entry) {
		dev_dbg(component->dev,
			"%s: failed to create wcd9335 version entry\n",
			__func__);
		return -ENOMEM;
	}
...
static int __tasha_codec_internal_rco_ctrl(struct snd_soc_component *component,
					   bool enable)
{
	struct tasha_priv *tasha = snd_soc_component_get_drvdata(component);
	int ret = 0;
	...
	if (enable) {
		tasha_cdc_sido_ccl_enable(tasha, true);
		if (wcd_resmgr_get_clk_type(tasha->resmgr) == WCD_CLK_RCO) {
		...
		ret = wcd_resmgr_disable_clk_block(tasha->resmgr, WCD_CLK_RCO);
		tasha_cdc_sido_ccl_enable(tasha, false);
	}
...
static void tasha_update_reg_reset_values(struct snd_soc_component *component)
{
	...
	if (TASHA_IS_1_1(tasha_core)) {
		for (i = 0; i < ARRAY_SIZE(tasha_reg_update_reset_val_1_1); i++)
			snd_soc_component_write(
				component,
...
static void tasha_codec_init_reg(struct snd_soc_component *component)
{
	...
	for (i = 0; i < ARRAY_SIZE(tasha_codec_reg_init_common_val); i++)
		snd_soc_component_update_bits(
			component, tasha_codec_reg_init_common_val[i].reg,
			tasha_codec_reg_init_common_val[i].mask,
			tasha_codec_reg_init_common_val[i].val);

	if (TASHA_IS_1_1(wcd9xxx) || TASHA_IS_1_0(wcd9xxx))
		for (i = 0; i < ARRAY_SIZE(tasha_codec_reg_init_1_x_val); i++)
			snd_soc_component_update_bits(
				component, tasha_codec_reg_init_1_x_val[i].reg,
	...
	if (TASHA_IS_1_1(wcd9xxx)) {
		for (i = 0; i < ARRAY_SIZE(tasha_codec_reg_init_val_1_1); i++)
			snd_soc_component_update_bits(
				component, tasha_codec_reg_init_val_1_1[i].reg,
		...
		for (i = 0; i < ARRAY_SIZE(tasha_codec_reg_init_val_1_0); i++)
			snd_soc_component_update_bits(
				component, tasha_codec_reg_init_val_1_0[i].reg,
		...
		for (i = 0; i < ARRAY_SIZE(tasha_codec_reg_init_val_2_0); i++)
			snd_soc_component_update_bits(
				component, tasha_codec_reg_init_val_2_0[i].reg,
...
static void tasha_slim_interface_init_reg(struct snd_soc_component *component)
{
	...
	for (i = 0; i < WCD9XXX_SLIM_NUM_PORT_REG; i++)
		wcd9xxx_interface_reg_write(
			priv->wcd9xxx, TASHA_SLIM_PGD_PORT_INT_EN0 + i, 0xFF);
}
...
static irqreturn_t tasha_slimbus_irq(int irq, void *data)
{
	...
	for_each_set_bit(j, &status, 32) {
		...
		port_id = (tx ? j - 16 : j);
		val = wcd9xxx_interface_reg_read(
			priv->wcd9xxx, TASHA_SLIM_PGD_PORT_INT_RX_SOURCE0 + j);
		if (val) {
			if (!tx)
				...
				reg = TASHA_SLIM_PGD_PORT_INT_TX_EN0 +
				      (port_id / 8);
			int_val =
				wcd9xxx_interface_reg_read(priv->wcd9xxx, reg);
			/*
       ...
       */
		...
		if ((val & TASHA_SLIM_IRQ_OVERFLOW) ||
			...
			if (int_val & (1 << (port_id % 8))) {
				...
				wcd9xxx_interface_reg_write(priv->wcd9xxx, reg,
							    int_val);
			}
		}
			      ...
			      struct wcd9xxx_pdata *pdata)
{
	...
	snd_soc_component_update_bits(component, WCD9335_ANA_MICB1, 0x3F,
				      vout_ctl_1);
	snd_soc_component_update_bits(component, WCD9335_ANA_MICB2, 0x3F,
				      vout_ctl_2);
	snd_soc_component_update_bits(component, WCD9335_ANA_MICB3, 0x3F,
				      vout_ctl_3);
	snd_soc_component_update_bits(component, WCD9335_ANA_MICB4, 0x3F,
				      vout_ctl_4);
	...
	if (pdata->dmic_sample_rate == WCD9XXX_DMIC_SAMPLE_RATE_UNDEFINED) {
		dev_info(component->dev, "%s: dmic_rate invalid default = %d\n",
			 __func__, def_dmic_rate);
		pdata->dmic_sample_rate = def_dmic_rate;
	}
	if (pdata->mad_dmic_sample_rate == WCD9XXX_DMIC_SAMPLE_RATE_UNDEFINED) {
		dev_info(component->dev,
			 "%s: mad_dmic_rate invalid default = %d\n", __func__,
			 def_dmic_rate);
		/*
	...
	if (pdata->dmic_clk_drv == WCD9XXX_DMIC_CLK_DRIVE_UNDEFINED) {
   ...
   */
	mad_dmic_ctl_val = tasha_get_dmic_clk_val(tasha->component,
						  pdata->mclk_rate,
						  pdata->mad_dmic_sample_rate);
	snd_soc_component_update_bits(component, WCD9335_CPE_SS_DMIC0_CTL, 0x0E,
				      mad_dmic_ctl_val << 1);
	snd_soc_component_update_bits(component, WCD9335_CPE_SS_DMIC1_CTL, 0x0E,
				      mad_dmic_ctl_val << 1);
	snd_soc_component_update_bits(component, WCD9335_CPE_SS_DMIC2_CTL, 0x0E,
				      mad_dmic_ctl_val << 1);

	dmic_ctl_val = tasha_get_dmic_clk_val(
		tasha->component, pdata->mclk_rate, pdata->dmic_sample_rate);
...
static struct wcd_cpe_core *
tasha_codec_get_cpe_core(struct snd_soc_component *component)
{
	struct tasha_priv *priv = snd_soc_component_get_drvdata(component);
...
static int
tasha_codec_cpe_fll_update_divider(struct snd_soc_component *component,
				   u32 cpe_fll_rate)
{
	struct wcd9xxx *wcd9xxx = dev_get_drvdata(component->dev->parent);
	struct tasha_priv *tasha = snd_soc_component_get_drvdata(component);
	...
	if (cpe_fll_rate != CPE_FLL_CLK_75MHZ &&
		...
		dev_err(component->dev, "%s: Invalid CPE fll rate request %u\n",
	...
	if (wcd9xxx->mclk_rate == TASHA_MCLK_CLK_12P288MHZ) {
		...
		snd_soc_component_update_bits(
			component, WCD9335_CPE_FLL_USER_CTL_0, 0x7C, 0x70);
		snd_soc_component_update_bits(
			component, WCD9335_CPE_FLL_USER_CTL_1, 0xE0, 0x20);
		div_val = 8;
	} else {
		dev_err(component->dev, "%s: Invalid MCLK rate %u\n", __func__,
			wcd9xxx->mclk_rate);
		return -EINVAL;
	}

	l_val = ((cpe_fll_rate / 1000) * div_val) / (wcd9xxx->mclk_rate / 1000);
				      ...
				      u32 clk_freq)
{
	...
	if (clk_freq == CPE_FLL_CLK_75MHZ) {
		/* Change to SVS */
		snd_soc_component_update_bits(
			component, WCD9335_CPE_FLL_FLL_MODE, 0x08, 0x08);
		...
		snd_soc_component_update_bits(
			component, WCD9335_CPE_FLL_FLL_MODE, 0x10, 0x10);
	...
	snd_soc_component_update_bits(component, WCD9335_CPE_FLL_FLL_MODE, 0x10,
				      0x00);
	snd_soc_component_update_bits(component, WCD9335_CPE_FLL_FLL_MODE, 0x08,
				      0x00);
	return ret;
}
				      ...
				      bool enable)
{
	...
	if (enable) {
		if (tasha_cdc_is_svs_enabled(tasha)) {
			...
			if (tasha_codec_cpe_fll_update_divider(
				    component, CPE_FLL_CLK_75MHZ)) {
				dev_err(component->dev,
					"%s: clk change to %d failed\n",
					__func__, CPE_FLL_CLK_75MHZ);
				return -EINVAL;
		...
		/* program the PLL */
		snd_soc_component_update_bits(
			component, WCD9335_CPE_FLL_USER_CTL_0, 0x01, 0x01);

		/* TEST clk setting */
		snd_soc_component_update_bits(
			component, WCD9335_CPE_FLL_TEST_CTL_0, 0x80, 0x80);
		/* set FLL mode to HW controlled */
		snd_soc_component_update_bits(
			component, WCD9335_CPE_FLL_FLL_MODE, 0x60, 0x00);
		...
		snd_soc_component_update_bits(
			component, WCD9335_CPE_FLL_TEST_CTL_0, 0x80, 0x00);
		/* undo FLL mode to HW control */
		snd_soc_component_write(component, WCD9335_CPE_FLL_FLL_MODE,
					0x00);
		snd_soc_component_update_bits(
			component, WCD9335_CPE_FLL_FLL_MODE, 0x60, 0x20);
		/* undo the PLL */
		snd_soc_component_update_bits(
			component, WCD9335_CPE_FLL_USER_CTL_0, 0x01, 0x00);
					 ...
					 struct cpe_svc_cfg_clk_plan *clk_freq)
{
	...
	dev_dbg(component->dev, "%s: current_clk_freq = %u\n", __func__,
...
static void tasha_cdc_change_cpe_clk(void *data, u32 clk_freq)
{
	struct snd_soc_component *component = data;
	struct tasha_priv *tasha;
	...
	dev_dbg(component->dev,
		...
		__func__, clk_freq * 1000, tasha->current_cpe_clk_freq);
				   ...
				   bool vote)
{
	...
	if (vote) {
		...
		if (tasha->ref_count == 1) {
			...
			tasha_codec_slim_reserve_bw(component, bw_ops, true);
		}
	...
	dev_dbg(component->dev,
		"%s Value of counter after vote or un-vote is %d\n", __func__,
		tasha->ref_count);
				     ...
				     u8 *status)
{
	...
	case CPE_ERR_IRQ_CLEAR:
		snd_soc_component_write(
			component, WCD9335_CPE_SS_SS_ERROR_INT_CLEAR, irq_bits);
		break;
	case CPE_ERR_IRQ_STATUS:
		if (!status)
			return -EINVAL;
		*status = snd_soc_component_read32(
			component, WCD9335_CPE_SS_SS_ERROR_INT_STATUS);
		break;
	}
...
static int tasha_cpe_initialize(struct snd_soc_component *component)
{
	...
	memset(&cpe_params, 0, sizeof(struct wcd_cpe_params));
	...
	cpe_params.cdc_irq_info.cpe_engine_irq = WCD9335_IRQ_SVA_OUTBOX1;
	cpe_params.cdc_irq_info.cpe_err_irq = WCD9335_IRQ_SVA_ERROR;
	cpe_params.cdc_irq_info.cpe_fatal_irqs = TASHA_CPE_FATAL_IRQS;

	cpe_svc_params.context = component;
	cpe_params.cpe_svc_params = &cpe_svc_params;

	tasha->cpe_core = wcd_cpe_init("cpe_9335", component, &cpe_params);
	if (IS_ERR_OR_NULL(tasha->cpe_core)) {
		dev_err(component->dev, "%s: Failed to enable CPE\n", __func__);
		return -EINVAL;
	}
...
static int tasha_post_reset_cb(struct wcd9xxx *wcd9xxx)
{
	...
	tasha_slimbus_slave_port_cfg.slave_dev_pgd_la = control->slim->laddr;
	...
	if (control->mclk_rate == TASHA_MCLK_CLK_12P288MHZ)
		snd_soc_component_update_bits(
			component, WCD9335_CODEC_RPM_CLK_MCLK_CFG, 0x03, 0x00);
	else if (control->mclk_rate == TASHA_MCLK_CLK_9P6MHZ)
		snd_soc_component_update_bits(
			component, WCD9335_CODEC_RPM_CLK_MCLK_CFG, 0x03, 0x01);
...
tasha_codec_find_ondemand_regulator(struct snd_soc_component *component,
				    const char *name)
{
	int i;
	struct tasha_priv *tasha = snd_soc_component_get_drvdata(component);
...
static int tasha_codec_probe(struct snd_soc_component *component)
{
	...
	for (i = ON_DEMAND_MICBIAS; i < ON_DEMAND_SUPPLIES_MAX; i++) {
		supply = tasha_codec_find_ondemand_regulator(
			component, on_demand_supply_name[i]);
		if (supply) {
			tasha->on_demand_list[i].supply = supply;
			tasha->on_demand_list[i].ondemand_supply_count = 0;
		}
	}

	tasha->fw_data = devm_kzalloc(component->dev, sizeof(*(tasha->fw_data)),
				      GFP_KERNEL);
	if (!tasha->fw_data)
		goto err;
	...
	ret = wcd_cal_create_hwdep(tasha->fw_data, WCD9XXX_CODEC_HWDEP_NODE,
				   component);
	if (ret < 0) {
	...
	ptr = devm_kzalloc(component->dev,
			   (sizeof(tasha_rx_chs) + sizeof(tasha_tx_chs)),
			   GFP_KERNEL);
	if (!ptr) {
		ret = -ENOMEM;
		goto err_hwdep;
	...
	if (tasha->intf_type == WCD9XXX_INTERFACE_TYPE_I2C) {
		...
		tasha_slimbus_slave_port_cfg.slave_dev_pgd_la =
			control->slim->laddr;
		tasha_slimbus_slave_port_cfg.slave_port_mapping[0] = TASHA_TX13;
		tasha_init_slim_slave_cfg(component);
	}
	...
	if (tasha->is_wsa_attach)
		snd_soc_add_component_controls(
			component, tasha_spkr_wsa_controls,
...
static int tasha_swrm_read(void *handle, int reg)
{
	...
	ret = regmap_bulk_write(wcd9xxx->regmap, swr_rd_addr_base, (u8 *)&reg,
				4);
	if (ret < 0) {
	...
	/* Check for RD status */
	ret = regmap_bulk_read(wcd9xxx->regmap, swr_rd_data_base, (u8 *)&val,
			       4);
	if (ret < 0) {
				     ...
				     size_t len)
{
	...
	for (i = 0; i < (len * 2); i += 2) {
		...
		ret = regmap_bulk_write(wcd9xxx->regmap, swr_wr_data_base,
					bulk_reg[i].buf, 4);
		if (ret < 0) {
		...
		/* Next Write Address */
		ret = regmap_bulk_write(wcd9xxx->regmap, swr_wr_addr_base,
					bulk_reg[i + 1].buf, 4);
		if (ret < 0) {
...
static int tasha_swrm_bulk_write(void *handle, u32 *reg, u32 *val, size_t len)
{
	...
	bulk_reg =
		kzalloc((2 * len * sizeof(struct wcd9xxx_reg_val)), GFP_KERNEL);
	if (!bulk_reg)
		return -ENOMEM;
	...
	if (wcd9xxx_get_intf_type() == WCD9XXX_INTERFACE_TYPE_I2C) {
		...
		if (ret) {
			dev_err(tasha->dev,
				"%s: i2s bulk write failed, ret: %d\n",
				__func__, ret);
		}
	} else {
		ret = wcd9xxx_slim_bulk_write(wcd9xxx, bulk_reg, (len * 2),
					      false);
		if (ret) {
			dev_err(tasha->dev,
				"%s: swrm bulk write failed, ret: %d\n",
				__func__, ret);
		}
	}
				 ...
				 void *swrm_handle, int action)
{
	...
	if (action) {
		ret = wcd9xxx_request_irq(&wcd9xxx->core_res,
					  ...
					  swrm_irq_handler, "Tasha SWR Master",
					  swrm_handle);
		if (ret)
	...
	for_each_child_of_node(wcd9xxx->dev->of_node, node) {
		...
		if (!strcmp(node->name, "swr_master")) {
			temp = krealloc(
				swr_ctrl_data,
				(ctrl_num + 1) *
					sizeof(struct tasha_swr_ctrl_data),
				GFP_KERNEL);
			if (!temp) {
...
static int tasha_remove(struct platform_device *pdev)
{
	...
	for (count = 0;
	     count < tasha->child_count && count < WCD9335_CHILD_DEVICES_MAX;
	     count++)
