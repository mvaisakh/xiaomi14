...
static const struct zdet_dnl_entry zdet_dnl_table[] = {
	{ 0, 0, 0 },	    { 5, 56, 13 },	 { 10, 60, 34 },
	{ 15, 13, -4 },	    { 20, 21, 14 },	 { 25, -16, -20 },
	{ 30, 5, 7 },	    { 35, -46, -90 },	 { 40, -4, -17 },
	{ 45, -74, -40 },   { 50, -52, 3 },	 { 55, -37, -5 },
	{ 60, 4, -79 },	    { 65, -34, -82 },	 { 70, -105, -33 },
	{ 75, -81, -55 },   { 80, -39, 34 },	 { 85, -37, 46 },
	{ 90, -51, 81 },    { 95, 14, 132 },	 { 100, 101, 197 },
	{ 105, 150, 247 },  { 110, 217, 245 },	 { 115, 232, -189 },
	{ 120, 201, -146 }, { 125, -152, -121 }, { 130, -157, -69 },
	{ 135, -118, -72 }, { 140, -54, -24 },	 { 145, -55, 51 },
};

static struct wcd_mbhc_register wcd_mbhc_registers[WCD_MBHC_REG_FUNC_MAX] = {
	WCD_MBHC_REGISTER("WCD_MBHC_L_DET_EN", WCD939X_MBHC_MECH, 0x80, 7, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_GND_DET_EN", WCD939X_MBHC_MECH, 0x40, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_MECH_DETECTION_TYPE", WCD939X_MBHC_MECH,
			  0x20, 5, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_MIC_CLAMP_CTL", WCD939X_PLUG_DETECT_CTL,
			  0x30, 4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ELECT_DETECTION_TYPE", WCD939X_MBHC_ELECT,
			  0x08, 3, 0),
	...
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_PLUG_TYPE", WCD939X_MBHC_MECH, 0x10, 4,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_GND_PLUG_TYPE", WCD939X_MBHC_MECH, 0x08, 3,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_SW_HPH_LP_100K_TO_GND", WCD939X_MBHC_MECH,
			  0x01, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ELECT_SCHMT_ISRC", WCD939X_MBHC_ELECT, 0x06,
			  1, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_FSM_EN", WCD939X_MBHC_ELECT, 0x80, 7, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_INSREM_DBNC", WCD939X_PLUG_DETECT_CTL, 0x0F,
			  0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_BTN_DBNC", WCD939X_CTL_1, 0x03, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HS_VREF", WCD939X_CTL_2, 0x03, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HS_COMP_RESULT", WCD939X_MBHC_RESULT_3,
			  0x08, 3, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_IN2P_CLAMP_STATE", WCD939X_MBHC_RESULT_3,
			  0x10, 4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_MIC_SCHMT_RESULT", WCD939X_MBHC_RESULT_3,
			  0x20, 5, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_SCHMT_RESULT", WCD939X_MBHC_RESULT_3,
			  0x80, 7, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHR_SCHMT_RESULT", WCD939X_MBHC_RESULT_3,
			  0x40, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_OCP_FSM_EN", WCD939X_HPH_OCP_CTL, 0x10, 4,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_BTN_RESULT", WCD939X_MBHC_RESULT_3, 0x07, 0,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_BTN_ISRC_CTL", WCD939X_MBHC_ELECT, 0x70, 4,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_ELECT_RESULT", WCD939X_MBHC_RESULT_3, 0xFF,
			  0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_MICB_CTRL", WCD939X_MICB2, 0xC0, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPH_CNP_WG_TIME", WCD939X_CNP_WG_TIME, 0xFF,
			  0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHR_PA_EN", WCD939X_HPH, 0x40, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_PA_EN", WCD939X_HPH, 0x80, 7, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPH_PA_EN", WCD939X_HPH, 0xC0, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_SWCH_LEVEL_REMOVE", WCD939X_MBHC_RESULT_3,
			  0x10, 4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_PULLDOWN_CTRL", 0, 0, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ANC_DET_EN", WCD939X_CTL_BCS, 0x02, 1, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_FSM_STATUS", WCD939X_FSM_STATUS, 0x01, 0,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_MUX_CTL", WCD939X_CTL_2, 0x70, 4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_MOISTURE_STATUS", WCD939X_FSM_STATUS, 0x20,
			  5, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHR_GND", WCD939X_PA_CTL2, 0x40, 6, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_GND", WCD939X_PA_CTL2, 0x10, 4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_OCP_DET_EN", WCD939X_L_TEST, 0x01, 0,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHR_OCP_DET_EN", WCD939X_R_TEST, 0x01, 0,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHL_OCP_STATUS", WCD939X_INTR_STATUS_0,
			  0x80, 7, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_HPHR_OCP_STATUS", WCD939X_INTR_STATUS_0,
			  0x20, 5, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ADC_EN", WCD939X_CTL_1, 0x08, 3, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ADC_COMPLETE", WCD939X_FSM_STATUS, 0x40, 6,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_ADC_TIMEOUT", WCD939X_FSM_STATUS, 0x80, 7,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_ADC_RESULT", WCD939X_ADC_RESULT, 0xFF, 0,
			  0),
	WCD_MBHC_REGISTER("WCD_MBHC_MICB2_VOUT", WCD939X_MICB2, 0x3F, 0, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ADC_MODE", WCD939X_CTL_1, 0x10, 4, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_DETECTION_DONE", WCD939X_CTL_1, 0x04, 2, 0),
	WCD_MBHC_REGISTER("WCD_MBHC_ELECT_ISRC_EN", WCD939X_MBHC_ZDET, 0x02, 1,
			  0),
};
...
static int wcd939x_mbhc_free_irq(struct snd_soc_component *component, int irq,
				 void *data)
{
	struct wcd939x_priv *wcd939x = dev_get_drvdata(component->dev);
...
{
	if (enable)
		snd_soc_component_update_bits(component, WCD939X_CTL_1, 0x80,
					      0x80);
	else
		snd_soc_component_update_bits(component, WCD939X_CTL_1, 0x80,
					      0x00);
...
static bool wcd939x_mbhc_micb_en_status(struct wcd_mbhc *mbhc, int micb_num)
{
	...
	if (micb_num == MIC_BIAS_2) {
		val = ((snd_soc_component_read(mbhc->component, WCD939X_MICB2) &
			0xC0) >>
		       6);
		if (val == 0x01)
			return true;
...
{
	return (snd_soc_component_read(component, WCD939X_HPH) & 0xC0) ? true :
									 false;
}

static void
wcd939x_mbhc_hph_l_pull_up_control(struct snd_soc_component *component,
				   int pull_up_cur)
{
	...
	snd_soc_component_update_bits(component, WCD939X_MECH_DET_CURRENT, 0x1F,
				      pull_up_cur);
}
...
static int
wcd939x_mbhc_micb_ctrl_threshold_mic(struct snd_soc_component *component,
...
ramp_down:
	...
	mod_timer(&wcd939x_mbhc->rdown_timer,
		  jiffies + msecs_to_jiffies(RDOWN_TIMER_PERIOD_MSEC));
	while (x1) {
		regmap_read(wcd939x->regmap, WCD939X_MBHC_RESULT_1, &val);
		regmap_read(wcd939x->regmap, WCD939X_MBHC_RESULT_2, &val1);
		val = val << 0x08;
		val |= val1;
		x1 = WCD939X_MBHC_GET_X1(val);
		i++;
		if (i == WCD939X_ZDET_NUM_MEASUREMENTS)
			break;
		if (wcd939x_mbhc->rdown_timer_complete &&
		    wcd939x_mbhc->rdown_prev_iter == val)
			break;
		wcd939x_mbhc->rdown_prev_iter = val;
	}
				   ...
				   int32_t *zl, int32_t *zr, s16 *d1_a)
{
	...
	snd_soc_component_update_bits(component, WCD939X_MBHC_BTN7, 0xFC,
				      zdet_param->btn7);
	snd_soc_component_update_bits(component, WCD939X_ZDET_ANA_CTL, 0x0F,
				      zdet_param->noff);
	snd_soc_component_update_bits(component, WCD939X_ZDET_RAMP_CTL, 0x0F,
				      zdet_param->nshift);
	snd_soc_component_update_bits(component, WCD939X_ZDET_RAMP_CTL, 0x70,
				      0x60); /*acc1_min_63 */

	if (!zl)
		goto z_right;
	/* Start impedance measurement for HPH_L */
	regmap_update_bits(wcd939x->regmap, WCD939X_MBHC_ZDET, 0x80, 0x80);
	dev_dbg(wcd939x->dev, "%s: ramp for HPH_L, noff = %d\n", __func__,
		zdet_param->noff);
	wcd939x_mbhc_get_result_params(wcd939x, d1_a, zdet_param->noff, &zdet);
	regmap_update_bits(wcd939x->regmap, WCD939X_MBHC_ZDET, 0x80, 0x00);
...
z_right:
	...
	regmap_update_bits(wcd939x->regmap, WCD939X_MBHC_ZDET, 0x40, 0x40);
	dev_dbg(wcd939x->dev, "%s: ramp for HPH_R, noff = %d\n", __func__,
		zdet_param->noff);
	wcd939x_mbhc_get_result_params(wcd939x, d1_a, zdet_param->noff, &zdet);
	regmap_update_bits(wcd939x->regmap, WCD939X_MBHC_ZDET, 0x40, 0x00);

	*zr = zdet;
}

static inline void
wcd939x_wcd_mbhc_qfuse_cal(struct snd_soc_component *component, int32_t *z_val,
			   int flag_l_r)
{
	s16 q1;
	int q1_cal;

	q1 = snd_soc_component_read(component, WCD939X_EFUSE_REG_21 + flag_l_r);
	if (q1 & 0x80)
...
{
	struct wcd939x_mbhc *wcd939x_mbhc =
		container_of(timer, struct wcd939x_mbhc, rdown_timer);

	wcd939x_mbhc->rdown_timer_complete = true;
}

static void update_hd2_codes(struct regmap *regmap, u32 r_gnd_res_tot_mohms,
			     u32 r_load_eff_mohms)
{
	...
	if (!regmap)
		return;
	hd2_delta =
		(HD2_CODE_INV_RESOLUTION * (u64)r_gnd_res_tot_mohms +
		 FLOAT_TO_FIXED_XTALK *
			 (u64)((r_gnd_res_tot_mohms + r_load_eff_mohms) / 2)) /
		(FLOAT_TO_FIXED_XTALK *
		 (u64)(r_gnd_res_tot_mohms + r_load_eff_mohms));
...
static u8 get_xtalk_alpha(u32 gain, u8 scale)
{
	...
	alpha = (((gain * two_exp_scale - FLOAT_TO_FIXED_XTALK) * 255) +
		 round_offset) /
		FLOAT_TO_FIXED_XTALK;
...
{
	u32 r_gnd_res_tot_mohms = 0, r_gnd_int_fet_mohms = 0,
	    r_gnd_par_route1_mohms = 0;
	...
	if (pdata->usbcss_hs.xtalk.xtalk_config == XTALK_ANALOG) {
		...
		update_hd2_codes(wcd939x->regmap, r_gnd_res_tot_mohms,
				 r_load_eff_mohms);
	}
	...
	if (xtalk_gain_denom_l == 0) {
		...
		xtalk_gain_l = FLOAT_TO_FIXED_XTALK *
		...
		pdata->usbcss_hs.xtalk.alpha_l = get_xtalk_alpha(
			xtalk_gain_l, pdata->usbcss_hs.xtalk.scale_l);
	}
	...
	if (xtalk_gain_denom_r == 0) {
		...
		xtalk_gain_r = FLOAT_TO_FIXED_XTALK *
			       pdata->usbcss_hs.gnd.r_common_gnd_mohms /
			       xtalk_gain_denom_r;
		pdata->usbcss_hs.xtalk.scale_r = get_xtalk_scale(xtalk_gain_r);
		pdata->usbcss_hs.xtalk.alpha_r = get_xtalk_alpha(
			xtalk_gain_r, pdata->usbcss_hs.xtalk.scale_r);
	}

	/* Print relevant values */
	dev_dbg(wcd939x->dev, "%s: %s = %dmohms, %s = %dmohms, %s = %dmohms\n",
		__func__, "Left SE measurement", pdata->usbcss_hs.aud.l.zval,
		"right SE measurment", pdata->usbcss_hs.aud.r.zval,
		"differential measurement", pdata->usbcss_hs.zdiffval);
	dev_dbg(wcd939x->dev,
		"%s: %s = %dmohms, %s = %dmohms, %s = %dmohms, %s = %dmohms, %s = "
		"%dmohms\n",
		__func__, "R1_L", pdata->usbcss_hs.aud.l.r1, "R1_R",
		pdata->usbcss_hs.aud.r.r1, "R7", r7, "r_gnd_int_fet_mohms",
		r_gnd_int_fet_mohms, "r_common_gnd_mohms",
		pdata->usbcss_hs.gnd.r_common_gnd_mohms);
	dev_dbg(wcd939x->dev, "%s: %s = %d, %s = %d %s %d\n", __func__,
		"Xtalk gain (L->R)", xtalk_gain_l, "xtalk gain (R->L)",
		xtalk_gain_r,
		". To convert xtalk gain to floating point, divide by",
		FLOAT_TO_FIXED_XTALK);
}

static void update_ext_fet_res(struct wcd939x_pdata *pdata,
			       u32 r_aud_ext_fet_mohms, u32 r_gnd_ext_fet_mohms)
{
	if (!pdata)
		return;

	pdata->usbcss_hs.gnd.r_gnd_ext_fet_mohms =
		(r_gnd_ext_fet_mohms > MAX_USBCSS_HS_IMPEDANCE_MOHMS) ?
			MAX_USBCSS_HS_IMPEDANCE_MOHMS :
			r_gnd_ext_fet_mohms;
	pdata->usbcss_hs.aud.l.r_aud_ext_fet_mohms =
		(r_aud_ext_fet_mohms > MAX_USBCSS_HS_IMPEDANCE_MOHMS) ?
			MAX_USBCSS_HS_IMPEDANCE_MOHMS :
			r_aud_ext_fet_mohms;
...
{
	u32 r_gnd_res_tot_mohms = 0, r_gnd_int_fet_mohms = 0,
	    r_gnd_par_tot_mohms = 0;
	u32 v_aud1 = 0, v_aud2 = 0, aud_denom = 0;
	u32 r_load_eff_mohms = 0, r3 = 0, r_aud_ext_fet_mohms = 0,
	    r_aud_int_fet_mohms = 0;
	...
	aud_denom = (u32)(FLOAT_TO_FIXED_LINEARIZER +
			  (FLOAT_TO_FIXED_LINEARIZER *
			   pdata->usbcss_hs.aud.k_aud_times_100 / 100));
	...
	v_aud1 = FLOAT_TO_FIXED_LINEARIZER * v_aud1 /
		 (v_aud1 + r_aud_int_fet_mohms);
	v_aud2 = FLOAT_TO_FIXED_LINEARIZER * v_aud2 /
		 (v_aud2 + r_aud_ext_fet_mohms + r_aud_int_fet_mohms);

	*aud_tap = (u32)((s32)((1000 * v_aud1 +
				10 * pdata->usbcss_hs.aud.k_aud_times_100 *
					v_aud2 +
				aud_denom / 2) /
			       aud_denom) +
...
static void interpolate_zdet_val(uint32_t *z, s64 z_meas_bias_removed,
				 s64 z_val_slope_corrected, int lb,
				 int flag_se_diff)
{
	s64 lb_to_z = 0, lb_to_ub = 0, z_to_ub = 0, lb_corr = 0, ub_corr = 0,
	    z_interp = 0;

	/* If lb is the table upper bound, no interpolation needed, just use the lb
   * corr factor */
	if ((lb + 1) >= ARRAY_SIZE(zdet_dnl_table)) {
		z_interp = (s64)((flag_se_diff) ?
					 (zdet_dnl_table[lb].diff_corr_mohms) :
	...
	ub_corr = (s64)((flag_se_diff) ?
				(zdet_dnl_table[lb + 1].diff_corr_mohms) :
...
static int get_lb_zdet_base_val_index(uint32_t z_val)
{
	...
	/* Find the lower bound index, whose base value is the smallest value that is
   * still higher than the load
   */
	for (i = 1; i < ARRAY_SIZE(zdet_dnl_table); i++) {
		if (z_val <
		    (OHMS_TO_MILLIOHMS * (u32)zdet_dnl_table[i].base_val_ohms))
			return i - 1;
	}
...
static void apply_zdet_correction(uint32_t *z, int flag_se_diff,
				  ...
				  u32 diff_slope_factor_times_1000)
{
	...
	z_val_slope_corrected = ((s64)(u64)*z) *
				(FLOAT_TO_FIXED_XTALK)*slope_corr /
				SLOPE_FACTOR_SCALER / (FLOAT_TO_FIXED_XTALK);

	/* Interpolate correction term to bias out and apply correction */
	z_meas_bias_removed = (flag_se_diff) ? *z - DIFF_SLOPE_MEAS_BIAS :
					       *z - SE_SLOPE_MEAS_BIAS;
	lb = get_lb_zdet_base_val_index(z_meas_bias_removed);
	interpolate_zdet_val(z, (s64)(u64)z_meas_bias_removed,
			     z_val_slope_corrected, lb, flag_se_diff);
}

static void get_r_common_gnd(struct wcd939x_priv *wcd939x,
			     u32 r_gnd_res_tot_mohms, u32 r_gnd_int_fet_mohms,
			     u32 r_gnd_par_route1_mohms)
{
	...
	r_common_gnd_mohms = r_gnd_res_tot_mohms - r_gnd_int_fet_mohms -
			     r_gnd_par_route1_mohms;
   ...
   */
	...
	/* Otherwise, use the computed value and store it in the buffer, updating the
   * write index */
	...
	pdata->usbcss_hs.gnd.r_cm_gnd_buffer.write_index =
		(index + 1) % R_COMMON_GND_BUFFER_SIZE;
	dev_dbg(wcd939x->dev, "%s: %s %d %s\n", __func__,
		"The calculated r_common_gnd value,", r_common_gnd_mohms,
		"mohms, is being used");
}
				  ...
				  size_t count)
{
	...
	if (strcmp(attr->attr.name, "rdson_3p6v") == 0) {
		if (val > MAX_USBCSS_HS_IMPEDANCE_MOHMS) {
			dev_err(wcd939x->dev,
				"%s: Value %d out of HS impedance range %d\n",
		...
		update_linearizer = usbcss_hs->xtalk.xtalk_config ==
				    XTALK_ANALOG;
		...
		if (val < -MAX_USBCSS_HS_IMPEDANCE_MOHMS ||
			...
			dev_err(wcd939x->dev,
				"%s: Value %d out of bounds. Min: %d, Max: %d\n",
				__func__, val, -MAX_USBCSS_HS_IMPEDANCE_MOHMS,
				MAX_USBCSS_HS_IMPEDANCE_MOHMS);
			return count;
		}
	...
	} else if (strcmp(attr->attr.name, "diff_slope_factor_times_1000") ==
		   0) {
		if (val > MAX_DIFF_SLOPE_FACTOR ||
		    val < MIN_DIFF_SLOPE_FACTOR) {
			dev_err(wcd939x->dev,
				"%s: Value %d out of range of %d to %d\n",
				__func__, val, MIN_DIFF_SLOPE_FACTOR,
				MAX_DIFF_SLOPE_FACTOR);
			return count;
		}
	...
	case XTALK_DIGITAL:
		usbcss_hs->gnd.sbu1.r_gnd_par_route1_mohms =
			usbcss_hs->gnd.sbu1.r7;
		usbcss_hs->gnd.sbu2.r_gnd_par_route1_mohms =
			usbcss_hs->gnd.sbu2.r7;
...
static int create_sysfs_entry_file(struct wcd939x_priv *wcd939x, char *name,
...
static int usbcss_hs_sysfs_init(struct wcd939x_priv *wcd939x)
{
	...
	if (!kobj) {
		dev_err(wcd939x->dev,
			"%s: Could not create the USBC-SS HS kobj.\n",
			__func__);
		return -ENOMEM;
	}
					    ...
					    uint32_t *zr)
{
	...
	uint32_t zdiff_val = 0, r_gnd_int_fet_mohms = 0, rl_eff_l_mohms = 0,
		 rl_eff_r_mohms = 0;
	uint32_t r_gnd_ext_fet_mohms = 0, r_aud_ext_fet_mohms = 0,
		 r_gnd_res_tot_mohms = 0;
	uint32_t r_gnd_par_tot_mohms = 0, r_gnd_par_route1_mohms = 0;
	uint32_t aud_tap = LINEARIZER_DEFAULT_TAP, zdiff_counter = 0,
		 zdiff_sum = 0;
	...
	size_t i;
	bool is_fsm_disable = false, calculate_lin_aud_tap = false,
	     gnd_ext_fet_updated = false;
	struct wcd939x_mbhc_zdet_param zdet_param = {
		4, 0, 6, 0x18, 0x60, 0x78
	};
	struct wcd939x_mbhc_zdet_param *zdet_param_ptr = &zdet_param;
	s16 d1[] = { 0, 30, 30, 6 };
	uint32_t cached_regs[4][2] = { { WCD_USBSS_EXT_LIN_EN, 0 },
				       { WCD_USBSS_EXT_SW_CTRL_1, 0 },
				       { WCD_USBSS_MG1_BIAS, 0 },
				       { WCD_USBSS_MG2_BIAS, 0 } };
	uint32_t l_3_6V_regs[4][2] = { { WCD_USBSS_EXT_LIN_EN, 0x00 },
				       { WCD_USBSS_EXT_SW_CTRL_1, 0x00 },
				       { WCD_USBSS_MG1_BIAS, 0x0E },
				       { WCD_USBSS_MG2_BIAS, 0x0E } };
	uint32_t diff_regs[2][2] = { { WCD_USBSS_EXT_LIN_EN, 0x00 },
				     { WCD_USBSS_EXT_SW_CTRL_1, 0x00 } };
	...
	if (wcd939x->version == WCD939X_VERSION_2_0) {
		/* Start up Buck/Flyback, Enable RX bias, Use MBHC RCO for MBHC Zdet, Enable
     * Vneg */
		regmap_update_bits(wcd939x->regmap, WCD939X_ZDET_VNEG_CTL, 0x4E,
				   0x4E);
		/* Wait 100us for settling */
		usleep_range(100, 110);
		/* Enable VNEGDAC_LDO */
		regmap_update_bits(wcd939x->regmap, WCD939X_ZDET_VNEG_CTL, 0x10,
				   0x10);
		/* Wait 100us for settling */
		usleep_range(100, 110);
		/* Keep PA left/right channels disabled */
		regmap_update_bits(wcd939x->regmap, WCD939X_ZDET_VNEG_CTL, 0x01,
				   0x01);
		/* Enable VPOS */
		regmap_update_bits(wcd939x->regmap, WCD939X_ZDET_VNEG_CTL, 0x20,
				   0x20);
	...
	wcd_usbss_register_update(cached_regs, WCD_USBSS_READ,
				  ARRAY_SIZE(cached_regs));
	/* Disable 2k pulldown on MG for improved measurement */
	wcd_usbss_register_update(l_3_6V_regs, WCD_USBSS_WRITE,
				  ARRAY_SIZE(l_3_6V_regs));
#endif
	...
	if (snd_soc_component_read(component, WCD939X_MBHC_ELECT) & 0x80) {
		is_fsm_disable = true;
		regmap_update_bits(wcd939x->regmap, WCD939X_MBHC_ELECT, 0x80,
				   0x00);
	}

	/* For NO-jack, disable L_DET_EN before Z-det measurements */
	if (mbhc->hphl_swh)
		regmap_update_bits(wcd939x->regmap, WCD939X_MBHC_MECH, 0x80,
				   0x00);

	/* Turn off 100k pull down on HPHL */
	regmap_update_bits(wcd939x->regmap, WCD939X_MBHC_MECH, 0x01, 0x00);

	/* Disable surge protection before impedance detection.
   * This is done to give correct value for high impedance.
   */
	regmap_update_bits(wcd939x->regmap, WCD939X_HPHLR_SURGE_EN, 0xC0, 0x00);
	...
	if (mbhc->mbhc_cfg->enable_usbc_analog) {
		wcd_usbss_set_switch_settings_enable(SENSE_SWITCHES,
						     USBSS_SWITCH_DISABLE);
		wcd_usbss_set_switch_settings_enable(MIC_SWITCHES,
						     USBSS_SWITCH_DISABLE);
	}
#endif
	...
	if ((z1L == WCD939X_ZDET_FLOATING_IMPEDANCE) ||
		...
		*zl = z1L;
		...
		dev_dbg(component->dev,
			"%s: Calibrated left SE measurement is %d(mohms)\n",
			__func__, *zl);
		apply_zdet_correction(
			zl, ZDET_SE,
			pdata->usbcss_hs.se_slope_factor_times_1000,
			pdata->usbcss_hs.diff_slope_factor_times_1000);
	}
	...
	if ((z1R == WCD939X_ZDET_FLOATING_IMPEDANCE) ||
		...
		*zr = z1R;
		...
		dev_dbg(component->dev,
			"%s: Calibrated right SE measurement is %d(mohms)\n",
			__func__, *zr);
		apply_zdet_correction(
			zr, ZDET_SE,
			pdata->usbcss_hs.se_slope_factor_times_1000,
...
#if IS_ENABLED(CONFIG_QCOM_WCD_USBSS_I2C)
	/* Disable AGND switch */
	wcd_usbss_set_switch_settings_enable(AGND_SWITCHES,
					     USBSS_SWITCH_DISABLE);
	wcd_usbss_register_update(diff_regs, WCD_USBSS_WRITE,
				  ARRAY_SIZE(diff_regs));
#endif
	/* Enable HPHR NCLAMP */
	regmap_update_bits(wcd939x->regmap, WCD939X_HPHLR_SURGE_MISC1, 0x08,
			   0x08);
	/* Wait 3ms for settling */
	usleep_range(3000, 3010);
	/* Differential impedance */
	for (i = 0; i < NUM_DIFF_MEAS; i++) {
		wcd939x_mbhc_zdet_ramp(component, zdet_param_ptr, &z1Diff, NULL,
				       d1);
		...
		dev_dbg(component->dev,
			"%s: Calibrated and adjusted differential measurement %d is "
			"%d(mohms)\n",
			__func__, i + 1, *zdiff);
	}
	...
	dev_dbg(component->dev, "%s: %s %d(mohms)\n", __func__,
		"Average of the calibrated and adjusted differential measurement(s) is",
		*zdiff);
	/* Disable HPHR NCLAMP */
	regmap_update_bits(wcd939x->regmap, WCD939X_HPHLR_SURGE_MISC1, 0x08,
			   0x00);
	...
	dev_dbg(component->dev, "%s: %s : %d mohms\n", __func__,
		"The difference between the L and R SE measurements (L - R) is",
		z_L_R_delta_mohms);
	...
	if (pdata->usbcss_hs.aud.l.zval > ZDET_ACC_LMT_MOHMS ||
		...
		r_gnd_res_tot_mohms = pdata->usbcss_hs.gnd.rdson_mohms +
				      r_gnd_par_tot_mohms + r_gnd_int_fet_mohms;
		pdata->usbcss_hs.gnd.r_common_gnd_mohms =
			r_gnd_res_tot_mohms - r_gnd_int_fet_mohms -
			r_gnd_par_route1_mohms;
		...
		r_gnd_res_tot_mohms = (*zl + *zr - *zdiff +
				       pdata->usbcss_hs.aud.r_surge_mohms) /
				      2;
		/* Offset to account for using 3.6V SE measurements */
		r_gnd_res_tot_mohms =
			(pdata->usbcss_hs.gnd.gnd_ext_fet_delta_mohms >= 0) ?
				r_gnd_res_tot_mohms -
					(u32)(s32)pdata->usbcss_hs.gnd
						.gnd_ext_fet_delta_mohms :
				r_gnd_res_tot_mohms +
					(u32)(s32)(-1 *
						   pdata->usbcss_hs.gnd
							   .gnd_ext_fet_delta_mohms);
		/* Compute r_common_gnd */
		get_r_common_gnd(wcd939x, r_gnd_res_tot_mohms,
	...
	dev_dbg(component->dev, "%s: r_gnd_res_tot_mohms is : %d mohms\n",
		__func__, r_gnd_res_tot_mohms);
	/* Print r_common_gnd buffer */
	for (i = 0; i < R_COMMON_GND_BUFFER_SIZE; i++) {
		dev_dbg(component->dev,
			"%s: Element %d in r_common_gnd_buffer is : %d mohms\n",
			__func__, i + 1,
			pdata->usbcss_hs.gnd.r_cm_gnd_buffer.data[i]);
	}
	/* Apply r_common_gnd offset */
	pdata->usbcss_hs.gnd.r_common_gnd_mohms =
	...
	/* Ground external FET */
	r_gnd_ext_fet_mohms =
		r_gnd_res_tot_mohms - r_gnd_par_tot_mohms - r_gnd_int_fet_mohms;
	dev_dbg(component->dev, "%s: r_gnd_ext_fet_mohms is : %d mohms\n",
		__func__, r_gnd_ext_fet_mohms);

	/* Audio external FET */
	r_aud_ext_fet_mohms =
		(pdata->usbcss_hs.gnd.gnd_ext_fet_delta_mohms >= 0) ?
			r_gnd_ext_fet_mohms + (u32)(s32)pdata->usbcss_hs.gnd
						      .gnd_ext_fet_delta_mohms :
			r_gnd_ext_fet_mohms -
				(u32)(s32)(-1 *
					   pdata->usbcss_hs.gnd
	...
	dev_dbg(component->dev, "%s: r_aud_ext_fet_mohms is : %d mohms\n",
		__func__, r_aud_ext_fet_mohms);

	/* Compute effective load resistance */
	rl_eff_l_mohms = *zl - pdata->usbcss_hs.aud.l.r_aud_int_fet_mohms -
			 r_aud_ext_fet_mohms - r_gnd_res_tot_mohms;
	rl_eff_r_mohms = *zr - pdata->usbcss_hs.aud.r.r_aud_int_fet_mohms -
			 r_aud_ext_fet_mohms - r_gnd_res_tot_mohms;

	/* Store z values */
	*zl = (rl_eff_l_mohms - R_CONN_PAR_LOAD_POS_MOHMS -
	       pdata->usbcss_hs.aud.l.r3 + OHMS_TO_MILLIOHMS / 2) /
	      OHMS_TO_MILLIOHMS;
	dev_dbg(component->dev, "%s: rload_l is : %d mohms\n", __func__,
		rl_eff_l_mohms - R_CONN_PAR_LOAD_POS_MOHMS -
			pdata->usbcss_hs.aud.l.r3);
	*zr = (rl_eff_r_mohms - R_CONN_PAR_LOAD_POS_MOHMS -
	       pdata->usbcss_hs.aud.r.r3 + OHMS_TO_MILLIOHMS / 2) /
	      OHMS_TO_MILLIOHMS;
	dev_dbg(component->dev, "%s: rload_r is : %d mohms\n", __func__,
		rl_eff_r_mohms - R_CONN_PAR_LOAD_POS_MOHMS -
			pdata->usbcss_hs.aud.r.r3);
	...
	/* Update xtalk params */
	/* For SE measurements greater than ZDET_SE_MAX_MOHMS, use default xtalk
   * values */
	if (pdata->usbcss_hs.aud.l.zval > ZDET_SE_MAX_MOHMS ||
		...
		if (calculate_lin_aud_tap) {
			if (r_gnd_ext_fet_mohms <
			    pdata->usbcss_hs.gnd.gnd_ext_fet_min_mohms) {
				r_gnd_ext_fet_mohms =
					pdata->usbcss_hs.gnd
						.gnd_ext_fet_min_mohms;
...
#endif
	/* Enable surge protection again after impedance detection for platforms other
   * than USB-C analog platforms
   */
	if (!(mbhc->mbhc_cfg->enable_usbc_analog))
		regmap_update_bits(wcd939x->regmap, WCD939X_HPHLR_SURGE_EN,
				   0xC0, 0xC0);
	...
	regmap_update_bits(wcd939x->regmap, WCD939X_MBHC_MECH, 0x01, 0x01);
...
#if IS_ENABLED(CONFIG_QCOM_WCD_USBSS_I2C)
	wcd_usbss_register_update(cached_regs, WCD_USBSS_WRITE,
				  ARRAY_SIZE(cached_regs));
#endif
	...
	if (wcd939x->version == WCD939X_VERSION_2_0) {
		...
		regmap_update_bits(wcd939x->regmap, WCD939X_ZDET_VNEG_CTL, 0x11,
				   0x00);
		/* Wait 100us for settling */
		usleep_range(100, 110);
		/* Set Vneg mode and enable to be controlled by RX */
		regmap_update_bits(wcd939x->regmap, WCD939X_ZDET_VNEG_CTL, 0x06,
				   0x00);
		/* Wait 100us for settling */
		usleep_range(100, 110);
		/* Set RX bias to be controlled by RX and set Buck/Flyback back to SWR Rx
     * clock */
		regmap_update_bits(wcd939x->regmap, WCD939X_ZDET_VNEG_CTL, 0x48,
				   0x00);
	}
}
...
{
	if (enable) {
		snd_soc_component_update_bits(component, WCD939X_PA_CTL2, 0x40,
					      0x40);
		snd_soc_component_update_bits(component, WCD939X_PA_CTL2, 0x10,
					      0x10);
	} else {
		snd_soc_component_update_bits(component, WCD939X_PA_CTL2, 0x40,
					      0x00);
...
static void wcd939x_mbhc_moisture_config(struct wcd_mbhc *mbhc)
{
	...
	if ((mbhc->moist_rref == R_OFF) ||
		...
		snd_soc_component_update_bits(component, WCD939X_CTL_2, 0x0C,
					      R_OFF << 2);
		return;
	}
...
static bool wcd939x_mbhc_get_moisture_status(struct wcd_mbhc *mbhc)
{
   ...
   */
	...
	ret = ((snd_soc_component_read(component, WCD939X_FSM_STATUS) & 0x20) ?
		       0 :
		       1);
					       ...
					       bool enable)
{
	...
	snd_soc_component_update_bits(component,
				      WCD939X_MOISTURE_DET_POLLING_CTRL, 0x04,
				      (enable << 2));
}

static void wcd939x_mbhc_bcs_enable(struct wcd_mbhc *mbhc, bool bcs_enable)
{
	if (bcs_enable)
...
{
	struct wcd939x_priv *wcd939x =
		snd_soc_component_get_drvdata(mbhc->component);
						 ...
						 bool enable)
{
	if (enable)
		snd_soc_component_update_bits(mbhc->component,
					      WCD939X_ZDET_BIAS_CTL, 0x80,
					      0x80); /* disable 1M pull-up */
	else
		snd_soc_component_update_bits(mbhc->component,
					      WCD939X_ZDET_BIAS_CTL, 0x80,
					      0x00); /* enable 1M pull-up */
}
...
static const struct snd_kcontrol_new hph_type_detect_controls[] = {
	SOC_SINGLE_EXT("HPH Type", 0, 0, UINT_MAX, 0, wcd939x_get_hph_type,
		       NULL),
};
 ...
 */
int wcd939x_mbhc_get_impedance(struct wcd939x_mbhc *wcd939x_mbhc, uint32_t *zl,
			       uint32_t *zr)
{
	if (!wcd939x_mbhc) {
			       ...
			       struct snd_soc_component *component)
{
	...
	snd_soc_component_update_bits(component, WCD939X_MBHC_MECH, 0x20, 0x20);
