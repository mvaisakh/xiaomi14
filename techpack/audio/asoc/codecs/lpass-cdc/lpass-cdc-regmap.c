...
static bool lpass_cdc_is_readable_register(struct device *dev, unsigned int reg)
{
	...
	macro_id = lpass_cdc_get_macro_id(priv->va_without_decimation, reg);
...
static bool lpass_cdc_is_volatile_register(struct device *dev, unsigned int reg)
{
