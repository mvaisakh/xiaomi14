...
static int msm_vidc_set_ring_buffer_count_pineapple(
	void *instance, enum msm_vidc_inst_capability_type cap_id)
{
   ...
   */
	if ((pixel_count >= 7680 * 4320 && fps >= 30) ||
		...
		if (rc) {
			i_vpr_e(inst,
				"%s: failed to calculate ring buffer count\n",
				__func__);
			/* ignore error */
			rc = 0;
	...
	rc = venus_hfi_session_property(inst, HFI_PROP_ENC_RING_BIN_BUF,
					HFI_HOST_FLAGS_NONE, HFI_PORT_BITSTREAM,
					HFI_PAYLOAD_U32, &count, sizeof(u32));
	if (rc)
		return rc;
...
static struct msm_platform_inst_capability instance_cap_data_pineapple[] = {
     ...
     *      flags}
     */
	{ DRV_VERSION, DEC | ENC, CODECS_ALL, 0, INT_MAX, 1, DRIVER_VERSION,
	...
	{ PIX_FMTS, ENC | DEC, H264, MSM_VIDC_FMT_NV12, MSM_VIDC_FMT_NV12C,
	  MSM_VIDC_FMT_NV12 | MSM_VIDC_FMT_NV21 | MSM_VIDC_FMT_NV12C,
	  MSM_VIDC_FMT_NV12C },

	{ PIX_FMTS, ENC | DEC, HEVC | VP9 | AV1, MSM_VIDC_FMT_NV12,
	  MSM_VIDC_FMT_TP10C,
	  MSM_VIDC_FMT_NV12 | MSM_VIDC_FMT_NV21 | MSM_VIDC_FMT_NV12C |
		  MSM_VIDC_FMT_P010 | MSM_VIDC_FMT_TP10C,
	  MSM_VIDC_FMT_NV12C },

	{ PIX_FMTS, ENC, HEIC, MSM_VIDC_FMT_NV12, MSM_VIDC_FMT_P010,
	  MSM_VIDC_FMT_NV12 | MSM_VIDC_FMT_NV21 | MSM_VIDC_FMT_P010,
	  MSM_VIDC_FMT_NV12 },

	{ PIX_FMTS, DEC, HEIC, MSM_VIDC_FMT_NV12, MSM_VIDC_FMT_TP10C,
	  MSM_VIDC_FMT_NV12 | MSM_VIDC_FMT_NV21 | MSM_VIDC_FMT_NV12C |
		  MSM_VIDC_FMT_P010 | MSM_VIDC_FMT_TP10C,
	  MSM_VIDC_FMT_NV12C },
	...
	{ MIN_BUFFERS_OUTPUT, ENC | DEC, CODECS_ALL, 0, 64, 1, 4,
	  V4L2_CID_MIN_BUFFERS_FOR_CAPTURE, HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
	...
	{ SECURE_MBPF, ENC | DEC, H264 | HEVC | VP9 | AV1, 64, 36864, 1,
	  36864 },

	{ SECURE_MBPF, ENC, HEVC, 36, 36864, 1, 36864 },

	{ FRAME_RATE, ENC, CODECS_ALL, (MINIMUM_FPS << 16), (MAXIMUM_FPS << 16),
	  1, (DEFAULT_FPS << 16), 0, HFI_PROP_FRAME_RATE,
	  CAP_FLAG_OUTPUT_PORT },

	{ FRAME_RATE, ENC, HEIC, (MINIMUM_FPS << 16), (MAXIMUM_FPS << 16), 1,
	  (MINIMUM_FPS << 16), 0, HFI_PROP_FRAME_RATE, CAP_FLAG_OUTPUT_PORT },

	{ FRAME_RATE, DEC, CODECS_ALL, (MINIMUM_FPS << 16),
	  (MAXIMUM_DEC_FPS << 16), 1, (DEFAULT_FPS << 16),
	  V4L2_CID_MPEG_VIDC_FRAME_RATE, 0,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ FRAME_RATE, DEC, VP9, (MINIMUM_FPS << 16),
	  (MAXIMUM_OVERRIDE_VP9_FPS << 16), 1, (DEFAULT_FPS << 16),
	  V4L2_CID_MPEG_VIDC_FRAME_RATE, 0,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ OPERATING_RATE, ENC, CODECS_ALL, (MINIMUM_FPS << 16), INT_MAX, 1,
	  (DEFAULT_FPS << 16) },

	{ OPERATING_RATE, DEC, CODECS_ALL, (MINIMUM_FPS << 16), INT_MAX, 1,
	  (DEFAULT_FPS << 16), V4L2_CID_MPEG_VIDC_OPERATING_RATE, 0,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ INPUT_RATE, ENC | DEC, CODECS_ALL, (MINIMUM_FPS << 16), INT_MAX, 1,
	  (DEFAULT_FPS << 16) },

	{ TIMESTAMP_RATE, ENC | DEC, CODECS_ALL, (MINIMUM_FPS << 16), INT_MAX,
	  1, (DEFAULT_FPS << 16) },
	...
	{ ENC_RING_BUFFER_COUNT, ENC, CODECS_ALL, 0, MAX_ENC_RING_BUF_COUNT, 1,
	  0 },

	{ CLIENT_ID, ENC | DEC, CODECS_ALL, INVALID_CLIENT_ID, INT_MAX, 1,
	  INVALID_CLIENT_ID, V4L2_CID_MPEG_VIDC_CLIENT_ID },

	{ SECURE_MODE, ENC | DEC, H264 | HEVC | VP9 | AV1, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDC_SECURE, HFI_PROP_SECURE, CAP_FLAG_NONE },
     ...
     */
	{ FENCE_ID, DEC, CODECS_ALL, 0, INT_MAX, 1, 0,
	  V4L2_CID_MPEG_VIDC_SW_FENCE_ID, 0,
	  CAP_FLAG_DYNAMIC_ALLOWED | CAP_FLAG_OUTPUT_PORT },

	{ FENCE_FD, DEC, CODECS_ALL, INVALID_FD, INT_MAX, 1, INVALID_FD,
	  V4L2_CID_MPEG_VIDC_SW_FENCE_FD, 0, CAP_FLAG_VOLATILE },

	/* Fence type for input buffer. Currently unused */
	{ INBUF_FENCE_TYPE, DEC, H264 | HEVC | VP9 | AV1, MSM_VIDC_FENCE_NONE,
	  MSM_VIDC_FENCE_NONE, BIT(MSM_VIDC_FENCE_NONE), MSM_VIDC_FENCE_NONE, 0,
	  HFI_PROP_FENCE_TYPE, CAP_FLAG_MENU | CAP_FLAG_INPUT_PORT },

	{ OUTBUF_FENCE_TYPE, DEC, H264 | HEVC | VP9 | AV1, MSM_VIDC_FENCE_NONE,
	  MSM_VIDC_SYNX_V2_FENCE,
	  BIT(MSM_VIDC_FENCE_NONE) | BIT(MSM_VIDC_SW_FENCE) |
		  BIT(MSM_VIDC_SYNX_V2_FENCE),
	  MSM_VIDC_FENCE_NONE, 0, HFI_PROP_FENCE_TYPE,
	...
	{ INBUF_FENCE_DIRECTION, DEC, H264 | HEVC | VP9 | AV1,
	  ...
	  BIT(MSM_VIDC_FENCE_DIR_NONE), MSM_VIDC_FENCE_DIR_NONE, 0,
	  HFI_PROP_FENCE_DIRECTION, CAP_FLAG_MENU | CAP_FLAG_INPUT_PORT },
	...
	{ OUTBUF_FENCE_DIRECTION, DEC, H264 | HEVC | VP9 | AV1,
	  ...
	  MSM_VIDC_FENCE_DIR_NONE, 0, HFI_PROP_FENCE_DIRECTION,
	  CAP_FLAG_MENU | CAP_FLAG_OUTPUT_PORT },

	{ FENCE_ERROR_DATA_CORRUPT, DEC, H264 | HEVC | VP9 | AV1, 0, 1, 1, 0, 0,
	  HFI_PROP_FENCE_ERROR_DATA_CORRUPT },

	{ TS_REORDER, DEC, H264 | HEVC, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDC_TS_REORDER },

	{ HFLIP, ENC, CODECS_ALL, 0, 1, 1, 0, V4L2_CID_HFLIP, HFI_PROP_FLIP,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ VFLIP, ENC, CODECS_ALL, 0, 1, 1, 0, V4L2_CID_VFLIP, HFI_PROP_FLIP,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ ROTATION, ENC, CODECS_ALL, 0, 270, 90, 0, V4L2_CID_ROTATE,
	  HFI_PROP_ROTATION, CAP_FLAG_OUTPUT_PORT },

	{ SUPER_FRAME, ENC, H264 | HEVC, 0, 32, 1, 0,
	  V4L2_CID_MPEG_VIDC_SUPERFRAME, 0, CAP_FLAG_DYNAMIC_ALLOWED },

	{ SLICE_DECODE, DEC, H264 | HEVC | AV1, V4L2_MPEG_MSM_VIDC_DISABLE,
	  V4L2_MPEG_MSM_VIDC_DISABLE, 0, V4L2_MPEG_MSM_VIDC_DISABLE,
	  V4L2_CID_MPEG_VIDEO_DECODER_SLICE_INTERFACE, 0 },

	{ HEADER_MODE, ENC, CODECS_ALL, V4L2_MPEG_VIDEO_HEADER_MODE_SEPARATE,
	  V4L2_MPEG_VIDEO_HEADER_MODE_JOINED_WITH_1ST_FRAME,
	  BIT(V4L2_MPEG_VIDEO_HEADER_MODE_SEPARATE) |
		  BIT(V4L2_MPEG_VIDEO_HEADER_MODE_JOINED_WITH_1ST_FRAME),
	  V4L2_MPEG_VIDEO_HEADER_MODE_SEPARATE, V4L2_CID_MPEG_VIDEO_HEADER_MODE,
	  HFI_PROP_SEQ_HEADER_MODE, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ PREPEND_SPSPPS_TO_IDR, ENC, CODECS_ALL, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDEO_PREPEND_SPSPPS_TO_IDR },

	{ VUI_TIMING_INFO, ENC, CODECS_ALL, V4L2_MPEG_MSM_VIDC_DISABLE,
	  V4L2_MPEG_MSM_VIDC_ENABLE, 1, V4L2_MPEG_MSM_VIDC_DISABLE,
	  V4L2_CID_MPEG_VIDC_VUI_TIMING_INFO, HFI_PROP_DISABLE_VUI_TIMING_INFO,
	  CAP_FLAG_OUTPUT_PORT },

	{ WITHOUT_STARTCODE, ENC, CODECS_ALL, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDEO_HEVC_WITHOUT_STARTCODE, HFI_PROP_NAL_LENGTH_FIELD,
	  CAP_FLAG_OUTPUT_PORT },

	{ WITHOUT_STARTCODE, DEC, AV1, 0, 0, 1, 0,
	  V4L2_CID_MPEG_VIDEO_HEVC_WITHOUT_STARTCODE, HFI_PROP_NAL_LENGTH_FIELD,
	  CAP_FLAG_INPUT_PORT },

	{ NAL_LENGTH_FIELD, ENC, CODECS_ALL, V4L2_MPEG_VIDEO_HEVC_SIZE_0,
	  V4L2_MPEG_VIDEO_HEVC_SIZE_4,
	  BIT(V4L2_MPEG_VIDEO_HEVC_SIZE_0) | BIT(V4L2_MPEG_VIDEO_HEVC_SIZE_4),
	  V4L2_MPEG_VIDEO_HEVC_SIZE_0,
	  V4L2_CID_MPEG_VIDEO_HEVC_SIZE_OF_LENGTH_FIELD,
	  HFI_PROP_NAL_LENGTH_FIELD, CAP_FLAG_MENU | CAP_FLAG_OUTPUT_PORT },

	/* TODO: Firmware introduced enumeration type for this
     * with and without seq header.
     */
	{ REQUEST_I_FRAME, ENC, H264 | HEVC, 0, 0, 0, 0,
	  V4L2_CID_MPEG_VIDEO_FORCE_KEY_FRAME, HFI_PROP_REQUEST_SYNC_FRAME,
	  CAP_FLAG_INPUT_PORT | CAP_FLAG_DYNAMIC_ALLOWED },

	/* Enc: Keeping CABAC and CAVLC as same bitrate.
     * Dec: there's no use of Bitrate cap
     */
	{ BIT_RATE, ENC, H264 | HEVC, 1, MAX_BITRATE, 1, DEFAULT_BITRATE,
	  V4L2_CID_MPEG_VIDEO_BITRATE, HFI_PROP_TOTAL_BITRATE,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ BITRATE_MODE, ENC, H264, V4L2_MPEG_VIDEO_BITRATE_MODE_VBR,
	  V4L2_MPEG_VIDEO_BITRATE_MODE_CBR,
	  BIT(V4L2_MPEG_VIDEO_BITRATE_MODE_VBR) |
		  BIT(V4L2_MPEG_VIDEO_BITRATE_MODE_CBR),
	  V4L2_MPEG_VIDEO_BITRATE_MODE_VBR, V4L2_CID_MPEG_VIDEO_BITRATE_MODE,
	  HFI_PROP_RATE_CONTROL, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ BITRATE_MODE, ENC, HEVC, V4L2_MPEG_VIDEO_BITRATE_MODE_VBR,
	...
	{ BITRATE_MODE, ENC, HEIC, V4L2_MPEG_VIDEO_BITRATE_MODE_CQ,
	  V4L2_MPEG_VIDEO_BITRATE_MODE_CQ, BIT(V4L2_MPEG_VIDEO_BITRATE_MODE_CQ),
	  V4L2_MPEG_VIDEO_BITRATE_MODE_CQ, V4L2_CID_MPEG_VIDEO_BITRATE_MODE,
	  HFI_PROP_RATE_CONTROL, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ CABAC_MAX_BITRATE, ENC, H264 | HEVC, 0, 160000000, 1, 160000000 },

	{ CAVLC_MAX_BITRATE, ENC, H264, 0, 220000000, 1, 220000000 },

	{ ALLINTRA_MAX_BITRATE, ENC, H264 | HEVC, 0, 245000000, 1, 245000000 },

	{ LOWLATENCY_MAX_BITRATE, ENC, H264 | HEVC, 0, 70000000, 1, 70000000 },

	{ NUM_COMV, DEC, CODECS_ALL, 0, INT_MAX, 1, 0 },

	{ LOSSLESS, ENC, HEVC, 0, 1, 1, 0,
	...
	{ FRAME_SKIP_MODE, ENC, H264 | HEVC | HEIC,
	  ...
	  V4L2_MPEG_VIDEO_FRAME_SKIP_MODE_DISABLED,
	  V4L2_CID_MPEG_VIDEO_FRAME_SKIP_MODE, 0,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ FRAME_RC_ENABLE, ENC, H264 | HEVC | HEIC, 0, 1, 1, 1,
	  V4L2_CID_MPEG_VIDEO_FRAME_RC_ENABLE },

	{ CONSTANT_QUALITY, ENC, HEVC, 1, MAX_CONSTANT_QUALITY, 1, 90,
	  V4L2_CID_MPEG_VIDEO_CONSTANT_QUALITY, HFI_PROP_CONSTANT_QUALITY,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ CONSTANT_QUALITY, ENC, HEIC, 1, MAX_CONSTANT_QUALITY, 1, 100,
	  V4L2_CID_MPEG_VIDEO_CONSTANT_QUALITY, HFI_PROP_CONSTANT_QUALITY,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ GOP_SIZE, ENC, CODECS_ALL, 0, INT_MAX, 1, 2 * DEFAULT_FPS - 1,
	  V4L2_CID_MPEG_VIDEO_GOP_SIZE, HFI_PROP_MAX_GOP_FRAMES,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ GOP_SIZE, ENC, HEIC, 0, INT_MAX, 1, 0 /* all intra */,
	  V4L2_CID_MPEG_VIDEO_GOP_SIZE, HFI_PROP_MAX_GOP_FRAMES,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ GOP_CLOSURE, ENC, H264 | HEVC, 0, 1, 1, 1,
	  V4L2_CID_MPEG_VIDEO_GOP_CLOSURE, 0 },

	{ B_FRAME, ENC, H264 | HEVC, 0, 7, 1, 0, V4L2_CID_MPEG_VIDEO_B_FRAMES,
	  HFI_PROP_MAX_B_FRAMES, CAP_FLAG_OUTPUT_PORT },

	{ B_FRAME, ENC, HEIC, 0, 1, 1, 0, V4L2_CID_MPEG_VIDEO_B_FRAMES,
	  HFI_PROP_MAX_B_FRAMES, CAP_FLAG_OUTPUT_PORT },

	{ BLUR_TYPES, ENC, H264 | HEVC, MSM_VIDC_BLUR_NONE,
	  MSM_VIDC_BLUR_EXTERNAL,
	  BIT(MSM_VIDC_BLUR_NONE) | BIT(MSM_VIDC_BLUR_EXTERNAL),
	  MSM_VIDC_BLUR_NONE, V4L2_CID_MPEG_VIDC_VIDEO_BLUR_TYPES,
	  HFI_PROP_BLUR_TYPES, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ BLUR_RESOLUTION, ENC, H264 | HEVC, 0, S32_MAX, 1, 0,
	  V4L2_CID_MPEG_VIDC_VIDEO_BLUR_RESOLUTION, HFI_PROP_BLUR_RESOLUTION,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ CSC, ENC, CODECS_ALL, 0, 1, 1, 0, V4L2_CID_MPEG_VIDC_CSC,
	  HFI_PROP_CSC },

	{ CSC_CUSTOM_MATRIX, ENC, CODECS_ALL, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDC_VIDEO_VPE_CSC_CUSTOM_MATRIX, HFI_PROP_CSC_MATRIX,
	  CAP_FLAG_OUTPUT_PORT },

	{ LOWLATENCY_MODE, ENC, H264 | HEVC, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDC_LOWLATENCY_REQUEST, 0, CAP_FLAG_NONE },

	{ LOWLATENCY_MODE, DEC, H264 | HEVC | VP9 | AV1, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDC_LOWLATENCY_REQUEST,
	  HFI_PROP_SEQ_CHANGE_AT_SYNC_FRAME,
	  CAP_FLAG_INPUT_PORT | CAP_FLAG_DYNAMIC_ALLOWED },

	{ LTR_COUNT, ENC, H264 | HEVC, 0, MAX_LTR_FRAME_COUNT_5, 1, 0,
	  V4L2_CID_MPEG_VIDEO_LTR_COUNT, HFI_PROP_LTR_COUNT,
	  CAP_FLAG_OUTPUT_PORT },

	{ USE_LTR, ENC, H264 | HEVC, 0, ((1 << MAX_LTR_FRAME_COUNT_5) - 1), 0,
	  0, V4L2_CID_MPEG_VIDEO_USE_LTR_FRAMES, HFI_PROP_LTR_USE,
	  CAP_FLAG_INPUT_PORT | CAP_FLAG_DYNAMIC_ALLOWED },

	{ MARK_LTR, ENC, H264 | HEVC, INVALID_DEFAULT_MARK_OR_USE_LTR,
	  (MAX_LTR_FRAME_COUNT_5 - 1), 1, INVALID_DEFAULT_MARK_OR_USE_LTR,
	  V4L2_CID_MPEG_VIDEO_FRAME_LTR_INDEX, HFI_PROP_LTR_MARK,
	  CAP_FLAG_INPUT_PORT | CAP_FLAG_DYNAMIC_ALLOWED },

	{ BASELAYER_PRIORITY, ENC, H264, 0, MAX_BASE_LAYER_PRIORITY_ID, 1, 0,
	...
	{ IR_TYPE, ENC, H264 | HEVC,
	  ...
	  V4L2_CID_MPEG_VIDEO_INTRA_REFRESH_PERIOD_TYPE_RANDOM,
	  V4L2_CID_MPEG_VIDEO_INTRA_REFRESH_PERIOD_TYPE, 0,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ IR_PERIOD, ENC, H264 | HEVC, 0, INT_MAX, 1, 0,
	  V4L2_CID_MPEG_VIDEO_INTRA_REFRESH_PERIOD, 0,
	  CAP_FLAG_INPUT_PORT | CAP_FLAG_OUTPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ AU_DELIMITER, ENC, H264 | HEVC, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDEO_AU_DELIMITER, HFI_PROP_AUD,
	  CAP_FLAG_OUTPUT_PORT },

	{ TIME_DELTA_BASED_RC, ENC, H264 | HEVC, 0, 1, 1, 1,
	  V4L2_CID_MPEG_VIDC_TIME_DELTA_BASED_RC,
	  HFI_PROP_TIME_DELTA_BASED_RATE_CONTROL, CAP_FLAG_OUTPUT_PORT },

	{ TIME_DELTA_BASED_RC, ENC, HEIC, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDC_TIME_DELTA_BASED_RC,
	  HFI_PROP_TIME_DELTA_BASED_RATE_CONTROL, CAP_FLAG_OUTPUT_PORT },

	{ CONTENT_ADAPTIVE_CODING, ENC, H264 | HEVC, 0, 1, 1, 1,
	  V4L2_CID_MPEG_VIDC_CONTENT_ADAPTIVE_CODING,
	  HFI_PROP_CONTENT_ADAPTIVE_CODING, CAP_FLAG_OUTPUT_PORT },

	{ REQUEST_PREPROCESS, ENC, H264 | HEVC, MSM_VIDC_PREPROCESS_NONE,
	  MSM_VIDC_PREPROCESS_TYPE0,
	  BIT(MSM_VIDC_PREPROCESS_NONE) | BIT(MSM_VIDC_PREPROCESS_TYPE0),
	  MSM_VIDC_PREPROCESS_NONE, 0, HFI_PROP_REQUEST_PREPROCESS,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ BITRATE_BOOST, ENC, H264 | HEVC, 0, MAX_BITRATE_BOOST, 25,
	  MAX_BITRATE_BOOST, V4L2_CID_MPEG_VIDC_QUALITY_BITRATE_BOOST,
	  HFI_PROP_BITRATE_BOOST, CAP_FLAG_OUTPUT_PORT },

	{ MIN_QUALITY, ENC, H264 | HEVC, 0, MAX_SUPPORTED_MIN_QUALITY, 70,
	  MAX_SUPPORTED_MIN_QUALITY, 0, HFI_PROP_MAINTAIN_MIN_QUALITY,
	  CAP_FLAG_OUTPUT_PORT },

	{ VBV_DELAY, ENC, H264 | HEVC, 200, 300, 100, 300,
	  V4L2_CID_MPEG_VIDEO_VBV_DELAY, HFI_PROP_VBV_DELAY,
	  CAP_FLAG_OUTPUT_PORT },

	{ PEAK_BITRATE, ENC, H264 | HEVC,
	  /* default peak bitrate is 10% larger than avg bitrate */
	  1, MAX_BITRATE, 1, DEFAULT_BITRATE, V4L2_CID_MPEG_VIDEO_BITRATE_PEAK,
	  HFI_PROP_TOTAL_PEAK_BITRATE,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ MIN_FRAME_QP, ENC, H264, MIN_QP_8BIT, MAX_QP, 1, MIN_QP_8BIT,
	  V4L2_CID_MPEG_VIDEO_H264_MIN_QP, HFI_PROP_MIN_QP_PACKED,
	  CAP_FLAG_OUTPUT_PORT },

	{ MIN_FRAME_QP, ENC, HEVC | HEIC, MIN_QP_10BIT, MAX_QP, 1, MIN_QP_10BIT,
	  V4L2_CID_MPEG_VIDEO_HEVC_MIN_QP, HFI_PROP_MIN_QP_PACKED,
	  CAP_FLAG_OUTPUT_PORT },

	{ I_FRAME_MIN_QP, ENC, H264, MIN_QP_8BIT, MAX_QP, 1, MIN_QP_8BIT,
	  V4L2_CID_MPEG_VIDEO_H264_I_FRAME_MIN_QP },

	{ I_FRAME_MIN_QP, ENC, HEVC | HEIC, MIN_QP_10BIT, MAX_QP, 1,
	  MIN_QP_10BIT, V4L2_CID_MPEG_VIDEO_HEVC_I_FRAME_MIN_QP },

	{ P_FRAME_MIN_QP, ENC, H264, MIN_QP_8BIT, MAX_QP, 1, MIN_QP_8BIT,
	  V4L2_CID_MPEG_VIDEO_H264_P_FRAME_MIN_QP },

	{ P_FRAME_MIN_QP, ENC, HEVC | HEIC, MIN_QP_10BIT, MAX_QP, 1,
	  MIN_QP_10BIT, V4L2_CID_MPEG_VIDEO_HEVC_P_FRAME_MIN_QP },

	{ B_FRAME_MIN_QP, ENC, H264, MIN_QP_8BIT, MAX_QP, 1, MIN_QP_8BIT,
	  V4L2_CID_MPEG_VIDEO_H264_B_FRAME_MIN_QP },

	{ B_FRAME_MIN_QP, ENC, HEVC | HEIC, MIN_QP_10BIT, MAX_QP, 1,
	  MIN_QP_10BIT, V4L2_CID_MPEG_VIDEO_HEVC_B_FRAME_MIN_QP },

	{ MAX_FRAME_QP, ENC, H264, MIN_QP_8BIT, MAX_QP, 1, MAX_QP,
	  V4L2_CID_MPEG_VIDEO_H264_MAX_QP, HFI_PROP_MAX_QP_PACKED,
	  CAP_FLAG_OUTPUT_PORT },

	{ MAX_FRAME_QP, ENC, HEVC | HEIC, MIN_QP_10BIT, MAX_QP, 1, MAX_QP,
	  V4L2_CID_MPEG_VIDEO_HEVC_MAX_QP, HFI_PROP_MAX_QP_PACKED,
	  CAP_FLAG_OUTPUT_PORT },

	{ I_FRAME_MAX_QP, ENC, H264, MIN_QP_8BIT, MAX_QP, 1, MAX_QP,
	  V4L2_CID_MPEG_VIDEO_H264_I_FRAME_MAX_QP },

	{ I_FRAME_MAX_QP, ENC, HEVC | HEIC, MIN_QP_10BIT, MAX_QP, 1, MAX_QP,
	  V4L2_CID_MPEG_VIDEO_HEVC_I_FRAME_MAX_QP },

	{ P_FRAME_MAX_QP, ENC, H264, MIN_QP_8BIT, MAX_QP, 1, MAX_QP,
	  V4L2_CID_MPEG_VIDEO_H264_P_FRAME_MAX_QP },

	{ P_FRAME_MAX_QP, ENC, HEVC | HEIC, MIN_QP_10BIT, MAX_QP, 1, MAX_QP,
	  V4L2_CID_MPEG_VIDEO_HEVC_P_FRAME_MAX_QP },

	{ B_FRAME_MAX_QP, ENC, H264, MIN_QP_8BIT, MAX_QP, 1, MAX_QP,
	  V4L2_CID_MPEG_VIDEO_H264_B_FRAME_MAX_QP },

	{ B_FRAME_MAX_QP, ENC, HEVC | HEIC, MIN_QP_10BIT, MAX_QP, 1, MAX_QP,
	  V4L2_CID_MPEG_VIDEO_HEVC_B_FRAME_MAX_QP },

	{ I_FRAME_QP, ENC, HEVC, MIN_QP_10BIT, MAX_QP, 1, DEFAULT_QP,
	  V4L2_CID_MPEG_VIDEO_HEVC_I_FRAME_QP, HFI_PROP_QP_PACKED,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ I_FRAME_QP, ENC, H264, MIN_QP_8BIT, MAX_QP, 1, DEFAULT_QP,
	  V4L2_CID_MPEG_VIDEO_H264_I_FRAME_QP, HFI_PROP_QP_PACKED,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ P_FRAME_QP, ENC, HEVC, MIN_QP_10BIT, MAX_QP, 1, DEFAULT_QP,
	  V4L2_CID_MPEG_VIDEO_HEVC_P_FRAME_QP, HFI_PROP_QP_PACKED,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ P_FRAME_QP, ENC, H264, MIN_QP_8BIT, MAX_QP, 1, DEFAULT_QP,
	  V4L2_CID_MPEG_VIDEO_H264_P_FRAME_QP, HFI_PROP_QP_PACKED,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ B_FRAME_QP, ENC, HEVC, MIN_QP_10BIT, MAX_QP, 1, DEFAULT_QP,
	  V4L2_CID_MPEG_VIDEO_HEVC_B_FRAME_QP, HFI_PROP_QP_PACKED,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ B_FRAME_QP, ENC, H264, MIN_QP_8BIT, MAX_QP, 1, DEFAULT_QP,
	  V4L2_CID_MPEG_VIDEO_H264_B_FRAME_QP, HFI_PROP_QP_PACKED,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },
	...
	{ LAYER_TYPE, ENC, HEVC, V4L2_MPEG_VIDEO_HEVC_HIERARCHICAL_CODING_B,
	  ...
	  HFI_PROP_LAYER_ENCODING_TYPE, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ LAYER_TYPE, ENC, H264, V4L2_MPEG_VIDEO_H264_HIERARCHICAL_CODING_B,
	...
	{ LAYER_ENABLE, ENC, H264, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDEO_H264_HIERARCHICAL_CODING,
	  HFI_PROP_LAYER_ENCODING_TYPE, CAP_FLAG_OUTPUT_PORT },

	{ LAYER_ENABLE, ENC, HEVC, 0, 1, 1, 0, 0, 0, CAP_FLAG_OUTPUT_PORT },

	{ ENH_LAYER_COUNT, ENC, HEVC, 0, 5, 1, 0,
	  V4L2_CID_MPEG_VIDEO_HEVC_HIER_CODING_LAYER, HFI_PROP_LAYER_COUNT,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ ENH_LAYER_COUNT, ENC, H264, 0, 5, 1, 0,
	  V4L2_CID_MPEG_VIDEO_H264_HIERARCHICAL_CODING_LAYER,
	  HFI_PROP_LAYER_COUNT,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ ENH_LAYER_COUNT, DEC, AV1, 0, MAX_OP_POINT, 1, 0, 0,
	  HFI_PROP_AV1_OP_POINT, CAP_FLAG_INPUT_PORT },

	{ L0_BR, ENC, H264, 1, MAX_BITRATE, 1, DEFAULT_BITRATE,
	  V4L2_CID_MPEG_VIDEO_H264_HIER_CODING_L0_BR, HFI_PROP_BITRATE_LAYER1,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ L0_BR, ENC, HEVC, 1, MAX_BITRATE, 1, DEFAULT_BITRATE,
	  V4L2_CID_MPEG_VIDEO_HEVC_HIER_CODING_L0_BR, HFI_PROP_BITRATE_LAYER1,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ L1_BR, ENC, H264, 1, MAX_BITRATE, 1, DEFAULT_BITRATE,
	  V4L2_CID_MPEG_VIDEO_H264_HIER_CODING_L1_BR, HFI_PROP_BITRATE_LAYER2,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ L1_BR, ENC, HEVC, 1, MAX_BITRATE, 1, DEFAULT_BITRATE,
	  V4L2_CID_MPEG_VIDEO_HEVC_HIER_CODING_L1_BR, HFI_PROP_BITRATE_LAYER2,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ L2_BR, ENC, H264, 1, MAX_BITRATE, 1, DEFAULT_BITRATE,
	  V4L2_CID_MPEG_VIDEO_H264_HIER_CODING_L2_BR, HFI_PROP_BITRATE_LAYER3,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ L2_BR, ENC, HEVC, 1, MAX_BITRATE, 1, DEFAULT_BITRATE,
	  V4L2_CID_MPEG_VIDEO_HEVC_HIER_CODING_L2_BR, HFI_PROP_BITRATE_LAYER3,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ L3_BR, ENC, H264, 1, MAX_BITRATE, 1, DEFAULT_BITRATE,
	  V4L2_CID_MPEG_VIDEO_H264_HIER_CODING_L3_BR, HFI_PROP_BITRATE_LAYER4,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },
	{ L3_BR, ENC, HEVC, 1, MAX_BITRATE, 1, DEFAULT_BITRATE,
	  V4L2_CID_MPEG_VIDEO_HEVC_HIER_CODING_L3_BR, HFI_PROP_BITRATE_LAYER4,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ L4_BR, ENC, H264, 1, MAX_BITRATE, 1, DEFAULT_BITRATE,
	  V4L2_CID_MPEG_VIDEO_H264_HIER_CODING_L4_BR, HFI_PROP_BITRATE_LAYER5,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ L4_BR, ENC, HEVC, 1, MAX_BITRATE, 1, DEFAULT_BITRATE,
	  V4L2_CID_MPEG_VIDEO_HEVC_HIER_CODING_L4_BR, HFI_PROP_BITRATE_LAYER5,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ L5_BR, ENC, H264, 1, MAX_BITRATE, 1, DEFAULT_BITRATE,
	  V4L2_CID_MPEG_VIDEO_H264_HIER_CODING_L5_BR, HFI_PROP_BITRATE_LAYER6,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ L5_BR, ENC, HEVC, 1, MAX_BITRATE, 1, DEFAULT_BITRATE,
	  V4L2_CID_MPEG_VIDEO_HEVC_HIER_CODING_L5_BR, HFI_PROP_BITRATE_LAYER6,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ ENTROPY_MODE, ENC, H264, V4L2_MPEG_VIDEO_H264_ENTROPY_MODE_CAVLC,
	...
	{ ENTROPY_MODE, DEC, H264 | HEVC | VP9 | AV1,
	  ...
	  BIT(V4L2_MPEG_VIDEO_H264_ENTROPY_MODE_CAVLC) |
		  BIT(V4L2_MPEG_VIDEO_H264_ENTROPY_MODE_CABAC),
	  V4L2_MPEG_VIDEO_H264_ENTROPY_MODE_CABAC, 0, HFI_PROP_CABAC_SESSION },

	{ PROFILE, ENC | DEC, H264, V4L2_MPEG_VIDEO_H264_PROFILE_BASELINE,
	  ...
	  HFI_PROP_PROFILE, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ PROFILE, ENC | DEC, HEVC | HEIC, V4L2_MPEG_VIDEO_HEVC_PROFILE_MAIN,
	  ...
	  V4L2_MPEG_VIDEO_HEVC_PROFILE_MAIN, V4L2_CID_MPEG_VIDEO_HEVC_PROFILE,
	  HFI_PROP_PROFILE, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ PROFILE, DEC, VP9, V4L2_MPEG_VIDEO_VP9_PROFILE_0,
	  V4L2_MPEG_VIDEO_VP9_PROFILE_2,
	  BIT(V4L2_MPEG_VIDEO_VP9_PROFILE_0) |
		  BIT(V4L2_MPEG_VIDEO_VP9_PROFILE_2),
	  V4L2_MPEG_VIDEO_VP9_PROFILE_0, V4L2_CID_MPEG_VIDEO_VP9_PROFILE,
	  HFI_PROP_PROFILE, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ PROFILE, DEC, AV1, V4L2_MPEG_VIDC_AV1_PROFILE_MAIN,
	  V4L2_MPEG_VIDC_AV1_PROFILE_MAIN, BIT(V4L2_MPEG_VIDC_AV1_PROFILE_MAIN),
	  V4L2_MPEG_VIDC_AV1_PROFILE_MAIN, V4L2_CID_MPEG_VIDC_AV1_PROFILE,
	  HFI_PROP_PROFILE, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ LEVEL, ENC, H264, V4L2_MPEG_VIDEO_H264_LEVEL_1_0,
	  ...
	  V4L2_MPEG_VIDEO_H264_LEVEL_5_0, V4L2_CID_MPEG_VIDEO_H264_LEVEL,
	  HFI_PROP_LEVEL, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },
	...
	{ LEVEL, ENC, HEVC | HEIC, V4L2_MPEG_VIDEO_HEVC_LEVEL_1,
	  ...
	  V4L2_MPEG_VIDEO_HEVC_LEVEL_5, V4L2_CID_MPEG_VIDEO_HEVC_LEVEL,
	  HFI_PROP_LEVEL, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ LEVEL, DEC, H264, V4L2_MPEG_VIDEO_H264_LEVEL_1_0,
	  ...
	  V4L2_MPEG_VIDEO_H264_LEVEL_6_1, V4L2_CID_MPEG_VIDEO_H264_LEVEL,
	  HFI_PROP_LEVEL, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ LEVEL, DEC, HEVC | HEIC, V4L2_MPEG_VIDEO_HEVC_LEVEL_1,
	  V4L2_MPEG_VIDEO_HEVC_LEVEL_6_2,
	  BIT(V4L2_MPEG_VIDEO_HEVC_LEVEL_1) |
		  BIT(V4L2_MPEG_VIDEO_HEVC_LEVEL_2) |
		  BIT(V4L2_MPEG_VIDEO_HEVC_LEVEL_2_1) |
		  ...
		  BIT(V4L2_MPEG_VIDEO_HEVC_LEVEL_6_1) |
		  BIT(V4L2_MPEG_VIDEO_HEVC_LEVEL_6_2),
	  V4L2_MPEG_VIDEO_HEVC_LEVEL_6_1, V4L2_CID_MPEG_VIDEO_HEVC_LEVEL,
	  HFI_PROP_LEVEL, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ LEVEL, DEC, VP9, V4L2_MPEG_VIDEO_VP9_LEVEL_1_0,
	  ...
	  V4L2_MPEG_VIDEO_VP9_LEVEL_6_0, V4L2_CID_MPEG_VIDEO_VP9_LEVEL,
	  HFI_PROP_LEVEL, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ LEVEL, DEC, AV1, V4L2_MPEG_VIDC_AV1_LEVEL_2_0,
	  ...
	  V4L2_MPEG_VIDC_AV1_LEVEL_6_1, V4L2_CID_MPEG_VIDC_AV1_LEVEL,
	  HFI_PROP_LEVEL, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ AV1_TIER, DEC, AV1, V4L2_MPEG_VIDC_AV1_TIER_MAIN,
	  V4L2_MPEG_VIDC_AV1_TIER_HIGH,
	  BIT(V4L2_MPEG_VIDC_AV1_TIER_MAIN) | BIT(V4L2_MPEG_VIDC_AV1_TIER_HIGH),
	  V4L2_MPEG_VIDC_AV1_TIER_HIGH, V4L2_CID_MPEG_VIDC_AV1_TIER,
	  HFI_PROP_TIER, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ HEVC_TIER, ENC | DEC, HEVC, V4L2_MPEG_VIDEO_HEVC_TIER_MAIN,
	  V4L2_MPEG_VIDEO_HEVC_TIER_HIGH,
	  BIT(V4L2_MPEG_VIDEO_HEVC_TIER_MAIN) |
		  BIT(V4L2_MPEG_VIDEO_HEVC_TIER_HIGH),
	  V4L2_MPEG_VIDEO_HEVC_TIER_HIGH, V4L2_CID_MPEG_VIDEO_HEVC_TIER,
	  HFI_PROP_TIER, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ HEVC_TIER, ENC | DEC, HEIC, V4L2_MPEG_VIDEO_HEVC_TIER_MAIN,
	  V4L2_MPEG_VIDEO_HEVC_TIER_MAIN, BIT(V4L2_MPEG_VIDEO_HEVC_TIER_MAIN),
	  V4L2_MPEG_VIDEO_HEVC_TIER_MAIN, V4L2_CID_MPEG_VIDEO_HEVC_TIER,
	  HFI_PROP_TIER, CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ LF_MODE, ENC, H264, V4L2_MPEG_VIDEO_H264_LOOP_FILTER_MODE_ENABLED,
	  ...
	  V4L2_CID_MPEG_VIDEO_H264_LOOP_FILTER_MODE, HFI_PROP_DEBLOCKING_MODE,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },
	...
	{ LF_MODE, ENC, HEVC | HEIC,
	  ...
	  V4L2_CID_MPEG_VIDEO_HEVC_LOOP_FILTER_MODE, HFI_PROP_DEBLOCKING_MODE,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_MENU },

	{ LF_ALPHA, ENC, H264, -6, 6, 1, 0,
	  V4L2_CID_MPEG_VIDEO_H264_LOOP_FILTER_ALPHA },

	{ LF_ALPHA, ENC, HEVC | HEIC, -6, 6, 1, 0,
	  V4L2_CID_MPEG_VIDEO_HEVC_LF_TC_OFFSET_DIV2 },

	{ LF_BETA, ENC, H264, -6, 6, 1, 0,
	  V4L2_CID_MPEG_VIDEO_H264_LOOP_FILTER_BETA },

	{ LF_BETA, ENC, HEVC | HEIC, -6, 6, 1, 0,
	  V4L2_CID_MPEG_VIDEO_HEVC_LF_BETA_OFFSET_DIV2 },

	{ SLICE_MODE, ENC, H264 | HEVC, V4L2_MPEG_VIDEO_MULTI_SLICE_MODE_SINGLE,
	...
	{ SLICE_MODE, ENC, HEIC, V4L2_MPEG_VIDEO_MULTI_SLICE_MODE_SINGLE,
	  V4L2_MPEG_VIDEO_MULTI_SLICE_MODE_SINGLE,
	  BIT(V4L2_MPEG_VIDEO_MULTI_SLICE_MODE_SINGLE),
	  V4L2_MPEG_VIDEO_MULTI_SLICE_MODE_SINGLE,
	  V4L2_CID_MPEG_VIDEO_MULTI_SLICE_MODE, 0,
	...
	{ SLICE_MAX_BYTES, ENC, H264 | HEVC, MIN_SLICE_BYTE_SIZE,
	  MAX_SLICE_BYTE_SIZE, 1, MIN_SLICE_BYTE_SIZE,
	  V4L2_CID_MPEG_VIDEO_MULTI_SLICE_MAX_BYTES,
	  HFI_PROP_MULTI_SLICE_BYTES_COUNT, CAP_FLAG_OUTPUT_PORT },

	{ SLICE_MAX_MB, ENC, H264 | HEVC, 1, MAX_SLICE_MB_SIZE, 1, 1,
	  V4L2_CID_MPEG_VIDEO_MULTI_SLICE_MAX_MB, HFI_PROP_MULTI_SLICE_MB_COUNT,
	  CAP_FLAG_OUTPUT_PORT },

	{ MB_RC, ENC, H264 | HEVC, 0, 1, 1, 1, V4L2_CID_MPEG_VIDEO_MB_RC_ENABLE,
	  0, CAP_FLAG_OUTPUT_PORT },

	{ TRANSFORM_8X8, ENC, H264, 0, 1, 1, 1,
	  V4L2_CID_MPEG_VIDEO_H264_8X8_TRANSFORM, HFI_PROP_8X8_TRANSFORM,
	  CAP_FLAG_OUTPUT_PORT },

	{ CHROMA_QP_INDEX_OFFSET, ENC, HEVC, MIN_CHROMA_QP_OFFSET,
	  MAX_CHROMA_QP_OFFSET, 1, MAX_CHROMA_QP_OFFSET,
	  V4L2_CID_MPEG_VIDEO_H264_CHROMA_QP_INDEX_OFFSET,
	  HFI_PROP_CHROMA_QP_OFFSET, CAP_FLAG_OUTPUT_PORT },

	{ DISPLAY_DELAY_ENABLE, DEC, H264 | HEVC | VP9 | AV1, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDEO_DEC_DISPLAY_DELAY_ENABLE,
	  HFI_PROP_DECODE_ORDER_OUTPUT, CAP_FLAG_INPUT_PORT },

	{ DISPLAY_DELAY, DEC, H264 | HEVC | VP9 | AV1, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDEO_DEC_DISPLAY_DELAY, HFI_PROP_DECODE_ORDER_OUTPUT,
	  CAP_FLAG_INPUT_PORT },

	{ OUTPUT_ORDER, DEC, H264 | HEVC | VP9 | AV1, 0, 1, 1, 0, 0,
	  HFI_PROP_DECODE_ORDER_OUTPUT, CAP_FLAG_INPUT_PORT },

	{ INPUT_BUF_HOST_MAX_COUNT, ENC | DEC, CODECS_ALL,
	  DEFAULT_MAX_HOST_BUF_COUNT, DEFAULT_MAX_HOST_BURST_BUF_COUNT, 1,
	  DEFAULT_MAX_HOST_BUF_COUNT, 0, HFI_PROP_BUFFER_HOST_MAX_COUNT,
	  CAP_FLAG_INPUT_PORT },
	...
	{ CONCEAL_COLOR_8BIT, DEC, CODECS_ALL, 0x0, 0xff3fcff, 1,
	  DEFAULT_VIDEO_CONCEAL_COLOR_BLACK, V4L2_CID_MPEG_VIDEO_MUTE_YUV,
	  HFI_PROP_CONCEAL_COLOR_8BIT, CAP_FLAG_INPUT_PORT },

	{ CONCEAL_COLOR_10BIT, DEC, CODECS_ALL, 0x0, 0x3fffffff, 1,
	  DEFAULT_VIDEO_CONCEAL_COLOR_BLACK, V4L2_CID_MPEG_VIDEO_MUTE_YUV,
	  HFI_PROP_CONCEAL_COLOR_10BIT, CAP_FLAG_INPUT_PORT },

	{ STAGE, DEC | ENC, CODECS_ALL, MSM_VIDC_STAGE_1, MSM_VIDC_STAGE_2, 1,
	  MSM_VIDC_STAGE_2, 0, HFI_PROP_STAGE },

	{ PIPE, DEC | ENC, CODECS_ALL, MSM_VIDC_PIPE_1, MSM_VIDC_PIPE_4, 1,
	  MSM_VIDC_PIPE_4, 0, HFI_PROP_PIPE },

	{ POC, DEC, H264, 0, 2, 1, 1, 0, HFI_PROP_PIC_ORDER_CNT_TYPE,
	  CAP_FLAG_VOLATILE },

	{ MAX_NUM_REORDER_FRAMES, DEC, H264 | HEVC, 0, 16, 1, 0,
	  V4L2_CID_MPEG_VIDC_MAX_NUM_REORDER_FRAMES,
	  HFI_PROP_MAX_NUM_REORDER_FRAMES, CAP_FLAG_VOLATILE },

	{ QUALITY_MODE, ENC, CODECS_ALL, MSM_VIDC_MAX_QUALITY_MODE,
	  MSM_VIDC_POWER_SAVE_MODE, 1, MSM_VIDC_POWER_SAVE_MODE },

	{ CODED_FRAMES, DEC, H264 | HEVC | HEIC, CODED_FRAMES_PROGRESSIVE,
	  CODED_FRAMES_INTERLACE, 1, CODED_FRAMES_PROGRESSIVE,
	  V4L2_CID_MPEG_VIDC_INTERLACE, HFI_PROP_CODED_FRAMES,
	  CAP_FLAG_VOLATILE },

	{ BIT_DEPTH, DEC, CODECS_ALL, BIT_DEPTH_8, BIT_DEPTH_10, 1, BIT_DEPTH_8,
	  0, HFI_PROP_LUMA_CHROMA_BIT_DEPTH },

	{ CODEC_CONFIG, DEC, H264 | HEVC | HEIC | AV1, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDC_CODEC_CONFIG, 0, CAP_FLAG_DYNAMIC_ALLOWED },
	...
	{ THUMBNAIL_MODE, DEC, CODECS_ALL, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDC_THUMBNAIL_MODE, HFI_PROP_THUMBNAIL_MODE,
	  CAP_FLAG_INPUT_PORT },

	{ DEFAULT_HEADER, DEC, CODECS_ALL, 0, 1, 1, 0, 0,
	  HFI_PROP_DEC_DEFAULT_HEADER },

	{ RAP_FRAME, DEC, CODECS_ALL, 0, 1, 1, 1, 0,
	  HFI_PROP_DEC_START_FROM_RAP_FRAME, CAP_FLAG_INPUT_PORT },

	{ SEQ_CHANGE_AT_SYNC_FRAME, DEC, CODECS_ALL, 0, 1, 1, 1, 0,
	  HFI_PROP_SEQ_CHANGE_AT_SYNC_FRAME,
	  CAP_FLAG_INPUT_PORT | CAP_FLAG_DYNAMIC_ALLOWED },

	{ PRIORITY, DEC | ENC, CODECS_ALL, 0, 4, 1, 4,
	  V4L2_CID_MPEG_VIDC_PRIORITY, HFI_PROP_SESSION_PRIORITY,
	  CAP_FLAG_DYNAMIC_ALLOWED },

	{ FIRMWARE_PRIORITY_OFFSET, DEC | ENC, CODECS_ALL, 1, 1, 1, 1 },

	{ CRITICAL_PRIORITY, ENC, CODECS_ALL, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDC_CRITICAL_PRIORITY },

	{ RESERVE_DURATION, ENC, CODECS_ALL, 0, INT_MAX, 1, 0,
	  V4L2_CID_MPEG_VIDC_RESERVE_DURATION, HFI_CMD_RESERVE,
	  CAP_FLAG_DYNAMIC_ALLOWED },

	{ ENC_IP_CR, ENC, CODECS_ALL, 0, S32_MAX, 1, 0,
	  V4L2_CID_MPEG_VIDC_ENC_INPUT_COMPRESSION_RATIO, 0,
	  CAP_FLAG_DYNAMIC_ALLOWED },

	{ FILM_GRAIN, DEC, AV1, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDC_AV1D_FILM_GRAIN_PRESENT,
	  HFI_PROP_AV1_FILM_GRAIN_PRESENT, CAP_FLAG_VOLATILE },

	{ SUPER_BLOCK, DEC, AV1, 0, 1, 1, 0, 0,
	  HFI_PROP_AV1_SUPER_BLOCK_ENABLED },

	{ DRAP, DEC, AV1, 0, S32_MAX, 1, 0, 0, HFI_PROP_AV1_DRAP_CONFIG,
	  CAP_FLAG_INPUT_PORT },

	{ LAST_FLAG_EVENT_ENABLE, DEC | ENC, CODECS_ALL, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDC_LAST_FLAG_EVENT_ENABLE },

	{ META_BITSTREAM_RESOLUTION, DEC, AV1, MSM_VIDC_META_DISABLE,
	  ...
	  HFI_PROP_BITSTREAM_RESOLUTION, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_CROP_OFFSETS, DEC, AV1, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_INPUT |
		  MSM_VIDC_META_RX_OUTPUT,
	  0, MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_CROP_OFFSETS,
	  HFI_PROP_CROP_OFFSETS, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ ALL_INTRA, ENC, H264 | HEVC, 0, 1, 1, 0, 0, 0, CAP_FLAG_OUTPUT_PORT },

	{ META_LTR_MARK_USE, ENC, H264 | HEVC, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_OUTPUT, 0,
	  MSM_VIDC_META_DISABLE,
	  V4L2_CID_MPEG_VIDC_METADATA_LTR_MARK_USE_DETAILS,
	  HFI_PROP_LTR_MARK_USE_DETAILS, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_SEQ_HDR_NAL, ENC, CODECS_ALL, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_OUTPUT, 0,
	  MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_SEQ_HEADER_NAL,
	  HFI_PROP_METADATA_SEQ_HEADER_NAL, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_DPB_MISR, DEC, CODECS_ALL, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_OUTPUT, 0,
	  MSM_VIDC_META_DISABLE,
	  V4L2_CID_MPEG_VIDC_METADATA_DPB_LUMA_CHROMA_MISR,
	  HFI_PROP_DPB_LUMA_CHROMA_MISR, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_OPB_MISR, DEC, CODECS_ALL, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_OUTPUT, 0,
	  MSM_VIDC_META_DISABLE,
	  V4L2_CID_MPEG_VIDC_METADATA_OPB_LUMA_CHROMA_MISR,
	  HFI_PROP_OPB_LUMA_CHROMA_MISR, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_INTERLACE, DEC, H264, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_OUTPUT, 0,
	  MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_INTERLACE,
	  HFI_PROP_INTERLACE_INFO, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_TIMESTAMP, DEC | ENC, CODECS_ALL, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_OUTPUT, 0,
	  MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_TIMESTAMP,
	  HFI_PROP_TIMESTAMP, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_CONCEALED_MB_CNT, DEC, CODECS_ALL, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_OUTPUT, 0,
	  MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_CONCEALED_MB_COUNT,
	  HFI_PROP_CONEALED_MB_COUNT, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_HIST_INFO, DEC, HEVC | AV1 | VP9, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_OUTPUT, 0,
	  MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_HISTOGRAM_INFO,
	  HFI_PROP_HISTOGRAM_INFO, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_TRANSCODING_STAT_INFO, DEC, HEVC | H264, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_OUTPUT, 0,
	  MSM_VIDC_META_DISABLE,
	  V4L2_CID_MPEG_VIDC_METADATA_TRANSCODE_STAT_INFO,
	  HFI_PROP_TRANSCODING_STAT_INFO, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_TRANSCODING_STAT_INFO, ENC, HEVC | H264, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_DYN_ENABLE | MSM_VIDC_META_TX_INPUT, 0,
	  MSM_VIDC_META_DISABLE,
	  V4L2_CID_MPEG_VIDC_METADATA_TRANSCODE_STAT_INFO,
	  HFI_PROP_TRANSCODING_STAT_INFO, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_PICTURE_TYPE, DEC, CODECS_ALL, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_INPUT, 0,
	  MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_PICTURE_TYPE,
	  HFI_PROP_PICTURE_TYPE,
	  CAP_FLAG_BITMASK | CAP_FLAG_META | CAP_FLAG_DYNAMIC_ALLOWED },

	{ META_SEI_MASTERING_DISP, ENC, HEVC | HEIC, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_DYN_ENABLE |
	...
	{ META_SEI_CLL, ENC, HEVC | HEIC, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_DYN_ENABLE |
		  MSM_VIDC_META_TX_INPUT,
	  0, MSM_VIDC_META_DISABLE,
	  V4L2_CID_MPEG_VIDC_METADATA_SEI_CONTENT_LIGHT_LEVEL,
	  HFI_PROP_SEI_CONTENT_LIGHT_LEVEL, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_SEI_CLL, DEC, HEVC | HEIC | AV1, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_INPUT |
		  MSM_VIDC_META_RX_OUTPUT,
	  0, MSM_VIDC_META_DISABLE,
	  V4L2_CID_MPEG_VIDC_METADATA_SEI_CONTENT_LIGHT_LEVEL,
	...
	{ META_HDR10PLUS, ENC, HEVC | HEIC, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_DYN_ENABLE |
		  MSM_VIDC_META_TX_INPUT,
	  0, MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_HDR10PLUS,
	  HFI_PROP_SEI_HDR10PLUS_USERDATA, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_HDR10PLUS, DEC, HEVC | HEIC | AV1, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_INPUT |
		  MSM_VIDC_META_RX_OUTPUT,
	  0, MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_HDR10PLUS,
	  HFI_PROP_SEI_HDR10PLUS_USERDATA, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_DOLBY_RPU, ENC, HEVC, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_TX_INPUT, 0,
	  MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_DOLBY_RPU,
	  HFI_PROP_DOLBY_RPU_METADATA, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_DOLBY_RPU, DEC, H264 | HEVC, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_OUTPUT, 0,
	  MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_DOLBY_RPU,
	  HFI_PROP_DOLBY_RPU_METADATA, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_EVA_STATS, ENC, H264 | HEVC, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_DYN_ENABLE |
		  MSM_VIDC_META_TX_INPUT,
	  0, MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_EVA_STATS,
	  HFI_PROP_EVA_STAT_INFO, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_BUF_TAG, ENC, CODECS_ALL, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_TX_INPUT |
		  MSM_VIDC_META_RX_OUTPUT,
	  0, MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_BUFFER_TAG,
	  HFI_PROP_BUFFER_TAG, CAP_FLAG_BITMASK | CAP_FLAG_META },

	/*
     * when fence enabled, client needs output buffer_tag
     * in input metadata buffer done.
     */
	{ META_BUF_TAG, DEC, CODECS_ALL, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_TX_INPUT |
	...
	{ META_DPB_TAG_LIST, DEC, CODECS_ALL, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_INPUT, 0,
	  MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_DPB_TAG_LIST,
	  HFI_PROP_DPB_TAG_LIST, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_SUBFRAME_OUTPUT, ENC, HEIC | H264 | HEVC, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_OUTPUT, 0,
	  MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_SUBFRAME_OUTPUT,
	  HFI_PROP_SUBFRAME_OUTPUT, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_SUBFRAME_OUTPUT, DEC, CODECS_ALL, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_OUTPUT, 0,
	  MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_SUBFRAME_OUTPUT,
	  HFI_PROP_SUBFRAME_OUTPUT, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_ENC_QP_METADATA, ENC, CODECS_ALL, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_OUTPUT, 0,
	  MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_ENC_QP_METADATA,
	  HFI_PROP_ENC_QP_METADATA, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_ROI_INFO, ENC, H264 | HEVC, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_TX_INPUT, 0,
	  MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_ROI_INFO,
	  HFI_PROP_ROI_INFO,
	  CAP_FLAG_INPUT_PORT | CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_SALIENCY_INFO, ENC, H264 | HEVC, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_TX_INPUT, 0,
	  MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_SALIENCY_INFO,
	  HFI_PROP_ROI_AS_SALIENCY_INFO,
	  CAP_FLAG_INPUT_PORT | CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ META_DEC_QP_METADATA, DEC, CODECS_ALL, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_OUTPUT, 0,
	  MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_DEC_QP_METADATA,
	  HFI_PROP_DEC_QP_METADATA, CAP_FLAG_BITMASK | CAP_FLAG_META },

	{ GRID_ENABLE, ENC, HEIC, 0, 1, 1, 1, 0, HFI_PROP_HEIC_GRID_ENABLE,
	  CAP_FLAG_OUTPUT_PORT },

	{ GRID_SIZE, ENC, HEIC, HEIC_GRID_WIDTH, HEIC_GRID_WIDTH * 2,
	  HEIC_GRID_WIDTH, HEIC_GRID_WIDTH, V4L2_CID_MPEG_VIDC_GRID_WIDTH },

	{ COMPLEXITY, ENC, H264 | HEVC, 0, 100, 1, DEFAULT_COMPLEXITY,
	  V4L2_CID_MPEG_VIDC_VENC_COMPLEXITY },

	{ DELIVERY_MODE, ENC, HEVC, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDC_HEVC_ENCODE_DELIVERY_MODE,
	  HFI_PROP_ENABLE_SLICE_DELIVERY, CAP_FLAG_OUTPUT_PORT },

	{ DELIVERY_MODE, ENC, H264, 0, 1, 1, 0,
	  V4L2_CID_MPEG_VIDC_H264_ENCODE_DELIVERY_MODE,
	  HFI_PROP_ENABLE_SLICE_DELIVERY, CAP_FLAG_OUTPUT_PORT },

	{ SIGNAL_COLOR_INFO, ENC, CODECS_ALL, 0, INT_MAX, 1, 0,
	  V4L2_CID_MPEG_VIDC_SIGNAL_COLOR_INFO, HFI_PROP_SIGNAL_COLOR_INFO,
	  CAP_FLAG_INPUT_PORT | CAP_FLAG_DYNAMIC_ALLOWED },
};
...
static struct msm_platform_inst_cap_dependency instance_cap_dependency_data_pineapple[] = {
	...
	{ PIX_FMTS, ENC, H264, { META_ROI_INFO, IR_PERIOD, CSC } },
	...
	{ PIX_FMTS, ENC, HEIC, { PROFILE, CSC } },

	{ PIX_FMTS, DEC, HEVC | HEIC, { PROFILE } },

	{ FRAME_RATE, ENC, CODECS_ALL, { 0 }, NULL, msm_vidc_set_q16 },

	{ FRAME_RATE, DEC, CODECS_ALL, { 0 }, msm_vidc_adjust_dec_frame_rate },
	...
	{ INBUF_FENCE_TYPE, DEC, H264 | HEVC | VP9 | AV1, { 0 }, NULL, NULL },
	...
	{ HFLIP, ENC, CODECS_ALL, { 0 }, NULL, msm_vidc_set_flip },

	{ VFLIP, ENC, CODECS_ALL, { 0 }, NULL, msm_vidc_set_flip },

	{ ROTATION, ENC, CODECS_ALL, { 0 }, NULL, msm_vidc_set_rotation },
	...
	{ SLICE_DECODE, DEC, H264 | HEVC | AV1, { 0 }, NULL, NULL },

	{ HEADER_MODE, ENC, CODECS_ALL, { 0 }, NULL, msm_vidc_set_header_mode },
	...
	{ WITHOUT_STARTCODE, DEC, AV1, { 0 }, NULL, msm_vidc_set_u32 },
	...
	{ BITRATE_MODE,
	  ENC,
	  H264,
	  { LTR_COUNT, IR_PERIOD, TIME_DELTA_BASED_RC, I_FRAME_QP, P_FRAME_QP,
	    B_FRAME_QP, ENH_LAYER_COUNT, BIT_RATE, META_ROI_INFO, MIN_QUALITY,
	    BITRATE_BOOST, VBV_DELAY, PEAK_BITRATE, SLICE_MODE,
	...
	{ GOP_SIZE, ENC, HEIC, { 0 }, NULL, msm_vidc_set_u32 },
	...
	{ B_FRAME, ENC, HEIC, { 0 }, NULL, msm_vidc_set_u32 },
	...
	{ CSC, ENC, CODECS_ALL, { 0 }, msm_vidc_adjust_csc, msm_vidc_set_u32 },
	...
	{ AU_DELIMITER, ENC, H264 | HEVC, { 0 }, NULL, msm_vidc_set_u32 },

	{ BASELAYER_PRIORITY, ENC, H264, { 0 }, NULL, msm_vidc_set_u32 },
	...
	{ MIN_FRAME_QP, ENC, H264, { 0 }, NULL, msm_vidc_set_min_qp },
	...
	{ MAX_FRAME_QP, ENC, H264, { 0 }, NULL, msm_vidc_set_max_qp },
	...
	{ I_FRAME_QP, ENC, H264, { 0 }, NULL, msm_vidc_set_frame_qp },
	...
	{ P_FRAME_QP, ENC, H264, { 0 }, NULL, msm_vidc_set_frame_qp },
	...
	{ B_FRAME_QP, ENC, H264, { 0 }, NULL, msm_vidc_set_frame_qp },

	{ LAYER_TYPE, ENC, H264 | HEVC, { CONTENT_ADAPTIVE_CODING, LTR_COUNT } },

	{ LAYER_ENABLE, ENC, H264 | HEVC, { CONTENT_ADAPTIVE_CODING } },
	...
	{ ENH_LAYER_COUNT, DEC, AV1, { 0 }, NULL, msm_vidc_set_u32 },
	...
	{ PROFILE, DEC, H264, { ENTROPY_MODE }, NULL, msm_vidc_set_u32_enum },
	...
	{ PROFILE, DEC, VP9 | AV1, { 0 }, NULL, msm_vidc_set_u32_enum },

	{ LEVEL, DEC, CODECS_ALL, { 0 }, NULL, msm_vidc_set_u32_enum },

	{ LEVEL, ENC, CODECS_ALL, { 0 }, NULL, msm_vidc_set_level },

	{ AV1_TIER, DEC, AV1, { 0 }, NULL, msm_vidc_set_u32_enum },

	{ HEVC_TIER, ENC | DEC, HEVC | HEIC, { 0 }, NULL, msm_vidc_set_u32_enum },

	{ LF_MODE, ENC, CODECS_ALL, { 0 }, NULL, msm_vidc_set_deblock_mode },
	...
	{ STAGE, ENC | DEC, CODECS_ALL, { 0 }, NULL, msm_vidc_set_stage },

	{ STAGE, ENC, H264 | HEVC, { 0 }, NULL, msm_vidc_set_stage },

	{ STAGE, DEC, H264 | HEVC | VP9 | AV1, { 0 }, NULL, msm_vidc_set_stage },

	{ PIPE, DEC | ENC, CODECS_ALL, { 0 }, NULL, msm_vidc_set_pipe },
	...
	{ THUMBNAIL_MODE, DEC, HEIC, { 0 }, NULL, msm_vidc_set_u32 },

	{ RAP_FRAME, DEC, CODECS_ALL, { 0 }, NULL, msm_vidc_set_u32 },
	...
	{ FIRMWARE_PRIORITY_OFFSET, DEC | ENC, CODECS_ALL, { 0 }, NULL, NULL },

	{ CRITICAL_PRIORITY, ENC, CODECS_ALL, { 0 }, NULL, NULL },
	...
	{ DRAP, DEC, AV1, { 0 }, NULL, msm_vidc_set_u32 },
	...
	{ META_EVA_STATS, ENC, HEVC, { 0 }, msm_vidc_adjust_eva_stats, NULL },
	...
	{ GRID_ENABLE, ENC, HEIC, { 0 }, NULL, msm_vidc_set_u32 },
	...
	{ META_SEI_CLL, ENC, HEVC | HEIC, { 0 }, msm_vidc_adjust_sei_cll, NULL },
...
static struct freq_table pineapple_freq_table[] = {
	{ 533333333 }, { 480000000 }, { 435000000 },
	{ 380000000 }, { 280000000 }, { 196000000 }
};

static struct freq_table pineapple_freq_table_v2[] = {
	{ 533333333 }, { 480000000 }, { 435000000 },
	{ 380000000 }, { 300000000 }, { 196000000 }
};
...
static const struct device_region_table pineapple_device_region_table[] = {
	{ "aon-registers", 0x0AAE0000, 0x1000, 0xFFAE0000, MSM_VIDC_AON },
	{ "ipc_protocol4_client8_version-registers", 0x00508000, 0x1000,
	  0xFFADF000, MSM_VIDC_PROTOCOL_FENCE_CLIENT_VPU },
	{ "qtimer_f0v1_qtmr_v1_cntpct_lo", 0x17421000, 0x1000, 0xFFADE000,
	  MSM_VIDC_QTIMER },
};
...
static const struct msm_vidc_platform_data pineapple_data = {
	...
	.inst_cap_dependency_data_size =
		ARRAY_SIZE(instance_cap_dependency_data_pineapple),
	...
	.dec_input_prop_size_avc =
		ARRAY_SIZE(pineapple_vdec_input_properties_avc),
	.dec_input_prop_size_hevc =
		ARRAY_SIZE(pineapple_vdec_input_properties_hevc),
	.dec_input_prop_size_vp9 =
		ARRAY_SIZE(pineapple_vdec_input_properties_vp9),
	.dec_input_prop_size_av1 =
		ARRAY_SIZE(pineapple_vdec_input_properties_av1),
	...
	.dec_output_prop_size_avc =
		ARRAY_SIZE(pineapple_vdec_output_properties_avc),
	.dec_output_prop_size_hevc =
		ARRAY_SIZE(pineapple_vdec_output_properties_hevc),
	.dec_output_prop_size_vp9 =
		ARRAY_SIZE(pineapple_vdec_output_properties_vp9),
	.dec_output_prop_size_av1 =
		ARRAY_SIZE(pineapple_vdec_output_properties_av1),
};
...
static int msm_vidc_init_data(struct msm_vidc_core *core)
{
	...
	if (of_device_is_compatible(dev->of_node, "qcom,sm8650-vidc-v2")) {
		...
		core->platform->data.freq_tbl_size =
			ARRAY_SIZE(pineapple_freq_table_v2);
	}
