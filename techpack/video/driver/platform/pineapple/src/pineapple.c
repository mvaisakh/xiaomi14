	...
	void *instance, enum msm_vidc_inst_capability_type cap_id)
{
   ...
   */
	if ((pixel_count >= 7680 * 4320 && fps >= 30) &&
		...
		if (rc) {
			i_vpr_e(inst,
				"%s: failed to calculate ring buf count\n",
				__func__);
			/* ignore error */
			rc = 0;
...
static struct msm_platform_inst_capability instance_cap_data_pineapple[] = {
	...
	{ SLICE_DECODE, DEC, CODECS_ALL, 0, 0, 0, 0,
...
static struct msm_platform_inst_cap_dependency
	instance_cap_dependency_data_pineapple[] = {
		/* {cap, domain, codec,
         *      parents,
         *      children,
         *      adjust, set}
		...
		{ BITRATE_MODE,
		  ENC,
		  H264,
		  { LTR_COUNT, I_FRAME_QP, P_FRAME_QP, B_FRAME_QP,
		    ENH_LAYER_COUNT, BIT_RATE, MIN_QUALITY, VBV_DELAY,
		...
		{ BITRATE_MODE,
		  ...
		  HEVC,
		  { LTR_COUNT, I_FRAME_QP, P_FRAME_QP, B_FRAME_QP,
		    CONSTANT_QUALITY, ENH_LAYER_COUNT, BIT_RATE, MIN_QUALITY,
		    VBV_DELAY, PEAK_BITRATE, SLICE_MODE,
