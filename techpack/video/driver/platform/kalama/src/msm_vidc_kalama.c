...
static struct msm_platform_inst_capability instance_cap_data_kalama[] = {
	...
	{ OPERATING_RATE, ENC, CODECS_ALL, (MINIMUM_FPS << 16),
	  (MAXIMUM_FPS << 16), 1, (DEFAULT_FPS << 16) },

	{ OPERATING_RATE, DEC, CODECS_ALL, (MINIMUM_FPS << 16),
	  (MAXIMUM_DEC_FPS << 16), 1, (DEFAULT_FPS << 16),
	  V4L2_CID_MPEG_VIDC_OPERATING_RATE, 0,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },

	{ OPERATING_RATE, DEC, VP9, (MINIMUM_FPS << 16),
	  (MAXIMUM_OVERRIDE_VP9_FPS << 16), 1, (DEFAULT_FPS << 16),
	  V4L2_CID_MPEG_VIDC_OPERATING_RATE, 0,
	  CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
		  CAP_FLAG_DYNAMIC_ALLOWED },
	...
	{ LTR_COUNT, ENC, H264 | HEVC, 0, MAX_LTR_FRAME_COUNT_2, 1, 0,
	  V4L2_CID_MPEG_VIDEO_LTR_COUNT, HFI_PROP_LTR_COUNT,
	  CAP_FLAG_OUTPUT_PORT },

	{ USE_LTR, ENC, H264 | HEVC, 0, ((1 << MAX_LTR_FRAME_COUNT_2) - 1), 0,
	  0, V4L2_CID_MPEG_VIDEO_USE_LTR_FRAMES, HFI_PROP_LTR_USE,
	  CAP_FLAG_INPUT_PORT | CAP_FLAG_DYNAMIC_ALLOWED },

	{ MARK_LTR, ENC, H264 | HEVC, INVALID_DEFAULT_MARK_OR_USE_LTR,
	  (MAX_LTR_FRAME_COUNT_2 - 1), 1, INVALID_DEFAULT_MARK_OR_USE_LTR,
	...
	{ BASELAYER_PRIORITY, ENC, H264, 0, MAX_BASE_LAYER_PRIORITY_ID, 1, 0,
	  ...
	  HFI_PROP_BASELAYER_PRIORITYID, CAP_FLAG_OUTPUT_PORT },
	...
	{ LAST_FLAG_EVENT_ENABLE, DEC, CODECS_ALL, 0, 1, 1, 0,
	...
	{ META_PICTURE_TYPE, DEC, CODECS_ALL, MSM_VIDC_META_DISABLE,
	  ...
	  HFI_PROP_PICTURE_TYPE, CAP_FLAG_BITMASK | CAP_FLAG_META },
	...
	{ META_HDR10PLUS, ENC, HEVC | HEIC, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_TX_INPUT, 0,
	  MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_HDR10PLUS,
	...
	{ META_EVA_STATS, ENC, CODECS_ALL, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_TX_INPUT, 0,
	  MSM_VIDC_META_DISABLE, V4L2_CID_MPEG_VIDC_METADATA_EVA_STATS,
	...
	{ META_MAX_NUM_REORDER_FRAMES, DEC, HEVC | H264, MSM_VIDC_META_DISABLE,
	  MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_OUTPUT, 0,
	  MSM_VIDC_META_DISABLE,
	  V4L2_CID_MPEG_VIDC_METADATA_MAX_NUM_REORDER_FRAMES,
	  HFI_PROP_MAX_NUM_REORDER_FRAMES, CAP_FLAG_BITMASK | CAP_FLAG_META },
...
static struct msm_platform_inst_cap_dependency instance_cap_dependency_data_kalama[] = {
	...
	{ PIX_FMTS, ENC, H264, { META_ROI_INFO, IR_PERIOD } },
	...
	{ BITRATE_MODE,
	  ...
	  HEVC,
	  { LTR_COUNT, IR_PERIOD, TIME_DELTA_BASED_RC, I_FRAME_QP, P_FRAME_QP,
	    B_FRAME_QP, CONSTANT_QUALITY, ENH_LAYER_COUNT, BIT_RATE,
	    META_ROI_INFO, MIN_QUALITY, BITRATE_BOOST, VBV_DELAY, PEAK_BITRATE,
	    SLICE_MODE, CONTENT_ADAPTIVE_CODING, BLUR_TYPES, LOWLATENCY_MODE },
	  msm_vidc_adjust_bitrate_mode,
	  msm_vidc_set_u32_enum },
...
/* freq */
static struct freq_table kalama_freq_table[] = { { 481000000 },
						 { 444000000 },
						 { 366000000 },
						 { 338000000 },
						 { 240000000 } };

static struct freq_table kalama_freq_table_v2[] = { { 533333333 },
						    { 444000000 },
						    { 366000000 },
						    { 338000000 },
						    { 240000000 } };
...
static const struct msm_vidc_platform_data kalama_data = {
	...
	.inst_cap_dependency_data_size =
		ARRAY_SIZE(instance_cap_dependency_data_kalama),
	...
	.dec_input_prop_size_hevc =
		ARRAY_SIZE(kalama_vdec_input_properties_hevc),
	...
	.dec_output_prop_size_avc =
		ARRAY_SIZE(kalama_vdec_output_properties_avc),
	.dec_output_prop_size_hevc =
		ARRAY_SIZE(kalama_vdec_output_properties_hevc),
	.dec_output_prop_size_vp9 =
		ARRAY_SIZE(kalama_vdec_output_properties_vp9),
	.dec_output_prop_size_av1 =
		ARRAY_SIZE(kalama_vdec_output_properties_av1),
};
