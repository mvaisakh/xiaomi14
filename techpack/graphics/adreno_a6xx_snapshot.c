...
static const unsigned int a6xx_gras_cluster[] = {
	0x8000, 0x8006, 0x8010, 0x8092, 0x8094, 0x809D, 0x80A0, 0x80A6, 0x80AF,
	0x80F1, 0x8100, 0x8107, 0x8109, 0x8109, 0x8110, 0x8110, 0x8400, 0x840B,
};
...
static const unsigned int a6xx_ps_cluster_rbp[] = {
	0x88F0, 0x88F3, 0x890D, 0x890E, 0x8927, 0x8928, 0x8BF0,
	0x8BF1, 0x8C02, 0x8C07, 0x8C11, 0x8C16, 0x8C20, 0x8C25,
};
...
static const unsigned int a6xx_fe_cluster[] = {
	0x9300, 0x9306, 0x9800, 0x9806, 0x9B00, 0x9B07,
	0xA000, 0xA009, 0xA00E, 0xA0EF, 0xA0F8, 0xA0F8,
};
...
static struct a6xx_cluster_registers {
	...
	{ CP_CLUSTER_GRAS, a6xx_gras_cluster, ARRAY_SIZE(a6xx_gras_cluster) / 2,
	  NULL },
	{ CP_CLUSTER_PS, a6xx_ps_cluster_rac,
	  ARRAY_SIZE(a6xx_ps_cluster_rac) / 2, &_a6xx_rb_rac_aperture },
	{ CP_CLUSTER_PS, a6xx_ps_cluster_rbp,
	  ARRAY_SIZE(a6xx_ps_cluster_rbp) / 2, &_a6xx_rb_rbp_aperture },
	{ CP_CLUSTER_PS, a6xx_vpc_ps_cluster,
	  ARRAY_SIZE(a6xx_vpc_ps_cluster) / 2, NULL },
...
static const unsigned int a6xx_sp_vs_sp_cluster[] = {
	0xA800, 0xA824, 0xA830, 0xA83C, 0xA840, 0xA864,
	0xA870, 0xA895, 0xA8A0, 0xA8AF, 0xA8C0, 0xA8C3,
};
...
static const unsigned int a6xx_sp_ps_hlsq_cluster[] = {
	0xB980, 0xB980, 0xB982, 0xB987, 0xB990,
	0xB99B, 0xB9A0, 0xB9A2, 0xB9C0, 0xB9C9,
};

static const unsigned int a6xx_sp_ps_sp_cluster[] = {
	0xA980, 0xA9A8, 0xA9B0, 0xA9BC, 0xA9D0, 0xA9D3, 0xA9E0,
	0xA9F3, 0xAA00, 0xAA00, 0xAA30, 0xAA31, 0xAAF2, 0xAAF2,
};
...
static const unsigned int a6xx_hlsq_non_ctx_registers[] = {
	0xBE00, 0xBE01, 0xBE04, 0xBE05, 0xBE08,
	0xBE09, 0xBE10, 0xBE15, 0xBE20, 0xBE23,
};

static const unsigned int a6xx_sp_non_ctx_registers[] = {
	0xAE00, 0xAE04, 0xAE0C, 0xAE0C, 0xAE0F, 0xAE2B, 0xAE30,
	0xAE32, 0xAE35, 0xAE35, 0xAE3A, 0xAE3F, 0xAE50, 0xAE52,
};
...
static const unsigned int a6xx_vbif_registers[] = {
	/* VBIF */
	0x3000, 0x3007, 0x300C, 0x3014, 0x3018, 0x302D, 0x3030, 0x3031, 0x3034,
	0x3036, 0x303C, 0x303D, 0x3040, 0x3040, 0x3042, 0x3042, 0x3049, 0x3049,
	0x3058, 0x3058, 0x305A, 0x3061, 0x3064, 0x3068, 0x306C, 0x306D, 0x3080,
	0x3088, 0x308B, 0x308C, 0x3090, 0x3094, 0x3098, 0x3098, 0x309C, 0x309C,
	0x30C0, 0x30C0, 0x30C8, 0x30C8, 0x30D0, 0x30D0, 0x30D8, 0x30D8, 0x30E0,
	0x30E0, 0x3100, 0x3100, 0x3108, 0x3108, 0x3110, 0x3110, 0x3118, 0x3118,
	0x3120, 0x3120, 0x3124, 0x3125, 0x3129, 0x3129, 0x3131, 0x3131, 0x3154,
	0x3154, 0x3156, 0x3156, 0x3158, 0x3158, 0x315A, 0x315A, 0x315C, 0x315C,
	0x315E, 0x315E, 0x3160, 0x3160, 0x3162, 0x3162, 0x340C, 0x340C, 0x3410,
	0x3410, 0x3800, 0x3801,
};
...
static const unsigned int a6xx_rb_rac_registers[] = {
	0x8E04, 0x8E05, 0x8E07, 0x8E08, 0x8E10, 0x8E1C, 0x8E20,
	0x8E25, 0x8E28, 0x8E28, 0x8E2C, 0x8E2F, 0x8E50, 0x8E52,
};

static const unsigned int a6xx_rb_rbp_registers[] = {
	0x8E01, 0x8E01, 0x8E0C, 0x8E0C, 0x8E3B, 0x8E3E,
	0x8E40, 0x8E43, 0x8E53, 0x8E5F, 0x8E70, 0x8E77,
};
...
#define REG_PAIR_COUNT(_a, _i) (((_a)[(2 * (_i)) + 1] - (_a)[2 * (_i)]) + 1)
...
static size_t a6xx_legacy_snapshot_shader(struct kgsl_device *device, u8 *buf,
					  size_t remain, void *priv)
{
...
static size_t a6xx_snapshot_shader_memory(struct kgsl_device *device, u8 *buf,
					  size_t remain, void *priv)
{
	struct kgsl_snapshot_shader *header =
		(struct kgsl_snapshot_shader *)buf;
	...
	for (i = 0; i < ARRAY_SIZE(a6xx_shader_blocks); i++) {
		for (j = 0; j < A6XX_NUM_SHADER_BANKS; j++) {
			...
			kgsl_snapshot_add_section(
				device, KGSL_SNAPSHOT_SECTION_SHADER, snapshot,
				a6xx_snapshot_shader_memory, &info);
		}
	}
}
				  ...
				  struct kgsl_snapshot *snapshot)
{
	...
	kgsl_snapshot_indexed_registers(device, snapshot,
					A6XX_CP_MEM_POOL_DBG_ADDR,
					A6XX_CP_MEM_POOL_DBG_DATA, 0, 0x2100);
					    ...
					    unsigned int reg)
{
	unsigned int read_reg =
		A6XX_HLSQ_DBG_AHB_READ_APERTURE + reg - regbase / 4;
	unsigned int val;
				      ...
				      struct kgsl_snapshot *snapshot)
{
	...
	for (i = 0; i < ARRAY_SIZE(a6xx_dbgahb_ctx_clusters); i++) {
		...
		for (j = 0; j < A6XX_NUM_CTXTS; j++) {
			...
			kgsl_snapshot_add_section(
				device, KGSL_SNAPSHOT_SECTION_MVC, snapshot,
	...
	for (i = 0; i < ARRAY_SIZE(a6xx_clusters); i++) {
		...
		for (j = 0; j < A6XX_NUM_CTXTS; j++) {
			...
			kgsl_snapshot_add_section(device,
						  KGSL_SNAPSHOT_SECTION_MVC,
						  snapshot, a6xx_snapshot_mvc,
						  &info);
		}
	}
}
						...
						void *priv)
{
   ...
   */
	...
	kgsl_regwrite(device, A6XX_VBIF_CLKON,
		      reg_clk | (A6XX_VBIF_CLKON_FORCE_ON_TESTBUS_MASK
	...
	for (i = 0; i < A6XX_NUM_XIN_CORE_BLOCKS; i++) {
		...
		for (j = 0; j < 12; j++) {
			kgsl_regwrite(
				device, A6XX_VBIF_TEST_BUS1_CTRL1,
				   ...
				   struct kgsl_snapshot *snapshot)
{
	...
	kgsl_regwrite(device, A6XX_DBGC_CFG_DBGBUS_CNTLT,
		      (0xf << A6XX_DBGC_CFG_DBGBUS_CNTLT_SEGT_SHIFT) |
			      ...
			      (0x0
			       << A6XX_DBGC_CFG_DBGBUS_CNTLT_TRACEEN_SHIFT));
	...
	for (i = 0; i < ARRAY_SIZE(a6xx_dbgc_debugbus_blocks); i++) {
		kgsl_snapshot_add_section(
			device, KGSL_SNAPSHOT_SECTION_DEBUGBUS, snapshot,
			a6xx_snapshot_dbgc_debugbus_block,
   ...
   */
	if (!adreno_is_a630(adreno_dev))
		...
		kgsl_snapshot_add_section(device,
					  KGSL_SNAPSHOT_SECTION_DEBUGBUS,
					  snapshot,
					  a6xx_snapshot_vbif_debugbus_block,
					  (void *)&a6xx_vbif_debugbus_blocks);

	/* Dump the CX debugbus data if the block exists */
	if (kgsl_regmap_valid_offset(&device->regmap,
					     ...
					     u8 *buf, size_t remain, void *priv)
{
	...
	for (j = 0; j < regs->count; j++) {
		...
		for (k = start; k <= end; k++) {
			...
			adreno_isense_regread(
				adreno_dev, k - (adreno_dev->isense_base >> 2),
				&val);
			*data++ = k;
			*data++ = val;
		}
					 ...
					 size_t remain, void *priv)
{
	...
	const struct adreno_a6xx_core *gpucore =
	...
	ctxt_record_size =
		min_t(u64, ctxt_record_size, device->snapshot_ctxt_record_size);
		   ...
		   struct kgsl_snapshot *snapshot)
{
   ...
   */
	...
	if (adreno_is_a650_family(adreno_dev)) {
		...
		kgsl_snapshot_add_section(device, KGSL_SNAPSHOT_SECTION_REGS,
					  snapshot,
					  a6xx_snapshot_isense_registers, &r);
	}
	...
	if (!gmu_core_isenabled(device)) {
		if (adreno_is_a619_holi(adreno_dev))
			adreno_snapshot_registers(
				...
				ARRAY_SIZE(a6xx_holi_gmu_wrapper_registers) /
					2);
		else
			adreno_snapshot_registers(
				device, snapshot, a6xx_gmu_wrapper_registers,
	...
	for (i = 0; i < ARRAY_SIZE(a6xx_reg_list); i++) {
		...
		kgsl_snapshot_add_section(device, KGSL_SNAPSHOT_SECTION_REGS,
					  snapshot, a6xx_snapshot_registers,
					  &a6xx_reg_list[i]);
	}

	/* CP_SQE indexed registers */
	kgsl_snapshot_indexed_registers(device, snapshot, A6XX_CP_SQE_STAT_ADDR,
					A6XX_CP_SQE_STAT_DATA, 0, 0x33);

	/* CP_DRAW_STATE */
	kgsl_snapshot_indexed_registers(device, snapshot,
					A6XX_CP_DRAW_STATE_ADDR,
					A6XX_CP_DRAW_STATE_DATA, 0, 0x100);

	/* SQE_UCODE Cache */
	kgsl_snapshot_indexed_registers(device, snapshot,
					A6XX_CP_SQE_UCODE_DBG_ADDR,
					A6XX_CP_SQE_UCODE_DBG_DATA, 0, 0x8000);
	...
	if (adreno_is_a660(adreno_dev)) {
		...
		kgsl_snapshot_indexed_registers(device, snapshot,
						A6XX_CP_SQE_AC_STAT_ADDR,
						A6XX_CP_SQE_AC_STAT_DATA, 0,
						0x33);
		kgsl_snapshot_indexed_registers(device, snapshot,
						A6XX_CP_LPAC_DRAW_STATE_ADDR,
						A6XX_CP_LPAC_DRAW_STATE_DATA, 0,
						0x100);
		kgsl_snapshot_indexed_registers(device, snapshot,
						A6XX_CP_SQE_AC_UCODE_DBG_ADDR,
						A6XX_CP_SQE_AC_UCODE_DBG_DATA,
						0, 0x8000);
		...
		kgsl_snapshot_indexed_registers(device, snapshot,
						...
						A6XX_CP_LPAC_ROQ_DBG_DATA, 0,
						roq_size);

		kgsl_snapshot_indexed_registers(device, snapshot,
						A6XX_CP_LPAC_FIFO_DBG_ADDR,
						A6XX_CP_LPAC_FIFO_DBG_DATA, 0,
						0x40);
	}
	/*
   ...
   */
	kgsl_snapshot_add_section(device, KGSL_SNAPSHOT_SECTION_DEBUG, snapshot,
				  a6xx_snapshot_cp_roq, NULL);

	/* SQE Firmware */
	kgsl_snapshot_add_section(device, KGSL_SNAPSHOT_SECTION_DEBUG, snapshot,
				  a6xx_snapshot_sqe, NULL);
	...
	if (adreno_is_preemption_enabled(adreno_dev)) {
		...
		{
			kgsl_snapshot_add_section(
				device, KGSL_SNAPSHOT_SECTION_GPU_OBJECT_V2,
	...
	for (i = 0; i < ARRAY_SIZE(a6xx_clusters); i++) {
		...
		for (j = 0; j < A6XX_NUM_CTXTS; j++) {
			...
			for (k = 0; k < cluster->num_sets; k++) {
				...
				ptr[qwords++] =
					a6xx_crashdump_registers->gpuaddr +
					*offset;
				ptr[qwords++] =
					(((uint64_t)cluster->regs[2 * k])
					 << 44) |
					count;
...
static int _a6xx_crashdump_init_ctx_dbgahb(uint64_t *ptr, uint64_t *offset)
{
	...
	for (i = 0; i < ARRAY_SIZE(a6xx_dbgahb_ctx_clusters); i++) {
		...
		for (j = 0; j < A6XX_NUM_CTXTS; j++) {
			...
			/* Program the aperture */
			ptr[qwords++] = ((cluster->statetype + j * 2) & 0xff)
					<< 8;
			ptr[qwords++] =
