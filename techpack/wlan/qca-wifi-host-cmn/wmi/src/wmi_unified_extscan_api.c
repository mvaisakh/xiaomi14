...
QDF_STATUS wmi_unified_reset_passpoint_network_list_cmd(
	wmi_unified_t wmi_handle, struct wifi_passpoint_req_param *req)
{
	if (wmi_handle->ops->send_reset_passpoint_network_list_cmd)
		return wmi_handle->ops->send_reset_passpoint_network_list_cmd(
			wmi_handle, req);
...
QDF_STATUS
wmi_unified_set_passpoint_network_list_cmd(wmi_unified_t wmi_handle,
					   struct wifi_passpoint_req_param *req)
{
	if (wmi_handle->ops->send_set_passpoint_network_list_cmd)
		return wmi_handle->ops->send_set_passpoint_network_list_cmd(
			wmi_handle, req);
...
QDF_STATUS
wmi_unified_set_epno_network_list_cmd(wmi_unified_t wmi_handle,
				      struct wifi_enhanced_pno_params *req)
{
	if (wmi_handle->ops->send_set_epno_network_list_cmd)
		return wmi_handle->ops->send_set_epno_network_list_cmd(
			wmi_handle, req);
	...
	wmi_unified_t wmi_handle, struct extscan_capabilities_params *pgetcapab)
{
	if (wmi_handle->ops->send_extscan_get_capabilities_cmd)
		return wmi_handle->ops->send_extscan_get_capabilities_cmd(
			wmi_handle, pgetcapab);
	...
	struct extscan_cached_result_params *pcached_results)
{
	if (wmi_handle->ops->send_extscan_get_cached_results_cmd)
		return wmi_handle->ops->send_extscan_get_cached_results_cmd(
			wmi_handle, pcached_results);
	...
	struct extscan_capabilities_reset_params *reset_req)
{
	if (wmi_handle->ops->send_extscan_stop_change_monitor_cmd)
		return wmi_handle->ops->send_extscan_stop_change_monitor_cmd(
			wmi_handle, reset_req);
	...
	struct extscan_set_sig_changereq_params *psigchange)
{
	if (wmi_handle->ops->send_extscan_start_change_monitor_cmd)
		return wmi_handle->ops->send_extscan_start_change_monitor_cmd(
	...
	struct extscan_bssid_hotlist_reset_params *photlist_reset)
{
	if (wmi_handle->ops->send_extscan_stop_hotlist_monitor_cmd)
		return wmi_handle->ops->send_extscan_stop_hotlist_monitor_cmd(
			wmi_handle, photlist_reset);
	...
	struct extscan_bssid_hotlist_set_params *params)
{
	if (wmi_handle->ops->send_extscan_start_hotlist_monitor_cmd)
		return wmi_handle->ops->send_extscan_start_hotlist_monitor_cmd(
			wmi_handle, params);
...
QDF_STATUS
wmi_unified_stop_extscan_cmd(wmi_unified_t wmi_handle,
...
QDF_STATUS
wmi_unified_start_extscan_cmd(wmi_unified_t wmi_handle,
