			   ...
			   struct twt_enable_param *params)
{
	if (wmi_handle->ops->send_twt_enable_cmd)
		return wmi_handle->ops->send_twt_enable_cmd(wmi_handle, params);
			    ...
			    struct twt_disable_param *params)
{
	if (wmi_handle->ops->send_twt_disable_cmd)
		return wmi_handle->ops->send_twt_disable_cmd(wmi_handle,
							     params);
			       ...
			       struct twt_add_dialog_param *params)
{
	if (wmi_handle->ops->send_twt_add_dialog_cmd)
		return wmi_handle->ops->send_twt_add_dialog_cmd(wmi_handle,
								params);
			       ...
			       struct twt_del_dialog_param *params)
{
	if (wmi_handle->ops->send_twt_del_dialog_cmd)
		return wmi_handle->ops->send_twt_del_dialog_cmd(wmi_handle,
								params);
				 ...
				 struct twt_pause_dialog_cmd_param *params)
{
	if (wmi_handle->ops->send_twt_pause_dialog_cmd)
		return wmi_handle->ops->send_twt_pause_dialog_cmd(wmi_handle,
								  params);
				 ...
				 struct twt_nudge_dialog_cmd_param *params)
{
	if (wmi_handle->ops->send_twt_nudge_dialog_cmd)
		return wmi_handle->ops->send_twt_nudge_dialog_cmd(wmi_handle,
								  params);
...
QDF_STATUS
wmi_unified_twt_resume_dialog_cmd(wmi_unified_t wmi_handle,
				  struct twt_resume_dialog_cmd_param *params)
{
	if (wmi_handle->ops->send_twt_resume_dialog_cmd)
		return wmi_handle->ops->send_twt_resume_dialog_cmd(wmi_handle,
								   params);
...
QDF_STATUS wmi_unified_twt_btwt_invite_sta_cmd(
	wmi_unified_t wmi_handle, struct twt_btwt_invite_sta_cmd_param *params)
{
	if (wmi_handle->ops->send_twt_btwt_invite_sta_cmd)
		return wmi_handle->ops->send_twt_btwt_invite_sta_cmd(wmi_handle,
								     params);
...
QDF_STATUS wmi_unified_twt_btwt_remove_sta_cmd(
	wmi_unified_t wmi_handle, struct twt_btwt_remove_sta_cmd_param *params)
{
	if (wmi_handle->ops->send_twt_btwt_remove_sta_cmd)
		return wmi_handle->ops->send_twt_btwt_remove_sta_cmd(wmi_handle,
								     params);
...
QDF_STATUS wmi_extract_twt_notify_event(wmi_unified_t wmi_handle,
					uint8_t *evt_buf,
					struct twt_notify_event_param *params)
{
	if (wmi_handle->ops->extract_twt_notify_event)
		return wmi_handle->ops->extract_twt_notify_event(
			wmi_handle, evt_buf, params);
...
QDF_STATUS
wmi_extract_twt_session_stats_data(wmi_unified_t wmi_handle, uint8_t *evt_buf,
				   struct twt_session_stats_event_param *params,
...
QDF_STATUS
wmi_extract_twt_cap_service_ready_ext2(wmi_unified_t wmi_handle,
				       uint8_t *evt_buf,
...
QDF_STATUS
wmi_extract_twt_ack_comp_event(wmi_unified_t wmi_handle, uint8_t *evt_buf,
...
QDF_STATUS
wmi_extract_twt_notify_event(wmi_unified_t wmi_handle, uint8_t *evt_buf,
