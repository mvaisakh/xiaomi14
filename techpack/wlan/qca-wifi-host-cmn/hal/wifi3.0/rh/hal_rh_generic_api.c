...
static uint32_t hal_get_reo_qdesc_size_rh(uint32_t ba_window_size, int tid)
{
	return 0;
}
...
static void hal_rx_msdu_link_desc_set_rh(hal_soc_handle_t hal_soc_hdl,
					 void *src_srng_desc,
...
static void hal_rx_buf_cookie_rbm_get_rh(uint32_t *buf_addr_info_hdl,
...
static void hal_rx_wbm_rel_buf_paddr_get_rh(hal_ring_desc_t rx_desc,
					    struct hal_buf_info *buf_info)
{
}
...
static void hal_reo_qdesc_setup_rh(hal_soc_handle_t hal_soc_hdl, int tid,
				   uint32_t ba_window_size, uint32_t start_seq,
				   void *hw_qdesc_vaddr,
				   qdf_dma_addr_t hw_qdesc_paddr, int pn_type,
...
static inline void hal_msdu_desc_info_set_rh(hal_soc_handle_t hal_soc_hdl,
					     void *msdu_desc, uint32_t dst_ind,
					     uint32_t nbuf_len)
{
}

static inline void hal_mpdu_desc_info_set_rh(hal_soc_handle_t hal_soc_hdl,
...
static inline uint8_t *hal_get_reo_ent_desc_qdesc_addr_rh(uint8_t *desc)
{
	return 0;
}

static inline void hal_set_reo_ent_desc_reo_dest_ind_rh(uint8_t *desc,
							uint32_t dst_ind)
{
}

static uint64_t hal_rx_get_qdesc_addr_rh(uint8_t *dst_ring_desc, uint8_t *buf)
{
	return 0;
}
 ...
 * Return: void
 */
static void hal_rx_dump_pkt_tlvs_rh(hal_soc_handle_t hal_soc_hdl, uint8_t *buf,
				    uint8_t dbg_level)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
 ...
 */
static int hal_rx_tlv_get_offload_info_rh(uint8_t *rx_tlv,
...
{
	struct rx_pkt_tlvs *rx_pkt_tlv = (struct rx_pkt_tlvs *)buf;
	...
	pn_num[0] |= ((uint64_t)rx_mpdu_info_details->pn_63_32 << 32);
	pn_num[1] = rx_mpdu_info_details->pn_95_64;
	pn_num[1] |= ((uint64_t)rx_mpdu_info_details->pn_127_96 << 32);
}
 ...
 */
static inline void
hal_rx_priv_info_set_in_tlv_rh(uint8_t *buf, uint8_t *priv_data, uint32_t len)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
 ...
 */
static inline void
hal_rx_priv_info_get_from_tlv_rh(uint8_t *buf, uint8_t *priv_data, uint32_t len)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	uint32_t copy_len = (len > RX_PADDING0_BYTES) ? RX_PADDING0_BYTES : len;
 ...
 *
 */
static void hal_rxdma_buff_addr_info_set_rh(void *rxdma_entry,
 ...
 * Return: None
 */
static inline void hal_rx_tlv_csum_err_get_rh(uint8_t *rx_tlv_hdr,
...
static inline bool hal_rx_mpdu_info_ampdu_flag_get_rh(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_mpdu_start *mpdu_start =
...
static uint32_t hal_rx_tlv_mpdu_len_err_get_rh(void *hw_desc_addr)
{
...
static uint32_t hal_rx_tlv_mpdu_fcs_err_get_rh(void *hw_desc_addr)
{
	struct rx_attention *rx_attn;
	struct rx_mon_pkt_tlvs *rx_desc =
		(struct rx_mon_pkt_tlvs *)hw_desc_addr;
 ...
 * Return: none
 */
static inline void hal_rx_msdu_start_msdu_len_set_rh(uint8_t *buf, uint32_t len)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_msdu_start *msdu_start =
		&pkt_tlvs->msdu_start_tlv.rx_msdu_start;
 ...
 */
static inline uint32_t hal_rx_tlv_get_freq_rh(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_msdu_start *msdu_start =
		&pkt_tlvs->msdu_start_tlv.rx_msdu_start;
 ...
 * Return: uint32_t(sgi)
 */
static inline uint32_t hal_rx_tlv_sgi_get_rh(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_msdu_start *msdu_start =
		&pkt_tlvs->msdu_start_tlv.rx_msdu_start;
 ...
 */
static inline uint32_t hal_rx_tlv_rate_mcs_get_rh(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_msdu_start *msdu_start =
		&pkt_tlvs->msdu_start_tlv.rx_msdu_start;
 ...
 */
static inline uint32_t hal_rx_tlv_mic_err_get_rh(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
 ...
 */
static inline uint32_t hal_rx_tlv_decrypt_err_get_rh(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_mpdu_end *mpdu_end = &pkt_tlvs->mpdu_end_tlv.rx_mpdu_end;
 ...
 */
static inline uint32_t hal_rx_tlv_first_mpdu_get_rh(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_attention *rx_attn = &pkt_tlvs->attn_tlv.rx_attn;
	uint32_t first_mpdu;
 ...
 */
static inline uint8_t hal_rx_msdu_get_keyid_rh(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
 ...
 */
static inline uint32_t hal_rx_tlv_get_is_decrypted_rh(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_attention *rx_attn = &pkt_tlvs->attn_tlv.rx_attn;
...
void hal_hw_txrx_default_ops_attach_rh(struct hal_soc *hal_soc)
{
	...
	hal_soc->ops->hal_get_rx_max_ba_window = hal_get_rx_max_ba_window_rh;
	...
	hal_soc->ops->hal_gen_reo_remap_val = hal_gen_reo_remap_val_generic_rh;
	hal_soc->ops->hal_rx_tlv_csum_err_get = hal_rx_tlv_csum_err_get_rh;
	hal_soc->ops->hal_rx_mpdu_desc_info_get = hal_rx_mpdu_desc_info_get_rh;
