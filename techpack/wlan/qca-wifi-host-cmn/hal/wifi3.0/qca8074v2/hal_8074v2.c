 ...
 */
static uint8_t hal_rx_get_rx_fragment_number_8074v2(uint8_t *buf)
{
 ...
 * Return: da_is_mcbc
 */
static uint8_t hal_rx_msdu_end_da_is_mcbc_get_8074v2(uint8_t *buf)
{
 ...
 */
static uint8_t hal_rx_msdu_end_sa_is_valid_get_8074v2(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_msdu_end *msdu_end = &pkt_tlvs->msdu_end_tlv.rx_msdu_end;
	uint8_t sa_is_valid;
 ...
 */
static inline uint32_t hal_rx_msdu_end_sa_sw_peer_id_get_8074v2(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_msdu_end *msdu_end = &pkt_tlvs->msdu_end_tlv.rx_msdu_end;
 ...
 * Return: void
 */
static inline void hal_tx_desc_set_mesh_en_8074v2(void *desc, uint8_t en)
{
	HAL_SET_FLD(desc, TCL_DATA_CMD_4, MESH_ENABLE) |=
		HAL_TX_SM(TCL_DATA_CMD_4, MESH_ENABLE, en);
}

static void *hal_rx_msdu0_buffer_addr_lsb_8074v2(void *link_desc_va)
{
	return (void *)HAL_RX_MSDU0_BUFFER_ADDR_LSB(link_desc_va);
}

static void *hal_rx_msdu_desc_info_ptr_get_8074v2(void *msdu0)
{
	return (void *)HAL_RX_MSDU_DESC_INFO_PTR_GET(msdu0);
}

static void *hal_ent_mpdu_desc_info_8074v2(void *ent_ring_desc)
{
	return (void *)HAL_ENT_MPDU_DESC_INFO(ent_ring_desc);
}

static void *hal_dst_mpdu_desc_info_8074v2(void *dst_ring_desc)
{
	return (void *)HAL_DST_MPDU_DESC_INFO(dst_ring_desc);
}

static uint8_t hal_rx_get_fc_valid_8074v2(uint8_t *buf)
{
...
static uint32_t hal_rx_get_ppdu_id_8074v2(uint8_t *buf)
{
	struct rx_mpdu_info *rx_mpdu_info;
 ...
 * Return: void
 */
static void hal_reo_config_8074v2(struct hal_soc *soc, uint32_t reg_val,
 ...
 * Return: cce_metadata
 */
static uint16_t hal_rx_msdu_cce_metadata_get_8074v2(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_msdu_end *msdu_end = &pkt_tlvs->msdu_end_tlv.rx_msdu_end;
 ...
 * Return: none
 */
static inline void hal_rx_msdu_get_flow_params_8074v2(uint8_t *buf,
						      bool *flow_invalid,
						      bool *flow_timeout,
						      uint32_t *flow_index)
{
 ...
 * Return: tcp checksum
 */
static uint16_t hal_rx_tlv_get_tcp_chksum_8074v2(uint8_t *buf)
{
 ...
 */
static uint16_t hal_rx_get_rx_sequence_8074v2(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = hal_rx_get_pkt_tlvs(buf);
	struct rx_mpdu_info *rx_mpdu_info = hal_rx_get_mpdu_info(pkt_tlvs);
 ...
 * Return: Success/Failure
 */
static void *hal_rx_flow_setup_fse_8074v2(uint8_t *rx_fst,
...
static void hal_compute_reo_remap_ix2_ix3_8074v2(uint32_t *ring,
						 uint32_t num_rings,
						 uint32_t *remap1,
						 uint32_t *remap2)
{
