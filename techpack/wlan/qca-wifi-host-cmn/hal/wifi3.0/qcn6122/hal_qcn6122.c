...
#define WINDOW_CONFIGURATION_VALUE_6122                                     \
	((CE_WINDOW_ADDRESS_6122 << 6) | (UMAC_WINDOW_ADDRESS_6122 << 12) | \
	 WINDOW_ENABLE_BIT)
 ...
 */
static inline void
hal_rx_proc_phyrx_other_receive_info_tlv_6122(void *rx_tlv_hdr,
					      void *ppdu_info_hdl)
{
}

#if defined(WLAN_CFR_ENABLE) && defined(WLAN_ENH_CFR_ENABLE)
static inline void hal_rx_get_bb_info_6122(void *rx_tlv, void *ppdu_info_hdl)
{
...
static inline void hal_rx_get_rtt_info_6122(void *rx_tlv, void *ppdu_info_hdl)
{
	struct hal_rx_ppdu_info *ppdu_info = ppdu_info_hdl;
 ...
 * Return: void
 */
static void hal_rx_dump_msdu_start_tlv_6122(void *pkttlvs, uint8_t dbg_level)
{
 ...
 * Return: void
 */
static void hal_rx_dump_msdu_end_tlv_6122(void *pkttlvs, uint8_t dbg_level)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)pkttlvs;
 ...
 */
static uint8_t hal_rx_get_rx_fragment_number_6122(uint8_t *buf)
{
 ...
 * Return: da_is_mcbc
 */
static uint8_t hal_rx_msdu_end_da_is_mcbc_get_6122(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_msdu_end *msdu_end = &pkt_tlvs->msdu_end_tlv.rx_msdu_end;
 ...
 */
static uint8_t hal_rx_msdu_end_sa_is_valid_get_6122(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_msdu_end *msdu_end = &pkt_tlvs->msdu_end_tlv.rx_msdu_end;
	uint8_t sa_is_valid;
 ...
 */
static QDF_STATUS hal_rx_mpdu_get_addr1_6122(uint8_t *buf, uint8_t *mac_addr)
{
 ...
 */
static inline uint32_t hal_rx_msdu_end_sa_sw_peer_id_get_6122(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_msdu_end *msdu_end = &pkt_tlvs->msdu_end_tlv.rx_msdu_end;
 ...
 * Return: void
 */
static inline void hal_tx_desc_set_mesh_en_6122(void *desc, uint8_t en)
{
	HAL_SET_FLD(desc, TCL_DATA_CMD_5, MESH_ENABLE) |=
		HAL_TX_SM(TCL_DATA_CMD_5, MESH_ENABLE, en);
}

static void *hal_rx_msdu0_buffer_addr_lsb_6122(void *link_desc_va)
{
	return (void *)HAL_RX_MSDU0_BUFFER_ADDR_LSB(link_desc_va);
}

static void *hal_rx_msdu_desc_info_ptr_get_6122(void *msdu0)
{
	return (void *)HAL_RX_MSDU_DESC_INFO_PTR_GET(msdu0);
}

static void *hal_ent_mpdu_desc_info_6122(void *ent_ring_desc)
{
	return (void *)HAL_ENT_MPDU_DESC_INFO(ent_ring_desc);
}

static void *hal_dst_mpdu_desc_info_6122(void *dst_ring_desc)
{
	return (void *)HAL_DST_MPDU_DESC_INFO(dst_ring_desc);
}

static uint8_t hal_rx_get_fc_valid_6122(uint8_t *buf)
{
...
static uint32_t hal_rx_get_ppdu_id_6122(uint8_t *buf)
{
 ...
 * Return: void
 */
static void hal_reo_config_6122(struct hal_soc *soc, uint32_t reg_val,
 ...
 * Return: cce_metadata
 */
static uint16_t hal_rx_msdu_cce_metadata_get_6122(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = (struct rx_pkt_tlvs *)buf;
	struct rx_msdu_end *msdu_end = &pkt_tlvs->msdu_end_tlv.rx_msdu_end;
 ...
 * Return: none
 */
static inline void hal_rx_msdu_get_flow_params_6122(uint8_t *buf,
						    bool *flow_invalid,
						    bool *flow_timeout,
						    uint32_t *flow_index)
{
 ...
 * Return: tcp checksum
 */
static uint16_t hal_rx_tlv_get_tcp_chksum_6122(uint8_t *buf)
{
 ...
 */
static uint16_t hal_rx_get_rx_sequence_6122(uint8_t *buf)
{
	struct rx_pkt_tlvs *pkt_tlvs = hal_rx_get_pkt_tlvs(buf);
	struct rx_mpdu_info *rx_mpdu_info = hal_rx_get_mpdu_info(pkt_tlvs);
 ...
 */
static void hal_rx_msdu_packet_metadata_get_6122(uint8_t *buf,
 ...
 * Return: Success/Failure
 */
static void *hal_rx_flow_setup_fse_6122(uint8_t *rx_fst, uint32_t table_offset,
					uint8_t *rx_flow)
{
...
static void hal_hw_txrx_ops_attach_qcn6122(struct hal_soc *hal_soc)
{
	...
	hal_soc->ops->hal_rx_tlv_msdu_len_get = hal_rx_msdu_start_get_len_6122;
};
