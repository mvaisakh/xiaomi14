...
const struct country_code_to_reg_domain g_all_countries[] = {
	...
	CE(SAINT_PIERRE_AND_MIQUELON, ETSI1_WORLD, ETSI1_6G_02, PM, 40, 160,
	   320, 0),
	CE(SAINT_VINCENT_AND_THE_GRENADIENS, ETSI1_WORLD, 0, VC, 40, 160, 0, 0),
...
const struct country_code_to_reg_domain g_all_countries[] = {
	...
	CE(SAINT_PIERRE_AND_MIQUELON, ETSI13_WORLD, ETSI1_6G_02, PM, 40, 160,
	   320, 0),
	CE(SAINT_VINCENT_AND_THE_GRENADIENS, ETSI13_WORLD, 0, VC, 40, 160, 0,
	   0),
	CE(SAMOA, ETSI1_WORLD, 0, WS, 40, 40, 0, 0),
	CE(SAN_MARINO, ETSI1_WORLD, ETSI1_6G_02, SM, 40, 160, 320, 0),
	CE(SAO_TOME_AND_PRINCIPE, FCC17_WORLD, 0, ST, 40, 160, 0, 0),
	...
	CE(UNITED_STATES, FCC8_FCCA, FCC1_6G_01, US, 40, 160, 320, 0),
	CE(UNITED_STATES_MINOR_OUTLYING_ISLANDS, FCC10_FCCA, FCC1_6G_01, UM, 40,
	   160, 320, 0),
	CE(URUGUAY, FCC2_WORLD, 0, UY, 40, 160, 0, 0),
	CE(UZBEKISTAN, ETSI3_WORLD, 0, UZ, 40, 160, 0, 0),
	CE(VANUATU, FCC17_WORLD, 0, VU, 40, 160, 0, 0),
...
const struct regulatory_rule reg_rules_5g[] = {
	...
	[CHAN_5170_5250_7] = { 5170, 5250, 80, 20,
			       REGULATORY_CHAN_INDOOR_ONLY },
	[CHAN_5170_5250_8] = { 5170, 5250, 80, 23,
			       REGULATORY_CHAN_INDOOR_ONLY },
	[CHAN_5170_5250_9] = { 5170, 5250, 40, 30, 0 },
	[CHAN_5170_5250_10] = { 5170, 5250, 20, 20,
				REGULATORY_CHAN_INDOOR_ONLY },
	[CHAN_5170_5250_11] = { 5170, 5250, 80, 16, 0 },
	[CHAN_5170_5250_12] = { 5170, 5250, 80, 24,
				REGULATORY_CHAN_INDOOR_ONLY },
	[CHAN_5170_5250_13] = { 5170, 5250, 80, 17,
				REGULATORY_CHAN_INDOOR_ONLY },
	[CHAN_5170_5250_14] = { 5170, 5250, 80, 36,
				REGULATORY_CHAN_INDOOR_ONLY },
	[CHAN_5170_5330_1] = { 5170, 5330, 160, 20, REGULATORY_CHAN_NO_IR },
	[CHAN_5170_5330_2] = { 5170, 5330, 160, 24, 0 },
	[CHAN_5170_5330_3] = { 5170, 5330, 160, 23,
			       REGULATORY_CHAN_INDOOR_ONLY },
	...
	[CHAN_5250_5330_11] = { 5250, 5330, 80, 20,
				REGULATORY_CHAN_INDOOR_ONLY },
	[CHAN_5250_5330_12] = { 5250, 5330, 80, 23,
				REGULATORY_CHAN_RADAR |
					REGULATORY_CHAN_INDOOR_ONLY },
	[CHAN_5250_5330_13] = { 5250, 5330, 40, 30, REGULATORY_CHAN_RADAR },
	[CHAN_5250_5330_14] = { 5250, 5330, 80, 20,
				REGULATORY_CHAN_RADAR |
					REGULATORY_CHAN_INDOOR_ONLY },
	[CHAN_5250_5330_15] = { 5250, 5330, 20, 20,
				REGULATORY_CHAN_RADAR |
					REGULATORY_CHAN_INDOOR_ONLY },
	[CHAN_5250_5330_16] = { 5250, 5330, 80, 23,
				REGULATORY_CHAN_INDOOR_ONLY },
	[CHAN_5250_5330_17] = { 5250, 5330, 80, 30,
				REGULATORY_CHAN_RADAR |
					REGULATORY_CHAN_INDOOR_ONLY },
	...
	[CHAN_5490_5730_8] = { 5490, 5730, 160, 30,
			       REGULATORY_CHAN_RADAR |
				       REGULATORY_CHAN_INDOOR_ONLY },
	...
	[CHAN_5490_5710_9] = { 5490, 5710, 160, 30,
			       REGULATORY_CHAN_RADAR |
				       REGULATORY_CHAN_INDOOR_ONLY },
	...
	[CHAN_5735_5835_10] = { 5735, 5835, 80, 14,
				REGULATORY_CHAN_INDOOR_ONLY },
	...
	[CHAN_5735_5875_6] = { 5735, 5875, 80, 23,
			       REGULATORY_CHAN_INDOOR_ONLY },
	...
	[CHAN_5735_5815_3] = { 5735, 5815, 80, 23,
			       REGULATORY_CHAN_INDOOR_ONLY },
	...
	[CHAN_5835_5855_2] = { 5835, 5855, 20, 14,
			       REGULATORY_CHAN_INDOOR_ONLY },
	[CHAN_5835_5895_1] = { 5835, 5895, 40, 30,
			       REGULATORY_CHAN_INDOOR_ONLY },
	[CHAN_5850_5925_1] = { 5850, 5925, 20, 24, 0 },
	[CHAN_5850_5925_2] = { 5850, 5925, 20, 30, 0 },
#if defined(CONFIG_BAND_6GHZ) && defined(COMPILE_REGDB_6G)
	[CHAN_5945_7125_1] = { 5945, 7125, 160, 21,
			       REGULATORY_CHAN_INDOOR_ONLY },
	[CHAN_5945_7125_2] = { 5945, 7125, 160, 27,
			       REGULATORY_CHAN_INDOOR_ONLY },
...
const struct regdomain regdomains_5g[] = {
	...
	[FCC1] = { CTL_FCC,
		   ...
		   6,
		   3,
		   { CHAN_5170_5250_1, CHAN_5250_5330_1, CHAN_5735_5835_2 } },
	...
	[FCC2] = { CTL_FCC,
		   ...
		   6,
		   3,
		   { CHAN_5170_5250_2, CHAN_5250_5330_1, CHAN_5735_5835_2 } },
	...
	[FCC3] = { CTL_FCC,
		   ...
		   6,
		   5,
		   { CHAN_5170_5250_5, CHAN_5250_5330_7, CHAN_5490_5730_1,
		     CHAN_5735_5835_2, CHAN_5835_5895_1 } },
	...
	[FCC4] = { CTL_FCC,
		   ...
		   6,
		   4,
		   { CHAN_4940_4990_1, CHAN_5170_5250_1, CHAN_5250_5330_7,
		     CHAN_5735_5835_2 } },
	...
	[FCC5] = { CTL_FCC,
		   ...
		   6,
		   2,
		   { CHAN_5170_5250_4, CHAN_5735_5835_2 } },
	...
	[FCC6] = { CTL_FCC,
		   ...
		   6,
		   5,
		   { CHAN_5170_5250_12, CHAN_5250_5330_7, CHAN_5490_5590_1,
		     CHAN_5650_5730_1, CHAN_5735_5835_2 } },
	...
	[FCC8] = { CTL_FCC,
		   ...
		   6,
		   5,
		   { CHAN_5170_5250_4, CHAN_5250_5330_7, CHAN_5490_5730_1,
		     CHAN_5735_5835_2, CHAN_5835_5895_1 } },
	...
	[FCC10] = { CTL_FCC,
		    ...
		    5,
		    { CHAN_5170_5250_4, CHAN_5250_5330_7, CHAN_5490_5730_1,
		      CHAN_5735_5835_2, CHAN_5850_5925_1 } },
	...
	[FCC11] = { CTL_FCC,
		    ...
		    6,
		    4,
		    { CHAN_5170_5250_5, CHAN_5250_5330_7, CHAN_5490_5650_2,
		      CHAN_5735_5835_6 } },
	...
	[FCC13] = { CTL_FCC,
		    ...
		    0,
		    3,
		    { CHAN_5170_5330_2, CHAN_5490_5730_4, CHAN_5735_5835_2 } },
	...
	[FCC14] = { CTL_FCC,
		    ...
		    0,
		    4,
		    { CHAN_5170_5250_4, CHAN_5250_5330_10, CHAN_5490_5730_4,
		      CHAN_5735_5835_2 } },
	...
	[FCC15] = { CTL_FCC,
		    ...
		    6,
		    { CHAN_5170_5250_5, CHAN_5250_5330_7, CHAN_5490_5730_1,
		      CHAN_5735_5835_2, CHAN_5835_5895_1, CHAN_5945_7125_1 } },
	...
	[FCC16] = { CTL_FCC,
		    ...
		    6,
		    { CHAN_5170_5250_4, CHAN_5250_5330_7, CHAN_5490_5730_1,
		      CHAN_5735_5835_2, CHAN_5835_5895_1, CHAN_5945_7125_2 } },
#endif
	[FCC17] = { CTL_FCC,
		    DFS_FCC_REGION,
		    2,
	...
	[FCC18] = { CTL_FCC,
		    ...
		    6,
		    4,
		    { CHAN_5170_5250_14, CHAN_5250_5330_17, CHAN_5490_5730_1,
		      CHAN_5735_5835_2 } },
	...
	[FCC20] = { CTL_FCC,
		    ...
		    6,
		    4,
		    { CHAN_5170_5250_4, CHAN_5250_5330_4, CHAN_5490_5730_5,
		      CHAN_5735_5835_2 } },
	...
	[FCC21] = { CTL_FCC,
		    ...
		    6,
		    2,
		    { CHAN_5170_5250_11, CHAN_5250_5330_18 } },
	...
	[ETSI1] = { CTL_ETSI,
		    ...
		    0,
		    3,
		    { CHAN_5170_5250_8, CHAN_5250_5330_12, CHAN_5490_5710_1 } },
	...
	[ETSI3] = { CTL_ETSI,
		    ...
		    0,
		    2,
		    { CHAN_5170_5250_2, CHAN_5250_5330_1 } },
	...
	[ETSI4] = { CTL_ETSI,
		    ...
		    0,
		    2,
		    { CHAN_5170_5250_6, CHAN_5250_5330_3 } },
	...
	[ETSI8] = { CTL_ETSI,
		    ...
		    0,
		    4,
		    { CHAN_5170_5250_2, CHAN_5250_5330_5, CHAN_5490_5730_3,
		      CHAN_5735_5835_2 } },
	...
	[ETSI9] = { CTL_ETSI,
		    ...
		    0,
		    4,
		    { CHAN_5170_5250_2, CHAN_5250_5330_1, CHAN_5490_5710_5,
		      CHAN_5735_5835_6 } },
	...
	[ETSI10] = { CTL_ETSI,
		     ...
		     0,
		     4,
		     { CHAN_5170_5250_7, CHAN_5250_5330_14, CHAN_5490_5710_3,
		       CHAN_5850_5925_2 } },
	...
	[ETSI12] = { CTL_ETSI,
		     ...
		     0,
		     4,
		     { CHAN_5170_5250_8, CHAN_5250_5330_12, CHAN_5490_5730_5,
		       CHAN_5735_5835_1 } },
	...
	[ETSI13] = { CTL_ETSI,
		     ...
		     0,
		     4,
		     { CHAN_5170_5250_2, CHAN_5250_5330_12, CHAN_5490_5710_1,
		       CHAN_5735_5875_4 } },
	...
	[ETSI14] = { CTL_ETSI,
		     ...
		     0,
		     4,
		     { CHAN_5170_5250_2, CHAN_5250_5330_1, CHAN_5490_5730_7,
		       CHAN_5735_5875_5 } },
	...
	[ETSI15] = { CTL_ETSI,
		     ...
		     0,
		     4,
		     { CHAN_5170_5250_2, CHAN_5250_5330_1, CHAN_5490_5730_5,
		       CHAN_5735_5815_2 } },
	...
	[ETSI16] = { CTL_ETSI,
		     ...
		     0,
		     2,
		     { CHAN_5170_5250_11, CHAN_5735_5875_4 } },
	...
	[ETSI17] = { CTL_ETSI,
		     ...
		     0,
		     5,
		     { CHAN_5170_5250_8, CHAN_5250_5330_12, CHAN_5490_5710_9,
		       CHAN_5735_5835_10, CHAN_5835_5855_2 } },
	...
	[ETSI18] = { CTL_ETSI,
		     ...
		     0,
		     4,
		     { CHAN_5170_5250_2, CHAN_5250_5330_12, CHAN_5490_5730_5,
		       CHAN_5735_5875_4 } },
	...
	[ETSI19] = { CTL_ETSI,
		     ...
		     0,
		     5,
		     { CHAN_5170_5250_11, CHAN_5250_5330_12, CHAN_5490_5710_9,
		       CHAN_5735_5835_10, CHAN_5835_5855_2 } },
	...
	[APL4] = { CTL_ETSI,
		   ...
		   0,
		   2,
		   { CHAN_5170_5250_2, CHAN_5735_5875_6 } },
	...
	[APL6] = { CTL_ETSI,
		   ...
		   0,
		   3,
		   { CHAN_5170_5250_3, CHAN_5250_5330_2, CHAN_5735_5835_3 } },
	...
	[APL8] = { CTL_FCC,
		   ...
		   0,
		   2,
		   { CHAN_5250_5330_4, CHAN_5735_5835_2 } },
	...
	[APL9] = { CTL_KOR,
		   ...
		   6,
		   4,
		   { CHAN_5170_5250_2, CHAN_5250_5330_1, CHAN_5490_5730_6,
		     CHAN_5735_5835_1 } },
	...
	[APL10] = { CTL_ETSI,
		    ...
		    6,
		    4,
		    { CHAN_5170_5250_2, CHAN_5250_5330_4, CHAN_5490_5710_1,
		      CHAN_5735_5815_1 } },
	...
	[APL11] = { CTL_ETSI,
		    ...
		    0,
		    4,
		    { CHAN_5170_5250_9, CHAN_5250_5330_13, CHAN_5490_5710_4,
		      CHAN_5735_5875_2 } },
	...
	[APL12] = { CTL_ETSI,
		    ...
		    0,
		    4,
		    { CHAN_5170_5250_2, CHAN_5250_5330_16, CHAN_5490_5730_8,
		      CHAN_5735_5875_6 } },
	...
	[APL13] = { CTL_ETSI,
		    ...
		    0,
		    3,
		    { CHAN_5170_5250_2, CHAN_5250_5330_1, CHAN_5490_5670_2 } },
	...
	[APL14] = { CTL_CHN,
		    ...
		    0,
		    3,
		    { CHAN_5170_5250_8, CHAN_5250_5330_12, CHAN_5735_5835_4 } },
	...
	[APL15] = { CTL_FCC,
		    ...
		    0,
		    3,
		    { CHAN_5170_5250_2, CHAN_5250_5330_5, CHAN_5735_5835_4 } },
	...
	[APL16] = { CTL_FCC,
		    ...
		    0,
		    5,
		    { CHAN_5170_5250_1, CHAN_5250_5330_10, CHAN_5490_5590_2,
		      CHAN_5650_5730_2, CHAN_5735_5835_2 } },
	...
	[APL17] = { CTL_FCC,
		    ...
		    0,
		    5,
		    { CHAN_5170_5250_2, CHAN_5250_5330_8, CHAN_5490_5590_3,
		      CHAN_5650_5730_3, CHAN_5735_5835_7 } },
	...
	[APL23] = { CTL_ETSI,
		    ...
		    0,
		    3,
		    { CHAN_5170_5250_7, CHAN_5250_5330_11, CHAN_5735_5835_3 } },
	...
	[APL24] = { CTL_ETSI,
		    ...
		    0,
		    3,
		    { CHAN_5170_5250_8, CHAN_5250_5330_12, CHAN_5735_5815_3 } },
	...
	[APL25] = { CTL_ETSI,
		    ...
		    0,
		    5,
		    { CHAN_5170_5250_8, CHAN_5250_5330_12, CHAN_5490_5590_4,
		      CHAN_5650_5730_4, CHAN_5735_5835_7 } },
	...
	[APL27] = { CTL_FCC,
		    ...
		    0,
		    4,
		    { CHAN_5170_5250_13, CHAN_5250_5330_7, CHAN_5490_5730_1,
		      CHAN_5735_5835_2 } },
	...
	[APL28] = { CTL_ETSI,
		    ...
		    0,
		    4,
		    { CHAN_5170_5250_8, CHAN_5250_5330_12, CHAN_5490_5730_6,
		      CHAN_5735_5875_3 } },
	...
	[APL29] = { CTL_FCC,
		    ...
		    0,
		    4,
		    { CHAN_5170_5250_2, CHAN_5250_5330_1, CHAN_5490_5730_1,
		      CHAN_5735_5835_11 } },
	...
	[MKK5] = { CTL_MKK,
		   ...
		   0,
		   3,
		   { CHAN_5170_5250_8, CHAN_5250_5330_12, CHAN_5490_5710_7 } },
	...
	[MKK11] = { CTL_MKK,
		    ...
		    0,
		    5,
		    { CHAN_4910_4990_1, CHAN_5170_5250_2, CHAN_5030_5090_1,
	...
	[WORLD_5G_1] = { CTL_NONE,
			 ...
			 0,
			 3,
			 { CHAN_5170_5330_1, CHAN_5735_5835_5,
			   CHAN_5945_7125_3 } },
	...
	[WORLD_5G_2] = { CTL_NONE,
			 ...
			 0,
			 4,
			 { CHAN_5170_5330_1, CHAN_5490_5730_2, CHAN_5735_5895_2,
			   CHAN_5945_7125_3 } },
#else
	[WORLD_5G_1] = { CTL_NONE,
			 DFS_UNINIT_REGION,
	...
	[WORLD_5G_2] = { CTL_NONE,
			 ...
			 0,
			 3,
			 { CHAN_5170_5330_1, CHAN_5490_5730_2,
			   CHAN_5735_5895_2 } },
#endif
...
static const struct sub_6g_regdomain sub_regdomains_6g[] = {
	[FCC1_AP_LPI_6G] = { 2,
			     320,
			     4,
			     { CHAN_5925_6425_5, CHAN_6425_6525_1,
			       CHAN_6525_6875_1, CHAN_6875_7125_1 } },
	[FCC1_AP_SP_6G] = { 2, 320, 2, { CHAN_5925_6425_7, CHAN_6525_6875_2 } },
	[FCC1_CLI_SP_6G] = { 2, 320, 2, { CHAN_5925_6425_4, CHAN_6525_6875_3 } },
	[FCC1_CLI_LPI_DEFAULT_6G] = { 2,
				      320,
				      4,
				      { CHAN_5925_6425_6, CHAN_6425_6525_2,
					CHAN_6525_6875_4, CHAN_6875_7125_2 } },
	[FCC2_AP_SP_6G] = { 2,
			    320,
			    3,
			    { CHAN_5925_6425_7, CHAN_6425_6525_6,
			      CHAN_6525_6875_8 } },
	[FCC2_CLI_SP_6G] = { 2,
			     320,
			     3,
			     { CHAN_5925_6425_4, CHAN_6425_6525_13,
			       CHAN_6525_6875_15 } },
	[FCC3_AP_VLP_6G] = { 2,
			     320,
			     4,
			     { CHAN_5925_6425_15, CHAN_6425_6525_12,
			       CHAN_6525_6875_14, CHAN_6875_7125_11 } },
	...
	[APL1_AP_LPI_6G] = { 2,
			     160,
			     4,
			     { CHAN_5945_6425_9, CHAN_6425_6525_3,
			       CHAN_6525_6875_5, CHAN_6875_7125_3 } },
	[APL1_AP_VLP_6G] = { 2, 160, 1, { CHAN_5945_6425_10 } },
	[APL2_AP_LPI_6G] = { 2,
			     320,
			     4,
			     { CHAN_5925_6425_1, CHAN_6425_6525_4,
			       CHAN_6525_6875_6, CHAN_6875_7125_4 } },
	[APL2_AP_VLP_6G] = { 2,
			     320,
			     4,
			     { CHAN_5925_6425_1, CHAN_6425_6525_4,
	...
	[APL3_AP_VLP_6G] = { 2,
			     320,
			     4,
			     { CHAN_5925_6425_2, CHAN_6425_6525_5,
			       CHAN_6525_6875_7, CHAN_6875_7125_5 } },
	[APL3_AP_LPI_6G] = { 2, 320, 1, { CHAN_5925_6425_3 } },
	[APL4_AP_LPI_6G] = { 2,
			     320,
			     4,
			     { CHAN_5925_6425_8, CHAN_6425_6525_7,
			       CHAN_6525_6875_9, CHAN_6875_7125_6 } },
	[APL4_AP_VLP_6G] = { 2,
			     320,
			     4,
			     { CHAN_5925_6425_9, CHAN_6425_6525_8,
			       CHAN_6525_6875_10, CHAN_6875_7125_7 } },
	...
	[APL6_CLI_LPI_6G] = { 2,
			      320,
			      4,
			      { CHAN_5925_6425_11, CHAN_6425_6525_10,
				CHAN_6525_6875_12, CHAN_6875_7125_9 } },
	[APL6_AP_LPI_6G] = { 2,
			     320,
			     4,
			     { CHAN_5925_6425_12, CHAN_6425_6525_11,
			       CHAN_6525_6875_13, CHAN_6875_7125_10 } },
...
const uint32_t reg_2g_sub_dmn_code[REG_DOMAINS_2G_MAX] = {
	[FCCA] = 0x0A10,  [FCCB] = 0x0B90, [WORLD] = 0x0199,
	[MKKA] = 0x0A40,  [MKKC] = 0x0A50, [ETSIC] = 0x0C30,
	[ETSID] = 0x0F30, [KRRA] = 0x0A60, [CHNA] = 0x0A80,
};

const uint32_t reg_5g_sub_dmn_code[REG_DOMAINS_5G_MAX] = {
	[NULL1] = 0x0198,  [FCC1] = 0x0110,   [FCC2] = 0x0120,
	[FCC3] = 0x0160,   [FCC4] = 0x0165,   [FCC5] = 0x0510,
	[FCC6] = 0x0610,   [FCC8] = 0x0810,   [FCC10] = 0x0B10,
	[FCC11] = 0x0B20,  [FCC13] = 0x0B60,  [FCC14] = 0x0B70,
	[FCC17] = 0x0B73,  [FCC18] = 0x0B74,  [FCC20] = 0x0B75,
	[FCC21] = 0x0B76,  [ETSI1] = 0x0130,  [ETSI3] = 0x0330,
	[ETSI4] = 0x0430,  [ETSI8] = 0x0830,  [ETSI9] = 0x0930,
	[ETSI10] = 0x0D30, [ETSI11] = 0x0E30, [ETSI12] = 0x0E38,
	[ETSI13] = 0x0E39, [ETSI14] = 0x0E40, [ETSI15] = 0x0E41,
	[ETSI18] = 0x0E44, [ETSI19] = 0x0E45, [ETSI20] = 0x0E46,
	[ETSI21] = 0x0E47, [APL1] = 0x0150,   [APL2] = 0x0250,
	[APL4] = 0x0450,   [APL6] = 0x0650,   [APL8] = 0x0850,
	[APL9] = 0x0950,   [APL10] = 0x1050,  [APL11] = 0x1150,
	[APL12] = 0x1160,  [APL13] = 0x1170,  [APL14] = 0x1180,
	[APL15] = 0x1190,  [APL16] = 0x1200,  [APL17] = 0x1210,
	[APL19] = 0x1240,  [APL20] = 0x1250,  [APL23] = 0x1280,
	[APL28] = 0x1233,  [APL29] = 0x1234,  [MKK3] = 0x0340,
	[MKK5] = 0x0540,   [MKK11] = 0x1140,  [MKK16] = 0x1640,
	[MKK17] = 0x1650,  [MKK18] = 0x1660,
};
#endif
...
{
	return ((reg_dmn == FCC3) || (reg_dmn == FCC8) || (reg_dmn == FCC15) ||
		(reg_dmn == FCC16));
}
...
{
	return ((regdmn == ETSI11_WORLD) || (regdmn == ETSI12_WORLD) ||
		(regdmn == ETSI14_WORLD) || (regdmn == ETSI15_WORLD));
}
#endif
