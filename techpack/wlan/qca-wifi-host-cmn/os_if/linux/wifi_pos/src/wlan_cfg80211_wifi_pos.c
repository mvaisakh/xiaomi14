...
void wlan_wifi_pos_cfg80211_set_wiphy_ext_feature(struct wiphy *wiphy,
						  struct wlan_objmgr_psoc *psoc)
{
	...
	iftype_ext_cap.extended_capabilities = wlan_extended_caps_iface,
					 ...
					 uint8_t *feature_flags)
{
	...
	if (wlan_psoc_nif_fw_ext2_cap_get(psoc,
		...
		wlan_wifi_pos_set_feature_flags(
			feature_flags, QCA_WLAN_VENDOR_FEATURE_SECURE_LTF_STA);
