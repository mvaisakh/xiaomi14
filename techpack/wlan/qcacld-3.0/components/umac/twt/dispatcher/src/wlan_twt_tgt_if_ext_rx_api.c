...
static QDF_STATUS tgt_twt_teardown_complete_resp_handler(
...
static QDF_STATUS tgt_twt_pause_complete_resp_handler(
	struct wlan_objmgr_psoc *psoc,
...
static QDF_STATUS tgt_twt_resume_complete_resp_handler(
	struct wlan_objmgr_psoc *psoc,
...
static QDF_STATUS tgt_twt_nudge_complete_resp_handler(
	struct wlan_objmgr_psoc *psoc,
