...
struct qmi_elem_info wfds_gen_resp_msg_v01_ei[] = {
	{
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0x02,
		.offset = offsetof(struct wfds_gen_resp_msg_v01, resp),
...
static struct qmi_elem_info wifi_drv_qmi_srng_information_v01_ei[] = {
	...
	},
	{
		...
		.tlv_type = 0,
		.offset =
			offsetof(struct wifi_drv_qmi_srng_information_v01, dir),
	},
	{
...
static struct qmi_elem_info wifi_drv_qmi_ce_information_v01_ei[] = {
	{
		...
		.tlv_type = 0,
		.offset =
			offsetof(struct wifi_drv_qmi_ce_information_v01, ce_id),
	},
	{
		.data_type = QMI_SIGNED_4_BYTE_ENUM,
		.elem_len = 1,
...
struct qmi_elem_info wfds_config_req_msg_v01_ei[] = {
	{
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0x01,
		.offset = offsetof(struct wfds_config_req_msg_v01, ce_info_len),
	},
	{
		.data_type = QMI_STRUCT,
		...
		.tlv_type = 0x01,
		.offset = offsetof(struct wfds_config_req_msg_v01, ce_info),
	...
	},
	{
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0x08,
		.offset = offsetof(struct wfds_config_req_msg_v01, rx_rbm),
	},
	{
		.data_type = QMI_UNSIGNED_8_BYTE,
		.elem_len = 1,
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0x09,
		.offset = offsetof(struct wfds_config_req_msg_v01, pcie_bar_pa),
	},
	{
		.data_type = QMI_UNSIGNED_4_BYTE,
		.elem_len = 1,
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0x0A,
		.offset = offsetof(struct wfds_config_req_msg_v01, pci_slot),
	},
	{
		.data_type = QMI_UNSIGNED_4_BYTE,
		.elem_len = 1,
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0x0B,
		.offset = offsetof(struct wfds_config_req_msg_v01, lpass_ep_id),
	},
	{
		.data_type = QMI_EOTI,
		.array_type = NO_ARRAY,
...
static struct qmi_elem_info wifi_drv_qmi_mem_arena_information_v01_ei[] = {
	{
		...
		.tlv_type = 0,
		.offset =
			offsetof(struct wifi_drv_qmi_mem_arena_information_v01,
				 entry_size),
	},
	{
		.data_type = QMI_UNSIGNED_2_BYTE,
...
struct qmi_elem_info wfds_mem_ind_msg_v01_ei[] = {
	...
	},
	{
		...
		.elem_size =
			sizeof(struct wifi_drv_qmi_mem_arena_information_v01),
		.array_type = VAR_LEN_ARRAY,
		.tlv_type = 0x01,
		.offset = offsetof(struct wfds_mem_ind_msg_v01, mem_arena_info),
...
struct qmi_elem_info wfds_misc_req_msg_v01_ei[] = {
	{
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0x01,
		.offset = offsetof(struct wfds_misc_req_msg_v01, event),
	},
	{
		.data_type = QMI_EOTI,
		.array_type = NO_ARRAY,
...
struct qmi_elem_info wfds_misc_ind_msg_v01_ei[] = {
	{
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0x01,
		.offset = offsetof(struct wfds_misc_ind_msg_v01, event),
	},
	{
		.data_type = QMI_EOTI,
		.array_type = NO_ARRAY,
...
struct qmi_elem_info wfds_ut_cmd_req_msg_v01_ei[] = {
	{
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0x01,
		.offset = offsetof(struct wfds_ut_cmd_req_msg_v01, cmd),
	},
	{
		.data_type = QMI_UNSIGNED_4_BYTE,
		.elem_len = 1,
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0x02,
		.offset = offsetof(struct wfds_ut_cmd_req_msg_v01, duration),
	},
	{
		.data_type = QMI_UNSIGNED_4_BYTE,
		.elem_len = 1,
		...
		.tlv_type = 0x03,
		.offset =
			offsetof(struct wfds_ut_cmd_req_msg_v01, flush_period),
	},
	{
		.data_type = QMI_UNSIGNED_4_BYTE,
		.elem_len = 1,
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0x04,
		.offset = offsetof(struct wfds_ut_cmd_req_msg_v01, num_pkts),
	},
	{
		.data_type = QMI_UNSIGNED_4_BYTE,
		.elem_len = 1,
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0x05,
		.offset = offsetof(struct wfds_ut_cmd_req_msg_v01, buf_size),
	},
	{
		.data_type = QMI_UNSIGNED_2_BYTE,
		.elem_len = 1,
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0x06,
		.offset = offsetof(struct wfds_ut_cmd_req_msg_v01, ether_type),
	},
	{
		.data_type = QMI_UNSIGNED_1_BYTE,
		.elem_len = 6,
		...
		.tlv_type = 0x07,
		.offset = offsetof(struct wfds_ut_cmd_req_msg_v01, src_mac),
	},
	{
		.data_type = QMI_UNSIGNED_1_BYTE,
		.elem_len = 6,
		...
		.array_type = STATIC_ARRAY,
		.tlv_type = 0x08,
		.offset = offsetof(struct wfds_ut_cmd_req_msg_v01, dest_mac),
	},
	{
		.data_type = QMI_EOTI,
		.array_type = NO_ARRAY,
	...
	},
	{
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0x09,
		.offset = offsetof(struct wfds_ut_cmd_req_msg_v01, ip_ver),
	},
	{
		.data_type = QMI_UNSIGNED_1_BYTE,
		.elem_len = 16,
		...
		.array_type = STATIC_ARRAY,
		.tlv_type = 0x0A,
		.offset = offsetof(struct wfds_ut_cmd_req_msg_v01, src_ip_addr),
	},
	{
		.data_type = QMI_UNSIGNED_1_BYTE,
		.elem_len = 16,
		...
		.tlv_type = 0x0B,
		.offset =
			offsetof(struct wfds_ut_cmd_req_msg_v01, dest_ip_addr),
	},
	{
		.data_type = QMI_UNSIGNED_2_BYTE,
		.elem_len = 1,
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0x0C,
		.offset = offsetof(struct wfds_ut_cmd_req_msg_v01, dest_port),
	},
	{
		.data_type = QMI_UNSIGNED_1_BYTE,
		.elem_len = 256,
		...
		.array_type = STATIC_ARRAY,
		.tlv_type = 0x0D,
		.offset = offsetof(struct wfds_ut_cmd_req_msg_v01, misc),
	},
};
