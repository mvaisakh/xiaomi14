...
static ssize_t __hdd_sysfs_dp_aggregation_show(struct hdd_context *hdd_ctx,
...
static ssize_t __hdd_sysfs_dp_aggregation_store(struct hdd_context *hdd_ctx,
						struct kobj_attribute *attr,
...
static ssize_t hdd_sysfs_dp_aggregation_store(struct kobject *kobj,
					      struct kobj_attribute *attr,
					      char const *buf, size_t count)
{
	...
	errno_size =
		__hdd_sysfs_dp_aggregation_store(hdd_ctx, attr, buf, count);
...
void hdd_sysfs_dp_aggregation_destroy(struct kobject *driver_kobject)
{
	if (!driver_kobject) {
		hdd_err("could not get driver kobject!");
		return;
