...
struct qmi_elem_info coex_antenna_switch_to_wlan_req_msg_v01_ei[] = {
	{
		...
		.tlv_type = 0x01,
		.offset =
			offsetof(struct coex_antenna_switch_to_wlan_req_msg_v01,
				 antenna),
	},
	{
		.data_type = QMI_EOTI,
...
struct qmi_elem_info coex_antenna_switch_to_wlan_resp_msg_v01_ei[] = {
	...
	},
	{
		...
		.tlv_type = 0x10,
		.offset = offsetof(
			struct coex_antenna_switch_to_wlan_resp_msg_v01, grant),
	},
	{
		.data_type = QMI_EOTI,
		.array_type = NO_ARRAY,
...
struct qmi_elem_info coex_antenna_switch_to_mdm_req_msg_v01_ei[] = {
	{
		...
		.tlv_type = 0x01,
		.offset = offsetof(
			struct coex_antenna_switch_to_mdm_req_msg_v01, antenna),
	},
	{
		.data_type = QMI_EOTI,
		.array_type = NO_ARRAY,
