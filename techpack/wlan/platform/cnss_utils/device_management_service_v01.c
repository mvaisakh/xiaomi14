...
struct qmi_elem_info dms_get_mac_address_req_msg_v01_ei[] = {
	{
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0x01,
		.offset = offsetof(struct dms_get_mac_address_req_msg_v01,
				   device),
	},
	{
		.data_type = QMI_EOTI,
...
struct qmi_elem_info dms_get_mac_address_resp_msg_v01_ei[] = {
	{
		...
		.tlv_type = 0x02,
		.offset =
			offsetof(struct dms_get_mac_address_resp_msg_v01, resp),
	...
	},
	{
		...
		.array_type = NO_ARRAY,
		.tlv_type = 0x10,
		.offset = offsetof(struct dms_get_mac_address_resp_msg_v01,
				   mac_address_valid),
	},
	{
