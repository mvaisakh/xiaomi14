...
struct qmi_elem_info cnss_plat_ipc_qmi_init_setup_resp_msg_v01_ei[] = {
	{
		...
		.tlv_type = 0x02,
		.offset = offsetof(
			struct cnss_plat_ipc_qmi_init_setup_resp_msg_v01, resp),
...
struct qmi_elem_info cnss_plat_ipc_qmi_file_upload_resp_msg_v01_ei[] = {
	...
	},
	{
		...
		.tlv_type = 0x04,
		.offset = offsetof(
			struct cnss_plat_ipc_qmi_file_upload_resp_msg_v01, end),
	},
	{
		.data_type = QMI_UNSIGNED_4_BYTE,
		.elem_len = 1,
...
struct qmi_elem_info cnss_plat_ipc_qmi_reg_client_resp_msg_v01_ei[] = {
	{
		...
		.tlv_type = 0x02,
		.offset = offsetof(
			struct cnss_plat_ipc_qmi_reg_client_resp_msg_v01, resp),
		.ei_array = qmi_response_type_v01_ei,
	},
	{
		.data_type = QMI_EOTI,
