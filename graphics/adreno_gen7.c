...
static const u32 gen7_pwrup_reglist[] = {
	GEN7_UCHE_TRAP_BASE_LO,	      GEN7_UCHE_TRAP_BASE_HI,
	GEN7_UCHE_WRITE_THRU_BASE_LO, GEN7_UCHE_WRITE_THRU_BASE_HI,
	GEN7_UCHE_GMEM_RANGE_MIN_LO,  GEN7_UCHE_GMEM_RANGE_MIN_HI,
	GEN7_UCHE_GMEM_RANGE_MAX_LO,  GEN7_UCHE_GMEM_RANGE_MAX_HI,
	GEN7_UCHE_CACHE_WAYS,	      GEN7_UCHE_MODE_CNTL,
	GEN7_RB_NC_MODE_CNTL,	      GEN7_RB_CMP_DBG_ECO_CNTL,
	GEN7_GRAS_NC_MODE_CNTL,	      GEN7_RB_CONTEXT_SWITCH_GMEM_SAVE_RESTORE,
	GEN7_UCHE_GBIF_GX_CONFIG,     GEN7_UCHE_CLIENT_PF,
...
static const u32 gen7_ifpc_pwrup_reglist[] = {
	GEN7_TPL1_NC_MODE_CNTL,	  GEN7_SP_NC_MODE_CNTL,
	GEN7_CP_DBG_ECO_CNTL,	  GEN7_CP_PROTECT_CNTL,
	GEN7_CP_PROTECT_REG,	  GEN7_CP_PROTECT_REG + 1,
	GEN7_CP_PROTECT_REG + 2,  GEN7_CP_PROTECT_REG + 3,
	GEN7_CP_PROTECT_REG + 4,  GEN7_CP_PROTECT_REG + 5,
	GEN7_CP_PROTECT_REG + 6,  GEN7_CP_PROTECT_REG + 7,
	GEN7_CP_PROTECT_REG + 8,  GEN7_CP_PROTECT_REG + 9,
	GEN7_CP_PROTECT_REG + 10, GEN7_CP_PROTECT_REG + 11,
	GEN7_CP_PROTECT_REG + 12, GEN7_CP_PROTECT_REG + 13,
	GEN7_CP_PROTECT_REG + 14, GEN7_CP_PROTECT_REG + 15,
	GEN7_CP_PROTECT_REG + 16, GEN7_CP_PROTECT_REG + 17,
	GEN7_CP_PROTECT_REG + 18, GEN7_CP_PROTECT_REG + 19,
	GEN7_CP_PROTECT_REG + 20, GEN7_CP_PROTECT_REG + 21,
	GEN7_CP_PROTECT_REG + 22, GEN7_CP_PROTECT_REG + 23,
	GEN7_CP_PROTECT_REG + 24, GEN7_CP_PROTECT_REG + 25,
	GEN7_CP_PROTECT_REG + 26, GEN7_CP_PROTECT_REG + 27,
	GEN7_CP_PROTECT_REG + 28, GEN7_CP_PROTECT_REG + 29,
	GEN7_CP_PROTECT_REG + 30, GEN7_CP_PROTECT_REG + 31,
	GEN7_CP_PROTECT_REG + 32, GEN7_CP_PROTECT_REG + 33,
	GEN7_CP_PROTECT_REG + 34, GEN7_CP_PROTECT_REG + 35,
	GEN7_CP_PROTECT_REG + 36, GEN7_CP_PROTECT_REG + 37,
	GEN7_CP_PROTECT_REG + 38, GEN7_CP_PROTECT_REG + 39,
	GEN7_CP_PROTECT_REG + 40, GEN7_CP_PROTECT_REG + 41,
	GEN7_CP_PROTECT_REG + 42, GEN7_CP_PROTECT_REG + 43,
	GEN7_CP_PROTECT_REG + 44, GEN7_CP_PROTECT_REG + 45,
	GEN7_CP_PROTECT_REG + 46, GEN7_CP_PROTECT_REG + 47,
	GEN7_CP_AHB_CNTL,
};

static const u32 gen7_0_0_ifpc_pwrup_reglist[] = {
	GEN7_TPL1_NC_MODE_CNTL,	  GEN7_CP_DBG_ECO_CNTL,
	GEN7_CP_PROTECT_CNTL,	  GEN7_CP_PROTECT_REG,
	GEN7_CP_PROTECT_REG + 1,  GEN7_CP_PROTECT_REG + 2,
	GEN7_CP_PROTECT_REG + 3,  GEN7_CP_PROTECT_REG + 4,
	GEN7_CP_PROTECT_REG + 5,  GEN7_CP_PROTECT_REG + 6,
	GEN7_CP_PROTECT_REG + 7,  GEN7_CP_PROTECT_REG + 8,
	GEN7_CP_PROTECT_REG + 9,  GEN7_CP_PROTECT_REG + 10,
	GEN7_CP_PROTECT_REG + 11, GEN7_CP_PROTECT_REG + 12,
	GEN7_CP_PROTECT_REG + 13, GEN7_CP_PROTECT_REG + 14,
	GEN7_CP_PROTECT_REG + 15, GEN7_CP_PROTECT_REG + 16,
	GEN7_CP_PROTECT_REG + 17, GEN7_CP_PROTECT_REG + 18,
	GEN7_CP_PROTECT_REG + 19, GEN7_CP_PROTECT_REG + 20,
	GEN7_CP_PROTECT_REG + 21, GEN7_CP_PROTECT_REG + 22,
	GEN7_CP_PROTECT_REG + 23, GEN7_CP_PROTECT_REG + 24,
	GEN7_CP_PROTECT_REG + 25, GEN7_CP_PROTECT_REG + 26,
	GEN7_CP_PROTECT_REG + 27, GEN7_CP_PROTECT_REG + 28,
	GEN7_CP_PROTECT_REG + 29, GEN7_CP_PROTECT_REG + 30,
	GEN7_CP_PROTECT_REG + 31, GEN7_CP_PROTECT_REG + 32,
	GEN7_CP_PROTECT_REG + 33, GEN7_CP_PROTECT_REG + 34,
	GEN7_CP_PROTECT_REG + 35, GEN7_CP_PROTECT_REG + 36,
	GEN7_CP_PROTECT_REG + 37, GEN7_CP_PROTECT_REG + 38,
	GEN7_CP_PROTECT_REG + 39, GEN7_CP_PROTECT_REG + 40,
	GEN7_CP_PROTECT_REG + 41, GEN7_CP_PROTECT_REG + 42,
	GEN7_CP_PROTECT_REG + 43, GEN7_CP_PROTECT_REG + 44,
	GEN7_CP_PROTECT_REG + 45, GEN7_CP_PROTECT_REG + 46,
	GEN7_CP_PROTECT_REG + 47, GEN7_CP_AHB_CNTL,
};
...
static int acd_calibrate_set(void *data, u64 val)
{
	...
	ret = gen7_hfi_send_set_value(adreno_dev, HFI_VALUE_DBG,
...
DEFINE_DEBUGFS_ATTRIBUTE(acd_cal_fops, acd_calibrate_get, acd_calibrate_set,
			 "%llu\n");
...
int gen7_fenced_write(struct adreno_device *adreno_dev, u32 offset, u32 value,
		      u32 mask)
{
	...
	dev_info(device->dev, "Waited %d usecs to write fenced register 0x%x\n",
...
int gen7_init(struct adreno_device *adreno_dev)
{
	...
	adreno_dev->cooperative_reset =
		ADRENO_FEATURE(adreno_dev, ADRENO_COOP_RESET);
...
void gen7_get_gpu_feature_info(struct adreno_device *adreno_dev)
{
	...
	adreno_dev->fastblend_enabled = feature_fuse &
					BIT(GEN7_FASTBLEND_SW_FUSE);
	adreno_dev->raytracing_enabled = feature_fuse &
					 BIT(GEN7_RAYTRACING_SW_FUSE);

	/* If software enables LPAC without HW support, disable it */
	if (ADRENO_FEATURE(adreno_dev, ADRENO_LPAC))
		adreno_dev->lpac_enabled = feature_fuse &
					   BIT(GEN7_LPAC_SW_FUSE);
...
static void gen7_protect_init(struct adreno_device *adreno_dev)
{
   ...
   */
	kgsl_regwrite(device, GEN7_CP_PROTECT_CNTL, BIT(0) | BIT(1) | BIT(3));
	...
	if (!gen7_core->hwcg) {
		...
		if (on) {
			...
			do {
				...
				udelay(1);
				kgsl_regread(device, GEN7_RBBM_CGC_P2S_STATUS,
					     &value);
			} while (!(value & BIT(0)) && --retry);

			if (!(value & BIT(0))) {
				dev_err(device->dev,
					"RBBM_CGC_P2S_STATUS:TXDONE Poll failed\n");
...
static void _set_secvid(struct kgsl_device *device)
{
	...
	kgsl_regwrite(
		device, GEN7_RBBM_SECVID_TSB_TRUSTED_SIZE,
...
int gen7_start(struct adreno_device *adreno_dev)
{
   ...
   * disabling L2 bypass
   */
	kgsl_regwrite(device, GEN7_UCHE_TRAP_BASE_LO,
		      lower_32_bits(uche_trap_base));
	kgsl_regwrite(device, GEN7_UCHE_TRAP_BASE_HI,
		      upper_32_bits(uche_trap_base));
	kgsl_regwrite(device, GEN7_UCHE_WRITE_THRU_BASE_LO,
		      lower_32_bits(uche_trap_base));
	kgsl_regwrite(device, GEN7_UCHE_WRITE_THRU_BASE_HI,
		      upper_32_bits(uche_trap_base));
   ...
   */
	...
	kgsl_regwrite(device, GEN7_UCHE_CMDQ_CONFIG,
		      FIELD_PREP(GENMASK(19, 16), 6) |
			      ...
			      FIELD_PREP(GENMASK(11, 8), 9) | BIT(3) | BIT(2) |
			      FIELD_PREP(GENMASK(1, 0), 2));

	/*
   * CP takes care of the restore during IFPC exit. We need to restore at
   * slumber boundary as well
   */
	...
	if (adreno_dev->bcl_enabled && adreno_is_gen7_2_x_family(adreno_dev))
		kgsl_regrmw(device, GEN7_GMU_CX_GMU_POWER_COUNTER_SELECT_1,
			    GENMASK(15, 8), FIELD_PREP(GENMASK(15, 8), 0x26));

	if (of_property_read_u32(device->pdev->dev.of_node,
				 "qcom,min-access-length", &mal))
		mal = 32;

	of_property_read_u32(device->pdev->dev.of_node, "qcom,ubwc-mode",
			     &mode);
	...
	if (adreno_is_gen7_9_x(adreno_dev)) {
		kgsl_regwrite(device, GEN7_TPL1_BICUBIC_WEIGHTS_TABLE_1,
			      0x3fe05ff4);
		kgsl_regwrite(device, GEN7_TPL1_BICUBIC_WEIGHTS_TABLE_2,
			      0x3fa0ebee);
		kgsl_regwrite(device, GEN7_TPL1_BICUBIC_WEIGHTS_TABLE_3,
			      0x3f5193ed);
		kgsl_regwrite(device, GEN7_TPL1_BICUBIC_WEIGHTS_TABLE_4,
			      0x3f0243f0);
	}
	...
	kgsl_regwrite(device, GEN7_RBBM_INTERFACE_HANG_INT_CNTL,
		      BIT(30) | FIELD_PREP(GENMASK(27, 0),
					   gen7_core->hang_detect_cycles));
	kgsl_regwrite(device, GEN7_UCHE_CLIENT_PF,
		      BIT(7) | FIELD_PREP(GENMASK(3, 0),
					  adreno_dev->uche_client_pf));
	...
	kgsl_regrmw(device, GEN7_GMU_CX_GMU_POWER_COUNTER_SELECT_0, 0xFF, 0x20);
...
void gen7_rdpm_mx_freq_update(struct gen7_gmu_device *gmu, u32 freq)
{
	if (gmu->rdpm_mx_virt) {
		writel_relaxed(freq / 1000,
			       (gmu->rdpm_mx_virt + GEN7_RDPM_MX_OFFSET));
...
void gen7_rdpm_cx_freq_update(struct gen7_gmu_device *gmu, u32 freq)
{
	if (gmu->rdpm_cx_virt) {
		writel_relaxed(freq / 1000,
			       (gmu->rdpm_cx_virt + GEN7_RDPM_CX_OFFSET));
...
void gen7_spin_idle_debug(struct adreno_device *adreno_dev, const char *str)
{
...
static int gen7_post_start(struct adreno_device *adreno_dev)
{
	...
	cmds = adreno_ringbuffer_allocspace(
		rb, (preempt->postamble_bootup_len ? 16 : 12));
	if (IS_ERR(cmds))
		return PTR_ERR(cmds);
	...
	*cmds++ = upper_32_bits(rb->secure_preemption_desc->gpuaddr);
	...
	if (preempt->postamble_bootup_len) {
		...
		*cmds++ =
			FIELD_PREP(GENMASK(22, 20), CP_KMD_AMBLE_TYPE) |
 ...
 */
static void gen7_gpu_keepalive(struct adreno_device *adreno_dev, bool state)
{
...
static void gen7_cp_hw_err_callback(struct adreno_device *adreno_dev, int bit)
{
	...
	if (status1 & BIT(CP_INT_CPHWFAULT)) {
		...
		dev_crit_ratelimited(
			dev, "CP | Ringbuffer HW fault | status=%x\n", status2);
	}
	...
	if (status1 & BIT(CP_INT_REGISTERPROTECTION)) {
		...
		dev_crit_ratelimited(
			...
			status2 & BIT(20) ? "READ" : "WRITE", status2 & 0x3ffff,
			status2);
	}
	...
	if (status1 & BIT(CP_INT_OPCODEERRORBV)) {
		...
		dev_crit_ratelimited(
			dev, "CP opcode error BV | opcode=0x%8.8x\n", opcode);
	}
	...
	if (status1 & BIT(CP_INT_CPHWFAULTBV)) {
		...
		dev_crit_ratelimited(
			dev, "CP BV | Ringbuffer HW fault | status=%x\n",
			status2);
	}
...
static void gen7_err_callback(struct adreno_device *adreno_dev, int bit)
{
	...
	case GEN7_INT_AHBERROR: {
		...
		kgsl_regread(device, GEN7_CP_RL_ERROR_DETAILS_0,
			     &err_details_0);
		kgsl_regread(device, GEN7_CP_RL_ERROR_DETAILS_1,
			     &err_details_1);
		dev_crit_ratelimited(
			dev,
			"CP: AHB bus error, CP_RL_ERROR_DETAILS_0:0x%x "
			"CP_RL_ERROR_DETAILS_1:0x%x\n",
	...
	case GEN7_INT_TSBWRITEERROR: {
		...
		dev_crit_ratelimited(
			dev,
			"TSB: Write error interrupt: Address: 0x%llx MID: %d\n",
...
static const char *const uche_client[] = {
	...
	"BR_LRZ",  "BR_TP", "BV_VFD", "BV_SP",	"BV_VSC",  "BV_VPC",
	"BV_HLSQ", "BV_PC", "BV_LRZ", "BV_TP"
};

static const char *const uche_lpac_client[] = { "-", "SP_LPAC",	  "-",
						"-", "HLSQ_LPAC", "-",
						"-", "TP_LPAC" };

#define SCOOBYDOO 0x5c00bd00

static const char *gen7_fault_block_uche(struct kgsl_device *device, char *str,
					 int size, bool lpac)
{
	struct adreno_device *adreno_dev = ADRENO_DEVICE(device);
...
fail:
	snprintf(str, size, "%s: Unknown (client_id: %u)", fault_block,
		 uche_client_id);
	return str;
}
 ...
 * @bit: Interrupt bit
 */
static void gen7_swfuse_violation_callback(struct adreno_device *adreno_dev,
					   int bit)
{
	struct kgsl_device *device = KGSL_DEVICE(adreno_dev);
	u32 status;
...
static const struct adreno_irq_funcs gen7_irq_funcs[32] = {
	...
	ADRENO_IRQ_CALLBACK(
		gen7_swfuse_violation_callback), /* 29 - SWFUSEVIOLATION */
		      ...
		      const struct adreno_gpu_core *gpucore)
{
	...
	debugfs_create_file("acd_calibrate", 0644, device->d_debugfs, device,
			    &acd_cal_fops);
	...
	device->snapshot_ctxt_record_size =
		ADRENO_FEATURE(adreno_dev, ADRENO_AQE) ? 112 * SZ_1K :
							 96 * SZ_1K;
...
{
	if (groupid == KGSL_PERFCOUNTER_GROUP_BV_TSE ||
	    groupid == KGSL_PERFCOUNTER_GROUP_BV_RAS ||
	    groupid == KGSL_PERFCOUNTER_GROUP_BV_LRZ ||
	    groupid == KGSL_PERFCOUNTER_GROUP_BV_HLSQ)
		return PIPE_BV;
	else if (groupid == KGSL_PERFCOUNTER_GROUP_HLSQ ||
		 groupid == KGSL_PERFCOUNTER_GROUP_TSE ||
			    ...
			    struct adreno_perfcount_register *reg, u32 groupid)
{
	...
	/*
   * If the entry is found, remove it from the list by overwriting with second
   * last entry. Skip this if data at offset is already second last entry
   */
	if (offset != second_last_offset)
		memcpy(&data[offset], &data[second_last_offset],
		       3 * sizeof(u32));

	/*
   * Overwrite the second last entry with last entry as last entry always has to
   * be GEN7_RBBM_PERFCTR_CNTL.
   */
	...
	/*
   * If dynamic list length is 1, the only entry in the list is the
   * GEN7_RBBM_PERFCTR_CNTL. Remove the same as we can disable perfcounters now.
   */
	if (lock->dynamic_list_len == 1) {
		memset(&data[offset], 0, 3 * sizeof(u32));
		lock->dynamic_list_len = 0;
		kgsl_regwrite(KGSL_DEVICE(adreno_dev), GEN7_RBBM_PERFCTR_CNTL,
			      0x0);
	}
			     ...
			     struct kgsl_power_stats *stats)
{
	...
	gpu_busy = counter_delta(device,
				 GEN7_GMU_CX_GMU_POWER_COUNTER_XOCLK_0_L,
				 &busy->gpu_busy);
	...
	if (ADRENO_FEATURE(adreno_dev, ADRENO_IFPC)) {
		u32 ifpc = counter_delta(
			device, GEN7_GMU_CX_GMU_POWER_COUNTER_XOCLK_4_L,
			&busy->num_ifpc);
	...
	if (adreno_dev->bcl_enabled) {
		...
		a = counter_delta(device,
				  GEN7_GMU_CX_GMU_POWER_COUNTER_XOCLK_1_L,
				  &busy->throttle_cycles[0]);

		b = counter_delta(device,
				  GEN7_GMU_CX_GMU_POWER_COUNTER_XOCLK_2_L,
				  &busy->throttle_cycles[1]);

		c = counter_delta(device,
				  GEN7_GMU_CX_GMU_POWER_COUNTER_XOCLK_3_L,
		...
		if (adreno_is_gen7_2_x_family(adreno_dev)) {
			u32 bcl_throttle = counter_delta(
				device, GEN7_GMU_CX_GMU_POWER_COUNTER_XOCLK_5_L,
				&busy->bcl_throttle);
			/*
       * This counts number of cycles throttled in XO cycles. Convert it to
       * micro seconds by dividing by XO freq which is 19.2MHz.
       */
			adreno_dev->bcl_throttle_time_us +=
				((bcl_throttle * 10) / 192);
		}
	}
}

static int gen7_setproperty(struct kgsl_device_private *dev_priv, u32 type,
