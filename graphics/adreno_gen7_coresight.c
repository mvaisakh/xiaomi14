...
/*CX debug registers*/
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_sel_a, &gen7_coresight_regs_cx[0]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_sel_b, &gen7_coresight_regs_cx[1]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_sel_c, &gen7_coresight_regs_cx[2]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_sel_d, &gen7_coresight_regs_cx[3]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_cntlt, &gen7_coresight_regs_cx[4]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_cntlm, &gen7_coresight_regs_cx[5]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_opl, &gen7_coresight_regs_cx[6]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_ope, &gen7_coresight_regs_cx[7]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_ivtl_0, &gen7_coresight_regs_cx[8]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_ivtl_1, &gen7_coresight_regs_cx[9]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_ivtl_2, &gen7_coresight_regs_cx[10]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_ivtl_3, &gen7_coresight_regs_cx[11]);
...
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_ivte_0, &gen7_coresight_regs_cx[18]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_ivte_1, &gen7_coresight_regs_cx[19]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_ivte_2, &gen7_coresight_regs_cx[20]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_ivte_3, &gen7_coresight_regs_cx[21]);
...
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_ptrc0, &gen7_coresight_regs_cx[27]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_ptrc1, &gen7_coresight_regs_cx[28]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_loadreg,
			     &gen7_coresight_regs_cx[29]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_idx, &gen7_coresight_regs_cx[30]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_clrc, &gen7_coresight_regs_cx[31]);
static ADRENO_CORESIGHT_ATTR(cx_cfg_dbgbus_loadivt,
			     &gen7_coresight_regs_cx[32]);
static ADRENO_CORESIGHT_ATTR(cx_vbif_dbg_cntl, &gen7_coresight_regs_cx[33]);
static ADRENO_CORESIGHT_ATTR(cx_dbg_lo_hi_gpio, &gen7_coresight_regs_cx[34]);
...
static ADRENO_CORESIGHT_ATTR(cx_evt_cfg, &gen7_coresight_regs_cx[39]);
static ADRENO_CORESIGHT_ATTR(cx_evt_intf_sel_0, &gen7_coresight_regs_cx[40]);
static ADRENO_CORESIGHT_ATTR(cx_evt_intf_sel_1, &gen7_coresight_regs_cx[41]);
static ADRENO_CORESIGHT_ATTR(cx_perf_atb_cfg, &gen7_coresight_regs_cx[42]);
...
static ADRENO_CORESIGHT_ATTR(cx_eco_cntl, &gen7_coresight_regs_cx[50]);
static ADRENO_CORESIGHT_ATTR(cx_ahb_dbg_cntl, &gen7_coresight_regs_cx[51]);
...
void gen7_coresight_init(struct adreno_device *adreno_dev)
{
	...
	amba_dev =
		bus_find_device_by_name(&amba_bustype, NULL, "10963000.funnel");
	if (!amba_dev)
		return;

	funnel_gfx->funnel_dev =
		device_find_child(amba_dev, "coresight-funnel-gfx", name_match);
	...
	/*
   * Since coresight_funnel_gfx component is in graphics block, GPU has to be
   * powered up before enabling the funnel. Currently the generic coresight
   * driver doesnt handle that. Override the funnel ops set by coresight driver
   * with graphics funnel ops, so that the GPU can be brought up before enabling
   * the funnel.
   */
	...
	/*
   * The read-only sysfs node (funnel_ctrl) associated with gfx funnel reads the
   * control register and could cause a NOC error when gpu is in slumber. Since
   * we do not require such node, remove the attribute groups for the funnel.
   */
	sysfs_remove_groups(&funnel_gfx->funnel_dev->kobj,
			    funnel_gfx->funnel_csdev->dev.groups);
