...
static const struct adreno_debugbus_block a5xx_debugbus_blocks[] = {
	...
	{
		A5XX_RBBM_DBGBUS_RBBM,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_VBIF,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_HLSQ,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_UCHE,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_DPM,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_TESS,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_PC,
	...
	{
		A5XX_RBBM_DBGBUS_VFDP,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_VPC,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_TSE,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_RAS,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_VSC,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_COM,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_DCOM,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_LRZ,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_A2D_DSP,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_CCUFCHE,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_GPMU,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_RBP,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_HM,
	...
	{
		A5XX_RBBM_DBGBUS_RBBM_CFG,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_VBIF_CX,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_GPC,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_LARC,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_HLSQ_SPTP,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_RB_0,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_RB_1,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_RB_2,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_RB_3,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_CCU_0,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_CCU_1,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_CCU_2,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_CCU_3,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_A2D_RAS_0,
		0x100,
	},
	{
	...
	{
		A5XX_RBBM_DBGBUS_A2D_RAS_2,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_A2D_RAS_3,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_VFD_0,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_VFD_1,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_VFD_2,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_VFD_3,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_SP_0,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_SP_1,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_SP_2,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_SP_3,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_TPL1_0,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_TPL1_1,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_TPL1_2,
		0x100,
	},
	{
		A5XX_RBBM_DBGBUS_TPL1_3,
		0x100,
	},
};
...
static size_t a5xx_snapshot_vbif_debugbus(struct kgsl_device *device, u8 *buf,
					  size_t remain, void *priv)
{
   ...
   */
	unsigned int dwords = (16 * A5XX_NUM_AXI_ARB_BLOCKS) +
			      (18 * A5XX_NUM_XIN_BLOCKS) +
			      (12 * A5XX_NUM_XIN_BLOCKS);
	unsigned int *data = (unsigned int *)(buf + sizeof(*header));
	size_t size;
	...
	kgsl_regwrite(device, A5XX_VBIF_CLKON,
		      reg_clk | (A5XX_VBIF_CLKON_FORCE_ON_TESTBUS_MASK
	...
	for (i = 0; i < A5XX_NUM_XIN_BLOCKS; i++) {
		...
		for (j = 0; j < 12; j++) {
			kgsl_regwrite(
				device, A5XX_VBIF_TEST_BUS1_CTRL1,
...
static size_t a5xx_snapshot_debugbus_block(struct kgsl_device *device, u8 *buf,
					   size_t remain, void *priv)
{
	struct kgsl_snapshot_debugbus *header =
		(struct kgsl_snapshot_debugbus *)buf;
...
static const unsigned int a5xx_vbif_registers[] = {
	0x3000, 0x3007, 0x300C, 0x3014, 0x3018, 0x302C, 0x3030, 0x3030, 0x3034,
	0x3036, 0x3038, 0x3038, 0x303C, 0x303D, 0x3040, 0x3040, 0x3042, 0x3042,
	0x3049, 0x3049, 0x3058, 0x3058, 0x305A, 0x3061, 0x3064, 0x3068, 0x306C,
	0x306D, 0x3080, 0x3088, 0x308C, 0x308C, 0x3090, 0x3094, 0x3098, 0x3098,
	0x309C, 0x309C, 0x30C0, 0x30C0, 0x30C8, 0x30C8, 0x30D0, 0x30D0, 0x30D8,
	0x30D8, 0x30E0, 0x30E0, 0x3100, 0x3100, 0x3108, 0x3108, 0x3110, 0x3110,
	0x3118, 0x3118, 0x3120, 0x3120, 0x3124, 0x3125, 0x3129, 0x3129, 0x3131,
	0x3131, 0x340C, 0x340C, 0x3410, 0x3410, 0x3800, 0x3801,
};
...
static size_t a5xx_snapshot_shader_memory(struct kgsl_device *device, u8 *buf,
					  size_t remain, void *priv)
{
	...
	for (i = 0; i < ARRAY_SIZE(a5xx_shader_blocks); i++) {
		for (j = 0; j < A5XX_NUM_SHADER_BANKS; j++) {
			...
			kgsl_snapshot_add_section(
				...
				a5xx_snapshot_shader_memory, &info);
		}
	}
}
...
static int get_hlsq_registers(struct kgsl_device *device,
			      const struct a5xx_hlsq_sp_tp_regs *regs,
			      unsigned int *data)
{
	unsigned int i;
				      ...
				      size_t remain, void *priv)
{
	...
	for (i = 0; i < size; i++) {
		kgsl_regread(device, A5XX_CP_MERCIU_DBG_DATA_1, &data[(i * 2)]);
		   ...
		   struct kgsl_snapshot *snapshot)
{
	...
	kgsl_snapshot_add_section(device, KGSL_SNAPSHOT_SECTION_REGS, snapshot,
				  a5xx_snapshot_pre_crashdump_regs, NULL);
	...
	if (a5xx_has_gpmu(adreno_dev)) {
		...
		kgsl_snapshot_add_section(device, KGSL_SNAPSHOT_SECTION_REGS,
					  snapshot, a5xx_snapshot_registers,
					  &regs);
	}
	...
	kgsl_snapshot_indexed_registers(device, snapshot, A5XX_CP_PFP_STAT_ADDR,
					A5XX_CP_PFP_STAT_DATA, 0, 36);

	/* CP_ME indexed registers */
	kgsl_snapshot_indexed_registers(device, snapshot, A5XX_CP_ME_STAT_ADDR,
					A5XX_CP_ME_STAT_DATA, 0, 29);

	/* CP_DRAW_STATE */
	kgsl_snapshot_indexed_registers(device, snapshot,
					A5XX_CP_DRAW_STATE_ADDR,
					A5XX_CP_DRAW_STATE_DATA, 0,
					1 << A5XX_CP_DRAW_STATE_ADDR_WIDTH);

	/* ME_UCODE Cache */
	kgsl_snapshot_indexed_registers(device, snapshot,
					A5XX_CP_ME_UCODE_DBG_ADDR,
					A5XX_CP_ME_UCODE_DBG_DATA, 0, 0x53F);

	/* PFP_UCODE Cache */
	kgsl_snapshot_indexed_registers(device, snapshot,
					A5XX_CP_PFP_UCODE_DBG_ADDR,
					A5XX_CP_PFP_UCODE_DBG_DATA, 0, 0x53F);

	/* CP MEQ */
	kgsl_snapshot_add_section(device, KGSL_SNAPSHOT_SECTION_DEBUG, snapshot,
				  a5xx_snapshot_cp_meq, NULL);

	/* CP ROQ */

	kgsl_snapshot_add_section(device, KGSL_SNAPSHOT_SECTION_DEBUG, snapshot,
				  a5xx_snapshot_cp_roq, NULL);

	kgsl_snapshot_add_section(device, KGSL_SNAPSHOT_SECTION_DEBUG, snapshot,
				  a5xx_snapshot_cp_merciu, NULL);

	/* CP PFP and PM4 */
	kgsl_snapshot_add_section(device, KGSL_SNAPSHOT_SECTION_DEBUG, snapshot,
				  a5xx_snapshot_cp_pfp, NULL);

	kgsl_snapshot_add_section(device, KGSL_SNAPSHOT_SECTION_DEBUG, snapshot,
				  a5xx_snapshot_cp_pm4, NULL);
				     ...
				     uint64_t *ptr, uint64_t *offset)
{
	...
	/* Program the aperture */
	ptr[qwords++] = (regs->statetype << A5XX_SHADER_STATETYPE_SHIFT);
	ptr[qwords++] = (((uint64_t)A5XX_HLSQ_DBG_READ_SEL << 44)) | (1 << 21) |
			1;

	/* Read all the data in one chunk */
	ptr[qwords++] = registers->gpuaddr + *offset;
	ptr[qwords++] = (((uint64_t)A5XX_HLSQ_DBG_AHB_READ_APERTURE << 44)) |
			regs->size;
...
void a5xx_crashdump_init(struct adreno_device *adreno_dev)
{
   ...
   */
	...
	for (i = 0; i < ARRAY_SIZE(a5xx_hlsq_sp_tp_registers); i++) {
		script_size += 32;
		data_size += a5xx_hlsq_sp_tp_registers[i].size *
			     sizeof(unsigned int);
	}
	...
	if (!IS_ERR_OR_NULL(capturescript))
		capturescript = kgsl_allocate_global(
			device, script_size + 16, 0, KGSL_MEMFLAGS_GPUREADONLY,
	...
	for (j = 0; j < ARRAY_SIZE(a5xx_registers) / 2; j++) {
		...
		*ptr++ = (((uint64_t)a5xx_registers[2 * j]) << 44) | r;
	...
	if (a5xx_has_gpmu(adreno_dev)) {
		for (j = 0; j < ARRAY_SIZE(a5xx_gpmu_registers) / 2; j++) {
			...
			*ptr++ = registers->gpuaddr + offset;
			*ptr++ =
				(((uint64_t)a5xx_gpmu_registers[2 * j]) << 44) |
				r;
			offset += r * sizeof(unsigned int);
		}
	}
